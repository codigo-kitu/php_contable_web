...
jQuery(document).ready(function() {
	...
	jQuery("#btnAceptar").click(function(){
		...
		jQuery.post('http://'+constantes.STR_IP_SERVIDOR+':'+constantes.STR_PUERTO_SERVIDOR+'/'+constantes.STR_CONTEXTO_APLICACION_SERVICIO+'/'+constantes.STR_CONTEXTO_APLICACION_TOCOMPLETE_SERVICIO+'/'+'GlobalController.php', strFormQueryString ,
			...
			.success(function(jsonresult) {
				...
				//alert(jQuery("#Mensaje-hdnAuxiliarUrlPagina"));
				jQuery("#Mensaje-hdnAuxiliarUrlPagina").val(loginController.strAuxiliarUrlPagina);
	...
	jQuery("#btnCerrarSesion").click(function(){
		var strFormQueryString=jQuery("#frmUsuarioLogin").serialize();
		...
		jQuery.post('http://'+constantes.STR_IP_SERVIDOR+':'+constantes.STR_PUERTO_SERVIDOR+'/'+constantes.STR_CONTEXTO_APLICACION_SERVICIO+'/'+constantes.STR_CONTEXTO_APLICACION_TOCOMPLETE_SERVICIO+'/'+'GlobalController.php', strFormQueryString ,
			...
			.complete(function(jsonresult) {
				...
				//login.validarLogginOnComplete(jsonresult);
				//funcionGeneral.procesarFinalizacionProceso();
			});									
	});
