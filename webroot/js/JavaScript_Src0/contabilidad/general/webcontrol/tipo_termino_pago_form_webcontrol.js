...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(tipo_termino_pago_control) {
		...
		jQuery("#form"+tipo_termino_pago_constante1.STR_SUFIJO+"-version_row").val(tipo_termino_pago_control.tipo_termino_pagoActual.versionRow);
	...
	actualizarSpanMensajesCampos(tipo_termino_pago_control) {
		...
		jQuery("#spanstrMensajeversion_row").text(tipo_termino_pago_control.strMensajeversion_row);		
