...
//var documento_contableFuncionGeneral= function () {

class documento_contable_funcion {
...
//---------- Clic-Seleccionar ----------
	...
	seleccionarMostrarDivAccionesRelacionesActualOnComplete() {
		funcionGeneral.seleccionarMostrarDivAccionesRelacionesActualOnComplete("documento_contable",this);
	}
...
//------------- Clic-Cancelar -------------------
	...
	cancelarControles() {
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientodocumento_contable.txtcontador);
		funcionGeneral.setEmptyControl(document.frmMantenimientodocumento_contable.txtincremento);
		funcionGeneral.setCheckControl(document.frmMantenimientodocumento_contable.chbusa_contador,false);
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(documento_contable_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(documento_contable_constante1.STR_RELATIVE_PATH,"documento_contable");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(documento_contable_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(documento_contable_constante1.STR_RELATIVE_PATH,"documento_contable");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(documento_contable_constante1.STR_RELATIVE_PATH,"documento_contable");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"documento_contable");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(documento_contable_constante1.BIT_CON_PAGINA_FORM==true && documento_contable_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
...
//------------- Formulario-Combo-Accion -------------------
	...
	setTipoColumnaAccion(strValueTipoColumna,idActual) {
		...
		if(strValueTipoColumna!=constantes.STR_COLUMNAS && strValueTipoColumna!=null) {
			...
			else if(strValueTipoColumna=="Contador") {
				jQuery(".col_contador").css({"border-color":"red"});
			}
			else if(strValueTipoColumna=="Incremento") {
				jQuery(".col_incremento").css({"border-color":"red"});
			}
			else if(strValueTipoColumna=="Usa Contador") {
				jQuery(".col_usa_contador").css({"border-color":"red"});
			}
		...
		if(documento_contable_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				messages: {
					...
					"form-contador": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
			...
			arrRules= {
				...
				"form_documento_contable-contador": {
					required:true,
					number:true
				},
				...
				messages: {
					...
					"form_documento_contable-contador": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"documento_contable");
	}
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodocumento_contable.txtcontador,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodocumento_contable.txtincremento,false);
			funcionGeneral.setDisabledControl(document.frmMantenimientodocumento_contable.chbusa_contador,false);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodocumento_contable.txtcontador,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodocumento_contable.txtincremento,true);
			funcionGeneral.setDisabledControl(document.frmMantenimientodocumento_contable.chbusa_contador,true);
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"documento_contable");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"documento_contable");
	}
