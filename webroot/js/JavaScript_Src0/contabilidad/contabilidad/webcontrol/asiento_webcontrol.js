...
class asiento_webcontrol extends asiento_webcontrol_add {
	...
	actualizarVariablesPagina(asiento_control) {
		...
		if(asiento_control.action=="index" || asiento_control.action=="load") {
		...
		} else if(asiento_control.action=="recargarFomularioGeneral") {
			...
			alert(asiento_control.action + " Revisar Manejo");
			
			if(asiento_control.bitEsAbrirVentanaAuxiliarUrl==true){
			...
			if(asiento_control.bitEsEjecutarFuncionJavaScript==true){
				this.actualizarPaginaEjecutarJavaScript(asiento_control);
			}
			...
			if(asiento_control.paramDivSeccion.bitDivsEsCargarGeneralAjaxWebPart==true) {		
				this.actualizarPaginaCargaGeneral(asiento_control);	
			}
			
			if(asiento_control.paramDivSeccion.bitDivEsCargarAjaxWebPart==true) {
				this.actualizarPaginaTablaDatos(asiento_control);
			}
			
			if(asiento_control.paramDivSeccion.bitDivsEsCargarMostrarAjaxWebPart==true) {		
			...
			if(asiento_control.paramDivSeccion.bitDivsEsCargarMostrarSoloBusquedasAjaxWebPart==true) {		
				this.actualizarPaginaAreaBusquedas(asiento_control);	
			}
			
			if(asiento_control.paramDivSeccion.bitDivsEsCargarMostrarSoloMantenimientosAjaxWebPart==true) {		
			...
			if(asiento_control.paramDivSeccion.bitDivEsCargarMantenimientosAjaxWebPart==true) {				
				this.actualizarPaginaTablaFilaActual(asiento_control);			
			}
			
			if(asiento_control.paramDivSeccion.bitDivsEsCargarReporteAuxiliarAjaxWebPart==true) {				
				this.actualizarPaginaImprimir(asiento_control);
			}
			
			
			if(asiento_control.paramDivSeccion.bitDivsEsCargarMostrarBusquedasAjaxWebPart==true) {
				this.actualizarPaginaAreaAuxiliarBusquedas(asiento_control);
			}
			
			if(asiento_control.paramDivSeccion.bitDivsEsCargarResumenAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarResumen(asiento_control);
			}				
			
			if(asiento_control.paramDivSeccion.bitDivsEsCargarAccionesRelacionesAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarAccionesRelaciones(asiento_control);
			}
			
			if(asiento_control.usuarioActual!=null && asiento_control.usuarioActual.field_strUserName!=null &&
			asiento_control.usuarioActual.field_strUserName!=undefined ) {
				
				this.actualizarPaginaUsuarioInvitado(asiento_control);			
			}
		}
...
//Funciones Auxiliares
	...
	actualizarPaginaTablaDatosAuxiliar(asiento_control) {
		if(asiento_funcion1.esPaginaForm()==true) {
	...
	actualizarPaginaEjecutarJavaScript(asiento_control) {
		eval(asiento_control.strFuncionJs);
	}
	
	actualizarPaginaMensajePantalla(asiento_control, mostrar) {
		
		if(mostrar==true) {
			asiento_funcion1.resaltarRestaurarDivsPagina(false);
			
			if(jQuery("#ParamsPostAccion-chbPostAccionSinCerrar").prop('checked')==false
				&& jQuery("#ParamsPostAccion-chbPostAccionNuevo").prop('checked')==false) {		
					
				asiento_funcion1.resaltarRestaurarDivMantenimiento(false);
			}			
	...
	actualizarPaginaImprimir(asiento_control) {
	
		funcionGeneral.printWebPartPage("asiento",asiento_control.htmlTablaReporteAuxiliars);			
			
		//jQuery("#divTablaDatosReporteAuxiliarasientosAjaxWebPart").html(asiento_control.htmlTablaReporteAuxiliars);						
		//funcionGeneral.printWebPartPage("asiento",jQuery("#divTablaDatosReporteAuxiliarasientosAjaxWebPart").html());			
	}
...
/*---------------------------------- AREA:FORMULARIO ---------------------------*/
	...
	actualizarCamposFormulario(asiento_control) {
		...
		jQuery("#form"+asiento_constante1.STR_SUFIJO+"-referencia").val(asiento_control.asientoActual.referencia);
	}
	...
	actualizarSpanMensajesCampos(asiento_control) {
		...
		jQuery("#spanstrMensajereferencia").text(asiento_control.strMensajereferencia);		
	}
...
/*---------------------------------- AREA:TABLA ---------------------------*/
	...
	actualizarCamposFilaTabla(asiento_control) {
		...
		if(asiento_control.asientoActual.id_fuente!=null && asiento_control.asientoActual.id_fuente>-1){
			if(jQuery("#t-cel_"+i+"_10").val() != asiento_control.asientoActual.id_fuente) {
				jQuery("#t-cel_"+i+"_10").val(asiento_control.asientoActual.id_fuente).trigger("change");
			}
		} else { 
		...
		if(asiento_control.asientoActual.id_centro_costo!=null && asiento_control.asientoActual.id_centro_costo>-1){
			if(jQuery("#t-cel_"+i+"_12").val() != asiento_control.asientoActual.id_centro_costo) {
				jQuery("#t-cel_"+i+"_12").val(asiento_control.asientoActual.id_centro_costo).trigger("change");
			}
		} else { 
		...
		if(asiento_control.asientoActual.id_documento_contable!=null && asiento_control.asientoActual.id_documento_contable>-1){
			if(jQuery("#t-cel_"+i+"_13").val() != asiento_control.asientoActual.id_documento_contable) {
				jQuery("#t-cel_"+i+"_13").val(asiento_control.asientoActual.id_documento_contable).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_22").val(asiento_control.asientoActual.referencia);
	}
	...
	registrarSesionParaasiento_detallees(idActual){
		...
		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"asiento","asiento_detalle","contabilidad","",asiento_funcion1,asiento_webcontrol1,"es","");
	}
...
/*---------------------------------- AREA:FK ---------------------------*/
	...
	cargarCombosfuentesFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_10",asiento_control.fuentesFK);
		}
	...
	cargarComboscentro_costosFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_12",asiento_control.centro_costosFK);
		}
	...
	cargarCombosdocumento_contablesFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_13",asiento_control.documento_contablesFK);
		}
...
/*---------------------------------- AREA:AUXILIARES ---------------------------*/
	...
	registrarAccionesEventos() {	
		...
		jQuery(document).ready(function() {
			...
			funcionGeneralEventoJQuery.setImagenCerrarSesionClic("asiento","contabilidad","",asiento_funcion1,asiento_webcontrol1);			
