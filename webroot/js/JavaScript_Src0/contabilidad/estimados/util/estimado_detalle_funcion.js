...
//var estimado_detalleFuncionGeneral= function () {

class estimado_detalle_funcion {
...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(estimado_detalle_constante1.STR_RELATIVE_PATH,"estimado_detalle");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(estimado_detalle_constante1.STR_RELATIVE_PATH,estimado_detalle_constante1.STR_NOMBRE_OPCION,"estimado_detalle");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(estimado_detalle_constante1.STR_RELATIVE_PATH,estimado_detalle_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Clic-Cancelar -------------------
	...
	cancelarControles() {
		...
		jQuery('dtestimado_detallefecha_emision').val(new Date());
		funcionGeneral.setEmptyControl(document.frmMantenimientoestimado_detalle.txtcomentario);
		funcionGeneral.setEmptyControl(document.frmMantenimientoestimado_detalle.txttipo_cambio);
		funcionGeneral.setEmptyControl(document.frmMantenimientoestimado_detalle.txtmoneda);
		jQuery('cmbestimado_detalleid_cliente').val("");	
	}
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(estimado_detalle_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(estimado_detalle_constante1.STR_RELATIVE_PATH,"estimado_detalle");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(estimado_detalle_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(estimado_detalle_constante1.STR_RELATIVE_PATH,"estimado_detalle");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(estimado_detalle_constante1.STR_RELATIVE_PATH,"estimado_detalle");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"estimado_detalle");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(estimado_detalle_constante1.BIT_CON_PAGINA_FORM==true && estimado_detalle_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
		...
		*/
		...
		if(estimado_detalle_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				"form_estimado_detalle-fecha_emision": {
					required:true,
					date:true
				},
					
				"form_estimado_detalle-comentario": {
					required:true,
					maxlength:1000
					,regexpStringMethod:true
				},
					
				"form_estimado_detalle-tipo_cambio": {
					required:true,
					number:true
				},
				...
				"form_estimado_detalle-id_cliente": {
					digits:true
				...
				messages: {
					...
					"form_estimado_detalle-fecha_emision": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_FECHA_INCORRECTO,
					"form_estimado_detalle-comentario": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_estimado_detalle-tipo_cambio": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_estimado_detalle-moneda": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
					"form_estimado_detalle-id_cliente": ""+constantes.STR_MENSAJE_ENTERO_INCORRECTO
				}		
			};	
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"estimado_detalle");
	}
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoestimado_detalle.txtcomentario,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoestimado_detalle.txttipo_cambio,false);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoestimado_detalle.txtcomentario,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoestimado_detalle.txttipo_cambio,true);
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"estimado_detalle");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"estimado_detalle");
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(estimado_detalle_control,estimado_detalle_webcontrol1,estimado_detalle_constante1) {
		
		var strSuf=estimado_detalle_constante1.STR_SUFIJO;
			...
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(constantes.STR_TIPO_COMBO=="select2") {
					...
					estimado_detalle_webcontrol1.registrarComboActionChangeid_bodega(control_name,true,i);
				}
				...
				if(constantes.STR_TIPO_COMBO=="select2") {
					...
					estimado_detalle_webcontrol1.registrarComboActionChangeid_producto(control_name,true,i);
				}
				...
				if(estimado_detalle_control.idestimadoDefaultForeignKey!=null && estimado_detalle_control.idestimadoDefaultForeignKey>-1) {
					idActual=estimado_detalle_control.idestimadoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					estimado_detalle_webcontrol1.cargarComboEditarTablaestimadoFK(estimado_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						estimado_detalle_webcontrol1.cargarComboEditarTablaestimadoFK(estimado_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(estimado_detalle_control.idbodegaDefaultForeignKey!=null && estimado_detalle_control.idbodegaDefaultForeignKey>-1) {
					idActual=estimado_detalle_control.idbodegaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					estimado_detalle_webcontrol1.cargarComboEditarTablabodegaFK(estimado_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						estimado_detalle_webcontrol1.cargarComboEditarTablabodegaFK(estimado_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(estimado_detalle_control.idproductoDefaultForeignKey!=null && estimado_detalle_control.idproductoDefaultForeignKey>-1) {
					idActual=estimado_detalle_control.idproductoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					estimado_detalle_webcontrol1.cargarComboEditarTablaproductoFK(estimado_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						estimado_detalle_webcontrol1.cargarComboEditarTablaproductoFK(estimado_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(estimado_detalle_control.idunidadDefaultForeignKey!=null && estimado_detalle_control.idunidadDefaultForeignKey>-1) {
					idActual=estimado_detalle_control.idunidadDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					estimado_detalle_webcontrol1.cargarComboEditarTablaunidadFK(estimado_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						estimado_detalle_webcontrol1.cargarComboEditarTablaunidadFK(estimado_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(estimado_detalle_control.idclienteDefaultForeignKey!=null && estimado_detalle_control.idclienteDefaultForeignKey>-1) {
					idActual=estimado_detalle_control.idclienteDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					estimado_detalle_webcontrol1.cargarComboEditarTablaclienteFK(estimado_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						estimado_detalle_webcontrol1.cargarComboEditarTablaclienteFK(estimado_detalle_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatosestimado_detalle").validate(json_rules);
