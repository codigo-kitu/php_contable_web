...
//var cuenta_pagar_detalleFuncionGeneral= function () {

class cuenta_pagar_detalle_funcion {
...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(cuenta_pagar_detalle_constante1.STR_RELATIVE_PATH,"cuenta_pagar_detalle");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(cuenta_pagar_detalle_constante1.STR_RELATIVE_PATH,cuenta_pagar_detalle_constante1.STR_NOMBRE_OPCION,"cuenta_pagar_detalle");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(cuenta_pagar_detalle_constante1.STR_RELATIVE_PATH,cuenta_pagar_detalle_constante1.STR_NOMBRE_OPCION);
	}
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(cuenta_pagar_detalle_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(cuenta_pagar_detalle_constante1.STR_RELATIVE_PATH,"cuenta_pagar_detalle");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(cuenta_pagar_detalle_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(cuenta_pagar_detalle_constante1.STR_RELATIVE_PATH,"cuenta_pagar_detalle");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(cuenta_pagar_detalle_constante1.STR_RELATIVE_PATH,"cuenta_pagar_detalle");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"cuenta_pagar_detalle");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(cuenta_pagar_detalle_constante1.BIT_CON_PAGINA_FORM==true && cuenta_pagar_detalle_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"cuenta_pagar_detalle");
	}
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"cuenta_pagar_detalle");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"cuenta_pagar_detalle");
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(cuenta_pagar_detalle_control,cuenta_pagar_detalle_webcontrol1,cuenta_pagar_detalle_constante1) {
		
		var strSuf=cuenta_pagar_detalle_constante1.STR_SUFIJO;
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(cuenta_pagar_detalle_control.idempresaDefaultForeignKey!=null && cuenta_pagar_detalle_control.idempresaDefaultForeignKey>-1) {
					idActual=cuenta_pagar_detalle_control.idempresaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablaempresaFK(cuenta_pagar_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablaempresaFK(cuenta_pagar_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(cuenta_pagar_detalle_control.idsucursalDefaultForeignKey!=null && cuenta_pagar_detalle_control.idsucursalDefaultForeignKey>-1) {
					idActual=cuenta_pagar_detalle_control.idsucursalDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablasucursalFK(cuenta_pagar_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablasucursalFK(cuenta_pagar_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(cuenta_pagar_detalle_control.idejercicioDefaultForeignKey!=null && cuenta_pagar_detalle_control.idejercicioDefaultForeignKey>-1) {
					idActual=cuenta_pagar_detalle_control.idejercicioDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablaejercicioFK(cuenta_pagar_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablaejercicioFK(cuenta_pagar_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(cuenta_pagar_detalle_control.idperiodoDefaultForeignKey!=null && cuenta_pagar_detalle_control.idperiodoDefaultForeignKey>-1) {
					idActual=cuenta_pagar_detalle_control.idperiodoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablaperiodoFK(cuenta_pagar_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablaperiodoFK(cuenta_pagar_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(cuenta_pagar_detalle_control.idusuarioDefaultForeignKey!=null && cuenta_pagar_detalle_control.idusuarioDefaultForeignKey>-1) {
					idActual=cuenta_pagar_detalle_control.idusuarioDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablausuarioFK(cuenta_pagar_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablausuarioFK(cuenta_pagar_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(cuenta_pagar_detalle_control.idcuenta_pagarDefaultForeignKey!=null && cuenta_pagar_detalle_control.idcuenta_pagarDefaultForeignKey>-1) {
					idActual=cuenta_pagar_detalle_control.idcuenta_pagarDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablacuenta_pagarFK(cuenta_pagar_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablacuenta_pagarFK(cuenta_pagar_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(cuenta_pagar_detalle_control.idestadoDefaultForeignKey!=null && cuenta_pagar_detalle_control.idestadoDefaultForeignKey>-1) {
					idActual=cuenta_pagar_detalle_control.idestadoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablaestadoFK(cuenta_pagar_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						cuenta_pagar_detalle_webcontrol1.cargarComboEditarTablaestadoFK(cuenta_pagar_detalle_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatoscuenta_pagar_detalle").validate(json_rules);
