...
//var imagen_documento_cuenta_pagarFuncionGeneral= function () {

class imagen_documento_cuenta_pagar_funcion {
...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(imagen_documento_cuenta_pagar_constante1.STR_RELATIVE_PATH,"imagen_documento_cuenta_pagar");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(imagen_documento_cuenta_pagar_constante1.STR_RELATIVE_PATH,imagen_documento_cuenta_pagar_constante1.STR_NOMBRE_OPCION,"imagen_documento_cuenta_pagar");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(imagen_documento_cuenta_pagar_constante1.STR_RELATIVE_PATH,imagen_documento_cuenta_pagar_constante1.STR_NOMBRE_OPCION);
	}
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(imagen_documento_cuenta_pagar_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(imagen_documento_cuenta_pagar_constante1.STR_RELATIVE_PATH,"imagen_documento_cuenta_pagar");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(imagen_documento_cuenta_pagar_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(imagen_documento_cuenta_pagar_constante1.STR_RELATIVE_PATH,"imagen_documento_cuenta_pagar");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(imagen_documento_cuenta_pagar_constante1.STR_RELATIVE_PATH,"imagen_documento_cuenta_pagar");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"imagen_documento_cuenta_pagar");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(imagen_documento_cuenta_pagar_constante1.BIT_CON_PAGINA_FORM==true && imagen_documento_cuenta_pagar_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"imagen_documento_cuenta_pagar");
	}
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"imagen_documento_cuenta_pagar");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"imagen_documento_cuenta_pagar");
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(imagen_documento_cuenta_pagar_control,imagen_documento_cuenta_pagar_webcontrol1,imagen_documento_cuenta_pagar_constante1) {
		
		var strSuf=imagen_documento_cuenta_pagar_constante1.STR_SUFIJO;
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(imagen_documento_cuenta_pagar_control.iddocumento_cuenta_pagarDefaultForeignKey!=null && imagen_documento_cuenta_pagar_control.iddocumento_cuenta_pagarDefaultForeignKey>-1) {
					idActual=imagen_documento_cuenta_pagar_control.iddocumento_cuenta_pagarDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					imagen_documento_cuenta_pagar_webcontrol1.cargarComboEditarTabladocumento_cuenta_pagarFK(imagen_documento_cuenta_pagar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						imagen_documento_cuenta_pagar_webcontrol1.cargarComboEditarTabladocumento_cuenta_pagarFK(imagen_documento_cuenta_pagar_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatosimagen_documento_cuenta_pagar").validate(json_rules);
