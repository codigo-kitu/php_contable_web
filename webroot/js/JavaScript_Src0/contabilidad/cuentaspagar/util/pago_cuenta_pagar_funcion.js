...
//var pago_cuenta_pagarFuncionGeneral= function () {

class pago_cuenta_pagar_funcion {
...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(pago_cuenta_pagar_constante1.STR_RELATIVE_PATH,"pago_cuenta_pagar");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(pago_cuenta_pagar_constante1.STR_RELATIVE_PATH,pago_cuenta_pagar_constante1.STR_NOMBRE_OPCION,"pago_cuenta_pagar");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(pago_cuenta_pagar_constante1.STR_RELATIVE_PATH,pago_cuenta_pagar_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Clic-Cancelar -------------------
	...
	cancelarControles() {
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientopago_cuenta_pagar.txtdescuento);
		funcionGeneral.setEmptyControl(document.frmMantenimientopago_cuenta_pagar.txtretencion);
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(pago_cuenta_pagar_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(pago_cuenta_pagar_constante1.STR_RELATIVE_PATH,"pago_cuenta_pagar");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(pago_cuenta_pagar_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(pago_cuenta_pagar_constante1.STR_RELATIVE_PATH,"pago_cuenta_pagar");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(pago_cuenta_pagar_constante1.STR_RELATIVE_PATH,"pago_cuenta_pagar");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"pago_cuenta_pagar");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(pago_cuenta_pagar_constante1.BIT_CON_PAGINA_FORM==true && pago_cuenta_pagar_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
		...
		*/
		...
		if(pago_cuenta_pagar_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				"form_pago_cuenta_pagar-descuento": {
					required:true,
					number:true
				},
					
				"form_pago_cuenta_pagar-retencion": {
					required:true,
					number:true
				},
				...
				messages: {
					...
					"form_pago_cuenta_pagar-referencia": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					...
					"form_pago_cuenta_pagar-descuento": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_pago_cuenta_pagar-retencion": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"pago_cuenta_pagar");
	}
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientopago_cuenta_pagar.txtdescuento,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientopago_cuenta_pagar.txtretencion,false);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientopago_cuenta_pagar.txtdescuento,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientopago_cuenta_pagar.txtretencion,true);
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"pago_cuenta_pagar");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"pago_cuenta_pagar");
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(pago_cuenta_pagar_control,pago_cuenta_pagar_webcontrol1,pago_cuenta_pagar_constante1) {
		
		var strSuf=pago_cuenta_pagar_constante1.STR_SUFIJO;
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(pago_cuenta_pagar_control.idempresaDefaultForeignKey!=null && pago_cuenta_pagar_control.idempresaDefaultForeignKey>-1) {
					idActual=pago_cuenta_pagar_control.idempresaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					pago_cuenta_pagar_webcontrol1.cargarComboEditarTablaempresaFK(pago_cuenta_pagar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						pago_cuenta_pagar_webcontrol1.cargarComboEditarTablaempresaFK(pago_cuenta_pagar_control,control_name,idActual,true);
					}
				});
				...
				if(pago_cuenta_pagar_control.idsucursalDefaultForeignKey!=null && pago_cuenta_pagar_control.idsucursalDefaultForeignKey>-1) {
					idActual=pago_cuenta_pagar_control.idsucursalDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					pago_cuenta_pagar_webcontrol1.cargarComboEditarTablasucursalFK(pago_cuenta_pagar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						pago_cuenta_pagar_webcontrol1.cargarComboEditarTablasucursalFK(pago_cuenta_pagar_control,control_name,idActual,true);
					}
				});
				...
				if(pago_cuenta_pagar_control.idejercicioDefaultForeignKey!=null && pago_cuenta_pagar_control.idejercicioDefaultForeignKey>-1) {
					idActual=pago_cuenta_pagar_control.idejercicioDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					pago_cuenta_pagar_webcontrol1.cargarComboEditarTablaejercicioFK(pago_cuenta_pagar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						pago_cuenta_pagar_webcontrol1.cargarComboEditarTablaejercicioFK(pago_cuenta_pagar_control,control_name,idActual,true);
					}
				});
				...
				if(pago_cuenta_pagar_control.idperiodoDefaultForeignKey!=null && pago_cuenta_pagar_control.idperiodoDefaultForeignKey>-1) {
					idActual=pago_cuenta_pagar_control.idperiodoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					pago_cuenta_pagar_webcontrol1.cargarComboEditarTablaperiodoFK(pago_cuenta_pagar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						pago_cuenta_pagar_webcontrol1.cargarComboEditarTablaperiodoFK(pago_cuenta_pagar_control,control_name,idActual,true);
					}
				});
				...
				if(pago_cuenta_pagar_control.idusuarioDefaultForeignKey!=null && pago_cuenta_pagar_control.idusuarioDefaultForeignKey>-1) {
					idActual=pago_cuenta_pagar_control.idusuarioDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					pago_cuenta_pagar_webcontrol1.cargarComboEditarTablausuarioFK(pago_cuenta_pagar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						pago_cuenta_pagar_webcontrol1.cargarComboEditarTablausuarioFK(pago_cuenta_pagar_control,control_name,idActual,true);
					}
				});
				...
				if(pago_cuenta_pagar_control.idcuenta_pagarDefaultForeignKey!=null && pago_cuenta_pagar_control.idcuenta_pagarDefaultForeignKey>-1) {
					idActual=pago_cuenta_pagar_control.idcuenta_pagarDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					pago_cuenta_pagar_webcontrol1.cargarComboEditarTablacuenta_pagarFK(pago_cuenta_pagar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						pago_cuenta_pagar_webcontrol1.cargarComboEditarTablacuenta_pagarFK(pago_cuenta_pagar_control,control_name,idActual,true);
					}
				});
				...
				if(pago_cuenta_pagar_control.idforma_pago_proveedorDefaultForeignKey!=null && pago_cuenta_pagar_control.idforma_pago_proveedorDefaultForeignKey>-1) {
					idActual=pago_cuenta_pagar_control.idforma_pago_proveedorDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					pago_cuenta_pagar_webcontrol1.cargarComboEditarTablaforma_pago_proveedorFK(pago_cuenta_pagar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						pago_cuenta_pagar_webcontrol1.cargarComboEditarTablaforma_pago_proveedorFK(pago_cuenta_pagar_control,control_name,idActual,true);
					}
				});
				...
				if(pago_cuenta_pagar_control.idestadoDefaultForeignKey!=null && pago_cuenta_pagar_control.idestadoDefaultForeignKey>-1) {
					idActual=pago_cuenta_pagar_control.idestadoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					pago_cuenta_pagar_webcontrol1.cargarComboEditarTablaestadoFK(pago_cuenta_pagar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						pago_cuenta_pagar_webcontrol1.cargarComboEditarTablaestadoFK(pago_cuenta_pagar_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatospago_cuenta_pagar").validate(json_rules);
