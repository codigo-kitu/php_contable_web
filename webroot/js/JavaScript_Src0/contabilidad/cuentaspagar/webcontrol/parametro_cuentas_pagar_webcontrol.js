...
class parametro_cuentas_pagar_webcontrol extends parametro_cuentas_pagar_webcontrol_add {
	...
	actualizarVariablesPagina(parametro_cuentas_pagar_control) {
		...
		if(parametro_cuentas_pagar_control.action=="index" || parametro_cuentas_pagar_control.action=="load") {
		...
		} else if(parametro_cuentas_pagar_control.action=="indexRecargarRelacionado") {
			this.actualizarVariablesPaginaAccionIndexRecargarRelacionado(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="recargarInformacion") {
			this.actualizarVariablesPaginaAccionRecargarInformacion(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="buscarPorIdGeneral") {
			this.actualizarVariablesPaginaAccionBuscarPorIdGeneral(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="anteriores") {
			this.actualizarVariablesPaginaAccionAnteriores(parametro_cuentas_pagar_control);
			
		} else if(parametro_cuentas_pagar_control.action=="siguientes") {
			this.actualizarVariablesPaginaAccionSiguientes(parametro_cuentas_pagar_control);
			
		} else if(parametro_cuentas_pagar_control.action=="recargarUltimaInformacion") {
			this.actualizarVariablesPaginaAccionRecargarUltimaInformacion(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="seleccionarLoteFk") {
			this.actualizarVariablesPaginaAccionSeleccionarLoteFk(parametro_cuentas_pagar_control);
		...
		} else if(parametro_cuentas_pagar_control.action=="guardarCambios") {
			this.actualizarVariablesPaginaAccionGuardarCambios(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="duplicar") {
			this.actualizarVariablesPaginaAccionDuplicar(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="copiar") {
			this.actualizarVariablesPaginaAccionCopiar(parametro_cuentas_pagar_control);
		...
		} else if(parametro_cuentas_pagar_control.action=="seleccionarActual") {
			this.actualizarVariablesPaginaAccionSeleccionarActual(parametro_cuentas_pagar_control);
		...
		} else if(parametro_cuentas_pagar_control.action=="seleccionarActualAbrirPaginaForm") {
			this.actualizarVariablesPaginaAccionSeleccionarActualAbrirPaginaForm(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="eliminarCascada") {
			this.actualizarVariablesPaginaAccionEliminarCascada(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="eliminarTabla") {
			this.actualizarVariablesPaginaAccionEliminarTabla(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="quitarElementosTabla") {
			this.actualizarVariablesPaginaAccionQuitarElementosTabla(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="nuevoPreparar") {
			this.actualizarVariablesPaginaAccionNuevoPreparar(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="nuevoTablaPreparar") {
			this.actualizarVariablesPaginaAccionNuevoTablaPreparar(parametro_cuentas_pagar_control);
		...
		} else if(parametro_cuentas_pagar_control.action=="nuevoPrepararAbrirPaginaForm") {
			this.actualizarVariablesPaginaAccionNuevoPrepararAbrirPaginaForm(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="editarTablaDatos") {
			this.actualizarVariablesPaginaAccionEditarTablaDatos(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="generarHtmlReporte") {
			this.actualizarVariablesPaginaAccionGenerarHtmlReporte(parametro_cuentas_pagar_control);
		
		} else if(parametro_cuentas_pagar_control.action=="generarHtmlFormReporte") {
			this.actualizarVariablesPaginaAccionGenerarHtmlFormReporte(parametro_cuentas_pagar_control);		
		...
		} else if(parametro_cuentas_pagar_control.action=="recargarFomularioGeneral") {
			...
			if(parametro_cuentas_pagar_control.bitEsEjecutarFuncionJavaScript==true){
				this.actualizarPaginaEjecutarJavaScript(parametro_cuentas_pagar_control);
			}
			...
			if(parametro_cuentas_pagar_control.paramDivSeccion.bitDivsEsCargarReporteAuxiliarAjaxWebPart==true) {				
				this.actualizarPaginaImprimir(parametro_cuentas_pagar_control);
			}
...
//Funciones Manejadores Accion
	...
	actualizarVariablesPaginaAccionIndexRecargarRelacionado(parametro_cuentas_pagar_control) {
	...
	actualizarVariablesPaginaAccionRecargarInformacion(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);
	}
	
	actualizarVariablesPaginaAccionBuscarPorIdGeneral(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);
	}
	
	actualizarVariablesPaginaAccionAnteriores(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);
	}
	
	actualizarVariablesPaginaAccionSiguientes(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);
	}
	
	actualizarVariablesPaginaAccionRecargarUltimaInformacion(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);
	}
	
	actualizarVariablesPaginaAccionSeleccionarLoteFk(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);
	}
	...
	actualizarVariablesPaginaAccionGuardarCambios(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);		
		this.actualizarPaginaFormulario(parametro_cuentas_pagar_control);						
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);		
		this.actualizarPaginaAreaMantenimiento(parametro_cuentas_pagar_control);
	...
	actualizarVariablesPaginaAccionDuplicar(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);		
		this.actualizarPaginaFormulario(parametro_cuentas_pagar_control);						
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);		
		this.actualizarPaginaAreaMantenimiento(parametro_cuentas_pagar_control);
	...
	actualizarVariablesPaginaAccionCopiar(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);		
		this.actualizarPaginaFormulario(parametro_cuentas_pagar_control);						
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);		
		this.actualizarPaginaAreaMantenimiento(parametro_cuentas_pagar_control);
	...
	actualizarVariablesPaginaAccionSeleccionarActual(parametro_cuentas_pagar_control) {
		this.actualizarPaginaFormulario(parametro_cuentas_pagar_control);						
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);		
		this.actualizarPaginaAreaMantenimiento(parametro_cuentas_pagar_control);
	}
	...
	actualizarVariablesPaginaAccionSeleccionarActualAbrirPaginaForm(parametro_cuentas_pagar_control) {
		this.actualizarPaginaAbrirLink(parametro_cuentas_pagar_control);
	}
		
	actualizarVariablesPaginaAccionEliminarCascada(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);				
		this.actualizarPaginaFormulario(parametro_cuentas_pagar_control);						
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);		
		this.actualizarPaginaAreaMantenimiento(parametro_cuentas_pagar_control);		
	...
	actualizarVariablesPaginaAccionEliminarTabla(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);
		this.actualizarPaginaFormulario(parametro_cuentas_pagar_control);
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);		
		this.actualizarPaginaAreaMantenimiento(parametro_cuentas_pagar_control);
	...
	actualizarVariablesPaginaAccionQuitarElementosTabla(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);
		this.actualizarPaginaFormulario(parametro_cuentas_pagar_control);
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);		
		this.actualizarPaginaAreaMantenimiento(parametro_cuentas_pagar_control);
	...
	actualizarVariablesPaginaAccionNuevoPreparar(parametro_cuentas_pagar_control) {
		this.actualizarPaginaFormulario(parametro_cuentas_pagar_control);
	...
	actualizarVariablesPaginaAccionNuevoTablaPreparar(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);
		this.actualizarPaginaFormulario(parametro_cuentas_pagar_control);
		this.onLoadCombosDefectoFK(parametro_cuentas_pagar_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);		
	...
	actualizarVariablesPaginaAccionNuevoPrepararAbrirPaginaForm(parametro_cuentas_pagar_control) {
		this.actualizarPaginaAbrirLink(parametro_cuentas_pagar_control);
	}
		
	actualizarVariablesPaginaAccionEditarTablaDatos(parametro_cuentas_pagar_control) {
		this.actualizarPaginaTablaDatos(parametro_cuentas_pagar_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(parametro_cuentas_pagar_control);
	}
		
	actualizarVariablesPaginaAccionGenerarHtmlReporte(parametro_cuentas_pagar_control) {
		this.actualizarPaginaImprimir(parametro_cuentas_pagar_control);
	}
	
	
	actualizarVariablesPaginaAccionGenerarHtmlFormReporte(parametro_cuentas_pagar_control) {
		this.actualizarPaginaImprimir(parametro_cuentas_pagar_control);
	}	
...
//Funciones Auxiliares
	...
	actualizarPaginaTablaDatosAuxiliar(parametro_cuentas_pagar_control) {
		if(parametro_cuentas_pagar_funcion1.esPaginaForm()==true) {
	...
	actualizarPaginaEjecutarJavaScript(parametro_cuentas_pagar_control) {
		eval(parametro_cuentas_pagar_control.strFuncionJs);
	}
	
	actualizarPaginaMensajePantalla(parametro_cuentas_pagar_control, mostrar) {
		
		if(mostrar==true) {
			parametro_cuentas_pagar_funcion1.resaltarRestaurarDivsPagina(false);
			
			if(jQuery("#ParamsPostAccion-chbPostAccionSinCerrar").prop('checked')==false
				&& jQuery("#ParamsPostAccion-chbPostAccionNuevo").prop('checked')==false) {		
					
				parametro_cuentas_pagar_funcion1.resaltarRestaurarDivMantenimiento(false);
			}			
	...
	actualizarPaginaImprimir(parametro_cuentas_pagar_control) {
	
		funcionGeneral.printWebPartPage("parametro_cuentas_pagar",parametro_cuentas_pagar_control.htmlTablaReporteAuxiliars);			
			
		//jQuery("#divTablaDatosReporteAuxiliarparametro_cuentas_pagarsAjaxWebPart").html(parametro_cuentas_pagar_control.htmlTablaReporteAuxiliars);						
		//funcionGeneral.printWebPartPage("parametro_cuentas_pagar",jQuery("#divTablaDatosReporteAuxiliarparametro_cuentas_pagarsAjaxWebPart").html());			
	}
	...
	actualizarPaginaCargaGeneral(parametro_cuentas_pagar_control) {
		...
		if(parametro_cuentas_pagar_constante1.STR_ES_RELACIONADO=="false") {
			...
			if(jQuery("#divRecargarInformacion").attr("style")!=parametro_cuentas_pagar_control.strPermiteRecargarInformacion) {
				jQuery("#divRecargarInformacion").attr("style",parametro_cuentas_pagar_control.strPermiteRecargarInformacion);		
			}
		}
	}
	
	actualizarPaginaTablaDatos(parametro_cuentas_pagar_control) {
		jQuery("#divTablaDatosparametro_cuentas_pagarsAjaxWebPart").html(parametro_cuentas_pagar_control.htmlTabla);						
			
		if(constantes.STR_TIPO_TABLA=="datatables") {
			var configDataTable=null;
			var tblTablaDatosparametro_cuentas_pagars=null;
			...
			tblTablaDatosparametro_cuentas_pagars=jQuery("#tblTablaDatosparametro_cuentas_pagars").dataTable(configDataTable);
				
			funcionGeneralJQuery.setConfigDataTableJQuery("parametro_cuentas_pagar",configDataTable);
		}
			
		jQuery("#ParamsBuscar-chbConEditar").prop('checked',parametro_cuentas_pagar_control.bitConEditar);
			
		if(jQuery("#ParamsBuscar-chbConEditar").prop('checked')==true) {
			parametro_cuentas_pagar_webcontrol1.registrarControlesTableEdition(parametro_cuentas_pagar_control);
				
			//DESHABILITA-->PUEDE USARSE PARA MOSTRAR NUEVAMENTE TABLA NORMAL
			//jQuery("#ParamsBuscar-chbConEditar").prop('checked',false);
		}
						
		parametro_cuentas_pagar_webcontrol1.registrarTablaAcciones();
	}
	
	actualizarPaginaTablaFilaActual(parametro_cuentas_pagar_control) {
		//ACTUALIZAR FILA TABLA, EVENTOS EN TABLA
		
		if(parametro_cuentas_pagar_control.parametro_cuentas_pagarActual!=null) {//form
			
			this.actualizarCamposFilaTabla(parametro_cuentas_pagar_control);			
		}
	}
	...
	actualizarPaginaAreaBusquedas(parametro_cuentas_pagar_control) {
		jQuery("#divBusquedaparametro_cuentas_pagarAjaxWebPart").css("display",parametro_cuentas_pagar_control.strPermisoBusqueda);
		jQuery("#trparametro_cuentas_pagarCabeceraBusquedas").css("display",parametro_cuentas_pagar_control.strPermisoBusqueda);
		jQuery("#trBusquedaparametro_cuentas_pagar").css("display",parametro_cuentas_pagar_control.strPermisoBusqueda);
			
		//CARGAR ORDER BY
		if(parametro_cuentas_pagar_control.htmlTablaOrderBy!=null
			&& parametro_cuentas_pagar_control.htmlTablaOrderBy!='') {
			
			jQuery("#divOrderByparametro_cuentas_pagarAjaxWebPart").html(parametro_cuentas_pagar_control.htmlTablaOrderBy);
				
			//NO TIENE, SON PARAMETROS EXTRA QUE SE ENVIAN COMO PARAMETROS
			//parametro_cuentas_pagar_webcontrol1.registrarOrderByActions();
			
		}
			
		if(parametro_cuentas_pagar_control.htmlTablaOrderByRel!=null
			&& parametro_cuentas_pagar_control.htmlTablaOrderByRel!='') {
				
			jQuery("#divOrderByRelparametro_cuentas_pagarAjaxWebPart").html(parametro_cuentas_pagar_control.htmlTablaOrderByRel);
		...
		if(parametro_cuentas_pagar_constante1.STR_ES_RELACIONADO=="true") {				
			jQuery("#divBusquedaparametro_cuentas_pagarAjaxWebPart").css("display","none");
			jQuery("#trparametro_cuentas_pagarCabeceraBusquedas").css("display","none");
			jQuery("#trBusquedaparametro_cuentas_pagar").css("display","none");			
		}
	}
	...
	actualizarPaginaAreaAuxiliarResumen(parametro_cuentas_pagar_control) {
		jQuery("#divResumenparametro_cuentas_pagarActualAjaxWebPart").html(parametro_cuentas_pagar_control.strAuxiliarHtmlReturn1);
	}
	
	actualizarPaginaAreaAuxiliarAccionesRelaciones(parametro_cuentas_pagar_control) {
		jQuery("#divAccionesRelacionesparametro_cuentas_pagarAjaxWebPart").html(parametro_cuentas_pagar_control.htmlTablaAccionesRelaciones);
			
		parametro_cuentas_pagar_webcontrol1.registrarDivAccionesRelaciones();
	}
	
	actualizarPaginaAreaAuxiliarBusquedas(parametro_cuentas_pagar_control) {
		//SI USA TABS, NO SE DEBE UTILIZAR			
		this.actualizarCssBusquedas(parametro_cuentas_pagar_control);
	}
	
/*---------------------------------- AREA:BUSQUEDAS ---------------------------*/

	actualizarCssBusquedas(parametro_cuentas_pagar_control) {
		
	}
	
	recargarUltimaInformacionDesdeHijo() {
		this.recargarUltimaInformacionparametro_cuentas_pagar();	
	}
	
	recargarUltimaInformacion() {		
		funcionGeneralEventoJQuery.setPageRecargarUltimaInformacionPost("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);							
	}	
	
	buscarPorIdGeneral(id) {//alert(strParametros);
		funcionGeneralEventoJQuery.setFuncionBuscarPorId("parametro_cuentas_pagar",id,"cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1,parametro_cuentas_pagar_constante1);		
	}
...
/*---------------------------------- AREA:TABLA ---------------------------*/
	...
	actualizarCamposFilaTabla(parametro_cuentas_pagar_control) {
		var i=0;
		
		i=parametro_cuentas_pagar_control.idFilaTablaActual;
		
		jQuery("#t-id_"+i+"").val(parametro_cuentas_pagar_control.parametro_cuentas_pagarActual.id);
		jQuery("#t-version_row_"+i+"").val(parametro_cuentas_pagar_control.parametro_cuentas_pagarActual.versionRow);
		jQuery("#t-cel_"+i+"_2").val(parametro_cuentas_pagar_control.parametro_cuentas_pagarActual.numero_cuenta_pagar);
		jQuery("#t-cel_"+i+"_3").val(parametro_cuentas_pagar_control.parametro_cuentas_pagarActual.numero_detalle);
		jQuery("#t-cel_"+i+"_4").val(parametro_cuentas_pagar_control.parametro_cuentas_pagarActual.numero_pago);
		jQuery("#t-cel_"+i+"_5").val(parametro_cuentas_pagar_control.parametro_cuentas_pagarActual.numero_credito);
	}
	...
	registrarTablaAcciones() {
		...
		if(parametro_cuentas_pagar_constante1.STR_ES_BUSQUEDA=="false") {	
			
			funcionGeneralEventoJQuery.setImagenSeleccionarClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1,parametro_cuentas_pagar_constante1);
			
			//ELIMINAR TABLA
			funcionGeneralEventoJQuery.setImagenEliminarTablaClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			
			
			
		} else {
			//alert("ES BUSQUEDA");			
			funcionGeneralEventoJQuery.setImagenSeleccionarBusquedaClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
		}
	...
	registrarControlesTableEdition(parametro_cuentas_pagar_control) {
		parametro_cuentas_pagar_funcion1.registrarControlesTableValidacionEdition(parametro_cuentas_pagar_control,parametro_cuentas_pagar_webcontrol1,parametro_cuentas_pagar_constante1);			
	}

/*---------------------------------- AREA:FK ---------------------------*/
	
	manejarSeleccionarLoteFk(strParametros) {//alert(strParametros);
		funcionGeneralEventoJQuery.setFuncionPadreDesdeBotonSeleccionarLoteFkClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1,parametro_cuentas_pagarConstante,strParametros);
		
		//parametro_cuentas_pagar_funcion1.cancelarOnComplete();
	}	
...
/*---------------------------------- AREA:AUXILIARES ---------------------------*/
	...
	registrarAccionesEventos() {	
		...
		jQuery(document).ready(function() {
			...
			funcionGeneralEventoJQuery.setBotonGuardarCambiosClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonSeleccionarLoteFkClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1,parametro_cuentas_pagar_constante1);
			
			funcionGeneralEventoJQuery.setBotonAnterioresClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonSiguientesClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonNuevoPrepararClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1,parametro_cuentas_pagar_constante1);
			
			funcionGeneralEventoJQuery.setBotonNuevoTablaPrepararClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonGuardarCambiosFormularioClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1,parametro_cuentas_pagar_constante1);
			
			funcionGeneralEventoJQuery.setBotonDuplicarClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonCopiarClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			...
			funcionGeneralEventoJQuery.setImagenNuevoPrepararRegistreseClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonRecargarInformacionClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
						
			funcionGeneralEventoJQuery.setBotonOrderByClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			...
			funcionGeneralEventoJQuery.setImagenCerrarSesionClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);			
			...
			funcionGeneralEventoJQuery.setBotonImprimirPaginaClic("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			...
			//TIPOS COLUMNAS
			funcionGeneralEventoJQuery.setComboTiposColumnas(parametro_cuentas_pagar_funcion1);						
			//TIPOS COLUMNAS
			
			funcionGeneralEventoJQuery.setCheckSeleccionarTodosChange("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			
			funcionGeneralEventoJQuery.setCheckConAltoMaximoTablaChange("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);
			...
			funcionGeneralEventoJQuery.setCheckConEditarChange("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1);			
			...
			if(parametro_cuentas_pagar_constante1.BIT_ES_PAGINA_PRINCIPAL==true) { // NO FORM
				//LLAMADO EN ONLOADWINDOW	
				funcionGeneralEventoJQuery.setWindowUnload("parametro_cuentas_pagar","cuentaspagar","",parametro_cuentas_pagar_funcion1,parametro_cuentas_pagar_webcontrol1,window);
			}
		});
		} else {
...
/*---------------------------------- AREA:PAGINA ---------------------------*/
	...
	actualizarCssBotonesPagina(parametro_cuentas_pagar_control) {
		...
		jQuery("#tdGenerarReporteparametro_cuentas_pagar").css("display",parametro_cuentas_pagar_control.strPermisoReporte);			
		jQuery("#tdMostrarTodosparametro_cuentas_pagar").attr("style",parametro_cuentas_pagar_control.strPermisoMostrarTodos);
		
		if(parametro_cuentas_pagar_control.strPermisoNuevo!=null) {
			jQuery("#tdparametro_cuentas_pagarNuevo").css("display",parametro_cuentas_pagar_control.strPermisoNuevo);
			jQuery("#tdparametro_cuentas_pagarNuevoToolBar").css("display",parametro_cuentas_pagar_control.strPermisoNuevo.replace("row","cell"));			
			jQuery("#tdparametro_cuentas_pagarDuplicar").css("display",parametro_cuentas_pagar_control.strPermisoNuevo.replace("row","cell"));
			jQuery("#tdparametro_cuentas_pagarDuplicarToolBar").css("display",parametro_cuentas_pagar_control.strPermisoNuevo.replace("row","cell"));
			jQuery("#tdparametro_cuentas_pagarNuevoGuardarCambios").css("display",parametro_cuentas_pagar_control.strPermisoNuevo);
			jQuery("#tdparametro_cuentas_pagarNuevoGuardarCambiosToolBar").css("display",parametro_cuentas_pagar_control.strPermisoNuevo.replace("row","cell"));
		}
		...
		if(parametro_cuentas_pagar_control.strPermisoActualizar!=null) {
			...
			jQuery("#tdparametro_cuentas_pagarCopiar").css("display",parametro_cuentas_pagar_control.strPermisoActualizar.replace("row","cell"));
			jQuery("#tdparametro_cuentas_pagarCopiarToolBar").css("display",parametro_cuentas_pagar_control.strPermisoActualizar.replace("row","cell"));
			jQuery("#tdparametro_cuentas_pagarConEditar").css("display",parametro_cuentas_pagar_control.strPermisoActualizar);
		}
		...
		jQuery("#tdparametro_cuentas_pagarGuardarCambios").css("display",parametro_cuentas_pagar_control.strPermisoGuardar.replace("row","cell"));
		jQuery("#tdparametro_cuentas_pagarGuardarCambiosToolBar").css("display",parametro_cuentas_pagar_control.strPermisoGuardar.replace("row","cell"));
