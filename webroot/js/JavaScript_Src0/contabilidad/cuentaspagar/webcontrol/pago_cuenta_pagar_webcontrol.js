...
class pago_cuenta_pagar_webcontrol extends pago_cuenta_pagar_webcontrol_add {
	...
	actualizarVariablesPagina(pago_cuenta_pagar_control) {
		...
		if(pago_cuenta_pagar_control.action=="index" || pago_cuenta_pagar_control.action=="load") {
		...
		} else if(pago_cuenta_pagar_control.action=="recargarFomularioGeneral") {
			...
			alert(pago_cuenta_pagar_control.action + " Revisar Manejo");
			
			if(pago_cuenta_pagar_control.bitEsAbrirVentanaAuxiliarUrl==true){
			...
			if(pago_cuenta_pagar_control.bitEsEjecutarFuncionJavaScript==true){
				this.actualizarPaginaEjecutarJavaScript(pago_cuenta_pagar_control);
			}
			...
			if(pago_cuenta_pagar_control.paramDivSeccion.bitDivsEsCargarGeneralAjaxWebPart==true) {		
				this.actualizarPaginaCargaGeneral(pago_cuenta_pagar_control);	
			}
			
			if(pago_cuenta_pagar_control.paramDivSeccion.bitDivEsCargarAjaxWebPart==true) {
				this.actualizarPaginaTablaDatos(pago_cuenta_pagar_control);
			}
			
			if(pago_cuenta_pagar_control.paramDivSeccion.bitDivsEsCargarMostrarAjaxWebPart==true) {		
			...
			if(pago_cuenta_pagar_control.paramDivSeccion.bitDivsEsCargarMostrarSoloBusquedasAjaxWebPart==true) {		
				this.actualizarPaginaAreaBusquedas(pago_cuenta_pagar_control);	
			}
			
			if(pago_cuenta_pagar_control.paramDivSeccion.bitDivsEsCargarMostrarSoloMantenimientosAjaxWebPart==true) {		
			...
			if(pago_cuenta_pagar_control.paramDivSeccion.bitDivEsCargarMantenimientosAjaxWebPart==true) {				
				this.actualizarPaginaTablaFilaActual(pago_cuenta_pagar_control);			
			}
			
			if(pago_cuenta_pagar_control.paramDivSeccion.bitDivsEsCargarReporteAuxiliarAjaxWebPart==true) {				
				this.actualizarPaginaImprimir(pago_cuenta_pagar_control);
			}
			
			
			if(pago_cuenta_pagar_control.paramDivSeccion.bitDivsEsCargarMostrarBusquedasAjaxWebPart==true) {
				this.actualizarPaginaAreaAuxiliarBusquedas(pago_cuenta_pagar_control);
			}
			
			if(pago_cuenta_pagar_control.paramDivSeccion.bitDivsEsCargarResumenAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarResumen(pago_cuenta_pagar_control);
			}				
			
			if(pago_cuenta_pagar_control.paramDivSeccion.bitDivsEsCargarAccionesRelacionesAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarAccionesRelaciones(pago_cuenta_pagar_control);
			}
			
			if(pago_cuenta_pagar_control.usuarioActual!=null && pago_cuenta_pagar_control.usuarioActual.field_strUserName!=null &&
			pago_cuenta_pagar_control.usuarioActual.field_strUserName!=undefined ) {
				
				this.actualizarPaginaUsuarioInvitado(pago_cuenta_pagar_control);			
			}
		}
...
//Funciones Auxiliares
	...
	actualizarPaginaTablaDatosAuxiliar(pago_cuenta_pagar_control) {
		if(pago_cuenta_pagar_funcion1.esPaginaForm()==true) {
	...
	actualizarPaginaEjecutarJavaScript(pago_cuenta_pagar_control) {
		eval(pago_cuenta_pagar_control.strFuncionJs);
	}
	
	actualizarPaginaMensajePantalla(pago_cuenta_pagar_control, mostrar) {
		
		if(mostrar==true) {
			pago_cuenta_pagar_funcion1.resaltarRestaurarDivsPagina(false);
			
			if(jQuery("#ParamsPostAccion-chbPostAccionSinCerrar").prop('checked')==false
				&& jQuery("#ParamsPostAccion-chbPostAccionNuevo").prop('checked')==false) {		
					
				pago_cuenta_pagar_funcion1.resaltarRestaurarDivMantenimiento(false);
			}			
	...
	actualizarPaginaImprimir(pago_cuenta_pagar_control) {
	
		funcionGeneral.printWebPartPage("pago_cuenta_pagar",pago_cuenta_pagar_control.htmlTablaReporteAuxiliars);			
			
		//jQuery("#divTablaDatosReporteAuxiliarpago_cuenta_pagarsAjaxWebPart").html(pago_cuenta_pagar_control.htmlTablaReporteAuxiliars);						
		//funcionGeneral.printWebPartPage("pago_cuenta_pagar",jQuery("#divTablaDatosReporteAuxiliarpago_cuenta_pagarsAjaxWebPart").html());			
	}
...
/*---------------------------------- AREA:FORMULARIO ---------------------------*/
	...
	actualizarCamposFormulario(pago_cuenta_pagar_control) {
		...
		jQuery("#form"+pago_cuenta_pagar_constante1.STR_SUFIJO+"-descuento").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.descuento);
		jQuery("#form"+pago_cuenta_pagar_constante1.STR_SUFIJO+"-retencion").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.retencion);
	...
	actualizarSpanMensajesCampos(pago_cuenta_pagar_control) {
		...
		jQuery("#spanstrMensajedescuento").text(pago_cuenta_pagar_control.strMensajedescuento);		
		jQuery("#spanstrMensajeretencion").text(pago_cuenta_pagar_control.strMensajeretencion);		
...
/*---------------------------------- AREA:TABLA ---------------------------*/
	...
	actualizarCamposFilaTabla(pago_cuenta_pagar_control) {
		...
		if(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_empresa!=null && pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_2").val() != pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_empresa) {
				jQuery("#t-cel_"+i+"_2").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_sucursal!=null && pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_3").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_ejercicio!=null && pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_4").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_periodo!=null && pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_periodo) {
				jQuery("#t-cel_"+i+"_5").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_usuario!=null && pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_usuario) {
				jQuery("#t-cel_"+i+"_6").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_cuenta_pagar!=null && pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_cuenta_pagar>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_cuenta_pagar) {
				jQuery("#t-cel_"+i+"_7").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_cuenta_pagar).trigger("change");
			}
		} else { 
		...
		if(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_forma_pago_proveedor!=null && pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_forma_pago_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_forma_pago_proveedor) {
				jQuery("#t-cel_"+i+"_8").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_forma_pago_proveedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_9").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.numero);
		jQuery("#t-cel_"+i+"_10").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.fecha_emision);
		jQuery("#t-cel_"+i+"_11").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.fecha_vence);
		jQuery("#t-cel_"+i+"_12").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.referencia);
		...
		jQuery("#t-cel_"+i+"_15").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.descuento);
		jQuery("#t-cel_"+i+"_16").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.retencion);
		jQuery("#t-cel_"+i+"_17").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.descripcion);
		
		if(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_estado!=null && pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_18").val() != pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_estado) {
				jQuery("#t-cel_"+i+"_18").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_19").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.debito);
		jQuery("#t-cel_"+i+"_20").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.credito);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/
	...
	cargarCombosestadosFK(pago_cuenta_pagar_control) {
		...
		if(pago_cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+pago_cuenta_pagar_control.idFilaTablaActual+"_18",pago_cuenta_pagar_control.estadosFK);
		}
...
/*---------------------------------- AREA:AUXILIARES ---------------------------*/
	...
	registrarAccionesEventos() {	
		...
		jQuery(document).ready(function() {
			...
			funcionGeneralEventoJQuery.setImagenCerrarSesionClic("pago_cuenta_pagar","cuentaspagar","",pago_cuenta_pagar_funcion1,pago_cuenta_pagar_webcontrol1);			
