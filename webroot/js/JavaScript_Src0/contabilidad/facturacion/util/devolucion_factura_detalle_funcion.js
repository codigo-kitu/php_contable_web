...
//var devolucion_factura_detalleFuncionGeneral= function () {

class devolucion_factura_detalle_funcion {
...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(devolucion_factura_detalle_constante1.STR_RELATIVE_PATH,"devolucion_factura_detalle");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(devolucion_factura_detalle_constante1.STR_RELATIVE_PATH,devolucion_factura_detalle_constante1.STR_NOMBRE_OPCION,"devolucion_factura_detalle");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(devolucion_factura_detalle_constante1.STR_RELATIVE_PATH,devolucion_factura_detalle_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Clic-Cancelar -------------------
	...
	cancelarControles() {
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura_detalle.txtcosto);
		...
		jQuery('dtdevolucion_factura_detallefecha_emision').val(new Date());
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura_detalle.txtcomentario);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura_detalle.txttipo_cambio);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura_detalle.txtmoneda);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura_detalle.txtanulada);
		jQuery('cmbdevolucion_factura_detalleid_cliente').val("");	
	}
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(devolucion_factura_detalle_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(devolucion_factura_detalle_constante1.STR_RELATIVE_PATH,"devolucion_factura_detalle");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(devolucion_factura_detalle_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(devolucion_factura_detalle_constante1.STR_RELATIVE_PATH,"devolucion_factura_detalle");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(devolucion_factura_detalle_constante1.STR_RELATIVE_PATH,"devolucion_factura_detalle");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"devolucion_factura_detalle");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(devolucion_factura_detalle_constante1.BIT_CON_PAGINA_FORM==true && devolucion_factura_detalle_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
		...
		*/
		...
		if(devolucion_factura_detalle_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				"form_devolucion_factura_detalle-costo": {
					required:true,
					number:true
				},
				...
				"form_devolucion_factura_detalle-fecha_emision": {
					required:true,
					date:true
				},
					
				"form_devolucion_factura_detalle-comentario": {
					required:true,
					maxlength:1000
					,regexpStringMethod:true
				},
					
				"form_devolucion_factura_detalle-tipo_cambio": {
					required:true,
					number:true
				},
					
				"form_devolucion_factura_detalle-moneda": {
					required:true,
					digits:true
				},
					
				"form_devolucion_factura_detalle-anulada": {
					required:true,
					digits:true
				},
					
				"form_devolucion_factura_detalle-id_cliente": {
					digits:true
				...
				messages: {
					...
					"form_devolucion_factura_detalle-costo": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					...
					"form_devolucion_factura_detalle-fecha_emision": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_FECHA_INCORRECTO,
					"form_devolucion_factura_detalle-comentario": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_devolucion_factura_detalle-tipo_cambio": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_devolucion_factura_detalle-moneda": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
					"form_devolucion_factura_detalle-anulada": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
					"form_devolucion_factura_detalle-id_cliente": ""+constantes.STR_MENSAJE_ENTERO_INCORRECTO
				}		
			};	
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"devolucion_factura_detalle");
	}
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura_detalle.txtcosto,false);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura_detalle.txtcomentario,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura_detalle.txttipo_cambio,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura_detalle.txtmoneda,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura_detalle.txtanulada,false);
		} else {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura_detalle.txtcosto,true);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura_detalle.txtcomentario,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura_detalle.txttipo_cambio,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura_detalle.txtmoneda,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura_detalle.txtanulada,true);
		}	
	}
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"devolucion_factura_detalle");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"devolucion_factura_detalle");
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(devolucion_factura_detalle_control,devolucion_factura_detalle_webcontrol1,devolucion_factura_detalle_constante1) {
		
		var strSuf=devolucion_factura_detalle_constante1.STR_SUFIJO;
			...
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(constantes.STR_TIPO_COMBO=="select2") {
					...
					devolucion_factura_detalle_webcontrol1.registrarComboActionChangeid_bodega(control_name,true,i);
				}
				...
				if(constantes.STR_TIPO_COMBO=="select2") {
					...
					devolucion_factura_detalle_webcontrol1.registrarComboActionChangeid_producto(control_name,true,i);
				}
				...
				if(devolucion_factura_detalle_control.iddevolucion_facturaDefaultForeignKey!=null && devolucion_factura_detalle_control.iddevolucion_facturaDefaultForeignKey>-1) {
					idActual=devolucion_factura_detalle_control.iddevolucion_facturaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_detalle_webcontrol1.cargarComboEditarTabladevolucion_facturaFK(devolucion_factura_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						devolucion_factura_detalle_webcontrol1.cargarComboEditarTabladevolucion_facturaFK(devolucion_factura_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_detalle_control.idbodegaDefaultForeignKey!=null && devolucion_factura_detalle_control.idbodegaDefaultForeignKey>-1) {
					idActual=devolucion_factura_detalle_control.idbodegaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_detalle_webcontrol1.cargarComboEditarTablabodegaFK(devolucion_factura_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_detalle_webcontrol1.cargarComboEditarTablabodegaFK(devolucion_factura_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_detalle_control.idproductoDefaultForeignKey!=null && devolucion_factura_detalle_control.idproductoDefaultForeignKey>-1) {
					idActual=devolucion_factura_detalle_control.idproductoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_detalle_webcontrol1.cargarComboEditarTablaproductoFK(devolucion_factura_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_detalle_webcontrol1.cargarComboEditarTablaproductoFK(devolucion_factura_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_detalle_control.idunidadDefaultForeignKey!=null && devolucion_factura_detalle_control.idunidadDefaultForeignKey>-1) {
					idActual=devolucion_factura_detalle_control.idunidadDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_detalle_webcontrol1.cargarComboEditarTablaunidadFK(devolucion_factura_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_detalle_webcontrol1.cargarComboEditarTablaunidadFK(devolucion_factura_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_detalle_control.idclienteDefaultForeignKey!=null && devolucion_factura_detalle_control.idclienteDefaultForeignKey>-1) {
					idActual=devolucion_factura_detalle_control.idclienteDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_detalle_webcontrol1.cargarComboEditarTablaclienteFK(devolucion_factura_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_detalle_webcontrol1.cargarComboEditarTablaclienteFK(devolucion_factura_detalle_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatosdevolucion_factura_detalle").validate(json_rules);
