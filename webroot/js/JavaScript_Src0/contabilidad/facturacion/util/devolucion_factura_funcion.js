...
//var devolucion_facturaFuncionGeneral= function () {

class devolucion_factura_funcion {
...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(devolucion_factura_constante1.STR_RELATIVE_PATH,"devolucion_factura");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(devolucion_factura_constante1.STR_RELATIVE_PATH,devolucion_factura_constante1.STR_NOMBRE_OPCION,"devolucion_factura");		
	}	
...
//---------- Clic-Seleccionar ----------
	...
	seleccionarMostrarDivAccionesRelacionesActualOnComplete() {
		funcionGeneral.seleccionarMostrarDivAccionesRelacionesActualOnComplete("devolucion_factura",this);
	}
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(devolucion_factura_constante1.STR_RELATIVE_PATH,devolucion_factura_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Clic-Cancelar -------------------
	...
	cancelarControles() {
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txttipo_cambio);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtmoneda);
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtimpuesto_en_precio);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtnota);
		jQuery('dtdevolucion_facturahora').val(new Date());
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txttipo_envio);
		jQuery('dtdevolucion_facturaactualizado').val(new Date());
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtcomputador);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtmonto_base);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtdescuento_parcial_monto);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtimpuesto2_porciento);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtimpuesto2_monto);
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtnro_estimado);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtncf);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtenviar);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtpagos);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txten_anexo);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtcampo1);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtcampo2);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtcampo3);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtanulada);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtcausa_anulacion);
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_factura.txtcomprobante);	
	}
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(devolucion_factura_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(devolucion_factura_constante1.STR_RELATIVE_PATH,"devolucion_factura");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(devolucion_factura_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(devolucion_factura_constante1.STR_RELATIVE_PATH,"devolucion_factura");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(devolucion_factura_constante1.STR_RELATIVE_PATH,"devolucion_factura");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"devolucion_factura");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(devolucion_factura_constante1.BIT_CON_PAGINA_FORM==true && devolucion_factura_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
		...
		*/
		...
		if(devolucion_factura_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				"form_devolucion_factura-tipo_cambio": {
					required:true,
					number:true
				},
					
				"form_devolucion_factura-moneda": {
					required:true,
					digits:true
				},
				...
				"form_devolucion_factura-impuesto_en_precio": {
					required:true,
					digits:true
				},
					
				"form_devolucion_factura-nota": {
					maxlength:1000
					,regexpStringMethod:true
				},
				...
				"form_devolucion_factura-tipo_envio": {
					maxlength:80
					,regexpStringMethod:true
				},
					
				"form_devolucion_factura-actualizado": {
					required:true,
					date:true
				},
					
				"form_devolucion_factura-computador": {
					maxlength:1000
					,regexpStringMethod:true
				},
					
				"form_devolucion_factura-monto_base": {
					required:true,
					number:true
				},
					
				"form_devolucion_factura-descuento_parcial_monto": {
					required:true,
					number:true
				},
					
				"form_devolucion_factura-impuesto2_porciento": {
					required:true,
					number:true
				},
					
				"form_devolucion_factura-impuesto2_monto": {
					required:true,
					number:true
				},
				...
				"form_devolucion_factura-nro_estimado": {
					maxlength:10
					,regexpStringMethod:true
				},
					
				"form_devolucion_factura-ncf": {
					maxlength:10
					,regexpStringMethod:true
				},
					
				"form_devolucion_factura-enviar": {
					maxlength:80
					,regexpStringMethod:true
				},
					
				"form_devolucion_factura-pagos": {
					required:true,
					number:true
				},
					
				"form_devolucion_factura-en_anexo": {
					maxlength:2
					,regexpStringMethod:true
				},
					
				"form_devolucion_factura-campo1": {
					maxlength:30
					,regexpStringMethod:true
				},
					
				"form_devolucion_factura-campo2": {
					required:true,
					number:true
				},
					
				"form_devolucion_factura-campo3": {
					maxlength:20
					,regexpStringMethod:true
				},
					
				"form_devolucion_factura-anulada": {
					required:true,
					digits:true
				},
					
				"form_devolucion_factura-causa_anulacion": {
					maxlength:1000
					,regexpStringMethod:true
				},
				...
				"form_devolucion_factura-comprobante": {
					maxlength:40
					,regexpStringMethod:true
				}
				},
				...
				messages: {
					...
					"form_devolucion_factura-tipo_cambio": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_devolucion_factura-moneda": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
					...
					"form_devolucion_factura-impuesto_en_precio": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
					"form_devolucion_factura-nota": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_devolucion_factura-hora": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_FECHA_INCORRECTO,
					"form_devolucion_factura-tipo_envio": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_devolucion_factura-actualizado": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_FECHA_INCORRECTO,
					"form_devolucion_factura-computador": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_devolucion_factura-monto_base": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_devolucion_factura-descuento_parcial_monto": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_devolucion_factura-impuesto2_porciento": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_devolucion_factura-impuesto2_monto": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					...
					"form_devolucion_factura-nro_estimado": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_devolucion_factura-ncf": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_devolucion_factura-enviar": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_devolucion_factura-pagos": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_devolucion_factura-en_anexo": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_devolucion_factura-campo1": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_devolucion_factura-campo2": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_devolucion_factura-campo3": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_devolucion_factura-anulada": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
					"form_devolucion_factura-causa_anulacion": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					...
					"form_devolucion_factura-comprobante": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO
				}		
			};	
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"devolucion_factura");
	}
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txttipo_cambio,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtmoneda,false);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtimpuesto_en_precio,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtnota,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txttipo_envio,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcomputador,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtmonto_base,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtdescuento_parcial_monto,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtimpuesto2_porciento,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtimpuesto2_monto,false);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtnro_estimado,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtncf,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtenviar,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtpagos,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txten_anexo,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcampo1,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcampo2,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcampo3,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtanulada,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcausa_anulacion,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcomprobante,false);
		} else {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txttipo_cambio,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtmoneda,true);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtimpuesto_en_precio,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtnota,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txttipo_envio,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcomputador,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtmonto_base,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtdescuento_parcial_monto,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtimpuesto2_porciento,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtimpuesto2_monto,true);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtnro_estimado,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtncf,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtenviar,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtpagos,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txten_anexo,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcampo1,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcampo2,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcampo3,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtanulada,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcausa_anulacion,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_factura.txtcomprobante,true);
		}	
	}
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"devolucion_factura");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"devolucion_factura");
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(devolucion_factura_control,devolucion_factura_webcontrol1,devolucion_factura_constante1) {
		
		var strSuf=devolucion_factura_constante1.STR_SUFIJO;
			...
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(constantes.STR_TIPO_COMBO=="select2") {
					...
					devolucion_factura_webcontrol1.registrarComboActionChangeid_cliente(control_name,true,i);
				}
				...
				if(devolucion_factura_control.idempresaDefaultForeignKey!=null && devolucion_factura_control.idempresaDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.idempresaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTablaempresaFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						devolucion_factura_webcontrol1.cargarComboEditarTablaempresaFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_control.idsucursalDefaultForeignKey!=null && devolucion_factura_control.idsucursalDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.idsucursalDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTablasucursalFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_webcontrol1.cargarComboEditarTablasucursalFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_control.idejercicioDefaultForeignKey!=null && devolucion_factura_control.idejercicioDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.idejercicioDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTablaejercicioFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_webcontrol1.cargarComboEditarTablaejercicioFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_control.idperiodoDefaultForeignKey!=null && devolucion_factura_control.idperiodoDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.idperiodoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTablaperiodoFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_webcontrol1.cargarComboEditarTablaperiodoFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_control.idusuarioDefaultForeignKey!=null && devolucion_factura_control.idusuarioDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.idusuarioDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTablausuarioFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_webcontrol1.cargarComboEditarTablausuarioFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_control.idclienteDefaultForeignKey!=null && devolucion_factura_control.idclienteDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.idclienteDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTablaclienteFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_webcontrol1.cargarComboEditarTablaclienteFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_control.idvendedorDefaultForeignKey!=null && devolucion_factura_control.idvendedorDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.idvendedorDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTablavendedorFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_webcontrol1.cargarComboEditarTablavendedorFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_control.idtermino_pago_clienteDefaultForeignKey!=null && devolucion_factura_control.idtermino_pago_clienteDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.idtermino_pago_clienteDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTablatermino_pago_clienteFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_webcontrol1.cargarComboEditarTablatermino_pago_clienteFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_control.idestadoDefaultForeignKey!=null && devolucion_factura_control.idestadoDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.idestadoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTablaestadoFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_webcontrol1.cargarComboEditarTablaestadoFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_control.idasientoDefaultForeignKey!=null && devolucion_factura_control.idasientoDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.idasientoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTablaasientoFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_webcontrol1.cargarComboEditarTablaasientoFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_control.iddocumento_cuenta_cobrarDefaultForeignKey!=null && devolucion_factura_control.iddocumento_cuenta_cobrarDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.iddocumento_cuenta_cobrarDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTabladocumento_cuenta_cobrarFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_webcontrol1.cargarComboEditarTabladocumento_cuenta_cobrarFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_factura_control.idkardexDefaultForeignKey!=null && devolucion_factura_control.idkardexDefaultForeignKey>-1) {
					idActual=devolucion_factura_control.idkardexDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_factura_webcontrol1.cargarComboEditarTablakardexFK(devolucion_factura_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_factura_webcontrol1.cargarComboEditarTablakardexFK(devolucion_factura_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatosdevolucion_factura").validate(json_rules);
