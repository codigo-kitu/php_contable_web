...
class impuesto_webcontrol extends impuesto_webcontrol_add {
	...
	actualizarVariablesPagina(impuesto_control) {
		...
		if(impuesto_control.action=="index" || impuesto_control.action=="load") {
		...
		} else if(impuesto_control.action=="recargarFomularioGeneral") {
			...
			alert(impuesto_control.action + " Revisar Manejo");
			
			if(impuesto_control.bitEsAbrirVentanaAuxiliarUrl==true){
			...
			if(impuesto_control.bitEsEjecutarFuncionJavaScript==true){
				this.actualizarPaginaEjecutarJavaScript(impuesto_control);
			}
			...
			if(impuesto_control.paramDivSeccion.bitDivsEsCargarGeneralAjaxWebPart==true) {		
				this.actualizarPaginaCargaGeneral(impuesto_control);	
			}
			
			if(impuesto_control.paramDivSeccion.bitDivEsCargarAjaxWebPart==true) {
				this.actualizarPaginaTablaDatos(impuesto_control);
			}
			
			if(impuesto_control.paramDivSeccion.bitDivsEsCargarMostrarAjaxWebPart==true) {		
			...
			if(impuesto_control.paramDivSeccion.bitDivsEsCargarMostrarSoloBusquedasAjaxWebPart==true) {		
				this.actualizarPaginaAreaBusquedas(impuesto_control);	
			}
			
			if(impuesto_control.paramDivSeccion.bitDivsEsCargarMostrarSoloMantenimientosAjaxWebPart==true) {		
			...
			if(impuesto_control.paramDivSeccion.bitDivEsCargarMantenimientosAjaxWebPart==true) {				
				this.actualizarPaginaTablaFilaActual(impuesto_control);			
			}
			
			if(impuesto_control.paramDivSeccion.bitDivsEsCargarReporteAuxiliarAjaxWebPart==true) {				
				this.actualizarPaginaImprimir(impuesto_control);
			}
			
			
			if(impuesto_control.paramDivSeccion.bitDivsEsCargarMostrarBusquedasAjaxWebPart==true) {
				this.actualizarPaginaAreaAuxiliarBusquedas(impuesto_control);
			}
			
			if(impuesto_control.paramDivSeccion.bitDivsEsCargarResumenAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarResumen(impuesto_control);
			}				
			
			if(impuesto_control.paramDivSeccion.bitDivsEsCargarAccionesRelacionesAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarAccionesRelaciones(impuesto_control);
			}
			
			if(impuesto_control.usuarioActual!=null && impuesto_control.usuarioActual.field_strUserName!=null &&
			impuesto_control.usuarioActual.field_strUserName!=undefined ) {
				
				this.actualizarPaginaUsuarioInvitado(impuesto_control);			
			}
		}
...
//Funciones Auxiliares
	...
	actualizarPaginaTablaDatosAuxiliar(impuesto_control) {
		if(impuesto_funcion1.esPaginaForm()==true) {
	...
	actualizarPaginaEjecutarJavaScript(impuesto_control) {
		eval(impuesto_control.strFuncionJs);
	}
	
	actualizarPaginaMensajePantalla(impuesto_control, mostrar) {
		
		if(mostrar==true) {
			impuesto_funcion1.resaltarRestaurarDivsPagina(false);
			
			if(jQuery("#ParamsPostAccion-chbPostAccionSinCerrar").prop('checked')==false
				&& jQuery("#ParamsPostAccion-chbPostAccionNuevo").prop('checked')==false) {		
					
				impuesto_funcion1.resaltarRestaurarDivMantenimiento(false);
			}			
	...
	actualizarPaginaImprimir(impuesto_control) {
	
		funcionGeneral.printWebPartPage("impuesto",impuesto_control.htmlTablaReporteAuxiliars);			
			
		//jQuery("#divTablaDatosReporteAuxiliarimpuestosAjaxWebPart").html(impuesto_control.htmlTablaReporteAuxiliars);						
		//funcionGeneral.printWebPartPage("impuesto",jQuery("#divTablaDatosReporteAuxiliarimpuestosAjaxWebPart").html());			
	}
...
/*---------------------------------- AREA:TABLA ---------------------------*/
	...
	actualizarCamposFilaTabla(impuesto_control) {
		...
		if(impuesto_control.impuestoActual.id_empresa!=null && impuesto_control.impuestoActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_2").val() != impuesto_control.impuestoActual.id_empresa) {
				jQuery("#t-cel_"+i+"_2").val(impuesto_control.impuestoActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_3").val(impuesto_control.impuestoActual.codigo);
		jQuery("#t-cel_"+i+"_4").val(impuesto_control.impuestoActual.descripcion);
		jQuery("#t-cel_"+i+"_5").val(impuesto_control.impuestoActual.valor);
		jQuery("#t-cel_"+i+"_6").prop('checked',impuesto_control.impuestoActual.predeterminado);
		
		if(impuesto_control.impuestoActual.id_cuenta_ventas!=null && impuesto_control.impuestoActual.id_cuenta_ventas>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != impuesto_control.impuestoActual.id_cuenta_ventas) {
				jQuery("#t-cel_"+i+"_7").val(impuesto_control.impuestoActual.id_cuenta_ventas).trigger("change");
			}
		} else { 
		...
		if(impuesto_control.impuestoActual.id_cuenta_compras!=null && impuesto_control.impuestoActual.id_cuenta_compras>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != impuesto_control.impuestoActual.id_cuenta_compras) {
				jQuery("#t-cel_"+i+"_8").val(impuesto_control.impuestoActual.id_cuenta_compras).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_9").val(impuesto_control.impuestoActual.cuenta_contable_ventas);
		jQuery("#t-cel_"+i+"_10").val(impuesto_control.impuestoActual.cuenta_contable_compras);
	}
	...
	registrarTablaAcciones() {
		...
		jQuery("#tblTablaDatosimpuestos").on("click",".imgrelacionlista_producto", function () {
	...
	registrarSesionParaproductos(idActual){
		...
		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"impuesto","producto","facturacion","",impuesto_funcion1,impuesto_webcontrol1,"s","");
	}

	registrarSesionParaclientes(idActual){

		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"impuesto","cliente","facturacion","",impuesto_funcion1,impuesto_webcontrol1,"s","");
	}

	registrarSesionParaproveedores(idActual){

		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"impuesto","proveedor","facturacion","",impuesto_funcion1,impuesto_webcontrol1,"es","");
	}

	registrarSesionParalista_productoes(idActual){

		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"impuesto","lista_producto","facturacion","",impuesto_funcion1,impuesto_webcontrol1,"es","");
	}
...
/*---------------------------------- AREA:AUXILIARES ---------------------------*/
	...
	registrarAccionesEventos() {	
		...
		jQuery(document).ready(function() {
			...
			funcionGeneralEventoJQuery.setImagenCerrarSesionClic("impuesto","facturacion","",impuesto_funcion1,impuesto_webcontrol1);			
