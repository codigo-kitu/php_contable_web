...
class otro_impuesto_webcontrol extends otro_impuesto_webcontrol_add {
	...
	actualizarVariablesPagina(otro_impuesto_control) {
		...
		if(otro_impuesto_control.action=="index" || otro_impuesto_control.action=="load") {
		...
		} else if(otro_impuesto_control.action=="recargarFomularioGeneral") {
			...
			alert(otro_impuesto_control.action + " Revisar Manejo");
			
			if(otro_impuesto_control.bitEsAbrirVentanaAuxiliarUrl==true){
			...
			if(otro_impuesto_control.bitEsEjecutarFuncionJavaScript==true){
				this.actualizarPaginaEjecutarJavaScript(otro_impuesto_control);
			}
			...
			if(otro_impuesto_control.paramDivSeccion.bitDivsEsCargarGeneralAjaxWebPart==true) {		
				this.actualizarPaginaCargaGeneral(otro_impuesto_control);	
			}
			
			if(otro_impuesto_control.paramDivSeccion.bitDivEsCargarAjaxWebPart==true) {
				this.actualizarPaginaTablaDatos(otro_impuesto_control);
			}
			
			if(otro_impuesto_control.paramDivSeccion.bitDivsEsCargarMostrarAjaxWebPart==true) {		
			...
			if(otro_impuesto_control.paramDivSeccion.bitDivsEsCargarMostrarSoloBusquedasAjaxWebPart==true) {		
				this.actualizarPaginaAreaBusquedas(otro_impuesto_control);	
			}
			
			if(otro_impuesto_control.paramDivSeccion.bitDivsEsCargarMostrarSoloMantenimientosAjaxWebPart==true) {		
			...
			if(otro_impuesto_control.paramDivSeccion.bitDivEsCargarMantenimientosAjaxWebPart==true) {				
				this.actualizarPaginaTablaFilaActual(otro_impuesto_control);			
			}
			
			if(otro_impuesto_control.paramDivSeccion.bitDivsEsCargarReporteAuxiliarAjaxWebPart==true) {				
				this.actualizarPaginaImprimir(otro_impuesto_control);
			}
			
			
			if(otro_impuesto_control.paramDivSeccion.bitDivsEsCargarMostrarBusquedasAjaxWebPart==true) {
				this.actualizarPaginaAreaAuxiliarBusquedas(otro_impuesto_control);
			}
			
			if(otro_impuesto_control.paramDivSeccion.bitDivsEsCargarResumenAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarResumen(otro_impuesto_control);
			}				
			
			if(otro_impuesto_control.paramDivSeccion.bitDivsEsCargarAccionesRelacionesAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarAccionesRelaciones(otro_impuesto_control);
			}
			
			if(otro_impuesto_control.usuarioActual!=null && otro_impuesto_control.usuarioActual.field_strUserName!=null &&
			otro_impuesto_control.usuarioActual.field_strUserName!=undefined ) {
				
				this.actualizarPaginaUsuarioInvitado(otro_impuesto_control);			
			}
		}
...
//Funciones Auxiliares
	...
	actualizarPaginaTablaDatosAuxiliar(otro_impuesto_control) {
		if(otro_impuesto_funcion1.esPaginaForm()==true) {
	...
	actualizarPaginaEjecutarJavaScript(otro_impuesto_control) {
		eval(otro_impuesto_control.strFuncionJs);
	}
	
	actualizarPaginaMensajePantalla(otro_impuesto_control, mostrar) {
		
		if(mostrar==true) {
			otro_impuesto_funcion1.resaltarRestaurarDivsPagina(false);
			
			if(jQuery("#ParamsPostAccion-chbPostAccionSinCerrar").prop('checked')==false
				&& jQuery("#ParamsPostAccion-chbPostAccionNuevo").prop('checked')==false) {		
					
				otro_impuesto_funcion1.resaltarRestaurarDivMantenimiento(false);
			}			
	...
	actualizarPaginaImprimir(otro_impuesto_control) {
	
		funcionGeneral.printWebPartPage("otro_impuesto",otro_impuesto_control.htmlTablaReporteAuxiliars);			
			
		//jQuery("#divTablaDatosReporteAuxiliarotro_impuestosAjaxWebPart").html(otro_impuesto_control.htmlTablaReporteAuxiliars);						
		//funcionGeneral.printWebPartPage("otro_impuesto",jQuery("#divTablaDatosReporteAuxiliarotro_impuestosAjaxWebPart").html());			
	}
...
/*---------------------------------- AREA:FORMULARIO ---------------------------*/
	...
	actualizarCamposFormulario(otro_impuesto_control) {
		...
		jQuery("#form"+otro_impuesto_constante1.STR_SUFIJO+"-version_row").val(otro_impuesto_control.otro_impuestoActual.versionRow);
	...
	actualizarSpanMensajesCampos(otro_impuesto_control) {
		...
		jQuery("#spanstrMensajeversion_row").text(otro_impuesto_control.strMensajeversion_row);		
...
/*---------------------------------- AREA:TABLA ---------------------------*/
	...
	registrarSesion_ventasParalista_productoes(idActual){
		...
		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"otro_impuesto","lista_producto","facturacion","",otro_impuesto_funcion1,otro_impuesto_webcontrol1,"es","_ventas");
	}

	registrarSesionParaproductos(idActual){

		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"otro_impuesto","producto","facturacion","",otro_impuesto_funcion1,otro_impuesto_webcontrol1,"s","");
	}
...
/*---------------------------------- AREA:AUXILIARES ---------------------------*/
	...
	registrarAccionesEventos() {	
		...
		jQuery(document).ready(function() {
			...
			funcionGeneralEventoJQuery.setImagenCerrarSesionClic("otro_impuesto","facturacion","",otro_impuesto_funcion1,otro_impuesto_webcontrol1);			
