...
class modulo_webcontrol extends modulo_webcontrol_add {
	...
	actualizarVariablesPagina(modulo_control) {
		...
		if(modulo_control.action=="index" || modulo_control.action=="load") {
		...
		} else if(modulo_control.action=="recargarFomularioGeneral") {
			...
			alert(modulo_control.action + " Revisar Manejo");
			
			if(modulo_control.bitEsAbrirVentanaAuxiliarUrl==true){
			...
			if(modulo_control.bitEsEjecutarFuncionJavaScript==true){
				this.actualizarPaginaEjecutarJavaScript(modulo_control);
			}
			...
			if(modulo_control.paramDivSeccion.bitDivsEsCargarGeneralAjaxWebPart==true) {		
				this.actualizarPaginaCargaGeneral(modulo_control);	
			}
			
			if(modulo_control.paramDivSeccion.bitDivEsCargarAjaxWebPart==true) {
				this.actualizarPaginaTablaDatos(modulo_control);
			}
			
			if(modulo_control.paramDivSeccion.bitDivsEsCargarMostrarAjaxWebPart==true) {		
			...
			if(modulo_control.paramDivSeccion.bitDivsEsCargarMostrarSoloBusquedasAjaxWebPart==true) {		
				this.actualizarPaginaAreaBusquedas(modulo_control);	
			}
			
			if(modulo_control.paramDivSeccion.bitDivsEsCargarMostrarSoloMantenimientosAjaxWebPart==true) {		
			...
			if(modulo_control.paramDivSeccion.bitDivEsCargarMantenimientosAjaxWebPart==true) {				
				this.actualizarPaginaTablaFilaActual(modulo_control);			
			}
			
			if(modulo_control.paramDivSeccion.bitDivsEsCargarReporteAuxiliarAjaxWebPart==true) {				
				this.actualizarPaginaImprimir(modulo_control);
			}
			
			
			if(modulo_control.paramDivSeccion.bitDivsEsCargarMostrarBusquedasAjaxWebPart==true) {
				this.actualizarPaginaAreaAuxiliarBusquedas(modulo_control);
			}
			
			if(modulo_control.paramDivSeccion.bitDivsEsCargarResumenAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarResumen(modulo_control);
			}				
			
			if(modulo_control.paramDivSeccion.bitDivsEsCargarAccionesRelacionesAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarAccionesRelaciones(modulo_control);
			}
			
			if(modulo_control.usuarioActual!=null && modulo_control.usuarioActual.field_strUserName!=null &&
			modulo_control.usuarioActual.field_strUserName!=undefined ) {
				
				this.actualizarPaginaUsuarioInvitado(modulo_control);			
			}
		}
...
//Funciones Auxiliares
	...
	actualizarPaginaTablaDatosAuxiliar(modulo_control) {
		if(modulo_funcion1.esPaginaForm()==true) {
	...
	actualizarPaginaEjecutarJavaScript(modulo_control) {
		eval(modulo_control.strFuncionJs);
	}
	
	actualizarPaginaMensajePantalla(modulo_control, mostrar) {
		
		if(mostrar==true) {
			modulo_funcion1.resaltarRestaurarDivsPagina(false);
			
			if(jQuery("#ParamsPostAccion-chbPostAccionSinCerrar").prop('checked')==false
				&& jQuery("#ParamsPostAccion-chbPostAccionNuevo").prop('checked')==false) {		
					
				modulo_funcion1.resaltarRestaurarDivMantenimiento(false);
			}			
	...
	actualizarPaginaImprimir(modulo_control) {
	
		funcionGeneral.printWebPartPage("modulo",modulo_control.htmlTablaReporteAuxiliars);			
			
		//jQuery("#divTablaDatosReporteAuxiliarmodulosAjaxWebPart").html(modulo_control.htmlTablaReporteAuxiliars);						
		//funcionGeneral.printWebPartPage("modulo",jQuery("#divTablaDatosReporteAuxiliarmodulosAjaxWebPart").html());			
	}
...
/*---------------------------------- AREA:FORMULARIO ---------------------------*/
	...
	actualizarCamposFormulario(modulo_control) {
		...
		jQuery("#form"+modulo_constante1.STR_SUFIJO+"-version_row").val(modulo_control.moduloActual.versionRow);
	...
	actualizarSpanMensajesCampos(modulo_control) {
		...
		jQuery("#spanstrMensajeversion_row").text(modulo_control.strMensajeversion_row);		
...
/*---------------------------------- AREA:TABLA ---------------------------*/
	...
	actualizarCamposFilaTabla(modulo_control) {
		...
		if(modulo_control.moduloActual.id_sistema!=null && modulo_control.moduloActual.id_sistema>-1){
			if(jQuery("#t-cel_"+i+"_2").val() != modulo_control.moduloActual.id_sistema) {
				jQuery("#t-cel_"+i+"_2").val(modulo_control.moduloActual.id_sistema).trigger("change");
			}
		} else { 
		...
		if(modulo_control.moduloActual.id_paquete!=null && modulo_control.moduloActual.id_paquete>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != modulo_control.moduloActual.id_paquete) {
				jQuery("#t-cel_"+i+"_3").val(modulo_control.moduloActual.id_paquete).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(modulo_control.moduloActual.codigo);
		jQuery("#t-cel_"+i+"_5").val(modulo_control.moduloActual.nombre);
		
		if(modulo_control.moduloActual.id_tipo_tecla_mascara!=null && modulo_control.moduloActual.id_tipo_tecla_mascara>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != modulo_control.moduloActual.id_tipo_tecla_mascara) {
				jQuery("#t-cel_"+i+"_6").val(modulo_control.moduloActual.id_tipo_tecla_mascara).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(modulo_control.moduloActual.tecla);
		jQuery("#t-cel_"+i+"_8").prop('checked',modulo_control.moduloActual.estado);
		jQuery("#t-cel_"+i+"_9").val(modulo_control.moduloActual.orden);
		jQuery("#t-cel_"+i+"_10").val(modulo_control.moduloActual.descripcion);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/
	...
	cargarCombossistemasFK(modulo_control) {
		...
		if(modulo_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+modulo_control.idFilaTablaActual+"_2",modulo_control.sistemasFK);
		}
	...
	cargarCombospaquetesFK(modulo_control) {
		...
		if(modulo_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+modulo_control.idFilaTablaActual+"_3",modulo_control.paquetesFK);
		}
	...
	cargarCombostipo_tecla_mascarasFK(modulo_control) {
		...
		if(modulo_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+modulo_control.idFilaTablaActual+"_6",modulo_control.tipo_tecla_mascarasFK);
		}
...
/*---------------------------------- AREA:AUXILIARES ---------------------------*/
	...
	registrarAccionesEventos() {	
		...
		jQuery(document).ready(function() {
			...
			funcionGeneralEventoJQuery.setImagenCerrarSesionClic("modulo","seguridad","",modulo_funcion1,modulo_webcontrol1);			
