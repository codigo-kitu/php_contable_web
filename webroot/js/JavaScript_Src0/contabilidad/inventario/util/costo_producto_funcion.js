...
//var costo_productoFuncionGeneral= function () {

class costo_producto_funcion {
...
//------------- Clic-Cancelar -------------------
	...
	cancelarControles() {
		...
		jQuery('cmbcosto_productoid_kardex_detalle').val("");
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(costo_producto_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(costo_producto_constante1.STR_RELATIVE_PATH,"costo_producto");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(costo_producto_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(costo_producto_constante1.STR_RELATIVE_PATH,"costo_producto");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(costo_producto_constante1.STR_RELATIVE_PATH,"costo_producto");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"costo_producto");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(costo_producto_constante1.BIT_CON_PAGINA_FORM==true && costo_producto_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
		...
		if(costo_producto_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				messages: {
					...
					"form-id_kardex_detalle": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
			...
			arrRules= {
				...
				"form_costo_producto-id_kardex_detalle": {
					required:true,
					digits:true
					,min:0
				},
				...
				messages: {
					...
					"form_costo_producto-id_kardex_detalle": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"costo_producto");
	}
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"costo_producto");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"costo_producto");
	}
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(costo_producto_control.idkardex_detalleDefaultForeignKey!=null && costo_producto_control.idkardex_detalleDefaultForeignKey>-1) {
					idActual=costo_producto_control.idkardex_detalleDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					costo_producto_webcontrol1.cargarComboEditarTablakardex_detalleFK(costo_producto_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						costo_producto_webcontrol1.cargarComboEditarTablakardex_detalleFK(costo_producto_control,control_name,idActual,true);
					}
				});
