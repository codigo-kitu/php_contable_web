...
//var orden_compra_detalleFuncionGeneral= function () {

class orden_compra_detalle_funcion {
...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(orden_compra_detalle_constante1.STR_RELATIVE_PATH,"orden_compra_detalle");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(orden_compra_detalle_constante1.STR_RELATIVE_PATH,orden_compra_detalle_constante1.STR_NOMBRE_OPCION,"orden_compra_detalle");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(orden_compra_detalle_constante1.STR_RELATIVE_PATH,orden_compra_detalle_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Clic-Cancelar -------------------
	...
	cancelarControles() {
		...
		jQuery('dtorden_compra_detallefecha_emision').val(new Date());
		funcionGeneral.setEmptyControl(document.frmMantenimientoorden_compra_detalle.txtcomentario);
		funcionGeneral.setEmptyControl(document.frmMantenimientoorden_compra_detalle.txttipo_cambio);
		funcionGeneral.setEmptyControl(document.frmMantenimientoorden_compra_detalle.txtmoneda);
		jQuery('cmborden_compra_detalleid_proveedor').val("");	
	}
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(orden_compra_detalle_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(orden_compra_detalle_constante1.STR_RELATIVE_PATH,"orden_compra_detalle");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(orden_compra_detalle_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(orden_compra_detalle_constante1.STR_RELATIVE_PATH,"orden_compra_detalle");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(orden_compra_detalle_constante1.STR_RELATIVE_PATH,"orden_compra_detalle");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"orden_compra_detalle");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(orden_compra_detalle_constante1.BIT_CON_PAGINA_FORM==true && orden_compra_detalle_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
		...
		*/
		...
		if(orden_compra_detalle_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				"form_orden_compra_detalle-fecha_emision": {
					required:true,
					date:true
				},
					
				"form_orden_compra_detalle-comentario": {
					required:true,
					maxlength:1000
					,regexpStringMethod:true
				},
					
				"form_orden_compra_detalle-tipo_cambio": {
					required:true,
					number:true
				},
					
				"form_orden_compra_detalle-moneda": {
					required:true,
					digits:true
				},
					
				"form_orden_compra_detalle-id_proveedor": {
					digits:true
				...
				messages: {
					...
					"form_orden_compra_detalle-fecha_emision": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_FECHA_INCORRECTO,
					"form_orden_compra_detalle-comentario": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_orden_compra_detalle-tipo_cambio": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_orden_compra_detalle-moneda": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
					"form_orden_compra_detalle-id_proveedor": ""+constantes.STR_MENSAJE_ENTERO_INCORRECTO
				}		
			};	
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"orden_compra_detalle");
	}
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoorden_compra_detalle.txtcomentario,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoorden_compra_detalle.txttipo_cambio,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoorden_compra_detalle.txtmoneda,false);
		} else {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoorden_compra_detalle.txtcomentario,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoorden_compra_detalle.txttipo_cambio,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoorden_compra_detalle.txtmoneda,true);
		}	
	}
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"orden_compra_detalle");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"orden_compra_detalle");
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(orden_compra_detalle_control,orden_compra_detalle_webcontrol1,orden_compra_detalle_constante1) {
		
		var strSuf=orden_compra_detalle_constante1.STR_SUFIJO;
			...
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(constantes.STR_TIPO_COMBO=="select2") {
					...
					orden_compra_detalle_webcontrol1.registrarComboActionChangeid_bodega(control_name,true,i);
				}
				...
				if(constantes.STR_TIPO_COMBO=="select2") {
					...
					orden_compra_detalle_webcontrol1.registrarComboActionChangeid_producto(control_name,true,i);
				}
				...
				if(orden_compra_detalle_control.idorden_compraDefaultForeignKey!=null && orden_compra_detalle_control.idorden_compraDefaultForeignKey>-1) {
					idActual=orden_compra_detalle_control.idorden_compraDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					orden_compra_detalle_webcontrol1.cargarComboEditarTablaorden_compraFK(orden_compra_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						orden_compra_detalle_webcontrol1.cargarComboEditarTablaorden_compraFK(orden_compra_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(orden_compra_detalle_control.idbodegaDefaultForeignKey!=null && orden_compra_detalle_control.idbodegaDefaultForeignKey>-1) {
					idActual=orden_compra_detalle_control.idbodegaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					orden_compra_detalle_webcontrol1.cargarComboEditarTablabodegaFK(orden_compra_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						orden_compra_detalle_webcontrol1.cargarComboEditarTablabodegaFK(orden_compra_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(orden_compra_detalle_control.idproductoDefaultForeignKey!=null && orden_compra_detalle_control.idproductoDefaultForeignKey>-1) {
					idActual=orden_compra_detalle_control.idproductoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					orden_compra_detalle_webcontrol1.cargarComboEditarTablaproductoFK(orden_compra_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						orden_compra_detalle_webcontrol1.cargarComboEditarTablaproductoFK(orden_compra_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(orden_compra_detalle_control.idunidadDefaultForeignKey!=null && orden_compra_detalle_control.idunidadDefaultForeignKey>-1) {
					idActual=orden_compra_detalle_control.idunidadDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					orden_compra_detalle_webcontrol1.cargarComboEditarTablaunidadFK(orden_compra_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						orden_compra_detalle_webcontrol1.cargarComboEditarTablaunidadFK(orden_compra_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(orden_compra_detalle_control.idproveedorDefaultForeignKey!=null && orden_compra_detalle_control.idproveedorDefaultForeignKey>-1) {
					idActual=orden_compra_detalle_control.idproveedorDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					orden_compra_detalle_webcontrol1.cargarComboEditarTablaproveedorFK(orden_compra_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						orden_compra_detalle_webcontrol1.cargarComboEditarTablaproveedorFK(orden_compra_detalle_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatosorden_compra_detalle").validate(json_rules);
