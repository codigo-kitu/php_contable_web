...
//var unidadFuncionGeneral= function () {

class unidad_funcion {
...
//------------- Clic-Cancelar -------------------
	...
	cancelarControles() {
		...
		funcionGeneral.setCheckControl(document.frmMantenimientounidad.chbpredeterminado_venta,false);
		funcionGeneral.setCheckControl(document.frmMantenimientounidad.chbpredeterminado_compra,false);
		funcionGeneral.setEmptyControl(document.frmMantenimientounidad.txtnro_productos);	
	}
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(unidad_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(unidad_constante1.STR_RELATIVE_PATH,"unidad");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(unidad_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(unidad_constante1.STR_RELATIVE_PATH,"unidad");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(unidad_constante1.STR_RELATIVE_PATH,"unidad");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"unidad");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(unidad_constante1.BIT_CON_PAGINA_FORM==true && unidad_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
		...
		if(unidad_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				messages: {
					...
					"form_unidad-nro_productos": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO
				}		
			};	
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"unidad");
	}
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			...
			funcionGeneral.setDisabledControl(document.frmMantenimientounidad.chbpredeterminado_venta,false);
			funcionGeneral.setDisabledControl(document.frmMantenimientounidad.chbpredeterminado_compra,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientounidad.txtnro_productos,false);
		} else {
			...
			funcionGeneral.setDisabledControl(document.frmMantenimientounidad.chbpredeterminado_venta,true);
			funcionGeneral.setDisabledControl(document.frmMantenimientounidad.chbpredeterminado_compra,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientounidad.txtnro_productos,true);
		}	
	}
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"unidad");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"unidad");
	}
