...
//var categoria_productoFuncionGeneral= function () {

class categoria_producto_funcion {
...
//---------- Clic-Seleccionar ----------
	...
	seleccionarMostrarDivAccionesRelacionesActualOnComplete() {
		funcionGeneral.seleccionarMostrarDivAccionesRelacionesActualOnComplete("categoria_producto",this);
	}
...
//------------- Clic-Cancelar -------------------
	...
	cancelarControles() {
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientocategoria_producto.txtnro_productos);
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(categoria_producto_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(categoria_producto_constante1.STR_RELATIVE_PATH,"categoria_producto");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(categoria_producto_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(categoria_producto_constante1.STR_RELATIVE_PATH,"categoria_producto");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(categoria_producto_constante1.STR_RELATIVE_PATH,"categoria_producto");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"categoria_producto");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(categoria_producto_constante1.BIT_CON_PAGINA_FORM==true && categoria_producto_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
		...
		*/
		...
		if(categoria_producto_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				"form_categoria_producto-nro_productos": {
					required:true,
					digits:true
				},
				...
				messages: {
					...
					"form_categoria_producto-nro_productos": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"categoria_producto");
	}
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientocategoria_producto.txtnro_productos,false);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientocategoria_producto.txtnro_productos,true);
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"categoria_producto");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"categoria_producto");
	}
