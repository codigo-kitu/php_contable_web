...
//var devolucion_detalleFuncionGeneral= function () {

class devolucion_detalle_funcion {
...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(devolucion_detalle_constante1.STR_RELATIVE_PATH,"devolucion_detalle");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(devolucion_detalle_constante1.STR_RELATIVE_PATH,devolucion_detalle_constante1.STR_NOMBRE_OPCION,"devolucion_detalle");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(devolucion_detalle_constante1.STR_RELATIVE_PATH,devolucion_detalle_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Clic-Cancelar -------------------
	...
	cancelarControles() {
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_detalle.txtnro_item);
		...
		jQuery('dtdevolucion_detallefecha_emision').val(new Date());
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_detalle.txtcomentario);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_detalle.txttipo_cambio);
		funcionGeneral.setEmptyControl(document.frmMantenimientodevolucion_detalle.txtmoneda);
		jQuery('cmbdevolucion_detalleid_proveedor').val("");	
	}
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(devolucion_detalle_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(devolucion_detalle_constante1.STR_RELATIVE_PATH,"devolucion_detalle");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(devolucion_detalle_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(devolucion_detalle_constante1.STR_RELATIVE_PATH,"devolucion_detalle");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(devolucion_detalle_constante1.STR_RELATIVE_PATH,"devolucion_detalle");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"devolucion_detalle");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(devolucion_detalle_constante1.BIT_CON_PAGINA_FORM==true && devolucion_detalle_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
		...
		*/
		...
		if(devolucion_detalle_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				"form_devolucion_detalle-nro_item": {
					required:true,
					digits:true
				},
				...
				"form_devolucion_detalle-fecha_emision": {
					required:true,
					date:true
				},
					
				"form_devolucion_detalle-comentario": {
					required:true,
					maxlength:1000
					,regexpStringMethod:true
				},
					
				"form_devolucion_detalle-tipo_cambio": {
					required:true,
					number:true
				},
					
				"form_devolucion_detalle-moneda": {
					required:true,
					digits:true
				},
					
				"form_devolucion_detalle-id_proveedor": {
					digits:true
				...
				messages: {
					...
					"form_devolucion_detalle-nro_item": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
					...
					"form_devolucion_detalle-fecha_emision": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_FECHA_INCORRECTO,
					"form_devolucion_detalle-comentario": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					"form_devolucion_detalle-tipo_cambio": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_devolucion_detalle-moneda": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
					"form_devolucion_detalle-id_proveedor": ""+constantes.STR_MENSAJE_ENTERO_INCORRECTO
				}		
			};	
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"devolucion_detalle");
	}
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_detalle.txtnro_item,false);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_detalle.txtcomentario,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_detalle.txttipo_cambio,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_detalle.txtmoneda,false);
		} else {
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_detalle.txtnro_item,true);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_detalle.txtcomentario,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_detalle.txttipo_cambio,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodevolucion_detalle.txtmoneda,true);
		}	
	}
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"devolucion_detalle");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"devolucion_detalle");
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(devolucion_detalle_control,devolucion_detalle_webcontrol1,devolucion_detalle_constante1) {
		
		var strSuf=devolucion_detalle_constante1.STR_SUFIJO;
			...
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(constantes.STR_TIPO_COMBO=="select2") {
					...
					devolucion_detalle_webcontrol1.registrarComboActionChangeid_bodega(control_name,true,i);
				}
				...
				if(constantes.STR_TIPO_COMBO=="select2") {
					...
					devolucion_detalle_webcontrol1.registrarComboActionChangeid_producto(control_name,true,i);
				}
				...
				if(devolucion_detalle_control.iddevolucionDefaultForeignKey!=null && devolucion_detalle_control.iddevolucionDefaultForeignKey>-1) {
					idActual=devolucion_detalle_control.iddevolucionDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_detalle_webcontrol1.cargarComboEditarTabladevolucionFK(devolucion_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						devolucion_detalle_webcontrol1.cargarComboEditarTabladevolucionFK(devolucion_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_detalle_control.idbodegaDefaultForeignKey!=null && devolucion_detalle_control.idbodegaDefaultForeignKey>-1) {
					idActual=devolucion_detalle_control.idbodegaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_detalle_webcontrol1.cargarComboEditarTablabodegaFK(devolucion_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_detalle_webcontrol1.cargarComboEditarTablabodegaFK(devolucion_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_detalle_control.idproductoDefaultForeignKey!=null && devolucion_detalle_control.idproductoDefaultForeignKey>-1) {
					idActual=devolucion_detalle_control.idproductoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_detalle_webcontrol1.cargarComboEditarTablaproductoFK(devolucion_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_detalle_webcontrol1.cargarComboEditarTablaproductoFK(devolucion_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_detalle_control.idunidadDefaultForeignKey!=null && devolucion_detalle_control.idunidadDefaultForeignKey>-1) {
					idActual=devolucion_detalle_control.idunidadDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_detalle_webcontrol1.cargarComboEditarTablaunidadFK(devolucion_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_detalle_webcontrol1.cargarComboEditarTablaunidadFK(devolucion_detalle_control,control_name,idActual,true);
					}
				});
				...
				if(devolucion_detalle_control.idproveedorDefaultForeignKey!=null && devolucion_detalle_control.idproveedorDefaultForeignKey>-1) {
					idActual=devolucion_detalle_control.idproveedorDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					devolucion_detalle_webcontrol1.cargarComboEditarTablaproveedorFK(devolucion_detalle_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						devolucion_detalle_webcontrol1.cargarComboEditarTablaproveedorFK(devolucion_detalle_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatosdevolucion_detalle").validate(json_rules);
