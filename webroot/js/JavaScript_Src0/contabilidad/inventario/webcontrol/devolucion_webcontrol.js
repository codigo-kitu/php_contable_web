...
class devolucion_webcontrol extends devolucion_webcontrol_add {
	...
	actualizarVariablesPagina(devolucion_control) {
		...
		if(devolucion_control.action=="index" || devolucion_control.action=="load") {
		...
		} else if(devolucion_control.action=="recargarFomularioGeneral") {
			...
			alert(devolucion_control.action + " Revisar Manejo");
			
			if(devolucion_control.bitEsAbrirVentanaAuxiliarUrl==true){
			...
			if(devolucion_control.bitEsEjecutarFuncionJavaScript==true){
				this.actualizarPaginaEjecutarJavaScript(devolucion_control);
			}
			...
			if(devolucion_control.paramDivSeccion.bitDivsEsCargarGeneralAjaxWebPart==true) {		
				this.actualizarPaginaCargaGeneral(devolucion_control);	
			}
			
			if(devolucion_control.paramDivSeccion.bitDivEsCargarAjaxWebPart==true) {
				this.actualizarPaginaTablaDatos(devolucion_control);
			}
			
			if(devolucion_control.paramDivSeccion.bitDivsEsCargarMostrarAjaxWebPart==true) {		
			...
			if(devolucion_control.paramDivSeccion.bitDivsEsCargarMostrarSoloBusquedasAjaxWebPart==true) {		
				this.actualizarPaginaAreaBusquedas(devolucion_control);	
			}
			
			if(devolucion_control.paramDivSeccion.bitDivsEsCargarMostrarSoloMantenimientosAjaxWebPart==true) {		
			...
			if(devolucion_control.paramDivSeccion.bitDivEsCargarMantenimientosAjaxWebPart==true) {				
				this.actualizarPaginaTablaFilaActual(devolucion_control);			
			}
			
			if(devolucion_control.paramDivSeccion.bitDivsEsCargarReporteAuxiliarAjaxWebPart==true) {				
				this.actualizarPaginaImprimir(devolucion_control);
			}
			
			
			if(devolucion_control.paramDivSeccion.bitDivsEsCargarMostrarBusquedasAjaxWebPart==true) {
				this.actualizarPaginaAreaAuxiliarBusquedas(devolucion_control);
			}
			
			if(devolucion_control.paramDivSeccion.bitDivsEsCargarResumenAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarResumen(devolucion_control);
			}				
			
			if(devolucion_control.paramDivSeccion.bitDivsEsCargarAccionesRelacionesAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarAccionesRelaciones(devolucion_control);
			}
			
			if(devolucion_control.usuarioActual!=null && devolucion_control.usuarioActual.field_strUserName!=null &&
			devolucion_control.usuarioActual.field_strUserName!=undefined ) {
				
				this.actualizarPaginaUsuarioInvitado(devolucion_control);			
			}
		}
...
//Funciones Auxiliares
	...
	actualizarPaginaTablaDatosAuxiliar(devolucion_control) {
		if(devolucion_funcion1.esPaginaForm()==true) {
	...
	actualizarPaginaEjecutarJavaScript(devolucion_control) {
		eval(devolucion_control.strFuncionJs);
	}
	
	actualizarPaginaMensajePantalla(devolucion_control, mostrar) {
		
		if(mostrar==true) {
			devolucion_funcion1.resaltarRestaurarDivsPagina(false);
			
			if(jQuery("#ParamsPostAccion-chbPostAccionSinCerrar").prop('checked')==false
				&& jQuery("#ParamsPostAccion-chbPostAccionNuevo").prop('checked')==false) {		
					
				devolucion_funcion1.resaltarRestaurarDivMantenimiento(false);
			}			
	...
	actualizarPaginaImprimir(devolucion_control) {
	
		funcionGeneral.printWebPartPage("devolucion",devolucion_control.htmlTablaReporteAuxiliars);			
			
		//jQuery("#divTablaDatosReporteAuxiliardevolucionsAjaxWebPart").html(devolucion_control.htmlTablaReporteAuxiliars);						
		//funcionGeneral.printWebPartPage("devolucion",jQuery("#divTablaDatosReporteAuxiliardevolucionsAjaxWebPart").html());			
	}
...
/*---------------------------------- AREA:FORMULARIO ---------------------------*/
	...
	actualizarCamposFormulario(devolucion_control) {
		...
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-tipo_cambio").val(devolucion_control.devolucionActual.tipo_cambio);
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-moneda").val(devolucion_control.devolucionActual.moneda);
		...
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-enviar_a").val(devolucion_control.devolucionActual.enviar_a);
		...
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-impuesto_en_precio").val(devolucion_control.devolucionActual.impuesto_en_precio);
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-nota").val(devolucion_control.devolucionActual.nota);
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-hora").val(devolucion_control.devolucionActual.hora);
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-tipo_envio").val(devolucion_control.devolucionActual.tipo_envio);
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-actualizado").val(devolucion_control.devolucionActual.actualizado);
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-computador").val(devolucion_control.devolucionActual.computador);
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-descuento_parcial_monto").val(devolucion_control.devolucionActual.descuento_parcial_monto);
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-impuesto2_porciento").val(devolucion_control.devolucionActual.impuesto2_porciento);
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-impuesto2_monto").val(devolucion_control.devolucionActual.impuesto2_monto);
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-nro_factura_proveedor").val(devolucion_control.devolucionActual.nro_factura_proveedor);
		...
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-devolucion_cancelada").prop('checked',devolucion_control.devolucionActual.devolucion_cancelada);
	...
	actualizarSpanMensajesCampos(devolucion_control) {
		...
		jQuery("#spanstrMensajetipo_cambio").text(devolucion_control.strMensajetipo_cambio);		
		jQuery("#spanstrMensajemoneda").text(devolucion_control.strMensajemoneda);		
		...
		jQuery("#spanstrMensajeenviar_a").text(devolucion_control.strMensajeenviar_a);		
		...
		jQuery("#spanstrMensajenota").text(devolucion_control.strMensajenota);		
		jQuery("#spanstrMensajehora").text(devolucion_control.strMensajehora);		
		jQuery("#spanstrMensajetipo_envio").text(devolucion_control.strMensajetipo_envio);		
		jQuery("#spanstrMensajeactualizado").text(devolucion_control.strMensajeactualizado);		
		jQuery("#spanstrMensajecomputador").text(devolucion_control.strMensajecomputador);		
		jQuery("#spanstrMensajedescuento_parcial_monto").text(devolucion_control.strMensajedescuento_parcial_monto);		
		jQuery("#spanstrMensajeimpuesto2_porciento").text(devolucion_control.strMensajeimpuesto2_porciento);		
		jQuery("#spanstrMensajeimpuesto2_monto").text(devolucion_control.strMensajeimpuesto2_monto);		
		jQuery("#spanstrMensajenro_factura_proveedor").text(devolucion_control.strMensajenro_factura_proveedor);		
		...
		jQuery("#spanstrMensajedevolucion_cancelada").text(devolucion_control.strMensajedevolucion_cancelada);		
...
/*---------------------------------- AREA:TABLA ---------------------------*/
	...
	actualizarCamposFilaTabla(devolucion_control) {
		...
		if(devolucion_control.devolucionActual.id_empresa!=null && devolucion_control.devolucionActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_2").val() != devolucion_control.devolucionActual.id_empresa) {
				jQuery("#t-cel_"+i+"_2").val(devolucion_control.devolucionActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(devolucion_control.devolucionActual.id_sucursal!=null && devolucion_control.devolucionActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != devolucion_control.devolucionActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_3").val(devolucion_control.devolucionActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(devolucion_control.devolucionActual.id_ejercicio!=null && devolucion_control.devolucionActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != devolucion_control.devolucionActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_4").val(devolucion_control.devolucionActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(devolucion_control.devolucionActual.id_periodo!=null && devolucion_control.devolucionActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != devolucion_control.devolucionActual.id_periodo) {
				jQuery("#t-cel_"+i+"_5").val(devolucion_control.devolucionActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(devolucion_control.devolucionActual.id_usuario!=null && devolucion_control.devolucionActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != devolucion_control.devolucionActual.id_usuario) {
				jQuery("#t-cel_"+i+"_6").val(devolucion_control.devolucionActual.id_usuario).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(devolucion_control.devolucionActual.numero);
		
		if(devolucion_control.devolucionActual.id_proveedor!=null && devolucion_control.devolucionActual.id_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != devolucion_control.devolucionActual.id_proveedor) {
				jQuery("#t-cel_"+i+"_8").val(devolucion_control.devolucionActual.id_proveedor).trigger("change");
			}
		} else { 
		...
		if(devolucion_control.devolucionActual.id_vendedor!=null && devolucion_control.devolucionActual.id_vendedor>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != devolucion_control.devolucionActual.id_vendedor) {
				jQuery("#t-cel_"+i+"_9").val(devolucion_control.devolucionActual.id_vendedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_10").val(devolucion_control.devolucionActual.ruc);
		jQuery("#t-cel_"+i+"_11").val(devolucion_control.devolucionActual.fecha_emision);
		
		if(devolucion_control.devolucionActual.id_termino_pago_proveedor!=null && devolucion_control.devolucionActual.id_termino_pago_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_12").val() != devolucion_control.devolucionActual.id_termino_pago_proveedor) {
				jQuery("#t-cel_"+i+"_12").val(devolucion_control.devolucionActual.id_termino_pago_proveedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_13").val(devolucion_control.devolucionActual.fecha_vence);
		jQuery("#t-cel_"+i+"_14").val(devolucion_control.devolucionActual.tipo_cambio);
		jQuery("#t-cel_"+i+"_15").val(devolucion_control.devolucionActual.moneda);
		
		if(devolucion_control.devolucionActual.id_estado!=null && devolucion_control.devolucionActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_16").val() != devolucion_control.devolucionActual.id_estado) {
				jQuery("#t-cel_"+i+"_16").val(devolucion_control.devolucionActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_17").val(devolucion_control.devolucionActual.direccion);
		jQuery("#t-cel_"+i+"_18").val(devolucion_control.devolucionActual.enviar_a);
		jQuery("#t-cel_"+i+"_19").val(devolucion_control.devolucionActual.observacion);
		jQuery("#t-cel_"+i+"_20").val(devolucion_control.devolucionActual.sub_total);
		jQuery("#t-cel_"+i+"_21").val(devolucion_control.devolucionActual.descuento_monto);
		jQuery("#t-cel_"+i+"_22").val(devolucion_control.devolucionActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_23").val(devolucion_control.devolucionActual.iva_monto);
		jQuery("#t-cel_"+i+"_24").val(devolucion_control.devolucionActual.iva_porciento);
		jQuery("#t-cel_"+i+"_25").val(devolucion_control.devolucionActual.total);
		jQuery("#t-cel_"+i+"_26").val(devolucion_control.devolucionActual.otro_monto);
		jQuery("#t-cel_"+i+"_27").val(devolucion_control.devolucionActual.otro_porciento);
		jQuery("#t-cel_"+i+"_28").val(devolucion_control.devolucionActual.impuesto_en_precio);
		jQuery("#t-cel_"+i+"_29").val(devolucion_control.devolucionActual.nota);
		jQuery("#t-cel_"+i+"_30").val(devolucion_control.devolucionActual.hora);
		jQuery("#t-cel_"+i+"_31").val(devolucion_control.devolucionActual.tipo_envio);
		jQuery("#t-cel_"+i+"_32").val(devolucion_control.devolucionActual.actualizado);
		jQuery("#t-cel_"+i+"_33").val(devolucion_control.devolucionActual.computador);
		jQuery("#t-cel_"+i+"_34").val(devolucion_control.devolucionActual.descuento_parcial_monto);
		jQuery("#t-cel_"+i+"_35").val(devolucion_control.devolucionActual.impuesto2_porciento);
		jQuery("#t-cel_"+i+"_36").val(devolucion_control.devolucionActual.impuesto2_monto);
		jQuery("#t-cel_"+i+"_37").val(devolucion_control.devolucionActual.nro_factura_proveedor);
		jQuery("#t-cel_"+i+"_38").val(devolucion_control.devolucionActual.envia);
		jQuery("#t-cel_"+i+"_39").val(devolucion_control.devolucionActual.pago);
		jQuery("#t-cel_"+i+"_40").prop('checked',devolucion_control.devolucionActual.devolucion_cancelada);
		
		if(devolucion_control.devolucionActual.id_asiento!=null && devolucion_control.devolucionActual.id_asiento>-1){
			if(jQuery("#t-cel_"+i+"_41").val() != devolucion_control.devolucionActual.id_asiento) {
				jQuery("#t-cel_"+i+"_41").val(devolucion_control.devolucionActual.id_asiento).trigger("change");
			}
		} else { 
		...
		if(devolucion_control.devolucionActual.id_documento_cuenta_pagar!=null && devolucion_control.devolucionActual.id_documento_cuenta_pagar>-1){
			if(jQuery("#t-cel_"+i+"_42").val() != devolucion_control.devolucionActual.id_documento_cuenta_pagar) {
				jQuery("#t-cel_"+i+"_42").val(devolucion_control.devolucionActual.id_documento_cuenta_pagar).trigger("change");
			}
		} else { 
		...
		if(devolucion_control.devolucionActual.id_kardex!=null && devolucion_control.devolucionActual.id_kardex>-1){
			if(jQuery("#t-cel_"+i+"_43").val() != devolucion_control.devolucionActual.id_kardex) {
				jQuery("#t-cel_"+i+"_43").val(devolucion_control.devolucionActual.id_kardex).trigger("change");
			}
		} else { 
	...
	registrarSesionParadevolucion_detalles(idActual){
		...
		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"devolucion","devolucion_detalle","inventario","",devolucion_funcion1,devolucion_webcontrol1,"s","");
	}
...
/*---------------------------------- AREA:FK ---------------------------*/
	...
	cargarCombosasientosFK(devolucion_control) {
		...
		if(devolucion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+devolucion_control.idFilaTablaActual+"_41",devolucion_control.asientosFK);
		}
	...
	cargarCombosdocumento_cuenta_pagarsFK(devolucion_control) {
		...
		if(devolucion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+devolucion_control.idFilaTablaActual+"_42",devolucion_control.documento_cuenta_pagarsFK);
		}
	...
	cargarComboskardexsFK(devolucion_control) {
		...
		if(devolucion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+devolucion_control.idFilaTablaActual+"_43",devolucion_control.kardexsFK);
		}
...
/*---------------------------------- AREA:AUXILIARES ---------------------------*/
	...
	registrarAccionesEventos() {	
		...
		jQuery(document).ready(function() {
			...
			funcionGeneralEventoJQuery.setImagenCerrarSesionClic("devolucion","inventario","",devolucion_funcion1,devolucion_webcontrol1);			
