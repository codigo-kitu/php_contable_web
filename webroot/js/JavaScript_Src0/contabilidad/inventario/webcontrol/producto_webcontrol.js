...
class producto_webcontrol extends producto_webcontrol_add {
	...
	actualizarVariablesPagina(producto_control) {
		...
		if(producto_control.action=="index" || producto_control.action=="load") {
		...
		} else if(producto_control.action=="recargarFomularioGeneral") {
			...
			alert(producto_control.action + " Revisar Manejo");
			
			if(producto_control.bitEsAbrirVentanaAuxiliarUrl==true){
			...
			if(producto_control.bitEsEjecutarFuncionJavaScript==true){
				this.actualizarPaginaEjecutarJavaScript(producto_control);
			}
			...
			if(producto_control.paramDivSeccion.bitDivsEsCargarGeneralAjaxWebPart==true) {		
				this.actualizarPaginaCargaGeneral(producto_control);	
			}
			
			if(producto_control.paramDivSeccion.bitDivEsCargarAjaxWebPart==true) {
				this.actualizarPaginaTablaDatos(producto_control);
			}
			
			if(producto_control.paramDivSeccion.bitDivsEsCargarMostrarAjaxWebPart==true) {		
			...
			if(producto_control.paramDivSeccion.bitDivsEsCargarMostrarSoloBusquedasAjaxWebPart==true) {		
				this.actualizarPaginaAreaBusquedas(producto_control);	
			}
			
			if(producto_control.paramDivSeccion.bitDivsEsCargarMostrarSoloMantenimientosAjaxWebPart==true) {		
			...
			if(producto_control.paramDivSeccion.bitDivEsCargarMantenimientosAjaxWebPart==true) {				
				this.actualizarPaginaTablaFilaActual(producto_control);			
			}
			
			if(producto_control.paramDivSeccion.bitDivsEsCargarReporteAuxiliarAjaxWebPart==true) {				
				this.actualizarPaginaImprimir(producto_control);
			}
			
			
			if(producto_control.paramDivSeccion.bitDivsEsCargarMostrarBusquedasAjaxWebPart==true) {
				this.actualizarPaginaAreaAuxiliarBusquedas(producto_control);
			}
			
			if(producto_control.paramDivSeccion.bitDivsEsCargarResumenAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarResumen(producto_control);
			}				
			
			if(producto_control.paramDivSeccion.bitDivsEsCargarAccionesRelacionesAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarAccionesRelaciones(producto_control);
			}
			
			if(producto_control.usuarioActual!=null && producto_control.usuarioActual.field_strUserName!=null &&
			producto_control.usuarioActual.field_strUserName!=undefined ) {
				
				this.actualizarPaginaUsuarioInvitado(producto_control);			
			}
		}
...
//Funciones Auxiliares
	...
	actualizarPaginaTablaDatosAuxiliar(producto_control) {
		if(producto_funcion1.esPaginaForm()==true) {
	...
	actualizarPaginaEjecutarJavaScript(producto_control) {
		eval(producto_control.strFuncionJs);
	}
	
	actualizarPaginaMensajePantalla(producto_control, mostrar) {
		
		if(mostrar==true) {
			producto_funcion1.resaltarRestaurarDivsPagina(false);
			
			if(jQuery("#ParamsPostAccion-chbPostAccionSinCerrar").prop('checked')==false
				&& jQuery("#ParamsPostAccion-chbPostAccionNuevo").prop('checked')==false) {		
					
				producto_funcion1.resaltarRestaurarDivMantenimiento(false);
			}			
	...
	actualizarPaginaImprimir(producto_control) {
	
		funcionGeneral.printWebPartPage("producto",producto_control.htmlTablaReporteAuxiliars);			
			
		//jQuery("#divTablaDatosReporteAuxiliarproductosAjaxWebPart").html(producto_control.htmlTablaReporteAuxiliars);						
		//funcionGeneral.printWebPartPage("producto",jQuery("#divTablaDatosReporteAuxiliarproductosAjaxWebPart").html());			
	}
...
/*---------------------------------- AREA:FORMULARIO ---------------------------*/
	...
	actualizarCamposFormulario(producto_control) {
		...
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-version_row").val(producto_control.productoActual.versionRow);
		...
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-impuesto_en_ventas").prop('checked',producto_control.productoActual.impuesto_en_ventas);
		...
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-impuesto_en_compras").prop('checked',producto_control.productoActual.impuesto_en_compras);
		...
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-equivalencia_en_compra").val(producto_control.productoActual.equivalencia_en_compra);
		...
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-equivalencia_en_venta").val(producto_control.productoActual.equivalencia_en_venta);
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-incremento1").val(producto_control.productoActual.incremento1);
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-incremento2").val(producto_control.productoActual.incremento2);
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-incremento3").val(producto_control.productoActual.incremento3);
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-incremento4").val(producto_control.productoActual.incremento4);
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-notas").val(producto_control.productoActual.notas);
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-imagen").val(producto_control.productoActual.imagen);
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-comentario").val(producto_control.productoActual.comentario);
		...
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-requiere_nro_serie").prop('checked',producto_control.productoActual.requiere_nro_serie);
		...
		if(producto_control.productoActual.id_cuenta_inventario!=null && producto_control.productoActual.id_cuenta_inventario>-1){
			if(jQuery("#form"+producto_constante1.STR_SUFIJO+"-id_cuenta_inventario").val() != producto_control.productoActual.id_cuenta_inventario) {
				jQuery("#form"+producto_constante1.STR_SUFIJO+"-id_cuenta_inventario").val(producto_control.productoActual.id_cuenta_inventario).trigger("change");
			}
		} else { 
			if(jQuery("#form"+producto_constante1.STR_SUFIJO+"-id_cuenta_inventario").val()!=constantes.INT_VALOR_ESCOJA_OPCION) {
				jQuery("#form"+producto_constante1.STR_SUFIJO+"-id_cuenta_inventario").val(constantes.INT_VALOR_ESCOJA_OPCION).trigger("change");
			}
		}
		...
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-precio_de_compra_0").val(producto_control.productoActual.precio_de_compra_0);
		...
		jQuery("#form"+producto_constante1.STR_SUFIJO+"-situacion_producto").val(producto_control.productoActual.situacion_producto);
	...
	cargarCombosFK(producto_control) {
		//CARGA INICIAL O RECARGAR COMBOS
			...
			if(producto_control.strRecargarFkTipos=="TODOS" || funcionGeneral.existeCadenaSplit("id_cuenta_inventario",producto_control.strRecargarFkTipos,",")) { 
				producto_webcontrol1.cargarComboscuenta_inventariosFK(producto_control);
			}
		...
		if(producto_control.strRecargarFkTiposNinguno!=null && producto_control.strRecargarFkTiposNinguno!='NINGUNO' && producto_control.strRecargarFkTiposNinguno!='') {
				...
				if(producto_control.strRecargarFkTiposNinguno!="NINGUNO" && funcionGeneral.existeCadenaSplit("id_cuenta_inventario",producto_control.strRecargarFkTiposNinguno,",")) { 
					producto_webcontrol1.cargarComboscuenta_inventariosFK(producto_control);
				}
	...
	actualizarSpanMensajesCampos(producto_control) {
		...
		jQuery("#spanstrMensajeversion_row").text(producto_control.strMensajeversion_row);		
		...
		jQuery("#spanstrMensajeimpuesto_en_ventas").text(producto_control.strMensajeimpuesto_en_ventas);		
		jQuery("#spanstrMensajeotro_impuesto_ventas").text(producto_control.strMensajeotro_impuesto_ventas);		
		jQuery("#spanstrMensajeimpuesto_en_compras").text(producto_control.strMensajeimpuesto_en_compras);		
		...
		jQuery("#spanstrMensajeequivalencia_en_compra").text(producto_control.strMensajeequivalencia_en_compra);		
		jQuery("#spanstrMensajeid_unidad_venta").text(producto_control.strMensajeid_unidad_venta);		
		jQuery("#spanstrMensajeequivalencia_en_venta").text(producto_control.strMensajeequivalencia_en_venta);		
		jQuery("#spanstrMensajeincremento1").text(producto_control.strMensajeincremento1);		
		jQuery("#spanstrMensajeincremento2").text(producto_control.strMensajeincremento2);		
		jQuery("#spanstrMensajeincremento3").text(producto_control.strMensajeincremento3);		
		jQuery("#spanstrMensajeincremento4").text(producto_control.strMensajeincremento4);		
		jQuery("#spanstrMensajenotas").text(producto_control.strMensajenotas);		
		jQuery("#spanstrMensajeimagen").text(producto_control.strMensajeimagen);		
		jQuery("#spanstrMensajecomentario").text(producto_control.strMensajecomentario);		
		...
		jQuery("#spanstrMensajerequiere_nro_serie").text(producto_control.strMensajerequiere_nro_serie);		
		...
		jQuery("#spanstrMensajeid_cuenta_inventario").text(producto_control.strMensajeid_cuenta_inventario);		
		...
		jQuery("#spanstrMensajeprecio_de_compra_0").text(producto_control.strMensajeprecio_de_compra_0);		
		...
		jQuery("#spanstrMensajesituacion_producto").text(producto_control.strMensajesituacion_producto);		
	...
	cargarComboEditarTablacuenta_inventarioFK(producto_control,control_name,idActual,para_evento) {
		funcionGeneralJQuery.cargarCombosForeignKeyEditar(control_name,para_evento,idActual,producto_funcion1,producto_control.cuenta_inventariosFK);
	}
...
/*---------------------------------- AREA:TABLA ---------------------------*/
	...
	actualizarCamposFilaTabla(producto_control) {
		...
		jQuery("#t-cel_"+i+"_12").prop('checked',producto_control.productoActual.impuesto_en_ventas);
		jQuery("#t-cel_"+i+"_13").prop('checked',producto_control.productoActual.otro_impuesto_ventas);
		jQuery("#t-cel_"+i+"_14").prop('checked',producto_control.productoActual.impuesto_en_compras);
		...
		jQuery("#t-cel_"+i+"_20").val(producto_control.productoActual.equivalencia_en_compra);
		...
		jQuery("#t-cel_"+i+"_22").val(producto_control.productoActual.equivalencia_en_venta);
		jQuery("#t-cel_"+i+"_23").val(producto_control.productoActual.incremento1);
		jQuery("#t-cel_"+i+"_24").val(producto_control.productoActual.incremento2);
		jQuery("#t-cel_"+i+"_25").val(producto_control.productoActual.incremento3);
		jQuery("#t-cel_"+i+"_26").val(producto_control.productoActual.incremento4);
		jQuery("#t-cel_"+i+"_27").val(producto_control.productoActual.notas);
		jQuery("#t-cel_"+i+"_28").val(producto_control.productoActual.imagen);
		jQuery("#t-cel_"+i+"_29").val(producto_control.productoActual.comentario);
		jQuery("#t-cel_"+i+"_30").prop('checked',producto_control.productoActual.comenta_factura);
		jQuery("#t-cel_"+i+"_31").val(producto_control.productoActual.codigo_fabricante);
		jQuery("#t-cel_"+i+"_32").val(producto_control.productoActual.cantidad);
		jQuery("#t-cel_"+i+"_33").val(producto_control.productoActual.cantidad_maxima);
		jQuery("#t-cel_"+i+"_34").val(producto_control.productoActual.cantidad_minima);
		jQuery("#t-cel_"+i+"_35").prop('checked',producto_control.productoActual.factura_sin_stock);
		jQuery("#t-cel_"+i+"_36").prop('checked',producto_control.productoActual.mostrar_componente);
		jQuery("#t-cel_"+i+"_37").prop('checked',producto_control.productoActual.producto_equivalente);
		jQuery("#t-cel_"+i+"_38").prop('checked',producto_control.productoActual.avisa_expiracion);
		jQuery("#t-cel_"+i+"_39").prop('checked',producto_control.productoActual.requiere_nro_serie);
		jQuery("#t-cel_"+i+"_40").prop('checked',producto_control.productoActual.acepta_lote);
		
		if(producto_control.productoActual.id_cuenta_venta!=null && producto_control.productoActual.id_cuenta_venta>-1){
			if(jQuery("#t-cel_"+i+"_41").val() != producto_control.productoActual.id_cuenta_venta) {
				jQuery("#t-cel_"+i+"_41").val(producto_control.productoActual.id_cuenta_venta).trigger("change");
			}
		} else { 
		...
		if(producto_control.productoActual.id_cuenta_compra!=null && producto_control.productoActual.id_cuenta_compra>-1){
			if(jQuery("#t-cel_"+i+"_42").val() != producto_control.productoActual.id_cuenta_compra) {
				jQuery("#t-cel_"+i+"_42").val(producto_control.productoActual.id_cuenta_compra).trigger("change");
			}
		} else { 
		...
		if(producto_control.productoActual.id_cuenta_inventario!=null && producto_control.productoActual.id_cuenta_inventario>-1){
			if(jQuery("#t-cel_"+i+"_43").val() != producto_control.productoActual.id_cuenta_inventario) {
				jQuery("#t-cel_"+i+"_43").val(producto_control.productoActual.id_cuenta_inventario).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_44").val(producto_control.productoActual.valor_inventario);
		jQuery("#t-cel_"+i+"_45").val(producto_control.productoActual.producto_fisico);
		jQuery("#t-cel_"+i+"_46").val(producto_control.productoActual.ultima_venta);
		jQuery("#t-cel_"+i+"_47").val(producto_control.productoActual.precio_de_compra_0);
		jQuery("#t-cel_"+i+"_48").val(producto_control.productoActual.precio_actualizado);
		
		if(producto_control.productoActual.id_retencion!=null && producto_control.productoActual.id_retencion>-1){
			if(jQuery("#t-cel_"+i+"_49").val() != producto_control.productoActual.id_retencion) {
				jQuery("#t-cel_"+i+"_49").val(producto_control.productoActual.id_retencion).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_50").prop('checked',producto_control.productoActual.retencion_ventas);
		jQuery("#t-cel_"+i+"_51").prop('checked',producto_control.productoActual.retencion_compras);
		jQuery("#t-cel_"+i+"_52").val(producto_control.productoActual.situacion_producto);
		jQuery("#t-cel_"+i+"_53").val(producto_control.productoActual.factura_con_precio);
	}
	...
	registrarSesionParaproducto_bodegas(idActual){
		...
		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"producto","producto_bodega","inventario","",producto_funcion1,producto_webcontrol1,"s","");
	}

	registrarSesionParaotro_suplidores(idActual){

		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"producto","otro_suplidor","inventario","",producto_funcion1,producto_webcontrol1,"es","");
	}

	registrarSesionParaimagen_productos(idActual){

		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"producto","imagen_producto","inventario","",producto_funcion1,producto_webcontrol1,"s","");
	}

	registrarSesionParalista_precioes(idActual){

		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"producto","lista_precio","inventario","",producto_funcion1,producto_webcontrol1,"es","");
	}

	registrarSesionParalista_productoes(idActual){

		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"producto","lista_producto","inventario","",producto_funcion1,producto_webcontrol1,"es","");
	}

	registrarSesionParalista_clientes(idActual){

		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"producto","lista_cliente","inventario","",producto_funcion1,producto_webcontrol1,"s","");
	}
...
/*---------------------------------- AREA:FK ---------------------------*/
	...
	cargarComboscuenta_ventasFK(producto_control) {
		...
		if(producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+producto_control.idFilaTablaActual+"_41",producto_control.cuenta_ventasFK);
		}
	...
	cargarComboscuenta_comprasFK(producto_control) {
		...
		if(producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+producto_control.idFilaTablaActual+"_42",producto_control.cuenta_comprasFK);
		}
	...
	cargarComboscuenta_inventariosFK(producto_control) {

		funcionGeneralJQuery.cargarCombosForeignKeyIndices("#form"+producto_constante1.STR_SUFIJO+"-id_cuenta_inventario",producto_control.cuenta_inventariosFK);

		if(producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+producto_control.idFilaTablaActual+"_43",producto_control.cuenta_inventariosFK);
		}
		funcionGeneralJQuery.cargarCombosForeignKeyIndices("#"+producto_constante1.STR_SUFIJO+"FK_Idcuenta_inventario-cmbid_cuenta_inventario",producto_control.cuenta_inventariosFK);
	...
	cargarCombosretencionsFK(producto_control) {
		...
		if(producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+producto_control.idFilaTablaActual+"_49",producto_control.retencionsFK);
		}
	...
	registrarComboActionChangeComboscuenta_inventariosFK(producto_control) {
	...
	setDefectoValorComboscuenta_inventariosFK(producto_control) {

		if(constantes.STR_TIPO_COMBO=="select2") {
			if(producto_control.idcuenta_inventarioDefaultFK>-1 && jQuery("#form"+producto_constante1.STR_SUFIJO+"-id_cuenta_inventario").val() != producto_control.idcuenta_inventarioDefaultFK) {
				jQuery("#form"+producto_constante1.STR_SUFIJO+"-id_cuenta_inventario").val(producto_control.idcuenta_inventarioDefaultFK).trigger("change");
			}
		}

		if(constantes.STR_TIPO_COMBO=="select2") {
			//jQuery("#"+producto_constante1.STR_SUFIJO+"FK_Idcuenta_inventario-cmbid_cuenta_inventario").val(producto_control.idcuenta_inventarioDefaultForeignKey).trigger("change");
			if(jQuery("#"+producto_constante1.STR_SUFIJO+"FK_Idcuenta_inventario-cmbid_cuenta_inventario").val() != constantes.INT_VALOR_ESCOJA_OPCION) {
				jQuery("#"+producto_constante1.STR_SUFIJO+"FK_Idcuenta_inventario-cmbid_cuenta_inventario").val(constantes.INT_VALOR_ESCOJA_OPCION).trigger("change");
			}
		}
...
/*---------------------------------- AREA:AUXILIARES ---------------------------*/
	...
	onLoadCombosDefectoFK(producto_control) {
		...
		if(constantes.STR_TIPO_COMBO=="select2") {
			...
			if(producto_control.strRecargarFkTipos=="TODOS" || funcionGeneral.existeCadenaSplit("id_cuenta_inventario",producto_control.strRecargarFkTipos,",")) { 
				producto_webcontrol1.setDefectoValorComboscuenta_inventariosFK(producto_control);
			}
	...
	onLoadCombosEventosFK(producto_control) {
		...
		if(constantes.STR_TIPO_COMBO=="select2") {
			...
			//if(producto_control.strRecargarFkTipos=="TODOS" || funcionGeneral.existeCadenaSplit("id_cuenta_inventario",producto_control.strRecargarFkTipos,",")) { 
				...
				//REGISTRAR EVENTOS COMBO
				producto_webcontrol1.registrarComboActionChangeComboscuenta_inventariosFK(producto_control);
			//}
	...
	registrarAccionesEventos() {	
		...
		jQuery(document).ready(function() {
			...
			funcionGeneralEventoJQuery.setImagenCerrarSesionClic("producto","inventario","",producto_funcion1,producto_webcontrol1);			
			...
			funcionGeneralEventoJQuery.setImagenForeingKeyAbrirClic("cuenta","id_cuenta_inventario","contabilidad","",producto_funcion1,producto_webcontrol1,producto_constante1);

			//FK IMAGENES BUSQUEDA DATOS
			jQuery("#form"+producto_constante1.STR_SUFIJO+"-id_cuenta_inventario_img_busqueda").click(function(){
				producto_webcontrol1.abrirBusquedaParacuenta("id_cuenta_inventario");
