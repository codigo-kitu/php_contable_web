...
class cotizacion_detalle_webcontrol extends cotizacion_detalle_webcontrol_add {
	...
	actualizarVariablesPagina(cotizacion_detalle_control) {
		...
		if(cotizacion_detalle_control.action=="index" || cotizacion_detalle_control.action=="load") {
		...
		} else if(cotizacion_detalle_control.action=="recargarFomularioGeneral") {
			...
			alert(cotizacion_detalle_control.action + " Revisar Manejo");
			
			if(cotizacion_detalle_control.bitEsAbrirVentanaAuxiliarUrl==true){
			...
			if(cotizacion_detalle_control.bitEsEjecutarFuncionJavaScript==true){
				this.actualizarPaginaEjecutarJavaScript(cotizacion_detalle_control);
			}
			...
			if(cotizacion_detalle_control.paramDivSeccion.bitDivsEsCargarGeneralAjaxWebPart==true) {		
				this.actualizarPaginaCargaGeneral(cotizacion_detalle_control);	
			}
			
			if(cotizacion_detalle_control.paramDivSeccion.bitDivEsCargarAjaxWebPart==true) {
				this.actualizarPaginaTablaDatos(cotizacion_detalle_control);
			}
			
			if(cotizacion_detalle_control.paramDivSeccion.bitDivsEsCargarMostrarAjaxWebPart==true) {		
			...
			if(cotizacion_detalle_control.paramDivSeccion.bitDivsEsCargarMostrarSoloBusquedasAjaxWebPart==true) {		
				this.actualizarPaginaAreaBusquedas(cotizacion_detalle_control);	
			}
			
			if(cotizacion_detalle_control.paramDivSeccion.bitDivsEsCargarMostrarSoloMantenimientosAjaxWebPart==true) {		
			...
			if(cotizacion_detalle_control.paramDivSeccion.bitDivEsCargarMantenimientosAjaxWebPart==true) {				
				this.actualizarPaginaTablaFilaActual(cotizacion_detalle_control);			
			}
			
			if(cotizacion_detalle_control.paramDivSeccion.bitDivsEsCargarReporteAuxiliarAjaxWebPart==true) {				
				this.actualizarPaginaImprimir(cotizacion_detalle_control);
			}
			
			
			if(cotizacion_detalle_control.paramDivSeccion.bitDivsEsCargarMostrarBusquedasAjaxWebPart==true) {
				this.actualizarPaginaAreaAuxiliarBusquedas(cotizacion_detalle_control);
			}
			
			if(cotizacion_detalle_control.paramDivSeccion.bitDivsEsCargarResumenAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarResumen(cotizacion_detalle_control);
			}				
			
			if(cotizacion_detalle_control.paramDivSeccion.bitDivsEsCargarAccionesRelacionesAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarAccionesRelaciones(cotizacion_detalle_control);
			}
			
			if(cotizacion_detalle_control.usuarioActual!=null && cotizacion_detalle_control.usuarioActual.field_strUserName!=null &&
			cotizacion_detalle_control.usuarioActual.field_strUserName!=undefined ) {
				
				this.actualizarPaginaUsuarioInvitado(cotizacion_detalle_control);			
			}
		}
...
//Funciones Auxiliares
	...
	actualizarPaginaTablaDatosAuxiliar(cotizacion_detalle_control) {
		if(cotizacion_detalle_funcion1.esPaginaForm()==true) {
	...
	actualizarPaginaEjecutarJavaScript(cotizacion_detalle_control) {
		eval(cotizacion_detalle_control.strFuncionJs);
	}
	
	actualizarPaginaMensajePantalla(cotizacion_detalle_control, mostrar) {
		
		if(mostrar==true) {
			cotizacion_detalle_funcion1.resaltarRestaurarDivsPagina(false);
			
			if(jQuery("#ParamsPostAccion-chbPostAccionSinCerrar").prop('checked')==false
				&& jQuery("#ParamsPostAccion-chbPostAccionNuevo").prop('checked')==false) {		
					
				cotizacion_detalle_funcion1.resaltarRestaurarDivMantenimiento(false);
			}			
	...
	actualizarPaginaImprimir(cotizacion_detalle_control) {
	
		funcionGeneral.printWebPartPage("cotizacion_detalle",cotizacion_detalle_control.htmlTablaReporteAuxiliars);			
			
		//jQuery("#divTablaDatosReporteAuxiliarcotizacion_detallesAjaxWebPart").html(cotizacion_detalle_control.htmlTablaReporteAuxiliars);						
		//funcionGeneral.printWebPartPage("cotizacion_detalle",jQuery("#divTablaDatosReporteAuxiliarcotizacion_detallesAjaxWebPart").html());			
	}
...
/*---------------------------------- AREA:FORMULARIO ---------------------------*/
	...
	actualizarCamposFormulario(cotizacion_detalle_control) {
		...
		jQuery("#form"+cotizacion_detalle_constante1.STR_SUFIJO+"-fecha_emision").val(cotizacion_detalle_control.cotizacion_detalleActual.fecha_emision);
		jQuery("#form"+cotizacion_detalle_constante1.STR_SUFIJO+"-comentario").val(cotizacion_detalle_control.cotizacion_detalleActual.comentario);
		jQuery("#form"+cotizacion_detalle_constante1.STR_SUFIJO+"-tipo_cambio").val(cotizacion_detalle_control.cotizacion_detalleActual.tipo_cambio);
		jQuery("#form"+cotizacion_detalle_constante1.STR_SUFIJO+"-moneda").val(cotizacion_detalle_control.cotizacion_detalleActual.moneda);
	...
	actualizarSpanMensajesCampos(cotizacion_detalle_control) {
		...
		jQuery("#spanstrMensajefecha_emision").text(cotizacion_detalle_control.strMensajefecha_emision);		
		jQuery("#spanstrMensajecomentario").text(cotizacion_detalle_control.strMensajecomentario);		
		jQuery("#spanstrMensajetipo_cambio").text(cotizacion_detalle_control.strMensajetipo_cambio);		
		jQuery("#spanstrMensajemoneda").text(cotizacion_detalle_control.strMensajemoneda);		
...
/*---------------------------------- AREA:TABLA ---------------------------*/
	...
	actualizarCamposFilaTabla(cotizacion_detalle_control) {
		...
		jQuery("#t-cel_"+i+"_8").val(cotizacion_detalle_control.cotizacion_detalleActual.sub_total);
		jQuery("#t-cel_"+i+"_9").val(cotizacion_detalle_control.cotizacion_detalleActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_10").val(cotizacion_detalle_control.cotizacion_detalleActual.descuento_monto);
		...
		jQuery("#t-cel_"+i+"_14").val(cotizacion_detalle_control.cotizacion_detalleActual.impuesto2_porciento);
		jQuery("#t-cel_"+i+"_15").val(cotizacion_detalle_control.cotizacion_detalleActual.impuesto2_monto);
		jQuery("#t-cel_"+i+"_16").val(cotizacion_detalle_control.cotizacion_detalleActual.fecha_emision);
		jQuery("#t-cel_"+i+"_17").val(cotizacion_detalle_control.cotizacion_detalleActual.comentario);
		jQuery("#t-cel_"+i+"_18").val(cotizacion_detalle_control.cotizacion_detalleActual.tipo_cambio);
		jQuery("#t-cel_"+i+"_19").val(cotizacion_detalle_control.cotizacion_detalleActual.moneda);
		
		if(cotizacion_detalle_control.cotizacion_detalleActual.id_otro_suplidor!=null && cotizacion_detalle_control.cotizacion_detalleActual.id_otro_suplidor>-1){
			if(jQuery("#t-cel_"+i+"_20").val() != cotizacion_detalle_control.cotizacion_detalleActual.id_otro_suplidor) {
				jQuery("#t-cel_"+i+"_20").val(cotizacion_detalle_control.cotizacion_detalleActual.id_otro_suplidor).trigger("change");
			}
		} else { 
...
/*---------------------------------- AREA:FK ---------------------------*/
	...
	cargarCombosotro_suplidorsFK(cotizacion_detalle_control) {
		...
		if(cotizacion_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cotizacion_detalle_control.idFilaTablaActual+"_20",cotizacion_detalle_control.otro_suplidorsFK);
		}
...
/*---------------------------------- AREA:AUXILIARES ---------------------------*/
	...
	registrarAccionesEventos() {	
		...
		jQuery(document).ready(function() {
			...
			funcionGeneralEventoJQuery.setImagenCerrarSesionClic("cotizacion_detalle","inventario","",cotizacion_detalle_funcion1,cotizacion_detalle_webcontrol1);			
