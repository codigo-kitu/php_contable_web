...
//var retiro_cuenta_corrienteFuncionGeneral= function () {

class retiro_cuenta_corriente_funcion {
...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(retiro_cuenta_corriente_constante1.STR_RELATIVE_PATH,"retiro_cuenta_corriente");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(retiro_cuenta_corriente_constante1.STR_RELATIVE_PATH,retiro_cuenta_corriente_constante1.STR_NOMBRE_OPCION,"retiro_cuenta_corriente");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(retiro_cuenta_corriente_constante1.STR_RELATIVE_PATH,retiro_cuenta_corriente_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Clic-Cancelar -------------------
	...
	cancelarControles() {
		...
		funcionGeneral.setCheckControl(document.frmMantenimientoretiro_cuenta_corriente.chbes_balance_inicial,false);
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(retiro_cuenta_corriente_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(retiro_cuenta_corriente_constante1.STR_RELATIVE_PATH,"retiro_cuenta_corriente");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(retiro_cuenta_corriente_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(retiro_cuenta_corriente_constante1.STR_RELATIVE_PATH,"retiro_cuenta_corriente");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(retiro_cuenta_corriente_constante1.STR_RELATIVE_PATH,"retiro_cuenta_corriente");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"retiro_cuenta_corriente");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(retiro_cuenta_corriente_constante1.BIT_CON_PAGINA_FORM==true && retiro_cuenta_corriente_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
		...
		if(retiro_cuenta_corriente_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				messages: {
					...
					"form_retiro_cuenta_corriente-descripcion": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"retiro_cuenta_corriente");
	}
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			...
			funcionGeneral.setDisabledControl(document.frmMantenimientoretiro_cuenta_corriente.chbes_balance_inicial,false);
			...
			funcionGeneral.setDisabledControl(document.frmMantenimientoretiro_cuenta_corriente.chbes_balance_inicial,true);
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"retiro_cuenta_corriente");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"retiro_cuenta_corriente");
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(retiro_cuenta_corriente_control,retiro_cuenta_corriente_webcontrol1,retiro_cuenta_corriente_constante1) {
		
		var strSuf=retiro_cuenta_corriente_constante1.STR_SUFIJO;
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(retiro_cuenta_corriente_control.idempresaDefaultForeignKey!=null && retiro_cuenta_corriente_control.idempresaDefaultForeignKey>-1) {
					idActual=retiro_cuenta_corriente_control.idempresaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablaempresaFK(retiro_cuenta_corriente_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablaempresaFK(retiro_cuenta_corriente_control,control_name,idActual,true);
					}
				});
				...
				if(retiro_cuenta_corriente_control.idejercicioDefaultForeignKey!=null && retiro_cuenta_corriente_control.idejercicioDefaultForeignKey>-1) {
					idActual=retiro_cuenta_corriente_control.idejercicioDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablaejercicioFK(retiro_cuenta_corriente_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablaejercicioFK(retiro_cuenta_corriente_control,control_name,idActual,true);
					}
				});
				...
				if(retiro_cuenta_corriente_control.idperiodoDefaultForeignKey!=null && retiro_cuenta_corriente_control.idperiodoDefaultForeignKey>-1) {
					idActual=retiro_cuenta_corriente_control.idperiodoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablaperiodoFK(retiro_cuenta_corriente_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablaperiodoFK(retiro_cuenta_corriente_control,control_name,idActual,true);
					}
				});
				...
				if(retiro_cuenta_corriente_control.idusuarioDefaultForeignKey!=null && retiro_cuenta_corriente_control.idusuarioDefaultForeignKey>-1) {
					idActual=retiro_cuenta_corriente_control.idusuarioDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablausuarioFK(retiro_cuenta_corriente_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablausuarioFK(retiro_cuenta_corriente_control,control_name,idActual,true);
					}
				});
				...
				if(retiro_cuenta_corriente_control.idcuenta_corrienteDefaultForeignKey!=null && retiro_cuenta_corriente_control.idcuenta_corrienteDefaultForeignKey>-1) {
					idActual=retiro_cuenta_corriente_control.idcuenta_corrienteDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablacuenta_corrienteFK(retiro_cuenta_corriente_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablacuenta_corrienteFK(retiro_cuenta_corriente_control,control_name,idActual,true);
					}
				});
				...
				if(retiro_cuenta_corriente_control.idestado_deposito_retiroDefaultForeignKey!=null && retiro_cuenta_corriente_control.idestado_deposito_retiroDefaultForeignKey>-1) {
					idActual=retiro_cuenta_corriente_control.idestado_deposito_retiroDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablaestado_deposito_retiroFK(retiro_cuenta_corriente_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						retiro_cuenta_corriente_webcontrol1.cargarComboEditarTablaestado_deposito_retiroFK(retiro_cuenta_corriente_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatosretiro_cuenta_corriente").validate(json_rules);
