...
class cuenta_cobrar_detalle_webcontrol extends cuenta_cobrar_detalle_webcontrol_add {
	...
	actualizarVariablesPagina(cuenta_cobrar_detalle_control) {
		...
		if(cuenta_cobrar_detalle_control.action=="index" || cuenta_cobrar_detalle_control.action=="load") {
		...
		} else if(cuenta_cobrar_detalle_control.action=="recargarFomularioGeneral") {
			...
			alert(cuenta_cobrar_detalle_control.action + " Revisar Manejo");
			
			if(cuenta_cobrar_detalle_control.bitEsAbrirVentanaAuxiliarUrl==true){
			...
			if(cuenta_cobrar_detalle_control.bitEsEjecutarFuncionJavaScript==true){
				this.actualizarPaginaEjecutarJavaScript(cuenta_cobrar_detalle_control);
			}
			...
			if(cuenta_cobrar_detalle_control.paramDivSeccion.bitDivsEsCargarGeneralAjaxWebPart==true) {		
				this.actualizarPaginaCargaGeneral(cuenta_cobrar_detalle_control);	
			}
			
			if(cuenta_cobrar_detalle_control.paramDivSeccion.bitDivEsCargarAjaxWebPart==true) {
				this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);
			}
			
			if(cuenta_cobrar_detalle_control.paramDivSeccion.bitDivsEsCargarMostrarAjaxWebPart==true) {		
			...
			if(cuenta_cobrar_detalle_control.paramDivSeccion.bitDivsEsCargarMostrarSoloBusquedasAjaxWebPart==true) {		
				this.actualizarPaginaAreaBusquedas(cuenta_cobrar_detalle_control);	
			}
			
			if(cuenta_cobrar_detalle_control.paramDivSeccion.bitDivsEsCargarMostrarSoloMantenimientosAjaxWebPart==true) {		
			...
			if(cuenta_cobrar_detalle_control.paramDivSeccion.bitDivEsCargarMantenimientosAjaxWebPart==true) {				
				this.actualizarPaginaTablaFilaActual(cuenta_cobrar_detalle_control);			
			}
			
			if(cuenta_cobrar_detalle_control.paramDivSeccion.bitDivsEsCargarReporteAuxiliarAjaxWebPart==true) {				
				this.actualizarPaginaImprimir(cuenta_cobrar_detalle_control);
			}
			
			
			if(cuenta_cobrar_detalle_control.paramDivSeccion.bitDivsEsCargarMostrarBusquedasAjaxWebPart==true) {
				this.actualizarPaginaAreaAuxiliarBusquedas(cuenta_cobrar_detalle_control);
			}
			
			if(cuenta_cobrar_detalle_control.paramDivSeccion.bitDivsEsCargarResumenAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarResumen(cuenta_cobrar_detalle_control);
			}				
			
			if(cuenta_cobrar_detalle_control.paramDivSeccion.bitDivsEsCargarAccionesRelacionesAjaxWebPart==true) {						
				this.actualizarPaginaAreaAuxiliarAccionesRelaciones(cuenta_cobrar_detalle_control);
			}
			
			if(cuenta_cobrar_detalle_control.usuarioActual!=null && cuenta_cobrar_detalle_control.usuarioActual.field_strUserName!=null &&
			cuenta_cobrar_detalle_control.usuarioActual.field_strUserName!=undefined ) {
				
				this.actualizarPaginaUsuarioInvitado(cuenta_cobrar_detalle_control);			
			}
		}
...
//Funciones Auxiliares
	...
	actualizarPaginaTablaDatosAuxiliar(cuenta_cobrar_detalle_control) {
		if(cuenta_cobrar_detalle_funcion1.esPaginaForm()==true) {
	...
	actualizarPaginaEjecutarJavaScript(cuenta_cobrar_detalle_control) {
		eval(cuenta_cobrar_detalle_control.strFuncionJs);
	}
	
	actualizarPaginaMensajePantalla(cuenta_cobrar_detalle_control, mostrar) {
		
		if(mostrar==true) {
			cuenta_cobrar_detalle_funcion1.resaltarRestaurarDivsPagina(false);
			
			if(jQuery("#ParamsPostAccion-chbPostAccionSinCerrar").prop('checked')==false
				&& jQuery("#ParamsPostAccion-chbPostAccionNuevo").prop('checked')==false) {		
					
				cuenta_cobrar_detalle_funcion1.resaltarRestaurarDivMantenimiento(false);
			}			
	...
	actualizarPaginaImprimir(cuenta_cobrar_detalle_control) {
	
		funcionGeneral.printWebPartPage("cuenta_cobrar_detalle",cuenta_cobrar_detalle_control.htmlTablaReporteAuxiliars);			
			
		//jQuery("#divTablaDatosReporteAuxiliarcuenta_cobrar_detallesAjaxWebPart").html(cuenta_cobrar_detalle_control.htmlTablaReporteAuxiliars);						
		//funcionGeneral.printWebPartPage("cuenta_cobrar_detalle",jQuery("#divTablaDatosReporteAuxiliarcuenta_cobrar_detallesAjaxWebPart").html());			
	}
...
/*---------------------------------- AREA:FORMULARIO ---------------------------*/
	...
	actualizarCamposFormulario(cuenta_cobrar_detalle_control) {
		...
		jQuery("#form"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"-version_row").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.versionRow);
	...
	actualizarSpanMensajesCampos(cuenta_cobrar_detalle_control) {
		...
		jQuery("#spanstrMensajeversion_row").text(cuenta_cobrar_detalle_control.strMensajeversion_row);		
...
/*---------------------------------- AREA:AUXILIARES ---------------------------*/
	...
	registrarAccionesEventos() {	
		...
		jQuery(document).ready(function() {
			...
			funcionGeneralEventoJQuery.setImagenCerrarSesionClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);			
