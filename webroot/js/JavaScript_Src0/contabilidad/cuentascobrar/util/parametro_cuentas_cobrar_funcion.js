...
//var parametro_cuentas_cobrarFuncionGeneral= function () {

class parametro_cuentas_cobrar_funcion {
...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(parametro_cuentas_cobrar_constante1.STR_RELATIVE_PATH,"parametro_cuentas_cobrar");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(parametro_cuentas_cobrar_constante1.STR_RELATIVE_PATH,parametro_cuentas_cobrar_constante1.STR_NOMBRE_OPCION,"parametro_cuentas_cobrar");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(parametro_cuentas_cobrar_constante1.STR_RELATIVE_PATH,parametro_cuentas_cobrar_constante1.STR_NOMBRE_OPCION);
	}
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(parametro_cuentas_cobrar_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(parametro_cuentas_cobrar_constante1.STR_RELATIVE_PATH,"parametro_cuentas_cobrar");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(parametro_cuentas_cobrar_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(parametro_cuentas_cobrar_constante1.STR_RELATIVE_PATH,"parametro_cuentas_cobrar");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(parametro_cuentas_cobrar_constante1.STR_RELATIVE_PATH,"parametro_cuentas_cobrar");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"parametro_cuentas_cobrar");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(parametro_cuentas_cobrar_constante1.BIT_CON_PAGINA_FORM==true && parametro_cuentas_cobrar_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"parametro_cuentas_cobrar");
	}
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"parametro_cuentas_cobrar");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"parametro_cuentas_cobrar");
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(parametro_cuentas_cobrar_control,parametro_cuentas_cobrar_webcontrol1,parametro_cuentas_cobrar_constante1) {
		
		var strSuf=parametro_cuentas_cobrar_constante1.STR_SUFIJO;
		...
		jQuery("#frmTablaDatosparametro_cuentas_cobrar").validate(json_rules);
