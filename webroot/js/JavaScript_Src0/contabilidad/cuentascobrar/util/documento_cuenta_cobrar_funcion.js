...
//var documento_cuenta_cobrarFuncionGeneral= function () {

class documento_cuenta_cobrar_funcion {
...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(documento_cuenta_cobrar_constante1.STR_RELATIVE_PATH,"documento_cuenta_cobrar");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(documento_cuenta_cobrar_constante1.STR_RELATIVE_PATH,documento_cuenta_cobrar_constante1.STR_NOMBRE_OPCION,"documento_cuenta_cobrar");		
	}	
...
//---------- Clic-Seleccionar ----------
	...
	seleccionarMostrarDivAccionesRelacionesActualOnComplete() {
		funcionGeneral.seleccionarMostrarDivAccionesRelacionesActualOnComplete("documento_cuenta_cobrar",this);
	}
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(documento_cuenta_cobrar_constante1.STR_RELATIVE_PATH,documento_cuenta_cobrar_constante1.STR_NOMBRE_OPCION);
	}
...
/*---------------------------------- AREA:PROCESAR ------------------------*/
	...
	procesarInicioProceso() {		
		funcionGeneral.procesarInicioProceso(documento_cuenta_cobrar_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProceso() {
		funcionGeneralJQuery.procesarFinalizacionProceso(documento_cuenta_cobrar_constante1.STR_RELATIVE_PATH,"documento_cuenta_cobrar");		
	}	
	
	procesarInicioProcesoSimple() {		
		funcionGeneral.procesarInicioProcesoSimple(documento_cuenta_cobrar_constante1.STR_RELATIVE_PATH);				
	}
	
	procesarFinalizacionProcesoSimple() {
		funcionGeneralJQuery.procesarFinalizacionProcesoSimple(documento_cuenta_cobrar_constante1.STR_RELATIVE_PATH,"documento_cuenta_cobrar");
	}

//------------- Procesar-Link -------------------

	procesarFinalizacionProcesoAbrirLink() {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLink(documento_cuenta_cobrar_constante1.STR_RELATIVE_PATH,"documento_cuenta_cobrar");		
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		funcionGeneralJQuery.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"documento_cuenta_cobrar");
	}
...
/*---------------------------------- AREA:FORMULARIO ----------------------*/
	...
	esPaginaForm() {
		...
		if(documento_cuenta_cobrar_constante1.BIT_CON_PAGINA_FORM==true && documento_cuenta_cobrar_constante1.BIT_ES_PAGINA_FORM==true) {
			bitRetorno =true;
		}
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	resaltarRestaurarDivMantenimiento(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMantenimiento(bitEsResaltar,"documento_cuenta_cobrar");
	}
	...
	resaltarRestaurarDivMensajePopup(bitEsResaltar) {
		funcionGeneralJQuery.resaltarRestaurarDivMensajePopup(bitEsResaltar,"documento_cuenta_cobrar");
	}
	
	resaltarRestaurarDivsPagina(bitEsResaltar) {
		funcionGeneral.resaltarRestaurarDivsPagina(bitEsResaltar,"documento_cuenta_cobrar");
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(documento_cuenta_cobrar_control,documento_cuenta_cobrar_webcontrol1,documento_cuenta_cobrar_constante1) {
		
		var strSuf=documento_cuenta_cobrar_constante1.STR_SUFIJO;
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(documento_cuenta_cobrar_control.idempresaDefaultForeignKey!=null && documento_cuenta_cobrar_control.idempresaDefaultForeignKey>-1) {
					idActual=documento_cuenta_cobrar_control.idempresaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablaempresaFK(documento_cuenta_cobrar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablaempresaFK(documento_cuenta_cobrar_control,control_name,idActual,true);
					}
				});
				...
				if(documento_cuenta_cobrar_control.idsucursalDefaultForeignKey!=null && documento_cuenta_cobrar_control.idsucursalDefaultForeignKey>-1) {
					idActual=documento_cuenta_cobrar_control.idsucursalDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablasucursalFK(documento_cuenta_cobrar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablasucursalFK(documento_cuenta_cobrar_control,control_name,idActual,true);
					}
				});
				...
				if(documento_cuenta_cobrar_control.idejercicioDefaultForeignKey!=null && documento_cuenta_cobrar_control.idejercicioDefaultForeignKey>-1) {
					idActual=documento_cuenta_cobrar_control.idejercicioDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablaejercicioFK(documento_cuenta_cobrar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablaejercicioFK(documento_cuenta_cobrar_control,control_name,idActual,true);
					}
				});
				...
				if(documento_cuenta_cobrar_control.idperiodoDefaultForeignKey!=null && documento_cuenta_cobrar_control.idperiodoDefaultForeignKey>-1) {
					idActual=documento_cuenta_cobrar_control.idperiodoDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablaperiodoFK(documento_cuenta_cobrar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablaperiodoFK(documento_cuenta_cobrar_control,control_name,idActual,true);
					}
				});
				...
				if(documento_cuenta_cobrar_control.idusuarioDefaultForeignKey!=null && documento_cuenta_cobrar_control.idusuarioDefaultForeignKey>-1) {
					idActual=documento_cuenta_cobrar_control.idusuarioDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablausuarioFK(documento_cuenta_cobrar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablausuarioFK(documento_cuenta_cobrar_control,control_name,idActual,true);
					}
				});
				...
				if(documento_cuenta_cobrar_control.idclienteDefaultForeignKey!=null && documento_cuenta_cobrar_control.idclienteDefaultForeignKey>-1) {
					idActual=documento_cuenta_cobrar_control.idclienteDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablaclienteFK(documento_cuenta_cobrar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablaclienteFK(documento_cuenta_cobrar_control,control_name,idActual,true);
					}
				});
				...
				if(documento_cuenta_cobrar_control.idforma_pago_clienteDefaultForeignKey!=null && documento_cuenta_cobrar_control.idforma_pago_clienteDefaultForeignKey>-1) {
					idActual=documento_cuenta_cobrar_control.idforma_pago_clienteDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablaforma_pago_clienteFK(documento_cuenta_cobrar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablaforma_pago_clienteFK(documento_cuenta_cobrar_control,control_name,idActual,true);
					}
				});
				...
				if(documento_cuenta_cobrar_control.idcuenta_corrienteDefaultForeignKey!=null && documento_cuenta_cobrar_control.idcuenta_corrienteDefaultForeignKey>-1) {
					idActual=documento_cuenta_cobrar_control.idcuenta_corrienteDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablacuenta_corrienteFK(documento_cuenta_cobrar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						documento_cuenta_cobrar_webcontrol1.cargarComboEditarTablacuenta_corrienteFK(documento_cuenta_cobrar_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatosdocumento_cuenta_cobrar").validate(json_rules);
