...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(tabla_control) {
		...
		jQuery("#form"+tabla_constante1.STR_SUFIJO+"-created_at").val(tabla_control.tablaActual.versionRow);
		jQuery("#form"+tabla_constante1.STR_SUFIJO+"-updated_at").val(tabla_control.tablaActual.versionRow);
	...
	actualizarSpanMensajesCampos(tabla_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(tabla_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(tabla_control.strMensajeupdated_at);		
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosmodulosFK(tabla_control) {
		...
		if(tabla_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+tabla_control.idFilaTablaActual+"_3",tabla_control.modulosFK);
		}
	};
