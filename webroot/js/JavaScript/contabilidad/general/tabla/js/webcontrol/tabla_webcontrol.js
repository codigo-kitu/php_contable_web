...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(tabla_control) {
		...
		if(tabla_control.tablaActual.id_modulo!=null && tabla_control.tablaActual.id_modulo>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != tabla_control.tablaActual.id_modulo) {
				jQuery("#t-cel_"+i+"_3").val(tabla_control.tablaActual.id_modulo).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(tabla_control.tablaActual.codigo);
		jQuery("#t-cel_"+i+"_5").val(tabla_control.tablaActual.nombre);
		jQuery("#t-cel_"+i+"_6").val(tabla_control.tablaActual.descripcion);
	}
