...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(otro_parametro_control) {
		...
		jQuery("#form"+otro_parametro_constante1.STR_SUFIJO+"-created_at").val(otro_parametro_control.otro_parametroActual.versionRow);
		jQuery("#form"+otro_parametro_constante1.STR_SUFIJO+"-updated_at").val(otro_parametro_control.otro_parametroActual.versionRow);
	...
	actualizarSpanMensajesCampos(otro_parametro_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(otro_parametro_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(otro_parametro_control.strMensajeupdated_at);		
