...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(otro_parametro_control) {
		...
		jQuery("#t-version_row_"+i+"").val(otro_parametro_control.otro_parametroActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(otro_parametro_control.otro_parametroActual.codigo);
		jQuery("#t-cel_"+i+"_4").val(otro_parametro_control.otro_parametroActual.codigo2);
		jQuery("#t-cel_"+i+"_5").val(otro_parametro_control.otro_parametroActual.grupo);
		jQuery("#t-cel_"+i+"_6").val(otro_parametro_control.otro_parametroActual.descripcion);
		jQuery("#t-cel_"+i+"_7").val(otro_parametro_control.otro_parametroActual.texto1);
		jQuery("#t-cel_"+i+"_8").val(otro_parametro_control.otro_parametroActual.orden);
		jQuery("#t-cel_"+i+"_9").val(otro_parametro_control.otro_parametroActual.monto1);
		jQuery("#t-cel_"+i+"_10").prop('checked',otro_parametro_control.otro_parametroActual.activo);
	}
