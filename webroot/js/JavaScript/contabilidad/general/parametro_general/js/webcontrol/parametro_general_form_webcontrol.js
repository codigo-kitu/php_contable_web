...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(parametro_general_control) {
		...
		jQuery("#form"+parametro_general_constante1.STR_SUFIJO+"-created_at").val(parametro_general_control.parametro_generalActual.versionRow);
		jQuery("#form"+parametro_general_constante1.STR_SUFIJO+"-updated_at").val(parametro_general_control.parametro_generalActual.versionRow);
	...
	actualizarSpanMensajesCampos(parametro_general_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(parametro_general_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(parametro_general_control.strMensajeupdated_at);		
