...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(parametro_auxiliar_facturacion_control) {
		...
		jQuery("#form"+parametro_auxiliar_facturacion_constante1.STR_SUFIJO+"-created_at").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.versionRow);
		jQuery("#form"+parametro_auxiliar_facturacion_constante1.STR_SUFIJO+"-updated_at").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.versionRow);
	...
	actualizarSpanMensajesCampos(parametro_auxiliar_facturacion_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(parametro_auxiliar_facturacion_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(parametro_auxiliar_facturacion_control.strMensajeupdated_at);		
