...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(parametro_auxiliar_facturacion_control) {
		...
		if(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.id_empresa!=null && parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.nombre_tipo_factura);
		jQuery("#t-cel_"+i+"_5").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.siguiente_numero_correlativo);
		jQuery("#t-cel_"+i+"_6").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.incremento);
		jQuery("#t-cel_"+i+"_7").prop('checked',parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.con_creacion_rapida_producto);
		jQuery("#t-cel_"+i+"_8").prop('checked',parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.con_busqueda_producto_fabricante);
		jQuery("#t-cel_"+i+"_9").prop('checked',parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.con_solo_costo_producto);
		jQuery("#t-cel_"+i+"_10").prop('checked',parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.con_recibo);
		jQuery("#t-cel_"+i+"_11").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.nombre_tipo_factura_recibo);
		jQuery("#t-cel_"+i+"_12").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.siguiente_numero_correlativo_recibo);
		jQuery("#t-cel_"+i+"_13").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.incremento_recibo);
		jQuery("#t-cel_"+i+"_14").prop('checked',parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.con_impuesto_final_boleta);
		jQuery("#t-cel_"+i+"_15").prop('checked',parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.con_ticket);
		jQuery("#t-cel_"+i+"_16").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.nombre_tipo_factura_ticket);
		jQuery("#t-cel_"+i+"_17").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.siguiente_numero_correlativo_ticket);
		jQuery("#t-cel_"+i+"_18").val(parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.incremento_ticket);
		jQuery("#t-cel_"+i+"_19").prop('checked',parametro_auxiliar_facturacion_control.parametro_auxiliar_facturacionActual.con_impuesto_final_ticket);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(parametro_auxiliar_facturacion_control) {
		...
		if(parametro_auxiliar_facturacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+parametro_auxiliar_facturacion_control.idFilaTablaActual+"_3",parametro_auxiliar_facturacion_control.empresasFK);
		}
	};
