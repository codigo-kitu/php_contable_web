...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(comentario_documento_control) {
		...
		jQuery("#form"+comentario_documento_constante1.STR_SUFIJO+"-created_at").val(comentario_documento_control.comentario_documentoActual.versionRow);
		jQuery("#form"+comentario_documento_constante1.STR_SUFIJO+"-updated_at").val(comentario_documento_control.comentario_documentoActual.versionRow);
	...
	actualizarSpanMensajesCampos(comentario_documento_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(comentario_documento_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(comentario_documento_control.strMensajeupdated_at);		
