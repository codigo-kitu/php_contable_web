...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(parametro_sql_control) {
		...
		jQuery("#t-version_row_"+i+"").val(parametro_sql_control.parametro_sqlActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(parametro_sql_control.parametro_sqlActual.binario1);
		jQuery("#t-cel_"+i+"_4").val(parametro_sql_control.parametro_sqlActual.binario2);
		jQuery("#t-cel_"+i+"_5").val(parametro_sql_control.parametro_sqlActual.binario3);
		jQuery("#t-cel_"+i+"_6").val(parametro_sql_control.parametro_sqlActual.binario4);
		jQuery("#t-cel_"+i+"_7").val(parametro_sql_control.parametro_sqlActual.binario5);
	}
