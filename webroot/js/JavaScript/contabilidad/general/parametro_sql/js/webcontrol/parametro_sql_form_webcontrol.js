...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(parametro_sql_control) {
		...
		jQuery("#form"+parametro_sql_constante1.STR_SUFIJO+"-created_at").val(parametro_sql_control.parametro_sqlActual.versionRow);
		jQuery("#form"+parametro_sql_constante1.STR_SUFIJO+"-updated_at").val(parametro_sql_control.parametro_sqlActual.versionRow);
	...
	actualizarSpanMensajesCampos(parametro_sql_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(parametro_sql_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(parametro_sql_control.strMensajeupdated_at);		
