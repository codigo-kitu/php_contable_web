...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(log_actividad_control) {
		...
		jQuery("#t-version_row_"+i+"").val(log_actividad_control.log_actividadActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(log_actividad_control.log_actividadActual.log_id);
		jQuery("#t-cel_"+i+"_4").val(log_actividad_control.log_actividadActual.fecha);
		jQuery("#t-cel_"+i+"_5").val(log_actividad_control.log_actividadActual.hora);
		jQuery("#t-cel_"+i+"_6").val(log_actividad_control.log_actividadActual.computador);
		jQuery("#t-cel_"+i+"_7").val(log_actividad_control.log_actividadActual.usuario);
		jQuery("#t-cel_"+i+"_8").val(log_actividad_control.log_actividadActual.descripcion);
		jQuery("#t-cel_"+i+"_9").val(log_actividad_control.log_actividadActual.modulo);
	}
