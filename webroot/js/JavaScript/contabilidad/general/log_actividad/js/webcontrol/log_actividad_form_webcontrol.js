...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(log_actividad_control) {
		...
		jQuery("#form"+log_actividad_constante1.STR_SUFIJO+"-created_at").val(log_actividad_control.log_actividadActual.versionRow);
		jQuery("#form"+log_actividad_constante1.STR_SUFIJO+"-updated_at").val(log_actividad_control.log_actividadActual.versionRow);
	...
	actualizarSpanMensajesCampos(log_actividad_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(log_actividad_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(log_actividad_control.strMensajeupdated_at);		
