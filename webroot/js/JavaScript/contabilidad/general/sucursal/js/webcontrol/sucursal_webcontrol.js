...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(sucursal_control) {
		...
		if(sucursal_control.sucursalActual.id_empresa!=null && sucursal_control.sucursalActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != sucursal_control.sucursalActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(sucursal_control.sucursalActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(sucursal_control.sucursalActual.id_pais!=null && sucursal_control.sucursalActual.id_pais>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != sucursal_control.sucursalActual.id_pais) {
				jQuery("#t-cel_"+i+"_4").val(sucursal_control.sucursalActual.id_pais).trigger("change");
			}
		} else { 
		...
		if(sucursal_control.sucursalActual.id_ciudad!=null && sucursal_control.sucursalActual.id_ciudad>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != sucursal_control.sucursalActual.id_ciudad) {
				jQuery("#t-cel_"+i+"_5").val(sucursal_control.sucursalActual.id_ciudad).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_6").val(sucursal_control.sucursalActual.nombre);
		jQuery("#t-cel_"+i+"_7").val(sucursal_control.sucursalActual.registro_tributario);
		jQuery("#t-cel_"+i+"_8").val(sucursal_control.sucursalActual.registro_sucursalrial);
		jQuery("#t-cel_"+i+"_9").val(sucursal_control.sucursalActual.direccion1);
		jQuery("#t-cel_"+i+"_10").val(sucursal_control.sucursalActual.direccion2);
		jQuery("#t-cel_"+i+"_11").val(sucursal_control.sucursalActual.direccion3);
		jQuery("#t-cel_"+i+"_12").val(sucursal_control.sucursalActual.telefono1);
		jQuery("#t-cel_"+i+"_13").val(sucursal_control.sucursalActual.celular);
		jQuery("#t-cel_"+i+"_14").val(sucursal_control.sucursalActual.correo_electronico);
		jQuery("#t-cel_"+i+"_15").val(sucursal_control.sucursalActual.sitio_web);
		jQuery("#t-cel_"+i+"_16").val(sucursal_control.sucursalActual.codigo_postal);
		jQuery("#t-cel_"+i+"_17").val(sucursal_control.sucursalActual.fax);
		jQuery("#t-cel_"+i+"_18").val(sucursal_control.sucursalActual.barrio_distrito);
		jQuery("#t-cel_"+i+"_19").val(sucursal_control.sucursalActual.logo);
		jQuery("#t-cel_"+i+"_20").val(sucursal_control.sucursalActual.base_de_datos);
		jQuery("#t-cel_"+i+"_21").val(sucursal_control.sucursalActual.condicion);
		jQuery("#t-cel_"+i+"_22").val(sucursal_control.sucursalActual.icono_asociado);
		jQuery("#t-cel_"+i+"_23").val(sucursal_control.sucursalActual.folder_sucursal);
	}
