...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(tipo_forma_pago_control) {
		...
		jQuery("#form"+tipo_forma_pago_constante1.STR_SUFIJO+"-created_at").val(tipo_forma_pago_control.tipo_forma_pagoActual.versionRow);
		jQuery("#form"+tipo_forma_pago_constante1.STR_SUFIJO+"-updated_at").val(tipo_forma_pago_control.tipo_forma_pagoActual.versionRow);
	...
	actualizarSpanMensajesCampos(tipo_forma_pago_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(tipo_forma_pago_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(tipo_forma_pago_control.strMensajeupdated_at);		
