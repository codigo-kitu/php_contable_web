...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(tipo_forma_pago_control) {
		...
		jQuery("#t-version_row_"+i+"").val(tipo_forma_pago_control.tipo_forma_pagoActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(tipo_forma_pago_control.tipo_forma_pagoActual.codigo);
		jQuery("#t-cel_"+i+"_4").val(tipo_forma_pago_control.tipo_forma_pagoActual.nombre);
	}
