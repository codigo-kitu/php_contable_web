...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(parametro_auxiliar_control) {
		...
		if(parametro_auxiliar_control.parametro_auxiliarActual.id_empresa!=null && parametro_auxiliar_control.parametro_auxiliarActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != parametro_auxiliar_control.parametro_auxiliarActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(parametro_auxiliar_control.parametro_auxiliarActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(parametro_auxiliar_control.parametro_auxiliarActual.nombre_asignado);
		jQuery("#t-cel_"+i+"_5").val(parametro_auxiliar_control.parametro_auxiliarActual.siguiente_numero_correlativo);
		jQuery("#t-cel_"+i+"_6").val(parametro_auxiliar_control.parametro_auxiliarActual.incremento);
		jQuery("#t-cel_"+i+"_7").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.mostrar_solo_costo_producto);
		jQuery("#t-cel_"+i+"_8").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.con_codigo_secuencial_producto);
		jQuery("#t-cel_"+i+"_9").val(parametro_auxiliar_control.parametro_auxiliarActual.contador_producto);
		...
		if(parametro_auxiliar_control.parametro_auxiliarActual.id_tipo_costeo_kardex!=null && parametro_auxiliar_control.parametro_auxiliarActual.id_tipo_costeo_kardex>-1){
			if(jQuery("#t-cel_"+i+"_10").val() != parametro_auxiliar_control.parametro_auxiliarActual.id_tipo_costeo_kardex) {
				jQuery("#t-cel_"+i+"_10").val(parametro_auxiliar_control.parametro_auxiliarActual.id_tipo_costeo_kardex).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_11").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.con_producto_inactivo);
		jQuery("#t-cel_"+i+"_12").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.con_busqueda_incremental);
		jQuery("#t-cel_"+i+"_13").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.permitir_revisar_asiento);
		jQuery("#t-cel_"+i+"_14").val(parametro_auxiliar_control.parametro_auxiliarActual.numero_decimales_unidades);
		jQuery("#t-cel_"+i+"_15").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.mostrar_documento_anulado);
		jQuery("#t-cel_"+i+"_16").val(parametro_auxiliar_control.parametro_auxiliarActual.siguiente_numero_correlativo_cc);
		jQuery("#t-cel_"+i+"_17").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.con_eliminacion_fisica_asiento);
		jQuery("#t-cel_"+i+"_18").val(parametro_auxiliar_control.parametro_auxiliarActual.siguiente_numero_correlativo_asiento);
		jQuery("#t-cel_"+i+"_19").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.con_asiento_simple_factura);
		jQuery("#t-cel_"+i+"_20").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.con_codigo_secuencial_cliente);
		jQuery("#t-cel_"+i+"_21").val(parametro_auxiliar_control.parametro_auxiliarActual.contador_cliente);
		jQuery("#t-cel_"+i+"_22").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.con_cliente_inactivo);
		jQuery("#t-cel_"+i+"_23").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.con_codigo_secuencial_proveedor);
		jQuery("#t-cel_"+i+"_24").val(parametro_auxiliar_control.parametro_auxiliarActual.contador_proveedor);
		jQuery("#t-cel_"+i+"_25").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.con_proveedor_inactivo);
		jQuery("#t-cel_"+i+"_26").val(parametro_auxiliar_control.parametro_auxiliarActual.abreviatura_registro_tributario);
		jQuery("#t-cel_"+i+"_27").prop('checked',parametro_auxiliar_control.parametro_auxiliarActual.con_asiento_cheque);
	}
