...
/*---------- Clic-Buscar-Auxiliar ----------*/
	procesarInicioBusqueda() { 
		funcionGeneral.procesarInicioBusquedaPrincipal(reporte_monica_constante1.STR_RELATIVE_PATH,"reporte_monica"); 
	}
	
	procesarFinalizacionBusqueda() { 
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(reporte_monica_constante1.STR_RELATIVE_PATH,reporte_monica_constante1.STR_NOMBRE_OPCION,"reporte_monica"); 
	}
/*---------- Clic-Siguiente ----------*/
	siguientesOnClick() { 
		this.procesarInicioBusqueda(); 
...
/*---------- Clic-Reporte ----------------*/
	...
	generarReporteFinalizacion() { 
		funcionGeneral.generarReporteFinalizacion(reporte_monica_constante1.STR_RELATIVE_PATH,reporte_monica_constante1.STR_NOMBRE_OPCION); 
	}
/*---------- Clic-Generar-Html -----------*/
...
/*-------------- Clic-Copiar -------------------*/
	...
	/*---------------------------------- AREA:TABLA ---------------------------*/
/*------------- Tabla-Validacion -------------------*/
	registrarControlesTableValidacionEdition(reporte_monica_control,reporte_monica_webcontrol1,reporte_monica_constante1) {
		
		var strSuf=reporte_monica_constante1.STR_SUFIJO;
		...
		jQuery("#frmTablaDatosreporte_monica").validate(json_rules);
