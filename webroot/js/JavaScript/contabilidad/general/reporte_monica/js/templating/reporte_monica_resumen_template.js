...
<script id="reporte_monica_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarreporte_monicasAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each reporte_monicasReporte}}

			<table id="tablereporte_monica{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
