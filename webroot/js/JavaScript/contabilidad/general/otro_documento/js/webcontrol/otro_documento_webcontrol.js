...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(otro_documento_control) {
		...
		if(otro_documento_control.otro_documentoActual.id_archivo!=null && otro_documento_control.otro_documentoActual.id_archivo>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != otro_documento_control.otro_documentoActual.id_archivo) {
				jQuery("#t-cel_"+i+"_3").val(otro_documento_control.otro_documentoActual.id_archivo).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(otro_documento_control.otro_documentoActual.nombre);
		jQuery("#t-cel_"+i+"_5").val(otro_documento_control.otro_documentoActual.data);
		jQuery("#t-cel_"+i+"_6").val(otro_documento_control.otro_documentoActual.campo1);
		jQuery("#t-cel_"+i+"_7").val(otro_documento_control.otro_documentoActual.campo2);
		jQuery("#t-cel_"+i+"_8").val(otro_documento_control.otro_documentoActual.campo3);
	}
