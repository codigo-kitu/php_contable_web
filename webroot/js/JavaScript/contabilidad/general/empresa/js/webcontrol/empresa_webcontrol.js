...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(empresa_control) {
		...
		if(empresa_control.empresaActual.id_pais!=null && empresa_control.empresaActual.id_pais>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != empresa_control.empresaActual.id_pais) {
				jQuery("#t-cel_"+i+"_3").val(empresa_control.empresaActual.id_pais).trigger("change");
			}
		} else { 
		...
		if(empresa_control.empresaActual.id_ciudad!=null && empresa_control.empresaActual.id_ciudad>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != empresa_control.empresaActual.id_ciudad) {
				jQuery("#t-cel_"+i+"_4").val(empresa_control.empresaActual.id_ciudad).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(empresa_control.empresaActual.ruc);
		jQuery("#t-cel_"+i+"_6").val(empresa_control.empresaActual.nombre);
		jQuery("#t-cel_"+i+"_7").val(empresa_control.empresaActual.nombre_comercial);
		jQuery("#t-cel_"+i+"_8").val(empresa_control.empresaActual.sector);
		jQuery("#t-cel_"+i+"_9").val(empresa_control.empresaActual.direccion1);
		jQuery("#t-cel_"+i+"_10").val(empresa_control.empresaActual.direccion2);
		jQuery("#t-cel_"+i+"_11").val(empresa_control.empresaActual.direccion3);
		jQuery("#t-cel_"+i+"_12").val(empresa_control.empresaActual.telefono1);
		jQuery("#t-cel_"+i+"_13").val(empresa_control.empresaActual.movil);
		jQuery("#t-cel_"+i+"_14").val(empresa_control.empresaActual.mail);
		jQuery("#t-cel_"+i+"_15").val(empresa_control.empresaActual.sitio_web);
		jQuery("#t-cel_"+i+"_16").val(empresa_control.empresaActual.codigo_postal);
		jQuery("#t-cel_"+i+"_17").val(empresa_control.empresaActual.fax);
		jQuery("#t-cel_"+i+"_18").val(empresa_control.empresaActual.logo);
		jQuery("#t-cel_"+i+"_19").val(empresa_control.empresaActual.icono);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombospaissFK(empresa_control) {
		...
		if(empresa_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+empresa_control.idFilaTablaActual+"_3",empresa_control.paissFK);
		}
	...
	cargarCombosciudadsFK(empresa_control) {
		...
		if(empresa_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+empresa_control.idFilaTablaActual+"_4",empresa_control.ciudadsFK);
		}
