...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(empresa_control) {
		...
		jQuery("#form"+empresa_constante1.STR_SUFIJO+"-created_at").val(empresa_control.empresaActual.versionRow);
		jQuery("#form"+empresa_constante1.STR_SUFIJO+"-updated_at").val(empresa_control.empresaActual.versionRow);
	...
	actualizarSpanMensajesCampos(empresa_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(empresa_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(empresa_control.strMensajeupdated_at);		
