...
import {tipo_termino_pago_funcion,tipo_termino_pago_funcion1} from '../util/tipo_termino_pago_funcion.js';
...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(tipo_termino_pago_control) {
		...
		jQuery("#t-version_row_"+i+"").val(tipo_termino_pago_control.tipo_termino_pagoActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(tipo_termino_pago_control.tipo_termino_pagoActual.codigo);
		jQuery("#t-cel_"+i+"_4").val(tipo_termino_pago_control.tipo_termino_pagoActual.nombre);
	}
