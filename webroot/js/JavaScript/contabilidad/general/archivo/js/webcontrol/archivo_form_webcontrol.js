...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(archivo_control) {
		...
		jQuery("#form"+archivo_constante1.STR_SUFIJO+"-created_at").val(archivo_control.archivoActual.versionRow);
		jQuery("#form"+archivo_constante1.STR_SUFIJO+"-updated_at").val(archivo_control.archivoActual.versionRow);
	...
	actualizarSpanMensajesCampos(archivo_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(archivo_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(archivo_control.strMensajeupdated_at);		
