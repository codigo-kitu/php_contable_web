...
<script id="archivo_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliararchivosAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each archivosReporte}}

			<table id="tablearchivo{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
		...
		{{#if (Is_List_Exist otro_documentos)}}
			{{#each otro_documentos}}
