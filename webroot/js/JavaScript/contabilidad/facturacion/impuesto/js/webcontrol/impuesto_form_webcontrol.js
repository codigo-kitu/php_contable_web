...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(impuesto_control) {
		...
		jQuery("#form"+impuesto_constante1.STR_SUFIJO+"-created_at").val(impuesto_control.impuestoActual.versionRow);
		jQuery("#form"+impuesto_constante1.STR_SUFIJO+"-updated_at").val(impuesto_control.impuestoActual.versionRow);
	...
	actualizarSpanMensajesCampos(impuesto_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(impuesto_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(impuesto_control.strMensajeupdated_at);		
