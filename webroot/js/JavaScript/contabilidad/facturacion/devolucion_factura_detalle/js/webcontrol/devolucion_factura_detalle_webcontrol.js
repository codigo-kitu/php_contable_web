...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(devolucion_factura_detalle_control) {
		...
		if(devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_devolucion_factura!=null && devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_devolucion_factura>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_devolucion_factura) {
				jQuery("#t-cel_"+i+"_3").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_devolucion_factura).trigger("change");
			}
		} else { 
		...
		if(devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_bodega!=null && devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_bodega) {
				jQuery("#t-cel_"+i+"_4").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_bodega).trigger("change");
			}
		} else { 
		...
		if(devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_producto!=null && devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_producto) {
				jQuery("#t-cel_"+i+"_5").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_producto).trigger("change");
			}
		} else { 
		...
		if(devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_unidad!=null && devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_unidad>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_unidad) {
				jQuery("#t-cel_"+i+"_6").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.id_unidad).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.cantidad);
		jQuery("#t-cel_"+i+"_8").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.precio);
		...
		jQuery("#t-cel_"+i+"_11").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.sub_total);
		jQuery("#t-cel_"+i+"_12").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.iva_porciento);
		jQuery("#t-cel_"+i+"_13").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.iva_monto);
		jQuery("#t-cel_"+i+"_14").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.total);
		jQuery("#t-cel_"+i+"_15").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.recibido);
		jQuery("#t-cel_"+i+"_16").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.observacion);
		jQuery("#t-cel_"+i+"_17").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.impuesto2_porciento);
		jQuery("#t-cel_"+i+"_18").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.impuesto2_monto);
		jQuery("#t-cel_"+i+"_19").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.cotizacion);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosdevolucion_facturasFK(devolucion_factura_detalle_control) {
		...
		if(devolucion_factura_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+devolucion_factura_detalle_control.idFilaTablaActual+"_3",devolucion_factura_detalle_control.devolucion_facturasFK);
		}
	...
	cargarCombosbodegasFK(devolucion_factura_detalle_control) {
		...
		if(devolucion_factura_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+devolucion_factura_detalle_control.idFilaTablaActual+"_4",devolucion_factura_detalle_control.bodegasFK);
		}
	...
	cargarCombosproductosFK(devolucion_factura_detalle_control) {
		...
		if(devolucion_factura_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+devolucion_factura_detalle_control.idFilaTablaActual+"_5",devolucion_factura_detalle_control.productosFK);
		}
	...
	cargarCombosunidadsFK(devolucion_factura_detalle_control) {
		...
		if(devolucion_factura_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+devolucion_factura_detalle_control.idFilaTablaActual+"_6",devolucion_factura_detalle_control.unidadsFK);
		}
