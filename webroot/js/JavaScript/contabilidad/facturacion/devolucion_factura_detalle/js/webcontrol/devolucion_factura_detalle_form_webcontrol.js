...
import {devolucion_factura_detalle_funcion,devolucion_factura_detalle_funcion1} from '../util/devolucion_factura_detalle_form_funcion.js';
...
class devolucion_factura_detalle_webcontrol extends GeneralEntityWebControl {
	...
	actualizarVariablesPagina(devolucion_factura_detalle_control) {
		...
		} else if(devolucion_factura_detalle_control.action=="recargarFormularioGeneral") {
...
//Funciones Manejadores Accion
	...
	actualizarVariablesPaginaAccionSeleccionarActualPaginaForm(devolucion_factura_detalle_control) {
		...
		this.seleccionarActualPaginaFormularioAdd(devolucion_factura_detalle_control);
	...
	*/
	...
	actualizarCamposFormulario(devolucion_factura_detalle_control) {
		...
		jQuery("#form"+devolucion_factura_detalle_constante1.STR_SUFIJO+"-created_at").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.versionRow);
		jQuery("#form"+devolucion_factura_detalle_constante1.STR_SUFIJO+"-updated_at").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.versionRow);
		...
		jQuery("#form"+devolucion_factura_detalle_constante1.STR_SUFIJO+"-observacion").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.observacion);
		...
		jQuery("#form"+devolucion_factura_detalle_constante1.STR_SUFIJO+"-cotizacion").val(devolucion_factura_detalle_control.devolucion_factura_detalleActual.cotizacion);
	}
	...
	actualizarSpanMensajesCampos(devolucion_factura_detalle_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(devolucion_factura_detalle_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(devolucion_factura_detalle_control.strMensajeupdated_at);		
		...
		jQuery("#spanstrMensajeobservacion").text(devolucion_factura_detalle_control.strMensajeobservacion);		
		...
		jQuery("#spanstrMensajecotizacion").text(devolucion_factura_detalle_control.strMensajecotizacion);		
	}
