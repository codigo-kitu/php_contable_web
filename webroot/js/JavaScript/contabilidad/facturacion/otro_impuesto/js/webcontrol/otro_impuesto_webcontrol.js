...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(otro_impuesto_control) {
		...
		if(otro_impuesto_control.otro_impuestoActual.id_empresa!=null && otro_impuesto_control.otro_impuestoActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != otro_impuesto_control.otro_impuestoActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(otro_impuesto_control.otro_impuestoActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(otro_impuesto_control.otro_impuestoActual.codigo);
		jQuery("#t-cel_"+i+"_5").val(otro_impuesto_control.otro_impuestoActual.descripcion);
		jQuery("#t-cel_"+i+"_6").val(otro_impuesto_control.otro_impuestoActual.valor);
		jQuery("#t-cel_"+i+"_7").prop('checked',otro_impuesto_control.otro_impuestoActual.predeterminado);
		...
		if(otro_impuesto_control.otro_impuestoActual.id_cuenta_ventas!=null && otro_impuesto_control.otro_impuestoActual.id_cuenta_ventas>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != otro_impuesto_control.otro_impuestoActual.id_cuenta_ventas) {
				jQuery("#t-cel_"+i+"_8").val(otro_impuesto_control.otro_impuestoActual.id_cuenta_ventas).trigger("change");
			}
		} else { 
		...
		if(otro_impuesto_control.otro_impuestoActual.id_cuenta_compras!=null && otro_impuesto_control.otro_impuestoActual.id_cuenta_compras>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != otro_impuesto_control.otro_impuestoActual.id_cuenta_compras) {
				jQuery("#t-cel_"+i+"_9").val(otro_impuesto_control.otro_impuestoActual.id_cuenta_compras).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_10").val(otro_impuesto_control.otro_impuestoActual.cuenta_contable_ventas);
		jQuery("#t-cel_"+i+"_11").val(otro_impuesto_control.otro_impuestoActual.cuenta_contable_compras);
	}
	...
	registrarTablaAcciones() {
		...
		jQuery("#tblTablaDatosotro_impuestos").on("click",".imgrelacionlista_producto_compras", function () {

			var idActual=jQuery(this).attr("idactualotro_impuesto");

			otro_impuesto_webcontrol1.registrarSesion_comprasParalista_productoes(idActual);
		});
	...
	registrarSesion_comprasParalista_productoes(idActual){
		...
		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"otro_impuesto","lista_producto","facturacion","",otro_impuesto_funcion1,otro_impuesto_webcontrol1,otro_impuesto_constante1,"es","_compras");
	}
