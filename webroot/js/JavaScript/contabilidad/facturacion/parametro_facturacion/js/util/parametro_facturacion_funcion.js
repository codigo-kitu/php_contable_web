		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(parametro_facturacion_control.idempresaDefaultForeignKey!=null && parametro_facturacion_control.idempresaDefaultForeignKey>-1) {
					idActual=parametro_facturacion_control.idempresaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					parametro_facturacion_webcontrol1.cargarComboEditarTablaempresaFK(parametro_facturacion_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						parametro_facturacion_webcontrol1.cargarComboEditarTablaempresaFK(parametro_facturacion_control,control_name,idActual,true);
					}
				});
