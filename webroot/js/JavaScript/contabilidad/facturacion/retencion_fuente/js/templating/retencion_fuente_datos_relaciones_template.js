...
<script id="retencion_fuente_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarretencion_fuentesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each retencion_fuentesReporte}}

			<table id="tableretencion_fuente{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Cta Cont Ventas' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Cta Cont Compras' ../arrOrderBy ../bitParaReporteOrderBy) }}
