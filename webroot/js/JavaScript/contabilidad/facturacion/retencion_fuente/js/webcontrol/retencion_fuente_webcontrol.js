...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(retencion_fuente_control) {
		...
		if(retencion_fuente_control.retencion_fuenteActual.id_empresa!=null && retencion_fuente_control.retencion_fuenteActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != retencion_fuente_control.retencion_fuenteActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(retencion_fuente_control.retencion_fuenteActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(retencion_fuente_control.retencion_fuenteActual.codigo);
		jQuery("#t-cel_"+i+"_5").val(retencion_fuente_control.retencion_fuenteActual.descripcion);
		jQuery("#t-cel_"+i+"_6").val(retencion_fuente_control.retencion_fuenteActual.valor);
		jQuery("#t-cel_"+i+"_7").val(retencion_fuente_control.retencion_fuenteActual.valor_base);
		jQuery("#t-cel_"+i+"_8").prop('checked',retencion_fuente_control.retencion_fuenteActual.predeterminado);
		...
		if(retencion_fuente_control.retencion_fuenteActual.id_cuenta_ventas!=null && retencion_fuente_control.retencion_fuenteActual.id_cuenta_ventas>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != retencion_fuente_control.retencion_fuenteActual.id_cuenta_ventas) {
				jQuery("#t-cel_"+i+"_9").val(retencion_fuente_control.retencion_fuenteActual.id_cuenta_ventas).trigger("change");
			}
		} else { 
		...
		if(retencion_fuente_control.retencion_fuenteActual.id_cuenta_compras!=null && retencion_fuente_control.retencion_fuenteActual.id_cuenta_compras>-1){
			if(jQuery("#t-cel_"+i+"_10").val() != retencion_fuente_control.retencion_fuenteActual.id_cuenta_compras) {
				jQuery("#t-cel_"+i+"_10").val(retencion_fuente_control.retencion_fuenteActual.id_cuenta_compras).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_11").val(retencion_fuente_control.retencion_fuenteActual.cuenta_contable_ventas);
		jQuery("#t-cel_"+i+"_12").val(retencion_fuente_control.retencion_fuenteActual.cuenta_contable_compras);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(retencion_fuente_control) {
		...
		if(retencion_fuente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+retencion_fuente_control.idFilaTablaActual+"_3",retencion_fuente_control.empresasFK);
		}
	};
	...
	cargarComboscuenta_ventassFK(retencion_fuente_control) {
		...
		if(retencion_fuente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+retencion_fuente_control.idFilaTablaActual+"_9",retencion_fuente_control.cuenta_ventassFK);
		}
	...
	cargarComboscuenta_comprassFK(retencion_fuente_control) {
		...
		if(retencion_fuente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+retencion_fuente_control.idFilaTablaActual+"_10",retencion_fuente_control.cuenta_comprassFK);
		}
