...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(retencion_fuente_control) {
		...
		jQuery("#form"+retencion_fuente_constante1.STR_SUFIJO+"-created_at").val(retencion_fuente_control.retencion_fuenteActual.versionRow);
		jQuery("#form"+retencion_fuente_constante1.STR_SUFIJO+"-updated_at").val(retencion_fuente_control.retencion_fuenteActual.versionRow);
	...
	actualizarSpanMensajesCampos(retencion_fuente_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(retencion_fuente_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(retencion_fuente_control.strMensajeupdated_at);		
