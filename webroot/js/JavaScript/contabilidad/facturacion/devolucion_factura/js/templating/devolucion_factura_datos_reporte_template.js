...
<script id="devolucion_factura_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist devolucion_facturasLocal)}}
			{{#each devolucion_facturasLocal}}
