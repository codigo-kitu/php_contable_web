...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(devolucion_factura_control) {
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_empresa!=null && devolucion_factura_control.devolucion_facturaActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != devolucion_factura_control.devolucion_facturaActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(devolucion_factura_control.devolucion_facturaActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_sucursal!=null && devolucion_factura_control.devolucion_facturaActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != devolucion_factura_control.devolucion_facturaActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(devolucion_factura_control.devolucion_facturaActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_ejercicio!=null && devolucion_factura_control.devolucion_facturaActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != devolucion_factura_control.devolucion_facturaActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(devolucion_factura_control.devolucion_facturaActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_periodo!=null && devolucion_factura_control.devolucion_facturaActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != devolucion_factura_control.devolucion_facturaActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(devolucion_factura_control.devolucion_facturaActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_usuario!=null && devolucion_factura_control.devolucion_facturaActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != devolucion_factura_control.devolucion_facturaActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(devolucion_factura_control.devolucion_facturaActual.id_usuario).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_8").val(devolucion_factura_control.devolucion_facturaActual.numero);
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_cliente!=null && devolucion_factura_control.devolucion_facturaActual.id_cliente>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != devolucion_factura_control.devolucion_facturaActual.id_cliente) {
				jQuery("#t-cel_"+i+"_9").val(devolucion_factura_control.devolucion_facturaActual.id_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_10").val(devolucion_factura_control.devolucion_facturaActual.ruc);
		jQuery("#t-cel_"+i+"_11").val(devolucion_factura_control.devolucion_facturaActual.referencia_cliente);
		jQuery("#t-cel_"+i+"_12").val(devolucion_factura_control.devolucion_facturaActual.fecha_emision);
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_vendedor!=null && devolucion_factura_control.devolucion_facturaActual.id_vendedor>-1){
			if(jQuery("#t-cel_"+i+"_13").val() != devolucion_factura_control.devolucion_facturaActual.id_vendedor) {
				jQuery("#t-cel_"+i+"_13").val(devolucion_factura_control.devolucion_facturaActual.id_vendedor).trigger("change");
			}
		} else { 
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_termino_pago_cliente!=null && devolucion_factura_control.devolucion_facturaActual.id_termino_pago_cliente>-1){
			if(jQuery("#t-cel_"+i+"_14").val() != devolucion_factura_control.devolucion_facturaActual.id_termino_pago_cliente) {
				jQuery("#t-cel_"+i+"_14").val(devolucion_factura_control.devolucion_facturaActual.id_termino_pago_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_15").val(devolucion_factura_control.devolucion_facturaActual.fecha_vence);
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_moneda!=null && devolucion_factura_control.devolucion_facturaActual.id_moneda>-1){
			if(jQuery("#t-cel_"+i+"_16").val() != devolucion_factura_control.devolucion_facturaActual.id_moneda) {
				jQuery("#t-cel_"+i+"_16").val(devolucion_factura_control.devolucion_facturaActual.id_moneda).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_17").val(devolucion_factura_control.devolucion_facturaActual.cotizacion);
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_estado!=null && devolucion_factura_control.devolucion_facturaActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_18").val() != devolucion_factura_control.devolucion_facturaActual.id_estado) {
				jQuery("#t-cel_"+i+"_18").val(devolucion_factura_control.devolucion_facturaActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_19").val(devolucion_factura_control.devolucion_facturaActual.direccion);
		jQuery("#t-cel_"+i+"_20").val(devolucion_factura_control.devolucion_facturaActual.enviar_a);
		jQuery("#t-cel_"+i+"_21").val(devolucion_factura_control.devolucion_facturaActual.observacion);
		jQuery("#t-cel_"+i+"_22").prop('checked',devolucion_factura_control.devolucion_facturaActual.impuesto_en_precio);
		jQuery("#t-cel_"+i+"_23").val(devolucion_factura_control.devolucion_facturaActual.sub_total);
		jQuery("#t-cel_"+i+"_24").val(devolucion_factura_control.devolucion_facturaActual.descuento_monto);
		jQuery("#t-cel_"+i+"_25").val(devolucion_factura_control.devolucion_facturaActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_26").val(devolucion_factura_control.devolucion_facturaActual.iva_monto);
		jQuery("#t-cel_"+i+"_27").val(devolucion_factura_control.devolucion_facturaActual.iva_porciento);
		jQuery("#t-cel_"+i+"_28").val(devolucion_factura_control.devolucion_facturaActual.retencion_fuente_monto);
		jQuery("#t-cel_"+i+"_29").val(devolucion_factura_control.devolucion_facturaActual.retencion_fuente_porciento);
		jQuery("#t-cel_"+i+"_30").val(devolucion_factura_control.devolucion_facturaActual.retencion_iva_monto);
		jQuery("#t-cel_"+i+"_31").val(devolucion_factura_control.devolucion_facturaActual.retencion_iva_porciento);
		jQuery("#t-cel_"+i+"_32").val(devolucion_factura_control.devolucion_facturaActual.total);
		jQuery("#t-cel_"+i+"_33").val(devolucion_factura_control.devolucion_facturaActual.otro_monto);
		jQuery("#t-cel_"+i+"_34").val(devolucion_factura_control.devolucion_facturaActual.otro_porciento);
		jQuery("#t-cel_"+i+"_35").val(devolucion_factura_control.devolucion_facturaActual.hora);
		jQuery("#t-cel_"+i+"_36").val(devolucion_factura_control.devolucion_facturaActual.retencion_ica_porciento);
		jQuery("#t-cel_"+i+"_37").val(devolucion_factura_control.devolucion_facturaActual.retencion_ica_monto);
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_asiento!=null && devolucion_factura_control.devolucion_facturaActual.id_asiento>-1){
			if(jQuery("#t-cel_"+i+"_38").val() != devolucion_factura_control.devolucion_facturaActual.id_asiento) {
				jQuery("#t-cel_"+i+"_38").val(devolucion_factura_control.devolucion_facturaActual.id_asiento).trigger("change");
			}
		} else { 
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_documento_cuenta_cobrar!=null && devolucion_factura_control.devolucion_facturaActual.id_documento_cuenta_cobrar>-1){
			if(jQuery("#t-cel_"+i+"_39").val() != devolucion_factura_control.devolucion_facturaActual.id_documento_cuenta_cobrar) {
				jQuery("#t-cel_"+i+"_39").val(devolucion_factura_control.devolucion_facturaActual.id_documento_cuenta_cobrar).trigger("change");
			}
		} else { 
		...
		if(devolucion_factura_control.devolucion_facturaActual.id_kardex!=null && devolucion_factura_control.devolucion_facturaActual.id_kardex>-1){
			if(jQuery("#t-cel_"+i+"_40").val() != devolucion_factura_control.devolucion_facturaActual.id_kardex) {
				jQuery("#t-cel_"+i+"_40").val(devolucion_factura_control.devolucion_facturaActual.id_kardex).trigger("change");
			}
		} else { 
