...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(factura_modelo_control) {
		...
		jQuery("#form"+factura_modelo_constante1.STR_SUFIJO+"-created_at").val(factura_modelo_control.factura_modeloActual.versionRow);
		jQuery("#form"+factura_modelo_constante1.STR_SUFIJO+"-updated_at").val(factura_modelo_control.factura_modeloActual.versionRow);
	...
	actualizarSpanMensajesCampos(factura_modelo_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(factura_modelo_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(factura_modelo_control.strMensajeupdated_at);		
