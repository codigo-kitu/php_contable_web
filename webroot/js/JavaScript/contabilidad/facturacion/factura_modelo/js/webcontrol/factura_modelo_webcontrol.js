...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(factura_modelo_control) {
		...
		if(factura_modelo_control.factura_modeloActual.id_factura_lote!=null && factura_modelo_control.factura_modeloActual.id_factura_lote>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != factura_modelo_control.factura_modeloActual.id_factura_lote) {
				jQuery("#t-cel_"+i+"_3").val(factura_modelo_control.factura_modeloActual.id_factura_lote).trigger("change");
			}
		} else { 
		...
		if(factura_modelo_control.factura_modeloActual.id_cliente!=null && factura_modelo_control.factura_modeloActual.id_cliente>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != factura_modelo_control.factura_modeloActual.id_cliente) {
				jQuery("#t-cel_"+i+"_4").val(factura_modelo_control.factura_modeloActual.id_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").prop('checked',factura_modelo_control.factura_modeloActual.marcado);
		jQuery("#t-cel_"+i+"_6").val(factura_modelo_control.factura_modeloActual.ultimo);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosfactura_lotesFK(factura_modelo_control) {
		...
		if(factura_modelo_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+factura_modelo_control.idFilaTablaActual+"_3",factura_modelo_control.factura_lotesFK);
		}
	...
	cargarCombosclientesFK(factura_modelo_control) {
		...
		if(factura_modelo_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+factura_modelo_control.idFilaTablaActual+"_4",factura_modelo_control.clientesFK);
		}
