...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(factura_control) {
		...
		if(factura_control.facturaActual.id_empresa!=null && factura_control.facturaActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != factura_control.facturaActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(factura_control.facturaActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(factura_control.facturaActual.id_sucursal!=null && factura_control.facturaActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != factura_control.facturaActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(factura_control.facturaActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(factura_control.facturaActual.id_ejercicio!=null && factura_control.facturaActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != factura_control.facturaActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(factura_control.facturaActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(factura_control.facturaActual.id_periodo!=null && factura_control.facturaActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != factura_control.facturaActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(factura_control.facturaActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(factura_control.facturaActual.id_usuario!=null && factura_control.facturaActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != factura_control.facturaActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(factura_control.facturaActual.id_usuario).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_8").val(factura_control.facturaActual.numero);
		
		if(factura_control.facturaActual.id_cliente!=null && factura_control.facturaActual.id_cliente>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != factura_control.facturaActual.id_cliente) {
				jQuery("#t-cel_"+i+"_9").val(factura_control.facturaActual.id_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_10").val(factura_control.facturaActual.ruc);
		jQuery("#t-cel_"+i+"_11").val(factura_control.facturaActual.referencia_cliente);
		jQuery("#t-cel_"+i+"_12").val(factura_control.facturaActual.fecha_emision);
		
		if(factura_control.facturaActual.id_moneda!=null && factura_control.facturaActual.id_moneda>-1){
			if(jQuery("#t-cel_"+i+"_13").val() != factura_control.facturaActual.id_moneda) {
				jQuery("#t-cel_"+i+"_13").val(factura_control.facturaActual.id_moneda).trigger("change");
			}
		} else { 
		...
		if(factura_control.facturaActual.id_vendedor!=null && factura_control.facturaActual.id_vendedor>-1){
			if(jQuery("#t-cel_"+i+"_14").val() != factura_control.facturaActual.id_vendedor) {
				jQuery("#t-cel_"+i+"_14").val(factura_control.facturaActual.id_vendedor).trigger("change");
			}
		} else { 
		...
		if(factura_control.facturaActual.id_termino_pago_cliente!=null && factura_control.facturaActual.id_termino_pago_cliente>-1){
			if(jQuery("#t-cel_"+i+"_15").val() != factura_control.facturaActual.id_termino_pago_cliente) {
				jQuery("#t-cel_"+i+"_15").val(factura_control.facturaActual.id_termino_pago_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_16").val(factura_control.facturaActual.fecha_vence);
		...
		jQuery("#t-cel_"+i+"_21").prop('checked',factura_control.facturaActual.impuesto_en_precio);
		jQuery("#t-cel_"+i+"_22").val(factura_control.facturaActual.sub_total);
		jQuery("#t-cel_"+i+"_23").val(factura_control.facturaActual.descuento_monto);
		jQuery("#t-cel_"+i+"_24").val(factura_control.facturaActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_25").val(factura_control.facturaActual.iva_monto);
		jQuery("#t-cel_"+i+"_26").val(factura_control.facturaActual.iva_porciento);
		jQuery("#t-cel_"+i+"_27").val(factura_control.facturaActual.retencion_fuente_monto);
		jQuery("#t-cel_"+i+"_28").val(factura_control.facturaActual.retencion_fuente_porciento);
		jQuery("#t-cel_"+i+"_29").val(factura_control.facturaActual.retencion_iva_monto);
		jQuery("#t-cel_"+i+"_30").val(factura_control.facturaActual.retencion_iva_porciento);
		jQuery("#t-cel_"+i+"_31").val(factura_control.facturaActual.total);
		jQuery("#t-cel_"+i+"_32").val(factura_control.facturaActual.hora);
		jQuery("#t-cel_"+i+"_33").val(factura_control.facturaActual.cotizacion);
		jQuery("#t-cel_"+i+"_34").val(factura_control.facturaActual.otro_monto);
		jQuery("#t-cel_"+i+"_35").val(factura_control.facturaActual.otro_porciento);
		jQuery("#t-cel_"+i+"_36").val(factura_control.facturaActual.retencion_ica_porciento);
		jQuery("#t-cel_"+i+"_37").val(factura_control.facturaActual.retencion_ica_monto);
		
		if(factura_control.facturaActual.id_asiento!=null && factura_control.facturaActual.id_asiento>-1){
			if(jQuery("#t-cel_"+i+"_38").val() != factura_control.facturaActual.id_asiento) {
				jQuery("#t-cel_"+i+"_38").val(factura_control.facturaActual.id_asiento).trigger("change");
			}
		} else { 
		...
		if(factura_control.facturaActual.id_documento_cuenta_cobrar!=null && factura_control.facturaActual.id_documento_cuenta_cobrar>-1){
			if(jQuery("#t-cel_"+i+"_39").val() != factura_control.facturaActual.id_documento_cuenta_cobrar) {
				jQuery("#t-cel_"+i+"_39").val(factura_control.facturaActual.id_documento_cuenta_cobrar).trigger("change");
			}
		} else { 
		...
		if(factura_control.facturaActual.id_kardex!=null && factura_control.facturaActual.id_kardex>-1){
			if(jQuery("#t-cel_"+i+"_40").val() != factura_control.facturaActual.id_kardex) {
				jQuery("#t-cel_"+i+"_40").val(factura_control.facturaActual.id_kardex).trigger("change");
			}
		} else { 
