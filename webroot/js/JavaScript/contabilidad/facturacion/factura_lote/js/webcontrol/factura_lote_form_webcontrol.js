...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(factura_lote_control) {
		...
		jQuery("#form"+factura_lote_constante1.STR_SUFIJO+"-created_at").val(factura_lote_control.factura_loteActual.versionRow);
		jQuery("#form"+factura_lote_constante1.STR_SUFIJO+"-updated_at").val(factura_lote_control.factura_loteActual.versionRow);
	...
	actualizarSpanMensajesCampos(factura_lote_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(factura_lote_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(factura_lote_control.strMensajeupdated_at);		
