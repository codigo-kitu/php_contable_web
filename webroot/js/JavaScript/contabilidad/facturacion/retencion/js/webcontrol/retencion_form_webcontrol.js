...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(retencion_control) {
		...
		jQuery("#form"+retencion_constante1.STR_SUFIJO+"-created_at").val(retencion_control.retencionActual.versionRow);
		jQuery("#form"+retencion_constante1.STR_SUFIJO+"-updated_at").val(retencion_control.retencionActual.versionRow);
	...
	actualizarSpanMensajesCampos(retencion_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(retencion_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(retencion_control.strMensajeupdated_at);		
