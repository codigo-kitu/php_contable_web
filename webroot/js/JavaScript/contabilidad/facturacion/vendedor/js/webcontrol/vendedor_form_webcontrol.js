...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(vendedor_control) {
		...
		jQuery("#form"+vendedor_constante1.STR_SUFIJO+"-created_at").val(vendedor_control.vendedorActual.versionRow);
		jQuery("#form"+vendedor_constante1.STR_SUFIJO+"-updated_at").val(vendedor_control.vendedorActual.versionRow);
	...
	actualizarSpanMensajesCampos(vendedor_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(vendedor_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(vendedor_control.strMensajeupdated_at);		
