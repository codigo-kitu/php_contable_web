...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(retencion_ica_control) {
		...
		jQuery("#form"+retencion_ica_constante1.STR_SUFIJO+"-created_at").val(retencion_ica_control.retencion_icaActual.versionRow);
		jQuery("#form"+retencion_ica_constante1.STR_SUFIJO+"-updated_at").val(retencion_ica_control.retencion_icaActual.versionRow);
	...
	actualizarSpanMensajesCampos(retencion_ica_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(retencion_ica_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(retencion_ica_control.strMensajeupdated_at);		
