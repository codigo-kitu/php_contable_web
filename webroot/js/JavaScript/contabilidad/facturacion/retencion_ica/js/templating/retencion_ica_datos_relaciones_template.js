...
<script id="retencion_ica_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarretencion_icasAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each retencion_icasReporte}}

			<table id="tableretencion_ica{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Valor Base' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Cta Contable Ventas' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Cta Contable Compras' ../arrOrderBy ../bitParaReporteOrderBy) }}
