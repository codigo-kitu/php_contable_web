...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(factura_lote_detalle_control) {
		...
		jQuery("#form"+factura_lote_detalle_constante1.STR_SUFIJO+"-created_at").val(factura_lote_detalle_control.factura_lote_detalleActual.versionRow);
		jQuery("#form"+factura_lote_detalle_constante1.STR_SUFIJO+"-updated_at").val(factura_lote_detalle_control.factura_lote_detalleActual.versionRow);
	...
	actualizarSpanMensajesCampos(factura_lote_detalle_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(factura_lote_detalle_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(factura_lote_detalle_control.strMensajeupdated_at);		
