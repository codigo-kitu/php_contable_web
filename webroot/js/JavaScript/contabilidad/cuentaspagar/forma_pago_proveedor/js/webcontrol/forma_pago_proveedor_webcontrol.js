...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(forma_pago_proveedor_control) {
		...
		if(forma_pago_proveedor_control.forma_pago_proveedorActual.id_empresa!=null && forma_pago_proveedor_control.forma_pago_proveedorActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != forma_pago_proveedor_control.forma_pago_proveedorActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(forma_pago_proveedor_control.forma_pago_proveedorActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(forma_pago_proveedor_control.forma_pago_proveedorActual.id_tipo_forma_pago!=null && forma_pago_proveedor_control.forma_pago_proveedorActual.id_tipo_forma_pago>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != forma_pago_proveedor_control.forma_pago_proveedorActual.id_tipo_forma_pago) {
				jQuery("#t-cel_"+i+"_4").val(forma_pago_proveedor_control.forma_pago_proveedorActual.id_tipo_forma_pago).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(forma_pago_proveedor_control.forma_pago_proveedorActual.codigo);
		jQuery("#t-cel_"+i+"_6").val(forma_pago_proveedor_control.forma_pago_proveedorActual.nombre);
		jQuery("#t-cel_"+i+"_7").prop('checked',forma_pago_proveedor_control.forma_pago_proveedorActual.predeterminado);
		...
		if(forma_pago_proveedor_control.forma_pago_proveedorActual.id_cuenta!=null && forma_pago_proveedor_control.forma_pago_proveedorActual.id_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != forma_pago_proveedor_control.forma_pago_proveedorActual.id_cuenta) {
				jQuery("#t-cel_"+i+"_8").val(forma_pago_proveedor_control.forma_pago_proveedorActual.id_cuenta).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_9").val(forma_pago_proveedor_control.forma_pago_proveedorActual.cuenta_contable);
	}
