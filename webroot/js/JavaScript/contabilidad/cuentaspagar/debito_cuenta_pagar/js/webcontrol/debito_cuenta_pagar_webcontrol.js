...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(debito_cuenta_pagar_control) {
		...
		if(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_empresa!=null && debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_sucursal!=null && debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_ejercicio!=null && debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_periodo!=null && debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_usuario!=null && debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_cuenta_pagar!=null && debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_cuenta_pagar>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_cuenta_pagar) {
				jQuery("#t-cel_"+i+"_8").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_cuenta_pagar).trigger("change");
			}
		} else { 
		...
		if(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_forma_pago_proveedor!=null && debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_forma_pago_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_forma_pago_proveedor) {
				jQuery("#t-cel_"+i+"_9").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_forma_pago_proveedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_10").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.numero);
		jQuery("#t-cel_"+i+"_11").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.fecha_emision);
		jQuery("#t-cel_"+i+"_12").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.fecha_vence);
		jQuery("#t-cel_"+i+"_13").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.abono);
		jQuery("#t-cel_"+i+"_14").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.saldo);
		jQuery("#t-cel_"+i+"_15").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.descripcion);
		...
		if(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_estado!=null && debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_16").val() != debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_estado) {
				jQuery("#t-cel_"+i+"_16").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_17").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.referencia);
		jQuery("#t-cel_"+i+"_18").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.debito);
		jQuery("#t-cel_"+i+"_19").val(debito_cuenta_pagar_control.debito_cuenta_pagarActual.credito);
	}
