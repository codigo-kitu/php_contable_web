...
<script id="debito_cuenta_pagar_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist debito_cuenta_pagarsLocal)}}
			{{#each debito_cuenta_pagarsLocal}}
