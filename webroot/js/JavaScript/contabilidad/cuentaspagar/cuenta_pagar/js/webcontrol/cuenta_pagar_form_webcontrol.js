...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(cuenta_pagar_control) {
		...
		jQuery("#form"+cuenta_pagar_constante1.STR_SUFIJO+"-created_at").val(cuenta_pagar_control.cuenta_pagarActual.versionRow);
		jQuery("#form"+cuenta_pagar_constante1.STR_SUFIJO+"-updated_at").val(cuenta_pagar_control.cuenta_pagarActual.versionRow);
	...
	actualizarSpanMensajesCampos(cuenta_pagar_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(cuenta_pagar_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(cuenta_pagar_control.strMensajeupdated_at);		
