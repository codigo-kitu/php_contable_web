...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cuenta_pagar_control) {
		...
		if(cuenta_pagar_control.cuenta_pagarActual.id_empresa!=null && cuenta_pagar_control.cuenta_pagarActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != cuenta_pagar_control.cuenta_pagarActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(cuenta_pagar_control.cuenta_pagarActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(cuenta_pagar_control.cuenta_pagarActual.id_sucursal!=null && cuenta_pagar_control.cuenta_pagarActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != cuenta_pagar_control.cuenta_pagarActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(cuenta_pagar_control.cuenta_pagarActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(cuenta_pagar_control.cuenta_pagarActual.id_ejercicio!=null && cuenta_pagar_control.cuenta_pagarActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != cuenta_pagar_control.cuenta_pagarActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(cuenta_pagar_control.cuenta_pagarActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(cuenta_pagar_control.cuenta_pagarActual.id_periodo!=null && cuenta_pagar_control.cuenta_pagarActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != cuenta_pagar_control.cuenta_pagarActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(cuenta_pagar_control.cuenta_pagarActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(cuenta_pagar_control.cuenta_pagarActual.id_usuario!=null && cuenta_pagar_control.cuenta_pagarActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != cuenta_pagar_control.cuenta_pagarActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(cuenta_pagar_control.cuenta_pagarActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(cuenta_pagar_control.cuenta_pagarActual.id_orden_compra!=null && cuenta_pagar_control.cuenta_pagarActual.id_orden_compra>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != cuenta_pagar_control.cuenta_pagarActual.id_orden_compra) {
				jQuery("#t-cel_"+i+"_8").val(cuenta_pagar_control.cuenta_pagarActual.id_orden_compra).trigger("change");
			}
		} else { 
		...
		if(cuenta_pagar_control.cuenta_pagarActual.id_proveedor!=null && cuenta_pagar_control.cuenta_pagarActual.id_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != cuenta_pagar_control.cuenta_pagarActual.id_proveedor) {
				jQuery("#t-cel_"+i+"_9").val(cuenta_pagar_control.cuenta_pagarActual.id_proveedor).trigger("change");
			}
		} else { 
		...
		if(cuenta_pagar_control.cuenta_pagarActual.id_termino_pago_proveedor!=null && cuenta_pagar_control.cuenta_pagarActual.id_termino_pago_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_10").val() != cuenta_pagar_control.cuenta_pagarActual.id_termino_pago_proveedor) {
				jQuery("#t-cel_"+i+"_10").val(cuenta_pagar_control.cuenta_pagarActual.id_termino_pago_proveedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_11").val(cuenta_pagar_control.cuenta_pagarActual.numero);
		jQuery("#t-cel_"+i+"_12").val(cuenta_pagar_control.cuenta_pagarActual.fecha_emision);
		jQuery("#t-cel_"+i+"_13").val(cuenta_pagar_control.cuenta_pagarActual.fecha_vence);
		jQuery("#t-cel_"+i+"_14").val(cuenta_pagar_control.cuenta_pagarActual.fecha_ultimo_movimiento);
		jQuery("#t-cel_"+i+"_15").val(cuenta_pagar_control.cuenta_pagarActual.monto);
		jQuery("#t-cel_"+i+"_16").val(cuenta_pagar_control.cuenta_pagarActual.saldo);
		jQuery("#t-cel_"+i+"_17").val(cuenta_pagar_control.cuenta_pagarActual.porcentaje);
		jQuery("#t-cel_"+i+"_18").val(cuenta_pagar_control.cuenta_pagarActual.descripcion);
		...
		if(cuenta_pagar_control.cuenta_pagarActual.id_estado_cuentas_pagar!=null && cuenta_pagar_control.cuenta_pagarActual.id_estado_cuentas_pagar>-1){
			if(jQuery("#t-cel_"+i+"_19").val() != cuenta_pagar_control.cuenta_pagarActual.id_estado_cuentas_pagar) {
				jQuery("#t-cel_"+i+"_19").val(cuenta_pagar_control.cuenta_pagarActual.id_estado_cuentas_pagar).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_20").val(cuenta_pagar_control.cuenta_pagarActual.referencia);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(cuenta_pagar_control) {
		...
		if(cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_pagar_control.idFilaTablaActual+"_3",cuenta_pagar_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(cuenta_pagar_control) {
		...
		if(cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_pagar_control.idFilaTablaActual+"_4",cuenta_pagar_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(cuenta_pagar_control) {
		...
		if(cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_pagar_control.idFilaTablaActual+"_5",cuenta_pagar_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(cuenta_pagar_control) {
		...
		if(cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_pagar_control.idFilaTablaActual+"_6",cuenta_pagar_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(cuenta_pagar_control) {
		...
		if(cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_pagar_control.idFilaTablaActual+"_7",cuenta_pagar_control.usuariosFK);
		}
	};
	...
	cargarCombosorden_comprasFK(cuenta_pagar_control) {
		...
		if(cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_pagar_control.idFilaTablaActual+"_8",cuenta_pagar_control.orden_comprasFK);
		}
	...
	cargarCombosproveedorsFK(cuenta_pagar_control) {
		...
		if(cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_pagar_control.idFilaTablaActual+"_9",cuenta_pagar_control.proveedorsFK);
		}
	...
	cargarCombostermino_pago_proveedorsFK(cuenta_pagar_control) {
		...
		if(cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_pagar_control.idFilaTablaActual+"_10",cuenta_pagar_control.termino_pago_proveedorsFK);
		}
	...
	cargarCombosestado_cuentas_pagarsFK(cuenta_pagar_control) {
		...
		if(cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_pagar_control.idFilaTablaActual+"_19",cuenta_pagar_control.estado_cuentas_pagarsFK);
		}
