...
<script id="cuenta_pagar_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarcuenta_pagarsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each cuenta_pagarsReporte}}

			<table id="tablecuenta_pagar{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy '% Interes' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy ' Estado Cuentas Pagar' ../arrOrderBy ../bitParaReporteOrderBy) }}
				...
				<tr>
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								<td width="20%" {{../strAuxStyleBackgroundContenidoCabecera}} >
									<b>-  Estado Cuentas Pagar</b>
								</td>
								<td>{{trim id_estado_cuentas_pagar_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
