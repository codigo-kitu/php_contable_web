...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(documento_cuenta_pagar_control) {
		...
		if(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_empresa!=null && documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_sucursal!=null && documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_ejercicio!=null && documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_periodo!=null && documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_usuario!=null && documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_usuario).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_8").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.numero);
		...
		if(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_proveedor!=null && documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_proveedor) {
				jQuery("#t-cel_"+i+"_9").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_proveedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_10").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.tipo);
		jQuery("#t-cel_"+i+"_11").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.fecha_emision);
		jQuery("#t-cel_"+i+"_12").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.descripcion);
		jQuery("#t-cel_"+i+"_13").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.monto);
		jQuery("#t-cel_"+i+"_14").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.monto_parcial);
		jQuery("#t-cel_"+i+"_15").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.moneda);
		jQuery("#t-cel_"+i+"_16").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.fecha_vence);
		jQuery("#t-cel_"+i+"_17").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.numero_de_pagos);
		jQuery("#t-cel_"+i+"_18").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.balance);
		jQuery("#t-cel_"+i+"_19").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.balance_mon);
		jQuery("#t-cel_"+i+"_20").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.numero_pagado);
		jQuery("#t-cel_"+i+"_21").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_pagado);
		jQuery("#t-cel_"+i+"_22").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.modulo_origen);
		jQuery("#t-cel_"+i+"_23").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_origen);
		jQuery("#t-cel_"+i+"_24").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.modulo_destino);
		jQuery("#t-cel_"+i+"_25").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_destino);
		jQuery("#t-cel_"+i+"_26").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.nombre_pc);
		jQuery("#t-cel_"+i+"_27").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.hora);
		jQuery("#t-cel_"+i+"_28").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.monto_mora);
		jQuery("#t-cel_"+i+"_29").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.interes_mora);
		jQuery("#t-cel_"+i+"_30").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.dias_gracia_mora);
		jQuery("#t-cel_"+i+"_31").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.instrumento_pago);
		jQuery("#t-cel_"+i+"_32").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.tipo_cambio);
		jQuery("#t-cel_"+i+"_33").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.nro_documento_proveedor);
		jQuery("#t-cel_"+i+"_34").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.clase_registro);
		jQuery("#t-cel_"+i+"_35").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.estado_registro);
		jQuery("#t-cel_"+i+"_36").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.motivo_anulacion);
		jQuery("#t-cel_"+i+"_37").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.impuesto_1);
		jQuery("#t-cel_"+i+"_38").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.impuesto_2);
		jQuery("#t-cel_"+i+"_39").prop('checked',documento_cuenta_pagar_control.documento_cuenta_pagarActual.impuesto_incluido);
		jQuery("#t-cel_"+i+"_40").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.observaciones);
		jQuery("#t-cel_"+i+"_41").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.grupo_pago);
		jQuery("#t-cel_"+i+"_42").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.termino_idpv);
		...
		if(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_forma_pago_proveedor!=null && documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_forma_pago_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_43").val() != documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_forma_pago_proveedor) {
				jQuery("#t-cel_"+i+"_43").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_forma_pago_proveedor).trigger("change");
			}
		} else { 
			//jQuery("#t-cel_"+i+"_43").select2("val", null);
		...
		jQuery("#t-cel_"+i+"_44").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.nro_pago);
		jQuery("#t-cel_"+i+"_45").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.referencia_pago);
		jQuery("#t-cel_"+i+"_46").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.fecha_hora);
		jQuery("#t-cel_"+i+"_47").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_base);
		...
		if(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_cuenta_corriente!=null && documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_cuenta_corriente>-1){
			if(jQuery("#t-cel_"+i+"_48").val() != documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_cuenta_corriente) {
				jQuery("#t-cel_"+i+"_48").val(documento_cuenta_pagar_control.documento_cuenta_pagarActual.id_cuenta_corriente).trigger("change");
			}
		} else { 
