...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(proveedor_control) {
		...
		if(proveedor_control.proveedorActual.id_empresa!=null && proveedor_control.proveedorActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != proveedor_control.proveedorActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(proveedor_control.proveedorActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(proveedor_control.proveedorActual.id_tipo_persona!=null && proveedor_control.proveedorActual.id_tipo_persona>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != proveedor_control.proveedorActual.id_tipo_persona) {
				jQuery("#t-cel_"+i+"_4").val(proveedor_control.proveedorActual.id_tipo_persona).trigger("change");
			}
		} else { 
		...
		if(proveedor_control.proveedorActual.id_categoria_proveedor!=null && proveedor_control.proveedorActual.id_categoria_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != proveedor_control.proveedorActual.id_categoria_proveedor) {
				jQuery("#t-cel_"+i+"_5").val(proveedor_control.proveedorActual.id_categoria_proveedor).trigger("change");
			}
		} else { 
		...
		if(proveedor_control.proveedorActual.id_giro_negocio_proveedor!=null && proveedor_control.proveedorActual.id_giro_negocio_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != proveedor_control.proveedorActual.id_giro_negocio_proveedor) {
				jQuery("#t-cel_"+i+"_6").val(proveedor_control.proveedorActual.id_giro_negocio_proveedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(proveedor_control.proveedorActual.codigo);
		jQuery("#t-cel_"+i+"_8").val(proveedor_control.proveedorActual.ruc);
		jQuery("#t-cel_"+i+"_9").val(proveedor_control.proveedorActual.primer_apellido);
		jQuery("#t-cel_"+i+"_10").val(proveedor_control.proveedorActual.segundo_apellido);
		jQuery("#t-cel_"+i+"_11").val(proveedor_control.proveedorActual.primer_nombre);
		jQuery("#t-cel_"+i+"_12").val(proveedor_control.proveedorActual.segundo_nombre);
		jQuery("#t-cel_"+i+"_13").val(proveedor_control.proveedorActual.nombre_completo);
		jQuery("#t-cel_"+i+"_14").val(proveedor_control.proveedorActual.direccion);
		jQuery("#t-cel_"+i+"_15").val(proveedor_control.proveedorActual.telefono);
		jQuery("#t-cel_"+i+"_16").val(proveedor_control.proveedorActual.telefono_movil);
		jQuery("#t-cel_"+i+"_17").val(proveedor_control.proveedorActual.e_mail);
		jQuery("#t-cel_"+i+"_18").val(proveedor_control.proveedorActual.e_mail2);
		jQuery("#t-cel_"+i+"_19").val(proveedor_control.proveedorActual.comentario);
		jQuery("#t-cel_"+i+"_20").val(proveedor_control.proveedorActual.imagen);
		jQuery("#t-cel_"+i+"_21").prop('checked',proveedor_control.proveedorActual.activo);
		
		if(proveedor_control.proveedorActual.id_pais!=null && proveedor_control.proveedorActual.id_pais>-1){
			if(jQuery("#t-cel_"+i+"_22").val() != proveedor_control.proveedorActual.id_pais) {
				jQuery("#t-cel_"+i+"_22").val(proveedor_control.proveedorActual.id_pais).trigger("change");
			}
		} else { 
		...
		if(proveedor_control.proveedorActual.id_provincia!=null && proveedor_control.proveedorActual.id_provincia>-1){
			if(jQuery("#t-cel_"+i+"_23").val() != proveedor_control.proveedorActual.id_provincia) {
				jQuery("#t-cel_"+i+"_23").val(proveedor_control.proveedorActual.id_provincia).trigger("change");
			}
		} else { 
		...
		if(proveedor_control.proveedorActual.id_ciudad!=null && proveedor_control.proveedorActual.id_ciudad>-1){
			if(jQuery("#t-cel_"+i+"_24").val() != proveedor_control.proveedorActual.id_ciudad) {
				jQuery("#t-cel_"+i+"_24").val(proveedor_control.proveedorActual.id_ciudad).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_25").val(proveedor_control.proveedorActual.codigo_postal);
		jQuery("#t-cel_"+i+"_26").val(proveedor_control.proveedorActual.fax);
		jQuery("#t-cel_"+i+"_27").val(proveedor_control.proveedorActual.contacto);
		
		if(proveedor_control.proveedorActual.id_vendedor!=null && proveedor_control.proveedorActual.id_vendedor>-1){
			if(jQuery("#t-cel_"+i+"_28").val() != proveedor_control.proveedorActual.id_vendedor) {
				jQuery("#t-cel_"+i+"_28").val(proveedor_control.proveedorActual.id_vendedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_29").val(proveedor_control.proveedorActual.maximo_credito);
		jQuery("#t-cel_"+i+"_30").val(proveedor_control.proveedorActual.maximo_descuento);
		jQuery("#t-cel_"+i+"_31").val(proveedor_control.proveedorActual.interes_anual);
		jQuery("#t-cel_"+i+"_32").val(proveedor_control.proveedorActual.balance);
		...
		if(proveedor_control.proveedorActual.id_termino_pago_proveedor!=null && proveedor_control.proveedorActual.id_termino_pago_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_33").val() != proveedor_control.proveedorActual.id_termino_pago_proveedor) {
				jQuery("#t-cel_"+i+"_33").val(proveedor_control.proveedorActual.id_termino_pago_proveedor).trigger("change");
			}
		} else { 
		...
		if(proveedor_control.proveedorActual.id_cuenta!=null && proveedor_control.proveedorActual.id_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_34").val() != proveedor_control.proveedorActual.id_cuenta) {
				jQuery("#t-cel_"+i+"_34").val(proveedor_control.proveedorActual.id_cuenta).trigger("change");
			}
		} else { 
		...
		if(proveedor_control.proveedorActual.id_impuesto!=null && proveedor_control.proveedorActual.id_impuesto>-1){
			if(jQuery("#t-cel_"+i+"_36").val() != proveedor_control.proveedorActual.id_impuesto) {
				jQuery("#t-cel_"+i+"_36").val(proveedor_control.proveedorActual.id_impuesto).trigger("change");
			}
		} else { 
			//jQuery("#t-cel_"+i+"_36").select2("val", null);
			if(jQuery("#t-cel_"+i+"_36").val() != constantes.INT_VALOR_ESCOJA_OPCION) {
				jQuery("#t-cel_"+i+"_36").val(constantes.INT_VALOR_ESCOJA_OPCION).trigger("change");
			}
		}
		jQuery("#t-cel_"+i+"_37").prop('checked',proveedor_control.proveedorActual.aplica_retencion_impuesto);
		
		if(proveedor_control.proveedorActual.id_retencion!=null && proveedor_control.proveedorActual.id_retencion>-1){
			if(jQuery("#t-cel_"+i+"_38").val() != proveedor_control.proveedorActual.id_retencion) {
				jQuery("#t-cel_"+i+"_38").val(proveedor_control.proveedorActual.id_retencion).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_39").prop('checked',proveedor_control.proveedorActual.aplica_retencion_fuente);
		
		if(proveedor_control.proveedorActual.id_retencion_fuente!=null && proveedor_control.proveedorActual.id_retencion_fuente>-1){
			if(jQuery("#t-cel_"+i+"_40").val() != proveedor_control.proveedorActual.id_retencion_fuente) {
				jQuery("#t-cel_"+i+"_40").val(proveedor_control.proveedorActual.id_retencion_fuente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_41").prop('checked',proveedor_control.proveedorActual.aplica_retencion_ica);
		
		if(proveedor_control.proveedorActual.id_retencion_ica!=null && proveedor_control.proveedorActual.id_retencion_ica>-1){
			if(jQuery("#t-cel_"+i+"_42").val() != proveedor_control.proveedorActual.id_retencion_ica) {
				jQuery("#t-cel_"+i+"_42").val(proveedor_control.proveedorActual.id_retencion_ica).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_43").prop('checked',proveedor_control.proveedorActual.aplica_2do_impuesto);
		
		if(proveedor_control.proveedorActual.id_otro_impuesto!=null && proveedor_control.proveedorActual.id_otro_impuesto>-1){
			if(jQuery("#t-cel_"+i+"_44").val() != proveedor_control.proveedorActual.id_otro_impuesto) {
				jQuery("#t-cel_"+i+"_44").val(proveedor_control.proveedorActual.id_otro_impuesto).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_45").val(proveedor_control.proveedorActual.creado);
		jQuery("#t-cel_"+i+"_46").val(proveedor_control.proveedorActual.monto_ultima_transaccion);
		jQuery("#t-cel_"+i+"_47").val(proveedor_control.proveedorActual.fecha_ultima_transaccion);
		jQuery("#t-cel_"+i+"_48").val(proveedor_control.proveedorActual.descripcion_ultima_transaccion);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_3",proveedor_control.empresasFK);
		}
	};
	...
	cargarCombostipo_personasFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_4",proveedor_control.tipo_personasFK);
		}
	...
	cargarComboscategoria_proveedorsFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_5",proveedor_control.categoria_proveedorsFK);
		}
	...
	cargarCombosgiro_negocio_proveedorsFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_6",proveedor_control.giro_negocio_proveedorsFK);
		}
	...
	cargarCombospaissFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_22",proveedor_control.paissFK);
		}
	...
	cargarCombosprovinciasFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_23",proveedor_control.provinciasFK);
		}
	...
	cargarCombosciudadsFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_24",proveedor_control.ciudadsFK);
		}
	...
	cargarCombosvendedorsFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_28",proveedor_control.vendedorsFK);
		}
	...
	cargarCombostermino_pago_proveedorsFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_33",proveedor_control.termino_pago_proveedorsFK);
		}
	...
	cargarComboscuentasFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_34",proveedor_control.cuentasFK);
		}
	...
	cargarCombosimpuestosFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_36",proveedor_control.impuestosFK);
		}
	...
	cargarCombosretencionsFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_38",proveedor_control.retencionsFK);
		}
	...
	cargarCombosretencion_fuentesFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_40",proveedor_control.retencion_fuentesFK);
		}
	...
	cargarCombosretencion_icasFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_42",proveedor_control.retencion_icasFK);
		}
	...
	cargarCombosotro_impuestosFK(proveedor_control) {
		...
		if(proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+proveedor_control.idFilaTablaActual+"_44",proveedor_control.otro_impuestosFK);
		}
