...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(proveedor_control) {
		...
		jQuery("#form"+proveedor_constante1.STR_SUFIJO+"-created_at").val(proveedor_control.proveedorActual.versionRow);
		jQuery("#form"+proveedor_constante1.STR_SUFIJO+"-updated_at").val(proveedor_control.proveedorActual.versionRow);
	...
	actualizarSpanMensajesCampos(proveedor_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(proveedor_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(proveedor_control.strMensajeupdated_at);		
