...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(parametro_cuenta_pagar_control) {
		...
		if(parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.id_empresa!=null && parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.numero_cuenta_pagar);
		jQuery("#t-cel_"+i+"_5").val(parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.numero_credito);
		jQuery("#t-cel_"+i+"_6").val(parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.numero_debito);
		jQuery("#t-cel_"+i+"_7").val(parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.numero_pago);
		jQuery("#t-cel_"+i+"_8").prop('checked',parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.mostrar_anulado);
		jQuery("#t-cel_"+i+"_9").val(parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.numero_proveedor);
		jQuery("#t-cel_"+i+"_10").prop('checked',parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.con_proveedor_inactivo);
	}
