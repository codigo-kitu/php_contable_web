...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(termino_pago_proveedor_control) {
		...
		if(termino_pago_proveedor_control.termino_pago_proveedorActual.id_empresa!=null && termino_pago_proveedor_control.termino_pago_proveedorActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != termino_pago_proveedor_control.termino_pago_proveedorActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(termino_pago_proveedor_control.termino_pago_proveedorActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(termino_pago_proveedor_control.termino_pago_proveedorActual.id_tipo_termino_pago!=null && termino_pago_proveedor_control.termino_pago_proveedorActual.id_tipo_termino_pago>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != termino_pago_proveedor_control.termino_pago_proveedorActual.id_tipo_termino_pago) {
				jQuery("#t-cel_"+i+"_4").val(termino_pago_proveedor_control.termino_pago_proveedorActual.id_tipo_termino_pago).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(termino_pago_proveedor_control.termino_pago_proveedorActual.codigo);
		jQuery("#t-cel_"+i+"_6").val(termino_pago_proveedor_control.termino_pago_proveedorActual.descripcion);
		jQuery("#t-cel_"+i+"_7").val(termino_pago_proveedor_control.termino_pago_proveedorActual.monto);
		jQuery("#t-cel_"+i+"_8").val(termino_pago_proveedor_control.termino_pago_proveedorActual.dias);
		jQuery("#t-cel_"+i+"_9").val(termino_pago_proveedor_control.termino_pago_proveedorActual.inicial);
		jQuery("#t-cel_"+i+"_10").val(termino_pago_proveedor_control.termino_pago_proveedorActual.cuotas);
		jQuery("#t-cel_"+i+"_11").val(termino_pago_proveedor_control.termino_pago_proveedorActual.descuento_pronto_pago);
		jQuery("#t-cel_"+i+"_12").prop('checked',termino_pago_proveedor_control.termino_pago_proveedorActual.predeterminado);
		...
		if(termino_pago_proveedor_control.termino_pago_proveedorActual.id_cuenta!=null && termino_pago_proveedor_control.termino_pago_proveedorActual.id_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_13").val() != termino_pago_proveedor_control.termino_pago_proveedorActual.id_cuenta) {
				jQuery("#t-cel_"+i+"_13").val(termino_pago_proveedor_control.termino_pago_proveedorActual.id_cuenta).trigger("change");
			}
		} else { 
