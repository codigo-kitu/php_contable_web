...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(imagen_documento_cuenta_pagar_control) {
		...
		jQuery("#t-version_row_"+i+"").val(imagen_documento_cuenta_pagar_control.imagen_documento_cuenta_pagarActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(imagen_documento_cuenta_pagar_control.imagen_documento_cuenta_pagarActual.imagen);
		...
		if(imagen_documento_cuenta_pagar_control.imagen_documento_cuenta_pagarActual.id_documento_cuenta_pagar!=null && imagen_documento_cuenta_pagar_control.imagen_documento_cuenta_pagarActual.id_documento_cuenta_pagar>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != imagen_documento_cuenta_pagar_control.imagen_documento_cuenta_pagarActual.id_documento_cuenta_pagar) {
				jQuery("#t-cel_"+i+"_4").val(imagen_documento_cuenta_pagar_control.imagen_documento_cuenta_pagarActual.id_documento_cuenta_pagar).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(imagen_documento_cuenta_pagar_control.imagen_documento_cuenta_pagarActual.nro_documento);
	}
