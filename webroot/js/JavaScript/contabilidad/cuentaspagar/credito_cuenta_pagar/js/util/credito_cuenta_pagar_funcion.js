		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(credito_cuenta_pagar_control.idtermino_pago_proveedorDefaultForeignKey!=null && credito_cuenta_pagar_control.idtermino_pago_proveedorDefaultForeignKey>-1) {
					idActual=credito_cuenta_pagar_control.idtermino_pago_proveedorDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					credito_cuenta_pagar_webcontrol1.cargarComboEditarTablatermino_pago_proveedorFK(credito_cuenta_pagar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						credito_cuenta_pagar_webcontrol1.cargarComboEditarTablatermino_pago_proveedorFK(credito_cuenta_pagar_control,control_name,idActual,true);
					}
				});
