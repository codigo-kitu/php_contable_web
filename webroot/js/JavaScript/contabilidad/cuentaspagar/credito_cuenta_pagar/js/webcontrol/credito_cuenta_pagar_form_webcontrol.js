...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(credito_cuenta_pagar_control) {
		...
		jQuery("#form"+credito_cuenta_pagar_constante1.STR_SUFIJO+"-created_at").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.versionRow);
		jQuery("#form"+credito_cuenta_pagar_constante1.STR_SUFIJO+"-updated_at").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.versionRow);
	...
	actualizarSpanMensajesCampos(credito_cuenta_pagar_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(credito_cuenta_pagar_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(credito_cuenta_pagar_control.strMensajeupdated_at);		
