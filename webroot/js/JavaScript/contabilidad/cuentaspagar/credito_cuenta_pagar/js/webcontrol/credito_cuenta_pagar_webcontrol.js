...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(credito_cuenta_pagar_control) {
		...
		if(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_empresa!=null && credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_sucursal!=null && credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_ejercicio!=null && credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_periodo!=null && credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_usuario!=null && credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_cuenta_pagar!=null && credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_cuenta_pagar>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_cuenta_pagar) {
				jQuery("#t-cel_"+i+"_8").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_cuenta_pagar).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_9").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.numero);
		jQuery("#t-cel_"+i+"_10").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.fecha_emision);
		jQuery("#t-cel_"+i+"_11").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.fecha_vence);
		...
		if(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_termino_pago_proveedor!=null && credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_termino_pago_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_12").val() != credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_termino_pago_proveedor) {
				jQuery("#t-cel_"+i+"_12").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_termino_pago_proveedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_13").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.monto);
		jQuery("#t-cel_"+i+"_14").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.saldo);
		jQuery("#t-cel_"+i+"_15").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.descripcion);
		jQuery("#t-cel_"+i+"_16").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.sub_total);
		jQuery("#t-cel_"+i+"_17").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.iva);
		jQuery("#t-cel_"+i+"_18").prop('checked',credito_cuenta_pagar_control.credito_cuenta_pagarActual.es_balance_inicial);
		...
		if(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_estado!=null && credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_19").val() != credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_estado) {
				jQuery("#t-cel_"+i+"_19").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_20").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.referencia);
		jQuery("#t-cel_"+i+"_21").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.debito);
		jQuery("#t-cel_"+i+"_22").val(credito_cuenta_pagar_control.credito_cuenta_pagarActual.credito);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(credito_cuenta_pagar_control) {
		...
		if(credito_cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_pagar_control.idFilaTablaActual+"_3",credito_cuenta_pagar_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(credito_cuenta_pagar_control) {
		...
		if(credito_cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_pagar_control.idFilaTablaActual+"_4",credito_cuenta_pagar_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(credito_cuenta_pagar_control) {
		...
		if(credito_cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_pagar_control.idFilaTablaActual+"_5",credito_cuenta_pagar_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(credito_cuenta_pagar_control) {
		...
		if(credito_cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_pagar_control.idFilaTablaActual+"_6",credito_cuenta_pagar_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(credito_cuenta_pagar_control) {
		...
		if(credito_cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_pagar_control.idFilaTablaActual+"_7",credito_cuenta_pagar_control.usuariosFK);
		}
	};
	...
	cargarComboscuenta_pagarsFK(credito_cuenta_pagar_control) {
		...
		if(credito_cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_pagar_control.idFilaTablaActual+"_8",credito_cuenta_pagar_control.cuenta_pagarsFK);
		}
	...
	cargarCombostermino_pago_proveedorsFK(credito_cuenta_pagar_control) {
		...
		if(credito_cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_pagar_control.idFilaTablaActual+"_12",credito_cuenta_pagar_control.termino_pago_proveedorsFK);
		}
	...
	cargarCombosestadosFK(credito_cuenta_pagar_control) {
		...
		if(credito_cuenta_pagar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_pagar_control.idFilaTablaActual+"_19",credito_cuenta_pagar_control.estadosFK);
		}
