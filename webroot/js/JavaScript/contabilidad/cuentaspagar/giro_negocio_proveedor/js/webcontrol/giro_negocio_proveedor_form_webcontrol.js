...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(giro_negocio_proveedor_control) {
		...
		jQuery("#form"+giro_negocio_proveedor_constante1.STR_SUFIJO+"-created_at").val(giro_negocio_proveedor_control.giro_negocio_proveedorActual.versionRow);
		jQuery("#form"+giro_negocio_proveedor_constante1.STR_SUFIJO+"-updated_at").val(giro_negocio_proveedor_control.giro_negocio_proveedorActual.versionRow);
	...
	actualizarSpanMensajesCampos(giro_negocio_proveedor_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(giro_negocio_proveedor_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(giro_negocio_proveedor_control.strMensajeupdated_at);		
