...
<script id="giro_negocio_proveedor_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliargiro_negocio_proveedorsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each giro_negocio_proveedorsReporte}}

			<table id="tablegiro_negocio_proveedor{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
