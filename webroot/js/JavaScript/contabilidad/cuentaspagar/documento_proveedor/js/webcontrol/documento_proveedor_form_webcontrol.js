...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(documento_proveedor_control) {
		...
		jQuery("#form"+documento_proveedor_constante1.STR_SUFIJO+"-created_at").val(documento_proveedor_control.documento_proveedorActual.versionRow);
		jQuery("#form"+documento_proveedor_constante1.STR_SUFIJO+"-updated_at").val(documento_proveedor_control.documento_proveedorActual.versionRow);
	...
	actualizarSpanMensajesCampos(documento_proveedor_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(documento_proveedor_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(documento_proveedor_control.strMensajeupdated_at);		
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosproveedorsFK(documento_proveedor_control) {
		...
		if(documento_proveedor_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+documento_proveedor_control.idFilaTablaActual+"_3",documento_proveedor_control.proveedorsFK);
		}
