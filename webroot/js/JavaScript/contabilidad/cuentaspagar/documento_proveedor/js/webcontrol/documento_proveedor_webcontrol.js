...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(documento_proveedor_control) {
		...
		if(documento_proveedor_control.documento_proveedorActual.id_proveedor!=null && documento_proveedor_control.documento_proveedorActual.id_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != documento_proveedor_control.documento_proveedorActual.id_proveedor) {
				jQuery("#t-cel_"+i+"_3").val(documento_proveedor_control.documento_proveedorActual.id_proveedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(documento_proveedor_control.documento_proveedorActual.documento);
	}
