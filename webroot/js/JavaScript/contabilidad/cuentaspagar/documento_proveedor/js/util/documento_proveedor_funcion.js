...
/*---------- Clic-Buscar-Auxiliar ----------*/
	procesarInicioBusqueda() { 
		funcionGeneral.procesarInicioBusquedaPrincipal(documento_proveedor_constante1.STR_RELATIVE_PATH,"documento_proveedor"); 
	}
	
	procesarFinalizacionBusqueda() { 
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(documento_proveedor_constante1.STR_RELATIVE_PATH,documento_proveedor_constante1.STR_NOMBRE_OPCION,"documento_proveedor"); 
	}
/*---------- Clic-Siguiente ----------*/
	siguientesOnClick() { 
		this.procesarInicioBusqueda(); 
...
/*---------- Clic-Seleccionar ----------*/
	...
	seleccionarMostrarDivAccionesRelacionesActualOnComplete() { 
		funcionGeneral.seleccionarMostrarDivAccionesRelacionesActualOnComplete("documento_proveedor",this,documento_proveedor_constante1); 
	}
/*---------- Clic-Reporte ----------------*/
	...
	generarReporteFinalizacion() { 
		funcionGeneral.generarReporteFinalizacion(documento_proveedor_constante1.STR_RELATIVE_PATH,documento_proveedor_constante1.STR_NOMBRE_OPCION); 
	}
/*---------- Clic-Generar-Html -----------*/
...
/*-------------- Clic-Copiar -------------------*/
	...
	/*---------------------------------- AREA:TABLA ---------------------------*/
/*------------- Tabla-Validacion -------------------*/
	registrarControlesTableValidacionEdition(documento_proveedor_control,documento_proveedor_webcontrol1,documento_proveedor_constante1) {
		
		var strSuf=documento_proveedor_constante1.STR_SUFIJO;
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(documento_proveedor_control.idproveedorDefaultForeignKey!=null && documento_proveedor_control.idproveedorDefaultForeignKey>-1) {
					idActual=documento_proveedor_control.idproveedorDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					documento_proveedor_webcontrol1.cargarComboEditarTablaproveedorFK(documento_proveedor_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						documento_proveedor_webcontrol1.cargarComboEditarTablaproveedorFK(documento_proveedor_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatosdocumento_proveedor").validate(json_rules);
