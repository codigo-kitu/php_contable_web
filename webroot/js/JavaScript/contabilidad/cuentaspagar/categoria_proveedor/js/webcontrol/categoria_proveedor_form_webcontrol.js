...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(categoria_proveedor_control) {
		...
		jQuery("#form"+categoria_proveedor_constante1.STR_SUFIJO+"-created_at").val(categoria_proveedor_control.categoria_proveedorActual.versionRow);
		jQuery("#form"+categoria_proveedor_constante1.STR_SUFIJO+"-updated_at").val(categoria_proveedor_control.categoria_proveedorActual.versionRow);
	...
	actualizarSpanMensajesCampos(categoria_proveedor_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(categoria_proveedor_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(categoria_proveedor_control.strMensajeupdated_at);		
