...
<script id="categoria_proveedor_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarcategoria_proveedorsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each categoria_proveedorsReporte}}

			<table id="tablecategoria_proveedor{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
