...
<script id="pago_cuenta_pagar_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarpago_cuenta_pagarsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each pago_cuenta_pagarsReporte}}

			<table id="tablepago_cuenta_pagar{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
