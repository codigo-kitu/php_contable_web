...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(pago_cuenta_pagar_control) {
		...
		jQuery("#form"+pago_cuenta_pagar_constante1.STR_SUFIJO+"-created_at").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.versionRow);
		jQuery("#form"+pago_cuenta_pagar_constante1.STR_SUFIJO+"-updated_at").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.versionRow);
	...
	actualizarSpanMensajesCampos(pago_cuenta_pagar_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(pago_cuenta_pagar_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(pago_cuenta_pagar_control.strMensajeupdated_at);		
