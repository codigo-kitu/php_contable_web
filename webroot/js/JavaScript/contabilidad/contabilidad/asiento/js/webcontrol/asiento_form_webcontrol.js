...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(asiento_control) {
		...
		jQuery("#form"+asiento_constante1.STR_SUFIJO+"-created_at").val(asiento_control.asientoActual.versionRow);
		jQuery("#form"+asiento_constante1.STR_SUFIJO+"-updated_at").val(asiento_control.asientoActual.versionRow);
	...
	actualizarSpanMensajesCampos(asiento_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(asiento_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(asiento_control.strMensajeupdated_at);		
