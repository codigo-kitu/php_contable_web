...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(asiento_control) {
		...
		if(asiento_control.asientoActual.id_empresa!=null && asiento_control.asientoActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != asiento_control.asientoActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(asiento_control.asientoActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(asiento_control.asientoActual.id_sucursal!=null && asiento_control.asientoActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != asiento_control.asientoActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(asiento_control.asientoActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(asiento_control.asientoActual.id_ejercicio!=null && asiento_control.asientoActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != asiento_control.asientoActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(asiento_control.asientoActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(asiento_control.asientoActual.id_periodo!=null && asiento_control.asientoActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != asiento_control.asientoActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(asiento_control.asientoActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(asiento_control.asientoActual.id_usuario!=null && asiento_control.asientoActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != asiento_control.asientoActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(asiento_control.asientoActual.id_usuario).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_8").val(asiento_control.asientoActual.numero);
		jQuery("#t-cel_"+i+"_9").val(asiento_control.asientoActual.fecha);
		
		if(asiento_control.asientoActual.id_asiento_predefinido!=null && asiento_control.asientoActual.id_asiento_predefinido>-1){
			if(jQuery("#t-cel_"+i+"_10").val() != asiento_control.asientoActual.id_asiento_predefinido) {
				jQuery("#t-cel_"+i+"_10").val(asiento_control.asientoActual.id_asiento_predefinido).trigger("change");
			}
		} else { 
		...
		if(asiento_control.asientoActual.id_documento_contable!=null && asiento_control.asientoActual.id_documento_contable>-1){
			if(jQuery("#t-cel_"+i+"_11").val() != asiento_control.asientoActual.id_documento_contable) {
				jQuery("#t-cel_"+i+"_11").val(asiento_control.asientoActual.id_documento_contable).trigger("change");
			}
		} else { 
		...
		if(asiento_control.asientoActual.id_libro_auxiliar!=null && asiento_control.asientoActual.id_libro_auxiliar>-1){
			if(jQuery("#t-cel_"+i+"_12").val() != asiento_control.asientoActual.id_libro_auxiliar) {
				jQuery("#t-cel_"+i+"_12").val(asiento_control.asientoActual.id_libro_auxiliar).trigger("change");
			}
		} else { 
		...
		if(asiento_control.asientoActual.id_fuente!=null && asiento_control.asientoActual.id_fuente>-1){
			if(jQuery("#t-cel_"+i+"_13").val() != asiento_control.asientoActual.id_fuente) {
				jQuery("#t-cel_"+i+"_13").val(asiento_control.asientoActual.id_fuente).trigger("change");
			}
		} else { 
		...
		if(asiento_control.asientoActual.id_centro_costo!=null && asiento_control.asientoActual.id_centro_costo>-1){
			if(jQuery("#t-cel_"+i+"_14").val() != asiento_control.asientoActual.id_centro_costo) {
				jQuery("#t-cel_"+i+"_14").val(asiento_control.asientoActual.id_centro_costo).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_15").val(asiento_control.asientoActual.descripcion);
		jQuery("#t-cel_"+i+"_16").val(asiento_control.asientoActual.total_debito);
		jQuery("#t-cel_"+i+"_17").val(asiento_control.asientoActual.total_credito);
		jQuery("#t-cel_"+i+"_18").val(asiento_control.asientoActual.diferencia);
		
		if(asiento_control.asientoActual.id_estado!=null && asiento_control.asientoActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_19").val() != asiento_control.asientoActual.id_estado) {
				jQuery("#t-cel_"+i+"_19").val(asiento_control.asientoActual.id_estado).trigger("change");
			}
		} else { 
		...
		if(asiento_control.asientoActual.id_documento_contable_origen!=null && asiento_control.asientoActual.id_documento_contable_origen>-1){
			if(jQuery("#t-cel_"+i+"_20").val() != asiento_control.asientoActual.id_documento_contable_origen) {
				jQuery("#t-cel_"+i+"_20").val(asiento_control.asientoActual.id_documento_contable_origen).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_21").val(asiento_control.asientoActual.valor);
		jQuery("#t-cel_"+i+"_22").val(asiento_control.asientoActual.nro_nit);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_3",asiento_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_4",asiento_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_5",asiento_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_6",asiento_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_7",asiento_control.usuariosFK);
		}
	};
	...
	cargarCombosasiento_predefinidosFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_10",asiento_control.asiento_predefinidosFK);
		}
	...
	cargarCombosdocumento_contablesFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_11",asiento_control.documento_contablesFK);
		}
	...
	cargarComboslibro_auxiliarsFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_12",asiento_control.libro_auxiliarsFK);
		}
	...
	cargarCombosfuentesFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_13",asiento_control.fuentesFK);
		}
	...
	cargarComboscentro_costosFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_14",asiento_control.centro_costosFK);
		}
	...
	cargarCombosestadosFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_19",asiento_control.estadosFK);
		}
	...
	cargarCombosdocumento_contable_origensFK(asiento_control) {
		...
		if(asiento_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_control.idFilaTablaActual+"_20",asiento_control.documento_contable_origensFK);
		}
