...
<script id="asiento_predefinido_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (ValCol 'Dcto Contable' paraReporte)}}
		...
		{{#if (Is_List_Exist asiento_predefinidosLocal)}}
			{{#each asiento_predefinidosLocal}}
