...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(asiento_predefinido_control) {
		...
		if(asiento_predefinido_control.asiento_predefinidoActual.id_empresa!=null && asiento_predefinido_control.asiento_predefinidoActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != asiento_predefinido_control.asiento_predefinidoActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(asiento_predefinido_control.asiento_predefinidoActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(asiento_predefinido_control.asiento_predefinidoActual.id_sucursal!=null && asiento_predefinido_control.asiento_predefinidoActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != asiento_predefinido_control.asiento_predefinidoActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(asiento_predefinido_control.asiento_predefinidoActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(asiento_predefinido_control.asiento_predefinidoActual.id_ejercicio!=null && asiento_predefinido_control.asiento_predefinidoActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != asiento_predefinido_control.asiento_predefinidoActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(asiento_predefinido_control.asiento_predefinidoActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(asiento_predefinido_control.asiento_predefinidoActual.id_periodo!=null && asiento_predefinido_control.asiento_predefinidoActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != asiento_predefinido_control.asiento_predefinidoActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(asiento_predefinido_control.asiento_predefinidoActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(asiento_predefinido_control.asiento_predefinidoActual.id_usuario!=null && asiento_predefinido_control.asiento_predefinidoActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != asiento_predefinido_control.asiento_predefinidoActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(asiento_predefinido_control.asiento_predefinidoActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(asiento_predefinido_control.asiento_predefinidoActual.id_modulo!=null && asiento_predefinido_control.asiento_predefinidoActual.id_modulo>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != asiento_predefinido_control.asiento_predefinidoActual.id_modulo) {
				jQuery("#t-cel_"+i+"_8").val(asiento_predefinido_control.asiento_predefinidoActual.id_modulo).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_9").val(asiento_predefinido_control.asiento_predefinidoActual.codigo);
		jQuery("#t-cel_"+i+"_10").val(asiento_predefinido_control.asiento_predefinidoActual.nombre);
		...
		if(asiento_predefinido_control.asiento_predefinidoActual.id_fuente!=null && asiento_predefinido_control.asiento_predefinidoActual.id_fuente>-1){
			if(jQuery("#t-cel_"+i+"_11").val() != asiento_predefinido_control.asiento_predefinidoActual.id_fuente) {
				jQuery("#t-cel_"+i+"_11").val(asiento_predefinido_control.asiento_predefinidoActual.id_fuente).trigger("change");
			}
		} else { 
		...
		if(asiento_predefinido_control.asiento_predefinidoActual.id_libro_auxiliar!=null && asiento_predefinido_control.asiento_predefinidoActual.id_libro_auxiliar>-1){
			if(jQuery("#t-cel_"+i+"_12").val() != asiento_predefinido_control.asiento_predefinidoActual.id_libro_auxiliar) {
				jQuery("#t-cel_"+i+"_12").val(asiento_predefinido_control.asiento_predefinidoActual.id_libro_auxiliar).trigger("change");
			}
		} else { 
		...
		if(asiento_predefinido_control.asiento_predefinidoActual.id_centro_costo!=null && asiento_predefinido_control.asiento_predefinidoActual.id_centro_costo>-1){
			if(jQuery("#t-cel_"+i+"_13").val() != asiento_predefinido_control.asiento_predefinidoActual.id_centro_costo) {
				jQuery("#t-cel_"+i+"_13").val(asiento_predefinido_control.asiento_predefinidoActual.id_centro_costo).trigger("change");
			}
		} else { 
		...
		if(asiento_predefinido_control.asiento_predefinidoActual.id_documento_contable!=null && asiento_predefinido_control.asiento_predefinidoActual.id_documento_contable>-1){
			if(jQuery("#t-cel_"+i+"_14").val() != asiento_predefinido_control.asiento_predefinidoActual.id_documento_contable) {
				jQuery("#t-cel_"+i+"_14").val(asiento_predefinido_control.asiento_predefinidoActual.id_documento_contable).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_15").val(asiento_predefinido_control.asiento_predefinidoActual.descripcion);
		jQuery("#t-cel_"+i+"_16").val(asiento_predefinido_control.asiento_predefinidoActual.nro_nit);
		jQuery("#t-cel_"+i+"_17").val(asiento_predefinido_control.asiento_predefinidoActual.referencia);
	}
