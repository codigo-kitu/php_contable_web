...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(centro_costo_control) {
		...
		jQuery("#form"+centro_costo_constante1.STR_SUFIJO+"-created_at").val(centro_costo_control.centro_costoActual.versionRow);
		jQuery("#form"+centro_costo_constante1.STR_SUFIJO+"-updated_at").val(centro_costo_control.centro_costoActual.versionRow);
	...
	actualizarSpanMensajesCampos(centro_costo_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(centro_costo_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(centro_costo_control.strMensajeupdated_at);		
