...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(fuente_control) {
		...
		jQuery("#form"+fuente_constante1.STR_SUFIJO+"-created_at").val(fuente_control.fuenteActual.versionRow);
		jQuery("#form"+fuente_constante1.STR_SUFIJO+"-updated_at").val(fuente_control.fuenteActual.versionRow);
	...
	actualizarSpanMensajesCampos(fuente_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(fuente_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(fuente_control.strMensajeupdated_at);		
