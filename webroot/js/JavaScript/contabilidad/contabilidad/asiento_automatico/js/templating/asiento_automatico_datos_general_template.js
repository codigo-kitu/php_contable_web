...
<script id="asiento_automatico_datos_general_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist asiento_automaticosLocal)}}
			{{#each asiento_automaticosLocal}}
