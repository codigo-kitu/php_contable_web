...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cierre_contable_control) {
		...
		if(cierre_contable_control.cierre_contableActual.id_empresa!=null && cierre_contable_control.cierre_contableActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != cierre_contable_control.cierre_contableActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(cierre_contable_control.cierre_contableActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(cierre_contable_control.cierre_contableActual.id_ejercicio!=null && cierre_contable_control.cierre_contableActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != cierre_contable_control.cierre_contableActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_4").val(cierre_contable_control.cierre_contableActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(cierre_contable_control.cierre_contableActual.id_periodo!=null && cierre_contable_control.cierre_contableActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != cierre_contable_control.cierre_contableActual.id_periodo) {
				jQuery("#t-cel_"+i+"_5").val(cierre_contable_control.cierre_contableActual.id_periodo).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_6").val(cierre_contable_control.cierre_contableActual.fecha_cierre);
		jQuery("#t-cel_"+i+"_7").val(cierre_contable_control.cierre_contableActual.gan_per);
		jQuery("#t-cel_"+i+"_8").val(cierre_contable_control.cierre_contableActual.total_cuentas);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(cierre_contable_control) {
		...
		if(cierre_contable_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cierre_contable_control.idFilaTablaActual+"_3",cierre_contable_control.empresasFK);
		}
	};
	...
	cargarCombosejerciciosFK(cierre_contable_control) {
		...
		if(cierre_contable_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cierre_contable_control.idFilaTablaActual+"_4",cierre_contable_control.ejerciciosFK);
		}
	...
	cargarCombosperiodosFK(cierre_contable_control) {
		...
		if(cierre_contable_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cierre_contable_control.idFilaTablaActual+"_5",cierre_contable_control.periodosFK);
		}
