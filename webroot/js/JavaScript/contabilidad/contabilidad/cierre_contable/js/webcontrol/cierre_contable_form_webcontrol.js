...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(cierre_contable_control) {
		...
		jQuery("#form"+cierre_contable_constante1.STR_SUFIJO+"-created_at").val(cierre_contable_control.cierre_contableActual.versionRow);
		jQuery("#form"+cierre_contable_constante1.STR_SUFIJO+"-updated_at").val(cierre_contable_control.cierre_contableActual.versionRow);
	...
	actualizarSpanMensajesCampos(cierre_contable_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(cierre_contable_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(cierre_contable_control.strMensajeupdated_at);		
