...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(asiento_predefinido_detalle_control) {
		...
		if(asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_asiento_predefinido!=null && asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_asiento_predefinido>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_asiento_predefinido) {
				jQuery("#t-cel_"+i+"_3").val(asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_asiento_predefinido).trigger("change");
			}
		} else { 
		...
		if(asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_cuenta!=null && asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_cuenta) {
				jQuery("#t-cel_"+i+"_4").val(asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_cuenta).trigger("change");
			}
		} else { 
		...
		if(asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_centro_costo!=null && asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_centro_costo>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_centro_costo) {
				jQuery("#t-cel_"+i+"_5").val(asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.id_centro_costo).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_6").val(asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.orden);
		jQuery("#t-cel_"+i+"_7").val(asiento_predefinido_detalle_control.asiento_predefinido_detalleActual.cuenta_contable);
	}
