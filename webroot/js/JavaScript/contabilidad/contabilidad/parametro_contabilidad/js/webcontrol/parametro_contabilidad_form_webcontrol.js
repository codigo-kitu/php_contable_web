...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(parametro_contabilidad_control) {
		...
		jQuery("#form"+parametro_contabilidad_constante1.STR_SUFIJO+"-created_at").val(parametro_contabilidad_control.parametro_contabilidadActual.versionRow);
		jQuery("#form"+parametro_contabilidad_constante1.STR_SUFIJO+"-updated_at").val(parametro_contabilidad_control.parametro_contabilidadActual.versionRow);
	...
	actualizarSpanMensajesCampos(parametro_contabilidad_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(parametro_contabilidad_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(parametro_contabilidad_control.strMensajeupdated_at);		
