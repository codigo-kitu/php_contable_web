...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(saldo_cuenta_control) {
		...
		if(saldo_cuenta_control.saldo_cuentaActual.id_empresa!=null && saldo_cuenta_control.saldo_cuentaActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != saldo_cuenta_control.saldo_cuentaActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(saldo_cuenta_control.saldo_cuentaActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(saldo_cuenta_control.saldo_cuentaActual.id_ejercicio!=null && saldo_cuenta_control.saldo_cuentaActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != saldo_cuenta_control.saldo_cuentaActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_4").val(saldo_cuenta_control.saldo_cuentaActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(saldo_cuenta_control.saldo_cuentaActual.id_periodo!=null && saldo_cuenta_control.saldo_cuentaActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != saldo_cuenta_control.saldo_cuentaActual.id_periodo) {
				jQuery("#t-cel_"+i+"_5").val(saldo_cuenta_control.saldo_cuentaActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(saldo_cuenta_control.saldo_cuentaActual.id_tipo_cuenta!=null && saldo_cuenta_control.saldo_cuentaActual.id_tipo_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != saldo_cuenta_control.saldo_cuentaActual.id_tipo_cuenta) {
				jQuery("#t-cel_"+i+"_6").val(saldo_cuenta_control.saldo_cuentaActual.id_tipo_cuenta).trigger("change");
			}
		} else { 
		...
		if(saldo_cuenta_control.saldo_cuentaActual.id_cuenta!=null && saldo_cuenta_control.saldo_cuentaActual.id_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != saldo_cuenta_control.saldo_cuentaActual.id_cuenta) {
				jQuery("#t-cel_"+i+"_7").val(saldo_cuenta_control.saldo_cuentaActual.id_cuenta).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_8").val(saldo_cuenta_control.saldo_cuentaActual.suma_debe);
		jQuery("#t-cel_"+i+"_9").val(saldo_cuenta_control.saldo_cuentaActual.suma_haber);
		jQuery("#t-cel_"+i+"_10").val(saldo_cuenta_control.saldo_cuentaActual.deudor);
		jQuery("#t-cel_"+i+"_11").val(saldo_cuenta_control.saldo_cuentaActual.acreedor);
		jQuery("#t-cel_"+i+"_12").val(saldo_cuenta_control.saldo_cuentaActual.saldo);
		jQuery("#t-cel_"+i+"_13").val(saldo_cuenta_control.saldo_cuentaActual.fecha_proceso);
		jQuery("#t-cel_"+i+"_14").val(saldo_cuenta_control.saldo_cuentaActual.fecha_fin_mes);
		jQuery("#t-cel_"+i+"_15").val(saldo_cuenta_control.saldo_cuentaActual.tipo_cuenta_codigo);
		jQuery("#t-cel_"+i+"_16").val(saldo_cuenta_control.saldo_cuentaActual.cuenta_contable);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(saldo_cuenta_control) {
		...
		if(saldo_cuenta_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+saldo_cuenta_control.idFilaTablaActual+"_3",saldo_cuenta_control.empresasFK);
		}
	};
	...
	cargarCombosejerciciosFK(saldo_cuenta_control) {
		...
		if(saldo_cuenta_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+saldo_cuenta_control.idFilaTablaActual+"_4",saldo_cuenta_control.ejerciciosFK);
		}
	...
	cargarCombosperiodosFK(saldo_cuenta_control) {
		...
		if(saldo_cuenta_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+saldo_cuenta_control.idFilaTablaActual+"_5",saldo_cuenta_control.periodosFK);
		}
	...
	cargarCombostipo_cuentasFK(saldo_cuenta_control) {
		...
		if(saldo_cuenta_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+saldo_cuenta_control.idFilaTablaActual+"_6",saldo_cuenta_control.tipo_cuentasFK);
		}
	...
	cargarComboscuentasFK(saldo_cuenta_control) {
		...
		if(saldo_cuenta_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+saldo_cuenta_control.idFilaTablaActual+"_7",saldo_cuenta_control.cuentasFK);
		}
