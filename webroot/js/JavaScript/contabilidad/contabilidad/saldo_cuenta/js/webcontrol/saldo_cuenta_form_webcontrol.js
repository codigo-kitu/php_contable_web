...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(saldo_cuenta_control) {
		...
		jQuery("#form"+saldo_cuenta_constante1.STR_SUFIJO+"-created_at").val(saldo_cuenta_control.saldo_cuentaActual.versionRow);
		jQuery("#form"+saldo_cuenta_constante1.STR_SUFIJO+"-updated_at").val(saldo_cuenta_control.saldo_cuentaActual.versionRow);
	...
	actualizarSpanMensajesCampos(saldo_cuenta_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(saldo_cuenta_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(saldo_cuenta_control.strMensajeupdated_at);		
