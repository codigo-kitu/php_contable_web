...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(ejercicio_control) {
		...
		jQuery("#t-version_row_"+i+"").val(ejercicio_control.ejercicioActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(ejercicio_control.ejercicioActual.fecha_inicio);
		jQuery("#t-cel_"+i+"_4").val(ejercicio_control.ejercicioActual.fecha_fin);
		jQuery("#t-cel_"+i+"_5").val(ejercicio_control.ejercicioActual.descripcion);
		jQuery("#t-cel_"+i+"_6").prop('checked',ejercicio_control.ejercicioActual.activo);
	}
