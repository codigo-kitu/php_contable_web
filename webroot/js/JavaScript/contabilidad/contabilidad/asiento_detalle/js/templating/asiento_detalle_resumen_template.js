...
<script id="asiento_detalle_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarasiento_detallesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each asiento_detallesReporte}}

			<table id="tableasiento_detalle{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Base' ../arrOrderBy ../bitParaReporteOrderBy) }}
