...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(asiento_detalle_control) {
		...
		if(asiento_detalle_control.asiento_detalleActual.id_empresa!=null && asiento_detalle_control.asiento_detalleActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != asiento_detalle_control.asiento_detalleActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(asiento_detalle_control.asiento_detalleActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(asiento_detalle_control.asiento_detalleActual.id_sucursal!=null && asiento_detalle_control.asiento_detalleActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != asiento_detalle_control.asiento_detalleActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(asiento_detalle_control.asiento_detalleActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(asiento_detalle_control.asiento_detalleActual.id_ejercicio!=null && asiento_detalle_control.asiento_detalleActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != asiento_detalle_control.asiento_detalleActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(asiento_detalle_control.asiento_detalleActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(asiento_detalle_control.asiento_detalleActual.id_periodo!=null && asiento_detalle_control.asiento_detalleActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != asiento_detalle_control.asiento_detalleActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(asiento_detalle_control.asiento_detalleActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(asiento_detalle_control.asiento_detalleActual.id_usuario!=null && asiento_detalle_control.asiento_detalleActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != asiento_detalle_control.asiento_detalleActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(asiento_detalle_control.asiento_detalleActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(asiento_detalle_control.asiento_detalleActual.id_asiento!=null && asiento_detalle_control.asiento_detalleActual.id_asiento>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != asiento_detalle_control.asiento_detalleActual.id_asiento) {
				jQuery("#t-cel_"+i+"_8").val(asiento_detalle_control.asiento_detalleActual.id_asiento).trigger("change");
			}
		} else { 
		...
		if(asiento_detalle_control.asiento_detalleActual.id_cuenta!=null && asiento_detalle_control.asiento_detalleActual.id_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != asiento_detalle_control.asiento_detalleActual.id_cuenta) {
				jQuery("#t-cel_"+i+"_9").val(asiento_detalle_control.asiento_detalleActual.id_cuenta).trigger("change");
			}
		} else { 
		...
		if(asiento_detalle_control.asiento_detalleActual.id_centro_costo!=null && asiento_detalle_control.asiento_detalleActual.id_centro_costo>-1){
			if(jQuery("#t-cel_"+i+"_10").val() != asiento_detalle_control.asiento_detalleActual.id_centro_costo) {
				jQuery("#t-cel_"+i+"_10").val(asiento_detalle_control.asiento_detalleActual.id_centro_costo).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_11").val(asiento_detalle_control.asiento_detalleActual.orden);
		jQuery("#t-cel_"+i+"_12").val(asiento_detalle_control.asiento_detalleActual.debito);
		jQuery("#t-cel_"+i+"_13").val(asiento_detalle_control.asiento_detalleActual.credito);
		jQuery("#t-cel_"+i+"_14").val(asiento_detalle_control.asiento_detalleActual.valor_base);
		jQuery("#t-cel_"+i+"_15").val(asiento_detalle_control.asiento_detalleActual.cuenta_contable);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(asiento_detalle_control) {
		...
		if(asiento_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_detalle_control.idFilaTablaActual+"_3",asiento_detalle_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(asiento_detalle_control) {
		...
		if(asiento_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_detalle_control.idFilaTablaActual+"_4",asiento_detalle_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(asiento_detalle_control) {
		...
		if(asiento_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_detalle_control.idFilaTablaActual+"_5",asiento_detalle_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(asiento_detalle_control) {
		...
		if(asiento_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_detalle_control.idFilaTablaActual+"_6",asiento_detalle_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(asiento_detalle_control) {
		...
		if(asiento_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_detalle_control.idFilaTablaActual+"_7",asiento_detalle_control.usuariosFK);
		}
	};
	...
	cargarCombosasientosFK(asiento_detalle_control) {
		...
		if(asiento_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_detalle_control.idFilaTablaActual+"_8",asiento_detalle_control.asientosFK);
		}
	...
	cargarComboscuentasFK(asiento_detalle_control) {
		...
		if(asiento_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_detalle_control.idFilaTablaActual+"_9",asiento_detalle_control.cuentasFK);
		}
	...
	cargarComboscentro_costosFK(asiento_detalle_control) {
		...
		if(asiento_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+asiento_detalle_control.idFilaTablaActual+"_10",asiento_detalle_control.centro_costosFK);
		}
