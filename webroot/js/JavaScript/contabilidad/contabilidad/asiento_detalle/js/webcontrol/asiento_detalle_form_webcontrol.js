...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(asiento_detalle_control) {
		...
		jQuery("#form"+asiento_detalle_constante1.STR_SUFIJO+"-created_at").val(asiento_detalle_control.asiento_detalleActual.versionRow);
		jQuery("#form"+asiento_detalle_constante1.STR_SUFIJO+"-updated_at").val(asiento_detalle_control.asiento_detalleActual.versionRow);
	...
	actualizarSpanMensajesCampos(asiento_detalle_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(asiento_detalle_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(asiento_detalle_control.strMensajeupdated_at);		
