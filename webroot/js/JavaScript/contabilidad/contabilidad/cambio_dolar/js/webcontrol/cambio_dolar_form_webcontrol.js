...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(cambio_dolar_control) {
		...
		jQuery("#form"+cambio_dolar_constante1.STR_SUFIJO+"-created_at").val(cambio_dolar_control.cambio_dolarActual.versionRow);
		jQuery("#form"+cambio_dolar_constante1.STR_SUFIJO+"-updated_at").val(cambio_dolar_control.cambio_dolarActual.versionRow);
	...
	actualizarSpanMensajesCampos(cambio_dolar_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(cambio_dolar_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(cambio_dolar_control.strMensajeupdated_at);		
