...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(imagen_asiento_control) {
		...
		jQuery("#form"+imagen_asiento_constante1.STR_SUFIJO+"-created_at").val(imagen_asiento_control.imagen_asientoActual.versionRow);
		jQuery("#form"+imagen_asiento_constante1.STR_SUFIJO+"-updated_at").val(imagen_asiento_control.imagen_asientoActual.versionRow);
	...
	actualizarSpanMensajesCampos(imagen_asiento_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(imagen_asiento_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(imagen_asiento_control.strMensajeupdated_at);		
