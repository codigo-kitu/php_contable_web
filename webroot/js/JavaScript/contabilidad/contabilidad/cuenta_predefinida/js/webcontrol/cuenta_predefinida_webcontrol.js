...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cuenta_predefinida_control) {
		...
		if(cuenta_predefinida_control.cuenta_predefinidaActual.id_empresa!=null && cuenta_predefinida_control.cuenta_predefinidaActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != cuenta_predefinida_control.cuenta_predefinidaActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(cuenta_predefinida_control.cuenta_predefinidaActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_cuenta_predefinida!=null && cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_cuenta_predefinida>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_cuenta_predefinida) {
				jQuery("#t-cel_"+i+"_4").val(cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_cuenta_predefinida).trigger("change");
			}
		} else { 
		...
		if(cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_cuenta!=null && cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_cuenta) {
				jQuery("#t-cel_"+i+"_5").val(cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_cuenta).trigger("change");
			}
		} else { 
		...
		if(cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_nivel_cuenta!=null && cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_nivel_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_nivel_cuenta) {
				jQuery("#t-cel_"+i+"_6").val(cuenta_predefinida_control.cuenta_predefinidaActual.id_tipo_nivel_cuenta).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(cuenta_predefinida_control.cuenta_predefinidaActual.codigo_tabla);
		jQuery("#t-cel_"+i+"_8").val(cuenta_predefinida_control.cuenta_predefinidaActual.codigo_cuenta);
		jQuery("#t-cel_"+i+"_9").val(cuenta_predefinida_control.cuenta_predefinidaActual.nombre_cuenta);
		jQuery("#t-cel_"+i+"_10").val(cuenta_predefinida_control.cuenta_predefinidaActual.monto_minimo);
		jQuery("#t-cel_"+i+"_11").val(cuenta_predefinida_control.cuenta_predefinidaActual.valor_retencion);
		jQuery("#t-cel_"+i+"_12").val(cuenta_predefinida_control.cuenta_predefinidaActual.balance);
		jQuery("#t-cel_"+i+"_13").val(cuenta_predefinida_control.cuenta_predefinidaActual.porcentaje_base);
		jQuery("#t-cel_"+i+"_14").val(cuenta_predefinida_control.cuenta_predefinidaActual.seleccionar);
		jQuery("#t-cel_"+i+"_15").prop('checked',cuenta_predefinida_control.cuenta_predefinidaActual.centro_costos);
		jQuery("#t-cel_"+i+"_16").prop('checked',cuenta_predefinida_control.cuenta_predefinidaActual.retencion);
		jQuery("#t-cel_"+i+"_17").prop('checked',cuenta_predefinida_control.cuenta_predefinidaActual.usa_base);
		jQuery("#t-cel_"+i+"_18").prop('checked',cuenta_predefinida_control.cuenta_predefinidaActual.nit);
		jQuery("#t-cel_"+i+"_19").prop('checked',cuenta_predefinida_control.cuenta_predefinidaActual.modifica);
		jQuery("#t-cel_"+i+"_20").val(cuenta_predefinida_control.cuenta_predefinidaActual.ultima_transaccion);
		jQuery("#t-cel_"+i+"_21").val(cuenta_predefinida_control.cuenta_predefinidaActual.comenta1);
		jQuery("#t-cel_"+i+"_22").val(cuenta_predefinida_control.cuenta_predefinidaActual.comenta2);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(cuenta_predefinida_control) {
		...
		if(cuenta_predefinida_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_predefinida_control.idFilaTablaActual+"_3",cuenta_predefinida_control.empresasFK);
		}
	};
	...
	cargarCombostipo_cuenta_predefinidasFK(cuenta_predefinida_control) {
		...
		if(cuenta_predefinida_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_predefinida_control.idFilaTablaActual+"_4",cuenta_predefinida_control.tipo_cuenta_predefinidasFK);
		}
	...
	cargarCombostipo_cuentasFK(cuenta_predefinida_control) {
		...
		if(cuenta_predefinida_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_predefinida_control.idFilaTablaActual+"_5",cuenta_predefinida_control.tipo_cuentasFK);
		}
	...
	cargarCombostipo_nivel_cuentasFK(cuenta_predefinida_control) {
		...
		if(cuenta_predefinida_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_predefinida_control.idFilaTablaActual+"_6",cuenta_predefinida_control.tipo_nivel_cuentasFK);
		}
