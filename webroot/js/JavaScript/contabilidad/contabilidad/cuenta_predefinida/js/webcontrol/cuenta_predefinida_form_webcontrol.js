...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(cuenta_predefinida_control) {
		...
		jQuery("#form"+cuenta_predefinida_constante1.STR_SUFIJO+"-created_at").val(cuenta_predefinida_control.cuenta_predefinidaActual.versionRow);
		jQuery("#form"+cuenta_predefinida_constante1.STR_SUFIJO+"-updated_at").val(cuenta_predefinida_control.cuenta_predefinidaActual.versionRow);
	...
	actualizarSpanMensajesCampos(cuenta_predefinida_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(cuenta_predefinida_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(cuenta_predefinida_control.strMensajeupdated_at);		
