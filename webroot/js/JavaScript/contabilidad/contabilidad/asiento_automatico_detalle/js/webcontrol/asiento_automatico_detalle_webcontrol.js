...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(asiento_automatico_detalle_control) {
		...
		if(asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_empresa!=null && asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_asiento_automatico!=null && asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_asiento_automatico>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_asiento_automatico) {
				jQuery("#t-cel_"+i+"_4").val(asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_asiento_automatico).trigger("change");
			}
		} else { 
		...
		if(asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_cuenta!=null && asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_cuenta) {
				jQuery("#t-cel_"+i+"_5").val(asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_cuenta).trigger("change");
			}
		} else { 
		...
		if(asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_centro_costo!=null && asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_centro_costo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_centro_costo) {
				jQuery("#t-cel_"+i+"_6").val(asiento_automatico_detalle_control.asiento_automatico_detalleActual.id_centro_costo).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").prop('checked',asiento_automatico_detalle_control.asiento_automatico_detalleActual.es_credito);
		jQuery("#t-cel_"+i+"_8").val(asiento_automatico_detalle_control.asiento_automatico_detalleActual.cuenta_contable);
	}
