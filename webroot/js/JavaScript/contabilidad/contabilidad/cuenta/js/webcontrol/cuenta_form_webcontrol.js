...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(cuenta_control) {
		...
		jQuery("#form"+cuenta_constante1.STR_SUFIJO+"-created_at").val(cuenta_control.cuentaActual.versionRow);
		jQuery("#form"+cuenta_constante1.STR_SUFIJO+"-updated_at").val(cuenta_control.cuentaActual.versionRow);
	...
	actualizarSpanMensajesCampos(cuenta_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(cuenta_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(cuenta_control.strMensajeupdated_at);		
