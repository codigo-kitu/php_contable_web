...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cierre_contable_detalle_control) {
		...
		jQuery("#t-version_row_"+i+"").val(cierre_contable_detalle_control.cierre_contable_detalleActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(cierre_contable_detalle_control.cierre_contable_detalleActual.id_detalle);
		...
		if(cierre_contable_detalle_control.cierre_contable_detalleActual.id_cierre_contable!=null && cierre_contable_detalle_control.cierre_contable_detalleActual.id_cierre_contable>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != cierre_contable_detalle_control.cierre_contable_detalleActual.id_cierre_contable) {
				jQuery("#t-cel_"+i+"_4").val(cierre_contable_detalle_control.cierre_contable_detalleActual.id_cierre_contable).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(cierre_contable_detalle_control.cierre_contable_detalleActual.nro_documento);
		jQuery("#t-cel_"+i+"_6").val(cierre_contable_detalle_control.cierre_contable_detalleActual.tipo_factura);
		jQuery("#t-cel_"+i+"_7").val(cierre_contable_detalle_control.cierre_contable_detalleActual.monto);
	}
