...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(documento_contable_control) {
		...
		if(documento_contable_control.documento_contableActual.id_empresa!=null && documento_contable_control.documento_contableActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != documento_contable_control.documento_contableActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(documento_contable_control.documento_contableActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(documento_contable_control.documento_contableActual.codigo);
		jQuery("#t-cel_"+i+"_5").val(documento_contable_control.documento_contableActual.nombre);
		jQuery("#t-cel_"+i+"_6").val(documento_contable_control.documento_contableActual.secuencial);
		jQuery("#t-cel_"+i+"_7").val(documento_contable_control.documento_contableActual.incremento);
		jQuery("#t-cel_"+i+"_8").prop('checked',documento_contable_control.documento_contableActual.reinicia_secuencial_mes);
		jQuery("#t-cel_"+i+"_9").val(documento_contable_control.documento_contableActual.generado_por);
	}
