...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(tipo_cuenta_predefinida_control) {
		...
		jQuery("#t-version_row_"+i+"").val(tipo_cuenta_predefinida_control.tipo_cuenta_predefinidaActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(tipo_cuenta_predefinida_control.tipo_cuenta_predefinidaActual.codigo);
		jQuery("#t-cel_"+i+"_4").val(tipo_cuenta_predefinida_control.tipo_cuenta_predefinidaActual.nombre);
		jQuery("#t-cel_"+i+"_5").val(tipo_cuenta_predefinida_control.tipo_cuenta_predefinidaActual.descripcion);
	}
