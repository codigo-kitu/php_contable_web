...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(tipo_cuenta_predefinida_control) {
		...
		jQuery("#form"+tipo_cuenta_predefinida_constante1.STR_SUFIJO+"-created_at").val(tipo_cuenta_predefinida_control.tipo_cuenta_predefinidaActual.versionRow);
		jQuery("#form"+tipo_cuenta_predefinida_constante1.STR_SUFIJO+"-updated_at").val(tipo_cuenta_predefinida_control.tipo_cuenta_predefinidaActual.versionRow);
	...
	actualizarSpanMensajesCampos(tipo_cuenta_predefinida_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(tipo_cuenta_predefinida_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(tipo_cuenta_predefinida_control.strMensajeupdated_at);		
