...
<script id="tipo_cuenta_predefinida_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliartipo_cuenta_predefinidasAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each tipo_cuenta_predefinidasReporte}}

			<table id="tabletipo_cuenta_predefinida{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
		...
		{{#if (Is_List_Exist cuenta_predefinidas)}}
			{{#each cuenta_predefinidas}}
