...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(moneda_control) {
		...
		jQuery("#form"+moneda_constante1.STR_SUFIJO+"-created_at").val(moneda_control.monedaActual.versionRow);
		jQuery("#form"+moneda_constante1.STR_SUFIJO+"-updated_at").val(moneda_control.monedaActual.versionRow);
	...
	actualizarSpanMensajesCampos(moneda_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(moneda_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(moneda_control.strMensajeupdated_at);		
