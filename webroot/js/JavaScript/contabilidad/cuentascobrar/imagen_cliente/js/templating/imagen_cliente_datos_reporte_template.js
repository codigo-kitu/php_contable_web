...
<script id="imagen_cliente_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (ValCol 'Imagen Cliente' paraReporte)}}
		...
		{{#if (Is_List_Exist imagen_clientesLocal)}}
			{{#each imagen_clientesLocal}}
