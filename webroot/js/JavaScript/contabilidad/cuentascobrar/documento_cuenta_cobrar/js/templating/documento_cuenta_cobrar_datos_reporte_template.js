...
<script id="documento_cuenta_cobrar_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (ValCol 'Id Destino' paraReporte)}}
		...
		{{#if (ValCol 'Nro Documento Cliente' paraReporte)}}
		...
		{{#if (ValCol 'Forma Pago Cliente' paraReporte)}}
