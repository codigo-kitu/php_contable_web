...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(documento_cliente_control) {
		...
		if(documento_cliente_control.documento_clienteActual.id_documento_proveedor!=null && documento_cliente_control.documento_clienteActual.id_documento_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != documento_cliente_control.documento_clienteActual.id_documento_proveedor) {
				jQuery("#t-cel_"+i+"_3").val(documento_cliente_control.documento_clienteActual.id_documento_proveedor).trigger("change");
			}
		} else { 
		...
		if(documento_cliente_control.documento_clienteActual.id_cliente!=null && documento_cliente_control.documento_clienteActual.id_cliente>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != documento_cliente_control.documento_clienteActual.id_cliente) {
				jQuery("#t-cel_"+i+"_4").val(documento_cliente_control.documento_clienteActual.id_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(documento_cliente_control.documento_clienteActual.documento);
	}
