...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(debito_cuenta_cobrar_control) {
		...
		if(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_empresa!=null && debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_sucursal!=null && debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_ejercicio!=null && debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_periodo!=null && debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_usuario!=null && debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_cuenta_cobrar!=null && debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_cuenta_cobrar>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_cuenta_cobrar) {
				jQuery("#t-cel_"+i+"_8").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_cuenta_cobrar).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_9").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.numero);
		jQuery("#t-cel_"+i+"_10").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.fecha_emision);
		jQuery("#t-cel_"+i+"_11").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.fecha_vence);
		...
		if(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_termino_pago_cliente!=null && debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_termino_pago_cliente>-1){
			if(jQuery("#t-cel_"+i+"_12").val() != debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_termino_pago_cliente) {
				jQuery("#t-cel_"+i+"_12").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_termino_pago_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_13").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.monto);
		jQuery("#t-cel_"+i+"_14").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.saldo);
		jQuery("#t-cel_"+i+"_15").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.descripcion);
		jQuery("#t-cel_"+i+"_16").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.sub_total);
		jQuery("#t-cel_"+i+"_17").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.iva);
		jQuery("#t-cel_"+i+"_18").prop('checked',debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.es_balance_inicial);
		...
		if(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_estado!=null && debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_19").val() != debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_estado) {
				jQuery("#t-cel_"+i+"_19").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_20").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.referencia);
		jQuery("#t-cel_"+i+"_21").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.debito);
		jQuery("#t-cel_"+i+"_22").val(debito_cuenta_cobrar_control.debito_cuenta_cobrarActual.credito);
	}
