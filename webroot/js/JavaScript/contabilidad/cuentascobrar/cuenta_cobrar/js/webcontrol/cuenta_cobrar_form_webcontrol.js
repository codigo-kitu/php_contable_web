...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(cuenta_cobrar_control) {
		...
		jQuery("#form"+cuenta_cobrar_constante1.STR_SUFIJO+"-created_at").val(cuenta_cobrar_control.cuenta_cobrarActual.versionRow);
		jQuery("#form"+cuenta_cobrar_constante1.STR_SUFIJO+"-updated_at").val(cuenta_cobrar_control.cuenta_cobrarActual.versionRow);
	...
	actualizarSpanMensajesCampos(cuenta_cobrar_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(cuenta_cobrar_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(cuenta_cobrar_control.strMensajeupdated_at);		
