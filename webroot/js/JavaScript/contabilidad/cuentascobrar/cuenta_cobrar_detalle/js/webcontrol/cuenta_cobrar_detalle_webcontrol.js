...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cuenta_cobrar_detalle_control) {
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_empresa!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_sucursal!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_ejercicio!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_periodo!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_usuario!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_cuenta_cobrar!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_cuenta_cobrar>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_cuenta_cobrar) {
				jQuery("#t-cel_"+i+"_8").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_cuenta_cobrar).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_9").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.numero);
		jQuery("#t-cel_"+i+"_10").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.fecha_emision);
		jQuery("#t-cel_"+i+"_11").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.fecha_vence);
		jQuery("#t-cel_"+i+"_12").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.referencia);
		jQuery("#t-cel_"+i+"_13").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.monto);
		jQuery("#t-cel_"+i+"_14").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.debito);
		jQuery("#t-cel_"+i+"_15").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.credito);
		jQuery("#t-cel_"+i+"_16").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.descripcion);
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_estado!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_17").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_estado) {
				jQuery("#t-cel_"+i+"_17").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_estado).trigger("change");
			}
		} else { 
