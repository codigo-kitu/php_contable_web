...
<script id="credito_cuenta_cobrar_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarcredito_cuenta_cobrarsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each credito_cuenta_cobrarsReporte}}

			<table id="tablecredito_cuenta_cobrar{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Abono' ../arrOrderBy ../bitParaReporteOrderBy) }}
