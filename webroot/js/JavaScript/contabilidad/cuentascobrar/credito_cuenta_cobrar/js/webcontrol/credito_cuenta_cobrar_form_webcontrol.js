...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(credito_cuenta_cobrar_control) {
		...
		jQuery("#form"+credito_cuenta_cobrar_constante1.STR_SUFIJO+"-created_at").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.versionRow);
		jQuery("#form"+credito_cuenta_cobrar_constante1.STR_SUFIJO+"-updated_at").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.versionRow);
	...
	actualizarSpanMensajesCampos(credito_cuenta_cobrar_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(credito_cuenta_cobrar_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(credito_cuenta_cobrar_control.strMensajeupdated_at);		
