...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(credito_cuenta_cobrar_control) {
		...
		if(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_empresa!=null && credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_sucursal!=null && credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_ejercicio!=null && credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_periodo!=null && credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_usuario!=null && credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_cuenta_cobrar!=null && credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_cuenta_cobrar>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_cuenta_cobrar) {
				jQuery("#t-cel_"+i+"_8").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_cuenta_cobrar).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_9").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.numero);
		...
		if(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_forma_pago_cliente!=null && credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_forma_pago_cliente>-1){
			if(jQuery("#t-cel_"+i+"_10").val() != credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_forma_pago_cliente) {
				jQuery("#t-cel_"+i+"_10").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_forma_pago_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_11").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.fecha_emision);
		jQuery("#t-cel_"+i+"_12").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.fecha_vence);
		jQuery("#t-cel_"+i+"_13").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.abono);
		jQuery("#t-cel_"+i+"_14").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.saldo);
		jQuery("#t-cel_"+i+"_15").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.descripcion);
		...
		if(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_estado!=null && credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_16").val() != credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_estado) {
				jQuery("#t-cel_"+i+"_16").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_17").val(credito_cuenta_cobrar_control.credito_cuenta_cobrarActual.referencia);
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(credito_cuenta_cobrar_control) {
		...
		if(credito_cuenta_cobrar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_cobrar_control.idFilaTablaActual+"_3",credito_cuenta_cobrar_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(credito_cuenta_cobrar_control) {
		...
		if(credito_cuenta_cobrar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_cobrar_control.idFilaTablaActual+"_4",credito_cuenta_cobrar_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(credito_cuenta_cobrar_control) {
		...
		if(credito_cuenta_cobrar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_cobrar_control.idFilaTablaActual+"_5",credito_cuenta_cobrar_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(credito_cuenta_cobrar_control) {
		...
		if(credito_cuenta_cobrar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_cobrar_control.idFilaTablaActual+"_6",credito_cuenta_cobrar_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(credito_cuenta_cobrar_control) {
		...
		if(credito_cuenta_cobrar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_cobrar_control.idFilaTablaActual+"_7",credito_cuenta_cobrar_control.usuariosFK);
		}
	};
	...
	cargarComboscuenta_cobrarsFK(credito_cuenta_cobrar_control) {
		...
		if(credito_cuenta_cobrar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_cobrar_control.idFilaTablaActual+"_8",credito_cuenta_cobrar_control.cuenta_cobrarsFK);
		}
	...
	cargarCombosforma_pago_clientesFK(credito_cuenta_cobrar_control) {
		...
		if(credito_cuenta_cobrar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_cobrar_control.idFilaTablaActual+"_10",credito_cuenta_cobrar_control.forma_pago_clientesFK);
		}
	...
	cargarCombosestadosFK(credito_cuenta_cobrar_control) {
		...
		if(credito_cuenta_cobrar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+credito_cuenta_cobrar_control.idFilaTablaActual+"_16",credito_cuenta_cobrar_control.estadosFK);
		}
