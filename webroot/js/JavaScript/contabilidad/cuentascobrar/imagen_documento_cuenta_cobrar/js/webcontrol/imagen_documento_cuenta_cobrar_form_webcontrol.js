...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(imagen_documento_cuenta_cobrar_control) {
		...
		jQuery("#form"+imagen_documento_cuenta_cobrar_constante1.STR_SUFIJO+"-created_at").val(imagen_documento_cuenta_cobrar_control.imagen_documento_cuenta_cobrarActual.versionRow);
		jQuery("#form"+imagen_documento_cuenta_cobrar_constante1.STR_SUFIJO+"-updated_at").val(imagen_documento_cuenta_cobrar_control.imagen_documento_cuenta_cobrarActual.versionRow);
	...
	actualizarSpanMensajesCampos(imagen_documento_cuenta_cobrar_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(imagen_documento_cuenta_cobrar_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(imagen_documento_cuenta_cobrar_control.strMensajeupdated_at);		
