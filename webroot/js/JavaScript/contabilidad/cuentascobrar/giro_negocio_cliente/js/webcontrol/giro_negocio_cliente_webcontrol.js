...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(giro_negocio_cliente_control) {
		...
		jQuery("#t-version_row_"+i+"").val(giro_negocio_cliente_control.giro_negocio_clienteActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(giro_negocio_cliente_control.giro_negocio_clienteActual.nombre);
		jQuery("#t-cel_"+i+"_4").prop('checked',giro_negocio_cliente_control.giro_negocio_clienteActual.predeterminado);
	}
