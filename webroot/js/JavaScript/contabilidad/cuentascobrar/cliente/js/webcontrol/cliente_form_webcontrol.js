...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(cliente_control) {
		...
		jQuery("#form"+cliente_constante1.STR_SUFIJO+"-created_at").val(cliente_control.clienteActual.versionRow);
		jQuery("#form"+cliente_constante1.STR_SUFIJO+"-updated_at").val(cliente_control.clienteActual.versionRow);
	...
	actualizarSpanMensajesCampos(cliente_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(cliente_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(cliente_control.strMensajeupdated_at);		
