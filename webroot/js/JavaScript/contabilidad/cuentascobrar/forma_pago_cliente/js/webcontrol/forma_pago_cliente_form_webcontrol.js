...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(forma_pago_cliente_control) {
		...
		jQuery("#form"+forma_pago_cliente_constante1.STR_SUFIJO+"-created_at").val(forma_pago_cliente_control.forma_pago_clienteActual.versionRow);
		jQuery("#form"+forma_pago_cliente_constante1.STR_SUFIJO+"-updated_at").val(forma_pago_cliente_control.forma_pago_clienteActual.versionRow);
	...
	actualizarSpanMensajesCampos(forma_pago_cliente_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(forma_pago_cliente_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(forma_pago_cliente_control.strMensajeupdated_at);		
