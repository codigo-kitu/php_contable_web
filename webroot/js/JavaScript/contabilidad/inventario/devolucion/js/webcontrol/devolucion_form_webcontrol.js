...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(devolucion_control) {
		...
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-created_at").val(devolucion_control.devolucionActual.versionRow);
		jQuery("#form"+devolucion_constante1.STR_SUFIJO+"-updated_at").val(devolucion_control.devolucionActual.versionRow);
	...
	actualizarSpanMensajesCampos(devolucion_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(devolucion_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(devolucion_control.strMensajeupdated_at);		
