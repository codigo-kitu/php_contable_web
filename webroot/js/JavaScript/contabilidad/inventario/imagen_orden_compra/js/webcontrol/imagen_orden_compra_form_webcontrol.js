...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(imagen_orden_compra_control) {
		...
		jQuery("#form"+imagen_orden_compra_constante1.STR_SUFIJO+"-created_at").val(imagen_orden_compra_control.imagen_orden_compraActual.versionRow);
		jQuery("#form"+imagen_orden_compra_constante1.STR_SUFIJO+"-updated_at").val(imagen_orden_compra_control.imagen_orden_compraActual.versionRow);
	...
	actualizarSpanMensajesCampos(imagen_orden_compra_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(imagen_orden_compra_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(imagen_orden_compra_control.strMensajeupdated_at);		
