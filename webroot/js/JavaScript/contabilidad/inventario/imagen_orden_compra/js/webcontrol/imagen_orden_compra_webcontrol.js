...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(imagen_orden_compra_control) {
		...
		jQuery("#t-version_row_"+i+"").val(imagen_orden_compra_control.imagen_orden_compraActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(imagen_orden_compra_control.imagen_orden_compraActual.imagen);
		jQuery("#t-cel_"+i+"_4").val(imagen_orden_compra_control.imagen_orden_compraActual.nro_compra);
	}
