...
<script id="orden_compra_detalle_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (ValCol 'Recibido' paraReporte)}}
		...
		{{#if (Is_List_Exist orden_compra_detallesLocal)}}
			{{#each orden_compra_detallesLocal}}
