...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(orden_compra_detalle_control) {
		...
		jQuery("#form"+orden_compra_detalle_constante1.STR_SUFIJO+"-created_at").val(orden_compra_detalle_control.orden_compra_detalleActual.versionRow);
		jQuery("#form"+orden_compra_detalle_constante1.STR_SUFIJO+"-updated_at").val(orden_compra_detalle_control.orden_compra_detalleActual.versionRow);
	...
	actualizarSpanMensajesCampos(orden_compra_detalle_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(orden_compra_detalle_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(orden_compra_detalle_control.strMensajeupdated_at);		
