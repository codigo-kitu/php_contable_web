...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(orden_compra_detalle_control) {
		...
		if(orden_compra_detalle_control.orden_compra_detalleActual.id_orden_compra!=null && orden_compra_detalle_control.orden_compra_detalleActual.id_orden_compra>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != orden_compra_detalle_control.orden_compra_detalleActual.id_orden_compra) {
				jQuery("#t-cel_"+i+"_3").val(orden_compra_detalle_control.orden_compra_detalleActual.id_orden_compra).trigger("change");
			}
		} else { 
		...
		if(orden_compra_detalle_control.orden_compra_detalleActual.id_bodega!=null && orden_compra_detalle_control.orden_compra_detalleActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != orden_compra_detalle_control.orden_compra_detalleActual.id_bodega) {
				jQuery("#t-cel_"+i+"_4").val(orden_compra_detalle_control.orden_compra_detalleActual.id_bodega).trigger("change");
			}
		} else { 
		...
		if(orden_compra_detalle_control.orden_compra_detalleActual.id_producto!=null && orden_compra_detalle_control.orden_compra_detalleActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != orden_compra_detalle_control.orden_compra_detalleActual.id_producto) {
				jQuery("#t-cel_"+i+"_5").val(orden_compra_detalle_control.orden_compra_detalleActual.id_producto).trigger("change");
			}
		} else { 
		...
		if(orden_compra_detalle_control.orden_compra_detalleActual.id_unidad!=null && orden_compra_detalle_control.orden_compra_detalleActual.id_unidad>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != orden_compra_detalle_control.orden_compra_detalleActual.id_unidad) {
				jQuery("#t-cel_"+i+"_6").val(orden_compra_detalle_control.orden_compra_detalleActual.id_unidad).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(orden_compra_detalle_control.orden_compra_detalleActual.cantidad);
		jQuery("#t-cel_"+i+"_8").val(orden_compra_detalle_control.orden_compra_detalleActual.precio);
		jQuery("#t-cel_"+i+"_9").val(orden_compra_detalle_control.orden_compra_detalleActual.sub_total);
		jQuery("#t-cel_"+i+"_10").val(orden_compra_detalle_control.orden_compra_detalleActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_11").val(orden_compra_detalle_control.orden_compra_detalleActual.descuento_monto);
		jQuery("#t-cel_"+i+"_12").val(orden_compra_detalle_control.orden_compra_detalleActual.iva_porciento);
		jQuery("#t-cel_"+i+"_13").val(orden_compra_detalle_control.orden_compra_detalleActual.iva_monto);
		jQuery("#t-cel_"+i+"_14").val(orden_compra_detalle_control.orden_compra_detalleActual.total);
		jQuery("#t-cel_"+i+"_15").val(orden_compra_detalle_control.orden_compra_detalleActual.observacion);
		jQuery("#t-cel_"+i+"_16").val(orden_compra_detalle_control.orden_compra_detalleActual.recibido);
		jQuery("#t-cel_"+i+"_17").val(orden_compra_detalle_control.orden_compra_detalleActual.impuesto2_porciento);
		jQuery("#t-cel_"+i+"_18").val(orden_compra_detalle_control.orden_compra_detalleActual.impuesto2_monto);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosorden_comprasFK(orden_compra_detalle_control) {
		...
		if(orden_compra_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+orden_compra_detalle_control.idFilaTablaActual+"_3",orden_compra_detalle_control.orden_comprasFK);
		}
	...
	cargarCombosbodegasFK(orden_compra_detalle_control) {
		...
		if(orden_compra_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+orden_compra_detalle_control.idFilaTablaActual+"_4",orden_compra_detalle_control.bodegasFK);
		}
	...
	cargarCombosproductosFK(orden_compra_detalle_control) {
		...
		if(orden_compra_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+orden_compra_detalle_control.idFilaTablaActual+"_5",orden_compra_detalle_control.productosFK);
		}
	...
	cargarCombosunidadsFK(orden_compra_detalle_control) {
		...
		if(orden_compra_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+orden_compra_detalle_control.idFilaTablaActual+"_6",orden_compra_detalle_control.unidadsFK);
		}
