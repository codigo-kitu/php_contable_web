...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(inventario_fisico_detalle_control) {
		...
		if(inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_inventario_fisico!=null && inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_inventario_fisico>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_inventario_fisico) {
				jQuery("#t-cel_"+i+"_3").val(inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_inventario_fisico).trigger("change");
			}
		} else { 
		...
		if(inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_producto!=null && inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_producto) {
				jQuery("#t-cel_"+i+"_4").val(inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_producto).trigger("change");
			}
		} else { 
		...
		if(inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_bodega!=null && inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_bodega) {
				jQuery("#t-cel_"+i+"_5").val(inventario_fisico_detalle_control.inventario_fisico_detalleActual.id_bodega).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_6").val(inventario_fisico_detalle_control.inventario_fisico_detalleActual.unidades_contadas);
		jQuery("#t-cel_"+i+"_7").val(inventario_fisico_detalle_control.inventario_fisico_detalleActual.campo1);
		jQuery("#t-cel_"+i+"_8").val(inventario_fisico_detalle_control.inventario_fisico_detalleActual.campo2);
		jQuery("#t-cel_"+i+"_9").val(inventario_fisico_detalle_control.inventario_fisico_detalleActual.campo3);
	}
