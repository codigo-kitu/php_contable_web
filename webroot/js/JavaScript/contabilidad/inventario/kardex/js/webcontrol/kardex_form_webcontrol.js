...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(kardex_control) {
		...
		jQuery("#form"+kardex_constante1.STR_SUFIJO+"-created_at").val(kardex_control.kardexActual.versionRow);
		jQuery("#form"+kardex_constante1.STR_SUFIJO+"-updated_at").val(kardex_control.kardexActual.versionRow);
	...
	actualizarSpanMensajesCampos(kardex_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(kardex_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(kardex_control.strMensajeupdated_at);		
