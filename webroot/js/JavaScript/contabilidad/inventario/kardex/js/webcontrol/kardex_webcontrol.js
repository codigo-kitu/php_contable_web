...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(kardex_control) {
		...
		if(kardex_control.kardexActual.id_empresa!=null && kardex_control.kardexActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != kardex_control.kardexActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(kardex_control.kardexActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(kardex_control.kardexActual.id_sucursal!=null && kardex_control.kardexActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != kardex_control.kardexActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(kardex_control.kardexActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(kardex_control.kardexActual.id_ejercicio!=null && kardex_control.kardexActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != kardex_control.kardexActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(kardex_control.kardexActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(kardex_control.kardexActual.id_periodo!=null && kardex_control.kardexActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != kardex_control.kardexActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(kardex_control.kardexActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(kardex_control.kardexActual.id_usuario!=null && kardex_control.kardexActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != kardex_control.kardexActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(kardex_control.kardexActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(kardex_control.kardexActual.id_modulo!=null && kardex_control.kardexActual.id_modulo>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != kardex_control.kardexActual.id_modulo) {
				jQuery("#t-cel_"+i+"_8").val(kardex_control.kardexActual.id_modulo).trigger("change");
			}
		} else { 
		...
		if(kardex_control.kardexActual.id_tipo_kardex!=null && kardex_control.kardexActual.id_tipo_kardex>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != kardex_control.kardexActual.id_tipo_kardex) {
				jQuery("#t-cel_"+i+"_9").val(kardex_control.kardexActual.id_tipo_kardex).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_10").val(kardex_control.kardexActual.numero);
		jQuery("#t-cel_"+i+"_11").val(kardex_control.kardexActual.numero_documento);
		
		if(kardex_control.kardexActual.id_proveedor!=null && kardex_control.kardexActual.id_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_12").val() != kardex_control.kardexActual.id_proveedor) {
				jQuery("#t-cel_"+i+"_12").val(kardex_control.kardexActual.id_proveedor).trigger("change");
			}
		} else { 
		...
		if(kardex_control.kardexActual.id_cliente!=null && kardex_control.kardexActual.id_cliente>-1){
			if(jQuery("#t-cel_"+i+"_13").val() != kardex_control.kardexActual.id_cliente) {
				jQuery("#t-cel_"+i+"_13").val(kardex_control.kardexActual.id_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_14").val(kardex_control.kardexActual.total);
		jQuery("#t-cel_"+i+"_15").val(kardex_control.kardexActual.descripcion);
		
		if(kardex_control.kardexActual.id_estado!=null && kardex_control.kardexActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_16").val() != kardex_control.kardexActual.id_estado) {
				jQuery("#t-cel_"+i+"_16").val(kardex_control.kardexActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_17").val(kardex_control.kardexActual.costo);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(kardex_control) {
		...
		if(kardex_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+kardex_control.idFilaTablaActual+"_3",kardex_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(kardex_control) {
		...
		if(kardex_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+kardex_control.idFilaTablaActual+"_4",kardex_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(kardex_control) {
		...
		if(kardex_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+kardex_control.idFilaTablaActual+"_5",kardex_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(kardex_control) {
		...
		if(kardex_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+kardex_control.idFilaTablaActual+"_6",kardex_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(kardex_control) {
		...
		if(kardex_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+kardex_control.idFilaTablaActual+"_7",kardex_control.usuariosFK);
		}
	};
	...
	cargarCombosmodulosFK(kardex_control) {
		...
		if(kardex_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+kardex_control.idFilaTablaActual+"_8",kardex_control.modulosFK);
		}
	};
	...
	cargarCombostipo_kardexsFK(kardex_control) {
		...
		if(kardex_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+kardex_control.idFilaTablaActual+"_9",kardex_control.tipo_kardexsFK);
		}
	...
	cargarCombosproveedorsFK(kardex_control) {
		...
		if(kardex_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+kardex_control.idFilaTablaActual+"_12",kardex_control.proveedorsFK);
		}
	...
	cargarCombosclientesFK(kardex_control) {
		...
		if(kardex_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+kardex_control.idFilaTablaActual+"_13",kardex_control.clientesFK);
		}
	...
	cargarCombosestadosFK(kardex_control) {
		...
		if(kardex_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+kardex_control.idFilaTablaActual+"_16",kardex_control.estadosFK);
		}
