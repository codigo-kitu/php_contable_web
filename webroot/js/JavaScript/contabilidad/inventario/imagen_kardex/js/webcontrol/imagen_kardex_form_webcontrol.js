...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(imagen_kardex_control) {
		...
		jQuery("#form"+imagen_kardex_constante1.STR_SUFIJO+"-created_at").val(imagen_kardex_control.imagen_kardexActual.versionRow);
		jQuery("#form"+imagen_kardex_constante1.STR_SUFIJO+"-updated_at").val(imagen_kardex_control.imagen_kardexActual.versionRow);
	...
	actualizarSpanMensajesCampos(imagen_kardex_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(imagen_kardex_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(imagen_kardex_control.strMensajeupdated_at);		
