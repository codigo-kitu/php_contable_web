...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(producto_equivalente_control) {
		...
		jQuery("#form"+producto_equivalente_constante1.STR_SUFIJO+"-created_at").val(producto_equivalente_control.producto_equivalenteActual.versionRow);
		jQuery("#form"+producto_equivalente_constante1.STR_SUFIJO+"-updated_at").val(producto_equivalente_control.producto_equivalenteActual.versionRow);
	...
	actualizarSpanMensajesCampos(producto_equivalente_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(producto_equivalente_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(producto_equivalente_control.strMensajeupdated_at);		
