...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(producto_equivalente_control) {
		...
		if(producto_equivalente_control.producto_equivalenteActual.id_producto_principal!=null && producto_equivalente_control.producto_equivalenteActual.id_producto_principal>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != producto_equivalente_control.producto_equivalenteActual.id_producto_principal) {
				jQuery("#t-cel_"+i+"_3").val(producto_equivalente_control.producto_equivalenteActual.id_producto_principal).trigger("change");
			}
		} else { 
		...
		if(producto_equivalente_control.producto_equivalenteActual.id_producto_equivalente!=null && producto_equivalente_control.producto_equivalenteActual.id_producto_equivalente>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != producto_equivalente_control.producto_equivalenteActual.id_producto_equivalente) {
				jQuery("#t-cel_"+i+"_4").val(producto_equivalente_control.producto_equivalenteActual.id_producto_equivalente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(producto_equivalente_control.producto_equivalenteActual.producto_id_principal);
		jQuery("#t-cel_"+i+"_6").val(producto_equivalente_control.producto_equivalenteActual.producto_id_equivalente);
		jQuery("#t-cel_"+i+"_7").val(producto_equivalente_control.producto_equivalenteActual.comentario);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosproducto_principalsFK(producto_equivalente_control) {
		...
		if(producto_equivalente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+producto_equivalente_control.idFilaTablaActual+"_3",producto_equivalente_control.producto_principalsFK);
		}
	...
	cargarCombosproducto_equivalentesFK(producto_equivalente_control) {
		...
		if(producto_equivalente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+producto_equivalente_control.idFilaTablaActual+"_4",producto_equivalente_control.producto_equivalentesFK);
		}
