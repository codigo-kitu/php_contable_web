...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(imagen_cotizacion_control) {
		...
		jQuery("#t-version_row_"+i+"").val(imagen_cotizacion_control.imagen_cotizacionActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(imagen_cotizacion_control.imagen_cotizacionActual.imagen);
		jQuery("#t-cel_"+i+"_4").val(imagen_cotizacion_control.imagen_cotizacionActual.nro_cotizacion);
	}
