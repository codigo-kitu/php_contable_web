...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(bodega_control) {
		...
		jQuery("#form"+bodega_constante1.STR_SUFIJO+"-created_at").val(bodega_control.bodegaActual.versionRow);
		jQuery("#form"+bodega_constante1.STR_SUFIJO+"-updated_at").val(bodega_control.bodegaActual.versionRow);
	...
	actualizarSpanMensajesCampos(bodega_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(bodega_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(bodega_control.strMensajeupdated_at);		
