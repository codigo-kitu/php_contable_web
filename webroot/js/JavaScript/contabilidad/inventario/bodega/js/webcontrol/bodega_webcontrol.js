...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(bodega_control) {
		...
		if(bodega_control.bodegaActual.id_empresa!=null && bodega_control.bodegaActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != bodega_control.bodegaActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(bodega_control.bodegaActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(bodega_control.bodegaActual.id_sucursal!=null && bodega_control.bodegaActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != bodega_control.bodegaActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(bodega_control.bodegaActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(bodega_control.bodegaActual.codigo);
		jQuery("#t-cel_"+i+"_6").val(bodega_control.bodegaActual.nombre);
		jQuery("#t-cel_"+i+"_7").val(bodega_control.bodegaActual.direccion);
		jQuery("#t-cel_"+i+"_8").val(bodega_control.bodegaActual.telefono);
		jQuery("#t-cel_"+i+"_9").val(bodega_control.bodegaActual.numero_productos);
		jQuery("#t-cel_"+i+"_10").prop('checked',bodega_control.bodegaActual.defecto);
		jQuery("#t-cel_"+i+"_11").prop('checked',bodega_control.bodegaActual.activo);
		jQuery("#t-cel_"+i+"_12").val(bodega_control.bodegaActual.direccion2);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(bodega_control) {
		...
		if(bodega_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+bodega_control.idFilaTablaActual+"_3",bodega_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(bodega_control) {
		...
		if(bodega_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+bodega_control.idFilaTablaActual+"_4",bodega_control.sucursalsFK);
		}
	};
