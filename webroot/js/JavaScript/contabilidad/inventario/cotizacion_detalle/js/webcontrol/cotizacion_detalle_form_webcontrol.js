...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(cotizacion_detalle_control) {
		...
		jQuery("#form"+cotizacion_detalle_constante1.STR_SUFIJO+"-created_at").val(cotizacion_detalle_control.cotizacion_detalleActual.versionRow);
		jQuery("#form"+cotizacion_detalle_constante1.STR_SUFIJO+"-updated_at").val(cotizacion_detalle_control.cotizacion_detalleActual.versionRow);
	...
	actualizarSpanMensajesCampos(cotizacion_detalle_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(cotizacion_detalle_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(cotizacion_detalle_control.strMensajeupdated_at);		
