...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cotizacion_detalle_control) {
		...
		if(cotizacion_detalle_control.cotizacion_detalleActual.id_cotizacion!=null && cotizacion_detalle_control.cotizacion_detalleActual.id_cotizacion>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != cotizacion_detalle_control.cotizacion_detalleActual.id_cotizacion) {
				jQuery("#t-cel_"+i+"_3").val(cotizacion_detalle_control.cotizacion_detalleActual.id_cotizacion).trigger("change");
			}
		} else { 
		...
		if(cotizacion_detalle_control.cotizacion_detalleActual.id_bodega!=null && cotizacion_detalle_control.cotizacion_detalleActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != cotizacion_detalle_control.cotizacion_detalleActual.id_bodega) {
				jQuery("#t-cel_"+i+"_4").val(cotizacion_detalle_control.cotizacion_detalleActual.id_bodega).trigger("change");
			}
		} else { 
		...
		if(cotizacion_detalle_control.cotizacion_detalleActual.id_producto!=null && cotizacion_detalle_control.cotizacion_detalleActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != cotizacion_detalle_control.cotizacion_detalleActual.id_producto) {
				jQuery("#t-cel_"+i+"_5").val(cotizacion_detalle_control.cotizacion_detalleActual.id_producto).trigger("change");
			}
		} else { 
		...
		if(cotizacion_detalle_control.cotizacion_detalleActual.id_unidad!=null && cotizacion_detalle_control.cotizacion_detalleActual.id_unidad>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != cotizacion_detalle_control.cotizacion_detalleActual.id_unidad) {
				jQuery("#t-cel_"+i+"_6").val(cotizacion_detalle_control.cotizacion_detalleActual.id_unidad).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(cotizacion_detalle_control.cotizacion_detalleActual.cantidad);
		jQuery("#t-cel_"+i+"_8").val(cotizacion_detalle_control.cotizacion_detalleActual.precio);
		...
		jQuery("#t-cel_"+i+"_11").val(cotizacion_detalle_control.cotizacion_detalleActual.sub_total);
		jQuery("#t-cel_"+i+"_12").val(cotizacion_detalle_control.cotizacion_detalleActual.iva_porciento);
		jQuery("#t-cel_"+i+"_13").val(cotizacion_detalle_control.cotizacion_detalleActual.iva_monto);
		jQuery("#t-cel_"+i+"_14").val(cotizacion_detalle_control.cotizacion_detalleActual.total);
		jQuery("#t-cel_"+i+"_15").val(cotizacion_detalle_control.cotizacion_detalleActual.observacion);
		jQuery("#t-cel_"+i+"_16").val(cotizacion_detalle_control.cotizacion_detalleActual.impuesto2_porciento);
		jQuery("#t-cel_"+i+"_17").val(cotizacion_detalle_control.cotizacion_detalleActual.impuesto2_monto);
		...
		if(cotizacion_detalle_control.cotizacion_detalleActual.id_otro_suplidor!=null && cotizacion_detalle_control.cotizacion_detalleActual.id_otro_suplidor>-1){
			if(jQuery("#t-cel_"+i+"_18").val() != cotizacion_detalle_control.cotizacion_detalleActual.id_otro_suplidor) {
				jQuery("#t-cel_"+i+"_18").val(cotizacion_detalle_control.cotizacion_detalleActual.id_otro_suplidor).trigger("change");
			}
		} else { 
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarComboscotizacionsFK(cotizacion_detalle_control) {
		...
		if(cotizacion_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cotizacion_detalle_control.idFilaTablaActual+"_3",cotizacion_detalle_control.cotizacionsFK);
		}
	...
	cargarCombosbodegasFK(cotizacion_detalle_control) {
		...
		if(cotizacion_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cotizacion_detalle_control.idFilaTablaActual+"_4",cotizacion_detalle_control.bodegasFK);
		}
	...
	cargarCombosproductosFK(cotizacion_detalle_control) {
		...
		if(cotizacion_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cotizacion_detalle_control.idFilaTablaActual+"_5",cotizacion_detalle_control.productosFK);
		}
	...
	cargarCombosunidadsFK(cotizacion_detalle_control) {
		...
		if(cotizacion_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cotizacion_detalle_control.idFilaTablaActual+"_6",cotizacion_detalle_control.unidadsFK);
		}
	...
	cargarCombosotro_suplidorsFK(cotizacion_detalle_control) {
		...
		if(cotizacion_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cotizacion_detalle_control.idFilaTablaActual+"_18",cotizacion_detalle_control.otro_suplidorsFK);
		}
