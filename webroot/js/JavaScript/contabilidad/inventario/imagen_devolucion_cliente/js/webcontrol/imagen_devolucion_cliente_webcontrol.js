...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(imagen_devolucion_cliente_control) {
		...
		jQuery("#t-version_row_"+i+"").val(imagen_devolucion_cliente_control.imagen_devolucion_clienteActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(imagen_devolucion_cliente_control.imagen_devolucion_clienteActual.id_imagen);
		jQuery("#t-cel_"+i+"_4").val(imagen_devolucion_cliente_control.imagen_devolucion_clienteActual.imagen);
		jQuery("#t-cel_"+i+"_5").val(imagen_devolucion_cliente_control.imagen_devolucion_clienteActual.nro_devolucion);
	}
