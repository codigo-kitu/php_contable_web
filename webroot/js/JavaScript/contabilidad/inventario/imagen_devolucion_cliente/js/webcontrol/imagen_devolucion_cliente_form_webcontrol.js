...
import {imagen_devolucion_cliente_funcion,imagen_devolucion_cliente_funcion1} from '../util/imagen_devolucion_cliente_form_funcion.js';
...
class imagen_devolucion_cliente_webcontrol extends GeneralEntityWebControl {
	...
	actualizarVariablesPagina(imagen_devolucion_cliente_control) {
		...
		} else if(imagen_devolucion_cliente_control.action=="recargarFormularioGeneral") {
...
//Funciones Manejadores Accion
	...
	actualizarVariablesPaginaAccionSeleccionarActualPaginaForm(imagen_devolucion_cliente_control) {
		...
		this.seleccionarActualPaginaFormularioAdd(imagen_devolucion_cliente_control);
	...
	actualizarCamposFormulario(imagen_devolucion_cliente_control) {
		...
		jQuery("#form"+imagen_devolucion_cliente_constante1.STR_SUFIJO+"-created_at").val(imagen_devolucion_cliente_control.imagen_devolucion_clienteActual.versionRow);
		jQuery("#form"+imagen_devolucion_cliente_constante1.STR_SUFIJO+"-updated_at").val(imagen_devolucion_cliente_control.imagen_devolucion_clienteActual.versionRow);
	...
	actualizarSpanMensajesCampos(imagen_devolucion_cliente_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(imagen_devolucion_cliente_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(imagen_devolucion_cliente_control.strMensajeupdated_at);		
