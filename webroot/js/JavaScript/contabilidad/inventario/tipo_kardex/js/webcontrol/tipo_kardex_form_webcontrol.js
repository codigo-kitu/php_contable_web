...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(tipo_kardex_control) {
		...
		jQuery("#form"+tipo_kardex_constante1.STR_SUFIJO+"-created_at").val(tipo_kardex_control.tipo_kardexActual.versionRow);
		jQuery("#form"+tipo_kardex_constante1.STR_SUFIJO+"-updated_at").val(tipo_kardex_control.tipo_kardexActual.versionRow);
	...
	actualizarSpanMensajesCampos(tipo_kardex_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(tipo_kardex_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(tipo_kardex_control.strMensajeupdated_at);		
