...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(devolucion_detalle_control) {
		...
		if(devolucion_detalle_control.devolucion_detalleActual.id_devolucion!=null && devolucion_detalle_control.devolucion_detalleActual.id_devolucion>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != devolucion_detalle_control.devolucion_detalleActual.id_devolucion) {
				jQuery("#t-cel_"+i+"_3").val(devolucion_detalle_control.devolucion_detalleActual.id_devolucion).trigger("change");
			}
		} else { 
		...
		if(devolucion_detalle_control.devolucion_detalleActual.id_bodega!=null && devolucion_detalle_control.devolucion_detalleActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != devolucion_detalle_control.devolucion_detalleActual.id_bodega) {
				jQuery("#t-cel_"+i+"_4").val(devolucion_detalle_control.devolucion_detalleActual.id_bodega).trigger("change");
			}
		} else { 
		...
		if(devolucion_detalle_control.devolucion_detalleActual.id_producto!=null && devolucion_detalle_control.devolucion_detalleActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != devolucion_detalle_control.devolucion_detalleActual.id_producto) {
				jQuery("#t-cel_"+i+"_5").val(devolucion_detalle_control.devolucion_detalleActual.id_producto).trigger("change");
			}
		} else { 
		...
		if(devolucion_detalle_control.devolucion_detalleActual.id_unidad!=null && devolucion_detalle_control.devolucion_detalleActual.id_unidad>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != devolucion_detalle_control.devolucion_detalleActual.id_unidad) {
				jQuery("#t-cel_"+i+"_6").val(devolucion_detalle_control.devolucion_detalleActual.id_unidad).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(devolucion_detalle_control.devolucion_detalleActual.numero_item);
		jQuery("#t-cel_"+i+"_8").val(devolucion_detalle_control.devolucion_detalleActual.cantidad);
		jQuery("#t-cel_"+i+"_9").val(devolucion_detalle_control.devolucion_detalleActual.precio);
		jQuery("#t-cel_"+i+"_10").val(devolucion_detalle_control.devolucion_detalleActual.sub_total);
		jQuery("#t-cel_"+i+"_11").val(devolucion_detalle_control.devolucion_detalleActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_12").val(devolucion_detalle_control.devolucion_detalleActual.descuento_monto);
		jQuery("#t-cel_"+i+"_13").val(devolucion_detalle_control.devolucion_detalleActual.iva_porciento);
		jQuery("#t-cel_"+i+"_14").val(devolucion_detalle_control.devolucion_detalleActual.iva_monto);
		jQuery("#t-cel_"+i+"_15").val(devolucion_detalle_control.devolucion_detalleActual.total);
		jQuery("#t-cel_"+i+"_16").val(devolucion_detalle_control.devolucion_detalleActual.observacion);
		jQuery("#t-cel_"+i+"_17").val(devolucion_detalle_control.devolucion_detalleActual.impuesto2_porciento);
		jQuery("#t-cel_"+i+"_18").val(devolucion_detalle_control.devolucion_detalleActual.impuesto2_monto);
	}
