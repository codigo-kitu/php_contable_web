...
<script id="devolucion_detalle_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliardevolucion_detallesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each devolucion_detallesReporte}}

			<table id="tabledevolucion_detalle{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Devolucion' ../arrOrderBy ../bitParaReporteOrderBy) }}
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								...
								<td>{{trim id_devolucion_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
			...
			{{#if (existeCadenaArrayOrderBy 'No Item' ../arrOrderBy ../bitParaReporteOrderBy) }}
