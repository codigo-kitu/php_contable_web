...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(inventario_fisico_control) {
		...
		jQuery("#form"+inventario_fisico_constante1.STR_SUFIJO+"-created_at").val(inventario_fisico_control.inventario_fisicoActual.versionRow);
		jQuery("#form"+inventario_fisico_constante1.STR_SUFIJO+"-updated_at").val(inventario_fisico_control.inventario_fisicoActual.versionRow);
	...
	actualizarSpanMensajesCampos(inventario_fisico_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(inventario_fisico_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(inventario_fisico_control.strMensajeupdated_at);		
