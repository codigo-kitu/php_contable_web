...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(inventario_fisico_control) {
		...
		if(inventario_fisico_control.inventario_fisicoActual.id_inventario_fisico!=null && inventario_fisico_control.inventario_fisicoActual.id_inventario_fisico>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != inventario_fisico_control.inventario_fisicoActual.id_inventario_fisico) {
				jQuery("#t-cel_"+i+"_3").val(inventario_fisico_control.inventario_fisicoActual.id_inventario_fisico).trigger("change");
			}
		} else { 
		...
		if(inventario_fisico_control.inventario_fisicoActual.id_bodega!=null && inventario_fisico_control.inventario_fisicoActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != inventario_fisico_control.inventario_fisicoActual.id_bodega) {
				jQuery("#t-cel_"+i+"_4").val(inventario_fisico_control.inventario_fisicoActual.id_bodega).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(inventario_fisico_control.inventario_fisicoActual.fecha);
		jQuery("#t-cel_"+i+"_6").val(inventario_fisico_control.inventario_fisicoActual.descripcion);
		jQuery("#t-cel_"+i+"_7").val(inventario_fisico_control.inventario_fisicoActual.id_almacen);
		jQuery("#t-cel_"+i+"_8").val(inventario_fisico_control.inventario_fisicoActual.prod_cont_almacen);
		jQuery("#t-cel_"+i+"_9").val(inventario_fisico_control.inventario_fisicoActual.total_productos_almacen);
		jQuery("#t-cel_"+i+"_10").val(inventario_fisico_control.inventario_fisicoActual.campo1);
		jQuery("#t-cel_"+i+"_11").val(inventario_fisico_control.inventario_fisicoActual.campo2);
		jQuery("#t-cel_"+i+"_12").val(inventario_fisico_control.inventario_fisicoActual.campo3);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosinventario_fisicosFK(inventario_fisico_control) {
		...
		if(inventario_fisico_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+inventario_fisico_control.idFilaTablaActual+"_3",inventario_fisico_control.inventario_fisicosFK);
		}
	...
	cargarCombosbodegasFK(inventario_fisico_control) {
		...
		if(inventario_fisico_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+inventario_fisico_control.idFilaTablaActual+"_4",inventario_fisico_control.bodegasFK);
		}
