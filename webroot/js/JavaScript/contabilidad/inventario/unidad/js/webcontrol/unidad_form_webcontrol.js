...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(unidad_control) {
		...
		jQuery("#form"+unidad_constante1.STR_SUFIJO+"-created_at").val(unidad_control.unidadActual.versionRow);
		jQuery("#form"+unidad_constante1.STR_SUFIJO+"-updated_at").val(unidad_control.unidadActual.versionRow);
	...
	actualizarSpanMensajesCampos(unidad_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(unidad_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(unidad_control.strMensajeupdated_at);		
