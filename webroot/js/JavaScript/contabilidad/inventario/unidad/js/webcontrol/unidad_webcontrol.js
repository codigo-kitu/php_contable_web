...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(unidad_control) {
		...
		if(unidad_control.unidadActual.id_empresa!=null && unidad_control.unidadActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != unidad_control.unidadActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(unidad_control.unidadActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(unidad_control.unidadActual.codigo);
		jQuery("#t-cel_"+i+"_5").val(unidad_control.unidadActual.nombre);
		jQuery("#t-cel_"+i+"_6").prop('checked',unidad_control.unidadActual.defecto_venta);
		jQuery("#t-cel_"+i+"_7").prop('checked',unidad_control.unidadActual.defecto_compra);
		jQuery("#t-cel_"+i+"_8").val(unidad_control.unidadActual.numero_productos);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(unidad_control) {
		...
		if(unidad_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+unidad_control.idFilaTablaActual+"_3",unidad_control.empresasFK);
		}
	};
