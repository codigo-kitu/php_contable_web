...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(categoria_producto_control) {
		...
		jQuery("#form"+categoria_producto_constante1.STR_SUFIJO+"-created_at").val(categoria_producto_control.categoria_productoActual.versionRow);
		jQuery("#form"+categoria_producto_constante1.STR_SUFIJO+"-updated_at").val(categoria_producto_control.categoria_productoActual.versionRow);
	...
	actualizarSpanMensajesCampos(categoria_producto_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(categoria_producto_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(categoria_producto_control.strMensajeupdated_at);		
