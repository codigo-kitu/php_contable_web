...
<script id="categoria_producto_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarcategoria_productosAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each categoria_productosReporte}}

			<table id="tablecategoria_producto{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
		...
		<form id="frmTablaDatossub_categoria_producto" name="frmTablaDatossub_categoria_producto">
			<div id="divTablaDatosAuxiliarsub_categoria_productosAjaxWebPart" style="{{style_div}}">

				<input type="hidden" id="t{{strSufijo}}-maxima_fila" name="t{{strSufijo}}-maxima_fila" value="{{count sub_categoria_productos}}">
		...
		<table id="tblTablaDatossub_categoria_productos" name="tblTablaDatossub_categoria_productos" class="{{class_table}}" cellpadding="3" cellspacing="3" style="{{style_tabla}}" border="1" rules="rows">
		...
		{{#if (Is_List_Exist sub_categoria_productos)}}
			{{#each sub_categoria_productos}}
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarsub_categoria_producto" idactualsub_categoria_producto="{{id}}" title="SELECCIONAR Sub Categoria Producto ACTUAL" src="{{../PATH_IMAGEN}}/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_eli col_id"  style="display:{{../strPermisoEliminar}}">
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgeliminartablasub_categoria_producto" idactualsub_categoria_producto="{{id}}" title="ELIMINAR Sub Categoria Producto ACTUAL" src="{{../PATH_IMAGEN}}/Imagenes/eliminar.gif" alt="Eliminar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_{{i}}" name="t-id_{{i}}" type="checkbox" class="chkb_id" title="SELECCIONAR Sub Categoria Producto ACTUAL" value="{{id}}"></input>
							</td>
							<td>
								{{i}}
							</td>
				...
				<td class="elementotabla columna_tabla_selrel col_id"  style="display:{{../strPermisoRelaciones}}">
					<a>
						{{id}}<img class="imgseleccionarmostraraccionesrelacionessub_categoria_producto" idactualsub_categoria_producto="{{id}}" title="DATOS RELACIONADOS" src="{{../PATH_IMAGEN}}/Imagenes/ejecutar_acciones.gif" alt="Ver" border="0" height="15" width="15">
					</a>
				</td>
				...
				{{#if (If_Not_AND_Not ../bitEsBusqueda  ../bitEsRelaciones)}}
					...
					<td class="elementotabla"  align="center" style="display:table-cell">
						<a>{{id}}
							<img class="imgrelacionlista_producto" idactualsub_categoria_producto="{{id}}" title="Lista ProductosS DE Sub Categoria Producto" src="{{PATH_IMAGEN}}/Imagenes/lista_productos.gif" alt="Seleccionar" border="" height="15" width="15">
						</a>
					</td>
					...
					<td class="elementotabla"  align="center" style="display:table-cell">
						<a>{{id}}
							<img class="imgrelacionproducto" idactualsub_categoria_producto="{{id}}" title="ProductoS DE Sub Categoria Producto" src="{{PATH_IMAGEN}}/Imagenes/productos.gif" alt="Seleccionar" border="" height="15" width="15">
						</a>
					</td>
