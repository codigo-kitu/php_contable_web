...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(serial_producto_control) {
		...
		jQuery("#form"+serial_producto_constante1.STR_SUFIJO+"-created_at").val(serial_producto_control.serial_productoActual.versionRow);
		jQuery("#form"+serial_producto_constante1.STR_SUFIJO+"-updated_at").val(serial_producto_control.serial_productoActual.versionRow);
	...
	actualizarSpanMensajesCampos(serial_producto_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(serial_producto_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(serial_producto_control.strMensajeupdated_at);		
