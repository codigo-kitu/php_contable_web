...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(lote_producto_control) {
		...
		jQuery("#form"+lote_producto_constante1.STR_SUFIJO+"-created_at").val(lote_producto_control.lote_productoActual.versionRow);
		jQuery("#form"+lote_producto_constante1.STR_SUFIJO+"-updated_at").val(lote_producto_control.lote_productoActual.versionRow);
	...
	actualizarSpanMensajesCampos(lote_producto_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(lote_producto_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(lote_producto_control.strMensajeupdated_at);		
