...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(lote_producto_control) {
		...
		if(lote_producto_control.lote_productoActual.id_producto!=null && lote_producto_control.lote_productoActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != lote_producto_control.lote_productoActual.id_producto) {
				jQuery("#t-cel_"+i+"_3").val(lote_producto_control.lote_productoActual.id_producto).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(lote_producto_control.lote_productoActual.nro_lote);
		jQuery("#t-cel_"+i+"_5").val(lote_producto_control.lote_productoActual.descripcion);
		
		if(lote_producto_control.lote_productoActual.id_bodega!=null && lote_producto_control.lote_productoActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != lote_producto_control.lote_productoActual.id_bodega) {
				jQuery("#t-cel_"+i+"_6").val(lote_producto_control.lote_productoActual.id_bodega).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(lote_producto_control.lote_productoActual.fecha_ingreso);
		jQuery("#t-cel_"+i+"_8").val(lote_producto_control.lote_productoActual.fecha_expiracion);
		jQuery("#t-cel_"+i+"_9").val(lote_producto_control.lote_productoActual.ubicacion);
		jQuery("#t-cel_"+i+"_10").val(lote_producto_control.lote_productoActual.cantidad);
		jQuery("#t-cel_"+i+"_11").val(lote_producto_control.lote_productoActual.comentario);
		jQuery("#t-cel_"+i+"_12").val(lote_producto_control.lote_productoActual.nro_documento);
		jQuery("#t-cel_"+i+"_13").val(lote_producto_control.lote_productoActual.disponible);
		jQuery("#t-cel_"+i+"_14").val(lote_producto_control.lote_productoActual.agotado_en);
		jQuery("#t-cel_"+i+"_15").val(lote_producto_control.lote_productoActual.nro_item);
		
		if(lote_producto_control.lote_productoActual.id_proveedor!=null && lote_producto_control.lote_productoActual.id_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_16").val() != lote_producto_control.lote_productoActual.id_proveedor) {
				jQuery("#t-cel_"+i+"_16").val(lote_producto_control.lote_productoActual.id_proveedor).trigger("change");
			}
		} else { 
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosproductosFK(lote_producto_control) {
		...
		if(lote_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lote_producto_control.idFilaTablaActual+"_3",lote_producto_control.productosFK);
		}
	...
	cargarCombosbodegasFK(lote_producto_control) {
		...
		if(lote_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lote_producto_control.idFilaTablaActual+"_6",lote_producto_control.bodegasFK);
		}
	...
	cargarCombosproveedorsFK(lote_producto_control) {
		...
		if(lote_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lote_producto_control.idFilaTablaActual+"_16",lote_producto_control.proveedorsFK);
		}
