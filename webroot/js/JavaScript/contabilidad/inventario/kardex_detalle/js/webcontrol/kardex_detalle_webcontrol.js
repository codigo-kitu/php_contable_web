...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(kardex_detalle_control) {
		...
		jQuery("#t-cel_"+i+"_4").val(kardex_detalle_control.kardex_detalleActual.numero_item);
		
		if(kardex_detalle_control.kardex_detalleActual.id_bodega!=null && kardex_detalle_control.kardex_detalleActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != kardex_detalle_control.kardex_detalleActual.id_bodega) {
				jQuery("#t-cel_"+i+"_5").val(kardex_detalle_control.kardex_detalleActual.id_bodega).trigger("change");
			}
		} else { 
		...
		if(kardex_detalle_control.kardex_detalleActual.id_producto!=null && kardex_detalle_control.kardex_detalleActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != kardex_detalle_control.kardex_detalleActual.id_producto) {
				jQuery("#t-cel_"+i+"_6").val(kardex_detalle_control.kardex_detalleActual.id_producto).trigger("change");
			}
		} else { 
		...
		if(kardex_detalle_control.kardex_detalleActual.id_unidad!=null && kardex_detalle_control.kardex_detalleActual.id_unidad>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != kardex_detalle_control.kardex_detalleActual.id_unidad) {
				jQuery("#t-cel_"+i+"_7").val(kardex_detalle_control.kardex_detalleActual.id_unidad).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_8").val(kardex_detalle_control.kardex_detalleActual.cantidad);
		jQuery("#t-cel_"+i+"_9").val(kardex_detalle_control.kardex_detalleActual.costo);
		jQuery("#t-cel_"+i+"_10").val(kardex_detalle_control.kardex_detalleActual.total);
		...
		if(kardex_detalle_control.kardex_detalleActual.id_lote_producto!=null && kardex_detalle_control.kardex_detalleActual.id_lote_producto>-1){
			if(jQuery("#t-cel_"+i+"_11").val() != kardex_detalle_control.kardex_detalleActual.id_lote_producto) {
				jQuery("#t-cel_"+i+"_11").val(kardex_detalle_control.kardex_detalleActual.id_lote_producto).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_12").val(kardex_detalle_control.kardex_detalleActual.descripcion);
		jQuery("#t-cel_"+i+"_13").val(kardex_detalle_control.kardex_detalleActual.cantidad_disponible);
		jQuery("#t-cel_"+i+"_14").val(kardex_detalle_control.kardex_detalleActual.cantidad_disponible_total);
		jQuery("#t-cel_"+i+"_15").val(kardex_detalle_control.kardex_detalleActual.costo_anterior);
	}
