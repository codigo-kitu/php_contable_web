...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(lista_precio_control) {
		...
		jQuery("#form"+lista_precio_constante1.STR_SUFIJO+"-created_at").val(lista_precio_control.lista_precioActual.versionRow);
		jQuery("#form"+lista_precio_constante1.STR_SUFIJO+"-updated_at").val(lista_precio_control.lista_precioActual.versionRow);
	...
	actualizarSpanMensajesCampos(lista_precio_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(lista_precio_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(lista_precio_control.strMensajeupdated_at);		
