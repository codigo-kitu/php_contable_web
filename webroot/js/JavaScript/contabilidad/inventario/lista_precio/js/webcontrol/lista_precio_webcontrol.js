...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(lista_precio_control) {
		...
		if(lista_precio_control.lista_precioActual.id_empresa!=null && lista_precio_control.lista_precioActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != lista_precio_control.lista_precioActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(lista_precio_control.lista_precioActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(lista_precio_control.lista_precioActual.id_bodega!=null && lista_precio_control.lista_precioActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != lista_precio_control.lista_precioActual.id_bodega) {
				jQuery("#t-cel_"+i+"_4").val(lista_precio_control.lista_precioActual.id_bodega).trigger("change");
			}
		} else { 
		...
		if(lista_precio_control.lista_precioActual.id_producto!=null && lista_precio_control.lista_precioActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != lista_precio_control.lista_precioActual.id_producto) {
				jQuery("#t-cel_"+i+"_5").val(lista_precio_control.lista_precioActual.id_producto).trigger("change");
			}
		} else { 
		...
		if(lista_precio_control.lista_precioActual.id_proveedor!=null && lista_precio_control.lista_precioActual.id_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != lista_precio_control.lista_precioActual.id_proveedor) {
				jQuery("#t-cel_"+i+"_6").val(lista_precio_control.lista_precioActual.id_proveedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(lista_precio_control.lista_precioActual.precio_compra);
		jQuery("#t-cel_"+i+"_8").val(lista_precio_control.lista_precioActual.rango_inicial);
		jQuery("#t-cel_"+i+"_9").val(lista_precio_control.lista_precioActual.rango_final);
		jQuery("#t-cel_"+i+"_10").val(lista_precio_control.lista_precioActual.precio_dolar);
		jQuery("#t-cel_"+i+"_11").val(lista_precio_control.lista_precioActual.precio_compra2);
		jQuery("#t-cel_"+i+"_12").val(lista_precio_control.lista_precioActual.precio_dolar2);
		jQuery("#t-cel_"+i+"_13").val(lista_precio_control.lista_precioActual.rango_inicial2);
		jQuery("#t-cel_"+i+"_14").val(lista_precio_control.lista_precioActual.rango_final2);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(lista_precio_control) {
		...
		if(lista_precio_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_precio_control.idFilaTablaActual+"_3",lista_precio_control.empresasFK);
		}
	};
	...
	cargarCombosbodegasFK(lista_precio_control) {
		...
		if(lista_precio_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_precio_control.idFilaTablaActual+"_4",lista_precio_control.bodegasFK);
		}
	...
	cargarCombosproductosFK(lista_precio_control) {
		...
		if(lista_precio_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_precio_control.idFilaTablaActual+"_5",lista_precio_control.productosFK);
		}
	...
	cargarCombosproveedorsFK(lista_precio_control) {
		...
		if(lista_precio_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_precio_control.idFilaTablaActual+"_6",lista_precio_control.proveedorsFK);
		}
