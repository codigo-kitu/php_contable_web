...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(costo_producto_control) {
		...
		jQuery("#form"+costo_producto_constante1.STR_SUFIJO+"-created_at").val(costo_producto_control.costo_productoActual.versionRow);
		jQuery("#form"+costo_producto_constante1.STR_SUFIJO+"-updated_at").val(costo_producto_control.costo_productoActual.versionRow);
	...
	actualizarSpanMensajesCampos(costo_producto_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(costo_producto_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(costo_producto_control.strMensajeupdated_at);		
