...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(costo_producto_control) {
		...
		if(costo_producto_control.costo_productoActual.id_empresa!=null && costo_producto_control.costo_productoActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != costo_producto_control.costo_productoActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(costo_producto_control.costo_productoActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(costo_producto_control.costo_productoActual.id_sucursal!=null && costo_producto_control.costo_productoActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != costo_producto_control.costo_productoActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(costo_producto_control.costo_productoActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(costo_producto_control.costo_productoActual.id_ejercicio!=null && costo_producto_control.costo_productoActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != costo_producto_control.costo_productoActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(costo_producto_control.costo_productoActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(costo_producto_control.costo_productoActual.id_periodo!=null && costo_producto_control.costo_productoActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != costo_producto_control.costo_productoActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(costo_producto_control.costo_productoActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(costo_producto_control.costo_productoActual.id_usuario!=null && costo_producto_control.costo_productoActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != costo_producto_control.costo_productoActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(costo_producto_control.costo_productoActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(costo_producto_control.costo_productoActual.id_producto!=null && costo_producto_control.costo_productoActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != costo_producto_control.costo_productoActual.id_producto) {
				jQuery("#t-cel_"+i+"_8").val(costo_producto_control.costo_productoActual.id_producto).trigger("change");
			}
		} else { 
		...
		if(costo_producto_control.costo_productoActual.id_tabla!=null && costo_producto_control.costo_productoActual.id_tabla>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != costo_producto_control.costo_productoActual.id_tabla) {
				jQuery("#t-cel_"+i+"_9").val(costo_producto_control.costo_productoActual.id_tabla).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_10").val(costo_producto_control.costo_productoActual.idn_origen);
		jQuery("#t-cel_"+i+"_11").val(costo_producto_control.costo_productoActual.idn_detalle_origen);
		jQuery("#t-cel_"+i+"_12").val(costo_producto_control.costo_productoActual.nro_documento);
		jQuery("#t-cel_"+i+"_13").val(costo_producto_control.costo_productoActual.fecha);
		jQuery("#t-cel_"+i+"_14").val(costo_producto_control.costo_productoActual.cantidad);
		jQuery("#t-cel_"+i+"_15").val(costo_producto_control.costo_productoActual.costo_unitario);
		jQuery("#t-cel_"+i+"_16").val(costo_producto_control.costo_productoActual.costo_total);
		jQuery("#t-cel_"+i+"_17").val(costo_producto_control.costo_productoActual.cantidad_origen);
		jQuery("#t-cel_"+i+"_18").val(costo_producto_control.costo_productoActual.costo_unitario_origen);
		jQuery("#t-cel_"+i+"_19").val(costo_producto_control.costo_productoActual.costo_total_origen);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(costo_producto_control) {
		...
		if(costo_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+costo_producto_control.idFilaTablaActual+"_3",costo_producto_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(costo_producto_control) {
		...
		if(costo_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+costo_producto_control.idFilaTablaActual+"_4",costo_producto_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(costo_producto_control) {
		...
		if(costo_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+costo_producto_control.idFilaTablaActual+"_5",costo_producto_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(costo_producto_control) {
		...
		if(costo_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+costo_producto_control.idFilaTablaActual+"_6",costo_producto_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(costo_producto_control) {
		...
		if(costo_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+costo_producto_control.idFilaTablaActual+"_7",costo_producto_control.usuariosFK);
		}
	};
	...
	cargarCombosproductosFK(costo_producto_control) {
		...
		if(costo_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+costo_producto_control.idFilaTablaActual+"_8",costo_producto_control.productosFK);
		}
	...
	cargarCombostablasFK(costo_producto_control) {
		...
		if(costo_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+costo_producto_control.idFilaTablaActual+"_9",costo_producto_control.tablasFK);
		}
