...
<script id="costo_producto_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarcosto_productosAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each costo_productosReporte}}

			<table id="tablecosto_producto{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Idn Detalle Origen' ../arrOrderBy ../bitParaReporteOrderBy) }}
				...
				<tr>
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								<td width="20%" {{../strAuxStyleBackgroundContenidoCabecera}} >
									<b>- Idn Detalle Origen</b>
								</td>
								<td>{{ idn_detalle_origen}}
								</td>
							</tr>
						</table>
					</td>
			...
			{{#if (existeCadenaArrayOrderBy 'Costo Unitario' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Costo Total' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Cantidad Origen' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Costo Unitario Origen' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Costo Total Origen' ../arrOrderBy ../bitParaReporteOrderBy) }}
				...
				<tr>
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								<td width="20%" {{../strAuxStyleBackgroundContenidoCabecera}} >
									<b>- Costo Total Origen</b>
								</td>
								<td>{{ costo_total_origen}}
								</td>
							</tr>
						</table>
					</td>
