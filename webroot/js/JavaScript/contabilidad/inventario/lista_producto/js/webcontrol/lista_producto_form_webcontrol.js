...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(lista_producto_control) {
		...
		jQuery("#form"+lista_producto_constante1.STR_SUFIJO+"-created_at").val(lista_producto_control.lista_productoActual.versionRow);
		jQuery("#form"+lista_producto_constante1.STR_SUFIJO+"-updated_at").val(lista_producto_control.lista_productoActual.versionRow);
	...
	actualizarSpanMensajesCampos(lista_producto_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(lista_producto_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(lista_producto_control.strMensajeupdated_at);		
