...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(lista_producto_control) {
		...
		if(lista_producto_control.lista_productoActual.id_producto!=null && lista_producto_control.lista_productoActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != lista_producto_control.lista_productoActual.id_producto) {
				jQuery("#t-cel_"+i+"_3").val(lista_producto_control.lista_productoActual.id_producto).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(lista_producto_control.lista_productoActual.codigo_producto);
		jQuery("#t-cel_"+i+"_5").val(lista_producto_control.lista_productoActual.descripcion_producto);
		jQuery("#t-cel_"+i+"_6").val(lista_producto_control.lista_productoActual.precio1);
		jQuery("#t-cel_"+i+"_7").val(lista_producto_control.lista_productoActual.precio2);
		jQuery("#t-cel_"+i+"_8").val(lista_producto_control.lista_productoActual.precio3);
		jQuery("#t-cel_"+i+"_9").val(lista_producto_control.lista_productoActual.precio4);
		jQuery("#t-cel_"+i+"_10").val(lista_producto_control.lista_productoActual.costo);
		...
		if(lista_producto_control.lista_productoActual.id_unidad_compra!=null && lista_producto_control.lista_productoActual.id_unidad_compra>-1){
			if(jQuery("#t-cel_"+i+"_11").val() != lista_producto_control.lista_productoActual.id_unidad_compra) {
				jQuery("#t-cel_"+i+"_11").val(lista_producto_control.lista_productoActual.id_unidad_compra).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_12").val(lista_producto_control.lista_productoActual.unidad_en_compra);
		jQuery("#t-cel_"+i+"_13").val(lista_producto_control.lista_productoActual.equivalencia_en_compra);
		...
		if(lista_producto_control.lista_productoActual.id_unidad_venta!=null && lista_producto_control.lista_productoActual.id_unidad_venta>-1){
			if(jQuery("#t-cel_"+i+"_14").val() != lista_producto_control.lista_productoActual.id_unidad_venta) {
				jQuery("#t-cel_"+i+"_14").val(lista_producto_control.lista_productoActual.id_unidad_venta).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_15").val(lista_producto_control.lista_productoActual.unidad_en_venta);
		jQuery("#t-cel_"+i+"_16").val(lista_producto_control.lista_productoActual.equivalencia_en_venta);
		jQuery("#t-cel_"+i+"_17").val(lista_producto_control.lista_productoActual.cantidad_total);
		jQuery("#t-cel_"+i+"_18").val(lista_producto_control.lista_productoActual.cantidad_minima);
		...
		if(lista_producto_control.lista_productoActual.id_categoria_producto!=null && lista_producto_control.lista_productoActual.id_categoria_producto>-1){
			if(jQuery("#t-cel_"+i+"_19").val() != lista_producto_control.lista_productoActual.id_categoria_producto) {
				jQuery("#t-cel_"+i+"_19").val(lista_producto_control.lista_productoActual.id_categoria_producto).trigger("change");
			}
		} else { 
		...
		if(lista_producto_control.lista_productoActual.id_sub_categoria_producto!=null && lista_producto_control.lista_productoActual.id_sub_categoria_producto>-1){
			if(jQuery("#t-cel_"+i+"_20").val() != lista_producto_control.lista_productoActual.id_sub_categoria_producto) {
				jQuery("#t-cel_"+i+"_20").val(lista_producto_control.lista_productoActual.id_sub_categoria_producto).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_21").val(lista_producto_control.lista_productoActual.acepta_lote);
		jQuery("#t-cel_"+i+"_22").val(lista_producto_control.lista_productoActual.valor_inventario);
		jQuery("#t-cel_"+i+"_23").val(lista_producto_control.lista_productoActual.imagen);
		jQuery("#t-cel_"+i+"_24").val(lista_producto_control.lista_productoActual.incremento1);
		jQuery("#t-cel_"+i+"_25").val(lista_producto_control.lista_productoActual.incremento2);
		jQuery("#t-cel_"+i+"_26").val(lista_producto_control.lista_productoActual.incremento3);
		jQuery("#t-cel_"+i+"_27").val(lista_producto_control.lista_productoActual.incremento4);
		jQuery("#t-cel_"+i+"_28").val(lista_producto_control.lista_productoActual.codigo_fabricante);
		jQuery("#t-cel_"+i+"_29").val(lista_producto_control.lista_productoActual.producto_fisico);
		jQuery("#t-cel_"+i+"_30").val(lista_producto_control.lista_productoActual.situacion_producto);
		...
		if(lista_producto_control.lista_productoActual.id_tipo_producto!=null && lista_producto_control.lista_productoActual.id_tipo_producto>-1){
			if(jQuery("#t-cel_"+i+"_31").val() != lista_producto_control.lista_productoActual.id_tipo_producto) {
				jQuery("#t-cel_"+i+"_31").val(lista_producto_control.lista_productoActual.id_tipo_producto).trigger("change");
			}
		} else { 
			//jQuery("#t-cel_"+i+"_31").select2("val", null);
			if(jQuery("#t-cel_"+i+"_31").val() != constantes.INT_VALOR_ESCOJA_OPCION) {
				jQuery("#t-cel_"+i+"_31").val(constantes.INT_VALOR_ESCOJA_OPCION).trigger("change");
			}
		}
		jQuery("#t-cel_"+i+"_32").val(lista_producto_control.lista_productoActual.tipo_producto_codigo);
		
		if(lista_producto_control.lista_productoActual.id_bodega!=null && lista_producto_control.lista_productoActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_33").val() != lista_producto_control.lista_productoActual.id_bodega) {
				jQuery("#t-cel_"+i+"_33").val(lista_producto_control.lista_productoActual.id_bodega).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_34").val(lista_producto_control.lista_productoActual.mostrar_componente);
		jQuery("#t-cel_"+i+"_35").val(lista_producto_control.lista_productoActual.factura_sin_stock);
		jQuery("#t-cel_"+i+"_36").val(lista_producto_control.lista_productoActual.avisa_expiracion);
		jQuery("#t-cel_"+i+"_37").val(lista_producto_control.lista_productoActual.factura_con_precio);
		jQuery("#t-cel_"+i+"_38").val(lista_producto_control.lista_productoActual.producto_equivalente);
		...
		if(lista_producto_control.lista_productoActual.id_cuenta_compra!=null && lista_producto_control.lista_productoActual.id_cuenta_compra>-1){
			if(jQuery("#t-cel_"+i+"_39").val() != lista_producto_control.lista_productoActual.id_cuenta_compra) {
				jQuery("#t-cel_"+i+"_39").val(lista_producto_control.lista_productoActual.id_cuenta_compra).trigger("change");
			}
		} else { 
		...
		if(lista_producto_control.lista_productoActual.id_cuenta_venta!=null && lista_producto_control.lista_productoActual.id_cuenta_venta>-1){
			if(jQuery("#t-cel_"+i+"_40").val() != lista_producto_control.lista_productoActual.id_cuenta_venta) {
				jQuery("#t-cel_"+i+"_40").val(lista_producto_control.lista_productoActual.id_cuenta_venta).trigger("change");
			}
		} else { 
		...
		if(lista_producto_control.lista_productoActual.id_cuenta_inventario!=null && lista_producto_control.lista_productoActual.id_cuenta_inventario>-1){
			if(jQuery("#t-cel_"+i+"_41").val() != lista_producto_control.lista_productoActual.id_cuenta_inventario) {
				jQuery("#t-cel_"+i+"_41").val(lista_producto_control.lista_productoActual.id_cuenta_inventario).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_42").val(lista_producto_control.lista_productoActual.cuenta_compra_codigo);
		jQuery("#t-cel_"+i+"_43").val(lista_producto_control.lista_productoActual.cuenta_venta_codigo);
		jQuery("#t-cel_"+i+"_44").val(lista_producto_control.lista_productoActual.cuenta_inventario_codigo);
		...
		if(lista_producto_control.lista_productoActual.id_otro_suplidor!=null && lista_producto_control.lista_productoActual.id_otro_suplidor>-1){
			if(jQuery("#t-cel_"+i+"_45").val() != lista_producto_control.lista_productoActual.id_otro_suplidor) {
				jQuery("#t-cel_"+i+"_45").val(lista_producto_control.lista_productoActual.id_otro_suplidor).trigger("change");
			}
		} else { 
		...
		if(lista_producto_control.lista_productoActual.id_impuesto!=null && lista_producto_control.lista_productoActual.id_impuesto>-1){
			if(jQuery("#t-cel_"+i+"_46").val() != lista_producto_control.lista_productoActual.id_impuesto) {
				jQuery("#t-cel_"+i+"_46").val(lista_producto_control.lista_productoActual.id_impuesto).trigger("change");
			}
		} else { 
		...
		if(lista_producto_control.lista_productoActual.id_impuesto_ventas!=null && lista_producto_control.lista_productoActual.id_impuesto_ventas>-1){
			if(jQuery("#t-cel_"+i+"_47").val() != lista_producto_control.lista_productoActual.id_impuesto_ventas) {
				jQuery("#t-cel_"+i+"_47").val(lista_producto_control.lista_productoActual.id_impuesto_ventas).trigger("change");
			}
		} else { 
		...
		if(lista_producto_control.lista_productoActual.id_impuesto_compras!=null && lista_producto_control.lista_productoActual.id_impuesto_compras>-1){
			if(jQuery("#t-cel_"+i+"_48").val() != lista_producto_control.lista_productoActual.id_impuesto_compras) {
				jQuery("#t-cel_"+i+"_48").val(lista_producto_control.lista_productoActual.id_impuesto_compras).trigger("change");
			}
		} else { 
			//jQuery("#t-cel_"+i+"_48").select2("val", null);
			if(jQuery("#t-cel_"+i+"_48").val() != constantes.INT_VALOR_ESCOJA_OPCION) {
				jQuery("#t-cel_"+i+"_48").val(constantes.INT_VALOR_ESCOJA_OPCION).trigger("change");
			}
		}
		jQuery("#t-cel_"+i+"_49").val(lista_producto_control.lista_productoActual.impuesto1_en_ventas);
		jQuery("#t-cel_"+i+"_50").val(lista_producto_control.lista_productoActual.impuesto1_en_compras);
		jQuery("#t-cel_"+i+"_51").val(lista_producto_control.lista_productoActual.ultima_venta);
		...
		if(lista_producto_control.lista_productoActual.id_otro_impuesto!=null && lista_producto_control.lista_productoActual.id_otro_impuesto>-1){
			if(jQuery("#t-cel_"+i+"_52").val() != lista_producto_control.lista_productoActual.id_otro_impuesto) {
				jQuery("#t-cel_"+i+"_52").val(lista_producto_control.lista_productoActual.id_otro_impuesto).trigger("change");
			}
		} else { 
		...
		if(lista_producto_control.lista_productoActual.id_otro_impuesto_ventas!=null && lista_producto_control.lista_productoActual.id_otro_impuesto_ventas>-1){
			if(jQuery("#t-cel_"+i+"_53").val() != lista_producto_control.lista_productoActual.id_otro_impuesto_ventas) {
				jQuery("#t-cel_"+i+"_53").val(lista_producto_control.lista_productoActual.id_otro_impuesto_ventas).trigger("change");
			}
		} else { 
		...
		if(lista_producto_control.lista_productoActual.id_otro_impuesto_compras!=null && lista_producto_control.lista_productoActual.id_otro_impuesto_compras>-1){
			if(jQuery("#t-cel_"+i+"_54").val() != lista_producto_control.lista_productoActual.id_otro_impuesto_compras) {
				jQuery("#t-cel_"+i+"_54").val(lista_producto_control.lista_productoActual.id_otro_impuesto_compras).trigger("change");
			}
		} else { 
			//jQuery("#t-cel_"+i+"_54").select2("val", null);
			if(jQuery("#t-cel_"+i+"_54").val() != constantes.INT_VALOR_ESCOJA_OPCION) {
				jQuery("#t-cel_"+i+"_54").val(constantes.INT_VALOR_ESCOJA_OPCION).trigger("change");
			}
		}
		jQuery("#t-cel_"+i+"_55").val(lista_producto_control.lista_productoActual.otro_impuesto_ventas_codigo);
		jQuery("#t-cel_"+i+"_56").val(lista_producto_control.lista_productoActual.otro_impuesto_compras_codigo);
		jQuery("#t-cel_"+i+"_57").val(lista_producto_control.lista_productoActual.precio_de_compra_0);
		jQuery("#t-cel_"+i+"_58").val(lista_producto_control.lista_productoActual.precio_actualizado);
		jQuery("#t-cel_"+i+"_59").val(lista_producto_control.lista_productoActual.requiere_nro_serie);
		jQuery("#t-cel_"+i+"_60").val(lista_producto_control.lista_productoActual.costo_dolar);
		jQuery("#t-cel_"+i+"_61").val(lista_producto_control.lista_productoActual.comentario);
		jQuery("#t-cel_"+i+"_62").val(lista_producto_control.lista_productoActual.comenta_factura);
		...
		if(lista_producto_control.lista_productoActual.id_retencion!=null && lista_producto_control.lista_productoActual.id_retencion>-1){
			if(jQuery("#t-cel_"+i+"_63").val() != lista_producto_control.lista_productoActual.id_retencion) {
				jQuery("#t-cel_"+i+"_63").val(lista_producto_control.lista_productoActual.id_retencion).trigger("change");
			}
		} else { 
		...
		if(lista_producto_control.lista_productoActual.id_retencion_ventas!=null && lista_producto_control.lista_productoActual.id_retencion_ventas>-1){
			if(jQuery("#t-cel_"+i+"_64").val() != lista_producto_control.lista_productoActual.id_retencion_ventas) {
				jQuery("#t-cel_"+i+"_64").val(lista_producto_control.lista_productoActual.id_retencion_ventas).trigger("change");
			}
		} else { 
		...
		if(lista_producto_control.lista_productoActual.id_retencion_compras!=null && lista_producto_control.lista_productoActual.id_retencion_compras>-1){
			if(jQuery("#t-cel_"+i+"_65").val() != lista_producto_control.lista_productoActual.id_retencion_compras) {
				jQuery("#t-cel_"+i+"_65").val(lista_producto_control.lista_productoActual.id_retencion_compras).trigger("change");
			}
		} else { 
			//jQuery("#t-cel_"+i+"_65").select2("val", null);
			if(jQuery("#t-cel_"+i+"_65").val() != constantes.INT_VALOR_ESCOJA_OPCION) {
				jQuery("#t-cel_"+i+"_65").val(constantes.INT_VALOR_ESCOJA_OPCION).trigger("change");
			}
		}
		jQuery("#t-cel_"+i+"_66").val(lista_producto_control.lista_productoActual.retencion_ventas_codigo);
		jQuery("#t-cel_"+i+"_67").val(lista_producto_control.lista_productoActual.retencion_compras_codigo);
		jQuery("#t-cel_"+i+"_68").val(lista_producto_control.lista_productoActual.notas);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosproductosFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_3",lista_producto_control.productosFK);
		}
	...
	cargarCombosunidad_comprasFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_11",lista_producto_control.unidad_comprasFK);
		}
	...
	cargarCombosunidad_ventasFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_14",lista_producto_control.unidad_ventasFK);
		}
	...
	cargarComboscategoria_productosFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_19",lista_producto_control.categoria_productosFK);
		}
	...
	cargarCombossub_categoria_productosFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_20",lista_producto_control.sub_categoria_productosFK);
		}
	...
	cargarCombostipo_productosFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_31",lista_producto_control.tipo_productosFK);
		}
	...
	cargarCombosbodegasFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_33",lista_producto_control.bodegasFK);
		}
	...
	cargarComboscuenta_comprasFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_39",lista_producto_control.cuenta_comprasFK);
		}
	...
	cargarComboscuenta_ventasFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_40",lista_producto_control.cuenta_ventasFK);
		}
	...
	cargarComboscuenta_inventariosFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_41",lista_producto_control.cuenta_inventariosFK);
		}
	...
	cargarCombosotro_suplidorsFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_45",lista_producto_control.otro_suplidorsFK);
		}
	...
	cargarCombosimpuestosFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_46",lista_producto_control.impuestosFK);
		}
	...
	cargarCombosimpuesto_ventassFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_47",lista_producto_control.impuesto_ventassFK);
		}
	...
	cargarCombosimpuesto_comprassFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_48",lista_producto_control.impuesto_comprassFK);
		}
	...
	cargarCombosotro_impuestosFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_52",lista_producto_control.otro_impuestosFK);
		}
	...
	cargarCombosotro_impuesto_ventassFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_53",lista_producto_control.otro_impuesto_ventassFK);
		}
	...
	cargarCombosotro_impuesto_comprassFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_54",lista_producto_control.otro_impuesto_comprassFK);
		}
	...
	cargarCombosretencionsFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_63",lista_producto_control.retencionsFK);
		}
	...
	cargarCombosretencion_ventassFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_64",lista_producto_control.retencion_ventassFK);
		}
	...
	cargarCombosretencion_comprassFK(lista_producto_control) {
		...
		if(lista_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+lista_producto_control.idFilaTablaActual+"_65",lista_producto_control.retencion_comprassFK);
		}
