...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(imagen_devolucion_control) {
		...
		jQuery("#form"+imagen_devolucion_constante1.STR_SUFIJO+"-created_at").val(imagen_devolucion_control.imagen_devolucionActual.versionRow);
		jQuery("#form"+imagen_devolucion_constante1.STR_SUFIJO+"-updated_at").val(imagen_devolucion_control.imagen_devolucionActual.versionRow);
	...
	actualizarSpanMensajesCampos(imagen_devolucion_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(imagen_devolucion_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(imagen_devolucion_control.strMensajeupdated_at);		
