...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(orden_compra_control) {
		...
		jQuery("#form"+orden_compra_constante1.STR_SUFIJO+"-created_at").val(orden_compra_control.orden_compraActual.versionRow);
		jQuery("#form"+orden_compra_constante1.STR_SUFIJO+"-updated_at").val(orden_compra_control.orden_compraActual.versionRow);
	...
	actualizarSpanMensajesCampos(orden_compra_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(orden_compra_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(orden_compra_control.strMensajeupdated_at);		
