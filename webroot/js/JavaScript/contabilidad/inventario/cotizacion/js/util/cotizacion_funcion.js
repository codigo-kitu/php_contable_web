...
/*---------- Clic-Seleccionar ----------*/
	...
	seleccionarMostrarDivAccionesRelacionesActualOnComplete() { 
		funcionGeneral.seleccionarMostrarDivAccionesRelacionesActualOnComplete("cotizacion",this,cotizacion_constante1); 
	}
/*---------- Clic-Reporte ----------------*/
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(cotizacion_control.idmonedaDefaultForeignKey!=null && cotizacion_control.idmonedaDefaultForeignKey>-1) {
					idActual=cotizacion_control.idmonedaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					cotizacion_webcontrol1.cargarComboEditarTablamonedaFK(cotizacion_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						cotizacion_webcontrol1.cargarComboEditarTablamonedaFK(cotizacion_control,control_name,idActual,true);
					}
				});
