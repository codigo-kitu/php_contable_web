...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(cotizacion_control) {
		...
		jQuery("#form"+cotizacion_constante1.STR_SUFIJO+"-created_at").val(cotizacion_control.cotizacionActual.versionRow);
		jQuery("#form"+cotizacion_constante1.STR_SUFIJO+"-updated_at").val(cotizacion_control.cotizacionActual.versionRow);
	...
	actualizarSpanMensajesCampos(cotizacion_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(cotizacion_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(cotizacion_control.strMensajeupdated_at);		
