...
<script id="cotizacion_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist cotizacionsLocal)}}
			{{#each cotizacionsLocal}}
