...
<script id="precio_producto_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist precio_productosLocal)}}
			{{#each precio_productosLocal}}
