...
<script id="precio_producto_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarprecio_productosAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each precio_productosReporte}}

			<table id="tableprecio_producto{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy '% Desc' ../arrOrderBy ../bitParaReporteOrderBy) }}
