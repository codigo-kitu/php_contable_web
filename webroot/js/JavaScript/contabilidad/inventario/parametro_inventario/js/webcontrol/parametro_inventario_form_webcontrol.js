...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(parametro_inventario_control) {
		...
		jQuery("#form"+parametro_inventario_constante1.STR_SUFIJO+"-created_at").val(parametro_inventario_control.parametro_inventarioActual.versionRow);
		jQuery("#form"+parametro_inventario_constante1.STR_SUFIJO+"-updated_at").val(parametro_inventario_control.parametro_inventarioActual.versionRow);
	...
	actualizarSpanMensajesCampos(parametro_inventario_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(parametro_inventario_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(parametro_inventario_control.strMensajeupdated_at);		
