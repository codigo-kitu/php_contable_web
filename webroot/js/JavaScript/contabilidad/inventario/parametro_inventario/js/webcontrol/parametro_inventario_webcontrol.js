...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(parametro_inventario_control) {
		...
		if(parametro_inventario_control.parametro_inventarioActual.id_empresa!=null && parametro_inventario_control.parametro_inventarioActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != parametro_inventario_control.parametro_inventarioActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(parametro_inventario_control.parametro_inventarioActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(parametro_inventario_control.parametro_inventarioActual.id_termino_pago_proveedor!=null && parametro_inventario_control.parametro_inventarioActual.id_termino_pago_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != parametro_inventario_control.parametro_inventarioActual.id_termino_pago_proveedor) {
				jQuery("#t-cel_"+i+"_4").val(parametro_inventario_control.parametro_inventarioActual.id_termino_pago_proveedor).trigger("change");
			}
		} else { 
		...
		if(parametro_inventario_control.parametro_inventarioActual.id_tipo_costeo_kardex!=null && parametro_inventario_control.parametro_inventarioActual.id_tipo_costeo_kardex>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != parametro_inventario_control.parametro_inventarioActual.id_tipo_costeo_kardex) {
				jQuery("#t-cel_"+i+"_5").val(parametro_inventario_control.parametro_inventarioActual.id_tipo_costeo_kardex).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(parametro_inventario_control.parametro_inventarioActual.numero_producto);
		jQuery("#t-cel_"+i+"_8").val(parametro_inventario_control.parametro_inventarioActual.numero_orden_compra);
		jQuery("#t-cel_"+i+"_9").val(parametro_inventario_control.parametro_inventarioActual.numero_devolucion);
		jQuery("#t-cel_"+i+"_10").val(parametro_inventario_control.parametro_inventarioActual.numero_cotizacion);
		jQuery("#t-cel_"+i+"_11").val(parametro_inventario_control.parametro_inventarioActual.numero_kardex);
		jQuery("#t-cel_"+i+"_12").prop('checked',parametro_inventario_control.parametro_inventarioActual.con_producto_inactivo);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(parametro_inventario_control) {
		...
		if(parametro_inventario_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+parametro_inventario_control.idFilaTablaActual+"_3",parametro_inventario_control.empresasFK);
		}
	};
	...
	cargarCombostermino_pago_proveedorsFK(parametro_inventario_control) {
		...
		if(parametro_inventario_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+parametro_inventario_control.idFilaTablaActual+"_4",parametro_inventario_control.termino_pago_proveedorsFK);
		}
	...
	cargarCombostipo_costeo_kardexsFK(parametro_inventario_control) {
		...
		if(parametro_inventario_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+parametro_inventario_control.idFilaTablaActual+"_5",parametro_inventario_control.tipo_costeo_kardexsFK);
		}
