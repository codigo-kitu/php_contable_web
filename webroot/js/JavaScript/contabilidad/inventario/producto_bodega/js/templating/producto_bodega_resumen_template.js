...
<script id="producto_bodega_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarproducto_bodegasAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each producto_bodegasReporte}}

			<table id="tableproducto_bodega{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
