...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(producto_bodega_control) {
		...
		if(producto_bodega_control.producto_bodegaActual.id_bodega!=null && producto_bodega_control.producto_bodegaActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != producto_bodega_control.producto_bodegaActual.id_bodega) {
				jQuery("#t-cel_"+i+"_3").val(producto_bodega_control.producto_bodegaActual.id_bodega).trigger("change");
			}
		} else { 
		...
		if(producto_bodega_control.producto_bodegaActual.id_producto!=null && producto_bodega_control.producto_bodegaActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != producto_bodega_control.producto_bodegaActual.id_producto) {
				jQuery("#t-cel_"+i+"_4").val(producto_bodega_control.producto_bodegaActual.id_producto).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(producto_bodega_control.producto_bodegaActual.cantidad);
		jQuery("#t-cel_"+i+"_6").val(producto_bodega_control.producto_bodegaActual.costo);
		jQuery("#t-cel_"+i+"_7").val(producto_bodega_control.producto_bodegaActual.ubicacion);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosbodegasFK(producto_bodega_control) {
		...
		if(producto_bodega_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+producto_bodega_control.idFilaTablaActual+"_3",producto_bodega_control.bodegasFK);
		}
	...
	cargarCombosproductosFK(producto_bodega_control) {
		...
		if(producto_bodega_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+producto_bodega_control.idFilaTablaActual+"_4",producto_bodega_control.productosFK);
		}
