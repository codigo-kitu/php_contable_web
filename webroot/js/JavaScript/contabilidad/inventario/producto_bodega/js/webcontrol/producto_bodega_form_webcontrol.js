...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(producto_bodega_control) {
		...
		jQuery("#form"+producto_bodega_constante1.STR_SUFIJO+"-created_at").val(producto_bodega_control.producto_bodegaActual.versionRow);
		jQuery("#form"+producto_bodega_constante1.STR_SUFIJO+"-updated_at").val(producto_bodega_control.producto_bodegaActual.versionRow);
	...
	actualizarSpanMensajesCampos(producto_bodega_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(producto_bodega_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(producto_bodega_control.strMensajeupdated_at);		
