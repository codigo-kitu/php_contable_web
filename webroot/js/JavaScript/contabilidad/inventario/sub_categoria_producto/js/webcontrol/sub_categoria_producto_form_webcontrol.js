...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(sub_categoria_producto_control) {
		...
		jQuery("#form"+sub_categoria_producto_constante1.STR_SUFIJO+"-created_at").val(sub_categoria_producto_control.sub_categoria_productoActual.versionRow);
		jQuery("#form"+sub_categoria_producto_constante1.STR_SUFIJO+"-updated_at").val(sub_categoria_producto_control.sub_categoria_productoActual.versionRow);
	...
	actualizarSpanMensajesCampos(sub_categoria_producto_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(sub_categoria_producto_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(sub_categoria_producto_control.strMensajeupdated_at);		
