...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(sub_categoria_producto_control) {
		...
		if(sub_categoria_producto_control.sub_categoria_productoActual.id_empresa!=null && sub_categoria_producto_control.sub_categoria_productoActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != sub_categoria_producto_control.sub_categoria_productoActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(sub_categoria_producto_control.sub_categoria_productoActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(sub_categoria_producto_control.sub_categoria_productoActual.id_categoria_producto!=null && sub_categoria_producto_control.sub_categoria_productoActual.id_categoria_producto>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != sub_categoria_producto_control.sub_categoria_productoActual.id_categoria_producto) {
				jQuery("#t-cel_"+i+"_4").val(sub_categoria_producto_control.sub_categoria_productoActual.id_categoria_producto).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(sub_categoria_producto_control.sub_categoria_productoActual.codigo);
		jQuery("#t-cel_"+i+"_6").val(sub_categoria_producto_control.sub_categoria_productoActual.nombre);
		jQuery("#t-cel_"+i+"_7").prop('checked',sub_categoria_producto_control.sub_categoria_productoActual.predeterminado);
		jQuery("#t-cel_"+i+"_8").val(sub_categoria_producto_control.sub_categoria_productoActual.imagen);
		jQuery("#t-cel_"+i+"_9").val(sub_categoria_producto_control.sub_categoria_productoActual.numero_productos);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(sub_categoria_producto_control) {
		...
		if(sub_categoria_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+sub_categoria_producto_control.idFilaTablaActual+"_3",sub_categoria_producto_control.empresasFK);
		}
	};
	...
	cargarComboscategoria_productosFK(sub_categoria_producto_control) {
		...
		if(sub_categoria_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+sub_categoria_producto_control.idFilaTablaActual+"_4",sub_categoria_producto_control.categoria_productosFK);
		}
