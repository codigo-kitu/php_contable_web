...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(producto_control) {
		...
		if(producto_control.productoActual.id_empresa!=null && producto_control.productoActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != producto_control.productoActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(producto_control.productoActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(producto_control.productoActual.id_proveedor!=null && producto_control.productoActual.id_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != producto_control.productoActual.id_proveedor) {
				jQuery("#t-cel_"+i+"_4").val(producto_control.productoActual.id_proveedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(producto_control.productoActual.codigo);
		jQuery("#t-cel_"+i+"_6").val(producto_control.productoActual.nombre);
		jQuery("#t-cel_"+i+"_7").val(producto_control.productoActual.costo);
		jQuery("#t-cel_"+i+"_8").prop('checked',producto_control.productoActual.activo);
		
		if(producto_control.productoActual.id_tipo_producto!=null && producto_control.productoActual.id_tipo_producto>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != producto_control.productoActual.id_tipo_producto) {
				jQuery("#t-cel_"+i+"_9").val(producto_control.productoActual.id_tipo_producto).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_10").val(producto_control.productoActual.cantidad_inicial);
		
		if(producto_control.productoActual.id_impuesto!=null && producto_control.productoActual.id_impuesto>-1){
			if(jQuery("#t-cel_"+i+"_11").val() != producto_control.productoActual.id_impuesto) {
				jQuery("#t-cel_"+i+"_11").val(producto_control.productoActual.id_impuesto).trigger("change");
			}
		} else { 
		...
		if(producto_control.productoActual.id_otro_impuesto!=null && producto_control.productoActual.id_otro_impuesto>-1){
			if(jQuery("#t-cel_"+i+"_12").val() != producto_control.productoActual.id_otro_impuesto) {
				jQuery("#t-cel_"+i+"_12").val(producto_control.productoActual.id_otro_impuesto).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_13").prop('checked',producto_control.productoActual.impuesto_ventas);
		jQuery("#t-cel_"+i+"_14").prop('checked',producto_control.productoActual.otro_impuesto_ventas);
		jQuery("#t-cel_"+i+"_15").prop('checked',producto_control.productoActual.impuesto_compras);
		jQuery("#t-cel_"+i+"_16").prop('checked',producto_control.productoActual.otro_impuesto_compras);
		
		if(producto_control.productoActual.id_categoria_producto!=null && producto_control.productoActual.id_categoria_producto>-1){
			if(jQuery("#t-cel_"+i+"_17").val() != producto_control.productoActual.id_categoria_producto) {
				jQuery("#t-cel_"+i+"_17").val(producto_control.productoActual.id_categoria_producto).trigger("change");
			}
		} else { 
		...
		if(producto_control.productoActual.id_sub_categoria_producto!=null && producto_control.productoActual.id_sub_categoria_producto>-1){
			if(jQuery("#t-cel_"+i+"_18").val() != producto_control.productoActual.id_sub_categoria_producto) {
				jQuery("#t-cel_"+i+"_18").val(producto_control.productoActual.id_sub_categoria_producto).trigger("change");
			}
		} else { 
		...
		if(producto_control.productoActual.id_bodega_defecto!=null && producto_control.productoActual.id_bodega_defecto>-1){
			if(jQuery("#t-cel_"+i+"_19").val() != producto_control.productoActual.id_bodega_defecto) {
				jQuery("#t-cel_"+i+"_19").val(producto_control.productoActual.id_bodega_defecto).trigger("change");
			}
		} else { 
		...
		if(producto_control.productoActual.id_unidad_compra!=null && producto_control.productoActual.id_unidad_compra>-1){
			if(jQuery("#t-cel_"+i+"_20").val() != producto_control.productoActual.id_unidad_compra) {
				jQuery("#t-cel_"+i+"_20").val(producto_control.productoActual.id_unidad_compra).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_21").val(producto_control.productoActual.equivalencia_compra);
		
		if(producto_control.productoActual.id_unidad_venta!=null && producto_control.productoActual.id_unidad_venta>-1){
			if(jQuery("#t-cel_"+i+"_22").val() != producto_control.productoActual.id_unidad_venta) {
				jQuery("#t-cel_"+i+"_22").val(producto_control.productoActual.id_unidad_venta).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_23").val(producto_control.productoActual.equivalencia_venta);
		jQuery("#t-cel_"+i+"_24").val(producto_control.productoActual.descripcion);
		jQuery("#t-cel_"+i+"_25").val(producto_control.productoActual.imagen);
		jQuery("#t-cel_"+i+"_26").val(producto_control.productoActual.observacion);
		jQuery("#t-cel_"+i+"_27").prop('checked',producto_control.productoActual.comenta_factura);
		jQuery("#t-cel_"+i+"_28").val(producto_control.productoActual.codigo_fabricante);
		jQuery("#t-cel_"+i+"_29").val(producto_control.productoActual.cantidad);
		jQuery("#t-cel_"+i+"_30").val(producto_control.productoActual.cantidad_minima);
		jQuery("#t-cel_"+i+"_31").val(producto_control.productoActual.cantidad_maxima);
		jQuery("#t-cel_"+i+"_32").prop('checked',producto_control.productoActual.factura_sin_stock);
		jQuery("#t-cel_"+i+"_33").prop('checked',producto_control.productoActual.mostrar_componente);
		jQuery("#t-cel_"+i+"_34").prop('checked',producto_control.productoActual.producto_equivalente);
		jQuery("#t-cel_"+i+"_35").prop('checked',producto_control.productoActual.avisa_expiracion);
		jQuery("#t-cel_"+i+"_36").prop('checked',producto_control.productoActual.requiere_serie);
		jQuery("#t-cel_"+i+"_37").prop('checked',producto_control.productoActual.acepta_lote);
		
		if(producto_control.productoActual.id_cuenta_venta!=null && producto_control.productoActual.id_cuenta_venta>-1){
			if(jQuery("#t-cel_"+i+"_38").val() != producto_control.productoActual.id_cuenta_venta) {
				jQuery("#t-cel_"+i+"_38").val(producto_control.productoActual.id_cuenta_venta).trigger("change");
			}
		} else { 
		...
		if(producto_control.productoActual.id_cuenta_compra!=null && producto_control.productoActual.id_cuenta_compra>-1){
			if(jQuery("#t-cel_"+i+"_39").val() != producto_control.productoActual.id_cuenta_compra) {
				jQuery("#t-cel_"+i+"_39").val(producto_control.productoActual.id_cuenta_compra).trigger("change");
			}
		} else { 
		...
		if(producto_control.productoActual.id_cuenta_costo!=null && producto_control.productoActual.id_cuenta_costo>-1){
			if(jQuery("#t-cel_"+i+"_40").val() != producto_control.productoActual.id_cuenta_costo) {
				jQuery("#t-cel_"+i+"_40").val(producto_control.productoActual.id_cuenta_costo).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_41").val(producto_control.productoActual.valor_inventario);
		jQuery("#t-cel_"+i+"_42").val(producto_control.productoActual.producto_fisico);
		jQuery("#t-cel_"+i+"_43").val(producto_control.productoActual.ultima_venta);
		jQuery("#t-cel_"+i+"_44").val(producto_control.productoActual.precio_actualizado);
		
		if(producto_control.productoActual.id_retencion!=null && producto_control.productoActual.id_retencion>-1){
			if(jQuery("#t-cel_"+i+"_45").val() != producto_control.productoActual.id_retencion) {
				jQuery("#t-cel_"+i+"_45").val(producto_control.productoActual.id_retencion).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_46").prop('checked',producto_control.productoActual.retencion_ventas);
		jQuery("#t-cel_"+i+"_47").prop('checked',producto_control.productoActual.retencion_compras);
		jQuery("#t-cel_"+i+"_48").val(producto_control.productoActual.factura_con_precio);
	}
