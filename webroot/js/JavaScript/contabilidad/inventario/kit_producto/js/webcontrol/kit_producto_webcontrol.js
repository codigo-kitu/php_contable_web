...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(kit_producto_control) {
		...
		jQuery("#t-version_row_"+i+"").val(kit_producto_control.kit_productoActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(kit_producto_control.kit_productoActual.id_padre);
		jQuery("#t-cel_"+i+"_4").val(kit_producto_control.kit_productoActual.id_hijo);
		jQuery("#t-cel_"+i+"_5").val(kit_producto_control.kit_productoActual.cantidad);
	}
