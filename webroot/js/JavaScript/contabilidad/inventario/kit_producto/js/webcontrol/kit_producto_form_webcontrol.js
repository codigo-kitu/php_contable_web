...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(kit_producto_control) {
		...
		jQuery("#form"+kit_producto_constante1.STR_SUFIJO+"-created_at").val(kit_producto_control.kit_productoActual.versionRow);
		jQuery("#form"+kit_producto_constante1.STR_SUFIJO+"-updated_at").val(kit_producto_control.kit_productoActual.versionRow);
	...
	actualizarSpanMensajesCampos(kit_producto_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(kit_producto_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(kit_producto_control.strMensajeupdated_at);		
