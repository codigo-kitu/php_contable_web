...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(grupo_opcion_control) {
		...
		if(grupo_opcion_control.grupo_opcionActual.id_modulo!=null && grupo_opcion_control.grupo_opcionActual.id_modulo>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != grupo_opcion_control.grupo_opcionActual.id_modulo) {
				jQuery("#t-cel_"+i+"_3").val(grupo_opcion_control.grupo_opcionActual.id_modulo).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(grupo_opcion_control.grupo_opcionActual.codigo);
		jQuery("#t-cel_"+i+"_5").val(grupo_opcion_control.grupo_opcionActual.nombre_principal);
		jQuery("#t-cel_"+i+"_6").val(grupo_opcion_control.grupo_opcionActual.orden);
		jQuery("#t-cel_"+i+"_7").prop('checked',grupo_opcion_control.grupo_opcionActual.estado);
	}
