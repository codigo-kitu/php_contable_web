...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(perfil_control) {
		...
		jQuery("#form"+perfil_constante1.STR_SUFIJO+"-created_at").val(perfil_control.perfilActual.versionRow);
		jQuery("#form"+perfil_constante1.STR_SUFIJO+"-updated_at").val(perfil_control.perfilActual.versionRow);
	...
	actualizarSpanMensajesCampos(perfil_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(perfil_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(perfil_control.strMensajeupdated_at);		
