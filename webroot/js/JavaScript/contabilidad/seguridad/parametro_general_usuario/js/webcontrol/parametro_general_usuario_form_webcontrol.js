...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(parametro_general_usuario_control) {
		...
		jQuery("#form"+parametro_general_usuario_constante1.STR_SUFIJO+"-created_at").val(parametro_general_usuario_control.parametro_general_usuarioActual.versionRow);
		jQuery("#form"+parametro_general_usuario_constante1.STR_SUFIJO+"-updated_at").val(parametro_general_usuario_control.parametro_general_usuarioActual.versionRow);
	...
	actualizarSpanMensajesCampos(parametro_general_usuario_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(parametro_general_usuario_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(parametro_general_usuario_control.strMensajeupdated_at);		
