...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(dato_general_usuario_control) {
		...
		jQuery("#form"+dato_general_usuario_constante1.STR_SUFIJO+"-created_at").val(dato_general_usuario_control.dato_general_usuarioActual.versionRow);
		jQuery("#form"+dato_general_usuario_constante1.STR_SUFIJO+"-updated_at").val(dato_general_usuario_control.dato_general_usuarioActual.versionRow);
	...
	actualizarSpanMensajesCampos(dato_general_usuario_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(dato_general_usuario_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(dato_general_usuario_control.strMensajeupdated_at);		
