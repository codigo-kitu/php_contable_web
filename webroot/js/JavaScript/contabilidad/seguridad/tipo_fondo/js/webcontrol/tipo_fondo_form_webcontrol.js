...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(tipo_fondo_control) {
		...
		jQuery("#form"+tipo_fondo_constante1.STR_SUFIJO+"-created_at").val(tipo_fondo_control.tipo_fondoActual.versionRow);
		jQuery("#form"+tipo_fondo_constante1.STR_SUFIJO+"-updated_at").val(tipo_fondo_control.tipo_fondoActual.versionRow);
	...
	actualizarSpanMensajesCampos(tipo_fondo_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(tipo_fondo_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(tipo_fondo_control.strMensajeupdated_at);		
