...
<script id="accion_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliaraccionsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each accionsReporte}}

			<table id="tableaccion{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
