...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(historial_cambio_clave_control) {
		...
		if(historial_cambio_clave_control.historial_cambio_claveActual.id_usuario!=null && historial_cambio_clave_control.historial_cambio_claveActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != historial_cambio_clave_control.historial_cambio_claveActual.id_usuario) {
				jQuery("#t-cel_"+i+"_3").val(historial_cambio_clave_control.historial_cambio_claveActual.id_usuario).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(historial_cambio_clave_control.historial_cambio_claveActual.nombre);
		jQuery("#t-cel_"+i+"_5").val(historial_cambio_clave_control.historial_cambio_claveActual.fecha_hora);
		jQuery("#t-cel_"+i+"_6").val(historial_cambio_clave_control.historial_cambio_claveActual.observacion);
	}
