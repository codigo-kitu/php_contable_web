...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(auditoria_detalle_control) {
		...
		jQuery("#form"+auditoria_detalle_constante1.STR_SUFIJO+"-created_at").val(auditoria_detalle_control.auditoria_detalleActual.versionRow);
		jQuery("#form"+auditoria_detalle_constante1.STR_SUFIJO+"-updated_at").val(auditoria_detalle_control.auditoria_detalleActual.versionRow);
	...
	actualizarSpanMensajesCampos(auditoria_detalle_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(auditoria_detalle_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(auditoria_detalle_control.strMensajeupdated_at);		
