...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(sistema_control) {
		...
		jQuery("#form"+sistema_constante1.STR_SUFIJO+"-created_at").val(sistema_control.sistemaActual.versionRow);
		jQuery("#form"+sistema_constante1.STR_SUFIJO+"-updated_at").val(sistema_control.sistemaActual.versionRow);
	...
	actualizarSpanMensajesCampos(sistema_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(sistema_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(sistema_control.strMensajeupdated_at);		
