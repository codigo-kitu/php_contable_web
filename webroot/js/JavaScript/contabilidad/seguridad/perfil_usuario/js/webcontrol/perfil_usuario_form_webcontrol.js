...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(perfil_usuario_control) {
		...
		jQuery("#form"+perfil_usuario_constante1.STR_SUFIJO+"-created_at").val(perfil_usuario_control.perfil_usuarioActual.versionRow);
		jQuery("#form"+perfil_usuario_constante1.STR_SUFIJO+"-updated_at").val(perfil_usuario_control.perfil_usuarioActual.versionRow);
	...
	actualizarSpanMensajesCampos(perfil_usuario_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(perfil_usuario_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(perfil_usuario_control.strMensajeupdated_at);		
