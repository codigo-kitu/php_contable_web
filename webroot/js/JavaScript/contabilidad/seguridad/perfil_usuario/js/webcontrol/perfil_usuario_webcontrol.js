...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(perfil_usuario_control) {
		...
		if(perfil_usuario_control.perfil_usuarioActual.id_perfil!=null && perfil_usuario_control.perfil_usuarioActual.id_perfil>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != perfil_usuario_control.perfil_usuarioActual.id_perfil) {
				jQuery("#t-cel_"+i+"_3").val(perfil_usuario_control.perfil_usuarioActual.id_perfil).trigger("change");
			}
		} else { 
		...
		if(perfil_usuario_control.perfil_usuarioActual.id_usuario!=null && perfil_usuario_control.perfil_usuarioActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != perfil_usuario_control.perfil_usuarioActual.id_usuario) {
				jQuery("#t-cel_"+i+"_4").val(perfil_usuario_control.perfil_usuarioActual.id_usuario).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").prop('checked',perfil_usuario_control.perfil_usuarioActual.estado);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosperfilsFK(perfil_usuario_control) {
		...
		if(perfil_usuario_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+perfil_usuario_control.idFilaTablaActual+"_3",perfil_usuario_control.perfilsFK);
		}
	...
	cargarCombosusuariosFK(perfil_usuario_control) {
		...
		if(perfil_usuario_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+perfil_usuario_control.idFilaTablaActual+"_4",perfil_usuario_control.usuariosFK);
		}
	};
