...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(auditoria_control) {
		...
		if(auditoria_control.auditoriaActual.id_usuario!=null && auditoria_control.auditoriaActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != auditoria_control.auditoriaActual.id_usuario) {
				jQuery("#t-cel_"+i+"_3").val(auditoria_control.auditoriaActual.id_usuario).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(auditoria_control.auditoriaActual.nombre_tabla);
		jQuery("#t-cel_"+i+"_5").val(auditoria_control.auditoriaActual.id_fila);
		jQuery("#t-cel_"+i+"_6").val(auditoria_control.auditoriaActual.accion);
		jQuery("#t-cel_"+i+"_7").val(auditoria_control.auditoriaActual.proceso);
		jQuery("#t-cel_"+i+"_8").val(auditoria_control.auditoriaActual.nombre_pc);
		jQuery("#t-cel_"+i+"_9").val(auditoria_control.auditoriaActual.ip_pc);
		jQuery("#t-cel_"+i+"_10").val(auditoria_control.auditoriaActual.usuario_pc);
		jQuery("#t-cel_"+i+"_11").val(auditoria_control.auditoriaActual.fecha_hora);
		jQuery("#t-cel_"+i+"_12").val(auditoria_control.auditoriaActual.observacion);
	}
