...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(parametro_general_sg_control) {
		...
		jQuery("#t-version_row_"+i+"").val(parametro_general_sg_control.parametro_general_sgActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(parametro_general_sg_control.parametro_general_sgActual.nombre_sistema);
		jQuery("#t-cel_"+i+"_4").val(parametro_general_sg_control.parametro_general_sgActual.nombre_simple_sistema);
		jQuery("#t-cel_"+i+"_5").val(parametro_general_sg_control.parametro_general_sgActual.nombre_empresa);
		jQuery("#t-cel_"+i+"_6").val(parametro_general_sg_control.parametro_general_sgActual.version_sistema);
		jQuery("#t-cel_"+i+"_7").val(parametro_general_sg_control.parametro_general_sgActual.siglas_sistema);
		jQuery("#t-cel_"+i+"_8").val(parametro_general_sg_control.parametro_general_sgActual.mail_sistema);
		jQuery("#t-cel_"+i+"_9").val(parametro_general_sg_control.parametro_general_sgActual.telefono_sistema);
		jQuery("#t-cel_"+i+"_10").val(parametro_general_sg_control.parametro_general_sgActual.fax_sistema);
		jQuery("#t-cel_"+i+"_11").val(parametro_general_sg_control.parametro_general_sgActual.representante_nombre);
		jQuery("#t-cel_"+i+"_12").val(parametro_general_sg_control.parametro_general_sgActual.codigo_proceso_actualizacion);
		jQuery("#t-cel_"+i+"_13").prop('checked',parametro_general_sg_control.parametro_general_sgActual.esta_activo);
	}
