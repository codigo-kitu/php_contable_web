...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(perfil_opcion_control) {
		...
		if(perfil_opcion_control.perfil_opcionActual.id_perfil!=null && perfil_opcion_control.perfil_opcionActual.id_perfil>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != perfil_opcion_control.perfil_opcionActual.id_perfil) {
				jQuery("#t-cel_"+i+"_3").val(perfil_opcion_control.perfil_opcionActual.id_perfil).trigger("change");
			}
		} else { 
		...
		if(perfil_opcion_control.perfil_opcionActual.id_opcion!=null && perfil_opcion_control.perfil_opcionActual.id_opcion>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != perfil_opcion_control.perfil_opcionActual.id_opcion) {
				jQuery("#t-cel_"+i+"_4").val(perfil_opcion_control.perfil_opcionActual.id_opcion).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").prop('checked',perfil_opcion_control.perfil_opcionActual.todo);
		jQuery("#t-cel_"+i+"_6").prop('checked',perfil_opcion_control.perfil_opcionActual.ingreso);
		jQuery("#t-cel_"+i+"_7").prop('checked',perfil_opcion_control.perfil_opcionActual.modificacion);
		jQuery("#t-cel_"+i+"_8").prop('checked',perfil_opcion_control.perfil_opcionActual.eliminacion);
		jQuery("#t-cel_"+i+"_9").prop('checked',perfil_opcion_control.perfil_opcionActual.consulta);
		jQuery("#t-cel_"+i+"_10").prop('checked',perfil_opcion_control.perfil_opcionActual.busqueda);
		jQuery("#t-cel_"+i+"_11").prop('checked',perfil_opcion_control.perfil_opcionActual.reporte);
		jQuery("#t-cel_"+i+"_12").prop('checked',perfil_opcion_control.perfil_opcionActual.estado);
	}
