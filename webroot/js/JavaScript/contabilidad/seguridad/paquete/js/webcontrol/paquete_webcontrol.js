...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(paquete_control) {
		...
		if(paquete_control.paqueteActual.id_sistema!=null && paquete_control.paqueteActual.id_sistema>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != paquete_control.paqueteActual.id_sistema) {
				jQuery("#t-cel_"+i+"_3").val(paquete_control.paqueteActual.id_sistema).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(paquete_control.paqueteActual.nombre);
		jQuery("#t-cel_"+i+"_5").val(paquete_control.paqueteActual.descripcion);
	}
