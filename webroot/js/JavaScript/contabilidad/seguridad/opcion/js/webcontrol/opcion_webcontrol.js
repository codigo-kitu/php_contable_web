...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(opcion_control) {
		...
		if(opcion_control.opcionActual.id_sistema!=null && opcion_control.opcionActual.id_sistema>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != opcion_control.opcionActual.id_sistema) {
				jQuery("#t-cel_"+i+"_3").val(opcion_control.opcionActual.id_sistema).trigger("change");
			}
		} else { 
		...
		if(opcion_control.opcionActual.id_opcion!=null && opcion_control.opcionActual.id_opcion>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != opcion_control.opcionActual.id_opcion) {
				jQuery("#t-cel_"+i+"_4").val(opcion_control.opcionActual.id_opcion).trigger("change");
			}
		} else { 
		...
		if(opcion_control.opcionActual.id_grupo_opcion!=null && opcion_control.opcionActual.id_grupo_opcion>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != opcion_control.opcionActual.id_grupo_opcion) {
				jQuery("#t-cel_"+i+"_5").val(opcion_control.opcionActual.id_grupo_opcion).trigger("change");
			}
		} else { 
		...
		if(opcion_control.opcionActual.id_modulo!=null && opcion_control.opcionActual.id_modulo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != opcion_control.opcionActual.id_modulo) {
				jQuery("#t-cel_"+i+"_6").val(opcion_control.opcionActual.id_modulo).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(opcion_control.opcionActual.codigo);
		jQuery("#t-cel_"+i+"_8").val(opcion_control.opcionActual.nombre);
		jQuery("#t-cel_"+i+"_9").val(opcion_control.opcionActual.posicion);
		jQuery("#t-cel_"+i+"_10").val(opcion_control.opcionActual.icon_name);
		jQuery("#t-cel_"+i+"_11").val(opcion_control.opcionActual.nombre_clase);
		jQuery("#t-cel_"+i+"_12").val(opcion_control.opcionActual.modulo0);
		jQuery("#t-cel_"+i+"_13").val(opcion_control.opcionActual.sub_modulo);
		jQuery("#t-cel_"+i+"_14").val(opcion_control.opcionActual.paquete);
		jQuery("#t-cel_"+i+"_15").prop('checked',opcion_control.opcionActual.es_para_menu);
		jQuery("#t-cel_"+i+"_16").prop('checked',opcion_control.opcionActual.es_guardar_relaciones);
		jQuery("#t-cel_"+i+"_17").prop('checked',opcion_control.opcionActual.con_mostrar_acciones_campo);
		jQuery("#t-cel_"+i+"_18").prop('checked',opcion_control.opcionActual.estado);
	}
