...
<script id="modulo_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarmodulosAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each modulosReporte}}

			<table id="tablemodulo{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								...
								<td>{{trim id_paquete_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
			...
			{{#if (existeCadenaArrayOrderBy 'Tipo Tecla Mascara' ../arrOrderBy ../bitParaReporteOrderBy) }}
				...
				<tr>
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								<td width="20%" {{../strAuxStyleBackgroundContenidoCabecera}} >
									<b>- Tipo Tecla Mascara</b>
								</td>
								<td>{{trim id_tipo_tecla_mascara_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
			...
			{{#if (existeCadenaArrayOrderBy 'Tecla' ../arrOrderBy ../bitParaReporteOrderBy) }}
