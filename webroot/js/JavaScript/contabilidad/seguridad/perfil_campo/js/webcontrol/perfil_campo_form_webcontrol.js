...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(perfil_campo_control) {
		...
		jQuery("#form"+perfil_campo_constante1.STR_SUFIJO+"-created_at").val(perfil_campo_control.perfil_campoActual.versionRow);
		jQuery("#form"+perfil_campo_constante1.STR_SUFIJO+"-updated_at").val(perfil_campo_control.perfil_campoActual.versionRow);
	...
	actualizarSpanMensajesCampos(perfil_campo_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(perfil_campo_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(perfil_campo_control.strMensajeupdated_at);		
