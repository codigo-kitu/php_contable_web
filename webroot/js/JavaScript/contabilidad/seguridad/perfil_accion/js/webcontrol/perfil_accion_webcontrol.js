...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(perfil_accion_control) {
		...
		if(perfil_accion_control.perfil_accionActual.id_perfil!=null && perfil_accion_control.perfil_accionActual.id_perfil>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != perfil_accion_control.perfil_accionActual.id_perfil) {
				jQuery("#t-cel_"+i+"_3").val(perfil_accion_control.perfil_accionActual.id_perfil).trigger("change");
			}
		} else { 
		...
		if(perfil_accion_control.perfil_accionActual.id_accion!=null && perfil_accion_control.perfil_accionActual.id_accion>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != perfil_accion_control.perfil_accionActual.id_accion) {
				jQuery("#t-cel_"+i+"_4").val(perfil_accion_control.perfil_accionActual.id_accion).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").prop('checked',perfil_accion_control.perfil_accionActual.ejecusion);
		jQuery("#t-cel_"+i+"_6").prop('checked',perfil_accion_control.perfil_accionActual.estado);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosperfilsFK(perfil_accion_control) {
		...
		if(perfil_accion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+perfil_accion_control.idFilaTablaActual+"_3",perfil_accion_control.perfilsFK);
		}
	...
	cargarCombosaccionsFK(perfil_accion_control) {
		...
		if(perfil_accion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+perfil_accion_control.idFilaTablaActual+"_4",perfil_accion_control.accionsFK);
		}
