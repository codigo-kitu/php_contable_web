...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(perfil_accion_control) {
		...
		jQuery("#form"+perfil_accion_constante1.STR_SUFIJO+"-created_at").val(perfil_accion_control.perfil_accionActual.versionRow);
		jQuery("#form"+perfil_accion_constante1.STR_SUFIJO+"-updated_at").val(perfil_accion_control.perfil_accionActual.versionRow);
	...
	actualizarSpanMensajesCampos(perfil_accion_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(perfil_accion_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(perfil_accion_control.strMensajeupdated_at);		
