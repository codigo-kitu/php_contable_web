...
//Funciones Manejadores Accion
	...
	actualizarCamposFormulario(tipo_tecla_mascara_control) {
		...
		jQuery("#form"+tipo_tecla_mascara_constante1.STR_SUFIJO+"-created_at").val(tipo_tecla_mascara_control.tipo_tecla_mascaraActual.versionRow);
		jQuery("#form"+tipo_tecla_mascara_constante1.STR_SUFIJO+"-updated_at").val(tipo_tecla_mascara_control.tipo_tecla_mascaraActual.versionRow);
	...
	actualizarSpanMensajesCampos(tipo_tecla_mascara_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(tipo_tecla_mascara_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(tipo_tecla_mascara_control.strMensajeupdated_at);		
