...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(tipo_tecla_mascara_control) {
		...
		jQuery("#t-version_row_"+i+"").val(tipo_tecla_mascara_control.tipo_tecla_mascaraActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(tipo_tecla_mascara_control.tipo_tecla_mascaraActual.codigo);
		jQuery("#t-cel_"+i+"_4").val(tipo_tecla_mascara_control.tipo_tecla_mascaraActual.nombre);
	}
