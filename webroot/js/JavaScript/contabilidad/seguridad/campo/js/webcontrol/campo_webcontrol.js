...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(campo_control) {
		...
		if(campo_control.campoActual.id_opcion!=null && campo_control.campoActual.id_opcion>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != campo_control.campoActual.id_opcion) {
				jQuery("#t-cel_"+i+"_3").val(campo_control.campoActual.id_opcion).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(campo_control.campoActual.codigo);
		jQuery("#t-cel_"+i+"_5").val(campo_control.campoActual.nombre);
		jQuery("#t-cel_"+i+"_6").val(campo_control.campoActual.descripcion);
		jQuery("#t-cel_"+i+"_7").prop('checked',campo_control.campoActual.estado);
	}
