...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(imagen_estimado_control) {
		...
		if(imagen_estimado_control.imagen_estimadoActual.id_estimado!=null && imagen_estimado_control.imagen_estimadoActual.id_estimado>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != imagen_estimado_control.imagen_estimadoActual.id_estimado) {
				jQuery("#t-cel_"+i+"_3").val(imagen_estimado_control.imagen_estimadoActual.id_estimado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(imagen_estimado_control.imagen_estimadoActual.imagen);
	}
