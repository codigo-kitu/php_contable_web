...
<script id="consignacion_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarconsignacionsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each consignacionsReporte}}

			<table id="tableconsignacion{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
