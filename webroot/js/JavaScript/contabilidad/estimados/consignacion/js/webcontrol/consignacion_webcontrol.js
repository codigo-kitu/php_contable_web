...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(consignacion_control) {
		...
		if(consignacion_control.consignacionActual.id_empresa!=null && consignacion_control.consignacionActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != consignacion_control.consignacionActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(consignacion_control.consignacionActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(consignacion_control.consignacionActual.id_sucursal!=null && consignacion_control.consignacionActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != consignacion_control.consignacionActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(consignacion_control.consignacionActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(consignacion_control.consignacionActual.id_ejercicio!=null && consignacion_control.consignacionActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != consignacion_control.consignacionActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(consignacion_control.consignacionActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(consignacion_control.consignacionActual.id_periodo!=null && consignacion_control.consignacionActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != consignacion_control.consignacionActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(consignacion_control.consignacionActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(consignacion_control.consignacionActual.id_usuario!=null && consignacion_control.consignacionActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != consignacion_control.consignacionActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(consignacion_control.consignacionActual.id_usuario).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_8").val(consignacion_control.consignacionActual.numero);
		
		if(consignacion_control.consignacionActual.id_cliente!=null && consignacion_control.consignacionActual.id_cliente>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != consignacion_control.consignacionActual.id_cliente) {
				jQuery("#t-cel_"+i+"_9").val(consignacion_control.consignacionActual.id_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_10").val(consignacion_control.consignacionActual.ruc);
		jQuery("#t-cel_"+i+"_11").val(consignacion_control.consignacionActual.referencia_cliente);
		jQuery("#t-cel_"+i+"_12").val(consignacion_control.consignacionActual.fecha_emision);
		
		if(consignacion_control.consignacionActual.id_vendedor!=null && consignacion_control.consignacionActual.id_vendedor>-1){
			if(jQuery("#t-cel_"+i+"_13").val() != consignacion_control.consignacionActual.id_vendedor) {
				jQuery("#t-cel_"+i+"_13").val(consignacion_control.consignacionActual.id_vendedor).trigger("change");
			}
		} else { 
		...
		if(consignacion_control.consignacionActual.id_termino_pago_cliente!=null && consignacion_control.consignacionActual.id_termino_pago_cliente>-1){
			if(jQuery("#t-cel_"+i+"_14").val() != consignacion_control.consignacionActual.id_termino_pago_cliente) {
				jQuery("#t-cel_"+i+"_14").val(consignacion_control.consignacionActual.id_termino_pago_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_15").val(consignacion_control.consignacionActual.fecha_vence);
		
		if(consignacion_control.consignacionActual.id_moneda!=null && consignacion_control.consignacionActual.id_moneda>-1){
			if(jQuery("#t-cel_"+i+"_16").val() != consignacion_control.consignacionActual.id_moneda) {
				jQuery("#t-cel_"+i+"_16").val(consignacion_control.consignacionActual.id_moneda).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_17").val(consignacion_control.consignacionActual.cotizacion);
		jQuery("#t-cel_"+i+"_18").val(consignacion_control.consignacionActual.direccion);
		jQuery("#t-cel_"+i+"_19").val(consignacion_control.consignacionActual.enviar_a);
		jQuery("#t-cel_"+i+"_20").val(consignacion_control.consignacionActual.observacion);
		jQuery("#t-cel_"+i+"_21").prop('checked',consignacion_control.consignacionActual.impuesto_en_precio);
		jQuery("#t-cel_"+i+"_22").prop('checked',consignacion_control.consignacionActual.genero_factura);
		
		if(consignacion_control.consignacionActual.id_estado!=null && consignacion_control.consignacionActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_23").val() != consignacion_control.consignacionActual.id_estado) {
				jQuery("#t-cel_"+i+"_23").val(consignacion_control.consignacionActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_24").val(consignacion_control.consignacionActual.sub_total);
		jQuery("#t-cel_"+i+"_25").val(consignacion_control.consignacionActual.descuento_monto);
		jQuery("#t-cel_"+i+"_26").val(consignacion_control.consignacionActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_27").val(consignacion_control.consignacionActual.iva_monto);
		jQuery("#t-cel_"+i+"_28").val(consignacion_control.consignacionActual.iva_porciento);
		jQuery("#t-cel_"+i+"_29").val(consignacion_control.consignacionActual.retencion_fuente_monto);
		jQuery("#t-cel_"+i+"_30").val(consignacion_control.consignacionActual.retencion_fuente_porciento);
		jQuery("#t-cel_"+i+"_31").val(consignacion_control.consignacionActual.retencion_iva_monto);
		jQuery("#t-cel_"+i+"_32").val(consignacion_control.consignacionActual.retencion_iva_porciento);
		jQuery("#t-cel_"+i+"_33").val(consignacion_control.consignacionActual.total);
		jQuery("#t-cel_"+i+"_34").val(consignacion_control.consignacionActual.otro_monto);
		jQuery("#t-cel_"+i+"_35").val(consignacion_control.consignacionActual.otro_porciento);
		jQuery("#t-cel_"+i+"_36").val(consignacion_control.consignacionActual.retencion_ica_porciento);
		jQuery("#t-cel_"+i+"_37").val(consignacion_control.consignacionActual.retencion_ica_monto);
		
		if(consignacion_control.consignacionActual.id_kardex!=null && consignacion_control.consignacionActual.id_kardex>-1){
			if(jQuery("#t-cel_"+i+"_38").val() != consignacion_control.consignacionActual.id_kardex) {
				jQuery("#t-cel_"+i+"_38").val(consignacion_control.consignacionActual.id_kardex).trigger("change");
			}
		} else { 
		...
		if(consignacion_control.consignacionActual.id_asiento!=null && consignacion_control.consignacionActual.id_asiento>-1){
			if(jQuery("#t-cel_"+i+"_39").val() != consignacion_control.consignacionActual.id_asiento) {
				jQuery("#t-cel_"+i+"_39").val(consignacion_control.consignacionActual.id_asiento).trigger("change");
			}
		} else { 
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_3",consignacion_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_4",consignacion_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_5",consignacion_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_6",consignacion_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_7",consignacion_control.usuariosFK);
		}
	};
	...
	cargarCombosclientesFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_9",consignacion_control.clientesFK);
		}
	...
	cargarCombosvendedorsFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_13",consignacion_control.vendedorsFK);
		}
	...
	cargarCombostermino_pago_clientesFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_14",consignacion_control.termino_pago_clientesFK);
		}
	...
	cargarCombosmonedasFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_16",consignacion_control.monedasFK);
		}
	...
	cargarCombosestadosFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_23",consignacion_control.estadosFK);
		}
	...
	cargarComboskardexsFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_38",consignacion_control.kardexsFK);
		}
	...
	cargarCombosasientosFK(consignacion_control) {
		...
		if(consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+consignacion_control.idFilaTablaActual+"_39",consignacion_control.asientosFK);
		}
