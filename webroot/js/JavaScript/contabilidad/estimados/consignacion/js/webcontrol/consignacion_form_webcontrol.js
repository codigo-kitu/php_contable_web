...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(consignacion_control) {
		...
		jQuery("#form"+consignacion_constante1.STR_SUFIJO+"-created_at").val(consignacion_control.consignacionActual.versionRow);
		jQuery("#form"+consignacion_constante1.STR_SUFIJO+"-updated_at").val(consignacion_control.consignacionActual.versionRow);
	...
	actualizarSpanMensajesCampos(consignacion_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(consignacion_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(consignacion_control.strMensajeupdated_at);		
