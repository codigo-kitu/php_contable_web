...
<script id="consignacion_detalle_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (ValCol 'Consignacion' paraReporte)}}
		...
		{{#if (Is_List_Exist consignacion_detallesLocal)}}
			{{#each consignacion_detallesLocal}}
