...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(imagen_consignacion_control) {
		...
		if(imagen_consignacion_control.imagen_consignacionActual.id_consignacion!=null && imagen_consignacion_control.imagen_consignacionActual.id_consignacion>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != imagen_consignacion_control.imagen_consignacionActual.id_consignacion) {
				jQuery("#t-cel_"+i+"_3").val(imagen_consignacion_control.imagen_consignacionActual.id_consignacion).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(imagen_consignacion_control.imagen_consignacionActual.imagen);
	}
