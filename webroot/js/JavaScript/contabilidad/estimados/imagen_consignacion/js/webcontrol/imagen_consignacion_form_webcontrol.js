...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(imagen_consignacion_control) {
		...
		jQuery("#form"+imagen_consignacion_constante1.STR_SUFIJO+"-created_at").val(imagen_consignacion_control.imagen_consignacionActual.versionRow);
		jQuery("#form"+imagen_consignacion_constante1.STR_SUFIJO+"-updated_at").val(imagen_consignacion_control.imagen_consignacionActual.versionRow);
	...
	actualizarSpanMensajesCampos(imagen_consignacion_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(imagen_consignacion_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(imagen_consignacion_control.strMensajeupdated_at);		
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosconsignacionsFK(imagen_consignacion_control) {
		...
		if(imagen_consignacion_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+imagen_consignacion_control.idFilaTablaActual+"_3",imagen_consignacion_control.consignacionsFK);
		}
