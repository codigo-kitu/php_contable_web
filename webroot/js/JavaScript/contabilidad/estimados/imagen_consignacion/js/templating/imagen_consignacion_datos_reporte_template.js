...
<script id="imagen_consignacion_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist imagen_consignacionsLocal)}}
			{{#each imagen_consignacionsLocal}}
