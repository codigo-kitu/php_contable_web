...
<script id="estimado_detalle_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (ValCol 'Estimado' paraReporte)}}
		...
		{{#if (Is_List_Exist estimado_detallesLocal)}}
			{{#each estimado_detallesLocal}}
