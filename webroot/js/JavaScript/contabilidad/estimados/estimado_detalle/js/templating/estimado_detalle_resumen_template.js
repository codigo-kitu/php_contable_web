...
<script id="estimado_detalle_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarestimado_detallesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each estimado_detallesReporte}}

			<table id="tableestimado_detalle{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Estimado' ../arrOrderBy ../bitParaReporteOrderBy) }}
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								...
								<td>{{trim id_estimado_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
