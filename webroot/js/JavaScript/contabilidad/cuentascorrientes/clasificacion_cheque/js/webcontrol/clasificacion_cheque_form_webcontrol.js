...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(clasificacion_cheque_control) {
		...
		jQuery("#form"+clasificacion_cheque_constante1.STR_SUFIJO+"-created_at").val(clasificacion_cheque_control.clasificacion_chequeActual.versionRow);
		jQuery("#form"+clasificacion_cheque_constante1.STR_SUFIJO+"-updated_at").val(clasificacion_cheque_control.clasificacion_chequeActual.versionRow);
	...
	actualizarSpanMensajesCampos(clasificacion_cheque_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(clasificacion_cheque_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(clasificacion_cheque_control.strMensajeupdated_at);		
