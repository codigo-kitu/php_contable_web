...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(clasificacion_cheque_control) {
		...
		if(clasificacion_cheque_control.clasificacion_chequeActual.id_cuenta_corriente_detalle!=null && clasificacion_cheque_control.clasificacion_chequeActual.id_cuenta_corriente_detalle>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != clasificacion_cheque_control.clasificacion_chequeActual.id_cuenta_corriente_detalle) {
				jQuery("#t-cel_"+i+"_3").val(clasificacion_cheque_control.clasificacion_chequeActual.id_cuenta_corriente_detalle).trigger("change");
			}
		} else { 
		...
		if(clasificacion_cheque_control.clasificacion_chequeActual.id_categoria_cheque!=null && clasificacion_cheque_control.clasificacion_chequeActual.id_categoria_cheque>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != clasificacion_cheque_control.clasificacion_chequeActual.id_categoria_cheque) {
				jQuery("#t-cel_"+i+"_4").val(clasificacion_cheque_control.clasificacion_chequeActual.id_categoria_cheque).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(clasificacion_cheque_control.clasificacion_chequeActual.monto);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarComboscuenta_corriente_detallesFK(clasificacion_cheque_control) {
		...
		if(clasificacion_cheque_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+clasificacion_cheque_control.idFilaTablaActual+"_3",clasificacion_cheque_control.cuenta_corriente_detallesFK);
		}
	...
	cargarComboscategoria_chequesFK(clasificacion_cheque_control) {
		...
		if(clasificacion_cheque_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+clasificacion_cheque_control.idFilaTablaActual+"_4",clasificacion_cheque_control.categoria_chequesFK);
		}
