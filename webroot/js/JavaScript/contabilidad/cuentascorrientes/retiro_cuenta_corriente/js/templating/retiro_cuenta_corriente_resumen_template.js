...
<script id="retiro_cuenta_corriente_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarretiro_cuenta_corrientesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each retiro_cuenta_corrientesReporte}}

			<table id="tableretiro_cuenta_corriente{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy ' Cuenta Corriente' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Monto Texto' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Saldo Actual' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy ' Estado Deposito Retiro' ../arrOrderBy ../bitParaReporteOrderBy) }}
				...
				<tr>
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								<td width="20%" {{../strAuxStyleBackgroundContenidoCabecera}} >
									<b>-  Estado Deposito Retiro</b>
								</td>
								<td>{{trim id_estado_deposito_retiro_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
