...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(retiro_cuenta_corriente_control) {
		...
		if(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_empresa!=null && retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_sucursal!=null && retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_ejercicio!=null && retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_periodo!=null && retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_usuario!=null && retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_cuenta_corriente!=null && retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_cuenta_corriente>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_cuenta_corriente) {
				jQuery("#t-cel_"+i+"_8").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_cuenta_corriente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_9").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.fecha_emision);
		jQuery("#t-cel_"+i+"_10").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.monto);
		jQuery("#t-cel_"+i+"_11").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.monto_texto);
		jQuery("#t-cel_"+i+"_12").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.saldo);
		jQuery("#t-cel_"+i+"_13").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.descripcion);
		...
		if(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_estado_deposito_retiro!=null && retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_estado_deposito_retiro>-1){
			if(jQuery("#t-cel_"+i+"_14").val() != retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_estado_deposito_retiro) {
				jQuery("#t-cel_"+i+"_14").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.id_estado_deposito_retiro).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_15").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.debito);
		jQuery("#t-cel_"+i+"_16").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.credito);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(retiro_cuenta_corriente_control) {
		...
		if(retiro_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+retiro_cuenta_corriente_control.idFilaTablaActual+"_3",retiro_cuenta_corriente_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(retiro_cuenta_corriente_control) {
		...
		if(retiro_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+retiro_cuenta_corriente_control.idFilaTablaActual+"_4",retiro_cuenta_corriente_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(retiro_cuenta_corriente_control) {
		...
		if(retiro_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+retiro_cuenta_corriente_control.idFilaTablaActual+"_5",retiro_cuenta_corriente_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(retiro_cuenta_corriente_control) {
		...
		if(retiro_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+retiro_cuenta_corriente_control.idFilaTablaActual+"_6",retiro_cuenta_corriente_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(retiro_cuenta_corriente_control) {
		...
		if(retiro_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+retiro_cuenta_corriente_control.idFilaTablaActual+"_7",retiro_cuenta_corriente_control.usuariosFK);
		}
	};
	...
	cargarComboscuenta_corrientesFK(retiro_cuenta_corriente_control) {
		...
		if(retiro_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+retiro_cuenta_corriente_control.idFilaTablaActual+"_8",retiro_cuenta_corriente_control.cuenta_corrientesFK);
		}
	...
	cargarCombosestado_deposito_retirosFK(retiro_cuenta_corriente_control) {
		...
		if(retiro_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+retiro_cuenta_corriente_control.idFilaTablaActual+"_14",retiro_cuenta_corriente_control.estado_deposito_retirosFK);
		}
