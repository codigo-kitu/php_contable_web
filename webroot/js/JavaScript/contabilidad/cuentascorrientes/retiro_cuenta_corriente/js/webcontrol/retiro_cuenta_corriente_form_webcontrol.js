...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(retiro_cuenta_corriente_control) {
		...
		jQuery("#form"+retiro_cuenta_corriente_constante1.STR_SUFIJO+"-created_at").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.versionRow);
		jQuery("#form"+retiro_cuenta_corriente_constante1.STR_SUFIJO+"-updated_at").val(retiro_cuenta_corriente_control.retiro_cuenta_corrienteActual.versionRow);
	...
	actualizarSpanMensajesCampos(retiro_cuenta_corriente_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(retiro_cuenta_corriente_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(retiro_cuenta_corriente_control.strMensajeupdated_at);		
