...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(instrumento_pago_control) {
		...
		jQuery("#t-version_row_"+i+"").val(instrumento_pago_control.instrumento_pagoActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(instrumento_pago_control.instrumento_pagoActual.codigo);
		jQuery("#t-cel_"+i+"_4").val(instrumento_pago_control.instrumento_pagoActual.descripcion);
		jQuery("#t-cel_"+i+"_5").val(instrumento_pago_control.instrumento_pagoActual.predeterminado);
		...
		if(instrumento_pago_control.instrumento_pagoActual.id_cuenta_compras!=null && instrumento_pago_control.instrumento_pagoActual.id_cuenta_compras>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != instrumento_pago_control.instrumento_pagoActual.id_cuenta_compras) {
				jQuery("#t-cel_"+i+"_6").val(instrumento_pago_control.instrumento_pagoActual.id_cuenta_compras).trigger("change");
			}
		} else { 
		...
		if(instrumento_pago_control.instrumento_pagoActual.id_cuenta_ventas!=null && instrumento_pago_control.instrumento_pagoActual.id_cuenta_ventas>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != instrumento_pago_control.instrumento_pagoActual.id_cuenta_ventas) {
				jQuery("#t-cel_"+i+"_7").val(instrumento_pago_control.instrumento_pagoActual.id_cuenta_ventas).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_8").val(instrumento_pago_control.instrumento_pagoActual.cuenta_contable_compra);
		jQuery("#t-cel_"+i+"_9").val(instrumento_pago_control.instrumento_pagoActual.cuenta_contable_ventas);
		...
		if(instrumento_pago_control.instrumento_pagoActual.id_cuenta_corriente!=null && instrumento_pago_control.instrumento_pagoActual.id_cuenta_corriente>-1){
			if(jQuery("#t-cel_"+i+"_10").val() != instrumento_pago_control.instrumento_pagoActual.id_cuenta_corriente) {
				jQuery("#t-cel_"+i+"_10").val(instrumento_pago_control.instrumento_pagoActual.id_cuenta_corriente).trigger("change");
			}
		} else { 
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarComboscuenta_comprassFK(instrumento_pago_control) {
		...
		if(instrumento_pago_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+instrumento_pago_control.idFilaTablaActual+"_6",instrumento_pago_control.cuenta_comprassFK);
		}
	...
	cargarComboscuenta_ventassFK(instrumento_pago_control) {
		...
		if(instrumento_pago_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+instrumento_pago_control.idFilaTablaActual+"_7",instrumento_pago_control.cuenta_ventassFK);
		}
	...
	cargarComboscuenta_corrientesFK(instrumento_pago_control) {
		...
		if(instrumento_pago_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+instrumento_pago_control.idFilaTablaActual+"_10",instrumento_pago_control.cuenta_corrientesFK);
		}
