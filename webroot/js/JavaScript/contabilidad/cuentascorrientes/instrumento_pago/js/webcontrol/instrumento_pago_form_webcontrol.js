...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(instrumento_pago_control) {
		...
		jQuery("#form"+instrumento_pago_constante1.STR_SUFIJO+"-created_at").val(instrumento_pago_control.instrumento_pagoActual.versionRow);
		jQuery("#form"+instrumento_pago_constante1.STR_SUFIJO+"-updated_at").val(instrumento_pago_control.instrumento_pagoActual.versionRow);
	...
	actualizarSpanMensajesCampos(instrumento_pago_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(instrumento_pago_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(instrumento_pago_control.strMensajeupdated_at);		
