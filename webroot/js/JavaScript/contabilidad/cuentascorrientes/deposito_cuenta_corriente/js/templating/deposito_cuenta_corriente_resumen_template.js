...
<script id="deposito_cuenta_corriente_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliardeposito_cuenta_corrientesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each deposito_cuenta_corrientesReporte}}

			<table id="tabledeposito_cuenta_corriente{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
