...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(banco_control) {
		...
		if(banco_control.bancoActual.id_empresa!=null && banco_control.bancoActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != banco_control.bancoActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(banco_control.bancoActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_4").val(banco_control.bancoActual.codigo);
		jQuery("#t-cel_"+i+"_5").val(banco_control.bancoActual.nombre);
	}
