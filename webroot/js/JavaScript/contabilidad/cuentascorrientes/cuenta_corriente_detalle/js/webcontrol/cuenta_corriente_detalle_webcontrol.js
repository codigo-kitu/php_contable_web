...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cuenta_corriente_detalle_control) {
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_empresa!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_ejercicio!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_4").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_periodo!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_periodo) {
				jQuery("#t-cel_"+i+"_5").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_usuario!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_usuario) {
				jQuery("#t-cel_"+i+"_6").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_corriente!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_corriente>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_corriente) {
				jQuery("#t-cel_"+i+"_7").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_corriente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_8").prop('checked',cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.es_balance_inicial);
		jQuery("#t-cel_"+i+"_9").prop('checked',cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.es_cheque);
		jQuery("#t-cel_"+i+"_10").prop('checked',cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.es_deposito);
		jQuery("#t-cel_"+i+"_11").prop('checked',cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.es_retiro);
		jQuery("#t-cel_"+i+"_12").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.numero_cheque);
		jQuery("#t-cel_"+i+"_13").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.fecha_emision);
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cliente!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cliente>-1){
			if(jQuery("#t-cel_"+i+"_14").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cliente) {
				jQuery("#t-cel_"+i+"_14").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cliente).trigger("change");
			}
		} else { 
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_proveedor!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_15").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_proveedor) {
				jQuery("#t-cel_"+i+"_15").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_proveedor).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_16").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.monto);
		jQuery("#t-cel_"+i+"_17").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.debito);
		jQuery("#t-cel_"+i+"_18").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.credito);
		jQuery("#t-cel_"+i+"_19").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.balance);
		jQuery("#t-cel_"+i+"_20").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.fecha_hora);
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_tabla!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_tabla>-1){
			if(jQuery("#t-cel_"+i+"_21").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_tabla) {
				jQuery("#t-cel_"+i+"_21").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_tabla).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_22").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_origen);
		jQuery("#t-cel_"+i+"_23").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.descripcion);
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_estado!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_24").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_estado) {
				jQuery("#t-cel_"+i+"_24").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_estado).trigger("change");
			}
		} else { 
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_asiento!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_asiento>-1){
			if(jQuery("#t-cel_"+i+"_25").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_asiento) {
				jQuery("#t-cel_"+i+"_25").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_asiento).trigger("change");
			}
		} else { 
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_pagar!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_pagar>-1){
			if(jQuery("#t-cel_"+i+"_26").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_pagar) {
				jQuery("#t-cel_"+i+"_26").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_pagar).trigger("change");
			}
		} else { 
		...
		if(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_cobrar!=null && cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_cobrar>-1){
			if(jQuery("#t-cel_"+i+"_27").val() != cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_cobrar) {
				jQuery("#t-cel_"+i+"_27").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.id_cuenta_cobrar).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_28").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.tabla_origen);
		jQuery("#t-cel_"+i+"_29").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.origen_empresa);
		jQuery("#t-cel_"+i+"_30").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.motivo_anulacion);
		jQuery("#t-cel_"+i+"_31").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.origen_dato);
		jQuery("#t-cel_"+i+"_32").val(cuenta_corriente_detalle_control.cuenta_corriente_detalleActual.computador_origen);
	}
