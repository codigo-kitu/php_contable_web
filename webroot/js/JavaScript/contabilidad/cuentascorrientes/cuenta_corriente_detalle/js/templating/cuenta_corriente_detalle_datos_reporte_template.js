...
<script id="cuenta_corriente_detalle_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (ValCol 'Es Cheque' paraReporte)}}
		...
		{{#if (ValCol 'Es Deposito' paraReporte)}}
		...
		{{#if (ValCol 'Es Retiro' paraReporte)}}
