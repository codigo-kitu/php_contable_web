...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cuenta_corriente_control) {
		...
		if(cuenta_corriente_control.cuenta_corrienteActual.id_empresa!=null && cuenta_corriente_control.cuenta_corrienteActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != cuenta_corriente_control.cuenta_corrienteActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(cuenta_corriente_control.cuenta_corrienteActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(cuenta_corriente_control.cuenta_corrienteActual.id_usuario!=null && cuenta_corriente_control.cuenta_corrienteActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != cuenta_corriente_control.cuenta_corrienteActual.id_usuario) {
				jQuery("#t-cel_"+i+"_4").val(cuenta_corriente_control.cuenta_corrienteActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(cuenta_corriente_control.cuenta_corrienteActual.id_banco!=null && cuenta_corriente_control.cuenta_corrienteActual.id_banco>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != cuenta_corriente_control.cuenta_corrienteActual.id_banco) {
				jQuery("#t-cel_"+i+"_5").val(cuenta_corriente_control.cuenta_corrienteActual.id_banco).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_6").val(cuenta_corriente_control.cuenta_corrienteActual.numero_cuenta);
		jQuery("#t-cel_"+i+"_7").val(cuenta_corriente_control.cuenta_corrienteActual.balance_inicial);
		jQuery("#t-cel_"+i+"_8").val(cuenta_corriente_control.cuenta_corrienteActual.saldo);
		jQuery("#t-cel_"+i+"_9").val(cuenta_corriente_control.cuenta_corrienteActual.contador_cheque);
		...
		if(cuenta_corriente_control.cuenta_corrienteActual.id_cuenta!=null && cuenta_corriente_control.cuenta_corrienteActual.id_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_10").val() != cuenta_corriente_control.cuenta_corrienteActual.id_cuenta) {
				jQuery("#t-cel_"+i+"_10").val(cuenta_corriente_control.cuenta_corrienteActual.id_cuenta).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_11").val(cuenta_corriente_control.cuenta_corrienteActual.descripcion);
		jQuery("#t-cel_"+i+"_12").val(cuenta_corriente_control.cuenta_corrienteActual.icono);
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(cuenta_corriente_control) {
		...
		if(cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_corriente_control.idFilaTablaActual+"_3",cuenta_corriente_control.empresasFK);
		}
	};
	...
	cargarCombosusuariosFK(cuenta_corriente_control) {
		...
		if(cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_corriente_control.idFilaTablaActual+"_4",cuenta_corriente_control.usuariosFK);
		}
	};
	...
	cargarCombosbancosFK(cuenta_corriente_control) {
		...
		if(cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_corriente_control.idFilaTablaActual+"_5",cuenta_corriente_control.bancosFK);
		}
	...
	cargarComboscuentasFK(cuenta_corriente_control) {
		...
		if(cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_corriente_control.idFilaTablaActual+"_10",cuenta_corriente_control.cuentasFK);
		}
