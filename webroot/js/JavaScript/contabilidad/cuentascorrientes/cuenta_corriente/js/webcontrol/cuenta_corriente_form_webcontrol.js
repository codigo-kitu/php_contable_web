...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(cuenta_corriente_control) {
		...
		jQuery("#form"+cuenta_corriente_constante1.STR_SUFIJO+"-created_at").val(cuenta_corriente_control.cuenta_corrienteActual.versionRow);
		jQuery("#form"+cuenta_corriente_constante1.STR_SUFIJO+"-updated_at").val(cuenta_corriente_control.cuenta_corrienteActual.versionRow);
	...
	actualizarSpanMensajesCampos(cuenta_corriente_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(cuenta_corriente_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(cuenta_corriente_control.strMensajeupdated_at);		
