...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(cheque_cuenta_corriente_control) {
		...
		jQuery("#form"+cheque_cuenta_corriente_constante1.STR_SUFIJO+"-created_at").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.versionRow);
		jQuery("#form"+cheque_cuenta_corriente_constante1.STR_SUFIJO+"-updated_at").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.versionRow);
	...
	actualizarSpanMensajesCampos(cheque_cuenta_corriente_control) {
		...
		jQuery("#spanstrMensajecreated_at").text(cheque_cuenta_corriente_control.strMensajecreated_at);		
		jQuery("#spanstrMensajeupdated_at").text(cheque_cuenta_corriente_control.strMensajeupdated_at);		
