...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_empresa!=null && cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_sucursal!=null && cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_4").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_ejercicio!=null && cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_5").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_periodo!=null && cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_periodo) {
				jQuery("#t-cel_"+i+"_6").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_usuario!=null && cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_usuario) {
				jQuery("#t-cel_"+i+"_7").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_cuenta_corriente!=null && cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_cuenta_corriente>-1){
			if(jQuery("#t-cel_"+i+"_8").val() != cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_cuenta_corriente) {
				jQuery("#t-cel_"+i+"_8").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_cuenta_corriente).trigger("change");
			}
		} else { 
		...
		if(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_categoria_cheque!=null && cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_categoria_cheque>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_categoria_cheque) {
				jQuery("#t-cel_"+i+"_9").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_categoria_cheque).trigger("change");
			}
		} else { 
		...
		if(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_cliente!=null && cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_cliente>-1){
			if(jQuery("#t-cel_"+i+"_10").val() != cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_cliente) {
				jQuery("#t-cel_"+i+"_10").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_cliente).trigger("change");
			}
		} else { 
		...
		if(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_proveedor!=null && cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_proveedor>-1){
			if(jQuery("#t-cel_"+i+"_11").val() != cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_proveedor) {
				jQuery("#t-cel_"+i+"_11").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_proveedor).trigger("change");
			}
		} else { 
		...
		if(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_beneficiario_ocacional_cheque!=null && cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_beneficiario_ocacional_cheque>-1){
			if(jQuery("#t-cel_"+i+"_12").val() != cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_beneficiario_ocacional_cheque) {
				jQuery("#t-cel_"+i+"_12").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_beneficiario_ocacional_cheque).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_13").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.numero_cheque);
		jQuery("#t-cel_"+i+"_14").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.fecha_emision);
		jQuery("#t-cel_"+i+"_15").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.monto);
		jQuery("#t-cel_"+i+"_16").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.monto_texto);
		jQuery("#t-cel_"+i+"_17").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.saldo);
		jQuery("#t-cel_"+i+"_18").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.descripcion);
		jQuery("#t-cel_"+i+"_19").prop('checked',cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.cobrado);
		jQuery("#t-cel_"+i+"_20").prop('checked',cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.impreso);
		...
		if(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_estado_deposito_retiro!=null && cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_estado_deposito_retiro>-1){
			if(jQuery("#t-cel_"+i+"_21").val() != cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_estado_deposito_retiro) {
				jQuery("#t-cel_"+i+"_21").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.id_estado_deposito_retiro).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_22").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.debito);
		jQuery("#t-cel_"+i+"_23").val(cheque_cuenta_corriente_control.cheque_cuenta_corrienteActual.credito);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cheque_cuenta_corriente_control.idFilaTablaActual+"_3",cheque_cuenta_corriente_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cheque_cuenta_corriente_control.idFilaTablaActual+"_4",cheque_cuenta_corriente_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cheque_cuenta_corriente_control.idFilaTablaActual+"_5",cheque_cuenta_corriente_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cheque_cuenta_corriente_control.idFilaTablaActual+"_6",cheque_cuenta_corriente_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cheque_cuenta_corriente_control.idFilaTablaActual+"_7",cheque_cuenta_corriente_control.usuariosFK);
		}
	};
	...
	cargarComboscuenta_corrientesFK(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cheque_cuenta_corriente_control.idFilaTablaActual+"_8",cheque_cuenta_corriente_control.cuenta_corrientesFK);
		}
	...
	cargarComboscategoria_chequesFK(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cheque_cuenta_corriente_control.idFilaTablaActual+"_9",cheque_cuenta_corriente_control.categoria_chequesFK);
		}
	...
	cargarCombosclientesFK(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cheque_cuenta_corriente_control.idFilaTablaActual+"_10",cheque_cuenta_corriente_control.clientesFK);
		}
	...
	cargarCombosproveedorsFK(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cheque_cuenta_corriente_control.idFilaTablaActual+"_11",cheque_cuenta_corriente_control.proveedorsFK);
		}
	...
	cargarCombosbeneficiario_ocacional_chequesFK(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cheque_cuenta_corriente_control.idFilaTablaActual+"_12",cheque_cuenta_corriente_control.beneficiario_ocacional_chequesFK);
		}
	...
	cargarCombosestado_deposito_retirosFK(cheque_cuenta_corriente_control) {
		...
		if(cheque_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cheque_cuenta_corriente_control.idFilaTablaActual+"_21",cheque_cuenta_corriente_control.estado_deposito_retirosFK);
		}
