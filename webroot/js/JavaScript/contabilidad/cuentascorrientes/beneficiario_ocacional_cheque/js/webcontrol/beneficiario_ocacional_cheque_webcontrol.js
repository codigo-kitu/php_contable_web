...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(beneficiario_ocacional_cheque_control) {
		...
		jQuery("#t-version_row_"+i+"").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.versionRow);
		jQuery("#t-cel_"+i+"_3").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.codigo);
		jQuery("#t-cel_"+i+"_4").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.nombre);
		jQuery("#t-cel_"+i+"_5").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.direccion_1);
		jQuery("#t-cel_"+i+"_6").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.direccion_2);
		jQuery("#t-cel_"+i+"_7").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.direccion_3);
		jQuery("#t-cel_"+i+"_8").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.telefono);
		jQuery("#t-cel_"+i+"_9").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.telefono_movil);
		jQuery("#t-cel_"+i+"_10").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.email);
		jQuery("#t-cel_"+i+"_11").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.notas);
		jQuery("#t-cel_"+i+"_12").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.registro_ocacional);
		jQuery("#t-cel_"+i+"_13").val(beneficiario_ocacional_cheque_control.beneficiario_ocacional_chequeActual.registro_tributario);
	}
