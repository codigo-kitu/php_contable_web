...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(categoria_cheque_control) {
		...
		if(categoria_cheque_control.categoria_chequeActual.id_empresa!=null && categoria_cheque_control.categoria_chequeActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != categoria_cheque_control.categoria_chequeActual.id_empresa) {
				jQuery("#t-cel_"+i+"_3").val(categoria_cheque_control.categoria_chequeActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(categoria_cheque_control.categoria_chequeActual.id_cuenta!=null && categoria_cheque_control.categoria_chequeActual.id_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != categoria_cheque_control.categoria_chequeActual.id_cuenta) {
				jQuery("#t-cel_"+i+"_4").val(categoria_cheque_control.categoria_chequeActual.id_cuenta).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(categoria_cheque_control.categoria_chequeActual.nombre);
		jQuery("#t-cel_"+i+"_6").val(categoria_cheque_control.categoria_chequeActual.cuenta_contable);
		jQuery("#t-cel_"+i+"_7").prop('checked',categoria_cheque_control.categoria_chequeActual.predeterminado);
	}
