		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(debito_cuenta_pagar_control.idforma_pago_proveedorDefaultForeignKey!=null && debito_cuenta_pagar_control.idforma_pago_proveedorDefaultForeignKey>-1) {
					idActual=debito_cuenta_pagar_control.idforma_pago_proveedorDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					debito_cuenta_pagar_webcontrol1.cargarComboEditarTablaforma_pago_proveedorFK(debito_cuenta_pagar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						debito_cuenta_pagar_webcontrol1.cargarComboEditarTablaforma_pago_proveedorFK(debito_cuenta_pagar_control,control_name,idActual,true);
					}
				});
