...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(parametro_cuenta_pagar_control) {
		...
		jQuery("#form"+parametro_cuenta_pagar_constante1.STR_SUFIJO+"-version_row").val(parametro_cuenta_pagar_control.parametro_cuenta_pagarActual.versionRow);
	...
	actualizarSpanMensajesCampos(parametro_cuenta_pagar_control) {
		...
		jQuery("#spanstrMensajeversion_row").text(parametro_cuenta_pagar_control.strMensajeversion_row);		
