...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(pago_cuenta_pagar_control) {
		...
		jQuery("#t-cel_"+i+"_12").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.abono);
		jQuery("#t-cel_"+i+"_13").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.saldo);
		jQuery("#t-cel_"+i+"_14").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.descripcion);
		...
		if(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_estado!=null && pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_15").val() != pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_estado) {
				jQuery("#t-cel_"+i+"_15").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_16").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.referencia);
		jQuery("#t-cel_"+i+"_17").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.debito);
		jQuery("#t-cel_"+i+"_18").val(pago_cuenta_pagar_control.pago_cuenta_pagarActual.credito);
	}
