...
<script id="imagen_documento_cuenta_pagar_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist imagen_documento_cuenta_pagarsLocal)}}
			{{#each imagen_documento_cuenta_pagarsLocal}}
