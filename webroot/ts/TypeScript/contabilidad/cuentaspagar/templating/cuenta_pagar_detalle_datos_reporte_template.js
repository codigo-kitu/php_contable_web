...
<script id="cuenta_pagar_detalle_datos_reporte_template" type="text/x-handlebars-template">



		<form id="frmTablaDatoscuenta_pagar_detalle" name="frmTablaDatoscuenta_pagar_detalle">
			<div id="divTablaDatosAuxiliarcuenta_pagar_detallesAjaxWebPart" style="{{style_div}}">

				<input type="hidden" id="t{{strSufijo}}-maxima_fila" name="t{{strSufijo}}-maxima_fila" value="{{count cuenta_pagar_detalles}}">
		...
		<table id="tblTablaDatoscuenta_pagar_detalles" name="tblTablaDatoscuenta_pagar_detalles" class="{{class_table}}" cellpadding="3" cellspacing="3" style="{{style_tabla}}" border="1" rules="rows">
		...
		{{#if (Is_List_Exist cuenta_pagar_detallesLocal)}}
			{{#each cuenta_pagar_detallesLocal}}
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarcuenta_pagar_detalle" idactualcuenta_pagar_detalle="{{id}}" title="SELECCIONAR Detalle Cuenta Pagar ACTUAL" src="{{../PATH_IMAGEN}}/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_eli col_id"  style="display:{{../strPermisoEliminar}}">
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgeliminartablacuenta_pagar_detalle" idactualcuenta_pagar_detalle="{{id}}" title="ELIMINAR Detalle Cuenta Pagar ACTUAL" src="{{../PATH_IMAGEN}}/Imagenes/eliminar.gif" alt="Eliminar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_{{i}}" name="t-id_{{i}}" type="checkbox" class="chkb_id" title="SELECCIONAR Detalle Cuenta Pagar ACTUAL" value="{{id}}"></input>
							</td>
							<td>
								{{i}}
							</td>
