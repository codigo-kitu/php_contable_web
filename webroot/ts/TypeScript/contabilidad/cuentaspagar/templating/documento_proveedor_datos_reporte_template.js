...
<script id="documento_proveedor_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist documento_proveedorsLocal)}}
			{{#each documento_proveedorsLocal}}
