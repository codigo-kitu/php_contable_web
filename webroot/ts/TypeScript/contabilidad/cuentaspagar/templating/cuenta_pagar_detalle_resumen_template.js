...
<script id="cuenta_pagar_detalle_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarcuenta_pagar_detallesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each cuenta_pagar_detallesReporte}}

			<table id="tablecuenta_pagar_detalle{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
