...
<script id="debito_cuenta_pagar_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliardebito_cuenta_pagarsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each debito_cuenta_pagarsReporte}}

			<table id="tabledebito_cuenta_pagar{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
