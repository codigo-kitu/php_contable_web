...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(municipio_constante1.STR_RELATIVE_PATH,"municipio");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(municipio_constante1.STR_RELATIVE_PATH,municipio_constante1.STR_NOMBRE_OPCION,"municipio");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(municipio_constante1.STR_RELATIVE_PATH,municipio_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(municipio_control,municipio_webcontrol1,municipio_constante1) {
		
		var strSuf=municipio_constante1.STR_SUFIJO;
		...
		jQuery("#frmTablaDatosmunicipio").validate(json_rules);
