...
<script id="paquete_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarpaquetesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each paquetesReporte}}

			<table id="tablepaquete{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
