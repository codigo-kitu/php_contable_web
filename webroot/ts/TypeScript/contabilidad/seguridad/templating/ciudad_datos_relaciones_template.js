...
<script id="ciudad_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarciudadsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each ciudadsReporte}}

			<table id="tableciudad{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
