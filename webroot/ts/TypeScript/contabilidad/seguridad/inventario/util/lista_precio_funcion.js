		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(lista_precio_control.idempresaDefaultForeignKey!=null && lista_precio_control.idempresaDefaultForeignKey>-1) {
					idActual=lista_precio_control.idempresaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					lista_precio_webcontrol1.cargarComboEditarTablaempresaFK(lista_precio_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						lista_precio_webcontrol1.cargarComboEditarTablaempresaFK(lista_precio_control,control_name,idActual,true);
					}
				});
				...
				if(lista_precio_control.idbodegaDefaultForeignKey!=null && lista_precio_control.idbodegaDefaultForeignKey>-1) {
					idActual=lista_precio_control.idbodegaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					lista_precio_webcontrol1.cargarComboEditarTablabodegaFK(lista_precio_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						lista_precio_webcontrol1.cargarComboEditarTablabodegaFK(lista_precio_control,control_name,idActual,true);
					}
				});
