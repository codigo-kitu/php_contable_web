...
<script id="inventario_fisico_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (ValCol 'Id Almacen' paraReporte)}}
		...
		{{#if (ValCol 'Prod Cont Almacen' paraReporte)}}
		...
		{{#if (ValCol 'Total Productos Almacen' paraReporte)}}
