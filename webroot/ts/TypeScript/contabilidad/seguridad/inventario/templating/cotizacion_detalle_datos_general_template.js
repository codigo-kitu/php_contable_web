...
<script id="cotizacion_detalle_datos_general_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist cotizacion_detallesLocal)}}
			{{#each cotizacion_detallesLocal}}
