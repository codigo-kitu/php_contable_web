...
<script id="kardex_detalle_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarkardex_detallesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each kardex_detallesReporte}}

			<table id="tablekardex_detalle{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Lote' ../arrOrderBy ../bitParaReporteOrderBy) }}
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								...
								<td>{{trim id_lote_producto_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
			...
			{{#if (existeCadenaArrayOrderBy 'Cantidad Disponible' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Cantidad Disponible Total' ../arrOrderBy ../bitParaReporteOrderBy) }}
				...
				<tr>
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								<td width="20%" {{../strAuxStyleBackgroundContenidoCabecera}} >
									<b>- Cantidad Disponible Total</b>
								</td>
								<td>{{ cantidad_disponible_total}}
								</td>
							</tr>
						</table>
					</td>
			...
			{{#if (existeCadenaArrayOrderBy 'Costo Anterior' ../arrOrderBy ../bitParaReporteOrderBy) }}
		...
		{{/if}}
			...
			<th class="cabecera_titulo_tabla" >
				<pre class="cabecera_texto_titulo_tabla"> Kardex Detalle<a onclick="jQuery('#form-id_kardex_detalle_img').trigger('click' );"><img id="form{{strSufijo}}-id_kardex_detalle_img2" name="form{{strSufijo}}-id_kardex_detalle_img2" class="imagen_actualizar" title="ACTUALIZAR DATOS RELACIONADOS" src="{{PATH_IMAGEN}}Imagenes/actualizardatos.gif" alt="Actualizar Datos" border="" height="15" width="15"></a><a onclick="costo_producto_webcontrol1.abrirBusquedaParakardex_detalle('id_kardex_detalle');"><img id="form{{strSufijo}}-id_kardex_detalle_img_busqueda2" name="form{{strSufijo}}-id_kardex_detalle_img_busqueda2" title="Buscar Detalle" style="width: 15px; height: 15px;text-align: center; visibility:visible;" src="{{PATH_IMAGEN}}Imagenes/buscar.gif" width="15" height="15"/></a></pre>
			</th>
		...
		{{#if (Is_List_Exist costo_productos)}}
			{{#each costo_productos}}
				...
				<td class="elementotabla col_id_kardex_detalle" > {{id_kardex_detalle_Descripcion}}</td>
