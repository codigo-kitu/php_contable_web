...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(devolucion_control) {
		...
		jQuery("#t-cel_"+i+"_14").val(devolucion_control.devolucionActual.cotizacion);
		
		if(devolucion_control.devolucionActual.id_moneda!=null && devolucion_control.devolucionActual.id_moneda>-1){
			if(jQuery("#t-cel_"+i+"_15").val() != devolucion_control.devolucionActual.id_moneda) {
				jQuery("#t-cel_"+i+"_15").val(devolucion_control.devolucionActual.id_moneda).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_18").val(devolucion_control.devolucionActual.envia);
		jQuery("#t-cel_"+i+"_19").val(devolucion_control.devolucionActual.observacion);
		jQuery("#t-cel_"+i+"_20").prop('checked',devolucion_control.devolucionActual.impuesto_en_precio);
		jQuery("#t-cel_"+i+"_21").val(devolucion_control.devolucionActual.sub_total);
		jQuery("#t-cel_"+i+"_22").val(devolucion_control.devolucionActual.descuento_monto);
		jQuery("#t-cel_"+i+"_23").val(devolucion_control.devolucionActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_24").val(devolucion_control.devolucionActual.iva_monto);
		jQuery("#t-cel_"+i+"_25").val(devolucion_control.devolucionActual.iva_porciento);
		jQuery("#t-cel_"+i+"_26").val(devolucion_control.devolucionActual.total);
		jQuery("#t-cel_"+i+"_27").val(devolucion_control.devolucionActual.otro_monto);
		jQuery("#t-cel_"+i+"_28").val(devolucion_control.devolucionActual.otro_porciento);
		jQuery("#t-cel_"+i+"_29").val(devolucion_control.devolucionActual.factura_proveedor);
		jQuery("#t-cel_"+i+"_30").val(devolucion_control.devolucionActual.pago);
		
		if(devolucion_control.devolucionActual.id_asiento!=null && devolucion_control.devolucionActual.id_asiento>-1){
			if(jQuery("#t-cel_"+i+"_31").val() != devolucion_control.devolucionActual.id_asiento) {
				jQuery("#t-cel_"+i+"_31").val(devolucion_control.devolucionActual.id_asiento).trigger("change");
			}
		} else { 
		...
		if(devolucion_control.devolucionActual.id_documento_cuenta_pagar!=null && devolucion_control.devolucionActual.id_documento_cuenta_pagar>-1){
			if(jQuery("#t-cel_"+i+"_32").val() != devolucion_control.devolucionActual.id_documento_cuenta_pagar) {
				jQuery("#t-cel_"+i+"_32").val(devolucion_control.devolucionActual.id_documento_cuenta_pagar).trigger("change");
			}
		} else { 
		...
		if(devolucion_control.devolucionActual.id_kardex!=null && devolucion_control.devolucionActual.id_kardex>-1){
			if(jQuery("#t-cel_"+i+"_33").val() != devolucion_control.devolucionActual.id_kardex) {
				jQuery("#t-cel_"+i+"_33").val(devolucion_control.devolucionActual.id_kardex).trigger("change");
			}
		} else { 
