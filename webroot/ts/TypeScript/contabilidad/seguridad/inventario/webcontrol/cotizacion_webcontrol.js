...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cotizacion_control) {
		...
		if(cotizacion_control.cotizacionActual.id_moneda!=null && cotizacion_control.cotizacionActual.id_moneda>-1){
			if(jQuery("#t-cel_"+i+"_14").val() != cotizacion_control.cotizacionActual.id_moneda) {
				jQuery("#t-cel_"+i+"_14").val(cotizacion_control.cotizacionActual.id_moneda).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_15").val(cotizacion_control.cotizacionActual.cotizacion);
		jQuery("#t-cel_"+i+"_16").val(cotizacion_control.cotizacionActual.direccion);
		jQuery("#t-cel_"+i+"_17").val(cotizacion_control.cotizacionActual.enviar);
