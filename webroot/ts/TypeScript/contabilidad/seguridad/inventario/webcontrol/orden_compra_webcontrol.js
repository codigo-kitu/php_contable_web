...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(orden_compra_control) {
		...
		jQuery("#t-cel_"+i+"_14").val(orden_compra_control.orden_compraActual.cotizacion);
		
		if(orden_compra_control.orden_compraActual.id_moneda!=null && orden_compra_control.orden_compraActual.id_moneda>-1){
			if(jQuery("#t-cel_"+i+"_15").val() != orden_compra_control.orden_compraActual.id_moneda) {
				jQuery("#t-cel_"+i+"_15").val(orden_compra_control.orden_compraActual.id_moneda).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_16").prop('checked',orden_compra_control.orden_compraActual.impuesto_en_precio);
		
		if(orden_compra_control.orden_compraActual.id_estado!=null && orden_compra_control.orden_compraActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_17").val() != orden_compra_control.orden_compraActual.id_estado) {
				jQuery("#t-cel_"+i+"_17").val(orden_compra_control.orden_compraActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_18").val(orden_compra_control.orden_compraActual.direccion);
		jQuery("#t-cel_"+i+"_19").val(orden_compra_control.orden_compraActual.enviar);
		jQuery("#t-cel_"+i+"_20").val(orden_compra_control.orden_compraActual.observacion);
		jQuery("#t-cel_"+i+"_21").val(orden_compra_control.orden_compraActual.sub_total);
		jQuery("#t-cel_"+i+"_22").val(orden_compra_control.orden_compraActual.descuento_monto);
		jQuery("#t-cel_"+i+"_23").val(orden_compra_control.orden_compraActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_24").val(orden_compra_control.orden_compraActual.iva_monto);
		jQuery("#t-cel_"+i+"_25").val(orden_compra_control.orden_compraActual.iva_porciento);
		jQuery("#t-cel_"+i+"_26").val(orden_compra_control.orden_compraActual.retencion_fuente_monto);
		jQuery("#t-cel_"+i+"_27").val(orden_compra_control.orden_compraActual.retencion_fuente_porciento);
		jQuery("#t-cel_"+i+"_28").val(orden_compra_control.orden_compraActual.retencion_iva_monto);
		jQuery("#t-cel_"+i+"_29").val(orden_compra_control.orden_compraActual.retencion_iva_porciento);
		jQuery("#t-cel_"+i+"_30").val(orden_compra_control.orden_compraActual.total);
		jQuery("#t-cel_"+i+"_31").val(orden_compra_control.orden_compraActual.otro_monto);
		jQuery("#t-cel_"+i+"_32").val(orden_compra_control.orden_compraActual.otro_porciento);
		jQuery("#t-cel_"+i+"_33").val(orden_compra_control.orden_compraActual.retencion_ica_monto);
		jQuery("#t-cel_"+i+"_34").val(orden_compra_control.orden_compraActual.retencion_ica_porciento);
		jQuery("#t-cel_"+i+"_35").val(orden_compra_control.orden_compraActual.factura_proveedor);
		jQuery("#t-cel_"+i+"_36").prop('checked',orden_compra_control.orden_compraActual.recibida);
		jQuery("#t-cel_"+i+"_37").val(orden_compra_control.orden_compraActual.pagos);
		
		if(orden_compra_control.orden_compraActual.id_asiento!=null && orden_compra_control.orden_compraActual.id_asiento>-1){
			if(jQuery("#t-cel_"+i+"_38").val() != orden_compra_control.orden_compraActual.id_asiento) {
				jQuery("#t-cel_"+i+"_38").val(orden_compra_control.orden_compraActual.id_asiento).trigger("change");
			}
		} else { 
		...
		if(orden_compra_control.orden_compraActual.id_documento_cuenta_pagar!=null && orden_compra_control.orden_compraActual.id_documento_cuenta_pagar>-1){
			if(jQuery("#t-cel_"+i+"_39").val() != orden_compra_control.orden_compraActual.id_documento_cuenta_pagar) {
				jQuery("#t-cel_"+i+"_39").val(orden_compra_control.orden_compraActual.id_documento_cuenta_pagar).trigger("change");
			}
		} else { 
		...
		if(orden_compra_control.orden_compraActual.id_kardex!=null && orden_compra_control.orden_compraActual.id_kardex>-1){
			if(jQuery("#t-cel_"+i+"_40").val() != orden_compra_control.orden_compraActual.id_kardex) {
				jQuery("#t-cel_"+i+"_40").val(orden_compra_control.orden_compraActual.id_kardex).trigger("change");
			}
		} else { 
