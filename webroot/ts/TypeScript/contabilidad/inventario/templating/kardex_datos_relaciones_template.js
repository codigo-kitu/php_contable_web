...
<script id="kardex_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarkardexsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each kardexsReporte}}

			<table id="tablekardex{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Nro Documento Soporte' ../arrOrderBy ../bitParaReporteOrderBy) }}
				...
				<tr>
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								<td width="20%" {{../strAuxStyleBackgroundContenidoCabecera}} >
									<b>- Nro Documento Soporte</b>
								</td>
								<td>{{trim numero_documento}}
								</td>
							</tr>
						</table>
					</td>
			...
			{{#if (existeCadenaArrayOrderBy ' Clientes' ../arrOrderBy ../bitParaReporteOrderBy) }}
