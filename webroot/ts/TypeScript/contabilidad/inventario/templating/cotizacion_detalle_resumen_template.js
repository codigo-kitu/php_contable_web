...
<script id="cotizacion_detalle_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarcotizacion_detallesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each cotizacion_detallesReporte}}

			<table id="tablecotizacion_detalle{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								...
								<td>{{trim id_cotizacion_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
