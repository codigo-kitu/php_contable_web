...
<script id="lista_precio_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (ValCol 'Precio Compra' paraReporte)}}
		...
		{{#if (ValCol 'Rango Inicial' paraReporte)}}
		...
		{{#if (ValCol 'Rango Final' paraReporte)}}
