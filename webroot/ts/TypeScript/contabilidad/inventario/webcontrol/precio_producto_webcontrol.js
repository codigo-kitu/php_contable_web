...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(precio_producto_control) {
		...
		if(precio_producto_control.precio_productoActual.id_empresa!=null && precio_producto_control.precio_productoActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_2").val() != precio_producto_control.precio_productoActual.id_empresa) {
				jQuery("#t-cel_"+i+"_2").val(precio_producto_control.precio_productoActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(precio_producto_control.precio_productoActual.id_bodega!=null && precio_producto_control.precio_productoActual.id_bodega>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != precio_producto_control.precio_productoActual.id_bodega) {
				jQuery("#t-cel_"+i+"_3").val(precio_producto_control.precio_productoActual.id_bodega).trigger("change");
			}
		} else { 
		...
		if(precio_producto_control.precio_productoActual.id_producto!=null && precio_producto_control.precio_productoActual.id_producto>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != precio_producto_control.precio_productoActual.id_producto) {
				jQuery("#t-cel_"+i+"_4").val(precio_producto_control.precio_productoActual.id_producto).trigger("change");
			}
		} else { 
		...
		if(precio_producto_control.precio_productoActual.id_tipo_precio!=null && precio_producto_control.precio_productoActual.id_tipo_precio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != precio_producto_control.precio_productoActual.id_tipo_precio) {
				jQuery("#t-cel_"+i+"_5").val(precio_producto_control.precio_productoActual.id_tipo_precio).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_6").val(precio_producto_control.precio_productoActual.precio);
		jQuery("#t-cel_"+i+"_7").val(precio_producto_control.precio_productoActual.descuento_porciento);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(precio_producto_control) {
		...
		if(precio_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+precio_producto_control.idFilaTablaActual+"_2",precio_producto_control.empresasFK);
		}
	};
	...
	cargarCombosbodegasFK(precio_producto_control) {
		...
		if(precio_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+precio_producto_control.idFilaTablaActual+"_3",precio_producto_control.bodegasFK);
		}
	...
	cargarCombosproductosFK(precio_producto_control) {
		...
		if(precio_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+precio_producto_control.idFilaTablaActual+"_4",precio_producto_control.productosFK);
		}
	...
	cargarCombostipo_preciosFK(precio_producto_control) {
		...
		if(precio_producto_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+precio_producto_control.idFilaTablaActual+"_5",precio_producto_control.tipo_preciosFK);
		}
