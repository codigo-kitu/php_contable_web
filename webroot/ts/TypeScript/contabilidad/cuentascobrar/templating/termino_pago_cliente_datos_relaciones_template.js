...
<script id="termino_pago_cliente_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliartermino_pago_clientesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each termino_pago_clientesReporte}}

			<table id="tabletermino_pago_cliente{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
		...
		{{#if (Is_List_Exist parametro_facturacions)}}
			{{#each parametro_facturacions}}
