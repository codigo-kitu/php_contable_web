...
<script id="imagen_documento_cuenta_cobrar_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist imagen_documento_cuenta_cobrarsLocal)}}
			{{#each imagen_documento_cuenta_cobrarsLocal}}
