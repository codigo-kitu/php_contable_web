...
<script id="debito_cuenta_cobrar_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliardebito_cuenta_cobrarsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each debito_cuenta_cobrarsReporte}}

			<table id="tabledebito_cuenta_cobrar{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
