...
<script id="transacciones_cuenta_cobrar_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliartransacciones_cuenta_cobrarsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each transacciones_cuenta_cobrarsReporte}}

			<table id="tabletransacciones_cuenta_cobrar{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
