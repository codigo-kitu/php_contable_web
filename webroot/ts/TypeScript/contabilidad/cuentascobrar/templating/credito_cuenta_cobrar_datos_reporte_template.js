...
<script id="credito_cuenta_cobrar_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist credito_cuenta_cobrarsLocal)}}
			{{#each credito_cuenta_cobrarsLocal}}
