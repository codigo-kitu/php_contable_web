...
<script id="pago_cuenta_cobrar_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist pago_cuenta_cobrarsLocal)}}
			{{#each pago_cuenta_cobrarsLocal}}
