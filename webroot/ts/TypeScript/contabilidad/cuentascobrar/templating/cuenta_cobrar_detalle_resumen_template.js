...
<script id="cuenta_cobrar_detalle_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarcuenta_cobrar_detallesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each cuenta_cobrar_detallesReporte}}

			<table id="tablecuenta_cobrar_detalle{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
