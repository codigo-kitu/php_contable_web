...
<script id="pago_cuenta_cobrar_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarpago_cuenta_cobrarsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each pago_cuenta_cobrarsReporte}}

			<table id="tablepago_cuenta_cobrar{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
