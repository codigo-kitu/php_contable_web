...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(parametro_cuenta_cobrar_constante1.STR_RELATIVE_PATH,"parametro_cuenta_cobrar");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(parametro_cuenta_cobrar_constante1.STR_RELATIVE_PATH,parametro_cuenta_cobrar_constante1.STR_NOMBRE_OPCION,"parametro_cuenta_cobrar");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(parametro_cuenta_cobrar_constante1.STR_RELATIVE_PATH,parametro_cuenta_cobrar_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(parametro_cuenta_cobrar_control,parametro_cuenta_cobrar_webcontrol1,parametro_cuenta_cobrar_constante1) {
		
		var strSuf=parametro_cuenta_cobrar_constante1.STR_SUFIJO;
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(parametro_cuenta_cobrar_control.idempresaDefaultForeignKey!=null && parametro_cuenta_cobrar_control.idempresaDefaultForeignKey>-1) {
					idActual=parametro_cuenta_cobrar_control.idempresaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					parametro_cuenta_cobrar_webcontrol1.cargarComboEditarTablaempresaFK(parametro_cuenta_cobrar_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						parametro_cuenta_cobrar_webcontrol1.cargarComboEditarTablaempresaFK(parametro_cuenta_cobrar_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatosparametro_cuenta_cobrar").validate(json_rules);
