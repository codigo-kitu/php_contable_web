...
//------------- Clic-Actualizar -------------
	...
	actualizarOnComplete() {
		...
		if(super.esPaginaForm(debito_cuenta_cobrar_constante1)==true) {
...
//------------- Clic-Cancelar -------------------
	...
	cancelarOnComplete() {
		super.resaltarRestaurarDivMantenimiento(false,"debito_cuenta_cobrar");
	...
	cancelarControles() {
		...
		jQuery('cmbdebito_cuenta_cobrarid_termino_pago_cliente').val("");
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientodebito_cuenta_cobrar.txtsub_total);
		funcionGeneral.setEmptyControl(document.frmMantenimientodebito_cuenta_cobrar.txtiva);
		...
		*/
		...
		if(debito_cuenta_cobrar_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				"form_debito_cuenta_cobrar-id_termino_pago_cliente": {
					required:true,
					digits:true
					,min:0
				},
				...
				"form_debito_cuenta_cobrar-sub_total": {
					required:true,
					number:true
				},
					
				"form_debito_cuenta_cobrar-iva": {
					required:true,
					number:true
				},
				...
				messages: {
					...
					"form_debito_cuenta_cobrar-id_termino_pago_cliente": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
					...
					"form_debito_cuenta_cobrar-sub_total": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					"form_debito_cuenta_cobrar-iva": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
					
					"form_debito_cuenta_cobrar-id_estado": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_ENTERO_INCORRECTO,
					"form_debito_cuenta_cobrar-referencia": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodebito_cuenta_cobrar.txtsub_total,false);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodebito_cuenta_cobrar.txtiva,false);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodebito_cuenta_cobrar.txtsub_total,true);
			funcionGeneral.setReadOnlyControl(document.frmMantenimientodebito_cuenta_cobrar.txtiva,true);
