...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(clientes_por_vendedor_constante1.STR_RELATIVE_PATH,"clientes_por_vendedor");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(clientes_por_vendedor_constante1.STR_RELATIVE_PATH,clientes_por_vendedor_constante1.STR_NOMBRE_OPCION,"clientes_por_vendedor");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(clientes_por_vendedor_constante1.STR_RELATIVE_PATH,clientes_por_vendedor_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(clientes_por_vendedor_control,clientes_por_vendedor_webcontrol1,clientes_por_vendedor_constante1) {
		
		var strSuf=clientes_por_vendedor_constante1.STR_SUFIJO;
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(clientes_por_vendedor_control.idvendedorDefaultForeignKey!=null && clientes_por_vendedor_control.idvendedorDefaultForeignKey>-1) {
					idActual=clientes_por_vendedor_control.idvendedorDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					clientes_por_vendedor_webcontrol1.cargarComboEditarTablavendedorFK(clientes_por_vendedor_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						...
						clientes_por_vendedor_webcontrol1.cargarComboEditarTablavendedorFK(clientes_por_vendedor_control,control_name,idActual,true);
					}
				});
		...
		jQuery("#frmTablaDatosclientes_por_vendedor").validate(json_rules);
