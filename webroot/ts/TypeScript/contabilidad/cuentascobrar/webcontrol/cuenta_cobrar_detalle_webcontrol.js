...
import {cuenta_cobrar_detalle_funcion,cuenta_cobrar_detalle_funcion1} from '../util/cuenta_cobrar_detalle_funcion.js';
...
class cuenta_cobrar_detalle_webcontrol extends GeneralEntityWebControl {
	...
	actualizarVariablesPagina(cuenta_cobrar_detalle_control) {
		...
		else if(cuenta_cobrar_detalle_control.action=="indexRecargarRelacionado") {
			this.actualizarVariablesPaginaAccionIndexRecargarRelacionado(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="recargarInformacion") {
			this.actualizarVariablesPaginaAccionRecargarInformacion(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="buscarPorIdGeneral") {
			this.actualizarVariablesPaginaAccionBuscarPorIdGeneral(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="anteriores") {
			this.actualizarVariablesPaginaAccionAnteriores(cuenta_cobrar_detalle_control);
			
		} else if(cuenta_cobrar_detalle_control.action=="siguientes") {
			this.actualizarVariablesPaginaAccionSiguientes(cuenta_cobrar_detalle_control);
			
		} else if(cuenta_cobrar_detalle_control.action=="recargarUltimaInformacion") {
			this.actualizarVariablesPaginaAccionRecargarUltimaInformacion(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="seleccionarLoteFk") {
			this.actualizarVariablesPaginaAccionSeleccionarLoteFk(cuenta_cobrar_detalle_control);		
		
		} else if(cuenta_cobrar_detalle_control.action=="guardarCambios") {
			this.actualizarVariablesPaginaAccionGuardarCambios(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="duplicar") {
			this.actualizarVariablesPaginaAccionDuplicar(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="copiar") {
			this.actualizarVariablesPaginaAccionCopiar(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="seleccionarActual") {
			this.actualizarVariablesPaginaAccionSeleccionarActual(cuenta_cobrar_detalle_control);
		
		}  else if(cuenta_cobrar_detalle_control.action=="seleccionarActualAbrirPaginaForm") {
			this.actualizarVariablesPaginaAccionSeleccionarActualAbrirPaginaForm(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="eliminarCascada") {
			this.actualizarVariablesPaginaAccionEliminarCascada(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="eliminarTabla") {
			this.actualizarVariablesPaginaAccionEliminarTabla(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="quitarElementosTabla") {
			this.actualizarVariablesPaginaAccionQuitarElementosTabla(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="nuevoPreparar") {
			this.actualizarVariablesPaginaAccionNuevoPreparar(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="nuevoTablaPreparar") {
			this.actualizarVariablesPaginaAccionNuevoTablaPreparar(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="nuevoPrepararAbrirPaginaForm") {
			this.actualizarVariablesPaginaAccionNuevoPrepararAbrirPaginaForm(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="editarTablaDatos") {
			this.actualizarVariablesPaginaAccionEditarTablaDatos(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="generarHtmlReporte") {
			this.actualizarVariablesPaginaAccionGenerarHtmlReporte(cuenta_cobrar_detalle_control);
		
		} else if(cuenta_cobrar_detalle_control.action=="generarHtmlFormReporte") {
			this.actualizarVariablesPaginaAccionGenerarHtmlFormReporte(cuenta_cobrar_detalle_control);		
		
		} else if(cuenta_cobrar_detalle_control.action=="generarHtmlRelacionesReporte") {
			this.actualizarVariablesPaginaAccionGenerarHtmlRelacionesReporte(cuenta_cobrar_detalle_control);		
		
		} else if(cuenta_cobrar_detalle_control.action=="quitarRelacionesReporte") {
			this.actualizarVariablesPaginaAccionQuitarRelacionesReporte(cuenta_cobrar_detalle_control);		
		
		} else if(cuenta_cobrar_detalle_control.action.includes("Busqueda") ||
				  cuenta_cobrar_detalle_control.action.includes("FK_Id") ) {
					
			this.actualizarVariablesPaginaAccionBusquedas(cuenta_cobrar_detalle_control);
			
		} else if(cuenta_cobrar_detalle_control.action.includes(constantes.STR_REPORTE)) {
						
			this.actualizarVariablesPaginaAccionGenerarReporteAbrirPaginaForm(cuenta_cobrar_detalle_control)
		}
...
//Funciones Manejadores Accion
	...
	actualizarVariablesPaginaAccionIndexRecargarRelacionado(cuenta_cobrar_detalle_control) {
	...
	actualizarVariablesPaginaAccionRecargarInformacion(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);
	}
	
	actualizarVariablesPaginaAccionBusquedas(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);
	}
	
	actualizarVariablesPaginaAccionBuscarPorIdGeneral(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);
	}
	
	actualizarVariablesPaginaAccionAnteriores(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);
	}
	
	actualizarVariablesPaginaAccionSiguientes(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);
	}
	
	actualizarVariablesPaginaAccionRecargarUltimaInformacion(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);
	}
	
	actualizarVariablesPaginaAccionSeleccionarLoteFk(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);
	}
	
	actualizarVariablesPaginaAccionGuardarCambios(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);		
		//this.actualizarPaginaFormulario(cuenta_cobrar_detalle_control);						
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);		
		//this.actualizarPaginaAreaMantenimiento(cuenta_cobrar_detalle_control);
	...
	actualizarVariablesPaginaAccionDuplicar(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);		
		//this.actualizarPaginaFormulario(cuenta_cobrar_detalle_control);						
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);		
		//this.actualizarPaginaAreaMantenimiento(cuenta_cobrar_detalle_control);
	...
	actualizarVariablesPaginaAccionCopiar(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);		
		//this.actualizarPaginaFormulario(cuenta_cobrar_detalle_control);						
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);		
		//this.actualizarPaginaAreaMantenimiento(cuenta_cobrar_detalle_control);
	...
	actualizarVariablesPaginaAccionSeleccionarActual(cuenta_cobrar_detalle_control) {
		//this.actualizarPaginaFormulario(cuenta_cobrar_detalle_control);						
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);		
		this.actualizarPaginaAreaMantenimiento(cuenta_cobrar_detalle_control);
	}
	
	actualizarVariablesPaginaAccionSeleccionarActualAbrirPaginaForm(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaAbrirLink(cuenta_cobrar_detalle_control);
	}
		
	actualizarVariablesPaginaAccionEliminarCascada(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);				
		//this.actualizarPaginaFormulario(cuenta_cobrar_detalle_control);						
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);		
		this.actualizarPaginaAreaMantenimiento(cuenta_cobrar_detalle_control);		
	...
	actualizarVariablesPaginaAccionEliminarTabla(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);
		//this.actualizarPaginaFormulario(cuenta_cobrar_detalle_control);
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);		
		//this.actualizarPaginaAreaMantenimiento(cuenta_cobrar_detalle_control);
	...
	actualizarVariablesPaginaAccionQuitarElementosTabla(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);
		//this.actualizarPaginaFormulario(cuenta_cobrar_detalle_control);
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);		
	...
	actualizarVariablesPaginaAccionNuevoPreparar(cuenta_cobrar_detalle_control) {
		//this.actualizarPaginaFormulario(cuenta_cobrar_detalle_control);
	...
	actualizarVariablesPaginaAccionNuevoTablaPreparar(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);
		//this.actualizarPaginaFormulario(cuenta_cobrar_detalle_control);
		this.onLoadCombosDefectoFK(cuenta_cobrar_detalle_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);		
	...
	actualizarVariablesPaginaAccionNuevoPrepararAbrirPaginaForm(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaAbrirLink(cuenta_cobrar_detalle_control);
	}
		
	actualizarVariablesPaginaAccionEditarTablaDatos(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control);		
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);
	}
		
	actualizarVariablesPaginaAccionGenerarHtmlReporte(cuenta_cobrar_detalle_control) {
					//super.actualizarPaginaImprimir(cuenta_cobrar_detalle_control,"cuenta_cobrar_detalle");
		
		//CON PHP TEMPLATE
		//sessionStorage.setItem("htmlTablaReporteAuxiliars",cuenta_cobrar_detalle_control.htmlTablaReporteAuxiliars);//JSON.stringify()
		
		//TABLA DATOS REPORTE
		let html_template_datos_general = document.getElementById("cuenta_cobrar_detalle_datos_reporte_template").innerHTML;
    
	    let template_datos_general = Handlebars.compile(html_template_datos_general);
	
	    let html_datos_general = template_datos_general(cuenta_cobrar_detalle_control);
	...
	actualizarVariablesPaginaAccionGenerarHtmlFormReporte(cuenta_cobrar_detalle_control) {
		//super.actualizarPaginaImprimir(cuenta_cobrar_detalle_control,"cuenta_cobrar_detalle");
						
		//DIV ACCIONES RESUMEN
		let html_template_resumen = document.getElementById("cuenta_cobrar_detalle_resumen_template").innerHTML;
    
	    let template_resumen = Handlebars.compile(html_template_resumen);
	
	    let html_resumen = template_resumen(cuenta_cobrar_detalle_control);
	...
	actualizarVariablesPaginaAccionGenerarHtmlRelacionesReporte(cuenta_cobrar_detalle_control) {
		//super.actualizarPaginaImprimir(cuenta_cobrar_detalle_control,"cuenta_cobrar_detalle");
						
		//DIV ACCIONES RESUMEN
		let html_template_relaciones = document.getElementById("cuenta_cobrar_detalle_datos_relaciones_template").innerHTML;
    
	    let template_relaciones = Handlebars.compile(html_template_relaciones);
	
	    let html_relaciones = template_relaciones(cuenta_cobrar_detalle_control);
		...
		funcionGeneralEventoJQuery.setQuitarRelacionesReporte("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
	}
	
	actualizarVariablesPaginaAccionQuitarRelacionesReporte(cuenta_cobrar_detalle_control) {
		this.actualizarPaginaMensajePantallaAuxiliar(cuenta_cobrar_detalle_control);
	}
	
	actualizarVariablesPaginaAccionGenerarReporteAbrirPaginaForm(cuenta_cobrar_detalle_control) {
		//GUARDA EN STORAGE OBJETOS RETURN PARA REPORTE
		this.actualizarPaginaGuardarReturnSession(cuenta_cobrar_detalle_control);
	...
	actualizarPaginaCargaGeneral(cuenta_cobrar_detalle_control) {
		...
		if(cuenta_cobrar_detalle_constante1.STR_ES_RELACIONADO=="false") {
			...
			if(jQuery("#divRecargarInformacion").attr("style")!=cuenta_cobrar_detalle_control.strPermiteRecargarInformacion) {
				jQuery("#divRecargarInformacion").attr("style",cuenta_cobrar_detalle_control.strPermiteRecargarInformacion);		
			}
		}
	}
	...
	actualizarPaginaAreaBusquedas(cuenta_cobrar_detalle_control) {
		jQuery("#divBusquedacuenta_cobrar_detalleAjaxWebPart").css("display",cuenta_cobrar_detalle_control.strPermisoBusqueda);
		jQuery("#trcuenta_cobrar_detalleCabeceraBusquedas").css("display",cuenta_cobrar_detalle_control.strPermisoBusqueda);
		jQuery("#trBusquedacuenta_cobrar_detalle").css("display",cuenta_cobrar_detalle_control.strPermisoBusqueda);
			
		//CARGAR ORDER BY
		if(cuenta_cobrar_detalle_control.htmlTablaOrderBy!=null
			&& cuenta_cobrar_detalle_control.htmlTablaOrderBy!='') {
			
			jQuery("#divOrderBycuenta_cobrar_detalleAjaxWebPart").html(cuenta_cobrar_detalle_control.htmlTablaOrderBy);
				
			//NO TIENE, SON PARAMETROS EXTRA QUE SE ENVIAN COMO PARAMETROS
			//cuenta_cobrar_detalle_webcontrol1.registrarOrderByActions();
			
		}
			
		if(cuenta_cobrar_detalle_control.htmlTablaOrderByRel!=null
			&& cuenta_cobrar_detalle_control.htmlTablaOrderByRel!='') {
				
			jQuery("#divOrderByRelcuenta_cobrar_detalleAjaxWebPart").html(cuenta_cobrar_detalle_control.htmlTablaOrderByRel);
		...
		if(cuenta_cobrar_detalle_constante1.STR_ES_RELACIONADO=="true") {				
			jQuery("#divBusquedacuenta_cobrar_detalleAjaxWebPart").css("display","none");
			jQuery("#trcuenta_cobrar_detalleCabeceraBusquedas").css("display","none");
			jQuery("#trBusquedacuenta_cobrar_detalle").css("display","none");			
		}
	}
	
	/*---------------------------------- AREA:TABLA ---------------------------*/
	
	actualizarPaginaTablaDatos(cuenta_cobrar_detalle_control) {
		
		if(!cuenta_cobrar_detalle_control.bitConEditar) {
			this.actualizarPaginaTablaDatosJsTemplate(cuenta_cobrar_detalle_control);
		} else {
			jQuery("#divTablaDatoscuenta_cobrar_detallesAjaxWebPart").html(cuenta_cobrar_detalle_control.htmlTabla);	
		}
				
			
		if(constantes.STR_TIPO_TABLA=="datatables") {
			var configDataTable=null;
			var tblTablaDatoscuenta_cobrar_detalles=null;
			...
			tblTablaDatoscuenta_cobrar_detalles=jQuery("#tblTablaDatoscuenta_cobrar_detalles").dataTable(configDataTable);
				
			funcionGeneralJQuery.setConfigDataTableJQuery("cuenta_cobrar_detalle",configDataTable);
		}
			
		jQuery("#ParamsBuscar-chbConEditar").prop('checked',cuenta_cobrar_detalle_control.bitConEditar);
			
		if(jQuery("#ParamsBuscar-chbConEditar").prop('checked')==true) {
			cuenta_cobrar_detalle_webcontrol1.registrarControlesTableEdition(cuenta_cobrar_detalle_control);
				
			//DESHABILITA-->PUEDE USARSE PARA MOSTRAR NUEVAMENTE TABLA NORMAL
			//jQuery("#ParamsBuscar-chbConEditar").prop('checked',false);
		}
						
		cuenta_cobrar_detalle_webcontrol1.registrarTablaAcciones();
	}
	
	actualizarPaginaTablaDatosJsTemplate(cuenta_cobrar_detalle_control) {					
		
		//TABLA DATOS
		let html_template_datos_general = document.getElementById("cuenta_cobrar_detalle_datos_general_template").innerHTML;
    
	    let template_datos_general = Handlebars.compile(html_template_datos_general);
	
	    let html_datos_general = template_datos_general(cuenta_cobrar_detalle_control);
		
		const divTablaDatos = document.getElementById("divTablaDatoscuenta_cobrar_detallesAjaxWebPart");
	...
	actualizarPaginaOrderBy(cuenta_cobrar_detalle_control) {
	    ...
	    let html_orderby = template_orderby(cuenta_cobrar_detalle_control);
		
		const divOrderBy = document.getElementById("divOrderBycuenta_cobrar_detalleAjaxWebPart");
	    ...
	    let html_orderby_rel = template_orderby_rel(cuenta_cobrar_detalle_control);
		
		const divOrderByRel = document.getElementById("divOrderByRelcuenta_cobrar_detalleAjaxWebPart");
	...
	actualizarPaginaTablaFilaActual(cuenta_cobrar_detalle_control) {
		//ACTUALIZAR FILA TABLA, EVENTOS EN TABLA
		
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual!=null) {//form
			
			this.actualizarCamposFilaTabla(cuenta_cobrar_detalle_control);			
		}
	}
	
	actualizarCamposFilaTabla(cuenta_cobrar_detalle_control) {
		var i=0;
		
		i=cuenta_cobrar_detalle_control.idFilaTablaActual;
		
		jQuery("#t-id_"+i+"").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id);
		jQuery("#t-version_row_"+i+"").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.versionRow);
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_empresa!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_2").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_empresa) {
				jQuery("#t-cel_"+i+"_2").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_empresa).trigger("change");
			}
		} else { 
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_sucursal!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_3").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_ejercicio!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_4").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_periodo!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_periodo) {
				jQuery("#t-cel_"+i+"_5").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_usuario!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_usuario) {
				jQuery("#t-cel_"+i+"_6").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_cuenta_cobrar!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_cuenta_cobrar>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_cuenta_cobrar) {
				jQuery("#t-cel_"+i+"_7").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_cuenta_cobrar).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_8").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.numero);
		jQuery("#t-cel_"+i+"_9").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.fecha_emision);
		jQuery("#t-cel_"+i+"_10").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.fecha_vence);
		jQuery("#t-cel_"+i+"_11").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.referencia);
		jQuery("#t-cel_"+i+"_12").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.monto);
		jQuery("#t-cel_"+i+"_13").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.debito);
		jQuery("#t-cel_"+i+"_14").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.credito);
		jQuery("#t-cel_"+i+"_15").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.descripcion);
		...
		if(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_estado!=null && cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_16").val() != cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_estado) {
				jQuery("#t-cel_"+i+"_16").val(cuenta_cobrar_detalle_control.cuenta_cobrar_detalleActual.id_estado).trigger("change");
			}
		} else { 
	...
	registrarTablaAcciones() {
		...
		if(cuenta_cobrar_detalle_constante1.STR_ES_BUSQUEDA=="false") {	
			
			funcionGeneralEventoJQuery.setImagenSeleccionarClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
			
			//ELIMINAR TABLA
			funcionGeneralEventoJQuery.setImagenEliminarTablaClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);
			
			
			
		} else {
			//alert("ES BUSQUEDA");			
			funcionGeneralEventoJQuery.setImagenSeleccionarBusquedaClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);
		}
	...
	registrarControlesTableEdition(cuenta_cobrar_detalle_control) {
		cuenta_cobrar_detalle_funcion1.registrarControlesTableValidacionEdition(cuenta_cobrar_detalle_control,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);			
	}
	
	actualizarPaginaAreaAuxiliarResumen(cuenta_cobrar_detalle_control) {
		jQuery("#divResumencuenta_cobrar_detalleActualAjaxWebPart").html(cuenta_cobrar_detalle_control.strAuxiliarHtmlReturn1);
	}
	
	actualizarPaginaAreaAuxiliarAccionesRelaciones(cuenta_cobrar_detalle_control) {
		//jQuery("#divAccionesRelacionescuenta_cobrar_detalleAjaxWebPart").html(cuenta_cobrar_detalle_control.htmlTablaAccionesRelaciones);
		
		//DIV ACCIONES RELACIONES
		let html_template_relaciones = document.getElementById("cuenta_cobrar_detalle_relaciones_template").innerHTML;
    
	    let template_relaciones = Handlebars.compile(html_template_relaciones);
	
	    let html_relaciones = template_relaciones(cuenta_cobrar_detalle_control);
		
		const divRelaciones = document.getElementById("divAccionesRelacionescuenta_cobrar_detalleAjaxWebPart");
		
		if(divRelaciones!=null) {
	    	divRelaciones.innerHTML=html_relaciones;
		}
		
		cuenta_cobrar_detalle_webcontrol1.registrarDivAccionesRelaciones();
	}
	
	actualizarPaginaAreaAuxiliarBusquedas(cuenta_cobrar_detalle_control) {
		//SI USA TABS, NO SE DEBE UTILIZAR			
		this.actualizarCssBusquedas(cuenta_cobrar_detalle_control);
	}
	
	/*---------------------------------- AREA:BUSQUEDAS ---------------------------*/

	actualizarCssBusquedas(cuenta_cobrar_detalle_control) {
		
		if(cuenta_cobrar_detalle_constante1.BIT_ES_PARA_JQUERY==true) {
			jQuery("#listrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idcuenta_cobrar").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idcuenta_cobrar);
			jQuery("#tblstrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idcuenta_cobrar").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idcuenta_cobrar);
		}

		if(cuenta_cobrar_detalle_constante1.BIT_ES_PARA_JQUERY==true) {
			jQuery("#listrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idejercicio").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idejercicio);
			jQuery("#tblstrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idejercicio").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idejercicio);
		}

		if(cuenta_cobrar_detalle_constante1.BIT_ES_PARA_JQUERY==true) {
			jQuery("#listrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idempresa").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idempresa);
			jQuery("#tblstrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idempresa").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idempresa);
		}

		if(cuenta_cobrar_detalle_constante1.BIT_ES_PARA_JQUERY==true) {
			jQuery("#listrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idestado").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idestado);
			jQuery("#tblstrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idestado").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idestado);
		}

		if(cuenta_cobrar_detalle_constante1.BIT_ES_PARA_JQUERY==true) {
			jQuery("#listrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idperiodo").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idperiodo);
			jQuery("#tblstrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idperiodo").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idperiodo);
		}

		if(cuenta_cobrar_detalle_constante1.BIT_ES_PARA_JQUERY==true) {
			jQuery("#listrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idsucursal").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idsucursal);
			jQuery("#tblstrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idsucursal").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idsucursal);
		}

		if(cuenta_cobrar_detalle_constante1.BIT_ES_PARA_JQUERY==true) {
			jQuery("#listrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idusuario").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idusuario);
			jQuery("#tblstrVisible"+cuenta_cobrar_detalle_constante1.STR_SUFIJO+"FK_Idusuario").attr("style",cuenta_cobrar_detalle_control.strVisibleFK_Idusuario);
		}

	}
	
	recargarUltimaInformacionDesdeHijo() {
		this.recargarUltimaInformacioncuenta_cobrar_detalle();	
	}
	
	recargarUltimaInformacion() {		
		funcionGeneralEventoJQuery.setPageRecargarUltimaInformacionPost("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);							
	}	
	
	buscarPorIdGeneral(id) {//alert(strParametros);
		funcionGeneralEventoJQuery.setFuncionBuscarPorId("cuenta_cobrar_detalle",id,"cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);		
	}
	
	

	abrirBusquedaParaempresa(strNombreCampoBusqueda){//idActual
		cuenta_cobrar_detalle_constante1.STR_NOMBRE_CAMPO_BUSQUEDA=strNombreCampoBusqueda;

		funcionGeneralEventoJQuery.setImagenForeingKeyAbrirBusquedaClic("cuenta_cobrar_detalle","empresa","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
	}

	abrirBusquedaParasucursal(strNombreCampoBusqueda){//idActual
		cuenta_cobrar_detalle_constante1.STR_NOMBRE_CAMPO_BUSQUEDA=strNombreCampoBusqueda;

		funcionGeneralEventoJQuery.setImagenForeingKeyAbrirBusquedaClic("cuenta_cobrar_detalle","sucursal","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
	}

	abrirBusquedaParaejercicio(strNombreCampoBusqueda){//idActual
		cuenta_cobrar_detalle_constante1.STR_NOMBRE_CAMPO_BUSQUEDA=strNombreCampoBusqueda;

		funcionGeneralEventoJQuery.setImagenForeingKeyAbrirBusquedaClic("cuenta_cobrar_detalle","ejercicio","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
	}

	abrirBusquedaParaperiodo(strNombreCampoBusqueda){//idActual
		cuenta_cobrar_detalle_constante1.STR_NOMBRE_CAMPO_BUSQUEDA=strNombreCampoBusqueda;

		funcionGeneralEventoJQuery.setImagenForeingKeyAbrirBusquedaClic("cuenta_cobrar_detalle","periodo","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
	}

	abrirBusquedaParausuario(strNombreCampoBusqueda){//idActual
		cuenta_cobrar_detalle_constante1.STR_NOMBRE_CAMPO_BUSQUEDA=strNombreCampoBusqueda;

		funcionGeneralEventoJQuery.setImagenForeingKeyAbrirBusquedaClic("cuenta_cobrar_detalle","usuario","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
	}

	abrirBusquedaParacuenta_cobrar(strNombreCampoBusqueda){//idActual
		cuenta_cobrar_detalle_constante1.STR_NOMBRE_CAMPO_BUSQUEDA=strNombreCampoBusqueda;

		funcionGeneralEventoJQuery.setImagenForeingKeyAbrirBusquedaClic("cuenta_cobrar_detalle","cuenta_cobrar","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
	}

	abrirBusquedaParaestado(strNombreCampoBusqueda){//idActual
		cuenta_cobrar_detalle_constante1.STR_NOMBRE_CAMPO_BUSQUEDA=strNombreCampoBusqueda;

		funcionGeneralEventoJQuery.setImagenForeingKeyAbrirBusquedaClic("cuenta_cobrar_detalle","estado","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
	}
	...
	manejarSeleccionarLoteFk(strParametros) {//alert(strParametros);
		funcionGeneralEventoJQuery.setFuncionPadreDesdeBotonSeleccionarLoteFkClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalleConstante,strParametros);
		
		//cuenta_cobrar_detalle_funcion1.cancelarOnComplete();
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(cuenta_cobrar_detalle_control) {
		...
		if(cuenta_cobrar_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_cobrar_detalle_control.idFilaTablaActual+"_2",cuenta_cobrar_detalle_control.empresasFK);
		}
	};
	...
	cargarCombossucursalsFK(cuenta_cobrar_detalle_control) {
		...
		if(cuenta_cobrar_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_cobrar_detalle_control.idFilaTablaActual+"_3",cuenta_cobrar_detalle_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(cuenta_cobrar_detalle_control) {
		...
		if(cuenta_cobrar_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_cobrar_detalle_control.idFilaTablaActual+"_4",cuenta_cobrar_detalle_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(cuenta_cobrar_detalle_control) {
		...
		if(cuenta_cobrar_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_cobrar_detalle_control.idFilaTablaActual+"_5",cuenta_cobrar_detalle_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(cuenta_cobrar_detalle_control) {
		...
		if(cuenta_cobrar_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_cobrar_detalle_control.idFilaTablaActual+"_6",cuenta_cobrar_detalle_control.usuariosFK);
		}
	};
	...
	cargarComboscuenta_cobrarsFK(cuenta_cobrar_detalle_control) {
		...
		if(cuenta_cobrar_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_cobrar_detalle_control.idFilaTablaActual+"_7",cuenta_cobrar_detalle_control.cuenta_cobrarsFK);
		}
	...
	cargarCombosestadosFK(cuenta_cobrar_detalle_control) {
		...
		if(cuenta_cobrar_detalle_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+cuenta_cobrar_detalle_control.idFilaTablaActual+"_16",cuenta_cobrar_detalle_control.estadosFK);
		}
...
/*---------------------------------- AREA:AUXILIARES ---------------------------*/
	...
	registrarAccionesEventos() {	
		...
		jQuery(document).ready(function() {
			...
			funcionGeneralEventoJQuery.setBotonRecargarInformacionClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonGuardarCambiosClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonGuardarCambiosFormularioClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
			
			funcionGeneralEventoJQuery.setBotonSeleccionarLoteFkClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
			
			funcionGeneralEventoJQuery.setBotonAnterioresClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonSiguientesClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonNuevoPrepararClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
			
			funcionGeneralEventoJQuery.setBotonNuevoTablaPrepararClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);				
			
			funcionGeneralEventoJQuery.setBotonDuplicarClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonCopiarClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);
			
			funcionGeneralEventoJQuery.setImagenNuevoPrepararRegistreseClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);
			
			funcionGeneralEventoJQuery.setBotonOrderByClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);
			
			funcionGeneralEventoJQuery.setImagenCerrarSesionClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);			
			
			//IMPRIMIR SOLO TABLA DATOS
			funcionGeneralEventoJQuery.setBotonImprimirPaginaClic("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);			
			
			//TIPOS COLUMNAS
			funcionGeneralEventoJQuery.setComboTiposColumnas(cuenta_cobrar_detalle_funcion1);						
			//TIPOS COLUMNAS
			
			funcionGeneralEventoJQuery.setCheckSeleccionarTodosChange("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);
			
			funcionGeneralEventoJQuery.setCheckConAltoMaximoTablaChange("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);			
			
			funcionGeneralEventoJQuery.setCheckConEditarChange("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1);			
			
			

			funcionGeneralEventoJQuery.setBotonBuscarClic("cuenta_cobrar_detalle","FK_Idcuenta_cobrar","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);

			funcionGeneralEventoJQuery.setBotonBuscarClic("cuenta_cobrar_detalle","FK_Idejercicio","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);

			funcionGeneralEventoJQuery.setBotonBuscarClic("cuenta_cobrar_detalle","FK_Idempresa","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);

			funcionGeneralEventoJQuery.setBotonBuscarClic("cuenta_cobrar_detalle","FK_Idestado","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);

			funcionGeneralEventoJQuery.setBotonBuscarClic("cuenta_cobrar_detalle","FK_Idperiodo","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);

			funcionGeneralEventoJQuery.setBotonBuscarClic("cuenta_cobrar_detalle","FK_Idsucursal","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);

			funcionGeneralEventoJQuery.setBotonBuscarClic("cuenta_cobrar_detalle","FK_Idusuario","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,cuenta_cobrar_detalle_constante1);
		
			
			if(cuenta_cobrar_detalle_constante1.BIT_ES_PAGINA_PRINCIPAL==true) { // NO FORM
				//LLAMADO EN ONLOADWINDOW	
				funcionGeneralEventoJQuery.setWindowUnload("cuenta_cobrar_detalle","cuentascobrar","",cuenta_cobrar_detalle_funcion1,cuenta_cobrar_detalle_webcontrol1,window);
			}
...
/*---------------------------------- AREA:PAGINA ---------------------------*/
	...
	actualizarCssBotonesPagina(cuenta_cobrar_detalle_control) {
		...
		jQuery("#tdGenerarReportecuenta_cobrar_detalle").css("display",cuenta_cobrar_detalle_control.strPermisoReporte);			
		jQuery("#tdMostrarTodoscuenta_cobrar_detalle").attr("style",cuenta_cobrar_detalle_control.strPermisoMostrarTodos);		
		
		if(cuenta_cobrar_detalle_control.strPermisoNuevo!=null) {
			jQuery("#tdcuenta_cobrar_detalleNuevo").css("display",cuenta_cobrar_detalle_control.strPermisoNuevo);
			jQuery("#tdcuenta_cobrar_detalleNuevoToolBar").css("display",cuenta_cobrar_detalle_control.strPermisoNuevo.replace("row","cell"));			
			jQuery("#tdcuenta_cobrar_detalleDuplicar").css("display",cuenta_cobrar_detalle_control.strPermisoNuevo.replace("row","cell"));
			jQuery("#tdcuenta_cobrar_detalleDuplicarToolBar").css("display",cuenta_cobrar_detalle_control.strPermisoNuevo.replace("row","cell"));
			jQuery("#tdcuenta_cobrar_detalleNuevoGuardarCambios").css("display",cuenta_cobrar_detalle_control.strPermisoNuevo);
			jQuery("#tdcuenta_cobrar_detalleNuevoGuardarCambiosToolBar").css("display",cuenta_cobrar_detalle_control.strPermisoNuevo.replace("row","cell"));
		}
		
		if(cuenta_cobrar_detalle_control.strPermisoActualizar!=null) {
			jQuery("#tdcuenta_cobrar_detalleCopiar").css("display",cuenta_cobrar_detalle_control.strPermisoActualizar.replace("row","cell"));
			jQuery("#tdcuenta_cobrar_detalleCopiarToolBar").css("display",cuenta_cobrar_detalle_control.strPermisoActualizar.replace("row","cell"));
			jQuery("#tdcuenta_cobrar_detalleConEditar").css("display",cuenta_cobrar_detalle_control.strPermisoActualizar);
		}
		
		jQuery("#tdcuenta_cobrar_detalleGuardarCambios").css("display",cuenta_cobrar_detalle_control.strPermisoGuardar.replace("row","cell"));
		jQuery("#tdcuenta_cobrar_detalleGuardarCambiosToolBar").css("display",cuenta_cobrar_detalle_control.strPermisoGuardar.replace("row","cell"));
