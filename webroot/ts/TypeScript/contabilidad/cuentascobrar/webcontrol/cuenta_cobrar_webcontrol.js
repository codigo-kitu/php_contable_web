...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cuenta_cobrar_control) {
		...
		jQuery("#t-cel_"+i+"_10").val(cuenta_cobrar_control.cuenta_cobrarActual.fecha_emision);
		jQuery("#t-cel_"+i+"_11").val(cuenta_cobrar_control.cuenta_cobrarActual.fecha_vence);
		jQuery("#t-cel_"+i+"_12").val(cuenta_cobrar_control.cuenta_cobrarActual.fecha_ultimo_movimiento);
		...
		if(cuenta_cobrar_control.cuenta_cobrarActual.id_termino_pago_cliente!=null && cuenta_cobrar_control.cuenta_cobrarActual.id_termino_pago_cliente>-1){
			if(jQuery("#t-cel_"+i+"_13").val() != cuenta_cobrar_control.cuenta_cobrarActual.id_termino_pago_cliente) {
				jQuery("#t-cel_"+i+"_13").val(cuenta_cobrar_control.cuenta_cobrarActual.id_termino_pago_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_19").val(cuenta_cobrar_control.cuenta_cobrarActual.referencia);
	}
