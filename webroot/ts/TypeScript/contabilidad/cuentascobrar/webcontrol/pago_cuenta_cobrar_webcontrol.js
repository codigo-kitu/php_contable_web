...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(pago_cuenta_cobrar_control) {
		...
		if(pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.id_forma_pago_cliente!=null && pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.id_forma_pago_cliente>-1){
			if(jQuery("#t-cel_"+i+"_9").val() != pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.id_forma_pago_cliente) {
				jQuery("#t-cel_"+i+"_9").val(pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.id_forma_pago_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_10").val(pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.fecha_emision);
		jQuery("#t-cel_"+i+"_11").val(pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.fecha_vence);
		...
		jQuery("#t-cel_"+i+"_14").val(pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.descripcion);
		...
		if(pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.id_estado!=null && pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.id_estado>-1){
			if(jQuery("#t-cel_"+i+"_15").val() != pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.id_estado) {
				jQuery("#t-cel_"+i+"_15").val(pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.id_estado).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_16").val(pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.referencia);
		jQuery("#t-cel_"+i+"_17").val(pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.debito);
		jQuery("#t-cel_"+i+"_18").val(pago_cuenta_cobrar_control.pago_cuenta_cobrarActual.credito);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosforma_pago_clientesFK(pago_cuenta_cobrar_control) {
		...
		if(pago_cuenta_cobrar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+pago_cuenta_cobrar_control.idFilaTablaActual+"_9",pago_cuenta_cobrar_control.forma_pago_clientesFK);
		}
	...
	cargarCombosestadosFK(pago_cuenta_cobrar_control) {
		...
		if(pago_cuenta_cobrar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+pago_cuenta_cobrar_control.idFilaTablaActual+"_15",pago_cuenta_cobrar_control.estadosFK);
		}
