...
//Funciones Manejadores Accion
	...
	*/
	...
	actualizarCamposFormulario(parametro_cuenta_cobrar_control) {
		...
		jQuery("#form"+parametro_cuenta_cobrar_constante1.STR_SUFIJO+"-version_row").val(parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.versionRow);
	...
	actualizarSpanMensajesCampos(parametro_cuenta_cobrar_control) {
		...
		jQuery("#spanstrMensajeversion_row").text(parametro_cuenta_cobrar_control.strMensajeversion_row);		
