...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(termino_pago_cliente_control) {
		...
		if(termino_pago_cliente_control.termino_pago_clienteActual.id_cuenta!=null && termino_pago_cliente_control.termino_pago_clienteActual.id_cuenta>-1){
			if(jQuery("#t-cel_"+i+"_12").val() != termino_pago_cliente_control.termino_pago_clienteActual.id_cuenta) {
				jQuery("#t-cel_"+i+"_12").val(termino_pago_cliente_control.termino_pago_clienteActual.id_cuenta).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_13").val(termino_pago_cliente_control.termino_pago_clienteActual.cuenta_contable);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarComboscuentasFK(termino_pago_cliente_control) {
		...
		if(termino_pago_cliente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+termino_pago_cliente_control.idFilaTablaActual+"_12",termino_pago_cliente_control.cuentasFK);
		}
