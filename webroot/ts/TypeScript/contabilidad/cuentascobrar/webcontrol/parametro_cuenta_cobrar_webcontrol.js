...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(parametro_cuenta_cobrar_control) {
		...
		if(parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.id_empresa!=null && parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_2").val() != parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.id_empresa) {
				jQuery("#t-cel_"+i+"_2").val(parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_3").val(parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.numero_cuenta_cobrar);
		jQuery("#t-cel_"+i+"_4").val(parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.numero_debito);
		jQuery("#t-cel_"+i+"_5").val(parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.numero_credito);
		jQuery("#t-cel_"+i+"_6").val(parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.numero_pago);
		jQuery("#t-cel_"+i+"_7").prop('checked',parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.mostrar_anulado);
		jQuery("#t-cel_"+i+"_8").val(parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.numero_cliente);
		jQuery("#t-cel_"+i+"_9").prop('checked',parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.con_cliente_inactivo);
		jQuery("#t-cel_"+i+"_10").val(parametro_cuenta_cobrar_control.parametro_cuenta_cobrarActual.nombre_registro_tributario);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosempresasFK(parametro_cuenta_cobrar_control) {
		...
		if(parametro_cuenta_cobrar_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+parametro_cuenta_cobrar_control.idFilaTablaActual+"_2",parametro_cuenta_cobrar_control.empresasFK);
		}
	};
