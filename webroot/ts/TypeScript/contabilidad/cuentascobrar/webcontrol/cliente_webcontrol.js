...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cliente_control) {
		...
		if(cliente_control.clienteActual.id_tipo_persona!=null && cliente_control.clienteActual.id_tipo_persona>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != cliente_control.clienteActual.id_tipo_persona) {
				jQuery("#t-cel_"+i+"_3").val(cliente_control.clienteActual.id_tipo_persona).trigger("change");
			}
		} else { 
		...
		if(cliente_control.clienteActual.id_categoria_cliente!=null && cliente_control.clienteActual.id_categoria_cliente>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != cliente_control.clienteActual.id_categoria_cliente) {
				jQuery("#t-cel_"+i+"_4").val(cliente_control.clienteActual.id_categoria_cliente).trigger("change");
			}
		} else { 
		...
		if(cliente_control.clienteActual.id_tipo_precio!=null && cliente_control.clienteActual.id_tipo_precio>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != cliente_control.clienteActual.id_tipo_precio) {
				jQuery("#t-cel_"+i+"_5").val(cliente_control.clienteActual.id_tipo_precio).trigger("change");
			}
		} else { 
		...
		if(cliente_control.clienteActual.id_giro_negocio_cliente!=null && cliente_control.clienteActual.id_giro_negocio_cliente>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != cliente_control.clienteActual.id_giro_negocio_cliente) {
				jQuery("#t-cel_"+i+"_6").val(cliente_control.clienteActual.id_giro_negocio_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_7").val(cliente_control.clienteActual.codigo);
		jQuery("#t-cel_"+i+"_8").val(cliente_control.clienteActual.ruc);
		...
		jQuery("#t-cel_"+i+"_35").val(cliente_control.clienteActual.facturar_con);
		jQuery("#t-cel_"+i+"_36").prop('checked',cliente_control.clienteActual.aplica_impuesto_ventas);
		
		if(cliente_control.clienteActual.id_impuesto!=null && cliente_control.clienteActual.id_impuesto>-1){
			if(jQuery("#t-cel_"+i+"_37").val() != cliente_control.clienteActual.id_impuesto) {
				jQuery("#t-cel_"+i+"_37").val(cliente_control.clienteActual.id_impuesto).trigger("change");
			}
		} else { 
			//jQuery("#t-cel_"+i+"_37").select2("val", null);
		...
		if(cliente_control.clienteActual.id_retencion!=null && cliente_control.clienteActual.id_retencion>-1){
			if(jQuery("#t-cel_"+i+"_39").val() != cliente_control.clienteActual.id_retencion) {
				jQuery("#t-cel_"+i+"_39").val(cliente_control.clienteActual.id_retencion).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_40").prop('checked',cliente_control.clienteActual.aplica_retencion_fuente);
		
		if(cliente_control.clienteActual.id_retencion_fuente!=null && cliente_control.clienteActual.id_retencion_fuente>-1){
			if(jQuery("#t-cel_"+i+"_41").val() != cliente_control.clienteActual.id_retencion_fuente) {
				jQuery("#t-cel_"+i+"_41").val(cliente_control.clienteActual.id_retencion_fuente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_42").prop('checked',cliente_control.clienteActual.aplica_retencion_ica);
		
		if(cliente_control.clienteActual.id_retencion_ica!=null && cliente_control.clienteActual.id_retencion_ica>-1){
			if(jQuery("#t-cel_"+i+"_43").val() != cliente_control.clienteActual.id_retencion_ica) {
				jQuery("#t-cel_"+i+"_43").val(cliente_control.clienteActual.id_retencion_ica).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_44").prop('checked',cliente_control.clienteActual.aplica_2do_impuesto);
		
		if(cliente_control.clienteActual.id_otro_impuesto!=null && cliente_control.clienteActual.id_otro_impuesto>-1){
			if(jQuery("#t-cel_"+i+"_45").val() != cliente_control.clienteActual.id_otro_impuesto) {
				jQuery("#t-cel_"+i+"_45").val(cliente_control.clienteActual.id_otro_impuesto).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_46").val(cliente_control.clienteActual.creado);
		jQuery("#t-cel_"+i+"_47").val(cliente_control.clienteActual.monto_ultima_transaccion);
		jQuery("#t-cel_"+i+"_48").val(cliente_control.clienteActual.fecha_ultima_transaccion);
		jQuery("#t-cel_"+i+"_49").val(cliente_control.clienteActual.descripcion_ultima_transaccion);
	}
