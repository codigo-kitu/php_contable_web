...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(parametro_sql_constante1.STR_RELATIVE_PATH,"parametro_sql");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(parametro_sql_constante1.STR_RELATIVE_PATH,parametro_sql_constante1.STR_NOMBRE_OPCION,"parametro_sql");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(parametro_sql_constante1.STR_RELATIVE_PATH,parametro_sql_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(parametro_sql_control,parametro_sql_webcontrol1,parametro_sql_constante1) {
		
		var strSuf=parametro_sql_constante1.STR_SUFIJO;
		...
		jQuery("#frmTablaDatosparametro_sql").validate(json_rules);
