...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(archivo_constante1.STR_RELATIVE_PATH,"archivo");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(archivo_constante1.STR_RELATIVE_PATH,archivo_constante1.STR_NOMBRE_OPCION,"archivo");		
	}	
...
//---------- Clic-Seleccionar ----------
	...
	seleccionarMostrarDivAccionesRelacionesActualOnComplete() {
		funcionGeneral.seleccionarMostrarDivAccionesRelacionesActualOnComplete("archivo",this,archivo_constante1);
	}
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(archivo_constante1.STR_RELATIVE_PATH,archivo_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(archivo_control,archivo_webcontrol1,archivo_constante1) {
		
		var strSuf=archivo_constante1.STR_SUFIJO;
		...
		jQuery("#frmTablaDatosarchivo").validate(json_rules);
