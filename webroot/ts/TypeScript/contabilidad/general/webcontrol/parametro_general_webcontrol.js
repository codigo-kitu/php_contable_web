...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(parametro_general_control) {
		...
		if(parametro_general_control.parametro_generalActual.id_modena!=null && parametro_general_control.parametro_generalActual.id_modena>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != parametro_general_control.parametro_generalActual.id_modena) {
				jQuery("#t-cel_"+i+"_4").val(parametro_general_control.parametro_generalActual.id_modena).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_5").val(parametro_general_control.parametro_generalActual.simbolo_moneda);
		jQuery("#t-cel_"+i+"_6").val(parametro_general_control.parametro_generalActual.numero_decimales);
		jQuery("#t-cel_"+i+"_7").prop('checked',parametro_general_control.parametro_generalActual.con_formato_fecha_mda);
		jQuery("#t-cel_"+i+"_8").prop('checked',parametro_general_control.parametro_generalActual.con_formato_cantidad_coma);
		jQuery("#t-cel_"+i+"_9").val(parametro_general_control.parametro_generalActual.iva_porciento);
	}
