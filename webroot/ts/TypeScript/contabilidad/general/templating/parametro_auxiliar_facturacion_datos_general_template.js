		...
		{{#if (Is_List_Exist parametro_auxiliar_facturacionsLocal)}}
			{{#each parametro_auxiliar_facturacionsLocal}}
				...
				{{/if}}
					...
					<td class="elementotabla col_con_creacion_rapida_producto" >{{{ getCheckBox con_creacion_rapida_producto 'form-con_creacion_rapida_productoi' ../paraReporte }}}
					</td>
				
					<td class="elementotabla col_con_busqueda_producto_fabricante" >{{{ getCheckBox con_busqueda_producto_fabricante 'form-con_busqueda_producto_fabricantei' ../paraReporte }}}
					</td>
				
					<td class="elementotabla col_con_solo_costo_producto" >{{{ getCheckBox con_solo_costo_producto 'form-con_solo_costo_productoi' ../paraReporte }}}
					</td>
					...
					<td class="elementotabla col_con_impuesto_final_boleta" >{{{ getCheckBox con_impuesto_final_boleta 'form-con_impuesto_final_boletai' ../paraReporte }}}
					</td>
				
					<td class="elementotabla col_con_ticket" >{{{ getCheckBox con_ticket 'form-con_ticketi' ../paraReporte }}}
					</td>
					...
					<td class="elementotabla col_con_impuesto_final_ticket" >{{{ getCheckBox con_impuesto_final_ticket 'form-con_impuesto_final_ticketi' ../paraReporte }}}
					</td>
