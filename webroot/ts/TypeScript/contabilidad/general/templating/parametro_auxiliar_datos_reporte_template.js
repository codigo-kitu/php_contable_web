		...
		{{#if (Is_List_Exist parametro_auxiliarsLocal)}}
			{{#each parametro_auxiliarsLocal}}
				...
				{{#if (ValCol 'Mostrar Solo Costo Producto' ../paraReporte)}}
					...
					<td class="elementotabla col_mostrar_solo_costo_producto" >{{{ getCheckBox mostrar_solo_costo_producto 'form-mostrar_solo_costo_productoi' ../paraReporte }}}
					</td>
				{{/if}}

				{{#if (ValCol 'Con Codigo Secuencial Producto' ../paraReporte)}}
				
					<td class="elementotabla col_con_codigo_secuencial_producto" >{{{ getCheckBox con_codigo_secuencial_producto 'form-con_codigo_secuencial_productoi' ../paraReporte }}}
					</td>
				{{/if}}
				...
				{{#if (ValCol 'Con Busqueda Incremental' ../paraReporte)}}
					...
					<td class="elementotabla col_con_busqueda_incremental" >{{{ getCheckBox con_busqueda_incremental 'form-con_busqueda_incrementali' ../paraReporte }}}
					</td>
				{{/if}}

				{{#if (ValCol 'Permitir Revisar Asiento' ../paraReporte)}}
				
					<td class="elementotabla col_permitir_revisar_asiento" >{{{ getCheckBox permitir_revisar_asiento 'form-permitir_revisar_asientoi' ../paraReporte }}}
					</td>
				{{/if}}
				...
				{{#if (ValCol 'Mostrar Documento Anulado' ../paraReporte)}}
					...
					<td class="elementotabla col_mostrar_documento_anulado" >{{{ getCheckBox mostrar_documento_anulado 'form-mostrar_documento_anuladoi' ../paraReporte }}}
					</td>
				{{/if}}
				...
				{{#if (ValCol 'Con Asiento Simple Factura' ../paraReporte)}}
					...
					<td class="elementotabla col_con_asiento_simple_factura" >{{{ getCheckBox con_asiento_simple_factura 'form-con_asiento_simple_facturai' ../paraReporte }}}
					</td>
				{{/if}}

				{{#if (ValCol 'Con Codigo Secuencial Cliente' ../paraReporte)}}
				
					<td class="elementotabla col_con_codigo_secuencial_cliente" >{{{ getCheckBox con_codigo_secuencial_cliente 'form-con_codigo_secuencial_clientei' ../paraReporte }}}
					</td>
				{{/if}}
				...
				{{#if (ValCol 'Con Codigo Secuencial Proveedor' ../paraReporte)}}
					...
					<td class="elementotabla col_con_codigo_secuencial_proveedor" >{{{ getCheckBox con_codigo_secuencial_proveedor 'form-con_codigo_secuencial_proveedori' ../paraReporte }}}
					</td>
				{{/if}}
				...
				{{#if (ValCol 'Con Asiento Cheque' ../paraReporte)}}
					...
					<td class="elementotabla col_con_asiento_cheque" >{{{ getCheckBox con_asiento_cheque 'form-con_asiento_chequei' ../paraReporte }}}
					</td>
				{{/if}}
