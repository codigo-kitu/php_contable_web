...
<script id="tabla_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliartablasAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each tablasReporte}}

			<table id="tabletabla{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
		...
		{{#if (Is_List_Exist cuenta_corriente_detalles)}}
			{{#each cuenta_corriente_detalles}}
				...
				<td class="elementotabla col_id_cuenta_corriente" > {{id_cuenta_corriente_Descripcion}}</td>
					...
					<td class="elementotabla col_es_cheque" >{{{ getCheckBox es_cheque 'form-es_chequei' ../paraReporte }}}
					</td>
				
					<td class="elementotabla col_es_deposito" >{{{ getCheckBox es_deposito 'form-es_depositoi' ../paraReporte }}}
					</td>
				
					<td class="elementotabla col_es_retiro" >{{{ getCheckBox es_retiro 'form-es_retiroi' ../paraReporte }}}
					</td>
		...
		{{#if (Is_List_Exist costo_productos)}}
			{{#each costo_productos}}
