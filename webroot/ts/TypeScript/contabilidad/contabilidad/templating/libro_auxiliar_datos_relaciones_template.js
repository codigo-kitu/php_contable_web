...
<script id="libro_auxiliar_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarlibro_auxiliarsAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each libro_auxiliarsReporte}}

			<table id="tablelibro_auxiliar{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Iniciales' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Secuencial' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Reinicia Secuencial Mes' ../arrOrderBy ../bitParaReporteOrderBy) }}
				...
				<tr>
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								<td width="20%" {{../strAuxStyleBackgroundContenidoCabecera}} >
									<b>- Reinicia Secuencial Mes</b>
								</td>
								<td>{{ getCheckBox reinicia_secuencial_mes 'none' true}}
								</td>
							</tr>
						</table>
					</td>
			...
			{{#if (existeCadenaArrayOrderBy 'Generado Por' ../arrOrderBy ../bitParaReporteOrderBy) }}
		...
		{{#if (Is_List_Exist contador_auxiliars)}}
			{{#each contador_auxiliars}}
		...
		<form id="frmTablaDatosasiento_automatico" name="frmTablaDatosasiento_automatico">
			<div id="divTablaDatosAuxiliarasiento_automaticosAjaxWebPart" style="{{style_div}}">

				<input type="hidden" id="t{{strSufijo}}-maxima_fila" name="t{{strSufijo}}-maxima_fila" value="{{count asiento_automaticos}}">
		...
		<table id="tblTablaDatosasiento_automaticos" name="tblTablaDatosasiento_automaticos" class="{{class_table}}" cellpadding="3" cellspacing="3" style="{{style_tabla}}" border="1" rules="rows">
		...
		{{#if (Is_List_Exist asiento_automaticos)}}
			{{#each asiento_automaticos}}
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarasiento_automatico" idactualasiento_automatico="{{id}}" title="SELECCIONAR Asiento Automatico ACTUAL" src="{{../PATH_IMAGEN}}/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_eli col_id"  style="display:{{../strPermisoEliminar}}">
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgeliminartablaasiento_automatico" idactualasiento_automatico="{{id}}" title="ELIMINAR Asiento Automatico ACTUAL" src="{{../PATH_IMAGEN}}/Imagenes/eliminar.gif" alt="Eliminar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_{{i}}" name="t-id_{{i}}" type="checkbox" class="chkb_id" title="SELECCIONAR Asiento Automatico ACTUAL" value="{{id}}"></input>
							</td>
							<td>
								{{i}}
							</td>
				...
				<td class="elementotabla columna_tabla_selrel col_id"  style="display:{{../strPermisoRelaciones}}">
					<a>
						{{id}}<img class="imgseleccionarmostraraccionesrelacionesasiento_automatico" idactualasiento_automatico="{{id}}" title="DATOS RELACIONADOS" src="{{../PATH_IMAGEN}}/Imagenes/ejecutar_acciones.gif" alt="Ver" border="0" height="15" width="15">
					</a>
				</td>
				...
				{{/if}}
				<td class="elementotabla col_id_modulo" > {{id_modulo_Descripcion}}</td>
				...
				{{#if (If_Not_AND_Not ../bitEsBusqueda  ../bitEsRelaciones)}}
					...
					<td class="elementotabla"  align="center" style="display:table-cell">
						<a>{{id}}
							<img class="imgrelacionasiento_automatico_detalle" idactualasiento_automatico="{{id}}" title="Detalle Asiento AutomaticoS DE Asiento Automatico" src="{{PATH_IMAGEN}}/Imagenes/asiento_automatico_detalles.gif" alt="Seleccionar" border="" height="15" width="15">
						</a>
					</td>
		...
		<form id="frmTablaDatosasiento_predefinido" name="frmTablaDatosasiento_predefinido">
			<div id="divTablaDatosAuxiliarasiento_predefinidosAjaxWebPart" style="{{style_div}}">

				<input type="hidden" id="t{{strSufijo}}-maxima_fila" name="t{{strSufijo}}-maxima_fila" value="{{count asiento_predefinidos}}">
		...
		<table id="tblTablaDatosasiento_predefinidos" name="tblTablaDatosasiento_predefinidos" class="{{class_table}}" cellpadding="3" cellspacing="3" style="{{style_tabla}}" border="1" rules="rows">
		...
		{{#if IS_DEVELOPING}}
			...
			<th class="cabecera_titulo_tabla" >
				<pre class="cabecera_texto_titulo_tabla">Empresa<a onclick="jQuery('#form-id_empresa_img').trigger('click' );"><img id="form{{strSufijo}}-id_empresa_img2" name="form{{strSufijo}}-id_empresa_img2" class="imagen_actualizar" title="ACTUALIZAR DATOS RELACIONADOS" src="{{PATH_IMAGEN}}Imagenes/actualizardatos.gif" alt="Actualizar Datos" border="" height="15" width="15"></a><a onclick="asiento_predefinido_webcontrol1.abrirBusquedaParaempresa('id_empresa');"><img id="form{{strSufijo}}-id_empresa_img_busqueda2" name="form{{strSufijo}}-id_empresa_img_busqueda2" title="Buscar Empresa" style="width: 15px; height: 15px;text-align: center; visibility:visible;" src="{{PATH_IMAGEN}}Imagenes/buscar.gif" width="15" height="15"/></a></pre>
			</th>
		{{/if}}
		...
		{{#if (Is_List_Exist asiento_predefinidos)}}
			{{#each asiento_predefinidos}}
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarasiento_predefinido" idactualasiento_predefinido="{{id}}" title="SELECCIONAR Asiento Predefinido ACTUAL" src="{{../PATH_IMAGEN}}/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_eli col_id"  style="display:{{../strPermisoEliminar}}">
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgeliminartablaasiento_predefinido" idactualasiento_predefinido="{{id}}" title="ELIMINAR Asiento Predefinido ACTUAL" src="{{../PATH_IMAGEN}}/Imagenes/eliminar.gif" alt="Eliminar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_{{i}}" name="t-id_{{i}}" type="checkbox" class="chkb_id" title="SELECCIONAR Asiento Predefinido ACTUAL" value="{{id}}"></input>
							</td>
							<td>
								{{i}}
							</td>
				...
				<td class="elementotabla columna_tabla_selrel col_id"  style="display:{{../strPermisoRelaciones}}">
					<a>
						{{id}}<img class="imgseleccionarmostraraccionesrelacionesasiento_predefinido" idactualasiento_predefinido="{{id}}" title="DATOS RELACIONADOS" src="{{../PATH_IMAGEN}}/Imagenes/ejecutar_acciones.gif" alt="Ver" border="0" height="15" width="15">
					</a>
				</td>
				...
				{{#if (If_Not_AND_Not ../bitEsBusqueda  ../bitEsRelaciones)}}
					...
					<td class="elementotabla"  align="center" style="display:table-cell">
						<a>{{id}}
							<img class="imgrelacionasiento" idactualasiento_predefinido="{{id}}" title="AsientoS DE Asiento Predefinido" src="{{PATH_IMAGEN}}/Imagenes/asientos.gif" alt="Seleccionar" border="" height="15" width="15">
						</a>
					</td>
					...
					<td class="elementotabla"  align="center" style="display:table-cell">
						<a>{{id}}
							<img class="imgrelacionasiento_predefinido_detalle" idactualasiento_predefinido="{{id}}" title="Detalle Asiento PredefinidoS DE Asiento Predefinido" src="{{PATH_IMAGEN}}/Imagenes/asiento_predefinido_detalles.gif" alt="Seleccionar" border="" height="15" width="15">
						</a>
					</td>
