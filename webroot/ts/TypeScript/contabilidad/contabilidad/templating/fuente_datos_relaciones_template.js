...
<script id="fuente_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarfuentesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each fuentesReporte}}

			<table id="tablefuente{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
