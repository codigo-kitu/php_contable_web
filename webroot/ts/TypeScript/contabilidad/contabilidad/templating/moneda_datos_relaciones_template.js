...
<script id="moneda_datos_relaciones_template" type="text/x-handlebars-template">
...
{{#each monedasReporte}}
		...
		{{#if (Is_List_Exist parametro_generals)}}
			{{#each parametro_generals}}
				...
				<td class="elementotabla col_id_modena" > {{id_modena_Descripcion}}</td>
					...
					<td class="elementotabla col_con_formato_fecha_mda" >{{{ getCheckBox con_formato_fecha_mda 'form-con_formato_fecha_mdai' ../paraReporte }}}
					</td>
				
					<td class="elementotabla col_con_formato_cantidad_coma" >{{{ getCheckBox con_formato_cantidad_coma 'form-con_formato_cantidad_comai' ../paraReporte }}}
					</td>
		...
		{{#if (Is_List_Exist factura_modelos)}}
			{{#each factura_modelos}}
				...
				<td class="elementotabla col_id_cliente" > {{id_cliente_Descripcion}}</td>
					...
					<td class="elementotabla col_marcado" >{{{ getCheckBox marcado 'form-marcadoi' ../paraReporte }}}
					</td>
