...
<script id="centro_costo_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarcentro_costosAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each centro_costosReporte}}

			<table id="tablecentro_costo{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
