...
<script id="asiento_predefinido_detalle_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarasiento_predefinido_detallesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each asiento_predefinido_detallesReporte}}

			<table id="tableasiento_predefinido_detalle{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
