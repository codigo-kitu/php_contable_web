...
//---------- Clic-Buscar-Auxiliar ----------
	...
	procesarInicioBusqueda() {
		funcionGeneral.procesarInicioBusquedaPrincipal(periodo_constante1.STR_RELATIVE_PATH,"periodo");		
	}
	
	procesarFinalizacionBusqueda() {
		funcionGeneral.procesarFinalizacionBusquedaPrincipal(periodo_constante1.STR_RELATIVE_PATH,periodo_constante1.STR_NOMBRE_OPCION,"periodo");		
	}	
...
//---------- Clic-Reporte ----------------
	...
	generarReporteFinalizacion() {
		funcionGeneral.generarReporteFinalizacion(periodo_constante1.STR_RELATIVE_PATH,periodo_constante1.STR_NOMBRE_OPCION);
	}
...
//------------- Tabla-Validacion -------------------
	...
	registrarControlesTableValidacionEdition(periodo_control,periodo_webcontrol1,periodo_constante1) {
		
		var strSuf=periodo_constante1.STR_SUFIJO;
		...
		jQuery("#frmTablaDatosperiodo").validate(json_rules);
