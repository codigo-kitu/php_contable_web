...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(cuenta_control) {
		...
		jQuery("#t-cel_"+i+"_9").prop('checked',cuenta_control.cuentaActual.usa_monto_base);
		jQuery("#t-cel_"+i+"_10").val(cuenta_control.cuentaActual.monto_base);
		jQuery("#t-cel_"+i+"_11").val(cuenta_control.cuentaActual.porcentaje_base);
		jQuery("#t-cel_"+i+"_12").prop('checked',cuenta_control.cuentaActual.con_centro_costos);
		jQuery("#t-cel_"+i+"_13").prop('checked',cuenta_control.cuentaActual.con_ruc);
		jQuery("#t-cel_"+i+"_14").val(cuenta_control.cuentaActual.balance);
		jQuery("#t-cel_"+i+"_15").val(cuenta_control.cuentaActual.descripcion);
		jQuery("#t-cel_"+i+"_16").prop('checked',cuenta_control.cuentaActual.con_retencion);
		jQuery("#t-cel_"+i+"_17").val(cuenta_control.cuentaActual.valor_retencion);
		jQuery("#t-cel_"+i+"_18").val(cuenta_control.cuentaActual.ultima_transaccion);
	}
	...
	registrarTablaAcciones() {
		...
		//SE PIERDE CON PAGINACION DATATABLES O PAGINACION CLIENTE
		//jQuery(".imgrelacionproducto_costo").click(function(){
		jQuery("#tblTablaDatoscuentas").on("click",".imgrelacionproducto_costo", function () {

			var idActual=jQuery(this).attr("idactualcuenta");

			cuenta_webcontrol1.registrarSesion_costoParaproductos(idActual);
		});
	...
	registrarSesion_costoParaproductos(idActual){

		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"cuenta","producto","contabilidad","",cuenta_funcion1,cuenta_webcontrol1,cuenta_constante1,"s","_costo");
	}
	...
	registrarSesion_comprasPararetencion_icas(idActual){
		...
		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"cuenta","retencion_ica","contabilidad","",cuenta_funcion1,cuenta_webcontrol1,cuenta_constante1,"s","_compras");
	}

	registrarSesion_comprasParainstrumento_pagos(idActual){

		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"cuenta","instrumento_pago","contabilidad","",cuenta_funcion1,cuenta_webcontrol1,cuenta_constante1,"s","_compras");
	}
	...
	registrarSesion_inventarioParalista_productoes(idActual){
		...
		funcionGeneralEventoJQuery.registrarSesionMaestroParaDetalle(idActual,"cuenta","lista_producto","contabilidad","",cuenta_funcion1,cuenta_webcontrol1,cuenta_constante1,"es","_inventario");
	}
