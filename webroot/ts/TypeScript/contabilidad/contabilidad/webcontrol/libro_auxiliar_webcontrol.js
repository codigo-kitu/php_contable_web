...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(libro_auxiliar_control) {
		...
		jQuery("#t-cel_"+i+"_7").prop('checked',libro_auxiliar_control.libro_auxiliarActual.reinicia_secuencial_mes);
		jQuery("#t-cel_"+i+"_8").val(libro_auxiliar_control.libro_auxiliarActual.generado_por);
	}
