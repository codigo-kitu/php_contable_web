...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(parametro_contabilidad_control) {
		...
		if(parametro_contabilidad_control.parametro_contabilidadActual.id_empresa!=null && parametro_contabilidad_control.parametro_contabilidadActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_2").val() != parametro_contabilidad_control.parametro_contabilidadActual.id_empresa) {
				jQuery("#t-cel_"+i+"_2").val(parametro_contabilidad_control.parametro_contabilidadActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_3").val(parametro_contabilidad_control.parametro_contabilidadActual.numero_asiento);
		jQuery("#t-cel_"+i+"_4").prop('checked',parametro_contabilidad_control.parametro_contabilidadActual.con_asiento_simple_facturacion);
		jQuery("#t-cel_"+i+"_5").prop('checked',parametro_contabilidad_control.parametro_contabilidadActual.con_eliminacion_fisica_asiento);
	}
