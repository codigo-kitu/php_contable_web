...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(moneda_control) {
		...
		if(moneda_control.monedaActual.id_empresa!=null && moneda_control.monedaActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_2").val() != moneda_control.monedaActual.id_empresa) {
				jQuery("#t-cel_"+i+"_2").val(moneda_control.monedaActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_3").val(moneda_control.monedaActual.codigo);
		jQuery("#t-cel_"+i+"_4").val(moneda_control.monedaActual.nombre);
		jQuery("#t-cel_"+i+"_5").val(moneda_control.monedaActual.simbolo);
	}
