...
<script id="consignacion_detalle_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarconsignacion_detallesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each consignacion_detallesReporte}}

			<table id="tableconsignacion_detalle{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Consignacion' ../arrOrderBy ../bitParaReporteOrderBy) }}
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								...
								<td>{{trim id_consignacion_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
