...
class consignacion_detalle_funcion extends GeneralEntityFuncion {
...
//---------- Clic-Nuevo --------------
	...
	nuevoOnClick() {
		//super.procesarInicioProceso(consignacion_detalle_constante1);
	}
	
	nuevoOnComplete() {
		//super.procesarFinalizacionProceso(consignacion_detalle_constante1,"consignacion_detalle");
	}
	
	nuevoPrepararPaginaFormOnClick() {
		super.resaltarRestaurarDivMantenimiento(true,"consignacion_detalle");
...
//------------- Clic-Actualizar -------------
	...
	actualizarOnComplete() {
		...
		if(super.esPaginaForm(consignacion_detalle_constante1)==true) {
...
//------------- Clic-Cancelar -------------------
	...
	cancelarOnComplete() {
		super.resaltarRestaurarDivMantenimiento(false,"consignacion_detalle");
	...
	cancelarControles() {
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientoconsignacion_detalle.txtobservacion);
		...
		funcionGeneral.setEmptyControl(document.frmMantenimientoconsignacion_detalle.txtcotizacion);
		...
		*/
		...
		if(consignacion_detalle_constante1.STR_SUFIJO=="") {
			...
			arrRules= {
				...
				"form_consignacion_detalle-observacion": {
					maxlength:1000
					,regexpStringMethod:true
				},
				...
				"form_consignacion_detalle-cotizacion": {
					required:true,
					number:true
				},
				...
				messages: {
					...
					"form_consignacion_detalle-observacion": ""+constantes.STR_MENSAJE_TEXTO_INCORRECTO,
					...
					"form_consignacion_detalle-cotizacion": constantes.STR_MENSAJE_REQUERIDO+""+constantes.STR_MENSAJE_DECIMAL_INCORRECTO,
...
/*---------------------------------- AREA:AUXILIAR ---------------------------*/
	...
	habilitarDeshabilitarControles(bitEsHabilitar) {
		if(bitEsHabilitar==true) {
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoconsignacion_detalle.txtobservacion,false);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoconsignacion_detalle.txtcotizacion,false);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoconsignacion_detalle.txtobservacion,true);
			...
			funcionGeneral.setReadOnlyControl(document.frmMantenimientoconsignacion_detalle.txtcotizacion,true);
	...
	procesarFinalizacionProcesoAbrirLink() {
		super.procesarFinalizacionProcesoAbrirLink(consignacion_detalle_constante1,"consignacion_detalle");
	}
	
	procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink) {
		super.procesarFinalizacionProcesoAbrirLinkParametros(strTipo,strLink,"consignacion_detalle");
	}
	
	procesarInicioProcesoSimple() {		
		super.procesarInicioProcesoSimple(consignacion_detalle_constante1);
	}
	
	procesarFinalizacionProcesoSimple() {
		super.procesarFinalizacionProcesoSimple(consignacion_detalle_constante1,"consignacion_detalle");
	}
...
export {consignacion_detalle_funcion,consignacion_detalle_funcion1};

//Para ser llamado desde window.opener
window.consignacion_detalle_funcion1 = consignacion_detalle_funcion1;
