...
//---------- Clic-Seleccionar ----------
	...
	seleccionarMostrarDivAccionesRelacionesActualOnComplete() {
		funcionGeneral.seleccionarMostrarDivAccionesRelacionesActualOnComplete("consignacion",this,consignacion_constante1);
	}
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(consignacion_control.idtermino_pago_clienteDefaultForeignKey!=null && consignacion_control.idtermino_pago_clienteDefaultForeignKey>-1) {
					idActual=consignacion_control.idtermino_pago_clienteDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					consignacion_webcontrol1.cargarComboEditarTablatermino_pago_clienteFK(consignacion_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						consignacion_webcontrol1.cargarComboEditarTablatermino_pago_clienteFK(consignacion_control,control_name,idActual,true);
					}
				});
				...
				if(consignacion_control.idmonedaDefaultForeignKey!=null && consignacion_control.idmonedaDefaultForeignKey>-1) {
					idActual=consignacion_control.idmonedaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					consignacion_webcontrol1.cargarComboEditarTablamonedaFK(consignacion_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						consignacion_webcontrol1.cargarComboEditarTablamonedaFK(consignacion_control,control_name,idActual,true);
					}
				});
