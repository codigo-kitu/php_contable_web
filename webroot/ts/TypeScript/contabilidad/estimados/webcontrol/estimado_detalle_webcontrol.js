...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(estimado_detalle_control) {
		...
		jQuery("#t-cel_"+i+"_8").val(estimado_detalle_control.estimado_detalleActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_9").val(estimado_detalle_control.estimado_detalleActual.descuento_monto);
		jQuery("#t-cel_"+i+"_10").val(estimado_detalle_control.estimado_detalleActual.sub_total);
		...
		jQuery("#t-cel_"+i+"_15").val(estimado_detalle_control.estimado_detalleActual.observacion);
		jQuery("#t-cel_"+i+"_16").val(estimado_detalle_control.estimado_detalleActual.impuesto2_porciento);
		jQuery("#t-cel_"+i+"_17").val(estimado_detalle_control.estimado_detalleActual.impuesto2_monto);
		jQuery("#t-cel_"+i+"_18").val(estimado_detalle_control.estimado_detalleActual.cotizacion);
		jQuery("#t-cel_"+i+"_19").val(estimado_detalle_control.estimado_detalleActual.moneda);
	}
