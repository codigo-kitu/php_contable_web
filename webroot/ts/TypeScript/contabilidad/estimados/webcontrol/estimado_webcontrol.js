...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(estimado_control) {
		...
		if(estimado_control.estimadoActual.id_moneda!=null && estimado_control.estimadoActual.id_moneda>-1){
			if(jQuery("#t-cel_"+i+"_16").val() != estimado_control.estimadoActual.id_moneda) {
				jQuery("#t-cel_"+i+"_16").val(estimado_control.estimadoActual.id_moneda).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_17").val(estimado_control.estimadoActual.cotizacion);
		...
		jQuery("#t-cel_"+i+"_22").prop('checked',estimado_control.estimadoActual.iva_en_precio);
		jQuery("#t-cel_"+i+"_23").prop('checked',estimado_control.estimadoActual.genero_factura);
		jQuery("#t-cel_"+i+"_24").val(estimado_control.estimadoActual.sub_total);
		jQuery("#t-cel_"+i+"_25").val(estimado_control.estimadoActual.descuento_monto);
		jQuery("#t-cel_"+i+"_26").val(estimado_control.estimadoActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_27").val(estimado_control.estimadoActual.iva_monto);
		jQuery("#t-cel_"+i+"_28").val(estimado_control.estimadoActual.iva_porciento);
		jQuery("#t-cel_"+i+"_29").val(estimado_control.estimadoActual.retencion_fuente_monto);
		jQuery("#t-cel_"+i+"_30").val(estimado_control.estimadoActual.retencion_fuente_porciento);
		jQuery("#t-cel_"+i+"_31").val(estimado_control.estimadoActual.retencion_iva_monto);
		jQuery("#t-cel_"+i+"_32").val(estimado_control.estimadoActual.retencion_iva_porciento);
		jQuery("#t-cel_"+i+"_33").val(estimado_control.estimadoActual.total);
		jQuery("#t-cel_"+i+"_34").val(estimado_control.estimadoActual.otro_monto);
		jQuery("#t-cel_"+i+"_35").val(estimado_control.estimadoActual.otro_porciento);
		jQuery("#t-cel_"+i+"_36").val(estimado_control.estimadoActual.hora);
		jQuery("#t-cel_"+i+"_37").val(estimado_control.estimadoActual.retencion_ica_monto);
		jQuery("#t-cel_"+i+"_38").val(estimado_control.estimadoActual.retencion_ica_porciento);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombosmonedasFK(estimado_control) {
		...
		if(estimado_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+estimado_control.idFilaTablaActual+"_16",estimado_control.monedasFK);
		}
