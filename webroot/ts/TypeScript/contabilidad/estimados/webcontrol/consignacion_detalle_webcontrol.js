...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(consignacion_detalle_control) {
		...
		jQuery("#t-cel_"+i+"_8").val(consignacion_detalle_control.consignacion_detalleActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_9").val(consignacion_detalle_control.consignacion_detalleActual.descuento_monto);
		jQuery("#t-cel_"+i+"_10").val(consignacion_detalle_control.consignacion_detalleActual.sub_total);
		...
		jQuery("#t-cel_"+i+"_15").val(consignacion_detalle_control.consignacion_detalleActual.observacion);
		...
		jQuery("#t-cel_"+i+"_18").val(consignacion_detalle_control.consignacion_detalleActual.cotizacion);
		jQuery("#t-cel_"+i+"_19").val(consignacion_detalle_control.consignacion_detalleActual.moneda);
	}
