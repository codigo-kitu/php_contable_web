...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(parametro_facturacion_control) {
		...
		if(parametro_facturacion_control.parametro_facturacionActual.id_empresa!=null && parametro_facturacion_control.parametro_facturacionActual.id_empresa>-1){
			if(jQuery("#t-cel_"+i+"_2").val() != parametro_facturacion_control.parametro_facturacionActual.id_empresa) {
				jQuery("#t-cel_"+i+"_2").val(parametro_facturacion_control.parametro_facturacionActual.id_empresa).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_3").val(parametro_facturacion_control.parametro_facturacionActual.nombre_factura);
		jQuery("#t-cel_"+i+"_4").val(parametro_facturacion_control.parametro_facturacionActual.numero_factura);
		jQuery("#t-cel_"+i+"_5").val(parametro_facturacion_control.parametro_facturacionActual.incremento_factura);
		jQuery("#t-cel_"+i+"_6").prop('checked',parametro_facturacion_control.parametro_facturacionActual.solo_costo_producto);
		jQuery("#t-cel_"+i+"_7").val(parametro_facturacion_control.parametro_facturacionActual.numero_factura_lote);
		jQuery("#t-cel_"+i+"_8").val(parametro_facturacion_control.parametro_facturacionActual.incremento_factura_lote);
		jQuery("#t-cel_"+i+"_9").val(parametro_facturacion_control.parametro_facturacionActual.numero_devolucion);
		jQuery("#t-cel_"+i+"_10").val(parametro_facturacion_control.parametro_facturacionActual.incremento_devolucion);
		...
		if(parametro_facturacion_control.parametro_facturacionActual.id_termino_pago_cliente!=null && parametro_facturacion_control.parametro_facturacionActual.id_termino_pago_cliente>-1){
			if(jQuery("#t-cel_"+i+"_11").val() != parametro_facturacion_control.parametro_facturacionActual.id_termino_pago_cliente) {
				jQuery("#t-cel_"+i+"_11").val(parametro_facturacion_control.parametro_facturacionActual.id_termino_pago_cliente).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_12").val(parametro_facturacion_control.parametro_facturacionActual.nombre_estimado);
		jQuery("#t-cel_"+i+"_13").val(parametro_facturacion_control.parametro_facturacionActual.numero_estimado);
		jQuery("#t-cel_"+i+"_14").val(parametro_facturacion_control.parametro_facturacionActual.incremento_estimado);
		jQuery("#t-cel_"+i+"_15").prop('checked',parametro_facturacion_control.parametro_facturacionActual.solo_costo_producto_estimado);
		jQuery("#t-cel_"+i+"_16").val(parametro_facturacion_control.parametro_facturacionActual.nombre_consignacion);
		jQuery("#t-cel_"+i+"_17").val(parametro_facturacion_control.parametro_facturacionActual.numero_consignacion);
		jQuery("#t-cel_"+i+"_18").val(parametro_facturacion_control.parametro_facturacionActual.incremento_consignacion);
		jQuery("#t-cel_"+i+"_19").prop('checked',parametro_facturacion_control.parametro_facturacionActual.solo_costo_producto_consignacion);
		jQuery("#t-cel_"+i+"_20").prop('checked',parametro_facturacion_control.parametro_facturacionActual.con_recibo);
		jQuery("#t-cel_"+i+"_21").val(parametro_facturacion_control.parametro_facturacionActual.nombre_recibo);
		jQuery("#t-cel_"+i+"_22").val(parametro_facturacion_control.parametro_facturacionActual.numero_recibo);
		jQuery("#t-cel_"+i+"_23").val(parametro_facturacion_control.parametro_facturacionActual.incremento_recibo);
		jQuery("#t-cel_"+i+"_24").prop('checked',parametro_facturacion_control.parametro_facturacionActual.con_impuesto_recibo);
	}
