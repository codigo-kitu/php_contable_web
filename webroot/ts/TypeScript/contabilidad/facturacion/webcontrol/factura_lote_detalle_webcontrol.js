...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(factura_lote_detalle_control) {
		...
		jQuery("#t-cel_"+i+"_8").val(factura_lote_detalle_control.factura_lote_detalleActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_9").val(factura_lote_detalle_control.factura_lote_detalleActual.descuento_monto);
		jQuery("#t-cel_"+i+"_10").val(factura_lote_detalle_control.factura_lote_detalleActual.sub_total);
		...
		jQuery("#t-cel_"+i+"_15").val(factura_lote_detalle_control.factura_lote_detalleActual.observacion);
		...
		jQuery("#t-cel_"+i+"_18").val(factura_lote_detalle_control.factura_lote_detalleActual.cotizacion);
		jQuery("#t-cel_"+i+"_19").val(factura_lote_detalle_control.factura_lote_detalleActual.moneda);
	}
