...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(factura_lote_control) {
		...
		jQuery("#t-cel_"+i+"_15").val(factura_lote_control.factura_loteActual.cotizacion);
		
		if(factura_lote_control.factura_loteActual.id_moneda!=null && factura_lote_control.factura_loteActual.id_moneda>-1){
			if(jQuery("#t-cel_"+i+"_16").val() != factura_lote_control.factura_loteActual.id_moneda) {
				jQuery("#t-cel_"+i+"_16").val(factura_lote_control.factura_loteActual.id_moneda).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_21").prop('checked',factura_lote_control.factura_loteActual.impuesto_en_precio);
		jQuery("#t-cel_"+i+"_22").val(factura_lote_control.factura_loteActual.sub_total);
		jQuery("#t-cel_"+i+"_23").val(factura_lote_control.factura_loteActual.descuento_monto);
		jQuery("#t-cel_"+i+"_24").val(factura_lote_control.factura_loteActual.descuento_porciento);
		jQuery("#t-cel_"+i+"_25").val(factura_lote_control.factura_loteActual.iva_monto);
		jQuery("#t-cel_"+i+"_26").val(factura_lote_control.factura_loteActual.iva_porciento);
		jQuery("#t-cel_"+i+"_27").val(factura_lote_control.factura_loteActual.retencion_fuente_monto);
		jQuery("#t-cel_"+i+"_28").val(factura_lote_control.factura_loteActual.retencion_fuente_porciento);
		jQuery("#t-cel_"+i+"_29").val(factura_lote_control.factura_loteActual.retencion_iva_monto);
		jQuery("#t-cel_"+i+"_30").val(factura_lote_control.factura_loteActual.retencion_iva_porciento);
		jQuery("#t-cel_"+i+"_31").val(factura_lote_control.factura_loteActual.total);
		jQuery("#t-cel_"+i+"_32").val(factura_lote_control.factura_loteActual.otro_monto);
		jQuery("#t-cel_"+i+"_33").val(factura_lote_control.factura_loteActual.otro_porciento);
		jQuery("#t-cel_"+i+"_34").val(factura_lote_control.factura_loteActual.hora);
		jQuery("#t-cel_"+i+"_35").val(factura_lote_control.factura_loteActual.retencion_ica_monto);
		jQuery("#t-cel_"+i+"_36").val(factura_lote_control.factura_loteActual.retencion_ica_porciento);
		
		if(factura_lote_control.factura_loteActual.id_asiento!=null && factura_lote_control.factura_loteActual.id_asiento>-1){
			if(jQuery("#t-cel_"+i+"_37").val() != factura_lote_control.factura_loteActual.id_asiento) {
				jQuery("#t-cel_"+i+"_37").val(factura_lote_control.factura_loteActual.id_asiento).trigger("change");
			}
		} else { 
		...
		if(factura_lote_control.factura_loteActual.id_documento_cuenta_cobrar!=null && factura_lote_control.factura_loteActual.id_documento_cuenta_cobrar>-1){
			if(jQuery("#t-cel_"+i+"_38").val() != factura_lote_control.factura_loteActual.id_documento_cuenta_cobrar) {
				jQuery("#t-cel_"+i+"_38").val(factura_lote_control.factura_loteActual.id_documento_cuenta_cobrar).trigger("change");
			}
		} else { 
		...
		if(factura_lote_control.factura_loteActual.id_kardex!=null && factura_lote_control.factura_loteActual.id_kardex>-1){
			if(jQuery("#t-cel_"+i+"_39").val() != factura_lote_control.factura_loteActual.id_kardex) {
				jQuery("#t-cel_"+i+"_39").val(factura_lote_control.factura_loteActual.id_kardex).trigger("change");
			}
		} else { 
