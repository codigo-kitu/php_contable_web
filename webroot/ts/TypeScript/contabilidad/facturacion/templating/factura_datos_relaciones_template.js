...
<script id="factura_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarfacturasAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each facturasReporte}}

			<table id="tablefactura{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Iva en Precio' ../arrOrderBy ../bitParaReporteOrderBy) }}
