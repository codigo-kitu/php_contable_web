...
<script id="devolucion_factura_detalle_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliardevolucion_factura_detallesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each devolucion_factura_detallesReporte}}

			<table id="tabledevolucion_factura_detalle{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Devolucion Factura' ../arrOrderBy ../bitParaReporteOrderBy) }}
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								<td width="20%" {{../strAuxStyleBackgroundContenidoCabecera}} >
									<b>- Devolucion Factura</b>
								</td>
								<td>{{trim id_devolucion_factura_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
			...
			{{#if (existeCadenaArrayOrderBy 'Unidad' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Precio' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'No Recibidos' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Impuesto2 %' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Impuesto2 Monto' ../arrOrderBy ../bitParaReporteOrderBy) }}
