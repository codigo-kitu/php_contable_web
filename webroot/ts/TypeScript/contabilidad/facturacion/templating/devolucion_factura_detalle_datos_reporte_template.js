...
<script id="devolucion_factura_detalle_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (ValCol 'Devolucion Factura' paraReporte)}}
		...
		{{#if (Is_List_Exist devolucion_factura_detallesLocal)}}
			{{#each devolucion_factura_detallesLocal}}
