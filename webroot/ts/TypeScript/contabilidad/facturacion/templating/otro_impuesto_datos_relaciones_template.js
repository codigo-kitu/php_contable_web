...
<script id="otro_impuesto_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarotro_impuestosAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each otro_impuestosReporte}}

			<table id="tableotro_impuesto{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
