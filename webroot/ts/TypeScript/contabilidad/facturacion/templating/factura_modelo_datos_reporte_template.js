...
<script id="factura_modelo_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist factura_modelosLocal)}}
			{{#each factura_modelosLocal}}
