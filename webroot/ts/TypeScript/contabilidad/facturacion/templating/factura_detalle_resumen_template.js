...
<script id="factura_detalle_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarfactura_detallesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each factura_detallesReporte}}

			<table id="tablefactura_detalle{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
