...
<script id="factura_lote_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarfactura_lotesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each factura_lotesReporte}}

			<table id="tablefactura_lote{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Referencia Cliente' ../arrOrderBy ../bitParaReporteOrderBy) }}
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								...
								<td>{{trim id_termino_pago_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
			...
			{{#if (existeCadenaArrayOrderBy 'Docs Cc' ../arrOrderBy ../bitParaReporteOrderBy) }}
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								...
								<td>{{trim id_documento_cuenta_cobrar_Descripcion}}
								</td>
							</tr>
						</table>
					</td>
