...
//---------- Clic-Seleccionar ----------
	...
	seleccionarMostrarDivAccionesRelacionesActualOnComplete() {
		funcionGeneral.seleccionarMostrarDivAccionesRelacionesActualOnComplete("factura_lote",this,factura_lote_constante1);
	}
		...
		if(maxima_fila!=null && maxima_fila > 0) {
			for (var i = 1; i <= maxima_fila; i++) { 
				...
				*/
				...
				if(factura_lote_control.idmonedaDefaultForeignKey!=null && factura_lote_control.idmonedaDefaultForeignKey>-1) {
					idActual=factura_lote_control.idmonedaDefaultForeignKey;
				}

				if(jQuery("#"+control_name_id).val()<0) {
					factura_lote_webcontrol1.cargarComboEditarTablamonedaFK(factura_lote_control,control_name,idActual,false);
				}
				...
				jQuery("#chb_"+control_name).change(function(){
					...
					if(jQuery(this).prop('checked')==true) {
						//alert("FK_ID_ACTUAL="+idActual);
						factura_lote_webcontrol1.cargarComboEditarTablamonedaFK(factura_lote_control,control_name,idActual,true);
					}
				});
