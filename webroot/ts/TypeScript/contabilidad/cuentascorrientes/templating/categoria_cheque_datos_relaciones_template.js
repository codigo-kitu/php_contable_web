...
<script id="categoria_cheque_datos_relaciones_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarcategoria_chequesAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each categoria_chequesReporte}}

			<table id="tablecategoria_cheque{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
