...
<script id="retiro_cuenta_corriente_datos_reporte_template" type="text/x-handlebars-template">
		...
		{{#if (Is_List_Exist retiro_cuenta_corrientesLocal)}}
			{{#each retiro_cuenta_corrientesLocal}}
