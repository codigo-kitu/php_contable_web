...
<script id="instrumento_pago_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliarinstrumento_pagosAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each instrumento_pagosReporte}}

			<table id="tableinstrumento_pago{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy ' Cuenta Compras' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy ' Cuenta Ventas' ../arrOrderBy ../bitParaReporteOrderBy) }}
			...
			{{#if (existeCadenaArrayOrderBy 'Cuenta Contable Compra' ../arrOrderBy ../bitParaReporteOrderBy) }}
				...
				<tr>
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr {{../strAuxStyleBackgroundContenido}}>
								<td width="20%" {{../strAuxStyleBackgroundContenidoCabecera}} >
									<b>- Cuenta Contable Compra</b>
								</td>
								<td>{{trim cuenta_contable_compra}}
								</td>
							</tr>
						</table>
					</td>
