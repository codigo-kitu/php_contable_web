...
<script id="transacciones_cuenta_resumen_template" type="text/x-handlebars-template">


<div id="divTablaDatosAuxiliartransacciones_cuentasAjaxWebPart" style="width:100%;height:100%;overflow:auto;">

{{#each transacciones_cuentasReporte}}

			<table id="tabletransacciones_cuenta{{id}}" {{../strAuxStyleBackgroundTablaPrincipal}} width="{{../strTamanioTablaPrincipal}}" align="center" cellspacing="0" cellpadding="0" border="{{../borderValue}}">
			...
			{{#if (existeCadenaArrayOrderBy 'Numero Cuenta' ../arrOrderBy ../bitParaReporteOrderBy) }}
