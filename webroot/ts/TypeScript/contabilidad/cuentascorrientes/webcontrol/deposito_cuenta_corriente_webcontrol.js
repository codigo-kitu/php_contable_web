...
//Funciones Manejadores Accion
	...
	actualizarCamposFilaTabla(deposito_cuenta_corriente_control) {
		...
		if(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_sucursal!=null && deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_sucursal>-1){
			if(jQuery("#t-cel_"+i+"_3").val() != deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_sucursal) {
				jQuery("#t-cel_"+i+"_3").val(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_sucursal).trigger("change");
			}
		} else { 
		...
		if(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_ejercicio!=null && deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_ejercicio>-1){
			if(jQuery("#t-cel_"+i+"_4").val() != deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_ejercicio) {
				jQuery("#t-cel_"+i+"_4").val(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_ejercicio).trigger("change");
			}
		} else { 
		...
		if(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_periodo!=null && deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_periodo>-1){
			if(jQuery("#t-cel_"+i+"_5").val() != deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_periodo) {
				jQuery("#t-cel_"+i+"_5").val(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_periodo).trigger("change");
			}
		} else { 
		...
		if(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_usuario!=null && deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_usuario>-1){
			if(jQuery("#t-cel_"+i+"_6").val() != deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_usuario) {
				jQuery("#t-cel_"+i+"_6").val(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_usuario).trigger("change");
			}
		} else { 
		...
		if(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_cuenta_corriente!=null && deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_cuenta_corriente>-1){
			if(jQuery("#t-cel_"+i+"_7").val() != deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_cuenta_corriente) {
				jQuery("#t-cel_"+i+"_7").val(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_cuenta_corriente).trigger("change");
			}
		} else { 
		...
		if(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_estado_deposito_retiro!=null && deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_estado_deposito_retiro>-1){
			if(jQuery("#t-cel_"+i+"_14").val() != deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_estado_deposito_retiro) {
				jQuery("#t-cel_"+i+"_14").val(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.id_estado_deposito_retiro).trigger("change");
			}
		} else { 
		...
		jQuery("#t-cel_"+i+"_15").val(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.debito);
		jQuery("#t-cel_"+i+"_16").val(deposito_cuenta_corriente_control.deposito_cuenta_corrienteActual.credito);
	}
...
/*---------------------------------- AREA:FK ---------------------------*/		
	...
	cargarCombossucursalsFK(deposito_cuenta_corriente_control) {
		...
		if(deposito_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+deposito_cuenta_corriente_control.idFilaTablaActual+"_3",deposito_cuenta_corriente_control.sucursalsFK);
		}
	};
	...
	cargarCombosejerciciosFK(deposito_cuenta_corriente_control) {
		...
		if(deposito_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+deposito_cuenta_corriente_control.idFilaTablaActual+"_4",deposito_cuenta_corriente_control.ejerciciosFK);
		}
	};
	...
	cargarCombosperiodosFK(deposito_cuenta_corriente_control) {
		...
		if(deposito_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+deposito_cuenta_corriente_control.idFilaTablaActual+"_5",deposito_cuenta_corriente_control.periodosFK);
		}
	};
	...
	cargarCombosusuariosFK(deposito_cuenta_corriente_control) {
		...
		if(deposito_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+deposito_cuenta_corriente_control.idFilaTablaActual+"_6",deposito_cuenta_corriente_control.usuariosFK);
		}
	};
	...
	cargarComboscuenta_corrientesFK(deposito_cuenta_corriente_control) {
		...
		if(deposito_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+deposito_cuenta_corriente_control.idFilaTablaActual+"_7",deposito_cuenta_corriente_control.cuenta_corrientesFK);
		}
	...
	cargarCombosestado_deposito_retirosFK(deposito_cuenta_corriente_control) {
		...
		if(deposito_cuenta_corriente_control.bitEsEventoTabla==true) {
			funcionGeneralJQuery.cargarCombosForeignKeyIndices("#t-cel_"+deposito_cuenta_corriente_control.idFilaTablaActual+"_14",deposito_cuenta_corriente_control.estado_deposito_retirosFK);
		}
