...
class FuncionGeneral {
	...
	STRNOMBREFRAMEMENU="leftSidebar";
	STRNOMBREFRAME_SLIDER_MENU="divLeftSideSliderAux";
	
	STR_PERMISO_TODO="TODO";
	STR_PERMISO_CONSULTA="CONSULTA";
	STR_PERMISO_INGRESO="INGRESO";
	STR_PERMISO_MODIFICACION="MODIFICACION";
	STR_PERMISO_ELIMINACION="ELIMINACION";
	STR_PERMISO_BUSQUEDA="BUSQUEDA";
	isExpanded=true;
	...
	printWebPartPage(title,data) {    
		...
		var window1:any=window.open("http://"+constantes.STR_IP_SERVIDOR+":"+constantes.STR_PUERTO_SERVIDOR+"/"+constantes.STR_CONTEXTO_APLICACION+"/"+constantes.STR_CONTEXTO_APLICACION_TOCOMPLETE+"/"+constantes.STR_CARPETA_REPORTE+"/"+constantes.STR_REPORTE_PAGE_JQUERY,"REPORTE" + constantes.STR_HTML,constantes.STR_REPORTE_CONFIGURACION_VENTANA);
	...
	validarCombo(arrData,value) {//alert(value);alert(arrData);
		var mensaje= "";
	...
	actualizarEstadoBotones(strAccion,strPermisos,bitGuardarCambiosEnLote,bitEsMantenimientoRelacionado,sNombreClase) {		
		this.actualizarEstadoCeldasBotones(strAccion,bitGuardarCambiosEnLote,bitEsMantenimientoRelacionado,
			document.getElementById("tblAccionesMantenimiento"+sNombreClase+"").rows["trAccionesMantenimiento"+sNombreClase+"Basicos"].cells["tdbtnNuevo"+sNombreClase+""],
			document.getElementById("tblAccionesMantenimiento"+sNombreClase+"").rows["trAccionesMantenimiento"+sNombreClase+"Basicos"].cells["tdbtnActualizar"+sNombreClase+""],
			document.getElementById("tblAccionesMantenimiento"+sNombreClase+"").rows["trAccionesMantenimiento"+sNombreClase+"Basicos"].cells["tdbtnEliminar"+sNombreClase+""],
			document.getElementById("tblAccionesMantenimiento"+sNombreClase+"").rows["trAccionesMantenimiento"+sNombreClase+"Basicos"].cells["tdbtnCancelar"+sNombreClase+""],
			document.getElementById("tblAccionesMantenimiento"+sNombreClase+"").rows["trAccionesMantenimiento"+sNombreClase+"Guardar"].cells["tdbtnGuardarCambios"+sNombreClase+""],
			document.getElementById("tdbtnNuevoPreparar"+sNombreClase+""),
			document.getElementById("tdbtnModificarDatos"+sNombreClase+""),
			strPermisos
		);		
	}
