...
class GetEntitiesDataAccessHelper {	            
    
	public  function getEntityConnectionId(Connexion $con, int $id) : GeneralEntity|null {		  
		$entityT = null;
    ...
    private function extracted(GeneralEntity $entityT) : GeneralEntity {
		return $entityT;
	}
	  
	public  function  getEntitiesById(GeneralEntity $entity,QueryWhereSelectParameters $queryWhereSelectParameters,Connexion $con, int $id) : array {
		$entitiesT =array();
		$entityT = null;
    ...
    public  function getEntityPrefijoEntityResult(string $strPrefijo,GeneralEntity $entityT,$rs) : GeneralEntity
    {		 
	...
	public function setGeneralEntityIsNewFalseIsChangedFalse(GeneralEntity $generalEntity) {
	...
	public  static function getGeneralEntity(string $strPrefijo,GeneralEntity $entityT,$rs) {		 
