...
class dhtmlgoodies_tree {
	...
	public $webrootImages='c';
	
	function __construct ($webroot) {
		$this->webrootImages=$webroot.'/img/menu/';
	}
	
	public static function Newdhtmlgoodies_tree($webroot='')
	{
		$dhtmlgoodies_tree=new dhtmlgoodies_tree($webroot);
		
		$dhtmlgoodies_tree->webrootImages=$webroot.'/img/menu/';
		
		return $dhtmlgoodies_tree;
	}
...
************************************************************************************************************/
		...
		var plusNode = '<?php echo $this->webrootImages?>dhtmlgoodies_plus.gif';
		var minusNode = '<?php echo $this->webrootImages?>dhtmlgoodies_minus.gif';
	...
	*/
	...
	function addToArrayAss($element){
		...
		$element['icon'] = isset($element['icon']) ? $element['icon'] : $this->webrootImages.'/dhtmlgoodies_folder.gif';
	...
	function drawSubNode($parentID){
		if(isset($this->elementArray[$parentID])){
			...
			for($no=0;$no<count($this->elementArray[$parentID]);$no++){
				...
				echo "<img class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no]['id']."\" src=\"".$this->webrootImages."dhtmlgoodies_plus.gif\"><img src=\"".$this->elementArray[$parentID][$no]['icon']."\">";				
	...
	function drawTree(){
		...
		for($no=0;$no<count($this->elementArray[0]);$no++){
			...
			echo "<img id=\"plusMinus".$this->elementArray[0][$no]['id']."\" class=\"tree_plusminus\" src=\"".$this->webrootImages."dhtmlgoodies_plus.gif\">";
			//echo "path:".$this->webrootImages;
