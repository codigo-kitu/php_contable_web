...
use com\bydan\contabilidad\contabilidad\cuenta_predefinida\util\cuenta_predefinida_carga;//1-M,M-M
...
class tipo_cuenta_predefinida_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/util/tipo_cuenta_predefinida_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/util/tipo_cuenta_predefinidaParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/util/tipo_cuenta_predefinida_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/business/entity/tipo_cuenta_predefinida.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/business/entity/tipo_cuenta_predefinidaForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/business/data/tipo_cuenta_predefinida_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/business/data/tipo_cuenta_predefinida_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/business/logic/tipo_cuenta_predefinida_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/business/logic/tipo_cuenta_predefinida_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/presentation/session/tipo_cuenta_predefinida_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/presentation/view/tipo_cuenta_predefinida_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!tipo_cuenta_predefinida_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/business/entity/tipo_cuenta_predefinida.php');				
						tipo_cuenta_predefinida_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!tipo_cuenta_predefinida_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/business/data/tipo_cuenta_predefinida_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/business/data/tipo_cuenta_predefinida_data.php');
						tipo_cuenta_predefinida_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!tipo_cuenta_predefinida_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!tipo_cuenta_predefinida_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/business/logic/tipo_cuenta_predefinida_logic.php');
						tipo_cuenta_predefinida_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!tipo_cuenta_predefinida_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/util/tipo_cuenta_predefinida_util.php');
						tipo_cuenta_predefinida_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!tipo_cuenta_predefinida_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_cuenta_predefinida/presentation/session/tipo_cuenta_predefinida_session.php');
						tipo_cuenta_predefinida_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesRelaciones(string $paqueteTipo='LOGIC') {
		...
		cuenta_predefinida_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/contabilidad/cuenta_predefinida/presentation/session/cuenta_predefinida_session.php');
	...
	/*
	interface tipo_cuenta_predefinida_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
