...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/contabilidad/documento_contable/js/util/documento_contable_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			documento_contable_web::$STR_NOMBRE_PAGINA = 'documento_contable_form_view.php';
			documento_contable_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			documento_contable_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trdocumento_contableElementosFormulario">
	<td>
		<div id="divMantenimientodocumento_contableAjaxWebPart" title="DOCUMENTO CONTABLE" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientodocumento_contable" name="frmMantenimientodocumento_contable">

			</br>

			<?php if(documento_contable_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tbldocumento_contableToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tbldocumento_contableToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tddocumento_contableActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBardocumento_contable" name="imgActualizarToolBardocumento_contable" title="ACTUALIZAR Documento Contable ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tddocumento_contableEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBardocumento_contable" name="imgEliminarToolBardocumento_contable" title="ELIMINAR Documento Contable ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tddocumento_contableCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBardocumento_contable" name="imgCancelarToolBardocumento_contable" title="CANCELAR Documento Contable ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tddocumento_contableRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosdocumento_contable',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tbldocumento_contableToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tbldocumento_contableToolBarFormularioExterior -->

			<table id="tbldocumento_contableElementos">
			<tr id="trdocumento_contableElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosdocumento_contable" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: center;">
					<tr id="tr_fila_1">
					...
					<tr id="tr_fila_6">
						...
						<td id="td_control-secuencial" align="left" class="controlcampo">
							<input id="form-secuencial" name="form-secuencial" type="text" class="form-control"  placeholder="Secuencial"  title="Secuencial"    maxlength="18" size="12" >
					...
					<tr id="tr_fila_7">
						...
						<td id="td_control-incremento" align="left" class="controlcampo">
							<input id="form-incremento" name="form-incremento" type="text" class="form-control"  placeholder="Incremento"  title="Incremento"    maxlength="18" size="12" >
				...
				</table> <!-- tblElementosdocumento_contable -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosdocumento_contable" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultosdocumento_contable -->

			</td></tr> <!-- trdocumento_contableElementos -->
			</table> <!-- tbldocumento_contableElementos -->
			</form> <!-- frmMantenimientodocumento_contable -->


			

				<form id="frmAccionesMantenimientodocumento_contable" name="frmAccionesMantenimientodocumento_contable">

			<?php if(documento_contable_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tbldocumento_contableAcciones" class="elementos" style="text-align: center">
		<tr id="trdocumento_contableAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientodocumento_contable" class="busqueda" style="width: 50%;text-align: center">
						...
						<tr id="trAccionesMantenimientodocumento_contableBasicos">
							<td id="tdbtnNuevodocumento_contable" style="visibility:visible">
								<div id="divNuevodocumento_contable" style="display:table-row">
									<input type="button" id="btnNuevodocumento_contable" name="btnNuevodocumento_contable" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizardocumento_contable" style="visibility:visible">
								<div id="divActualizardocumento_contable" style="display:table-row">
									<input type="button" id="btnActualizardocumento_contable" name="btnActualizardocumento_contable" title="ACTUALIZAR Documento Contable ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminardocumento_contable" style="visibility:visible">
								<div id="divEliminardocumento_contable" style="display:table-row">
									<input type="button" id="btnEliminardocumento_contable" name="btnEliminardocumento_contable" title="ELIMINAR Documento Contable ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirdocumento_contable" style="visibility:visible">
								<input type="button" id="btnImprimirdocumento_contable" name="btnImprimirdocumento_contable" title="IMPRIMIR PAGINA Documento Contable ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelardocumento_contable" style="visibility:visible">
								<input type="button" id="btnCancelardocumento_contable" name="btnCancelardocumento_contable" title="CANCELAR Documento Contable ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientodocumento_contableGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosdocumento_contable" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosdocumento_contable" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariodocumento_contable" name="btnGuardarCambiosFormulariodocumento_contable" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientodocumento_contable -->
			</td>
		</tr> <!-- trdocumento_contableAcciones -->
		<?php if(documento_contable_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trdocumento_contableParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tbldocumento_contableParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trdocumento_contableFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tbldocumento_contableParametrosAcciones -->
			</td>
		</tr> <!-- trdocumento_contableParametrosAcciones -->
		<?php }?>
		<tr id="trdocumento_contableMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trdocumento_contableMensajes -->
			</table> <!-- tbldocumento_contableAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientodocumento_contable -->
			</div> <!-- divMantenimientodocumento_contableAjaxWebPart -->
		</td>
	</tr> <!-- trdocumento_contableElementosFormulario/super -->
		<?php if(documento_contable_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {documento_contable_webcontrol,documento_contable_webcontrol1} from './webroot/js/JavaScript/contabilidad/contabilidad/documento_contable/js/webcontrol/documento_contable_form_webcontrol.js?random=1';
