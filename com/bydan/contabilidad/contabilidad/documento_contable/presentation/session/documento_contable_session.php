...
namespace com\bydan\contabilidad\contabilidad\documento_contable\presentation\session;
...
class documento_contable_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $documento_contable_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->documento_contable_sessionAdditional=new documento_contable_sessionAdditional();
		*/
