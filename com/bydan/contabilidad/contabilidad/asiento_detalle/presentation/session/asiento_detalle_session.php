...
namespace com\bydan\contabilidad\contabilidad\asiento_detalle\presentation\session;
...
class asiento_detalle_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $asiento_detalle_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->asiento_detalle_sessionAdditional=new asiento_detalle_sessionAdditional();
		*/
