			...
			<?php foreach ($fuentesLocal as $fuente) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarfuente" idactualfuente="<?php echo($fuente->id) ?>"  funcionjsactualfuente="'.str_replace('TO_REPLACE',$fuente->id.',\''.fuente_util::getfuenteDescripcion($fuente).'\'',$this->strFuncionJs).'" title="SELECCIONAR Fuente ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Fuente ACTUAL" value="<?php echo($fuente->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($fuente->id) ?>" style="width:50px" ></input>
							</td>
						</tr>
					</table>
				</td>
