...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/contabilidad/asiento_automatico_detalle/js/util/asiento_automatico_detalle_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			asiento_automatico_detalle_web::$STR_NOMBRE_PAGINA = 'asiento_automatico_detalle_form_view.php';
			asiento_automatico_detalle_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			asiento_automatico_detalle_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trasiento_automatico_detalleElementosFormulario">
	<td>
		<div id="divMantenimientoasiento_automatico_detalleAjaxWebPart" title="DETALLE ASIENTO AUTOMATICO" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoasiento_automatico_detalle" name="frmMantenimientoasiento_automatico_detalle">

			</br>

			<?php if(asiento_automatico_detalle_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblasiento_automatico_detalleToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblasiento_automatico_detalleToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdasiento_automatico_detalleActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarasiento_automatico_detalle" name="imgActualizarToolBarasiento_automatico_detalle" title="ACTUALIZAR Detalle Asiento Automatico ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdasiento_automatico_detalleEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarasiento_automatico_detalle" name="imgEliminarToolBarasiento_automatico_detalle" title="ELIMINAR Detalle Asiento Automatico ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdasiento_automatico_detalleCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarasiento_automatico_detalle" name="imgCancelarToolBarasiento_automatico_detalle" title="CANCELAR Detalle Asiento Automatico ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdasiento_automatico_detalleRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosasiento_automatico_detalle',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblasiento_automatico_detalleToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblasiento_automatico_detalleToolBarFormularioExterior -->

			<table id="tblasiento_automatico_detalleElementos">
			<tr id="trasiento_automatico_detalleElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosasiento_automatico_detalle" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: center;">
					<tr id="tr_fila_1">
					...
					<tr id="tr_fila_4">
						<td id="td_title-id_asiento_automatico" class="titulocampo">
							<label class="form-label"> Asiento Automatico.(*)</label>
						</td>
						<td id="td_control-id_asiento_automatico" align="left" class="controlcombo">
							
							<table align="left" cellspacing="0" cellpadding="0" border="0">
								<tr>
									<td><select id="form-id_asiento_automatico" name="form-id_asiento_automatico" title=" Asiento Automatico" ></select></td>
									<td><a><img id="form-id_asiento_automatico_img" name="form-id_asiento_automatico_img" class="imagen_actualizar" title="ACTUALIZAR DATOS RELACIONADOS" src="/contabilidad0/webroot/img/Imagenes/actualizardatos.gif" alt="Actualizar Datos" border="" height="15" width="15"></a></td>
									<td><img id="form-id_asiento_automatico_img_busqueda" name="form-id_asiento_automatico_img_busqueda" title="Buscar Asiento Automatico" style="width: 15px; height: 15px;text-align: center; visibility:hidden;" src="/contabilidad0/webroot/img/Imagenes/buscar.gif" width="15" height="15"/></td>
								</tr>
							</table>
							<span id="spanstrMensajeid_asiento_automatico" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_5">
					...
					<tr id="tr_fila_7">
						<td id="td_title-es_credito" class="titulocampo">
							<label class="form-label">Es Credito</label>
						</td>
						<td id="td_control-es_credito" align="left" class="controlcampo">
							<input id="form-es_credito" name="form-es_credito" type="checkbox" >
							<span id="spanstrMensajees_credito" class="mensajeerror"></span>
						</td>
					</tr>
				</table> <!-- tblElementosasiento_automatico_detalle -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosasiento_automatico_detalle" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultosasiento_automatico_detalle -->

			</td></tr> <!-- trasiento_automatico_detalleElementos -->
			</table> <!-- tblasiento_automatico_detalleElementos -->
			</form> <!-- frmMantenimientoasiento_automatico_detalle -->


			

				<form id="frmAccionesMantenimientoasiento_automatico_detalle" name="frmAccionesMantenimientoasiento_automatico_detalle">

			<?php if(asiento_automatico_detalle_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblasiento_automatico_detalleAcciones" class="elementos" style="text-align: center">
		<tr id="trasiento_automatico_detalleAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoasiento_automatico_detalle" class="busqueda" style="width: 50%;text-align: center">
						...
						<tr id="trAccionesMantenimientoasiento_automatico_detalleBasicos">
							<td id="tdbtnNuevoasiento_automatico_detalle" style="visibility:visible">
								<div id="divNuevoasiento_automatico_detalle" style="display:table-row">
									<input type="button" id="btnNuevoasiento_automatico_detalle" name="btnNuevoasiento_automatico_detalle" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarasiento_automatico_detalle" style="visibility:visible">
								<div id="divActualizarasiento_automatico_detalle" style="display:table-row">
									<input type="button" id="btnActualizarasiento_automatico_detalle" name="btnActualizarasiento_automatico_detalle" title="ACTUALIZAR Detalle Asiento Automatico ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarasiento_automatico_detalle" style="visibility:visible">
								<div id="divEliminarasiento_automatico_detalle" style="display:table-row">
									<input type="button" id="btnEliminarasiento_automatico_detalle" name="btnEliminarasiento_automatico_detalle" title="ELIMINAR Detalle Asiento Automatico ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirasiento_automatico_detalle" style="visibility:visible">
								<input type="button" id="btnImprimirasiento_automatico_detalle" name="btnImprimirasiento_automatico_detalle" title="IMPRIMIR PAGINA Detalle Asiento Automatico ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarasiento_automatico_detalle" style="visibility:visible">
								<input type="button" id="btnCancelarasiento_automatico_detalle" name="btnCancelarasiento_automatico_detalle" title="CANCELAR Detalle Asiento Automatico ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoasiento_automatico_detalleGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosasiento_automatico_detalle" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosasiento_automatico_detalle" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioasiento_automatico_detalle" name="btnGuardarCambiosFormularioasiento_automatico_detalle" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoasiento_automatico_detalle -->
			</td>
		</tr> <!-- trasiento_automatico_detalleAcciones -->
		<?php if(asiento_automatico_detalle_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trasiento_automatico_detalleParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblasiento_automatico_detalleParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trasiento_automatico_detalleFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblasiento_automatico_detalleParametrosAcciones -->
			</td>
		</tr> <!-- trasiento_automatico_detalleParametrosAcciones -->
		<?php }?>
		<tr id="trasiento_automatico_detalleMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trasiento_automatico_detalleMensajes -->
			</table> <!-- tblasiento_automatico_detalleAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoasiento_automatico_detalle -->
			</div> <!-- divMantenimientoasiento_automatico_detalleAjaxWebPart -->
		</td>
	</tr> <!-- trasiento_automatico_detalleElementosFormulario/super -->
		<?php if(asiento_automatico_detalle_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {asiento_automatico_detalle_webcontrol,asiento_automatico_detalle_webcontrol1} from './webroot/js/JavaScript/contabilidad/contabilidad/asiento_automatico_detalle/js/webcontrol/asiento_automatico_detalle_form_webcontrol.js?random=1';
