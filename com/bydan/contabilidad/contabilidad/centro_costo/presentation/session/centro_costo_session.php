...
namespace com\bydan\contabilidad\contabilidad\centro_costo\presentation\session;
...
class centro_costo_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $centro_costo_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->centro_costo_sessionAdditional=new centro_costo_sessionAdditional();
		*/
