...
use com\bydan\contabilidad\contabilidad\cuenta\util\cuenta_carga;//1-M,M-M
...
class tipo_nivel_cuenta_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/util/tipo_nivel_cuenta_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/util/tipo_nivel_cuentaParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/util/tipo_nivel_cuenta_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/business/entity/tipo_nivel_cuenta.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/business/entity/tipo_nivel_cuentaForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/business/data/tipo_nivel_cuenta_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/business/data/tipo_nivel_cuenta_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/business/logic/tipo_nivel_cuenta_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/business/logic/tipo_nivel_cuenta_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/presentation/session/tipo_nivel_cuenta_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/presentation/view/tipo_nivel_cuenta_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!tipo_nivel_cuenta_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/business/entity/tipo_nivel_cuenta.php');				
						tipo_nivel_cuenta_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!tipo_nivel_cuenta_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/business/data/tipo_nivel_cuenta_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/business/data/tipo_nivel_cuenta_data.php');
						tipo_nivel_cuenta_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!tipo_nivel_cuenta_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!tipo_nivel_cuenta_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/business/logic/tipo_nivel_cuenta_logic.php');
						tipo_nivel_cuenta_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!tipo_nivel_cuenta_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/util/tipo_nivel_cuenta_util.php');
						tipo_nivel_cuenta_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!tipo_nivel_cuenta_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/tipo_nivel_cuenta/presentation/session/tipo_nivel_cuenta_session.php');
						tipo_nivel_cuenta_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesRelaciones(string $paqueteTipo='LOGIC') {
		...
		include_once('com/bydan/contabilidad/contabilidad/cuenta/presentation/session/cuenta_session.php');
	...
	/*
	interface tipo_nivel_cuenta_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
