...
namespace com\bydan\contabilidad\contabilidad\libro_auxiliar\presentation\session;
...
class libro_auxiliar_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $libro_auxiliar_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->libro_auxiliar_sessionAdditional=new libro_auxiliar_sessionAdditional();
		*/
