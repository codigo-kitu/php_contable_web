...
use com\bydan\contabilidad\contabilidad\contador_auxiliar\util\contador_auxiliar_carga;//1-M,M-M
...
class libro_auxiliar_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/util/libro_auxiliar_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/util/libro_auxiliarParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/util/libro_auxiliar_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/business/entity/libro_auxiliar.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/business/entity/libro_auxiliarForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/business/data/libro_auxiliar_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/business/data/libro_auxiliar_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/business/logic/libro_auxiliar_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/business/logic/libro_auxiliar_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/presentation/session/libro_auxiliar_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/presentation/view/libro_auxiliar_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!libro_auxiliar_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/business/entity/libro_auxiliar.php');				
						libro_auxiliar_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!libro_auxiliar_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/business/data/libro_auxiliar_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/business/data/libro_auxiliar_data.php');
						libro_auxiliar_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!libro_auxiliar_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!libro_auxiliar_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/business/logic/libro_auxiliar_logic.php');
						libro_auxiliar_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!libro_auxiliar_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/util/libro_auxiliar_util.php');
						libro_auxiliar_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!libro_auxiliar_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/contabilidad/libro_auxiliar/presentation/session/libro_auxiliar_session.php');
						libro_auxiliar_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesRelaciones(string $paqueteTipo='LOGIC') {
		...
		contador_auxiliar_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/contabilidad/contador_auxiliar/presentation/session/contador_auxiliar_session.php');
	...
	/*
	interface libro_auxiliar_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
