...
namespace com\bydan\contabilidad\contabilidad\moneda\presentation\session;
...
class moneda_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $moneda_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->moneda_sessionAdditional=new moneda_sessionAdditional();
		*/
