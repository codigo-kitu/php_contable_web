			...
			<?php foreach ($asiento_predefinido_detallesLocal as $asiento_predefinido_detalle) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarasiento_predefinido_detalle" idactualasiento_predefinido_detalle="<?php echo($asiento_predefinido_detalle->id) ?>"  funcionjsactualasiento_predefinido_detalle="'.str_replace('TO_REPLACE',$asiento_predefinido_detalle->id.',\''.asiento_predefinido_detalle_util::getasiento_predefinido_detalleDescripcion($asiento_predefinido_detalle).'\'',$this->strFuncionJs).'" title="SELECCIONAR Detalle Asiento Predefinido ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Detalle Asiento Predefinido ACTUAL" value="<?php echo($asiento_predefinido_detalle->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($asiento_predefinido_detalle->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $asiento_predefinido_detalle->updated_at ) ?>
					</td>
				
					<td class="elementotabla col_updated_at"  style="display:none"> 
						<?php echo( $asiento_predefinido_detalle->updated_at ) ?>
					</td>
				<td class="elementotabla col_id_asiento_predefinido" > <?php echo($asiento_predefinido_detalle->id_asiento_predefinido_Descripcion) ?></td>
				<td class="elementotabla col_id_cuenta" > <?php echo($asiento_predefinido_detalle->id_cuenta_Descripcion) ?></td>
				<td class="elementotabla col_id_centro_costo" > <?php echo($asiento_predefinido_detalle->id_centro_costo_Descripcion) ?></td>
