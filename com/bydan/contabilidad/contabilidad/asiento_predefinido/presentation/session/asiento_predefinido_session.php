...
namespace com\bydan\contabilidad\contabilidad\asiento_predefinido\presentation\session;
...
class asiento_predefinido_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $asiento_predefinido_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->asiento_predefinido_sessionAdditional=new asiento_predefinido_sessionAdditional();
		*/
