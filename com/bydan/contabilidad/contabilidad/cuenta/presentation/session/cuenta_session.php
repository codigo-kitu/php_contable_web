...
namespace com\bydan\contabilidad\contabilidad\cuenta\presentation\session;
...
class cuenta_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $cuenta_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->cuenta_sessionAdditional=new cuenta_sessionAdditional();
		*/
