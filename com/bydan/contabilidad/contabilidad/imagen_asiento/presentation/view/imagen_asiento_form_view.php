...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/contabilidad/imagen_asiento/js/util/imagen_asiento_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			imagen_asiento_web::$STR_NOMBRE_PAGINA = 'imagen_asiento_form_view.php';
			imagen_asiento_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			imagen_asiento_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trimagen_asientoElementosFormulario">
	<td>
		<div id="divMantenimientoimagen_asientoAjaxWebPart" title="IMAGENES ASIENTOS" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoimagen_asiento" name="frmMantenimientoimagen_asiento">

			</br>

			<?php if(imagen_asiento_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblimagen_asientoToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblimagen_asientoToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdimagen_asientoActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarimagen_asiento" name="imgActualizarToolBarimagen_asiento" title="ACTUALIZAR Imagenes Asientos ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_asientoEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarimagen_asiento" name="imgEliminarToolBarimagen_asiento" title="ELIMINAR Imagenes Asientos ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_asientoCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarimagen_asiento" name="imgCancelarToolBarimagen_asiento" title="CANCELAR Imagenes Asientos ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_asientoRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosimagen_asiento',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblimagen_asientoToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblimagen_asientoToolBarFormularioExterior -->

			<table id="tblimagen_asientoElementos">
			<tr id="trimagen_asientoElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosimagen_asiento" class="elementos" style="width: 300px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: center;">
					<tr id="tr_fila_1">
					...
					<tr id="tr_fila_6">
						<td id="td_title-nro_asiento" class="titulocampo">
							<label class="form-label">Nro Asiento.(*)</label>
						</td>
						<td id="td_control-nro_asiento" align="left" class="controlcampo">
							<input id="form-nro_asiento" name="form-nro_asiento" type="text" class="form-control"  placeholder="Nro Asiento"  title="Nro Asiento"    maxlength="10" size="10" >
							<span id="spanstrMensajenro_asiento" class="mensajeerror"></span>
						</td>
					</tr>
				</table> <!-- tblElementosimagen_asiento -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosimagen_asiento" class="elementos" style="display: table-row;">
					<caption class="busquedacabecera">
						<span>Campos Ocultos</span>
					</caption>
				</table> <!-- tblCamposOcultosimagen_asiento -->

			</td></tr> <!-- trimagen_asientoElementos -->
			</table> <!-- tblimagen_asientoElementos -->
			</form> <!-- frmMantenimientoimagen_asiento -->


			

				<form id="frmAccionesMantenimientoimagen_asiento" name="frmAccionesMantenimientoimagen_asiento">

			<?php if(imagen_asiento_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblimagen_asientoAcciones" class="elementos" style="text-align: center">
		<tr id="trimagen_asientoAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoimagen_asiento" class="busqueda" style="width: 50%;text-align: center">
						...
						<tr id="trAccionesMantenimientoimagen_asientoBasicos">
							<td id="tdbtnNuevoimagen_asiento" style="visibility:visible">
								<div id="divNuevoimagen_asiento" style="display:table-row">
									<input type="button" id="btnNuevoimagen_asiento" name="btnNuevoimagen_asiento" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarimagen_asiento" style="visibility:visible">
								<div id="divActualizarimagen_asiento" style="display:table-row">
									<input type="button" id="btnActualizarimagen_asiento" name="btnActualizarimagen_asiento" title="ACTUALIZAR Imagenes Asientos ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarimagen_asiento" style="visibility:visible">
								<div id="divEliminarimagen_asiento" style="display:table-row">
									<input type="button" id="btnEliminarimagen_asiento" name="btnEliminarimagen_asiento" title="ELIMINAR Imagenes Asientos ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirimagen_asiento" style="visibility:visible">
								<input type="button" id="btnImprimirimagen_asiento" name="btnImprimirimagen_asiento" title="IMPRIMIR PAGINA Imagenes Asientos ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarimagen_asiento" style="visibility:visible">
								<input type="button" id="btnCancelarimagen_asiento" name="btnCancelarimagen_asiento" title="CANCELAR Imagenes Asientos ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoimagen_asientoGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosimagen_asiento" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosimagen_asiento" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioimagen_asiento" name="btnGuardarCambiosFormularioimagen_asiento" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoimagen_asiento -->
			</td>
		</tr> <!-- trimagen_asientoAcciones -->
		<?php if(imagen_asiento_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trimagen_asientoParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblimagen_asientoParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trimagen_asientoFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblimagen_asientoParametrosAcciones -->
			</td>
		</tr> <!-- trimagen_asientoParametrosAcciones -->
		<?php }?>
		<tr id="trimagen_asientoMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trimagen_asientoMensajes -->
			</table> <!-- tblimagen_asientoAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoimagen_asiento -->
			</div> <!-- divMantenimientoimagen_asientoAjaxWebPart -->
		</td>
	</tr> <!-- trimagen_asientoElementosFormulario/super -->
		<?php if(imagen_asiento_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {imagen_asiento_webcontrol,imagen_asiento_webcontrol1} from './webroot/js/JavaScript/contabilidad/contabilidad/imagen_asiento/js/webcontrol/imagen_asiento_form_webcontrol.js?random=1';
