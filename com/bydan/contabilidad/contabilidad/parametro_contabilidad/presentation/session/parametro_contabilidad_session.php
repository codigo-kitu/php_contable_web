...
namespace com\bydan\contabilidad\contabilidad\parametro_contabilidad\presentation\session;
...
class parametro_contabilidad_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $parametro_contabilidad_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->parametro_contabilidad_sessionAdditional=new parametro_contabilidad_sessionAdditional();
		*/
