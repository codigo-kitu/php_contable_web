...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/cuentaspagar/imagen_proveedor/js/util/imagen_proveedor_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			imagen_proveedor_web::$STR_NOMBRE_PAGINA = 'imagen_proveedor_form_view.php';
			imagen_proveedor_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			imagen_proveedor_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trimagen_proveedorElementosFormulario">
	<td>
		<div id="divMantenimientoimagen_proveedorAjaxWebPart" title="IMAGENES PROVEEDORES" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoimagen_proveedor" name="frmMantenimientoimagen_proveedor">

			</br>

			<?php if(imagen_proveedor_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblimagen_proveedorToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblimagen_proveedorToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdimagen_proveedorActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarimagen_proveedor" name="imgActualizarToolBarimagen_proveedor" title="ACTUALIZAR Imagenes Proveedores ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_proveedorEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarimagen_proveedor" name="imgEliminarToolBarimagen_proveedor" title="ELIMINAR Imagenes Proveedores ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_proveedorCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarimagen_proveedor" name="imgCancelarToolBarimagen_proveedor" title="CANCELAR Imagenes Proveedores ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_proveedorRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosimagen_proveedor',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblimagen_proveedorToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblimagen_proveedorToolBarFormularioExterior -->

			<table id="tblimagen_proveedorElementos">
			<tr id="trimagen_proveedorElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosimagen_proveedor" class="elementos" style="width: 300px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: center;">
					<tr id="tr_fila_1">
				...
				</table> <!-- tblElementosimagen_proveedor -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosimagen_proveedor" class="elementos" style="display: table-row;">
					<caption class="busquedacabecera">
						<span>Campos Ocultos</span>
					</caption>
				</table> <!-- tblCamposOcultosimagen_proveedor -->

			</td></tr> <!-- trimagen_proveedorElementos -->
			</table> <!-- tblimagen_proveedorElementos -->
			</form> <!-- frmMantenimientoimagen_proveedor -->


			

				<form id="frmAccionesMantenimientoimagen_proveedor" name="frmAccionesMantenimientoimagen_proveedor">

			<?php if(imagen_proveedor_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblimagen_proveedorAcciones" class="elementos" style="text-align: center">
		<tr id="trimagen_proveedorAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoimagen_proveedor" class="busqueda" style="width: 50%;text-align: center">
						...
						<tr id="trAccionesMantenimientoimagen_proveedorBasicos">
							<td id="tdbtnNuevoimagen_proveedor" style="visibility:visible">
								<div id="divNuevoimagen_proveedor" style="display:table-row">
									<input type="button" id="btnNuevoimagen_proveedor" name="btnNuevoimagen_proveedor" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarimagen_proveedor" style="visibility:visible">
								<div id="divActualizarimagen_proveedor" style="display:table-row">
									<input type="button" id="btnActualizarimagen_proveedor" name="btnActualizarimagen_proveedor" title="ACTUALIZAR Imagenes Proveedores ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarimagen_proveedor" style="visibility:visible">
								<div id="divEliminarimagen_proveedor" style="display:table-row">
									<input type="button" id="btnEliminarimagen_proveedor" name="btnEliminarimagen_proveedor" title="ELIMINAR Imagenes Proveedores ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirimagen_proveedor" style="visibility:visible">
								<input type="button" id="btnImprimirimagen_proveedor" name="btnImprimirimagen_proveedor" title="IMPRIMIR PAGINA Imagenes Proveedores ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarimagen_proveedor" style="visibility:visible">
								<input type="button" id="btnCancelarimagen_proveedor" name="btnCancelarimagen_proveedor" title="CANCELAR Imagenes Proveedores ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoimagen_proveedorGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosimagen_proveedor" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosimagen_proveedor" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioimagen_proveedor" name="btnGuardarCambiosFormularioimagen_proveedor" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoimagen_proveedor -->
			</td>
		</tr> <!-- trimagen_proveedorAcciones -->
		<?php if(imagen_proveedor_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trimagen_proveedorParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblimagen_proveedorParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trimagen_proveedorFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblimagen_proveedorParametrosAcciones -->
			</td>
		</tr> <!-- trimagen_proveedorParametrosAcciones -->
		<?php }?>
		<tr id="trimagen_proveedorMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trimagen_proveedorMensajes -->
			</table> <!-- tblimagen_proveedorAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoimagen_proveedor -->
			</div> <!-- divMantenimientoimagen_proveedorAjaxWebPart -->
		</td>
	</tr> <!-- trimagen_proveedorElementosFormulario/super -->
		<?php if(imagen_proveedor_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {imagen_proveedor_webcontrol,imagen_proveedor_webcontrol1} from './webroot/js/JavaScript/contabilidad/cuentaspagar/imagen_proveedor/js/webcontrol/imagen_proveedor_form_webcontrol.js?random=1';
