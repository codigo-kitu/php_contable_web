			...
			<?php foreach ($imagen_proveedorsLocal as $imagen_proveedor) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarimagen_proveedor" idactualimagen_proveedor="<?php echo($imagen_proveedor->id) ?>"  funcionjsactualimagen_proveedor="'.str_replace('TO_REPLACE',$imagen_proveedor->id.',\''.imagen_proveedor_util::getimagen_proveedorDescripcion($imagen_proveedor).'\'',$this->strFuncionJs).'" title="SELECCIONAR Imagenes Proveedores ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Imagenes Proveedores ACTUAL" value="<?php echo($imagen_proveedor->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($imagen_proveedor->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $imagen_proveedor->updated_at ) ?>
					</td>
				
					<td class="elementotabla col_updated_at"  style="display:none"> 
						<?php echo( $imagen_proveedor->updated_at ) ?>
					</td>
				<td class="elementotabla col_id_proveedor" > <?php echo($imagen_proveedor->id_proveedor_Descripcion) ?></td>
				
					<td class="elementotabla col_imagen" > 
						<?php echo( $imagen_proveedor->imagen ) ?>
					</td>
