...
namespace com\bydan\contabilidad\cuentaspagar\imagen_proveedor\presentation\session;
...
class imagen_proveedor_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $imagen_proveedor_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->imagen_proveedor_sessionAdditional=new imagen_proveedor_sessionAdditional();
		*/
