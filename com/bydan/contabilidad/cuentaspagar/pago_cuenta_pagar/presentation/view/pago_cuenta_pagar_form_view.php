...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/cuentaspagar/pago_cuenta_pagar/js/util/pago_cuenta_pagar_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			pago_cuenta_pagar_web::$STR_NOMBRE_PAGINA = 'pago_cuenta_pagar_form_view.php';
			pago_cuenta_pagar_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			pago_cuenta_pagar_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trpago_cuenta_pagarElementosFormulario">
	<td>
		<div id="divMantenimientopago_cuenta_pagarAjaxWebPart" title="PAGO CUENTA PAGAR" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientopago_cuenta_pagar" name="frmMantenimientopago_cuenta_pagar">

			</br>

			<?php if(pago_cuenta_pagar_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblpago_cuenta_pagarToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblpago_cuenta_pagarToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdpago_cuenta_pagarActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarpago_cuenta_pagar" name="imgActualizarToolBarpago_cuenta_pagar" title="ACTUALIZAR Pago Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdpago_cuenta_pagarEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarpago_cuenta_pagar" name="imgEliminarToolBarpago_cuenta_pagar" title="ELIMINAR Pago Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdpago_cuenta_pagarCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarpago_cuenta_pagar" name="imgCancelarToolBarpago_cuenta_pagar" title="CANCELAR Pago Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdpago_cuenta_pagarRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultospago_cuenta_pagar',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblpago_cuenta_pagarToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblpago_cuenta_pagarToolBarFormularioExterior -->

			<table id="tblpago_cuenta_pagarElementos">
			<tr id="trpago_cuenta_pagarElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementospago_cuenta_pagar" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					<tr id="tr_fila_1">
				...
				</table> <!-- tblElementospago_cuenta_pagar -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultospago_cuenta_pagar" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultospago_cuenta_pagar -->

			</td></tr> <!-- trpago_cuenta_pagarElementos -->
			</table> <!-- tblpago_cuenta_pagarElementos -->
			</form> <!-- frmMantenimientopago_cuenta_pagar -->


			

				<form id="frmAccionesMantenimientopago_cuenta_pagar" name="frmAccionesMantenimientopago_cuenta_pagar">

			<?php if(pago_cuenta_pagar_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblpago_cuenta_pagarAcciones" class="elementos" style="text-align: center">
		<tr id="trpago_cuenta_pagarAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientopago_cuenta_pagar" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientopago_cuenta_pagarBasicos">
							<td id="tdbtnNuevopago_cuenta_pagar" style="visibility:visible">
								<div id="divNuevopago_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnNuevopago_cuenta_pagar" name="btnNuevopago_cuenta_pagar" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarpago_cuenta_pagar" style="visibility:visible">
								<div id="divActualizarpago_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnActualizarpago_cuenta_pagar" name="btnActualizarpago_cuenta_pagar" title="ACTUALIZAR Pago Cuenta Pagar ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarpago_cuenta_pagar" style="visibility:visible">
								<div id="divEliminarpago_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnEliminarpago_cuenta_pagar" name="btnEliminarpago_cuenta_pagar" title="ELIMINAR Pago Cuenta Pagar ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirpago_cuenta_pagar" style="visibility:visible">
								<input type="button" id="btnImprimirpago_cuenta_pagar" name="btnImprimirpago_cuenta_pagar" title="IMPRIMIR PAGINA Pago Cuenta Pagar ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarpago_cuenta_pagar" style="visibility:visible">
								<input type="button" id="btnCancelarpago_cuenta_pagar" name="btnCancelarpago_cuenta_pagar" title="CANCELAR Pago Cuenta Pagar ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientopago_cuenta_pagarGuardar" style="display:none">
							<td id="tdbtnGuardarCambiospago_cuenta_pagar" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiospago_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariopago_cuenta_pagar" name="btnGuardarCambiosFormulariopago_cuenta_pagar" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientopago_cuenta_pagar -->
			</td>
		</tr> <!-- trpago_cuenta_pagarAcciones -->
		<?php if(pago_cuenta_pagar_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trpago_cuenta_pagarParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblpago_cuenta_pagarParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trpago_cuenta_pagarFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblpago_cuenta_pagarParametrosAcciones -->
			</td>
		</tr> <!-- trpago_cuenta_pagarParametrosAcciones -->
		<?php }?>
		<tr id="trpago_cuenta_pagarMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trpago_cuenta_pagarMensajes -->
			</table> <!-- tblpago_cuenta_pagarAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientopago_cuenta_pagar -->
			</div> <!-- divMantenimientopago_cuenta_pagarAjaxWebPart -->
		</td>
	</tr> <!-- trpago_cuenta_pagarElementosFormulario/super -->
		<?php if(pago_cuenta_pagar_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {pago_cuenta_pagar_webcontrol,pago_cuenta_pagar_webcontrol1} from './webroot/js/JavaScript/contabilidad/cuentaspagar/pago_cuenta_pagar/js/webcontrol/pago_cuenta_pagar_form_webcontrol.js?random=1';
