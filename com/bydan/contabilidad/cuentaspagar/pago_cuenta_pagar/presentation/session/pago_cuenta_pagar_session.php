...
namespace com\bydan\contabilidad\cuentaspagar\pago_cuenta_pagar\presentation\session;
...
class pago_cuenta_pagar_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $pago_cuenta_pagar_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->pago_cuenta_pagar_sessionAdditional=new pago_cuenta_pagar_sessionAdditional();
		*/
