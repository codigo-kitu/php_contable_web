...
class pago_cuenta_pagar_util extends GeneralEntityConstantesFunciones  {
	/*CONTROL_INICIO*/
			
	/*GENERAL*/
	public static string $STR_CLASS_NAME='pago_cuenta_pagar';
	public static string $STR_FINAL_QUERY='';	
	public static string $STR_NOMBRE_OPCION='cuentas_pagar.pago_cuenta_pagars';
	/*'Mantenimientopago_cuenta_pagar.jsf';*/
	public static string $STR_MODULO_OPCION='cuentaspagar';
	public static string $STR_NOMBRE_CLASE='Mantenimientopago_cuenta_pagar.jsf';	
	public static string $STR_PATH_OPCION='';	
	public static string $STR_PERSISTENCE_CONTEXT_NAME='';
	public static string $STR_PERSISTENCE_NAME='pago_cuenta_pagarPersistenceName';
	/*.pago_cuenta_pagar_util::$SPERSISTENCECONTEXTNAME.Constantes::$SPERSISTENCECONTEXTNAME;*/
	public static string $STR_SESSION_NAME='pago_cuenta_pagar_session';
	/*.Constantes$::SSESSIONBEAN;*/
	public static string $STR_SESSION_CONTROLLER_NAME='pago_cuenta_pagar_control_session';
	/*.Constantes$::SSESSIONBEAN;*/
	public static string $STR_CONTROLLER_NAME='pago_cuenta_pagar_control';
	public static string $STR_CLASS_NAME_TITULO_REPORTES='Pago Cuenta Pagars';
	public static string $STR_RELATIVE_PATH='../';
	public static string $STR_CLASS_PLURAL='s';
	public static string $STR_CLASS_WEB_TITULO='Pago Cuenta Pagar';
	...
	/*AUXILIAR*/
	//public $pago_cuenta_pagarConstantesFuncionesAdditional;
	...
	function __construct (){
		...
		$this->pago_cuenta_pagarConstantesFuncionesAdditional=new $pago_cuenta_pagarConstantesFuncionesAdditional();*/
	}
	
	/*LISTA INDICE*/
	public static function getIndiceNuevo(array $pago_cuenta_pagars,int $iIdNuevopago_cuenta_pagar) : int {
		$iIndice=0;
		$existe=false;
		
		foreach($pago_cuenta_pagars as $pago_cuenta_pagarAux) {
			if($pago_cuenta_pagarAux->getId()==$iIdNuevopago_cuenta_pagar) {
				$existe=true;
				break;
			}
	...
	public static function getIndiceActual(array $pago_cuenta_pagars,pago_cuenta_pagar $pago_cuenta_pagar,int $iIndiceActual) : int {
		$iIndice=0;
		$existe=false;
		
		foreach($pago_cuenta_pagars as $pago_cuenta_pagarAux) {
			if($pago_cuenta_pagarAux->getId()==$pago_cuenta_pagar->getId()) {
				$existe=true;
				break;
			}
	...
	/*DESCRIPCION*/
	public static function getpago_cuenta_pagarDescripcion(?pago_cuenta_pagar $pago_cuenta_pagar) : string {//pago_cuenta_pagar NO USAR CLASE, PARA NULOS SE DANA
		$sDescripcion=Constantes::$STR_NONE;
			
		if($pago_cuenta_pagar !=null) {
			/*&& pago_cuenta_pagar->getId()!=0*/
			
			if($pago_cuenta_pagar->getId()!=null) {
				$sDescripcion=(string)$pago_cuenta_pagar->getId();
			}
	...
	public static function setpago_cuenta_pagarDescripcion(?pago_cuenta_pagar $pago_cuenta_pagar,string $sValor) {			
		if($pago_cuenta_pagar !=null) {
	...
	public static function prepararCombosFK(array $pago_cuenta_pagars) : array {
		$pago_cuenta_pagarsForeignKey=array();
		
		foreach ($pago_cuenta_pagars as $pago_cuenta_pagarLocal) {
			$pago_cuenta_pagarsForeignKey[$pago_cuenta_pagarLocal->getId()]=pago_cuenta_pagar_util::getpago_cuenta_pagarDescripcion($pago_cuenta_pagarLocal);
		}
			
		return $pago_cuenta_pagarsForeignKey;
	}
	...
	/*DESCRIPCION FKs*/
	public static function refrescarFKDescripciones(array $pago_cuenta_pagars) {		
		try {
	...
	public static function refrescarFKDescripcion(pago_cuenta_pagar $pago_cuenta_pagar) {		
		try {
	...
	public static function getTiposSeleccionar(bool $conFk) : array {
		return pago_cuenta_pagar_util::getTiposSeleccionar3($conFk,true,true,true,true);
	}
	
	public static function getTiposSeleccionar2() : array {
		return pago_cuenta_pagar_util::getTiposSeleccionar3(false,true,true,true,true);
	}
	...
	public static function getTiposSeleccionar3(bool $conFk,bool $conStringColumn,bool $conValorColumn,bool $conFechaColumn,bool $conBitColumn) : array {
		...
		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_ID_EMPRESA);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_ID_EMPRESA.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_ID_SUCURSAL);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_ID_SUCURSAL.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_ID_EJERCICIO);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_ID_EJERCICIO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_ID_PERIODO);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_ID_PERIODO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_ID_USUARIO);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_ID_USUARIO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_ID_CUENTA_PAGAR);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_ID_CUENTA_PAGAR.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_ID_FORMA_PAGO_PROVEEDOR);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_ID_FORMA_PAGO_PROVEEDOR.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_NUMERO);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_NUMERO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFechaColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_FECHA_EMISION);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_FECHA_EMISION);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFechaColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_FECHA_VENCE);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_FECHA_VENCE);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_ABONO);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_ABONO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_SALDO);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_SALDO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_DESCRIPCION);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_DESCRIPCION);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_ID_ESTADO);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_ID_ESTADO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_REFERENCIA);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_REFERENCIA);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_DEBITO);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_DEBITO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(pago_cuenta_pagar_util::$LABEL_CREDITO);
			$reporte->setsDescripcion(pago_cuenta_pagar_util::$LABEL_CREDITO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}
	...
	public static function getArrayColumnasGlobales(array $arrDatoGeneral) : array {
		...
		$arrColumnasGlobales=pago_cuenta_pagar_util::getArrayColumnasGlobalesConNoColumnas($arrDatoGeneral,array());
	...
	public static function getArrayColumnasGlobalesConNoColumnas(array $arrDatoGeneral,array $arrColumnasGlobalesNo) : array {
		...
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==pago_cuenta_pagar_util::$ID_EMPRESA) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=pago_cuenta_pagar_util::$ID_EMPRESA;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==pago_cuenta_pagar_util::$ID_SUCURSAL) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=pago_cuenta_pagar_util::$ID_SUCURSAL;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==pago_cuenta_pagar_util::$ID_EJERCICIO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=pago_cuenta_pagar_util::$ID_EJERCICIO;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==pago_cuenta_pagar_util::$ID_PERIODO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=pago_cuenta_pagar_util::$ID_PERIODO;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==pago_cuenta_pagar_util::$ID_USUARIO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=pago_cuenta_pagar_util::$ID_USUARIO;
		}
	...
	public static function getOrderByLista() : array {
		...
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_ID, pago_cuenta_pagar_util::$ID,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_ID_EMPRESA, pago_cuenta_pagar_util::$ID_EMPRESA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_ID_SUCURSAL, pago_cuenta_pagar_util::$ID_SUCURSAL,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_ID_EJERCICIO, pago_cuenta_pagar_util::$ID_EJERCICIO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_ID_PERIODO, pago_cuenta_pagar_util::$ID_PERIODO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_ID_USUARIO, pago_cuenta_pagar_util::$ID_USUARIO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_ID_CUENTA_PAGAR, pago_cuenta_pagar_util::$ID_CUENTA_PAGAR,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_ID_FORMA_PAGO_PROVEEDOR, pago_cuenta_pagar_util::$ID_FORMA_PAGO_PROVEEDOR,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_NUMERO, pago_cuenta_pagar_util::$NUMERO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_FECHA_EMISION, pago_cuenta_pagar_util::$FECHA_EMISION,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_FECHA_VENCE, pago_cuenta_pagar_util::$FECHA_VENCE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_ABONO, pago_cuenta_pagar_util::$ABONO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_SALDO, pago_cuenta_pagar_util::$SALDO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_DESCRIPCION, pago_cuenta_pagar_util::$DESCRIPCION,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_ID_ESTADO, pago_cuenta_pagar_util::$ID_ESTADO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_REFERENCIA, pago_cuenta_pagar_util::$REFERENCIA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_DEBITO, pago_cuenta_pagar_util::$DEBITO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,pago_cuenta_pagar_util::$LABEL_CREDITO, pago_cuenta_pagar_util::$CREDITO,false,""); $arrOrderBy[]=$orderBy;
	...
	public static function getDataReportRow(string $tipo='NORMAL',pago_cuenta_pagar $pago_cuenta_pagar,array $arrOrderBy,bool $bitParaReporteOrderBy) : array {
		$row=array();
		...
		if(Funciones::existeCadenaArrayOrderBy(' Empresa',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getid_empresa_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Sucursal',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getid_sucursal_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Ejercicio',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getid_ejercicio_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Periodo',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getid_periodo_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Usuario',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getid_usuario_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Cuenta Pagar',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getid_cuenta_pagar_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Forma Pago Proveedor',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getid_forma_pago_proveedor_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Numero',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getnumero(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Fecha Emision',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getfecha_emision(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Fecha Vence',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getfecha_vence(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Abono',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getabono(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Saldo',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getsaldo(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Descripcion',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getdescripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Estado',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($pago_cuenta_pagar->getid_estado_Descripcion(),40,6,1); $row[]=$cellReport;
		}
	...
	interface pago_cuenta_pagar_util extends GeneralEntityConstantesFunciones  {
		...
		//DESCRIPCION
		public static function getpago_cuenta_pagarDescripcion(?pago_cuenta_pagar $pago_cuenta_pagar) : string {;	
		public static function setpago_cuenta_pagarDescripcion(?pago_cuenta_pagar $pago_cuenta_pagar,string $sValor);
