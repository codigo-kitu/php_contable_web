...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/cuentaspagar/imagen_documento_cuenta_pagar/js/util/imagen_documento_cuenta_pagar_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			imagen_documento_cuenta_pagar_web::$STR_NOMBRE_PAGINA = 'imagen_documento_cuenta_pagar_form_view.php';
			imagen_documento_cuenta_pagar_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			imagen_documento_cuenta_pagar_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trimagen_documento_cuenta_pagarElementosFormulario">
	<td>
		<div id="divMantenimientoimagen_documento_cuenta_pagarAjaxWebPart" title="IMAGENES DOCUMENTOS CUENTAS POR PAGAR" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoimagen_documento_cuenta_pagar" name="frmMantenimientoimagen_documento_cuenta_pagar">

			</br>

			<?php if(imagen_documento_cuenta_pagar_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblimagen_documento_cuenta_pagarToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblimagen_documento_cuenta_pagarToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdimagen_documento_cuenta_pagarActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarimagen_documento_cuenta_pagar" name="imgActualizarToolBarimagen_documento_cuenta_pagar" title="ACTUALIZAR Imagenes Documentos Cuentas por Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_documento_cuenta_pagarEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarimagen_documento_cuenta_pagar" name="imgEliminarToolBarimagen_documento_cuenta_pagar" title="ELIMINAR Imagenes Documentos Cuentas por Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_documento_cuenta_pagarCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarimagen_documento_cuenta_pagar" name="imgCancelarToolBarimagen_documento_cuenta_pagar" title="CANCELAR Imagenes Documentos Cuentas por Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_documento_cuenta_pagarRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosimagen_documento_cuenta_pagar',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblimagen_documento_cuenta_pagarToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblimagen_documento_cuenta_pagarToolBarFormularioExterior -->

			<table id="tblimagen_documento_cuenta_pagarElementos">
			<tr id="trimagen_documento_cuenta_pagarElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosimagen_documento_cuenta_pagar" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: center;">
					<tr id="tr_fila_1">
					...
					<tr id="tr_fila_5">
						<td id="td_title-id_documento_cuenta_pagar" class="titulocampo">
							<label class="form-label">Id Docs.(*)</label>
						</td>
						<td id="td_control-id_documento_cuenta_pagar" align="left" class="controlcombo">
							
							<table align="left" cellspacing="0" cellpadding="0" border="0">
								<tr>
									<td><select id="form-id_documento_cuenta_pagar" name="form-id_documento_cuenta_pagar" title="Id Docs" ></select></td>
				...
				</table> <!-- tblElementosimagen_documento_cuenta_pagar -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosimagen_documento_cuenta_pagar" class="elementos" style="display: table-row;">
					<caption class="busquedacabecera">
						<span>Campos Ocultos</span>
					</caption>
				</table> <!-- tblCamposOcultosimagen_documento_cuenta_pagar -->

			</td></tr> <!-- trimagen_documento_cuenta_pagarElementos -->
			</table> <!-- tblimagen_documento_cuenta_pagarElementos -->
			</form> <!-- frmMantenimientoimagen_documento_cuenta_pagar -->


			

				<form id="frmAccionesMantenimientoimagen_documento_cuenta_pagar" name="frmAccionesMantenimientoimagen_documento_cuenta_pagar">

			<?php if(imagen_documento_cuenta_pagar_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblimagen_documento_cuenta_pagarAcciones" class="elementos" style="text-align: center">
		<tr id="trimagen_documento_cuenta_pagarAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoimagen_documento_cuenta_pagar" class="busqueda" style="width: 50%;text-align: center">
						...
						<tr id="trAccionesMantenimientoimagen_documento_cuenta_pagarBasicos">
							<td id="tdbtnNuevoimagen_documento_cuenta_pagar" style="visibility:visible">
								<div id="divNuevoimagen_documento_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnNuevoimagen_documento_cuenta_pagar" name="btnNuevoimagen_documento_cuenta_pagar" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarimagen_documento_cuenta_pagar" style="visibility:visible">
								<div id="divActualizarimagen_documento_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnActualizarimagen_documento_cuenta_pagar" name="btnActualizarimagen_documento_cuenta_pagar" title="ACTUALIZAR Imagenes Documentos Cuentas por Pagar ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarimagen_documento_cuenta_pagar" style="visibility:visible">
								<div id="divEliminarimagen_documento_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnEliminarimagen_documento_cuenta_pagar" name="btnEliminarimagen_documento_cuenta_pagar" title="ELIMINAR Imagenes Documentos Cuentas por Pagar ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirimagen_documento_cuenta_pagar" style="visibility:visible">
								<input type="button" id="btnImprimirimagen_documento_cuenta_pagar" name="btnImprimirimagen_documento_cuenta_pagar" title="IMPRIMIR PAGINA Imagenes Documentos Cuentas por Pagar ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarimagen_documento_cuenta_pagar" style="visibility:visible">
								<input type="button" id="btnCancelarimagen_documento_cuenta_pagar" name="btnCancelarimagen_documento_cuenta_pagar" title="CANCELAR Imagenes Documentos Cuentas por Pagar ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoimagen_documento_cuenta_pagarGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosimagen_documento_cuenta_pagar" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosimagen_documento_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioimagen_documento_cuenta_pagar" name="btnGuardarCambiosFormularioimagen_documento_cuenta_pagar" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoimagen_documento_cuenta_pagar -->
			</td>
		</tr> <!-- trimagen_documento_cuenta_pagarAcciones -->
		<?php if(imagen_documento_cuenta_pagar_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trimagen_documento_cuenta_pagarParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblimagen_documento_cuenta_pagarParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trimagen_documento_cuenta_pagarFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblimagen_documento_cuenta_pagarParametrosAcciones -->
			</td>
		</tr> <!-- trimagen_documento_cuenta_pagarParametrosAcciones -->
		<?php }?>
		<tr id="trimagen_documento_cuenta_pagarMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trimagen_documento_cuenta_pagarMensajes -->
			</table> <!-- tblimagen_documento_cuenta_pagarAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoimagen_documento_cuenta_pagar -->
			</div> <!-- divMantenimientoimagen_documento_cuenta_pagarAjaxWebPart -->
		</td>
	</tr> <!-- trimagen_documento_cuenta_pagarElementosFormulario/super -->
		<?php if(imagen_documento_cuenta_pagar_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {imagen_documento_cuenta_pagar_webcontrol,imagen_documento_cuenta_pagar_webcontrol1} from './webroot/js/JavaScript/contabilidad/cuentaspagar/imagen_documento_cuenta_pagar/js/webcontrol/imagen_documento_cuenta_pagar_form_webcontrol.js?random=1';
