...
class documento_proveedor_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/util/documento_proveedor_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/util/documento_proveedorParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/util/documento_proveedor_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/business/entity/documento_proveedor.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/business/entity/documento_proveedorForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/business/data/documento_proveedor_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/business/data/documento_proveedor_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/business/logic/documento_proveedor_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/business/logic/documento_proveedor_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/presentation/session/documento_proveedor_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/presentation/view/documento_proveedor_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!documento_proveedor_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/business/entity/documento_proveedor.php');				
						documento_proveedor_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!documento_proveedor_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/business/data/documento_proveedor_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/business/data/documento_proveedor_data.php');
						documento_proveedor_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!documento_proveedor_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!documento_proveedor_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/business/logic/documento_proveedor_logic.php');
						documento_proveedor_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!documento_proveedor_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/util/documento_proveedor_util.php');
						documento_proveedor_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!documento_proveedor_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/documento_proveedor/presentation/session/documento_proveedor_session.php');
						documento_proveedor_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface documento_proveedor_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
