...
namespace com\bydan\contabilidad\cuentaspagar\forma_pago_proveedor\presentation\session;
...
class forma_pago_proveedor_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $forma_pago_proveedor_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->forma_pago_proveedor_sessionAdditional=new forma_pago_proveedor_sessionAdditional();
		*/
