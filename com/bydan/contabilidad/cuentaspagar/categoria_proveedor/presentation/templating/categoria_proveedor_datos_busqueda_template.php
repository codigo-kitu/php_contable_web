			...
			<?php foreach ($categoria_proveedorsLocal as $categoria_proveedor) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarcategoria_proveedor" idactualcategoria_proveedor="<?php echo($categoria_proveedor->id) ?>"  funcionjsactualcategoria_proveedor="'.str_replace('TO_REPLACE',$categoria_proveedor->id.',\''.categoria_proveedor_util::getcategoria_proveedorDescripcion($categoria_proveedor).'\'',$this->strFuncionJs).'" title="SELECCIONAR Categorias Proveedor ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Categorias Proveedor ACTUAL" value="<?php echo($categoria_proveedor->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($categoria_proveedor->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $categoria_proveedor->updated_at ) ?>
					</td>
					...
					<td class="elementotabla col_nombre" > 
						<?php echo( $categoria_proveedor->nombre ) ?>
					</td>
				
					<td class="elementotabla col_predeterminado" > 
						<?php echo( $categoria_proveedor->predeterminado ) ?>
					</td>
