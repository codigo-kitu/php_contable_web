...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/cuentaspagar/credito_cuenta_pagar/js/util/credito_cuenta_pagar_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			credito_cuenta_pagar_web::$STR_NOMBRE_PAGINA = 'credito_cuenta_pagar_form_view.php';
			credito_cuenta_pagar_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			credito_cuenta_pagar_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trcredito_cuenta_pagarElementosFormulario">
	<td>
		<div id="divMantenimientocredito_cuenta_pagarAjaxWebPart" title="CREDITO CUENTA PAGAR" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientocredito_cuenta_pagar" name="frmMantenimientocredito_cuenta_pagar">

			</br>

			<?php if(credito_cuenta_pagar_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblcredito_cuenta_pagarToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblcredito_cuenta_pagarToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdcredito_cuenta_pagarActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarcredito_cuenta_pagar" name="imgActualizarToolBarcredito_cuenta_pagar" title="ACTUALIZAR Credito Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdcredito_cuenta_pagarEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarcredito_cuenta_pagar" name="imgEliminarToolBarcredito_cuenta_pagar" title="ELIMINAR Credito Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdcredito_cuenta_pagarCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarcredito_cuenta_pagar" name="imgCancelarToolBarcredito_cuenta_pagar" title="CANCELAR Credito Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdcredito_cuenta_pagarRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultoscredito_cuenta_pagar',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblcredito_cuenta_pagarToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblcredito_cuenta_pagarToolBarFormularioExterior -->

			<table id="tblcredito_cuenta_pagarElementos">
			<tr id="trcredito_cuenta_pagarElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementoscredito_cuenta_pagar" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					<tr id="tr_fila_1">
				...
				</table> <!-- tblElementoscredito_cuenta_pagar -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultoscredito_cuenta_pagar" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultoscredito_cuenta_pagar -->

			</td></tr> <!-- trcredito_cuenta_pagarElementos -->
			</table> <!-- tblcredito_cuenta_pagarElementos -->
			</form> <!-- frmMantenimientocredito_cuenta_pagar -->


			

				<form id="frmAccionesMantenimientocredito_cuenta_pagar" name="frmAccionesMantenimientocredito_cuenta_pagar">

			<?php if(credito_cuenta_pagar_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblcredito_cuenta_pagarAcciones" class="elementos" style="text-align: center">
		<tr id="trcredito_cuenta_pagarAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientocredito_cuenta_pagar" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientocredito_cuenta_pagarBasicos">
							<td id="tdbtnNuevocredito_cuenta_pagar" style="visibility:visible">
								<div id="divNuevocredito_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnNuevocredito_cuenta_pagar" name="btnNuevocredito_cuenta_pagar" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarcredito_cuenta_pagar" style="visibility:visible">
								<div id="divActualizarcredito_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnActualizarcredito_cuenta_pagar" name="btnActualizarcredito_cuenta_pagar" title="ACTUALIZAR Credito Cuenta Pagar ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarcredito_cuenta_pagar" style="visibility:visible">
								<div id="divEliminarcredito_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnEliminarcredito_cuenta_pagar" name="btnEliminarcredito_cuenta_pagar" title="ELIMINAR Credito Cuenta Pagar ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimircredito_cuenta_pagar" style="visibility:visible">
								<input type="button" id="btnImprimircredito_cuenta_pagar" name="btnImprimircredito_cuenta_pagar" title="IMPRIMIR PAGINA Credito Cuenta Pagar ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarcredito_cuenta_pagar" style="visibility:visible">
								<input type="button" id="btnCancelarcredito_cuenta_pagar" name="btnCancelarcredito_cuenta_pagar" title="CANCELAR Credito Cuenta Pagar ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientocredito_cuenta_pagarGuardar" style="display:none">
							<td id="tdbtnGuardarCambioscredito_cuenta_pagar" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambioscredito_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariocredito_cuenta_pagar" name="btnGuardarCambiosFormulariocredito_cuenta_pagar" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientocredito_cuenta_pagar -->
			</td>
		</tr> <!-- trcredito_cuenta_pagarAcciones -->
		<?php if(credito_cuenta_pagar_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trcredito_cuenta_pagarParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblcredito_cuenta_pagarParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trcredito_cuenta_pagarFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblcredito_cuenta_pagarParametrosAcciones -->
			</td>
		</tr> <!-- trcredito_cuenta_pagarParametrosAcciones -->
		<?php }?>
		<tr id="trcredito_cuenta_pagarMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trcredito_cuenta_pagarMensajes -->
			</table> <!-- tblcredito_cuenta_pagarAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientocredito_cuenta_pagar -->
			</div> <!-- divMantenimientocredito_cuenta_pagarAjaxWebPart -->
		</td>
	</tr> <!-- trcredito_cuenta_pagarElementosFormulario/super -->
		<?php if(credito_cuenta_pagar_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {credito_cuenta_pagar_webcontrol,credito_cuenta_pagar_webcontrol1} from './webroot/js/JavaScript/contabilidad/cuentaspagar/credito_cuenta_pagar/js/webcontrol/credito_cuenta_pagar_form_webcontrol.js?random=1';
