			...
			<?php foreach ($credito_cuenta_pagarsLocal as $credito_cuenta_pagar) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarcredito_cuenta_pagar" idactualcredito_cuenta_pagar="<?php echo($credito_cuenta_pagar->id) ?>"  funcionjsactualcredito_cuenta_pagar="'.str_replace('TO_REPLACE',$credito_cuenta_pagar->id.',\''.credito_cuenta_pagar_util::getcredito_cuenta_pagarDescripcion($credito_cuenta_pagar).'\'',$this->strFuncionJs).'" title="SELECCIONAR Credito Cuenta Pagar ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Credito Cuenta Pagar ACTUAL" value="<?php echo($credito_cuenta_pagar->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($credito_cuenta_pagar->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $credito_cuenta_pagar->updated_at ) ?>
					</td>
				...
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($credito_cuenta_pagar->id_empresa_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($credito_cuenta_pagar->id_sucursal_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($credito_cuenta_pagar->id_ejercicio_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($credito_cuenta_pagar->id_periodo_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($credito_cuenta_pagar->id_usuario_Descripcion) ?></td>
				<?php } ?>
				<td class="elementotabla col_id_cuenta_pagar" > <?php echo($credito_cuenta_pagar->id_cuenta_pagar_Descripcion) ?></td>
				
					<td class="elementotabla col_numero" > 
						<?php echo( $credito_cuenta_pagar->numero ) ?>
					</td>
				
					<td class="elementotabla col_fecha_emision" > 
						<?php echo( $credito_cuenta_pagar->fecha_emision ) ?>
					</td>
				
					<td class="elementotabla col_fecha_vence" > 
						<?php echo( $credito_cuenta_pagar->fecha_vence ) ?>
					</td>
				<td class="elementotabla col_id_termino_pago_proveedor" > <?php echo($credito_cuenta_pagar->id_termino_pago_proveedor_Descripcion) ?></td>
				
					<td class="elementotabla col_monto" > 
						<?php echo( $credito_cuenta_pagar->monto ) ?>
					</td>
				
					<td class="elementotabla col_saldo" > 
						<?php echo( $credito_cuenta_pagar->saldo ) ?>
					</td>
				<td class="elementotabla col_id_estado" > <?php echo($credito_cuenta_pagar->id_estado_Descripcion) ?></td>
