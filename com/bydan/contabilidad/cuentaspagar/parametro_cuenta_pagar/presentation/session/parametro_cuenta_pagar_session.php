...
namespace com\bydan\contabilidad\cuentaspagar\parametro_cuenta_pagar\presentation\session;
...
class parametro_cuenta_pagar_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $parametro_cuenta_pagar_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->parametro_cuenta_pagar_sessionAdditional=new parametro_cuenta_pagar_sessionAdditional();
		*/
