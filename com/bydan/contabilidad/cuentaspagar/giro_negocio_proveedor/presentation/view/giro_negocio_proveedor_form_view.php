...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/cuentaspagar/giro_negocio_proveedor/js/util/giro_negocio_proveedor_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			giro_negocio_proveedor_web::$STR_NOMBRE_PAGINA = 'giro_negocio_proveedor_form_view.php';
			giro_negocio_proveedor_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			giro_negocio_proveedor_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trgiro_negocio_proveedorElementosFormulario">
	<td>
		<div id="divMantenimientogiro_negocio_proveedorAjaxWebPart" title="GIRO NEGOCIOS PROVEEDOR" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientogiro_negocio_proveedor" name="frmMantenimientogiro_negocio_proveedor">

			</br>

			<?php if(giro_negocio_proveedor_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblgiro_negocio_proveedorToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblgiro_negocio_proveedorToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdgiro_negocio_proveedorActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBargiro_negocio_proveedor" name="imgActualizarToolBargiro_negocio_proveedor" title="ACTUALIZAR Giro Negocios Proveedor ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdgiro_negocio_proveedorEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBargiro_negocio_proveedor" name="imgEliminarToolBargiro_negocio_proveedor" title="ELIMINAR Giro Negocios Proveedor ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdgiro_negocio_proveedorCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBargiro_negocio_proveedor" name="imgCancelarToolBargiro_negocio_proveedor" title="CANCELAR Giro Negocios Proveedor ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdgiro_negocio_proveedorRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosgiro_negocio_proveedor',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblgiro_negocio_proveedorToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblgiro_negocio_proveedorToolBarFormularioExterior -->

			<table id="tblgiro_negocio_proveedorElementos">
			<tr id="trgiro_negocio_proveedorElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosgiro_negocio_proveedor" class="elementos" style="width: 300px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: center;">
					<tr id="tr_fila_1">
				...
				</table> <!-- tblElementosgiro_negocio_proveedor -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosgiro_negocio_proveedor" class="elementos" style="display: table-row;">
					<caption class="busquedacabecera">
						<span>Campos Ocultos</span>
					</caption>
				</table> <!-- tblCamposOcultosgiro_negocio_proveedor -->

			</td></tr> <!-- trgiro_negocio_proveedorElementos -->
			</table> <!-- tblgiro_negocio_proveedorElementos -->
			</form> <!-- frmMantenimientogiro_negocio_proveedor -->


			

				<form id="frmAccionesMantenimientogiro_negocio_proveedor" name="frmAccionesMantenimientogiro_negocio_proveedor">

			<?php if(giro_negocio_proveedor_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblgiro_negocio_proveedorAcciones" class="elementos" style="text-align: center">
		<tr id="trgiro_negocio_proveedorAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientogiro_negocio_proveedor" class="busqueda" style="width: 50%;text-align: center">
						...
						<tr id="trAccionesMantenimientogiro_negocio_proveedorBasicos">
							<td id="tdbtnNuevogiro_negocio_proveedor" style="visibility:visible">
								<div id="divNuevogiro_negocio_proveedor" style="display:table-row">
									<input type="button" id="btnNuevogiro_negocio_proveedor" name="btnNuevogiro_negocio_proveedor" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizargiro_negocio_proveedor" style="visibility:visible">
								<div id="divActualizargiro_negocio_proveedor" style="display:table-row">
									<input type="button" id="btnActualizargiro_negocio_proveedor" name="btnActualizargiro_negocio_proveedor" title="ACTUALIZAR Giro Negocios Proveedor ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminargiro_negocio_proveedor" style="visibility:visible">
								<div id="divEliminargiro_negocio_proveedor" style="display:table-row">
									<input type="button" id="btnEliminargiro_negocio_proveedor" name="btnEliminargiro_negocio_proveedor" title="ELIMINAR Giro Negocios Proveedor ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirgiro_negocio_proveedor" style="visibility:visible">
								<input type="button" id="btnImprimirgiro_negocio_proveedor" name="btnImprimirgiro_negocio_proveedor" title="IMPRIMIR PAGINA Giro Negocios Proveedor ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelargiro_negocio_proveedor" style="visibility:visible">
								<input type="button" id="btnCancelargiro_negocio_proveedor" name="btnCancelargiro_negocio_proveedor" title="CANCELAR Giro Negocios Proveedor ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientogiro_negocio_proveedorGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosgiro_negocio_proveedor" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosgiro_negocio_proveedor" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariogiro_negocio_proveedor" name="btnGuardarCambiosFormulariogiro_negocio_proveedor" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientogiro_negocio_proveedor -->
			</td>
		</tr> <!-- trgiro_negocio_proveedorAcciones -->
		<?php if(giro_negocio_proveedor_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trgiro_negocio_proveedorParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblgiro_negocio_proveedorParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trgiro_negocio_proveedorFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblgiro_negocio_proveedorParametrosAcciones -->
			</td>
		</tr> <!-- trgiro_negocio_proveedorParametrosAcciones -->
		<?php }?>
		<tr id="trgiro_negocio_proveedorMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trgiro_negocio_proveedorMensajes -->
			</table> <!-- tblgiro_negocio_proveedorAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientogiro_negocio_proveedor -->
			</div> <!-- divMantenimientogiro_negocio_proveedorAjaxWebPart -->
		</td>
	</tr> <!-- trgiro_negocio_proveedorElementosFormulario/super -->
		<?php if(giro_negocio_proveedor_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {giro_negocio_proveedor_webcontrol,giro_negocio_proveedor_webcontrol1} from './webroot/js/JavaScript/contabilidad/cuentaspagar/giro_negocio_proveedor/js/webcontrol/giro_negocio_proveedor_form_webcontrol.js?random=1';
