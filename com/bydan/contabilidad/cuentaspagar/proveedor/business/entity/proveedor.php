...
*/
namespace com\bydan\contabilidad\cuentaspagar\proveedor\business\entity;
...
class proveedor extends GeneralEntity {

	/*GENERAL*/
	public static string $class='proveedor';
	
	/*AUXILIARES*/
	public ?proveedor $proveedor_Original=null;	
	public ?GeneralEntity $proveedor_Additional=null;
	public array $map_proveedor=array();	
	...
	public string $id_categoria_proveedor_Descripcion = '';

	public int $id_giro_negocio_proveedor = -1;
	public string $id_giro_negocio_proveedor_Descripcion = '';
	...
	public bool $aplica_impuesto_compras = false;
	...
	public array $imagenproveedors = array();
	public array $documentoproveedors = array();
	...
	function __construct () {
		...
		*/
		...
		$this->id_categoria_proveedor_Descripcion='';

 		$this->id_giro_negocio_proveedor=-1;
		$this->id_giro_negocio_proveedor_Descripcion='';
		...
		$this->id_cuenta_Descripcion='';
 		...
 		$this->aplica_impuesto_compras=false;
 		$this->id_impuesto=-1;
		...
		$this->imagenproveedors=array();
		$this->documentoproveedors=array();
		$this->otrosuplidors=array();
		
		/*AUTOREFERENCIA INFINITA TALVEZ
		$this->proveedor_Additional=new proveedor_Additional();*/
    } 
	...
	public function inicializarMap_proveedor() {
		$this->map_proveedor = array();
	}
	...
	public function  getid_categoria_proveedor() : ?int {
		return $this->id_categoria_proveedor;
	}
	
	public function  getid_categoria_proveedor_Descripcion() : string {
		return $this->id_categoria_proveedor_Descripcion;
	}
    
	public function  getid_giro_negocio_proveedor() : ?int {
		return $this->id_giro_negocio_proveedor;
	}
	
	public function  getid_giro_negocio_proveedor_Descripcion() : string {
		return $this->id_giro_negocio_proveedor_Descripcion;
	}
	...
	public function  getaplica_impuesto_compras() : ?bool {
		return $this->aplica_impuesto_compras;
	}
		...
		try {
			if($this->id_empresa!==$newid_empresa) {
				if($newid_empresa===null && $newid_empresa!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna id_empresa');
				}

				if($newid_empresa!==null && filter_var($newid_empresa,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_empresa='.$newid_empresa);
				}
		...
		try {
			if($this->id_tipo_persona!==$newid_tipo_persona) {
				if($newid_tipo_persona===null && $newid_tipo_persona!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna id_tipo_persona');
				}

				if($newid_tipo_persona!==null && filter_var($newid_tipo_persona,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_tipo_persona='.$newid_tipo_persona);
				}
	...
	public function setid_categoria_proveedor(?int $newid_categoria_proveedor)
	{
		try {
			if($this->id_categoria_proveedor!==$newid_categoria_proveedor) {
				if($newid_categoria_proveedor===null && $newid_categoria_proveedor!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna id_categoria_proveedor');
				}

				if($newid_categoria_proveedor!==null && filter_var($newid_categoria_proveedor,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_categoria_proveedor='.$newid_categoria_proveedor);
				}

				$this->id_categoria_proveedor=$newid_categoria_proveedor;
				$this->setIsChanged(true);
			}
		} catch(Exception $e) {
			throw $e;
	...
	public function setid_categoria_proveedor_Descripcion(string $newid_categoria_proveedor_Descripcion)
	{
		try {
			if($this->id_categoria_proveedor_Descripcion!=$newid_categoria_proveedor_Descripcion) {
				if($newid_categoria_proveedor_Descripcion===null && $newid_categoria_proveedor_Descripcion!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna id_categoria_proveedor');
				}

				$this->id_categoria_proveedor_Descripcion=$newid_categoria_proveedor_Descripcion;
				//$this->setIsChanged(true);
			}
		} catch(Exception $e) {
			throw $e;
	...
	public function setid_giro_negocio_proveedor(?int $newid_giro_negocio_proveedor)
	{
		try {
			if($this->id_giro_negocio_proveedor!==$newid_giro_negocio_proveedor) {
				if($newid_giro_negocio_proveedor===null && $newid_giro_negocio_proveedor!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna id_giro_negocio_proveedor');
				}

				if($newid_giro_negocio_proveedor!==null && filter_var($newid_giro_negocio_proveedor,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_giro_negocio_proveedor='.$newid_giro_negocio_proveedor);
				}

				$this->id_giro_negocio_proveedor=$newid_giro_negocio_proveedor;
				$this->setIsChanged(true);
			}
		} catch(Exception $e) {
			throw $e;
	...
	public function setid_giro_negocio_proveedor_Descripcion(string $newid_giro_negocio_proveedor_Descripcion)
	{
		try {
			if($this->id_giro_negocio_proveedor_Descripcion!=$newid_giro_negocio_proveedor_Descripcion) {
				if($newid_giro_negocio_proveedor_Descripcion===null && $newid_giro_negocio_proveedor_Descripcion!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna id_giro_negocio_proveedor');
				}

				$this->id_giro_negocio_proveedor_Descripcion=$newid_giro_negocio_proveedor_Descripcion;
				//$this->setIsChanged(true);
			}
		} catch(Exception $e) {
			throw $e;
		...
		try {
			if($this->codigo!==$newcodigo) {
				if($newcodigo===null && $newcodigo!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna codigo');
				}

				if(strlen($newcodigo)>20) {
					throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=20 en columna codigo');
				}

				if(filter_var($newcodigo,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					throw new Exception('proveedor:Formato incorrecto en columna codigo='.$newcodigo);
				}
		...
		try {
			if($this->ruc!==$newruc) {
				if($newruc===null && $newruc!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna ruc');
				}

				if(strlen($newruc)>30) {
					throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=30 en columna ruc');
				}

				if(filter_var($newruc,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					throw new Exception('proveedor:Formato incorrecto en columna ruc='.$newruc);
				}
		...
		try {
			if($this->primer_apellido!==$newprimer_apellido) {
				if($newprimer_apellido===null && $newprimer_apellido!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna primer_apellido');
				}

				if(strlen($newprimer_apellido)>60) {
					throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=60 en columna primer_apellido');
				}
				...
				if(filter_var($newprimer_apellido,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					throw new Exception('proveedor:Formato incorrecto en columna primer_apellido='.$newprimer_apellido);
				}
	...
	public function setsegundo_apellido(?string $newsegundo_apellido) {
		if($this->segundo_apellido!==$newsegundo_apellido) {
				...
				if(strlen($newsegundo_apellido)>60) {
					try {
						throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=segundo_apellido en columna segundo_apellido');
					} catch(Exception $e) {
						throw $e;
					}
				}
				...
				if(filter_var($newsegundo_apellido,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					try {
						throw new Exception('proveedor:Formato incorrecto en la columna segundo_apellido='.$newsegundo_apellido);
					} catch(Exception $e) {
						throw $e;
					}
				}
		...
		try {
			if($this->primer_nombre!==$newprimer_nombre) {
				if($newprimer_nombre===null && $newprimer_nombre!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna primer_nombre');
				}

				if(strlen($newprimer_nombre)>60) {
					throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=60 en columna primer_nombre');
				}
				...
				if(filter_var($newprimer_nombre,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					throw new Exception('proveedor:Formato incorrecto en columna primer_nombre='.$newprimer_nombre);
				}
	...
	public function setsegundo_nombre(?string $newsegundo_nombre) {
		if($this->segundo_nombre!==$newsegundo_nombre) {
				...
				if(strlen($newsegundo_nombre)>60) {
					try {
						throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=segundo_nombre en columna segundo_nombre');
					} catch(Exception $e) {
						throw $e;
					}
				}
				...
				if(filter_var($newsegundo_nombre,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					try {
						throw new Exception('proveedor:Formato incorrecto en la columna segundo_nombre='.$newsegundo_nombre);
					} catch(Exception $e) {
						throw $e;
					}
				}
	...
	public function setnombre_completo(?string $newnombre_completo) {
		if($this->nombre_completo!==$newnombre_completo) {
				...
				if(strlen($newnombre_completo)>80) {
					try {
						throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=nombre_completo en columna nombre_completo');
					} catch(Exception $e) {
						throw $e;
					}
				}
				...
				if(filter_var($newnombre_completo,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					try {
						throw new Exception('proveedor:Formato incorrecto en la columna nombre_completo='.$newnombre_completo);
					} catch(Exception $e) {
						throw $e;
					}
				}
		...
		try {
			if($this->direccion!==$newdireccion) {
				if($newdireccion===null && $newdireccion!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna direccion');
				}

				if(strlen($newdireccion)>150) {
					throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna direccion');
				}

				if(filter_var($newdireccion,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					throw new Exception('proveedor:Formato incorrecto en columna direccion='.$newdireccion);
				}
	...
	public function settelefono(?string $newtelefono) {
		if($this->telefono!==$newtelefono) {
				...
				if(strlen($newtelefono)>20) {
					try {
						throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=telefono en columna telefono');
					} catch(Exception $e) {
						throw $e;
					}
				}
				...
				if(filter_var($newtelefono,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_TELEFONO_GENERAL)))===false) {
					try {
						throw new Exception('proveedor:Formato incorrecto en la columna telefono='.$newtelefono);
					} catch(Exception $e) {
						throw $e;
					}
				}
		...
		try {
			if($this->telefono_movil!==$newtelefono_movil) {
				if($newtelefono_movil===null && $newtelefono_movil!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna telefono_movil');
				}

				if(strlen($newtelefono_movil)>20) {
					throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=20 en columna telefono_movil');
				}
				...
				if(filter_var($newtelefono_movil,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_TELEFONO_GENERAL)))===false) {
					throw new Exception('proveedor:Formato incorrecto en columna telefono_movil='.$newtelefono_movil);
				}
		...
		try {
			if($this->e_mail!==$newe_mail) {
				if($newe_mail===null && $newe_mail!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna e_mail');
				}

				if(strlen($newe_mail)>100) {
					throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna e_mail');
				}

				if(!empty($newe_mail) && filter_var($newe_mail,FILTER_VALIDATE_EMAIL)===false) {
					throw new Exception('proveedor:Formato incorrecto en columna e_mail='.$newe_mail);
				}
	...
	public function sete_mail2(?string $newe_mail2) {
		if($this->e_mail2!==$newe_mail2) {
				...
				if(strlen($newe_mail2)>100) {
					try {
						throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=e_mail2 en columna e_mail2');
					} catch(Exception $e) {
						throw $e;
					}
				}
				...
				if(!empty($newe_mail2) && filter_var($newe_mail2,FILTER_VALIDATE_EMAIL)===false) {
					try {
						throw new Exception('proveedor:Formato incorrecto en la columna e_mail2='.$newe_mail2);
					} catch(Exception $e) {
						throw $e;
					}
				}
	...
	public function setcomentario(?string $newcomentario) {
		if($this->comentario!==$newcomentario) {
				...
				if(strlen($newcomentario)>1000) {
					try {
						throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=comentario en columna comentario');
					} catch(Exception $e) {
						throw $e;
					}
				}
				...
				if(filter_var($newcomentario,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					try {
						throw new Exception('proveedor:Formato incorrecto en la columna comentario='.$newcomentario);
					} catch(Exception $e) {
						throw $e;
					}
				}
	...
	public function setimagen(?string $newimagen) {
		if($this->imagen!==$newimagen) {
				...
				if(strlen($newimagen)>1000) {
					try {
						throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=imagen en columna imagen');
					} catch(Exception $e) {
						throw $e;
					}
				}
				...
				if(filter_var($newimagen,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					try {
						throw new Exception('proveedor:Formato incorrecto en la columna imagen='.$newimagen);
					} catch(Exception $e) {
						throw $e;
					}
				}
		...
		try {
			if($this->activo!==$newactivo) {
				if($newactivo===null && $newactivo!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna activo');
				}

				if($newactivo!==null && filter_var($newactivo,FILTER_VALIDATE_BOOLEAN)===false && $newactivo!==0 && $newactivo!==false) {
					throw new Exception('proveedor:No es valor booleano - activo='.$newactivo);
				}
		...
		try {
			if($this->id_pais!==$newid_pais) {
				if($newid_pais===null && $newid_pais!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna id_pais');
				}

				if($newid_pais!==null && filter_var($newid_pais,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_pais='.$newid_pais);
				}
		...
		try {
			if($this->id_provincia!==$newid_provincia) {
				if($newid_provincia===null && $newid_provincia!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna id_provincia');
				}

				if($newid_provincia!==null && filter_var($newid_provincia,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_provincia='.$newid_provincia);
				}
		...
		try {
			if($this->id_ciudad!==$newid_ciudad) {
				if($newid_ciudad===null && $newid_ciudad!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna id_ciudad');
				}

				if($newid_ciudad!==null && filter_var($newid_ciudad,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_ciudad='.$newid_ciudad);
				}
	...
	public function setcodigo_postal(?string $newcodigo_postal) {
		if($this->codigo_postal!==$newcodigo_postal) {
				...
				if(strlen($newcodigo_postal)>15) {
					try {
						throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=codigo_postal en columna codigo_postal');
					} catch(Exception $e) {
						throw $e;
					}
				}
				...
				if(filter_var($newcodigo_postal,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_POSTAL_GENERAL)))===false) {
					try {
						throw new Exception('proveedor:Formato incorrecto en la columna codigo_postal='.$newcodigo_postal);
					} catch(Exception $e) {
						throw $e;
					}
				}
	...
	public function setfax(?string $newfax) {
		if($this->fax!==$newfax) {
				...
				if(strlen($newfax)>20) {
					try {
						throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=fax en columna fax');
					} catch(Exception $e) {
						throw $e;
					}
				}
				...
				if(filter_var($newfax,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_FAX_GENERAL)))===false) {
					try {
						throw new Exception('proveedor:Formato incorrecto en la columna fax='.$newfax);
					} catch(Exception $e) {
						throw $e;
					}
				}
	...
	public function setcontacto(?string $newcontacto) {
		if($this->contacto!==$newcontacto) {
				...
				if(strlen($newcontacto)>50) {
					try {
						throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=contacto en columna contacto');
					} catch(Exception $e) {
						throw $e;
					}
				}
				...
				if(filter_var($newcontacto,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					try {
						throw new Exception('proveedor:Formato incorrecto en la columna contacto='.$newcontacto);
					} catch(Exception $e) {
						throw $e;
					}
				}
		...
		try {
			if($this->id_vendedor!==$newid_vendedor) {
				if($newid_vendedor===null && $newid_vendedor!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna id_vendedor');
				}

				if($newid_vendedor!==null && filter_var($newid_vendedor,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_vendedor='.$newid_vendedor);
				}
		...
		try {
			if($this->maximo_credito!==$newmaximo_credito) {
				if($newmaximo_credito===null && $newmaximo_credito!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna maximo_credito');
				}

				if($newmaximo_credito!=0) {
					if($newmaximo_credito!==null && filter_var($newmaximo_credito,FILTER_VALIDATE_FLOAT)===false) {
						throw new Exception('proveedor:No es numero decimal - maximo_credito='.$newmaximo_credito);
					}
				}
		...
		try {
			if($this->maximo_descuento!==$newmaximo_descuento) {
				if($newmaximo_descuento===null && $newmaximo_descuento!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna maximo_descuento');
				}

				if($newmaximo_descuento!=0) {
					if($newmaximo_descuento!==null && filter_var($newmaximo_descuento,FILTER_VALIDATE_FLOAT)===false) {
						throw new Exception('proveedor:No es numero decimal - maximo_descuento='.$newmaximo_descuento);
					}
				}
		...
		try {
			if($this->interes_anual!==$newinteres_anual) {
				if($newinteres_anual===null && $newinteres_anual!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna interes_anual');
				}

				if($newinteres_anual!=0) {
					if($newinteres_anual!==null && filter_var($newinteres_anual,FILTER_VALIDATE_FLOAT)===false) {
						throw new Exception('proveedor:No es numero decimal - interes_anual='.$newinteres_anual);
					}
				}
		...
		try {
			if($this->balance!==$newbalance) {
				if($newbalance===null && $newbalance!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna balance');
				}

				if($newbalance!=0) {
					if($newbalance!==null && filter_var($newbalance,FILTER_VALIDATE_FLOAT)===false) {
						throw new Exception('proveedor:No es numero decimal - balance='.$newbalance);
					}
				}
		...
		try {
			if($this->id_termino_pago_proveedor!==$newid_termino_pago_proveedor) {
				if($newid_termino_pago_proveedor===null && $newid_termino_pago_proveedor!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna id_termino_pago_proveedor');
				}

				if($newid_termino_pago_proveedor!==null && filter_var($newid_termino_pago_proveedor,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_termino_pago_proveedor='.$newid_termino_pago_proveedor);
				}
	...
	public function setid_cuenta(?int $newid_cuenta) {
		if($this->id_cuenta!==$newid_cuenta) {
				...
				if($newid_cuenta!==null && filter_var($newid_cuenta,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_cuenta');
				}
	...
	public function setaplica_impuesto_compras(?bool $newaplica_impuesto_compras)
	{
		try {
			if($this->aplica_impuesto_compras!==$newaplica_impuesto_compras) {
				if($newaplica_impuesto_compras===null && $newaplica_impuesto_compras!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna aplica_impuesto_compras');
				}

				if($newaplica_impuesto_compras!==null && filter_var($newaplica_impuesto_compras,FILTER_VALIDATE_BOOLEAN)===false && $newaplica_impuesto_compras!==0 && $newaplica_impuesto_compras!==false) {
					throw new Exception('proveedor:No es valor booleano - aplica_impuesto_compras='.$newaplica_impuesto_compras);
				}

				$this->aplica_impuesto_compras=$newaplica_impuesto_compras;
				$this->setIsChanged(true);
			}
		} catch(Exception $e) {
			throw $e;
	...
	public function setid_impuesto(?int $newid_impuesto) {
		if($this->id_impuesto!==$newid_impuesto) {
				...
				if($newid_impuesto!==null && filter_var($newid_impuesto,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_impuesto');
				}
		...
		try {
			if($this->aplica_retencion_impuesto!==$newaplica_retencion_impuesto) {
				if($newaplica_retencion_impuesto===null && $newaplica_retencion_impuesto!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna aplica_retencion_impuesto');
				}
				...
				if($newaplica_retencion_impuesto!==null && filter_var($newaplica_retencion_impuesto,FILTER_VALIDATE_BOOLEAN)===false && $newaplica_retencion_impuesto!==0 && $newaplica_retencion_impuesto!==false) {
					throw new Exception('proveedor:No es valor booleano - aplica_retencion_impuesto='.$newaplica_retencion_impuesto);
				}
	...
	public function setid_retencion(?int $newid_retencion) {
		if($this->id_retencion!==$newid_retencion) {
				...
				if($newid_retencion!==null && filter_var($newid_retencion,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_retencion');
				}
		...
		try {
			if($this->aplica_retencion_fuente!==$newaplica_retencion_fuente) {
				if($newaplica_retencion_fuente===null && $newaplica_retencion_fuente!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna aplica_retencion_fuente');
				}
				...
				if($newaplica_retencion_fuente!==null && filter_var($newaplica_retencion_fuente,FILTER_VALIDATE_BOOLEAN)===false && $newaplica_retencion_fuente!==0 && $newaplica_retencion_fuente!==false) {
					throw new Exception('proveedor:No es valor booleano - aplica_retencion_fuente='.$newaplica_retencion_fuente);
				}
	...
	public function setid_retencion_fuente(?int $newid_retencion_fuente) {
		if($this->id_retencion_fuente!==$newid_retencion_fuente) {
				...
				if($newid_retencion_fuente!==null && filter_var($newid_retencion_fuente,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_retencion_fuente');
				}
		...
		try {
			if($this->aplica_retencion_ica!==$newaplica_retencion_ica) {
				if($newaplica_retencion_ica===null && $newaplica_retencion_ica!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna aplica_retencion_ica');
				}
				...
				if($newaplica_retencion_ica!==null && filter_var($newaplica_retencion_ica,FILTER_VALIDATE_BOOLEAN)===false && $newaplica_retencion_ica!==0 && $newaplica_retencion_ica!==false) {
					throw new Exception('proveedor:No es valor booleano - aplica_retencion_ica='.$newaplica_retencion_ica);
				}
	...
	public function setid_retencion_ica(?int $newid_retencion_ica) {
		if($this->id_retencion_ica!==$newid_retencion_ica) {
				...
				if($newid_retencion_ica!==null && filter_var($newid_retencion_ica,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_retencion_ica');
				}
		...
		try {
			if($this->aplica_2do_impuesto!==$newaplica_2do_impuesto) {
				if($newaplica_2do_impuesto===null && $newaplica_2do_impuesto!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna aplica_2do_impuesto');
				}
				...
				if($newaplica_2do_impuesto!==null && filter_var($newaplica_2do_impuesto,FILTER_VALIDATE_BOOLEAN)===false && $newaplica_2do_impuesto!==0 && $newaplica_2do_impuesto!==false) {
					throw new Exception('proveedor:No es valor booleano - aplica_2do_impuesto='.$newaplica_2do_impuesto);
				}
	...
	public function setid_otro_impuesto(?int $newid_otro_impuesto) {
		if($this->id_otro_impuesto!==$newid_otro_impuesto) {
				...
				if($newid_otro_impuesto!==null && filter_var($newid_otro_impuesto,FILTER_VALIDATE_INT)===false) {
					throw new Exception('proveedor:No es numero entero - id_otro_impuesto');
				}
		...
		try {
			if($this->creado!==$newcreado) {
				if($newcreado===null && $newcreado!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna creado');
				}
				...
				if($newcreado!==null && filter_var($newcreado,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_FECHA)))===false) {
					throw new Exception('proveedor:No es fecha - creado='.$newcreado);
				}
	...
	public function setmonto_ultima_transaccion(?float $newmonto_ultima_transaccion) {
		if($this->monto_ultima_transaccion!==$newmonto_ultima_transaccion) {
				...
				if($newmonto_ultima_transaccion!==null && filter_var($newmonto_ultima_transaccion,FILTER_VALIDATE_FLOAT)===false) {
					throw new Exception('proveedor:No es numero decimal - monto_ultima_transaccion');
				}
		...
		try {
			if($this->fecha_ultima_transaccion!==$newfecha_ultima_transaccion) {
				if($newfecha_ultima_transaccion===null && $newfecha_ultima_transaccion!='') {
					throw new Exception('proveedor:Valor nulo no permitido en columna fecha_ultima_transaccion');
				}
				...
				if($newfecha_ultima_transaccion!==null && filter_var($newfecha_ultima_transaccion,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_FECHA)))===false) {
					throw new Exception('proveedor:No es fecha - fecha_ultima_transaccion='.$newfecha_ultima_transaccion);
				}
	...
	public function setdescripcion_ultima_transaccion(?string $newdescripcion_ultima_transaccion) {
		if($this->descripcion_ultima_transaccion!==$newdescripcion_ultima_transaccion) {
				...
				if(strlen($newdescripcion_ultima_transaccion)>80) {
					try {
						throw new Exception('proveedor:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=descripcion_ultima_transaccion en columna descripcion_ultima_transaccion');
					} catch(Exception $e) {
						throw $e;
					}
				}
				...
				if(filter_var($newdescripcion_ultima_transaccion,FILTER_VALIDATE_REGEXP,array("options"=>array("regexp"=>Constantes::$S_REGEX_PHP_STRING_GENERAL)))===false) {
					try {
						throw new Exception('proveedor:Formato incorrecto en la columna descripcion_ultima_transaccion='.$newdescripcion_ultima_transaccion);
					} catch(Exception $e) {
						throw $e;
					}
				}
	...
	public function getimagen_proveedors() : array {
		return $this->imagenproveedors;
	}

	public function getdocumento_proveedors() : array {
		return $this->documentoproveedors;
	}
	...
	public  function  setimagen_proveedors(array $imagenproveedors) {
		try {
			$this->imagenproveedors=$imagenproveedors;
		} catch(Exception $e) {
			;
		}
	}

	public  function  setdocumento_proveedors(array $documentoproveedors) {
		try {
			$this->documentoproveedors=$documentoproveedors;
		} catch(Exception $e) {
			;
		}
	}
	...
	/*AUXILIARES*/
	public function setMap_proveedorValue(string $sKey,$oValue) {
		$this->map_proveedor[$sKey]=$oValue;
	}
	
	public function getMap_proveedorValue(string $sKey) {
		return $this->map_proveedor[$sKey];
	}
	
	public function getproveedor_Original() : ?proveedor {
		return $this->proveedor_Original;
	}
	
	public function setproveedor_Original(proveedor $proveedor) {
		try {
			$this->proveedor_Original=$proveedor;
		} catch(Exception $e) {
			;
		}
	}
	
	public function getMap_proveedor() : array {
		return $this->map_proveedor;
	}

	public function setMap_proveedor(array $map_proveedor) {
		$this->map_proveedor = $map_proveedor;
	}
