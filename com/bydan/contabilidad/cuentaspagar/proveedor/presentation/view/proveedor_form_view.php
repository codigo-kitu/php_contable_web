...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/cuentaspagar/proveedor/js/util/proveedor_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			proveedor_web::$STR_NOMBRE_PAGINA = 'proveedor_form_view.php';
			proveedor_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			proveedor_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trproveedorElementosFormulario">
	<td>
		<div id="divMantenimientoproveedorAjaxWebPart" title="PROVEEDOR" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoproveedor" name="frmMantenimientoproveedor">

			</br>

			<?php if(proveedor_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblproveedorToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblproveedorToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdproveedorActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarproveedor" name="imgActualizarToolBarproveedor" title="ACTUALIZAR Proveedor ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdproveedorEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarproveedor" name="imgEliminarToolBarproveedor" title="ELIMINAR Proveedor ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdproveedorCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarproveedor" name="imgCancelarToolBarproveedor" title="CANCELAR Proveedor ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdproveedorRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosproveedor',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblproveedorToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblproveedorToolBarFormularioExterior -->

			<table id="tblproveedorElementos">
			<tr id="trproveedorElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosproveedor" class="elementos" style="width: 666px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					...
					<tr id="trproveedorprincipalElementos">
						<td id="tdproveedorprincipalElementos"  colspan="4">
			<div id="principal">
				<table class="elementos" style="width:666px;text-align:left; padding: 0px; border-spacing: 0px; border-collapse: collapse;">
					...
					<tr id="tr_fila_2">
						<td id="td_title-id_categoria_proveedor" class="titulocampo">
							<label class="form-label">Categoria.(*)</label>
						</td>
						<td id="td_control-id_categoria_proveedor" align="left" class="controlcombo">
							
							<table align="left" cellspacing="0" cellpadding="0" border="0">
								<tr>
									<td><select id="form-id_categoria_proveedor" name="form-id_categoria_proveedor" title="Categoria" ></select></td>
									<td><a><img id="form-id_categoria_proveedor_img" name="form-id_categoria_proveedor_img" class="imagen_actualizar" title="ACTUALIZAR DATOS RELACIONADOS" src="/contabilidad0/webroot/img/Imagenes/actualizardatos.gif" alt="Actualizar Datos" border="" height="15" width="15"></a></td>
									<td><img id="form-id_categoria_proveedor_img_busqueda" name="form-id_categoria_proveedor_img_busqueda" title="Buscar Categorias Proveedor" style="width: 15px; height: 15px;text-align: center; visibility:hidden;" src="/contabilidad0/webroot/img/Imagenes/buscar.gif" width="15" height="15"/></td>
								</tr>
							</table>
							<span id="spanstrMensajeid_categoria_proveedor" class="mensajeerror"></span>
						</td>
					
					
						<td id="td_title-id_giro_negocio_proveedor" class="titulocampo">
							<label class="form-label">Giro Negocio.(*)</label>
						</td>
						<td id="td_control-id_giro_negocio_proveedor" align="left" class="controlcombo">
							
							<table align="left" cellspacing="0" cellpadding="0" border="0">
								<tr>
									<td><select id="form-id_giro_negocio_proveedor" name="form-id_giro_negocio_proveedor" title="Giro Negocio" ></select></td>
									<td><a><img id="form-id_giro_negocio_proveedor_img" name="form-id_giro_negocio_proveedor_img" class="imagen_actualizar" title="ACTUALIZAR DATOS RELACIONADOS" src="/contabilidad0/webroot/img/Imagenes/actualizardatos.gif" alt="Actualizar Datos" border="" height="15" width="15"></a></td>
									<td><img id="form-id_giro_negocio_proveedor_img_busqueda" name="form-id_giro_negocio_proveedor_img_busqueda" title="Buscar Giro Negocios Proveedor" style="width: 15px; height: 15px;text-align: center; visibility:hidden;" src="/contabilidad0/webroot/img/Imagenes/buscar.gif" width="15" height="15"/></td>
								</tr>
							</table>
							<span id="spanstrMensajeid_giro_negocio_proveedor" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_3">
					...
					<tr id="trproveedorgeneralElementos">
						<td id="tdproveedorgeneralElementos"  colspan="4">
			<div id="general">
				<table class="elementos" style="width:400px;text-align:left; padding: 0px; border-spacing: 0px; border-collapse: collapse;">
					...
					<tr id="trproveedorcontableElementos">
						<td id="tdproveedorcontableElementos"  colspan="4">
			<div id="contable">
				<table class="elementos" style="width:400px;text-align:left; padding: 0px; border-spacing: 0px; border-collapse: collapse;">
					...
					<tr id="tr_fila_4">
						...
						<td id="td_control-id_termino_pago_proveedor" align="left" class="controlcombo">
							...
							<table align="left" cellspacing="0" cellpadding="0" border="0">
								<tr>
									<td><select id="form-id_termino_pago_proveedor" name="form-id_termino_pago_proveedor" title="Termino Pago" ></select></td>
					...
					<tr id="tr_fila_6">
						<td id="td_title-aplica_impuesto_compras" class="titulocampo">
							<label class="form-label">Aplica Impuesto Compras</label>
						</td>
						<td id="td_control-aplica_impuesto_compras" align="left" class="controlcampo">
							<input id="form-aplica_impuesto_compras" name="form-aplica_impuesto_compras" type="checkbox" >
							<span id="spanstrMensajeaplica_impuesto_compras" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_7">
				...
				</table> <!-- tblElementosproveedor -->
				</div>

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosproveedor" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultosproveedor -->

			</td></tr> <!-- trproveedorElementos -->
			</table> <!-- tblproveedorElementos -->
			</form> <!-- frmMantenimientoproveedor -->


			

				<form id="frmAccionesMantenimientoproveedor" name="frmAccionesMantenimientoproveedor">

			<?php if(proveedor_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblproveedorAcciones" class="elementos" style="text-align: center">
		<tr id="trproveedorAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoproveedor" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientoproveedorBasicos">
							<td id="tdbtnNuevoproveedor" style="visibility:visible">
								<div id="divNuevoproveedor" style="display:table-row">
									<input type="button" id="btnNuevoproveedor" name="btnNuevoproveedor" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarproveedor" style="visibility:visible">
								<div id="divActualizarproveedor" style="display:table-row">
									<input type="button" id="btnActualizarproveedor" name="btnActualizarproveedor" title="ACTUALIZAR Proveedor ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarproveedor" style="visibility:visible">
								<div id="divEliminarproveedor" style="display:table-row">
									<input type="button" id="btnEliminarproveedor" name="btnEliminarproveedor" title="ELIMINAR Proveedor ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirproveedor" style="visibility:visible">
								<input type="button" id="btnImprimirproveedor" name="btnImprimirproveedor" title="IMPRIMIR PAGINA Proveedor ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarproveedor" style="visibility:visible">
								<input type="button" id="btnCancelarproveedor" name="btnCancelarproveedor" title="CANCELAR Proveedor ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoproveedorGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosproveedor" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosproveedor" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioproveedor" name="btnGuardarCambiosFormularioproveedor" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoproveedor -->
			</td>
		</tr> <!-- trproveedorAcciones -->
		<?php if(proveedor_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trproveedorParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblproveedorParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trproveedorFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblproveedorParametrosAcciones -->
			</td>
		</tr> <!-- trproveedorParametrosAcciones -->
		<?php }?>
		<tr id="trproveedorMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trproveedorMensajes -->
			</table> <!-- tblproveedorAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoproveedor -->
			</div> <!-- divMantenimientoproveedorAjaxWebPart -->
		</td>
	</tr> <!-- trproveedorElementosFormulario/super -->
		<?php if(proveedor_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {proveedor_webcontrol,proveedor_webcontrol1} from './webroot/js/JavaScript/contabilidad/cuentaspagar/proveedor/js/webcontrol/proveedor_form_webcontrol.js?random=1';
