...
namespace com\bydan\contabilidad\cuentaspagar\debito_cuenta_pagar\presentation\session;
...
class debito_cuenta_pagar_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $debito_cuenta_pagar_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->debito_cuenta_pagar_sessionAdditional=new debito_cuenta_pagar_sessionAdditional();
		*/
