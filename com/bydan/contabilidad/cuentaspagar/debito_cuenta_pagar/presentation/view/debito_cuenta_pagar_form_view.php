...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/cuentaspagar/debito_cuenta_pagar/js/util/debito_cuenta_pagar_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			debito_cuenta_pagar_web::$STR_NOMBRE_PAGINA = 'debito_cuenta_pagar_form_view.php';
			debito_cuenta_pagar_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			debito_cuenta_pagar_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trdebito_cuenta_pagarElementosFormulario">
	<td>
		<div id="divMantenimientodebito_cuenta_pagarAjaxWebPart" title="DEBITO CUENTA PAGAR" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientodebito_cuenta_pagar" name="frmMantenimientodebito_cuenta_pagar">

			</br>

			<?php if(debito_cuenta_pagar_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tbldebito_cuenta_pagarToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tbldebito_cuenta_pagarToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tddebito_cuenta_pagarActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBardebito_cuenta_pagar" name="imgActualizarToolBardebito_cuenta_pagar" title="ACTUALIZAR Debito Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tddebito_cuenta_pagarEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBardebito_cuenta_pagar" name="imgEliminarToolBardebito_cuenta_pagar" title="ELIMINAR Debito Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tddebito_cuenta_pagarCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBardebito_cuenta_pagar" name="imgCancelarToolBardebito_cuenta_pagar" title="CANCELAR Debito Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tddebito_cuenta_pagarRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosdebito_cuenta_pagar',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tbldebito_cuenta_pagarToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tbldebito_cuenta_pagarToolBarFormularioExterior -->

			<table id="tbldebito_cuenta_pagarElementos">
			<tr id="trdebito_cuenta_pagarElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosdebito_cuenta_pagar" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					<tr id="tr_fila_1">
				...
				</table> <!-- tblElementosdebito_cuenta_pagar -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosdebito_cuenta_pagar" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultosdebito_cuenta_pagar -->

			</td></tr> <!-- trdebito_cuenta_pagarElementos -->
			</table> <!-- tbldebito_cuenta_pagarElementos -->
			</form> <!-- frmMantenimientodebito_cuenta_pagar -->


			

				<form id="frmAccionesMantenimientodebito_cuenta_pagar" name="frmAccionesMantenimientodebito_cuenta_pagar">

			<?php if(debito_cuenta_pagar_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tbldebito_cuenta_pagarAcciones" class="elementos" style="text-align: center">
		<tr id="trdebito_cuenta_pagarAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientodebito_cuenta_pagar" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientodebito_cuenta_pagarBasicos">
							<td id="tdbtnNuevodebito_cuenta_pagar" style="visibility:visible">
								<div id="divNuevodebito_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnNuevodebito_cuenta_pagar" name="btnNuevodebito_cuenta_pagar" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizardebito_cuenta_pagar" style="visibility:visible">
								<div id="divActualizardebito_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnActualizardebito_cuenta_pagar" name="btnActualizardebito_cuenta_pagar" title="ACTUALIZAR Debito Cuenta Pagar ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminardebito_cuenta_pagar" style="visibility:visible">
								<div id="divEliminardebito_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnEliminardebito_cuenta_pagar" name="btnEliminardebito_cuenta_pagar" title="ELIMINAR Debito Cuenta Pagar ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirdebito_cuenta_pagar" style="visibility:visible">
								<input type="button" id="btnImprimirdebito_cuenta_pagar" name="btnImprimirdebito_cuenta_pagar" title="IMPRIMIR PAGINA Debito Cuenta Pagar ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelardebito_cuenta_pagar" style="visibility:visible">
								<input type="button" id="btnCancelardebito_cuenta_pagar" name="btnCancelardebito_cuenta_pagar" title="CANCELAR Debito Cuenta Pagar ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientodebito_cuenta_pagarGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosdebito_cuenta_pagar" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosdebito_cuenta_pagar" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariodebito_cuenta_pagar" name="btnGuardarCambiosFormulariodebito_cuenta_pagar" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientodebito_cuenta_pagar -->
			</td>
		</tr> <!-- trdebito_cuenta_pagarAcciones -->
		<?php if(debito_cuenta_pagar_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trdebito_cuenta_pagarParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tbldebito_cuenta_pagarParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trdebito_cuenta_pagarFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tbldebito_cuenta_pagarParametrosAcciones -->
			</td>
		</tr> <!-- trdebito_cuenta_pagarParametrosAcciones -->
		<?php }?>
		<tr id="trdebito_cuenta_pagarMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trdebito_cuenta_pagarMensajes -->
			</table> <!-- tbldebito_cuenta_pagarAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientodebito_cuenta_pagar -->
			</div> <!-- divMantenimientodebito_cuenta_pagarAjaxWebPart -->
		</td>
	</tr> <!-- trdebito_cuenta_pagarElementosFormulario/super -->
		<?php if(debito_cuenta_pagar_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {debito_cuenta_pagar_webcontrol,debito_cuenta_pagar_webcontrol1} from './webroot/js/JavaScript/contabilidad/cuentaspagar/debito_cuenta_pagar/js/webcontrol/debito_cuenta_pagar_form_webcontrol.js?random=1';
