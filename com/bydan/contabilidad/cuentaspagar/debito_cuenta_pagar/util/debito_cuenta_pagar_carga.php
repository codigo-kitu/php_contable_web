...
class debito_cuenta_pagar_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/util/debito_cuenta_pagar_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/util/debito_cuenta_pagarParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/util/debito_cuenta_pagar_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/entity/debito_cuenta_pagar.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/entity/debito_cuenta_pagarForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/data/debito_cuenta_pagar_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/data/debito_cuenta_pagar_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/logic/debito_cuenta_pagar_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/logic/debito_cuenta_pagar_logic.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/logic/debito_cuenta_pagar_logic_add.php');		
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/presentation/session/debito_cuenta_pagar_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/presentation/view/debito_cuenta_pagar_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!debito_cuenta_pagar_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/entity/debito_cuenta_pagar.php');				
						debito_cuenta_pagar_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!debito_cuenta_pagar_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/data/debito_cuenta_pagar_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/data/debito_cuenta_pagar_data.php');
						debito_cuenta_pagar_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!debito_cuenta_pagar_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!debito_cuenta_pagar_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/logic/debito_cuenta_pagar_logic.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/business/logic/debito_cuenta_pagarLogic_add.php');
						debito_cuenta_pagar_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!debito_cuenta_pagar_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/util/debito_cuenta_pagar_util.php');
						debito_cuenta_pagar_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!debito_cuenta_pagar_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentaspagar/debito_cuenta_pagar/presentation/session/debito_cuenta_pagar_session.php');
						debito_cuenta_pagar_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface debito_cuenta_pagar_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
