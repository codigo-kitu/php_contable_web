			...
			<?php foreach ($cuenta_pagar_detallesLocal as $cuenta_pagar_detalle) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarcuenta_pagar_detalle" idactualcuenta_pagar_detalle="<?php echo($cuenta_pagar_detalle->id) ?>"  funcionjsactualcuenta_pagar_detalle="'.str_replace('TO_REPLACE',$cuenta_pagar_detalle->id.',\''.cuenta_pagar_detalle_util::getcuenta_pagar_detalleDescripcion($cuenta_pagar_detalle).'\'',$this->strFuncionJs).'" title="SELECCIONAR Detalle Cuenta Pagar ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Detalle Cuenta Pagar ACTUAL" value="<?php echo($cuenta_pagar_detalle->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($cuenta_pagar_detalle->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $cuenta_pagar_detalle->updated_at ) ?>
					</td>
				...
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($cuenta_pagar_detalle->id_empresa_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($cuenta_pagar_detalle->id_sucursal_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($cuenta_pagar_detalle->id_ejercicio_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($cuenta_pagar_detalle->id_periodo_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($cuenta_pagar_detalle->id_usuario_Descripcion) ?></td>
				<?php } ?>
				<td class="elementotabla col_id_cuenta_pagar" > <?php echo($cuenta_pagar_detalle->id_cuenta_pagar_Descripcion) ?></td>
				
					<td class="elementotabla col_numero" > 
						<?php echo( $cuenta_pagar_detalle->numero ) ?>
					</td>
				
					<td class="elementotabla col_fecha_emision" > 
						<?php echo( $cuenta_pagar_detalle->fecha_emision ) ?>
					</td>
				
					<td class="elementotabla col_fecha_vence" > 
						<?php echo( $cuenta_pagar_detalle->fecha_vence ) ?>
					</td>
				
					<td class="elementotabla col_referencia" > 
						<?php echo( $cuenta_pagar_detalle->referencia ) ?>
					</td>
				
					<td class="elementotabla col_monto" > 
						<?php echo( $cuenta_pagar_detalle->monto ) ?>
					</td>
				<td class="elementotabla col_id_estado" > <?php echo($cuenta_pagar_detalle->id_estado_Descripcion) ?></td>
