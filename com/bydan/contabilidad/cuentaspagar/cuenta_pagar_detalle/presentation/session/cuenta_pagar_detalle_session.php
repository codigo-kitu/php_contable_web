...
namespace com\bydan\contabilidad\cuentaspagar\cuenta_pagar_detalle\presentation\session;
...
class cuenta_pagar_detalle_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $cuenta_pagar_detalle_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->cuenta_pagar_detalle_sessionAdditional=new cuenta_pagar_detalle_sessionAdditional();
		*/
