...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/cuentaspagar/cuenta_pagar_detalle/js/util/cuenta_pagar_detalle_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			cuenta_pagar_detalle_web::$STR_NOMBRE_PAGINA = 'cuenta_pagar_detalle_form_view.php';
			cuenta_pagar_detalle_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			cuenta_pagar_detalle_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trcuenta_pagar_detalleElementosFormulario">
	<td>
		<div id="divMantenimientocuenta_pagar_detalleAjaxWebPart" title="DETALLE CUENTA PAGAR" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientocuenta_pagar_detalle" name="frmMantenimientocuenta_pagar_detalle">

			</br>

			<?php if(cuenta_pagar_detalle_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblcuenta_pagar_detalleToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblcuenta_pagar_detalleToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdcuenta_pagar_detalleActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarcuenta_pagar_detalle" name="imgActualizarToolBarcuenta_pagar_detalle" title="ACTUALIZAR Detalle Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdcuenta_pagar_detalleEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarcuenta_pagar_detalle" name="imgEliminarToolBarcuenta_pagar_detalle" title="ELIMINAR Detalle Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdcuenta_pagar_detalleCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarcuenta_pagar_detalle" name="imgCancelarToolBarcuenta_pagar_detalle" title="CANCELAR Detalle Cuenta Pagar ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdcuenta_pagar_detalleRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultoscuenta_pagar_detalle',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblcuenta_pagar_detalleToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblcuenta_pagar_detalleToolBarFormularioExterior -->

			<table id="tblcuenta_pagar_detalleElementos">
			<tr id="trcuenta_pagar_detalleElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementoscuenta_pagar_detalle" class="elementos" style="width: 350px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					<tr id="tr_fila_1">
				...
				</table> <!-- tblElementoscuenta_pagar_detalle -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultoscuenta_pagar_detalle" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultoscuenta_pagar_detalle -->

			</td></tr> <!-- trcuenta_pagar_detalleElementos -->
			</table> <!-- tblcuenta_pagar_detalleElementos -->
			</form> <!-- frmMantenimientocuenta_pagar_detalle -->


			

				<form id="frmAccionesMantenimientocuenta_pagar_detalle" name="frmAccionesMantenimientocuenta_pagar_detalle">

			<?php if(cuenta_pagar_detalle_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblcuenta_pagar_detalleAcciones" class="elementos" style="text-align: center">
		<tr id="trcuenta_pagar_detalleAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientocuenta_pagar_detalle" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientocuenta_pagar_detalleBasicos">
							<td id="tdbtnNuevocuenta_pagar_detalle" style="visibility:visible">
								<div id="divNuevocuenta_pagar_detalle" style="display:table-row">
									<input type="button" id="btnNuevocuenta_pagar_detalle" name="btnNuevocuenta_pagar_detalle" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarcuenta_pagar_detalle" style="visibility:visible">
								<div id="divActualizarcuenta_pagar_detalle" style="display:table-row">
									<input type="button" id="btnActualizarcuenta_pagar_detalle" name="btnActualizarcuenta_pagar_detalle" title="ACTUALIZAR Detalle Cuenta Pagar ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarcuenta_pagar_detalle" style="visibility:visible">
								<div id="divEliminarcuenta_pagar_detalle" style="display:table-row">
									<input type="button" id="btnEliminarcuenta_pagar_detalle" name="btnEliminarcuenta_pagar_detalle" title="ELIMINAR Detalle Cuenta Pagar ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimircuenta_pagar_detalle" style="visibility:visible">
								<input type="button" id="btnImprimircuenta_pagar_detalle" name="btnImprimircuenta_pagar_detalle" title="IMPRIMIR PAGINA Detalle Cuenta Pagar ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarcuenta_pagar_detalle" style="visibility:visible">
								<input type="button" id="btnCancelarcuenta_pagar_detalle" name="btnCancelarcuenta_pagar_detalle" title="CANCELAR Detalle Cuenta Pagar ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientocuenta_pagar_detalleGuardar" style="display:none">
							<td id="tdbtnGuardarCambioscuenta_pagar_detalle" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambioscuenta_pagar_detalle" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariocuenta_pagar_detalle" name="btnGuardarCambiosFormulariocuenta_pagar_detalle" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientocuenta_pagar_detalle -->
			</td>
		</tr> <!-- trcuenta_pagar_detalleAcciones -->
		<?php if(cuenta_pagar_detalle_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trcuenta_pagar_detalleParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblcuenta_pagar_detalleParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trcuenta_pagar_detalleFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblcuenta_pagar_detalleParametrosAcciones -->
			</td>
		</tr> <!-- trcuenta_pagar_detalleParametrosAcciones -->
		<?php }?>
		<tr id="trcuenta_pagar_detalleMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trcuenta_pagar_detalleMensajes -->
			</table> <!-- tblcuenta_pagar_detalleAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientocuenta_pagar_detalle -->
			</div> <!-- divMantenimientocuenta_pagar_detalleAjaxWebPart -->
		</td>
	</tr> <!-- trcuenta_pagar_detalleElementosFormulario/super -->
		<?php if(cuenta_pagar_detalle_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {cuenta_pagar_detalle_webcontrol,cuenta_pagar_detalle_webcontrol1} from './webroot/js/JavaScript/contabilidad/cuentaspagar/cuenta_pagar_detalle/js/webcontrol/cuenta_pagar_detalle_form_webcontrol.js?random=1';
