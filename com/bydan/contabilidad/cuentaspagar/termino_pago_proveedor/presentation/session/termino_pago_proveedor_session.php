...
namespace com\bydan\contabilidad\cuentaspagar\termino_pago_proveedor\presentation\session;
...
class termino_pago_proveedor_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $termino_pago_proveedor_sessionAdditional=null;
	...
	public ?bool $bitBusquedaDesdeFKSesiontipo_termino_pago=null;
	public ?int $bigidtipo_termino_pagoActual=null;
	public ?string $bigidtipo_termino_pagoActualDescripcion=null;
	...
	function __construct () {	
		...
		$this->termino_pago_proveedor_sessionAdditional=new termino_pago_proveedor_sessionAdditional();
		*/
		...
		$this->bitBusquedaDesdeFKSesiontipo_termino_pago=false;
		$this->bigidtipo_termino_pagoActual=0;
		$this->bigidtipo_termino_pagoActualDescripcion='';
