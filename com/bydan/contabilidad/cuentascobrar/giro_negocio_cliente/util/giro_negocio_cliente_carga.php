...
class giro_negocio_cliente_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/util/giro_negocio_cliente_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/util/giro_negocio_clienteParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/util/giro_negocio_cliente_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/business/entity/giro_negocio_cliente.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/business/entity/giro_negocio_clienteForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/business/data/giro_negocio_cliente_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/business/data/giro_negocio_cliente_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/business/logic/giro_negocio_cliente_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/business/logic/giro_negocio_cliente_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/presentation/session/giro_negocio_cliente_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/presentation/view/giro_negocio_cliente_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!giro_negocio_cliente_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/business/entity/giro_negocio_cliente.php');				
						giro_negocio_cliente_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!giro_negocio_cliente_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/business/data/giro_negocio_cliente_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/business/data/giro_negocio_cliente_data.php');
						giro_negocio_cliente_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!giro_negocio_cliente_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!giro_negocio_cliente_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/business/logic/giro_negocio_cliente_logic.php');
						giro_negocio_cliente_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!giro_negocio_cliente_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/util/giro_negocio_cliente_util.php');
						giro_negocio_cliente_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!giro_negocio_cliente_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/giro_negocio_cliente/presentation/session/giro_negocio_cliente_session.php');
						giro_negocio_cliente_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface giro_negocio_cliente_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
