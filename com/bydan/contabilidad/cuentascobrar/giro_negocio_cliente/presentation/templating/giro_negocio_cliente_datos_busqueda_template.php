			...
			<?php foreach ($giro_negocio_clientesLocal as $giro_negocio_cliente) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionargiro_negocio_cliente" idactualgiro_negocio_cliente="<?php echo($giro_negocio_cliente->id) ?>"  funcionjsactualgiro_negocio_cliente="'.str_replace('TO_REPLACE',$giro_negocio_cliente->id.',\''.giro_negocio_cliente_util::getgiro_negocio_clienteDescripcion($giro_negocio_cliente).'\'',$this->strFuncionJs).'" title="SELECCIONAR Giro Negocio ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Giro Negocio ACTUAL" value="<?php echo($giro_negocio_cliente->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($giro_negocio_cliente->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $giro_negocio_cliente->updated_at ) ?>
					</td>
					...
					<td class="elementotabla col_nombre" > 
						<?php echo( $giro_negocio_cliente->nombre ) ?>
					</td>
				
					<td class="elementotabla col_predeterminado" ><?php  $funciones->getCheckBox($giro_negocio_cliente->predeterminado,'form<?php echo($strSufijo) ?>-predeterminadoi',$paraReporte)  ?>
					</td>
