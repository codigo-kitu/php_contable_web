		...
		<?php if($IS_DEVELOPING) { ?>
			...
			<th class="cabecera_titulo_tabla" >
				<pre class="cabecera_texto_titulo_tabla"> Empresa<a onclick="jQuery('#form-id_empresa_img').trigger('click' );"><img id="form$strSufijo-id_empresa_img2" name="form$strSufijo-id_empresa_img2" class="imagen_actualizar" title="ACTUALIZAR DATOS RELACIONADOS" src="<?php echo($PATH_IMAGEN) ?>Imagenes/actualizardatos.gif" alt="Actualizar Datos" border="" height="15" width="15"></a><a onclick="cuenta_cobrar_webcontrol1.abrirBusquedaParaempresa('id_empresa');"><img id="form$strSufijo-id_empresa_img_busqueda2" name="form$strSufijo-id_empresa_img_busqueda2" title="Buscar Empresa" style="width: 15px; height: 15px;text-align: center; visibility:visible;" src="<?php echo($PATH_IMAGEN) ?>Imagenes/buscar.gif" width="15" height="15"/></a></pre>
			</th>
		<?php } ?>
		...
		<?php if($IS_DEVELOPING) { ?>
			...
			<th class="cabecera_titulo_tabla" >
				<pre class="cabecera_texto_titulo_tabla"> Sucursal<a onclick="jQuery('#form-id_sucursal_img').trigger('click' );"><img id="form$strSufijo-id_sucursal_img2" name="form$strSufijo-id_sucursal_img2" class="imagen_actualizar" title="ACTUALIZAR DATOS RELACIONADOS" src="<?php echo($PATH_IMAGEN) ?>Imagenes/actualizardatos.gif" alt="Actualizar Datos" border="" height="15" width="15"></a><a onclick="cuenta_cobrar_webcontrol1.abrirBusquedaParasucursal('id_sucursal');"><img id="form$strSufijo-id_sucursal_img_busqueda2" name="form$strSufijo-id_sucursal_img_busqueda2" title="Buscar Sucursal" style="width: 15px; height: 15px;text-align: center; visibility:visible;" src="<?php echo($PATH_IMAGEN) ?>Imagenes/buscar.gif" width="15" height="15"/></a></pre>
			</th>
		<?php } ?>
		...
		<?php if($IS_DEVELOPING) { ?>
			...
			<th class="cabecera_titulo_tabla" >
				<pre class="cabecera_texto_titulo_tabla"> Ejercicio<a onclick="jQuery('#form-id_ejercicio_img').trigger('click' );"><img id="form$strSufijo-id_ejercicio_img2" name="form$strSufijo-id_ejercicio_img2" class="imagen_actualizar" title="ACTUALIZAR DATOS RELACIONADOS" src="<?php echo($PATH_IMAGEN) ?>Imagenes/actualizardatos.gif" alt="Actualizar Datos" border="" height="15" width="15"></a><a onclick="cuenta_cobrar_webcontrol1.abrirBusquedaParaejercicio('id_ejercicio');"><img id="form$strSufijo-id_ejercicio_img_busqueda2" name="form$strSufijo-id_ejercicio_img_busqueda2" title="Buscar ejercicio" style="width: 15px; height: 15px;text-align: center; visibility:visible;" src="<?php echo($PATH_IMAGEN) ?>Imagenes/buscar.gif" width="15" height="15"/></a></pre>
			</th>
		<?php } ?>
			...
			<?php foreach ($cuenta_cobrarsLocal as $cuenta_cobrar) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarcuenta_cobrar" idactualcuenta_cobrar="<?php echo($cuenta_cobrar->id) ?>"  funcionjsactualcuenta_cobrar="'.str_replace('TO_REPLACE',$cuenta_cobrar->id.',\''.cuenta_cobrar_util::getcuenta_cobrarDescripcion($cuenta_cobrar).'\'',$this->strFuncionJs).'" title="SELECCIONAR Cuenta Cobrar ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Cuenta Cobrar ACTUAL" value="<?php echo($cuenta_cobrar->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($cuenta_cobrar->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $cuenta_cobrar->updated_at ) ?>
					</td>
				...
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($cuenta_cobrar->id_empresa_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($cuenta_cobrar->id_sucursal_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($cuenta_cobrar->id_ejercicio_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($cuenta_cobrar->id_periodo_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($cuenta_cobrar->id_usuario_Descripcion) ?></td>
				<?php } ?>
				<td class="elementotabla col_id_factura" > <?php echo($cuenta_cobrar->id_factura_Descripcion) ?></td>
				<td class="elementotabla col_id_cliente" > <?php echo($cuenta_cobrar->id_cliente_Descripcion) ?></td>
				
					<td class="elementotabla col_numero" > 
						<?php echo( $cuenta_cobrar->numero ) ?>
					</td>
				
					<td class="elementotabla col_fecha_emision" > 
						<?php echo( $cuenta_cobrar->fecha_emision ) ?>
					</td>
				
					<td class="elementotabla col_fecha_vence" > 
						<?php echo( $cuenta_cobrar->fecha_vence ) ?>
					</td>
				
					<td class="elementotabla col_fecha_ultimo_movimiento" > 
						<?php echo( $cuenta_cobrar->fecha_ultimo_movimiento ) ?>
					</td>
				<td class="elementotabla col_id_termino_pago_cliente" > <?php echo($cuenta_cobrar->id_termino_pago_cliente_Descripcion) ?></td>
				
					<td class="elementotabla col_monto" > 
						<?php echo( $cuenta_cobrar->monto ) ?>
					</td>
				<td class="elementotabla col_id_estado_cuentas_cobrar" > <?php echo($cuenta_cobrar->id_estado_cuentas_cobrar_Descripcion) ?></td>
