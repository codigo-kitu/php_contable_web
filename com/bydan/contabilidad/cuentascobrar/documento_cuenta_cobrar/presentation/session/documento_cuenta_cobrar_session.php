...
namespace com\bydan\contabilidad\cuentascobrar\documento_cuenta_cobrar\presentation\session;
...
class documento_cuenta_cobrar_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $documento_cuenta_cobrar_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->documento_cuenta_cobrar_sessionAdditional=new documento_cuenta_cobrar_sessionAdditional();
		*/
