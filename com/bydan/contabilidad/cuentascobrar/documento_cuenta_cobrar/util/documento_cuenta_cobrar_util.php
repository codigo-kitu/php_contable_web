...
class documento_cuenta_cobrar_util extends GeneralEntityConstantesFunciones  {
	/*CONTROL_INICIO*/
			
	/*GENERAL*/
	public static string $STR_CLASS_NAME='documento_cuenta_cobrar';
	public static string $STR_FINAL_QUERY='';	
	public static string $STR_NOMBRE_OPCION='cuentas_cobrar.documento_cuenta_cobrars';
	/*'Mantenimientodocumento_cuenta_cobrar.jsf';*/
	public static string $STR_MODULO_OPCION='cuentascobrar';
	public static string $STR_NOMBRE_CLASE='Mantenimientodocumento_cuenta_cobrar.jsf';	
	public static string $STR_PATH_OPCION='';	
	public static string $STR_PERSISTENCE_CONTEXT_NAME='';
	public static string $STR_PERSISTENCE_NAME='documento_cuenta_cobrarPersistenceName';
	/*.documento_cuenta_cobrar_util::$SPERSISTENCECONTEXTNAME.Constantes::$SPERSISTENCECONTEXTNAME;*/
	public static string $STR_SESSION_NAME='documento_cuenta_cobrar_session';
	/*.Constantes$::SSESSIONBEAN;*/
	public static string $STR_SESSION_CONTROLLER_NAME='documento_cuenta_cobrar_control_session';
	/*.Constantes$::SSESSIONBEAN;*/
	public static string $STR_CONTROLLER_NAME='documento_cuenta_cobrar_control';
	public static string $STR_CLASS_NAME_TITULO_REPORTES='Documentos Cuentas por Cobrares';
	public static string $STR_RELATIVE_PATH='../';
	public static string $STR_CLASS_PLURAL='es';
	public static string $STR_CLASS_WEB_TITULO='Documentos Cuentas por Cobrar';
	...
	/*AUXILIAR*/
	//public $documento_cuenta_cobrarConstantesFuncionesAdditional;
    ...
    public static string $REF_PAGO='ref_pago';
    ...
    public static string $LABEL_ID_ORIGEN='Id Origen';
    public static string $LABEL_MODULO_DESTINO='Modulo Destino';
    public static string $LABEL_ID_DESTINO='Id Destino';
    ...
    public static string $LABEL_NUMERO_CLIENTE='Nro Documento Cliente';
    ...
    public static string $LABEL_REF_PAGO='Referencia Pago';
    ...
    public static string $LABEL_NCF='Ncf';
	
	
	function __construct (){
		/*AUTOREFERENCIA INFINITA TALVEZ
		$this->documento_cuenta_cobrarConstantesFuncionesAdditional=new $documento_cuenta_cobrarConstantesFuncionesAdditional();*/
	}
	
	/*LISTA INDICE*/
	public static function getIndiceNuevo(array $documento_cuenta_cobrars,int $iIdNuevodocumento_cuenta_cobrar) : int {
		$iIndice=0;
		$existe=false;
		
		foreach($documento_cuenta_cobrars as $documento_cuenta_cobrarAux) {
			if($documento_cuenta_cobrarAux->getId()==$iIdNuevodocumento_cuenta_cobrar) {
				$existe=true;
				break;
			}
	...
	public static function getIndiceActual(array $documento_cuenta_cobrars,documento_cuenta_cobrar $documento_cuenta_cobrar,int $iIndiceActual) : int {
		$iIndice=0;
		$existe=false;
		
		foreach($documento_cuenta_cobrars as $documento_cuenta_cobrarAux) {
			if($documento_cuenta_cobrarAux->getId()==$documento_cuenta_cobrar->getId()) {
				$existe=true;
				break;
			}
	...
	/*DESCRIPCION*/
	public static function getdocumento_cuenta_cobrarDescripcion(?documento_cuenta_cobrar $documento_cuenta_cobrar) : string {//documento_cuenta_cobrar NO USAR CLASE, PARA NULOS SE DANA
		$sDescripcion=Constantes::$STR_NONE;
			
		if($documento_cuenta_cobrar !=null) {
			/*&& documento_cuenta_cobrar->getId()!=0*/
			
			if($documento_cuenta_cobrar->getId()!=null) {
				$sDescripcion=(string)$documento_cuenta_cobrar->getId();
			}
	...
	public static function setdocumento_cuenta_cobrarDescripcion(?documento_cuenta_cobrar $documento_cuenta_cobrar,string $sValor) {			
		if($documento_cuenta_cobrar !=null) {
	...
	public static function prepararCombosFK(array $documento_cuenta_cobrars) : array {
		$documento_cuenta_cobrarsForeignKey=array();
		
		foreach ($documento_cuenta_cobrars as $documento_cuenta_cobrarLocal) {
			$documento_cuenta_cobrarsForeignKey[$documento_cuenta_cobrarLocal->getId()]=documento_cuenta_cobrar_util::getdocumento_cuenta_cobrarDescripcion($documento_cuenta_cobrarLocal);
		}
			
		return $documento_cuenta_cobrarsForeignKey;
	}
    ...
    public static function getColumnLabelid_origen() : string  { return 'Id Origen'; }
    public static function getColumnLabelmodulo_destino() : string  { return 'Modulo Destino'; }
    public static function getColumnLabelid_destino() : string  { return 'Id Destino'; }
    ...
    public static function getColumnLabelnumero_cliente() : string  { return 'Nro Documento Cliente'; }
    ...
    public static function getColumnLabelref_pago() : string  { return 'Referencia Pago'; }
    ...
    public static function getColumnLabelncf() : string  { return 'Ncf'; }

	/*DESCRIPCION CAMPOS BOOLEAN*/
	
	/*DESCRIPCION FKs*/
	public static function refrescarFKDescripciones(array $documento_cuenta_cobrars) {		
		try {
	...
	public static function refrescarFKDescripcion(documento_cuenta_cobrar $documento_cuenta_cobrar) {		
		try {
	...
	public static function getTiposSeleccionar(bool $conFk) : array {
		return documento_cuenta_cobrar_util::getTiposSeleccionar3($conFk,true,true,true,true);
	}
	
	public static function getTiposSeleccionar2() : array {
		return documento_cuenta_cobrar_util::getTiposSeleccionar3(false,true,true,true,true);
	}
	...
	public static function getTiposSeleccionar3(bool $conFk,bool $conStringColumn,bool $conValorColumn,bool $conFechaColumn,bool $conBitColumn) : array {
		...
		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_EMPRESA);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_EMPRESA.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_SUCURSAL);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_SUCURSAL.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_EJERCICIO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_EJERCICIO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_PERIODO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_PERIODO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_USUARIO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_USUARIO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_NUMERO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_NUMERO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_CLIENTE);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_CLIENTE.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_TIPO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_TIPO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFechaColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_FECHA_EMISION);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_FECHA_EMISION);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_DESCRIPCION);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_DESCRIPCION);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_MONTO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_MONTO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_MONTO_PARCIAL);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_MONTO_PARCIAL);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_MONEDA);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_MONEDA);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFechaColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_FECHA_VENCE);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_FECHA_VENCE);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_NUMERO_DE_PAGOS);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_NUMERO_DE_PAGOS);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_BALANCE);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_BALANCE);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_NUMERO_PAGADO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_NUMERO_PAGADO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_PAGADO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_PAGADO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_MODULO_ORIGEN);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_MODULO_ORIGEN);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_ORIGEN);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_ORIGEN);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_MODULO_DESTINO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_MODULO_DESTINO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_DESTINO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_DESTINO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_NOMBRE_PC);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_NOMBRE_PC);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFechaColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_HORA);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_HORA);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_MONTO_MORA);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_MONTO_MORA);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_INTERES_MORA);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_INTERES_MORA);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_DIAS_GRACIA_MORA);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_DIAS_GRACIA_MORA);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_INSTRUMENTO_PAGO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_INSTRUMENTO_PAGO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_TIPO_CAMBIO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_TIPO_CAMBIO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_NUMERO_CLIENTE);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_NUMERO_CLIENTE);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_CLASE_REGISTRO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_CLASE_REGISTRO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ESTADO_REGISTRO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ESTADO_REGISTRO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_MOTIVO_ANULACION);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_MOTIVO_ANULACION);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_IMPUESTO_1);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_IMPUESTO_1);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_IMPUESTO_2);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_IMPUESTO_2);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_IMPUESTO_INCLUIDO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_IMPUESTO_INCLUIDO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_OBSERVACIONES);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_OBSERVACIONES);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_GRUPO_PAGO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_GRUPO_PAGO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_TERMINO_IDPV);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_TERMINO_IDPV);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_FORMA_PAGO_CLIENTE);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_FORMA_PAGO_CLIENTE.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_NRO_PAGO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_NRO_PAGO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_REF_PAGO);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_REF_PAGO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFechaColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_FECHA_HORA);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_FECHA_HORA);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_BASE);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_BASE);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_ID_CUENTA_CORRIENTE);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_ID_CUENTA_CORRIENTE.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(documento_cuenta_cobrar_util::$LABEL_NCF);
			$reporte->setsDescripcion(documento_cuenta_cobrar_util::$LABEL_NCF);
			$arrTiposSeleccionarTodos[]=$reporte;
		}
	...
	public static function getArrayColumnasGlobales(array $arrDatoGeneral) : array {
		...
		$arrColumnasGlobales=documento_cuenta_cobrar_util::getArrayColumnasGlobalesConNoColumnas($arrDatoGeneral,array());
	...
	public static function getArrayColumnasGlobalesConNoColumnas(array $arrDatoGeneral,array $arrColumnasGlobalesNo) : array {
		...
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==documento_cuenta_cobrar_util::$ID_EMPRESA) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=documento_cuenta_cobrar_util::$ID_EMPRESA;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==documento_cuenta_cobrar_util::$ID_SUCURSAL) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=documento_cuenta_cobrar_util::$ID_SUCURSAL;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==documento_cuenta_cobrar_util::$ID_EJERCICIO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=documento_cuenta_cobrar_util::$ID_EJERCICIO;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==documento_cuenta_cobrar_util::$ID_PERIODO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=documento_cuenta_cobrar_util::$ID_PERIODO;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==documento_cuenta_cobrar_util::$ID_USUARIO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=documento_cuenta_cobrar_util::$ID_USUARIO;
		}
	...
	public static function getClassesRelsOf(array $classesP,string $deepLoadType) : array {
		try {
			...
			if($deepLoadType==DeepLoadType::$NONE) {
				...
				foreach($classesP as $clas) {
					if($clas==imagen_documento_cuenta_cobrar::$class) {
						$classes[]=new Classe(imagen_documento_cuenta_cobrar::$class); break;
					}
				}
	...
	public static function getOrderByLista() : array {
		...
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID, documento_cuenta_cobrar_util::$ID,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_EMPRESA, documento_cuenta_cobrar_util::$ID_EMPRESA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_SUCURSAL, documento_cuenta_cobrar_util::$ID_SUCURSAL,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_EJERCICIO, documento_cuenta_cobrar_util::$ID_EJERCICIO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_PERIODO, documento_cuenta_cobrar_util::$ID_PERIODO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_USUARIO, documento_cuenta_cobrar_util::$ID_USUARIO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_NUMERO, documento_cuenta_cobrar_util::$NUMERO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_CLIENTE, documento_cuenta_cobrar_util::$ID_CLIENTE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_TIPO, documento_cuenta_cobrar_util::$TIPO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_FECHA_EMISION, documento_cuenta_cobrar_util::$FECHA_EMISION,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_DESCRIPCION, documento_cuenta_cobrar_util::$DESCRIPCION,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_MONTO, documento_cuenta_cobrar_util::$MONTO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_MONTO_PARCIAL, documento_cuenta_cobrar_util::$MONTO_PARCIAL,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_MONEDA, documento_cuenta_cobrar_util::$MONEDA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_FECHA_VENCE, documento_cuenta_cobrar_util::$FECHA_VENCE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_NUMERO_DE_PAGOS, documento_cuenta_cobrar_util::$NUMERO_DE_PAGOS,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_BALANCE, documento_cuenta_cobrar_util::$BALANCE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_NUMERO_PAGADO, documento_cuenta_cobrar_util::$NUMERO_PAGADO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_PAGADO, documento_cuenta_cobrar_util::$ID_PAGADO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_MODULO_ORIGEN, documento_cuenta_cobrar_util::$MODULO_ORIGEN,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_ORIGEN, documento_cuenta_cobrar_util::$ID_ORIGEN,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_MODULO_DESTINO, documento_cuenta_cobrar_util::$MODULO_DESTINO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_DESTINO, documento_cuenta_cobrar_util::$ID_DESTINO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_NOMBRE_PC, documento_cuenta_cobrar_util::$NOMBRE_PC,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_HORA, documento_cuenta_cobrar_util::$HORA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_MONTO_MORA, documento_cuenta_cobrar_util::$MONTO_MORA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_INTERES_MORA, documento_cuenta_cobrar_util::$INTERES_MORA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_DIAS_GRACIA_MORA, documento_cuenta_cobrar_util::$DIAS_GRACIA_MORA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_INSTRUMENTO_PAGO, documento_cuenta_cobrar_util::$INSTRUMENTO_PAGO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_TIPO_CAMBIO, documento_cuenta_cobrar_util::$TIPO_CAMBIO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_NUMERO_CLIENTE, documento_cuenta_cobrar_util::$NUMERO_CLIENTE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_CLASE_REGISTRO, documento_cuenta_cobrar_util::$CLASE_REGISTRO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ESTADO_REGISTRO, documento_cuenta_cobrar_util::$ESTADO_REGISTRO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_MOTIVO_ANULACION, documento_cuenta_cobrar_util::$MOTIVO_ANULACION,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_IMPUESTO_1, documento_cuenta_cobrar_util::$IMPUESTO_1,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_IMPUESTO_2, documento_cuenta_cobrar_util::$IMPUESTO_2,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_IMPUESTO_INCLUIDO, documento_cuenta_cobrar_util::$IMPUESTO_INCLUIDO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_OBSERVACIONES, documento_cuenta_cobrar_util::$OBSERVACIONES,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_GRUPO_PAGO, documento_cuenta_cobrar_util::$GRUPO_PAGO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_TERMINO_IDPV, documento_cuenta_cobrar_util::$TERMINO_IDPV,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_FORMA_PAGO_CLIENTE, documento_cuenta_cobrar_util::$ID_FORMA_PAGO_CLIENTE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_NRO_PAGO, documento_cuenta_cobrar_util::$NRO_PAGO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_REF_PAGO, documento_cuenta_cobrar_util::$REF_PAGO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_FECHA_HORA, documento_cuenta_cobrar_util::$FECHA_HORA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_BASE, documento_cuenta_cobrar_util::$ID_BASE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_ID_CUENTA_CORRIENTE, documento_cuenta_cobrar_util::$ID_CUENTA_CORRIENTE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,documento_cuenta_cobrar_util::$LABEL_NCF, documento_cuenta_cobrar_util::$NCF,false,""); $arrOrderBy[]=$orderBy;
	...
	public static function getOrderByListaRel() : array {
		...
		$orderBy=OrderBy::NewOrderBy(false,imagen_documento_cuenta_cobrar_util::$STR_CLASS_WEB_TITULO, imagen_documento_cuenta_cobrar_util::$STR_CLASS_WEB_TITULO,false,""); $arrOrderBy[]=$orderBy;
	...
	public static function getHeaderReportRow(string $tipo='NORMAL',array $arrOrderBy,bool $bitParaReporteOrderBy) : array {
		...
		if(Funciones::existeCadenaArrayOrderBy('Id Destino',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine('Id Destino',40,7,1);$cellReport->setblnFill($blnFill); $header[]=$cellReport;
		}
		...
		if(Funciones::existeCadenaArrayOrderBy('Nro Documento Cliente',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine('Nro Documento Cliente',40,7,1);$cellReport->setblnFill($blnFill); $header[]=$cellReport;
		}
		...
		if(Funciones::existeCadenaArrayOrderBy('Ncf',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine('Ncf',40,7,1);$cellReport->setblnFill($blnFill); $header[]=$cellReport;
		}
		
		return $header;
	}
	
	public static function getDataReportRow(string $tipo='NORMAL',documento_cuenta_cobrar $documento_cuenta_cobrar,array $arrOrderBy,bool $bitParaReporteOrderBy) : array {
		$row=array();
		...
		if(Funciones::existeCadenaArrayOrderBy('Empresa',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_empresa_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Sucursal',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_sucursal_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Ejercicio',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_ejercicio_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Periodo',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_periodo_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Usuario',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_usuario_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Numero',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getnumero(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Cliente',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_cliente_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Tipo',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->gettipo(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Fecha Emision',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getfecha_emision(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Descripcion',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getdescripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Monto',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getmonto(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Monto Parcial',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getmonto_parcial(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Moneda',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getmoneda(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Fecha Vencimiento',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getfecha_vence(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Nro De Pagos',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getnumero_de_pagos(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Balance',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getbalance(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Nro Documento Pagado',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getnumero_pagado(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Id Pagado',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_pagado(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Modulo Origen',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getmodulo_origen(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Id Origen',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_origen(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Modulo Destino',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getmodulo_destino(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Id Destino',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_destino(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Nombre Pc',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getnombre_pc(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Hora',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->gethora(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Monto Mora',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getmonto_mora(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Interes Mora',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getinteres_mora(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Dias Gracia Mora',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getdias_gracia_mora(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Instrumento Pago',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getinstrumento_pago(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Tipo Cambio',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->gettipo_cambio(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Nro Documento Cliente',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getnumero_cliente(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Clase Registro',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getclase_registro(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Estado Registro',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getestado_registro(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Motivo Anulacion',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getmotivo_anulacion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Impuesto 1',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getimpuesto_1(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Impuesto 2',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getimpuesto_2(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Impuesto Incluido',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getimpuesto_incluido(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Observaciones',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getobservaciones(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Grupo Pago',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getgrupo_pago(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Termino Idpv',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->gettermino_idpv(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Forma Pago Cliente',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_forma_pago_cliente_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Nro Pago',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getnro_pago(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Referencia Pago',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getref_pago(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Fecha Hora',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getfecha_hora(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Id Base',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_base(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Cuenta Cliente',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getid_cuenta_corriente_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Ncf',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($documento_cuenta_cobrar->getncf(),40,6,1); $row[]=$cellReport;
		}
	...
	interface documento_cuenta_cobrar_util extends GeneralEntityConstantesFunciones  {
