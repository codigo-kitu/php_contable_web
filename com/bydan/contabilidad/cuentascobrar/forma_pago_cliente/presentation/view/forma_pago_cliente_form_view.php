...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/cuentascobrar/forma_pago_cliente/js/util/forma_pago_cliente_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			forma_pago_cliente_web::$STR_NOMBRE_PAGINA = 'forma_pago_cliente_form_view.php';
			forma_pago_cliente_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			forma_pago_cliente_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trforma_pago_clienteElementosFormulario">
	<td>
		<div id="divMantenimientoforma_pago_clienteAjaxWebPart" title="FORMA PAGO CLIENTE" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoforma_pago_cliente" name="frmMantenimientoforma_pago_cliente">

			</br>

			<?php if(forma_pago_cliente_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblforma_pago_clienteToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblforma_pago_clienteToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdforma_pago_clienteActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarforma_pago_cliente" name="imgActualizarToolBarforma_pago_cliente" title="ACTUALIZAR Forma Pago Cliente ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdforma_pago_clienteEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarforma_pago_cliente" name="imgEliminarToolBarforma_pago_cliente" title="ELIMINAR Forma Pago Cliente ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdforma_pago_clienteCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarforma_pago_cliente" name="imgCancelarToolBarforma_pago_cliente" title="CANCELAR Forma Pago Cliente ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdforma_pago_clienteRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosforma_pago_cliente',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblforma_pago_clienteToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblforma_pago_clienteToolBarFormularioExterior -->

			<table id="tblforma_pago_clienteElementos">
			<tr id="trforma_pago_clienteElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosforma_pago_cliente" class="elementos" style="width: 350px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: center;">
					<tr id="tr_fila_1">
				...
				</table> <!-- tblElementosforma_pago_cliente -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosforma_pago_cliente" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultosforma_pago_cliente -->

			</td></tr> <!-- trforma_pago_clienteElementos -->
			</table> <!-- tblforma_pago_clienteElementos -->
			</form> <!-- frmMantenimientoforma_pago_cliente -->


			

				<form id="frmAccionesMantenimientoforma_pago_cliente" name="frmAccionesMantenimientoforma_pago_cliente">

			<?php if(forma_pago_cliente_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblforma_pago_clienteAcciones" class="elementos" style="text-align: center">
		<tr id="trforma_pago_clienteAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoforma_pago_cliente" class="busqueda" style="width: 50%;text-align: center">
						...
						<tr id="trAccionesMantenimientoforma_pago_clienteBasicos">
							<td id="tdbtnNuevoforma_pago_cliente" style="visibility:visible">
								<div id="divNuevoforma_pago_cliente" style="display:table-row">
									<input type="button" id="btnNuevoforma_pago_cliente" name="btnNuevoforma_pago_cliente" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarforma_pago_cliente" style="visibility:visible">
								<div id="divActualizarforma_pago_cliente" style="display:table-row">
									<input type="button" id="btnActualizarforma_pago_cliente" name="btnActualizarforma_pago_cliente" title="ACTUALIZAR Forma Pago Cliente ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarforma_pago_cliente" style="visibility:visible">
								<div id="divEliminarforma_pago_cliente" style="display:table-row">
									<input type="button" id="btnEliminarforma_pago_cliente" name="btnEliminarforma_pago_cliente" title="ELIMINAR Forma Pago Cliente ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirforma_pago_cliente" style="visibility:visible">
								<input type="button" id="btnImprimirforma_pago_cliente" name="btnImprimirforma_pago_cliente" title="IMPRIMIR PAGINA Forma Pago Cliente ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarforma_pago_cliente" style="visibility:visible">
								<input type="button" id="btnCancelarforma_pago_cliente" name="btnCancelarforma_pago_cliente" title="CANCELAR Forma Pago Cliente ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoforma_pago_clienteGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosforma_pago_cliente" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosforma_pago_cliente" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioforma_pago_cliente" name="btnGuardarCambiosFormularioforma_pago_cliente" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoforma_pago_cliente -->
			</td>
		</tr> <!-- trforma_pago_clienteAcciones -->
		<?php if(forma_pago_cliente_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trforma_pago_clienteParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblforma_pago_clienteParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trforma_pago_clienteFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblforma_pago_clienteParametrosAcciones -->
			</td>
		</tr> <!-- trforma_pago_clienteParametrosAcciones -->
		<?php }?>
		<tr id="trforma_pago_clienteMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trforma_pago_clienteMensajes -->
			</table> <!-- tblforma_pago_clienteAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoforma_pago_cliente -->
			</div> <!-- divMantenimientoforma_pago_clienteAjaxWebPart -->
		</td>
	</tr> <!-- trforma_pago_clienteElementosFormulario/super -->
		<?php if(forma_pago_cliente_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {forma_pago_cliente_webcontrol,forma_pago_cliente_webcontrol1} from './webroot/js/JavaScript/contabilidad/cuentascobrar/forma_pago_cliente/js/webcontrol/forma_pago_cliente_form_webcontrol.js?random=1';
