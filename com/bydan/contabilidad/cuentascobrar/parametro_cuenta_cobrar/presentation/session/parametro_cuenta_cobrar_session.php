...
namespace com\bydan\contabilidad\cuentascobrar\parametro_cuenta_cobrar\presentation\session;
...
class parametro_cuenta_cobrar_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $parametro_cuenta_cobrar_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->parametro_cuenta_cobrar_sessionAdditional=new parametro_cuenta_cobrar_sessionAdditional();
		*/
