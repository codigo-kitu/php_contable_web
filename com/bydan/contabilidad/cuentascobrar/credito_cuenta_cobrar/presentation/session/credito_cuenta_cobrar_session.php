...
namespace com\bydan\contabilidad\cuentascobrar\credito_cuenta_cobrar\presentation\session;
...
class credito_cuenta_cobrar_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $credito_cuenta_cobrar_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->credito_cuenta_cobrar_sessionAdditional=new credito_cuenta_cobrar_sessionAdditional();
		*/
