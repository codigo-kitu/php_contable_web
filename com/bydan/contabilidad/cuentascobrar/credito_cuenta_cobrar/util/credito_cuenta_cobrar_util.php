...
class credito_cuenta_cobrar_util extends GeneralEntityConstantesFunciones  {
	/*CONTROL_INICIO*/
			
	/*GENERAL*/
	public static string $STR_CLASS_NAME='credito_cuenta_cobrar';
	public static string $STR_FINAL_QUERY='';	
	public static string $STR_NOMBRE_OPCION='cuentas_cobrar.credito_cuenta_cobrars';
	/*'Mantenimientocredito_cuenta_cobrar.jsf';*/
	public static string $STR_MODULO_OPCION='cuentascobrar';
	public static string $STR_NOMBRE_CLASE='Mantenimientocredito_cuenta_cobrar.jsf';	
	public static string $STR_PATH_OPCION='';	
	public static string $STR_PERSISTENCE_CONTEXT_NAME='';
	public static string $STR_PERSISTENCE_NAME='credito_cuenta_cobrarPersistenceName';
	/*.credito_cuenta_cobrar_util::$SPERSISTENCECONTEXTNAME.Constantes::$SPERSISTENCECONTEXTNAME;*/
	public static string $STR_SESSION_NAME='credito_cuenta_cobrar_session';
	/*.Constantes$::SSESSIONBEAN;*/
	public static string $STR_SESSION_CONTROLLER_NAME='credito_cuenta_cobrar_control_session';
	/*.Constantes$::SSESSIONBEAN;*/
	public static string $STR_CONTROLLER_NAME='credito_cuenta_cobrar_control';
	public static string $STR_CLASS_NAME_TITULO_REPORTES='Credito Cuenta Cobrars';
	public static string $STR_RELATIVE_PATH='../';
	public static string $STR_CLASS_PLURAL='s';
	public static string $STR_CLASS_WEB_TITULO='Credito Cuenta Cobrar';
	...
	/*AUXILIAR*/
	//public $credito_cuenta_cobrarConstantesFuncionesAdditional;
	...
	function __construct (){
		...
		$this->credito_cuenta_cobrarConstantesFuncionesAdditional=new $credito_cuenta_cobrarConstantesFuncionesAdditional();*/
	}
	
	/*LISTA INDICE*/
	public static function getIndiceNuevo(array $credito_cuenta_cobrars,int $iIdNuevocredito_cuenta_cobrar) : int {
		$iIndice=0;
		$existe=false;
		
		foreach($credito_cuenta_cobrars as $credito_cuenta_cobrarAux) {
			if($credito_cuenta_cobrarAux->getId()==$iIdNuevocredito_cuenta_cobrar) {
				$existe=true;
				break;
			}
	...
	public static function getIndiceActual(array $credito_cuenta_cobrars,credito_cuenta_cobrar $credito_cuenta_cobrar,int $iIndiceActual) : int {
		$iIndice=0;
		$existe=false;
		
		foreach($credito_cuenta_cobrars as $credito_cuenta_cobrarAux) {
			if($credito_cuenta_cobrarAux->getId()==$credito_cuenta_cobrar->getId()) {
				$existe=true;
				break;
			}
	...
	/*DESCRIPCION*/
	public static function getcredito_cuenta_cobrarDescripcion(?credito_cuenta_cobrar $credito_cuenta_cobrar) : string {//credito_cuenta_cobrar NO USAR CLASE, PARA NULOS SE DANA
		$sDescripcion=Constantes::$STR_NONE;
			
		if($credito_cuenta_cobrar !=null) {
			/*&& credito_cuenta_cobrar->getId()!=0*/
			
			if($credito_cuenta_cobrar->getId()!=null) {
				$sDescripcion=(string)$credito_cuenta_cobrar->getId();
			}
	...
	public static function setcredito_cuenta_cobrarDescripcion(?credito_cuenta_cobrar $credito_cuenta_cobrar,string $sValor) {			
		if($credito_cuenta_cobrar !=null) {
	...
	public static function prepararCombosFK(array $credito_cuenta_cobrars) : array {
		$credito_cuenta_cobrarsForeignKey=array();
		
		foreach ($credito_cuenta_cobrars as $credito_cuenta_cobrarLocal) {
			$credito_cuenta_cobrarsForeignKey[$credito_cuenta_cobrarLocal->getId()]=credito_cuenta_cobrar_util::getcredito_cuenta_cobrarDescripcion($credito_cuenta_cobrarLocal);
		}
			
		return $credito_cuenta_cobrarsForeignKey;
	}
	...
	/*DESCRIPCION FKs*/
	public static function refrescarFKDescripciones(array $credito_cuenta_cobrars) {		
		try {
	...
	public static function refrescarFKDescripcion(credito_cuenta_cobrar $credito_cuenta_cobrar) {		
		try {
	...
	public static function getTiposSeleccionar(bool $conFk) : array {
		return credito_cuenta_cobrar_util::getTiposSeleccionar3($conFk,true,true,true,true);
	}
	
	public static function getTiposSeleccionar2() : array {
		return credito_cuenta_cobrar_util::getTiposSeleccionar3(false,true,true,true,true);
	}
	...
	public static function getTiposSeleccionar3(bool $conFk,bool $conStringColumn,bool $conValorColumn,bool $conFechaColumn,bool $conBitColumn) : array {
		...
		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_ID_EMPRESA);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_ID_EMPRESA.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_ID_SUCURSAL);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_ID_SUCURSAL.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_ID_EJERCICIO);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_ID_EJERCICIO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_ID_PERIODO);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_ID_PERIODO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_ID_USUARIO);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_ID_USUARIO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_ID_CUENTA_COBRAR);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_ID_CUENTA_COBRAR.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_NUMERO);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_NUMERO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_ID_FORMA_PAGO_CLIENTE);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_ID_FORMA_PAGO_CLIENTE.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFechaColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_FECHA_EMISION);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_FECHA_EMISION);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFechaColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_FECHA_VENCE);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_FECHA_VENCE);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_ABONO);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_ABONO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_SALDO);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_SALDO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_DESCRIPCION);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_DESCRIPCION);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_ID_ESTADO);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_ID_ESTADO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_REFERENCIA);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_REFERENCIA);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_DEBITO);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_DEBITO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(credito_cuenta_cobrar_util::$LABEL_CREDITO);
			$reporte->setsDescripcion(credito_cuenta_cobrar_util::$LABEL_CREDITO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}
	...
	public static function getArrayColumnasGlobales(array $arrDatoGeneral) : array {
		...
		$arrColumnasGlobales=credito_cuenta_cobrar_util::getArrayColumnasGlobalesConNoColumnas($arrDatoGeneral,array());
	...
	public static function getArrayColumnasGlobalesConNoColumnas(array $arrDatoGeneral,array $arrColumnasGlobalesNo) : array {
		...
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==credito_cuenta_cobrar_util::$ID_EMPRESA) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=credito_cuenta_cobrar_util::$ID_EMPRESA;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==credito_cuenta_cobrar_util::$ID_SUCURSAL) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=credito_cuenta_cobrar_util::$ID_SUCURSAL;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==credito_cuenta_cobrar_util::$ID_EJERCICIO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=credito_cuenta_cobrar_util::$ID_EJERCICIO;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==credito_cuenta_cobrar_util::$ID_PERIODO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=credito_cuenta_cobrar_util::$ID_PERIODO;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==credito_cuenta_cobrar_util::$ID_USUARIO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=credito_cuenta_cobrar_util::$ID_USUARIO;
		}
	...
	public static function getOrderByLista() : array {
		...
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_ID, credito_cuenta_cobrar_util::$ID,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_ID_EMPRESA, credito_cuenta_cobrar_util::$ID_EMPRESA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_ID_SUCURSAL, credito_cuenta_cobrar_util::$ID_SUCURSAL,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_ID_EJERCICIO, credito_cuenta_cobrar_util::$ID_EJERCICIO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_ID_PERIODO, credito_cuenta_cobrar_util::$ID_PERIODO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_ID_USUARIO, credito_cuenta_cobrar_util::$ID_USUARIO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_ID_CUENTA_COBRAR, credito_cuenta_cobrar_util::$ID_CUENTA_COBRAR,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_NUMERO, credito_cuenta_cobrar_util::$NUMERO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_ID_FORMA_PAGO_CLIENTE, credito_cuenta_cobrar_util::$ID_FORMA_PAGO_CLIENTE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_FECHA_EMISION, credito_cuenta_cobrar_util::$FECHA_EMISION,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_FECHA_VENCE, credito_cuenta_cobrar_util::$FECHA_VENCE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_ABONO, credito_cuenta_cobrar_util::$ABONO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_SALDO, credito_cuenta_cobrar_util::$SALDO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_DESCRIPCION, credito_cuenta_cobrar_util::$DESCRIPCION,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_ID_ESTADO, credito_cuenta_cobrar_util::$ID_ESTADO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_REFERENCIA, credito_cuenta_cobrar_util::$REFERENCIA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_DEBITO, credito_cuenta_cobrar_util::$DEBITO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,credito_cuenta_cobrar_util::$LABEL_CREDITO, credito_cuenta_cobrar_util::$CREDITO,false,""); $arrOrderBy[]=$orderBy;
	...
	public static function getDataReportRow(string $tipo='NORMAL',credito_cuenta_cobrar $credito_cuenta_cobrar,array $arrOrderBy,bool $bitParaReporteOrderBy) : array {
		$row=array();
		...
		if(Funciones::existeCadenaArrayOrderBy(' Empresa',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getid_empresa_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Sucursal',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getid_sucursal_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Ejercicio',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getid_ejercicio_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Periodo',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getid_periodo_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Usuario',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getid_usuario_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Cuenta Cobrar',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getid_cuenta_cobrar_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Numero',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getnumero(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Forma Pago Cliente',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getid_forma_pago_cliente_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Fecha Emision',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getfecha_emision(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Fecha Vence',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getfecha_vence(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Abono',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getabono(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Saldo',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getsaldo(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Descripcion',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getdescripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Estado',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($credito_cuenta_cobrar->getid_estado_Descripcion(),40,6,1); $row[]=$cellReport;
		}
	...
	interface credito_cuenta_cobrar_util extends GeneralEntityConstantesFunciones  {
		...
		//DESCRIPCION
		public static function getcredito_cuenta_cobrarDescripcion(?credito_cuenta_cobrar $credito_cuenta_cobrar) : string {;	
		public static function setcredito_cuenta_cobrarDescripcion(?credito_cuenta_cobrar $credito_cuenta_cobrar,string $sValor);
