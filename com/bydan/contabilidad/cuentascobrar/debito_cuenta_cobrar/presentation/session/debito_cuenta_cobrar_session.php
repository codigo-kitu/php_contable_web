...
namespace com\bydan\contabilidad\cuentascobrar\debito_cuenta_cobrar\presentation\session;
...
class debito_cuenta_cobrar_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $debito_cuenta_cobrar_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->debito_cuenta_cobrar_sessionAdditional=new debito_cuenta_cobrar_sessionAdditional();
		*/
