...
class estado_cuentas_cobrar_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/util/estado_cuentas_cobrar_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/util/estado_cuentas_cobrarParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/util/estado_cuentas_cobrar_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/entity/estado_cuentas_cobrar.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/entity/estado_cuentas_cobrarForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/data/estado_cuentas_cobrar_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/data/estado_cuentas_cobrar_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/logic/estado_cuentas_cobrar_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/logic/estado_cuentas_cobrar_logic.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/logic/estado_cuentas_cobrar_logic_add.php');		
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/presentation/session/estado_cuentas_cobrar_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/presentation/view/estado_cuentas_cobrar_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!estado_cuentas_cobrar_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/entity/estado_cuentas_cobrar.php');				
						estado_cuentas_cobrar_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!estado_cuentas_cobrar_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/data/estado_cuentas_cobrar_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/data/estado_cuentas_cobrar_data.php');
						estado_cuentas_cobrar_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!estado_cuentas_cobrar_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!estado_cuentas_cobrar_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/logic/estado_cuentas_cobrar_logic.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/business/logic/estado_cuentas_cobrarLogic_add.php');
						estado_cuentas_cobrar_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!estado_cuentas_cobrar_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/util/estado_cuentas_cobrar_util.php');
						estado_cuentas_cobrar_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!estado_cuentas_cobrar_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascobrar/estado_cuentas_cobrar/presentation/session/estado_cuentas_cobrar_session.php');
						estado_cuentas_cobrar_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface estado_cuentas_cobrar_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
