...
use com\bydan\contabilidad\estimados\imagen_estimado\util\imagen_estimado_carga;//1-M,M-M
use com\bydan\contabilidad\estimados\estimado_detalle\util\estimado_detalle_carga;//1-M,M-M
...
class estimado_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/util/estimado_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/util/estimadoParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/util/estimado_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/business/entity/estimado.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/business/entity/estimadoForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/business/data/estimado_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/business/data/estimado_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/business/logic/estimado_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/business/logic/estimado_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/presentation/session/estimado_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/presentation/view/estimado_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!estimado_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/business/entity/estimado.php');				
						estimado_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!estimado_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/business/data/estimado_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/business/data/estimado_data.php');
						estimado_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!estimado_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!estimado_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/business/logic/estimado_logic.php');
						estimado_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!estimado_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/util/estimado_util.php');
						estimado_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!estimado_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado/presentation/session/estimado_session.php');
						estimado_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesRelaciones(string $paqueteTipo='LOGIC') {
		...
		imagen_estimado_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/estimados/imagen_estimado/presentation/session/imagen_estimado_session.php');
		...
		estimado_detalle_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/estimados/estimado_detalle/presentation/session/estimado_detalle_session.php');
