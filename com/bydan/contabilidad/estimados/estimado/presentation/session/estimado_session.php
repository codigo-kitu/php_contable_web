...
namespace com\bydan\contabilidad\estimados\estimado\presentation\session;
...
class estimado_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $estimado_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->estimado_sessionAdditional=new estimado_sessionAdditional();
		*/
