...
class imagen_estimado_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/util/imagen_estimado_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/util/imagen_estimadoParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/util/imagen_estimado_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/business/entity/imagen_estimado.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/business/entity/imagen_estimadoForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/business/data/imagen_estimado_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/business/data/imagen_estimado_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/business/logic/imagen_estimado_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/business/logic/imagen_estimado_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/presentation/session/imagen_estimado_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/presentation/view/imagen_estimado_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!imagen_estimado_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/business/entity/imagen_estimado.php');				
						imagen_estimado_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!imagen_estimado_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/business/data/imagen_estimado_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/business/data/imagen_estimado_data.php');
						imagen_estimado_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!imagen_estimado_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!imagen_estimado_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/business/logic/imagen_estimado_logic.php');
						imagen_estimado_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!imagen_estimado_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/util/imagen_estimado_util.php');
						imagen_estimado_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!imagen_estimado_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/imagen_estimado/presentation/session/imagen_estimado_session.php');
						imagen_estimado_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface imagen_estimado_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
