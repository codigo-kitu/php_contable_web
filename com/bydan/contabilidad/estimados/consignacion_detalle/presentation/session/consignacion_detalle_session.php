...
namespace com\bydan\contabilidad\estimados\consignacion_detalle\presentation\session;
...
class consignacion_detalle_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $consignacion_detalle_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->consignacion_detalle_sessionAdditional=new consignacion_detalle_sessionAdditional();
		*/
