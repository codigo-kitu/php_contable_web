...
class consignacion_detalle_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/util/consignacion_detalle_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/util/consignacion_detalleParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/util/consignacion_detalle_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/business/entity/consignacion_detalle.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/business/entity/consignacion_detalleForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/business/data/consignacion_detalle_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/business/data/consignacion_detalle_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/business/logic/consignacion_detalle_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/business/logic/consignacion_detalle_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/presentation/session/consignacion_detalle_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/presentation/view/consignacion_detalle_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!consignacion_detalle_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/business/entity/consignacion_detalle.php');				
						consignacion_detalle_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!consignacion_detalle_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/business/data/consignacion_detalle_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/business/data/consignacion_detalle_data.php');
						consignacion_detalle_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!consignacion_detalle_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!consignacion_detalle_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/business/logic/consignacion_detalle_logic.php');
						consignacion_detalle_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!consignacion_detalle_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/util/consignacion_detalle_util.php');
						consignacion_detalle_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!consignacion_detalle_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/consignacion_detalle/presentation/session/consignacion_detalle_session.php');
						consignacion_detalle_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface consignacion_detalle_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
