...
class estimado_detalle_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/util/estimado_detalle_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/util/estimado_detalleParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/util/estimado_detalle_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/business/entity/estimado_detalle.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/business/entity/estimado_detalleForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/business/data/estimado_detalle_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/business/data/estimado_detalle_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/business/logic/estimado_detalle_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/business/logic/estimado_detalle_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/presentation/session/estimado_detalle_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/presentation/view/estimado_detalle_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!estimado_detalle_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/business/entity/estimado_detalle.php');				
						estimado_detalle_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!estimado_detalle_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/business/data/estimado_detalle_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/business/data/estimado_detalle_data.php');
						estimado_detalle_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!estimado_detalle_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!estimado_detalle_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/business/logic/estimado_detalle_logic.php');
						estimado_detalle_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!estimado_detalle_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/util/estimado_detalle_util.php');
						estimado_detalle_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!estimado_detalle_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/estimados/estimado_detalle/presentation/session/estimado_detalle_session.php');
						estimado_detalle_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface estimado_detalle_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
