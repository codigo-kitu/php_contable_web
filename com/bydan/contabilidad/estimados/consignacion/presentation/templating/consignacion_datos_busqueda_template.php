			...
			<?php foreach ($consignacionsLocal as $consignacion) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarconsignacion" idactualconsignacion="<?php echo($consignacion->id) ?>"  funcionjsactualconsignacion="'.str_replace('TO_REPLACE',$consignacion->id.',\''.consignacion_util::getconsignacionDescripcion($consignacion).'\'',$this->strFuncionJs).'" title="SELECCIONAR Consignacion ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Consignacion ACTUAL" value="<?php echo($consignacion->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($consignacion->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $consignacion->updated_at ) ?>
					</td>
				...
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($consignacion->id_empresa_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($consignacion->id_sucursal_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($consignacion->id_ejercicio_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($consignacion->id_periodo_Descripcion) ?></td>
				<?php } ?>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($consignacion->id_usuario_Descripcion) ?></td>
				<?php } ?>
				
					<td class="elementotabla col_numero" > 
						<?php echo( $consignacion->numero ) ?>
					</td>
				<td class="elementotabla col_id_cliente" > <?php echo($consignacion->id_cliente_Descripcion) ?></td>
				
					<td class="elementotabla col_ruc" > 
						<?php echo( $consignacion->ruc ) ?>
					</td>
				
					<td class="elementotabla col_referencia_cliente" > 
						<?php echo( $consignacion->referencia_cliente ) ?>
					</td>
				
					<td class="elementotabla col_fecha_emision" > 
						<?php echo( $consignacion->fecha_emision ) ?>
					</td>
				<td class="elementotabla col_id_vendedor" > <?php echo($consignacion->id_vendedor_Descripcion) ?></td>
				<td class="elementotabla col_id_termino_pago_cliente" > <?php echo($consignacion->id_termino_pago_cliente_Descripcion) ?></td>
				
					<td class="elementotabla col_fecha_vence" > 
						<?php echo( $consignacion->fecha_vence ) ?>
					</td>
				<td class="elementotabla col_id_moneda" > <?php echo($consignacion->id_moneda_Descripcion) ?></td>
				<td class="elementotabla col_id_estado" > <?php echo($consignacion->id_estado_Descripcion) ?></td>
