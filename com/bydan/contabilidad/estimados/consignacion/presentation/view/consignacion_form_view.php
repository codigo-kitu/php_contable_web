...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/estimados/consignacion/js/util/consignacion_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			consignacion_web::$STR_NOMBRE_PAGINA = 'consignacion_form_view.php';
			consignacion_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			consignacion_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trconsignacionElementosFormulario">
	<td>
		<div id="divMantenimientoconsignacionAjaxWebPart" title="CONSIGNACION" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoconsignacion" name="frmMantenimientoconsignacion">

			</br>

			<?php if(consignacion_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblconsignacionToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblconsignacionToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdconsignacionActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarconsignacion" name="imgActualizarToolBarconsignacion" title="ACTUALIZAR Consignacion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdconsignacionEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarconsignacion" name="imgEliminarToolBarconsignacion" title="ELIMINAR Consignacion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdconsignacionCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarconsignacion" name="imgCancelarToolBarconsignacion" title="CANCELAR Consignacion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdconsignacionRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosconsignacion',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblconsignacionToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblconsignacionToolBarFormularioExterior -->

			<table id="tblconsignacionElementos">
			<tr id="trconsignacionElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosconsignacion" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					...
					<?php if(true || consignacion_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="8"><span><img id="imgMostrarOcultarconsignacionprincipal" name="imgMostrarOcultarconsignacionprincipal" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trconsignacionprincipalElementos',this,'../')"/>PRINCIPAL</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trconsignacionprincipalElementos">
						<td id="tdconsignacionprincipalElementos"  colspan="8">
				...
				</table> <!-- tblElementosconsignacion -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosconsignacion" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultosconsignacion -->

			</td></tr> <!-- trconsignacionElementos -->
			</table> <!-- tblconsignacionElementos -->
			</form> <!-- frmMantenimientoconsignacion -->

			<?php
			if(consignacion_web::$STR_ES_RELACIONES=="true") {
				...
				echo('<div id="tabs_general" class="tabs" style="width: 100%">');
					echo('<ul>');
						echo('<li class="titulotab"><a href="#divimagen_consignacions">Imagenes Consignacions</a></li>');
						echo('<li class="titulotab"><a href="#divconsignacion_detalles">Consignacion Detalles</a></li>');
					echo('</ul>');

					echo('<div id="divimagen_consignacions">');
					require_once('com/bydan/contabilidad/estimados/presentation/view/imagen_consignacion_view.php');
					echo('</div>');

					echo('<div id="divconsignacion_detalles">');
					require_once('com/bydan/contabilidad/estimados/presentation/view/consignacion_detalle_view.php');
					echo('</div>');
			...
			?>
			<form id="frmMantenimientoTotalesconsignacion" name="frmMantenimientoTotalesconsignacion">
				<table>
					...
					<?php if(true || consignacion_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="8"><span><img id="imgMostrarOcultarconsignaciontotales" name="imgMostrarOcultarconsignaciontotales" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trconsignaciontotalesElementos',this,'../')"/>TOTALES</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trconsignaciontotalesElementos">
						<td id="tdconsignaciontotalesElementos"  colspan="8">
				...
				<form id="frmAccionesMantenimientoconsignacion" name="frmAccionesMantenimientoconsignacion">

			<?php if(consignacion_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblconsignacionAcciones" class="elementos" style="text-align: center">
		<tr id="trconsignacionAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoconsignacion" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientoconsignacionBasicos">
							<td id="tdbtnNuevoconsignacion" style="visibility:visible">
								<div id="divNuevoconsignacion" style="display:table-row">
									<input type="button" id="btnNuevoconsignacion" name="btnNuevoconsignacion" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarconsignacion" style="visibility:visible">
								<div id="divActualizarconsignacion" style="display:table-row">
									<input type="button" id="btnActualizarconsignacion" name="btnActualizarconsignacion" title="ACTUALIZAR Consignacion ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarconsignacion" style="visibility:visible">
								<div id="divEliminarconsignacion" style="display:table-row">
									<input type="button" id="btnEliminarconsignacion" name="btnEliminarconsignacion" title="ELIMINAR Consignacion ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirconsignacion" style="visibility:visible">
								<input type="button" id="btnImprimirconsignacion" name="btnImprimirconsignacion" title="IMPRIMIR PAGINA Consignacion ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarconsignacion" style="visibility:visible">
								<input type="button" id="btnCancelarconsignacion" name="btnCancelarconsignacion" title="CANCELAR Consignacion ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoconsignacionGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosconsignacion" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosconsignacion" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioconsignacion" name="btnGuardarCambiosFormularioconsignacion" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoconsignacion -->
			</td>
		</tr> <!-- trconsignacionAcciones -->
		<?php if(consignacion_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trconsignacionParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblconsignacionParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trconsignacionFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblconsignacionParametrosAcciones -->
			</td>
		</tr> <!-- trconsignacionParametrosAcciones -->
		<?php }?>
		<tr id="trconsignacionMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trconsignacionMensajes -->
			</table> <!-- tblconsignacionAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoconsignacion -->
			</div> <!-- divMantenimientoconsignacionAjaxWebPart -->
		</td>
	</tr> <!-- trconsignacionElementosFormulario/super -->
		<?php if(consignacion_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {consignacion_webcontrol,consignacion_webcontrol1} from './webroot/js/JavaScript/contabilidad/estimados/consignacion/js/webcontrol/consignacion_form_webcontrol.js?random=1';
