...
namespace com\bydan\contabilidad\facturacion\factura\presentation\session;
...
class factura_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $factura_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->factura_sessionAdditional=new factura_sessionAdditional();
		*/
