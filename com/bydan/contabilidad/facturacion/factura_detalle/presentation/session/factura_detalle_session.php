...
namespace com\bydan\contabilidad\facturacion\factura_detalle\presentation\session;
...
class factura_detalle_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $factura_detalle_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->factura_detalle_sessionAdditional=new factura_detalle_sessionAdditional();
		*/
