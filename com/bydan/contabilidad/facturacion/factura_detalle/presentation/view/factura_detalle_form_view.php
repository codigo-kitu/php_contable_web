...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/facturacion/factura_detalle/js/util/factura_detalle_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			factura_detalle_web::$STR_NOMBRE_PAGINA = 'factura_detalle_form_view.php';
			factura_detalle_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			factura_detalle_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trfactura_detalleElementosFormulario">
	<td>
		<div id="divMantenimientofactura_detalleAjaxWebPart" title="FACTURA DETALLE" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientofactura_detalle" name="frmMantenimientofactura_detalle">

			</br>

			<?php if(factura_detalle_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblfactura_detalleToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblfactura_detalleToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdfactura_detalleActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarfactura_detalle" name="imgActualizarToolBarfactura_detalle" title="ACTUALIZAR Factura Detalle ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdfactura_detalleEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarfactura_detalle" name="imgEliminarToolBarfactura_detalle" title="ELIMINAR Factura Detalle ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdfactura_detalleCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarfactura_detalle" name="imgCancelarToolBarfactura_detalle" title="CANCELAR Factura Detalle ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdfactura_detalleRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosfactura_detalle',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblfactura_detalleToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblfactura_detalleToolBarFormularioExterior -->

			<table id="tblfactura_detalleElementos">
			<tr id="trfactura_detalleElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosfactura_detalle" class="elementos" style="width: 350px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					...
					<?php if(true || factura_detalle_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="4"><span><img id="imgMostrarOcultarfactura_detallegeneral" name="imgMostrarOcultarfactura_detallegeneral" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trfactura_detallegeneralElementos',this,'../')"/>GENERAL</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trfactura_detallegeneralElementos">
						<td id="tdfactura_detallegeneralElementos"  colspan="4">
				<table class="elementos" style="width:350px;text-align:left; padding: 0px; border-spacing: 0px; border-collapse: collapse;">
					...
					<?php if(true || factura_detalle_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="4"><span><img id="imgMostrarOcultarfactura_detallevalores" name="imgMostrarOcultarfactura_detallevalores" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trfactura_detallevaloresElementos',this,'../')"/>VALORES</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trfactura_detallevaloresElementos">
						<td id="tdfactura_detallevaloresElementos"  colspan="4">
				<table class="elementos" style="width:350px;text-align:left; padding: 0px; border-spacing: 0px; border-collapse: collapse;">
				...
				</table> <!-- tblElementosfactura_detalle -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosfactura_detalle" class="elementos" style="display: table-row;">
					...
					<td></td><td></td></tr>
				</table> <!-- tblCamposOcultosfactura_detalle -->

			</td></tr> <!-- trfactura_detalleElementos -->
			</table> <!-- tblfactura_detalleElementos -->
			</form> <!-- frmMantenimientofactura_detalle -->


			

				<form id="frmAccionesMantenimientofactura_detalle" name="frmAccionesMantenimientofactura_detalle">

			<?php if(factura_detalle_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblfactura_detalleAcciones" class="elementos" style="text-align: center">
		<tr id="trfactura_detalleAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientofactura_detalle" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientofactura_detalleBasicos">
							<td id="tdbtnNuevofactura_detalle" style="visibility:visible">
								<div id="divNuevofactura_detalle" style="display:table-row">
									<input type="button" id="btnNuevofactura_detalle" name="btnNuevofactura_detalle" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarfactura_detalle" style="visibility:visible">
								<div id="divActualizarfactura_detalle" style="display:table-row">
									<input type="button" id="btnActualizarfactura_detalle" name="btnActualizarfactura_detalle" title="ACTUALIZAR Factura Detalle ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarfactura_detalle" style="visibility:visible">
								<div id="divEliminarfactura_detalle" style="display:table-row">
									<input type="button" id="btnEliminarfactura_detalle" name="btnEliminarfactura_detalle" title="ELIMINAR Factura Detalle ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirfactura_detalle" style="visibility:visible">
								<input type="button" id="btnImprimirfactura_detalle" name="btnImprimirfactura_detalle" title="IMPRIMIR PAGINA Factura Detalle ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarfactura_detalle" style="visibility:visible">
								<input type="button" id="btnCancelarfactura_detalle" name="btnCancelarfactura_detalle" title="CANCELAR Factura Detalle ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientofactura_detalleGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosfactura_detalle" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosfactura_detalle" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariofactura_detalle" name="btnGuardarCambiosFormulariofactura_detalle" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientofactura_detalle -->
			</td>
		</tr> <!-- trfactura_detalleAcciones -->
		<?php if(factura_detalle_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trfactura_detalleParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblfactura_detalleParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trfactura_detalleFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblfactura_detalleParametrosAcciones -->
			</td>
		</tr> <!-- trfactura_detalleParametrosAcciones -->
		<?php }?>
		<tr id="trfactura_detalleMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trfactura_detalleMensajes -->
			</table> <!-- tblfactura_detalleAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientofactura_detalle -->
			</div> <!-- divMantenimientofactura_detalleAjaxWebPart -->
		</td>
	</tr> <!-- trfactura_detalleElementosFormulario/super -->
		<?php if(factura_detalle_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {factura_detalle_webcontrol,factura_detalle_webcontrol1} from './webroot/js/JavaScript/contabilidad/facturacion/factura_detalle/js/webcontrol/factura_detalle_form_webcontrol.js?random=1';
