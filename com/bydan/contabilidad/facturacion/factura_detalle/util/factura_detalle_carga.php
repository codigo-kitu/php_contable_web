...
class factura_detalle_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/util/factura_detalle_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/util/factura_detalleParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/util/factura_detalle_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/business/entity/factura_detalle.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/business/entity/factura_detalleForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/business/data/factura_detalle_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/business/data/factura_detalle_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/business/logic/factura_detalle_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/business/logic/factura_detalle_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/presentation/session/factura_detalle_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/presentation/view/factura_detalle_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!factura_detalle_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/business/entity/factura_detalle.php');				
						factura_detalle_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!factura_detalle_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/business/data/factura_detalle_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/business/data/factura_detalle_data.php');
						factura_detalle_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!factura_detalle_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!factura_detalle_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/business/logic/factura_detalle_logic.php');
						factura_detalle_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!factura_detalle_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/util/factura_detalle_util.php');
						factura_detalle_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!factura_detalle_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_detalle/presentation/session/factura_detalle_session.php');
						factura_detalle_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface factura_detalle_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
