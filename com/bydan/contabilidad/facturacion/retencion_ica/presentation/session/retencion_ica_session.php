...
namespace com\bydan\contabilidad\facturacion\retencion_ica\presentation\session;
...
class retencion_ica_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $retencion_ica_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->retencion_ica_sessionAdditional=new retencion_ica_sessionAdditional();
		*/
