...
namespace com\bydan\contabilidad\facturacion\vendedor\presentation\session;
...
class vendedor_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $vendedor_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->vendedor_sessionAdditional=new vendedor_sessionAdditional();
		*/
