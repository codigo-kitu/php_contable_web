...
namespace com\bydan\contabilidad\facturacion\otro_impuesto\presentation\session;
...
class otro_impuesto_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $otro_impuesto_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->otro_impuesto_sessionAdditional=new otro_impuesto_sessionAdditional();
		*/
