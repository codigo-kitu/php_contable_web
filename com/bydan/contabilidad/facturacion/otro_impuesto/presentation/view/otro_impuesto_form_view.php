...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/facturacion/otro_impuesto/js/util/otro_impuesto_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			otro_impuesto_web::$STR_NOMBRE_PAGINA = 'otro_impuesto_form_view.php';
			otro_impuesto_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			otro_impuesto_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trotro_impuestoElementosFormulario">
	<td>
		<div id="divMantenimientootro_impuestoAjaxWebPart" title="OTRO IMPUESTO" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientootro_impuesto" name="frmMantenimientootro_impuesto">

			</br>

			<?php if(otro_impuesto_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblotro_impuestoToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblotro_impuestoToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdotro_impuestoActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarotro_impuesto" name="imgActualizarToolBarotro_impuesto" title="ACTUALIZAR Otro Impuesto ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdotro_impuestoEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarotro_impuesto" name="imgEliminarToolBarotro_impuesto" title="ELIMINAR Otro Impuesto ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdotro_impuestoCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarotro_impuesto" name="imgCancelarToolBarotro_impuesto" title="CANCELAR Otro Impuesto ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdotro_impuestoRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosotro_impuesto',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblotro_impuestoToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblotro_impuestoToolBarFormularioExterior -->

			<table id="tblotro_impuestoElementos">
			<tr id="trotro_impuestoElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosotro_impuesto" class="elementos" style="width: 350px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					<tr id="tr_fila_1">
				...
				</table> <!-- tblElementosotro_impuesto -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosotro_impuesto" class="elementos" style="display: table-row;">
					...
					<tr id="tr_fila_2">
						<td id="td_title-cuenta_contable_compras" class="titulocampo">
							<label class="form-label">Cuenta Contable Compras</label>
						</td>
						<td id="td_control-cuenta_contable_compras" align="left" class="controlcampo">
							<input id="form-cuenta_contable_compras" name="form-cuenta_contable_compras" type="text" class="form-control"  placeholder="Cuenta Contable Compras"  title="Cuenta Contable Compras"    size="20"  maxlength="20"/>
							<span id="spanstrMensajecuenta_contable_compras" class="mensajeerror"></span>
						</td>
					</tr>
				</table> <!-- tblCamposOcultosotro_impuesto -->

			</td></tr> <!-- trotro_impuestoElementos -->
			</table> <!-- tblotro_impuestoElementos -->
			</form> <!-- frmMantenimientootro_impuesto -->


			

				<form id="frmAccionesMantenimientootro_impuesto" name="frmAccionesMantenimientootro_impuesto">

			<?php if(otro_impuesto_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblotro_impuestoAcciones" class="elementos" style="text-align: center">
		<tr id="trotro_impuestoAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientootro_impuesto" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientootro_impuestoBasicos">
							<td id="tdbtnNuevootro_impuesto" style="visibility:visible">
								<div id="divNuevootro_impuesto" style="display:table-row">
									<input type="button" id="btnNuevootro_impuesto" name="btnNuevootro_impuesto" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarotro_impuesto" style="visibility:visible">
								<div id="divActualizarotro_impuesto" style="display:table-row">
									<input type="button" id="btnActualizarotro_impuesto" name="btnActualizarotro_impuesto" title="ACTUALIZAR Otro Impuesto ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarotro_impuesto" style="visibility:visible">
								<div id="divEliminarotro_impuesto" style="display:table-row">
									<input type="button" id="btnEliminarotro_impuesto" name="btnEliminarotro_impuesto" title="ELIMINAR Otro Impuesto ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirotro_impuesto" style="visibility:visible">
								<input type="button" id="btnImprimirotro_impuesto" name="btnImprimirotro_impuesto" title="IMPRIMIR PAGINA Otro Impuesto ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarotro_impuesto" style="visibility:visible">
								<input type="button" id="btnCancelarotro_impuesto" name="btnCancelarotro_impuesto" title="CANCELAR Otro Impuesto ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientootro_impuestoGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosotro_impuesto" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosotro_impuesto" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariootro_impuesto" name="btnGuardarCambiosFormulariootro_impuesto" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientootro_impuesto -->
			</td>
		</tr> <!-- trotro_impuestoAcciones -->
		<?php if(otro_impuesto_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trotro_impuestoParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblotro_impuestoParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trotro_impuestoFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblotro_impuestoParametrosAcciones -->
			</td>
		</tr> <!-- trotro_impuestoParametrosAcciones -->
		<?php }?>
		<tr id="trotro_impuestoMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trotro_impuestoMensajes -->
			</table> <!-- tblotro_impuestoAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientootro_impuesto -->
			</div> <!-- divMantenimientootro_impuestoAjaxWebPart -->
		</td>
	</tr> <!-- trotro_impuestoElementosFormulario/super -->
		<?php if(otro_impuesto_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {otro_impuesto_webcontrol,otro_impuesto_webcontrol1} from './webroot/js/JavaScript/contabilidad/facturacion/otro_impuesto/js/webcontrol/otro_impuesto_form_webcontrol.js?random=1';
