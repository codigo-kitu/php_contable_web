...
namespace com\bydan\contabilidad\facturacion\factura_lote\presentation\session;
...
class factura_lote_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $factura_lote_sessionAdditional=null;
	...
	public ?bool $bitBusquedaDesdeFKSesiontermino_pago=null;
	public ?int $bigidtermino_pagoActual=null;
	public ?string $bigidtermino_pagoActualDescripcion=null;
	...
	function __construct () {	
		...
		$this->factura_lote_sessionAdditional=new factura_lote_sessionAdditional();
		*/
		...
		$this->bitBusquedaDesdeFKSesiontermino_pago=false;
		$this->bigidtermino_pagoActual=0;
		$this->bigidtermino_pagoActualDescripcion='';
