...
class factura_modelo_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/util/factura_modelo_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/util/factura_modeloParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/util/factura_modelo_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/business/entity/factura_modelo.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/business/entity/factura_modeloForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/business/data/factura_modelo_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/business/data/factura_modelo_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/business/logic/factura_modelo_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/business/logic/factura_modelo_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/presentation/session/factura_modelo_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/presentation/view/factura_modelo_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!factura_modelo_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/business/entity/factura_modelo.php');				
						factura_modelo_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!factura_modelo_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/business/data/factura_modelo_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/business/data/factura_modelo_data.php');
						factura_modelo_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!factura_modelo_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!factura_modelo_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/business/logic/factura_modelo_logic.php');
						factura_modelo_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!factura_modelo_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/util/factura_modelo_util.php');
						factura_modelo_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!factura_modelo_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/factura_modelo/presentation/session/factura_modelo_session.php');
						factura_modelo_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface factura_modelo_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
