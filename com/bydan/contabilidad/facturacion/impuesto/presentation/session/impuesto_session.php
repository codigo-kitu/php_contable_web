...
namespace com\bydan\contabilidad\facturacion\impuesto\presentation\session;
...
class impuesto_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $impuesto_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->impuesto_sessionAdditional=new impuesto_sessionAdditional();
		*/
