...
class retencion_util extends GeneralEntityConstantesFunciones  {
	/*CONTROL_INICIO*/
			
	/*GENERAL*/
	public static string $STR_CLASS_NAME='retencion';
	public static string $STR_FINAL_QUERY='';	
	public static string $STR_NOMBRE_OPCION='facturacion.retencions';
	/*'Mantenimientoretencion.jsf';*/
	public static string $STR_MODULO_OPCION='facturacion';
	public static string $STR_NOMBRE_CLASE='Mantenimientoretencion.jsf';	
	public static string $STR_PATH_OPCION='';	
	public static string $STR_PERSISTENCE_CONTEXT_NAME='';
	public static string $STR_PERSISTENCE_NAME='retencionPersistenceName';
	/*.retencion_util::$SPERSISTENCECONTEXTNAME.Constantes::$SPERSISTENCECONTEXTNAME;*/
	public static string $STR_SESSION_NAME='retencion_session';
	/*.Constantes$::SSESSIONBEAN;*/
	public static string $STR_SESSION_CONTROLLER_NAME='retencion_control_session';
	/*.Constantes$::SSESSIONBEAN;*/
	public static string $STR_CONTROLLER_NAME='retencion_control';
	public static string $STR_CLASS_NAME_TITULO_REPORTES='Retenciones';
	public static string $STR_RELATIVE_PATH='../';
	public static string $STR_CLASS_PLURAL='es';
	public static string $STR_CLASS_WEB_TITULO='Retencion';
	...
	/*AUXILIAR*/
	//public $retencionConstantesFuncionesAdditional;
	...
	function __construct (){
		...
		$this->retencionConstantesFuncionesAdditional=new $retencionConstantesFuncionesAdditional();*/
	}
	
	/*LISTA INDICE*/
	public static function getIndiceNuevo(array $retencions,int $iIdNuevoretencion) : int {
		$iIndice=0;
		$existe=false;
		
		foreach($retencions as $retencionAux) {
			if($retencionAux->getId()==$iIdNuevoretencion) {
				$existe=true;
				break;
			}
	...
	public static function getIndiceActual(array $retencions,retencion $retencion,int $iIndiceActual) : int {
		$iIndice=0;
		$existe=false;
		
		foreach($retencions as $retencionAux) {
			if($retencionAux->getId()==$retencion->getId()) {
				$existe=true;
				break;
			}
	...
	/*DESCRIPCION*/
	public static function getretencionDescripcion(?retencion $retencion) : string {//retencion NO USAR CLASE, PARA NULOS SE DANA
		$sDescripcion=Constantes::$STR_NONE;
			
		if($retencion !=null) {
			/*&& retencion->getId()!=0*/
			
			$sDescripcion=($retencion->getcodigo());
	...
	public static function setretencionDescripcion(?retencion $retencion,string $sValor) {			
		if($retencion !=null) {
			$retencion->setcodigo($sValor);;
			/*retencion;*/
		}		
	}
	
	/*PREPARAR FOREIGNKEYS*/
	public static function prepararCombosFK(array $retencions) : array {
		$retencionsForeignKey=array();
		
		foreach ($retencions as $retencionLocal) {
			$retencionsForeignKey[$retencionLocal->getId()]=retencion_util::getretencionDescripcion($retencionLocal);
		}
			
		return $retencionsForeignKey;
	}
	...
	public static function getpredeterminadoDescripcion($retencion) {
		$sDescripcion='Verdadero';
		if(!$retencion->getpredeterminado()) { $sDescripcion='Falso'; }
		return $sDescripcion;
	}	
	
	/*DESCRIPCION FKs*/
	public static function refrescarFKDescripciones(array $retencions) {		
		try {
	...
	public static function refrescarFKDescripcion(retencion $retencion) {		
		try {
	...
	public static function getTiposSeleccionar(bool $conFk) : array {
		return retencion_util::getTiposSeleccionar3($conFk,true,true,true,true);
	}
	
	public static function getTiposSeleccionar2() : array {
		return retencion_util::getTiposSeleccionar3(false,true,true,true,true);
	}
	...
	public static function getTiposSeleccionar3(bool $conFk,bool $conStringColumn,bool $conValorColumn,bool $conFechaColumn,bool $conBitColumn) : array {
		...
		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(retencion_util::$LABEL_ID_EMPRESA);
			$reporte->setsDescripcion(retencion_util::$LABEL_ID_EMPRESA.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(retencion_util::$LABEL_CODIGO);
			$reporte->setsDescripcion(retencion_util::$LABEL_CODIGO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(retencion_util::$LABEL_DESCRIPCION);
			$reporte->setsDescripcion(retencion_util::$LABEL_DESCRIPCION);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(retencion_util::$LABEL_VALOR);
			$reporte->setsDescripcion(retencion_util::$LABEL_VALOR);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(retencion_util::$LABEL_VALOR_BASE);
			$reporte->setsDescripcion(retencion_util::$LABEL_VALOR_BASE);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conBitColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(retencion_util::$LABEL_PREDETERMINADO);
			$reporte->setsDescripcion(retencion_util::$LABEL_PREDETERMINADO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(retencion_util::$LABEL_ID_CUENTA_VENTAS);
			$reporte->setsDescripcion(retencion_util::$LABEL_ID_CUENTA_VENTAS.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(retencion_util::$LABEL_ID_CUENTA_COMPRAS);
			$reporte->setsDescripcion(retencion_util::$LABEL_ID_CUENTA_COMPRAS.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(retencion_util::$LABEL_CUENTA_CONTABLE_VENTAS);
			$reporte->setsDescripcion(retencion_util::$LABEL_CUENTA_CONTABLE_VENTAS);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(retencion_util::$LABEL_CUENTA_CONTABLE_COMPRAS);
			$reporte->setsDescripcion(retencion_util::$LABEL_CUENTA_CONTABLE_COMPRAS);
			$arrTiposSeleccionarTodos[]=$reporte;
		}
	...
	public static function getArrayColumnasGlobales(array $arrDatoGeneral) : array {
		...
		$arrColumnasGlobales=retencion_util::getArrayColumnasGlobalesConNoColumnas($arrDatoGeneral,array());
	...
	public static function getArrayColumnasGlobalesConNoColumnas(array $arrDatoGeneral,array $arrColumnasGlobalesNo) : array {
		...
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==retencion_util::$ID_EMPRESA) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=retencion_util::$ID_EMPRESA;
		}
	...
	public static function getOrderByLista() : array {
		...
		$orderBy=OrderBy::NewOrderBy(false,retencion_util::$LABEL_ID, retencion_util::$ID,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,retencion_util::$LABEL_ID_EMPRESA, retencion_util::$ID_EMPRESA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,retencion_util::$LABEL_CODIGO, retencion_util::$CODIGO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,retencion_util::$LABEL_DESCRIPCION, retencion_util::$DESCRIPCION,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,retencion_util::$LABEL_VALOR, retencion_util::$VALOR,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,retencion_util::$LABEL_VALOR_BASE, retencion_util::$VALOR_BASE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,retencion_util::$LABEL_PREDETERMINADO, retencion_util::$PREDETERMINADO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,retencion_util::$LABEL_ID_CUENTA_VENTAS, retencion_util::$ID_CUENTA_VENTAS,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,retencion_util::$LABEL_ID_CUENTA_COMPRAS, retencion_util::$ID_CUENTA_COMPRAS,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,retencion_util::$LABEL_CUENTA_CONTABLE_VENTAS, retencion_util::$CUENTA_CONTABLE_VENTAS,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,retencion_util::$LABEL_CUENTA_CONTABLE_COMPRAS, retencion_util::$CUENTA_CONTABLE_COMPRAS,false,""); $arrOrderBy[]=$orderBy;
	...
	public static function getDataReportRow(string $tipo='NORMAL',retencion $retencion,array $arrOrderBy,bool $bitParaReporteOrderBy) : array {
		$row=array();
		...
		if(Funciones::existeCadenaArrayOrderBy('Empresa',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($retencion->getid_empresa_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Codigo',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($retencion->getcodigo(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Descripcion',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($retencion->getdescripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Valor',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($retencion->getvalor(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Valor Base',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($retencion->getvalor_base(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Predeterminado',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine(Funciones::getBitDescription($retencion->getpredeterminado()),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Cuentas Ventas',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($retencion->getid_cuenta_ventas_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Cuentas Compras',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($retencion->getid_cuenta_compras_Descripcion(),40,6,1); $row[]=$cellReport;
		}
	...
	interface retencion_util extends GeneralEntityConstantesFunciones  {
