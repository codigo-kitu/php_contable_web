...
namespace com\bydan\contabilidad\facturacion\retencion_fuente\presentation\session;
...
class retencion_fuente_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $retencion_fuente_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->retencion_fuente_sessionAdditional=new retencion_fuente_sessionAdditional();
		*/
