...
namespace com\bydan\contabilidad\facturacion\devolucion_factura_detalle\presentation\session;
...
class devolucion_factura_detalle_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $devolucion_factura_detalle_sessionAdditional=null;
	
	/*BUSQUEDA*/
	
	public ?bool $bitBusquedaDesdeFKSesiondevolucion_factura=null;
	public ?int $bigiddevolucion_facturaActual=null;
	public ?string $bigiddevolucion_facturaActualDescripcion=null;
	...
	function __construct () {	
		...
		$this->devolucion_factura_detalle_sessionAdditional=new devolucion_factura_detalle_sessionAdditional();
		*/
		...
		$this->bitBusquedaDesdeFKSesiondevolucion_factura=false;
		$this->bigiddevolucion_facturaActual=0;
		$this->bigiddevolucion_facturaActualDescripcion='';
