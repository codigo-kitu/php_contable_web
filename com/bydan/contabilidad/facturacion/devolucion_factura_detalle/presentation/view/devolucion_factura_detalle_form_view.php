...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/facturacion/devolucion_factura_detalle/js/util/devolucion_factura_detalle_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			devolucion_factura_detalle_web::$STR_NOMBRE_PAGINA = 'devolucion_factura_detalle_form_view.php';
			devolucion_factura_detalle_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			devolucion_factura_detalle_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trdevolucion_factura_detalleElementosFormulario">
	<td>
		<div id="divMantenimientodevolucion_factura_detalleAjaxWebPart" title="DEVOLUCION FACTURA DETALLE" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientodevolucion_factura_detalle" name="frmMantenimientodevolucion_factura_detalle">

			</br>

			<?php if(devolucion_factura_detalle_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tbldevolucion_factura_detalleToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tbldevolucion_factura_detalleToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tddevolucion_factura_detalleActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBardevolucion_factura_detalle" name="imgActualizarToolBardevolucion_factura_detalle" title="ACTUALIZAR Devolucion Factura Detalle ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tddevolucion_factura_detalleEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBardevolucion_factura_detalle" name="imgEliminarToolBardevolucion_factura_detalle" title="ELIMINAR Devolucion Factura Detalle ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tddevolucion_factura_detalleCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBardevolucion_factura_detalle" name="imgCancelarToolBardevolucion_factura_detalle" title="CANCELAR Devolucion Factura Detalle ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tddevolucion_factura_detalleRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosdevolucion_factura_detalle',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tbldevolucion_factura_detalleToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tbldevolucion_factura_detalleToolBarFormularioExterior -->

			<table id="tbldevolucion_factura_detalleElementos">
			<tr id="trdevolucion_factura_detalleElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosdevolucion_factura_detalle" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					...
					<?php if(true || devolucion_factura_detalle_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="4"><span><img id="imgMostrarOcultardevolucion_factura_detallegeneral" name="imgMostrarOcultardevolucion_factura_detallegeneral" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trdevolucion_factura_detallegeneralElementos',this,'../')"/>GENERAL</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trdevolucion_factura_detallegeneralElementos">
						<td id="tddevolucion_factura_detallegeneralElementos"  colspan="4">
				<table class="elementos" style="width:400px;text-align:left; padding: 0px; border-spacing: 0px; border-collapse: collapse;">
					...
					<tr id="tr_fila_2">
						<td id="td_title-id_devolucion_factura" class="titulocampo">
							<label class="form-label">Devolucion Factura</label>
						</td>
						<td id="td_control-id_devolucion_factura" align="left" class="controlcombo">
							
							<table align="left" cellspacing="0" cellpadding="0" border="0">
								<tr>
									<td><select id="form-id_devolucion_factura" name="form-id_devolucion_factura" title="Devolucion Factura" ></select></td>
									<td><a><img id="form-id_devolucion_factura_img" name="form-id_devolucion_factura_img" class="imagen_actualizar" title="ACTUALIZAR DATOS RELACIONADOS" src="/contabilidad0/webroot/img/Imagenes/actualizardatos.gif" alt="Actualizar Datos" border="" height="15" width="15"></a></td>
									<td><img id="form-id_devolucion_factura_img_busqueda" name="form-id_devolucion_factura_img_busqueda" title="Buscar Devolucion Factura" style="width: 15px; height: 15px;text-align: center; visibility:hidden;" src="/contabilidad0/webroot/img/Imagenes/buscar.gif" width="15" height="15"/></td>
								</tr>
							</table>
							<span id="spanstrMensajeid_devolucion_factura" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_3">
					...
					<?php if(true || devolucion_factura_detalle_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="4"><span><img id="imgMostrarOcultardevolucion_factura_detallevalores" name="imgMostrarOcultardevolucion_factura_detallevalores" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trdevolucion_factura_detallevaloresElementos',this,'../')"/>VALORES</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trdevolucion_factura_detallevaloresElementos">
						<td id="tddevolucion_factura_detallevaloresElementos"  colspan="4">
				<table class="elementos" style="width:400px;text-align:left; padding: 0px; border-spacing: 0px; border-collapse: collapse;">
				...
				</table> <!-- tblElementosdevolucion_factura_detalle -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosdevolucion_factura_detalle" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultosdevolucion_factura_detalle -->

			</td></tr> <!-- trdevolucion_factura_detalleElementos -->
			</table> <!-- tbldevolucion_factura_detalleElementos -->
			</form> <!-- frmMantenimientodevolucion_factura_detalle -->


			

				<form id="frmAccionesMantenimientodevolucion_factura_detalle" name="frmAccionesMantenimientodevolucion_factura_detalle">

			<?php if(devolucion_factura_detalle_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tbldevolucion_factura_detalleAcciones" class="elementos" style="text-align: center">
		<tr id="trdevolucion_factura_detalleAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientodevolucion_factura_detalle" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientodevolucion_factura_detalleBasicos">
							<td id="tdbtnNuevodevolucion_factura_detalle" style="visibility:visible">
								<div id="divNuevodevolucion_factura_detalle" style="display:table-row">
									<input type="button" id="btnNuevodevolucion_factura_detalle" name="btnNuevodevolucion_factura_detalle" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizardevolucion_factura_detalle" style="visibility:visible">
								<div id="divActualizardevolucion_factura_detalle" style="display:table-row">
									<input type="button" id="btnActualizardevolucion_factura_detalle" name="btnActualizardevolucion_factura_detalle" title="ACTUALIZAR Devolucion Factura Detalle ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminardevolucion_factura_detalle" style="visibility:visible">
								<div id="divEliminardevolucion_factura_detalle" style="display:table-row">
									<input type="button" id="btnEliminardevolucion_factura_detalle" name="btnEliminardevolucion_factura_detalle" title="ELIMINAR Devolucion Factura Detalle ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirdevolucion_factura_detalle" style="visibility:visible">
								<input type="button" id="btnImprimirdevolucion_factura_detalle" name="btnImprimirdevolucion_factura_detalle" title="IMPRIMIR PAGINA Devolucion Factura Detalle ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelardevolucion_factura_detalle" style="visibility:visible">
								<input type="button" id="btnCancelardevolucion_factura_detalle" name="btnCancelardevolucion_factura_detalle" title="CANCELAR Devolucion Factura Detalle ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientodevolucion_factura_detalleGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosdevolucion_factura_detalle" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosdevolucion_factura_detalle" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariodevolucion_factura_detalle" name="btnGuardarCambiosFormulariodevolucion_factura_detalle" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientodevolucion_factura_detalle -->
			</td>
		</tr> <!-- trdevolucion_factura_detalleAcciones -->
		<?php if(devolucion_factura_detalle_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trdevolucion_factura_detalleParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tbldevolucion_factura_detalleParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trdevolucion_factura_detalleFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tbldevolucion_factura_detalleParametrosAcciones -->
			</td>
		</tr> <!-- trdevolucion_factura_detalleParametrosAcciones -->
		<?php }?>
		<tr id="trdevolucion_factura_detalleMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trdevolucion_factura_detalleMensajes -->
			</table> <!-- tbldevolucion_factura_detalleAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientodevolucion_factura_detalle -->
			</div> <!-- divMantenimientodevolucion_factura_detalleAjaxWebPart -->
		</td>
	</tr> <!-- trdevolucion_factura_detalleElementosFormulario/super -->
		<?php if(devolucion_factura_detalle_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {devolucion_factura_detalle_webcontrol,devolucion_factura_detalle_webcontrol1} from './webroot/js/JavaScript/contabilidad/facturacion/devolucion_factura_detalle/js/webcontrol/devolucion_factura_detalle_form_webcontrol.js?random=1';
