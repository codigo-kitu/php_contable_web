...
class parametro_facturacion_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/util/parametro_facturacion_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/util/parametro_facturacionParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/util/parametro_facturacion_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/business/entity/parametro_facturacion.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/business/entity/parametro_facturacionForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/business/data/parametro_facturacion_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/business/data/parametro_facturacion_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/business/logic/parametro_facturacion_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/business/logic/parametro_facturacion_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/presentation/session/parametro_facturacion_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/presentation/view/parametro_facturacion_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!parametro_facturacion_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/business/entity/parametro_facturacion.php');				
						parametro_facturacion_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!parametro_facturacion_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/business/data/parametro_facturacion_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/business/data/parametro_facturacion_data.php');
						parametro_facturacion_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!parametro_facturacion_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!parametro_facturacion_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/business/logic/parametro_facturacion_logic.php');
						parametro_facturacion_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!parametro_facturacion_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/util/parametro_facturacion_util.php');
						parametro_facturacion_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!parametro_facturacion_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/parametro_facturacion/presentation/session/parametro_facturacion_session.php');
						parametro_facturacion_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface parametro_facturacion_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
