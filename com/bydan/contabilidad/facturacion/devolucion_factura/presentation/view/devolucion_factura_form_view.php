...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/facturacion/devolucion_factura/js/util/devolucion_factura_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			devolucion_factura_web::$STR_NOMBRE_PAGINA = 'devolucion_factura_form_view.php';
			devolucion_factura_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			devolucion_factura_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trdevolucion_facturaElementosFormulario">
	<td>
		<div id="divMantenimientodevolucion_facturaAjaxWebPart" title="DEVOLUCION FACTURA" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientodevolucion_factura" name="frmMantenimientodevolucion_factura">

			</br>

			<?php if(devolucion_factura_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tbldevolucion_facturaToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tbldevolucion_facturaToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tddevolucion_facturaActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBardevolucion_factura" name="imgActualizarToolBardevolucion_factura" title="ACTUALIZAR Devolucion Factura ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tddevolucion_facturaEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBardevolucion_factura" name="imgEliminarToolBardevolucion_factura" title="ELIMINAR Devolucion Factura ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tddevolucion_facturaCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBardevolucion_factura" name="imgCancelarToolBardevolucion_factura" title="CANCELAR Devolucion Factura ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tddevolucion_facturaRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosdevolucion_factura',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tbldevolucion_facturaToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tbldevolucion_facturaToolBarFormularioExterior -->

			<table id="tbldevolucion_facturaElementos">
			<tr id="trdevolucion_facturaElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosdevolucion_factura" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					...
					<?php if(true || devolucion_factura_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="8"><span><img id="imgMostrarOcultardevolucion_facturaprincipal" name="imgMostrarOcultardevolucion_facturaprincipal" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trdevolucion_facturaprincipalElementos',this,'../')"/>PRINCIPAL</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trdevolucion_facturaprincipalElementos">
						<td id="tddevolucion_facturaprincipalElementos"  colspan="8">
				...
				</table> <!-- tblElementosdevolucion_factura -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosdevolucion_factura" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultosdevolucion_factura -->

			</td></tr> <!-- trdevolucion_facturaElementos -->
			</table> <!-- tbldevolucion_facturaElementos -->
			</form> <!-- frmMantenimientodevolucion_factura -->

			<?php
			if(devolucion_factura_web::$STR_ES_RELACIONES=="true") {
				...
				echo('<div id="tabs_general" class="tabs" style="width: 100%">');
					echo('<ul>');
						echo('<li class="titulotab"><a href="#divdevolucion_factura_detalles">Devolucion Factura Detalles</a></li>');
					echo('</ul>');

					echo('<div id="divdevolucion_factura_detalles">');
					require_once('com/bydan/contabilidad/facturacion/presentation/view/devolucion_factura_detalle_view.php');
					echo('</div>');
			...
			?>
			<form id="frmMantenimientoTotalesdevolucion_factura" name="frmMantenimientoTotalesdevolucion_factura">
				<table>
					...
					<?php if(true || devolucion_factura_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="8"><span><img id="imgMostrarOcultardevolucion_facturatotales" name="imgMostrarOcultardevolucion_facturatotales" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trdevolucion_facturatotalesElementos',this,'../')"/>TOTALES</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trdevolucion_facturatotalesElementos">
						<td id="tddevolucion_facturatotalesElementos"  colspan="8">
				...
				<form id="frmAccionesMantenimientodevolucion_factura" name="frmAccionesMantenimientodevolucion_factura">

			<?php if(devolucion_factura_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tbldevolucion_facturaAcciones" class="elementos" style="text-align: center">
		<tr id="trdevolucion_facturaAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientodevolucion_factura" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientodevolucion_facturaBasicos">
							<td id="tdbtnNuevodevolucion_factura" style="visibility:visible">
								<div id="divNuevodevolucion_factura" style="display:table-row">
									<input type="button" id="btnNuevodevolucion_factura" name="btnNuevodevolucion_factura" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizardevolucion_factura" style="visibility:visible">
								<div id="divActualizardevolucion_factura" style="display:table-row">
									<input type="button" id="btnActualizardevolucion_factura" name="btnActualizardevolucion_factura" title="ACTUALIZAR Devolucion Factura ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminardevolucion_factura" style="visibility:visible">
								<div id="divEliminardevolucion_factura" style="display:table-row">
									<input type="button" id="btnEliminardevolucion_factura" name="btnEliminardevolucion_factura" title="ELIMINAR Devolucion Factura ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirdevolucion_factura" style="visibility:visible">
								<input type="button" id="btnImprimirdevolucion_factura" name="btnImprimirdevolucion_factura" title="IMPRIMIR PAGINA Devolucion Factura ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelardevolucion_factura" style="visibility:visible">
								<input type="button" id="btnCancelardevolucion_factura" name="btnCancelardevolucion_factura" title="CANCELAR Devolucion Factura ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientodevolucion_facturaGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosdevolucion_factura" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosdevolucion_factura" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariodevolucion_factura" name="btnGuardarCambiosFormulariodevolucion_factura" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientodevolucion_factura -->
			</td>
		</tr> <!-- trdevolucion_facturaAcciones -->
		<?php if(devolucion_factura_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trdevolucion_facturaParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tbldevolucion_facturaParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trdevolucion_facturaFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tbldevolucion_facturaParametrosAcciones -->
			</td>
		</tr> <!-- trdevolucion_facturaParametrosAcciones -->
		<?php }?>
		<tr id="trdevolucion_facturaMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trdevolucion_facturaMensajes -->
			</table> <!-- tbldevolucion_facturaAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientodevolucion_factura -->
			</div> <!-- divMantenimientodevolucion_facturaAjaxWebPart -->
		</td>
	</tr> <!-- trdevolucion_facturaElementosFormulario/super -->
		<?php if(devolucion_factura_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {devolucion_factura_webcontrol,devolucion_factura_webcontrol1} from './webroot/js/JavaScript/contabilidad/facturacion/devolucion_factura/js/webcontrol/devolucion_factura_form_webcontrol.js?random=1';
