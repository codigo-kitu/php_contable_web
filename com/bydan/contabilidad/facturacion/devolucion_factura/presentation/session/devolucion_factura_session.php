...
namespace com\bydan\contabilidad\facturacion\devolucion_factura\presentation\session;
...
class devolucion_factura_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $devolucion_factura_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->devolucion_factura_sessionAdditional=new devolucion_factura_sessionAdditional();
		*/
