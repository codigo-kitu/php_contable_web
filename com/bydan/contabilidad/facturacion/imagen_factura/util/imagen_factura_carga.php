...
class imagen_factura_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/util/imagen_factura_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/util/imagen_facturaParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/util/imagen_factura_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/business/entity/imagen_factura.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/business/entity/imagen_facturaForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/business/data/imagen_factura_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/business/data/imagen_factura_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/business/logic/imagen_factura_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/business/logic/imagen_factura_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/presentation/session/imagen_factura_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/presentation/view/imagen_factura_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!imagen_factura_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/business/entity/imagen_factura.php');				
						imagen_factura_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!imagen_factura_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/business/data/imagen_factura_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/business/data/imagen_factura_data.php');
						imagen_factura_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!imagen_factura_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!imagen_factura_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/business/logic/imagen_factura_logic.php');
						imagen_factura_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!imagen_factura_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/util/imagen_factura_util.php');
						imagen_factura_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!imagen_factura_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/facturacion/imagen_factura/presentation/session/imagen_factura_session.php');
						imagen_factura_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface imagen_factura_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
