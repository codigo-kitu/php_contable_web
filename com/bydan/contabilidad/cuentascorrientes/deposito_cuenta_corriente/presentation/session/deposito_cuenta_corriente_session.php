...
namespace com\bydan\contabilidad\cuentascorrientes\deposito_cuenta_corriente\presentation\session;
...
class deposito_cuenta_corriente_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $deposito_cuenta_corriente_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->deposito_cuenta_corriente_sessionAdditional=new deposito_cuenta_corriente_sessionAdditional();
		*/
