...
class estado_cuentas_corrientes_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/util/estado_cuentas_corrientes_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/util/estado_cuentas_corrientesParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/util/estado_cuentas_corrientes_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/entity/estado_cuentas_corrientes.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/entity/estado_cuentas_corrientesForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/data/estado_cuentas_corrientes_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/data/estado_cuentas_corrientes_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/logic/estado_cuentas_corrientes_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/logic/estado_cuentas_corrientes_logic.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/logic/estado_cuentas_corrientes_logic_add.php');		
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/presentation/session/estado_cuentas_corrientes_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/presentation/view/estado_cuentas_corrientes_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!estado_cuentas_corrientes_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/entity/estado_cuentas_corrientes.php');				
						estado_cuentas_corrientes_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!estado_cuentas_corrientes_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/data/estado_cuentas_corrientes_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/data/estado_cuentas_corrientes_data.php');
						estado_cuentas_corrientes_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!estado_cuentas_corrientes_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!estado_cuentas_corrientes_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/logic/estado_cuentas_corrientes_logic.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/business/logic/estado_cuentas_corrientesLogic_add.php');
						estado_cuentas_corrientes_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!estado_cuentas_corrientes_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/util/estado_cuentas_corrientes_util.php');
						estado_cuentas_corrientes_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!estado_cuentas_corrientes_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/estado_cuentas_corrientes/presentation/session/estado_cuentas_corrientes_session.php');
						estado_cuentas_corrientes_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface estado_cuentas_corrientes_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
