			...
			<?php foreach ($categoria_chequesLocal as $categoria_cheque) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarcategoria_cheque" idactualcategoria_cheque="<?php echo($categoria_cheque->id) ?>"  funcionjsactualcategoria_cheque="'.str_replace('TO_REPLACE',$categoria_cheque->id.',\''.categoria_cheque_util::getcategoria_chequeDescripcion($categoria_cheque).'\'',$this->strFuncionJs).'" title="SELECCIONAR Categoria Cheque ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Categoria Cheque ACTUAL" value="<?php echo($categoria_cheque->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($categoria_cheque->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $categoria_cheque->updated_at ) ?>
					</td>
				...
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($categoria_cheque->id_empresa_Descripcion) ?></td>
				<?php } ?>
				<td class="elementotabla col_id_cuenta" > <?php echo($categoria_cheque->id_cuenta_Descripcion) ?></td>
				
					<td class="elementotabla col_nombre" > 
						<?php echo( $categoria_cheque->nombre ) ?>
					</td>
				
					<td class="elementotabla col_predeterminado" ><?php  $funciones->getCheckBox($categoria_cheque->predeterminado,'form<?php echo($strSufijo) ?>-predeterminadoi',$paraReporte)  ?>
					</td>
