...
class retiro_cuenta_corriente_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/util/retiro_cuenta_corriente_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/util/retiro_cuenta_corrienteParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/util/retiro_cuenta_corriente_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/entity/retiro_cuenta_corriente.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/entity/retiro_cuenta_corrienteForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/data/retiro_cuenta_corriente_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/data/retiro_cuenta_corriente_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/logic/retiro_cuenta_corriente_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/logic/retiro_cuenta_corriente_logic.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/logic/retiro_cuenta_corriente_logic_add.php');		
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/presentation/session/retiro_cuenta_corriente_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/presentation/view/retiro_cuenta_corriente_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!retiro_cuenta_corriente_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/entity/retiro_cuenta_corriente.php');				
						retiro_cuenta_corriente_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!retiro_cuenta_corriente_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/data/retiro_cuenta_corriente_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/data/retiro_cuenta_corriente_data.php');
						retiro_cuenta_corriente_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!retiro_cuenta_corriente_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!retiro_cuenta_corriente_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/logic/retiro_cuenta_corriente_logic.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/business/logic/retiro_cuenta_corrienteLogic_add.php');
						retiro_cuenta_corriente_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!retiro_cuenta_corriente_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/util/retiro_cuenta_corriente_util.php');
						retiro_cuenta_corriente_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!retiro_cuenta_corriente_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/cuentascorrientes/retiro_cuenta_corriente/presentation/session/retiro_cuenta_corriente_session.php');
						retiro_cuenta_corriente_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface retiro_cuenta_corriente_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
