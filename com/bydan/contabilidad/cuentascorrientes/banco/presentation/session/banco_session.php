...
namespace com\bydan\contabilidad\cuentascorrientes\banco\presentation\session;
...
class banco_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $banco_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->intNumeroPaginacion = banco_util::$INT_NUMERO_PAGINACION;
		...
		$this->banco_sessionAdditional=new banco_sessionAdditional();
		*/
