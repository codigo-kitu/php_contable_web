...
class cheque_cuenta_corriente_util extends GeneralEntityConstantesFunciones  {
	/*CONTROL_INICIO*/
			
	/*GENERAL*/
	public static string $STR_CLASS_NAME='cheque_cuenta_corriente';
	public static string $STR_FINAL_QUERY='';	
	public static string $STR_NOMBRE_OPCION='cuentas_corrientes.cheque_cuenta_corrientes';
	/*'Mantenimientocheque_cuenta_corriente.jsf';*/
	public static string $STR_MODULO_OPCION='cuentascorrientes';
	public static string $STR_NOMBRE_CLASE='Mantenimientocheque_cuenta_corriente.jsf';	
	public static string $STR_PATH_OPCION='';	
	public static string $STR_PERSISTENCE_CONTEXT_NAME='';
	public static string $STR_PERSISTENCE_NAME='cheque_cuenta_corrientePersistenceName';
	/*.cheque_cuenta_corriente_util::$SPERSISTENCECONTEXTNAME.Constantes::$SPERSISTENCECONTEXTNAME;*/
	public static string $STR_SESSION_NAME='cheque_cuenta_corriente_session';
	/*.Constantes$::SSESSIONBEAN;*/
	public static string $STR_SESSION_CONTROLLER_NAME='cheque_cuenta_corriente_control_session';
	/*.Constantes$::SSESSIONBEAN;*/
	public static string $STR_CONTROLLER_NAME='cheque_cuenta_corriente_control';
	public static string $STR_CLASS_NAME_TITULO_REPORTES='Cheques';
	public static string $STR_RELATIVE_PATH='../';
	public static string $STR_CLASS_PLURAL='s';
	public static string $STR_CLASS_WEB_TITULO='Cheque';
	...
	/*AUXILIAR*/
	//public $cheque_cuenta_corrienteConstantesFuncionesAdditional;
    ...
    public static string $ID_BENEFICIARIO_OCACIONAL_CHEQUE='id_beneficiario_ocacional_cheque';
    ...
    public static string $COBRADO='cobrado';
    public static string $IMPRESO='impreso';
    ...
    public static string $LABEL_ID_BENEFICIARIO_OCACIONAL_CHEQUE=' Beneficiario Ocacional';
    ...
    public static string $LABEL_COBRADO='Cobrado';
    public static string $LABEL_IMPRESO='Impreso';
	...
	function __construct (){
		...
		$this->cheque_cuenta_corrienteConstantesFuncionesAdditional=new $cheque_cuenta_corrienteConstantesFuncionesAdditional();*/
	}
	
	/*LISTA INDICE*/
	public static function getIndiceNuevo(array $cheque_cuenta_corrientes,int $iIdNuevocheque_cuenta_corriente) : int {
		$iIndice=0;
		$existe=false;
		
		foreach($cheque_cuenta_corrientes as $cheque_cuenta_corrienteAux) {
			if($cheque_cuenta_corrienteAux->getId()==$iIdNuevocheque_cuenta_corriente) {
				$existe=true;
				break;
			}
	...
	public static function getIndiceActual(array $cheque_cuenta_corrientes,cheque_cuenta_corriente $cheque_cuenta_corriente,int $iIndiceActual) : int {
		$iIndice=0;
		$existe=false;
		
		foreach($cheque_cuenta_corrientes as $cheque_cuenta_corrienteAux) {
			if($cheque_cuenta_corrienteAux->getId()==$cheque_cuenta_corriente->getId()) {
				$existe=true;
				break;
			}
	...
	/*DESCRIPCION*/
	public static function getcheque_cuenta_corrienteDescripcion(?cheque_cuenta_corriente $cheque_cuenta_corriente) : string {//cheque_cuenta_corriente NO USAR CLASE, PARA NULOS SE DANA
		$sDescripcion=Constantes::$STR_NONE;
			
		if($cheque_cuenta_corriente !=null) {
			/*&& cheque_cuenta_corriente->getId()!=0*/
			
			if($cheque_cuenta_corriente->getId()!=null) {
				$sDescripcion=(string)$cheque_cuenta_corriente->getId();
			}
	...
	public static function setcheque_cuenta_corrienteDescripcion(?cheque_cuenta_corriente $cheque_cuenta_corriente,string $sValor) {			
		if($cheque_cuenta_corriente !=null) {
	...
	public static function prepararCombosFK(array $cheque_cuenta_corrientes) : array {
		$cheque_cuenta_corrientesForeignKey=array();
		
		foreach ($cheque_cuenta_corrientes as $cheque_cuenta_corrienteLocal) {
			$cheque_cuenta_corrientesForeignKey[$cheque_cuenta_corrienteLocal->getId()]=cheque_cuenta_corriente_util::getcheque_cuenta_corrienteDescripcion($cheque_cuenta_corrienteLocal);
		}
			
		return $cheque_cuenta_corrientesForeignKey;
	}
    ...
    public static function getColumnLabelid_beneficiario_ocacional_cheque() : string  { return ' Beneficiario Ocacional'; }
    ...
    public static function getColumnLabelcobrado() : string  { return 'Cobrado'; }
    public static function getColumnLabelimpreso() : string  { return 'Impreso'; }
	...
	public static function getcobradoDescripcion($cheque_cuenta_corriente) {
		$sDescripcion='Verdadero';
		if(!$cheque_cuenta_corriente->getcobrado()) { $sDescripcion='Falso'; }
		return $sDescripcion;
	}	
		
	public static function getimpresoDescripcion($cheque_cuenta_corriente) {
		$sDescripcion='Verdadero';
		if(!$cheque_cuenta_corriente->getimpreso()) { $sDescripcion='Falso'; }
		return $sDescripcion;
	}	
	
	/*DESCRIPCION FKs*/
	public static function refrescarFKDescripciones(array $cheque_cuenta_corrientes) {		
		try {
	...
	public static function refrescarFKDescripcion(cheque_cuenta_corriente $cheque_cuenta_corriente) {		
		try {
	...
	public static function getNombreIndice(string $sNombreIndice) : string {
		...
		} else if($sNombreIndice=='FK_Idbeneficiario_ocacional') {
			$sNombreIndice='Tipo=  Por  Beneficiario Ocacional';
	...
	public static function getDetalleIndiceFK_Idbeneficiario_ocacional(?int $id_beneficiario_ocacional_cheque) : string {
		$sDetalleIndice=' Parámetros -> ';
		$sDetalleIndice.=' Código Único de  Beneficiario Ocacional='+$id_beneficiario_ocacional_cheque; 
	...
	public static function getTiposSeleccionar(bool $conFk) : array {
		return cheque_cuenta_corriente_util::getTiposSeleccionar3($conFk,true,true,true,true);
	}
	
	public static function getTiposSeleccionar2() : array {
		return cheque_cuenta_corriente_util::getTiposSeleccionar3(false,true,true,true,true);
	}
	...
	public static function getTiposSeleccionar3(bool $conFk,bool $conStringColumn,bool $conValorColumn,bool $conFechaColumn,bool $conBitColumn) : array {
		...
		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_ID_EMPRESA);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_ID_EMPRESA.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_ID_SUCURSAL);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_ID_SUCURSAL.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_ID_EJERCICIO);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_ID_EJERCICIO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_ID_PERIODO);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_ID_PERIODO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_ID_USUARIO);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_ID_USUARIO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_ID_CUENTA_CORRIENTE);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_ID_CUENTA_CORRIENTE.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_ID_CATEGORIA_CHEQUE);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_ID_CATEGORIA_CHEQUE.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_ID_CLIENTE);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_ID_CLIENTE.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_ID_PROVEEDOR);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_ID_PROVEEDOR.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_ID_BENEFICIARIO_OCACIONAL_CHEQUE);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_ID_BENEFICIARIO_OCACIONAL_CHEQUE.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_NUMERO_CHEQUE);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_NUMERO_CHEQUE);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFechaColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_FECHA_EMISION);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_FECHA_EMISION);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_MONTO);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_MONTO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_MONTO_TEXTO);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_MONTO_TEXTO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_SALDO);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_SALDO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conStringColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_DESCRIPCION);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_DESCRIPCION);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conBitColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_COBRADO);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_COBRADO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conBitColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_IMPRESO);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_IMPRESO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conFk) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_ID_ESTADO_DEPOSITO_RETIRO);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_ID_ESTADO_DEPOSITO_RETIRO.'-->'.Constantes::$STR_RELACION_LABEL_FK);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_DEBITO);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_DEBITO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}

		if($conValorColumn) {
			$reporte=new Reporte();
			$reporte->setsCodigo(cheque_cuenta_corriente_util::$LABEL_CREDITO);
			$reporte->setsDescripcion(cheque_cuenta_corriente_util::$LABEL_CREDITO);
			$arrTiposSeleccionarTodos[]=$reporte;
		}
	...
	public static function getArrayColumnasGlobales(array $arrDatoGeneral) : array {
		...
		$arrColumnasGlobales=cheque_cuenta_corriente_util::getArrayColumnasGlobalesConNoColumnas($arrDatoGeneral,array());
	...
	public static function getArrayColumnasGlobalesConNoColumnas(array $arrDatoGeneral,array $arrColumnasGlobalesNo) : array {
		...
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==cheque_cuenta_corriente_util::$ID_EMPRESA) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=cheque_cuenta_corriente_util::$ID_EMPRESA;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==cheque_cuenta_corriente_util::$ID_SUCURSAL) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=cheque_cuenta_corriente_util::$ID_SUCURSAL;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==cheque_cuenta_corriente_util::$ID_EJERCICIO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=cheque_cuenta_corriente_util::$ID_EJERCICIO;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==cheque_cuenta_corriente_util::$ID_PERIODO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=cheque_cuenta_corriente_util::$ID_PERIODO;
		}

		$noExiste=false;
		foreach($arrColumnasGlobalesNo as $sColumnaGlobalNo) {
			if($sColumnaGlobalNo==cheque_cuenta_corriente_util::$ID_USUARIO) {
				$noExiste=true;
			}
		}

		if(!$noExiste) {
			$arrColumnasGlobales[]=cheque_cuenta_corriente_util::$ID_USUARIO;
		}
	...
	public static function getClassesFKsOf(array $classesP,string $deepLoadType) : array {
		try {
			...
			if($deepLoadType==DeepLoadType::$NONE) {
				...
				foreach($classesP as $clas) {
					if($clas==beneficiario_ocacional_cheque::$class) {
						$classes[]=new Classe(beneficiario_ocacional_cheque::$class);
					}
				}
	...
	public static function getOrderByLista() : array {
		...
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID, cheque_cuenta_corriente_util::$ID,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID_EMPRESA, cheque_cuenta_corriente_util::$ID_EMPRESA,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID_SUCURSAL, cheque_cuenta_corriente_util::$ID_SUCURSAL,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID_EJERCICIO, cheque_cuenta_corriente_util::$ID_EJERCICIO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID_PERIODO, cheque_cuenta_corriente_util::$ID_PERIODO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID_USUARIO, cheque_cuenta_corriente_util::$ID_USUARIO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID_CUENTA_CORRIENTE, cheque_cuenta_corriente_util::$ID_CUENTA_CORRIENTE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID_CATEGORIA_CHEQUE, cheque_cuenta_corriente_util::$ID_CATEGORIA_CHEQUE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID_CLIENTE, cheque_cuenta_corriente_util::$ID_CLIENTE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID_PROVEEDOR, cheque_cuenta_corriente_util::$ID_PROVEEDOR,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID_BENEFICIARIO_OCACIONAL_CHEQUE, cheque_cuenta_corriente_util::$ID_BENEFICIARIO_OCACIONAL_CHEQUE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_NUMERO_CHEQUE, cheque_cuenta_corriente_util::$NUMERO_CHEQUE,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_FECHA_EMISION, cheque_cuenta_corriente_util::$FECHA_EMISION,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_MONTO, cheque_cuenta_corriente_util::$MONTO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_MONTO_TEXTO, cheque_cuenta_corriente_util::$MONTO_TEXTO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_SALDO, cheque_cuenta_corriente_util::$SALDO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_DESCRIPCION, cheque_cuenta_corriente_util::$DESCRIPCION,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_COBRADO, cheque_cuenta_corriente_util::$COBRADO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_IMPRESO, cheque_cuenta_corriente_util::$IMPRESO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_ID_ESTADO_DEPOSITO_RETIRO, cheque_cuenta_corriente_util::$ID_ESTADO_DEPOSITO_RETIRO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_DEBITO, cheque_cuenta_corriente_util::$DEBITO,false,""); $arrOrderBy[]=$orderBy;
		$orderBy=OrderBy::NewOrderBy(false,cheque_cuenta_corriente_util::$LABEL_CREDITO, cheque_cuenta_corriente_util::$CREDITO,false,""); $arrOrderBy[]=$orderBy;
	...
	public static function getHeaderReportRow(string $tipo='NORMAL',array $arrOrderBy,bool $bitParaReporteOrderBy) : array {
		...
		if(Funciones::existeCadenaArrayOrderBy(' Beneficiario Ocacional',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine(' Beneficiario Ocacional',40,7,1);$cellReport->setblnFill($blnFill); $header[]=$cellReport;
		}
		...
		if(Funciones::existeCadenaArrayOrderBy('Cobrado',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine('Cobrado',40,7,1);$cellReport->setblnFill($blnFill); $header[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Impreso',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine('Impreso',40,7,1);$cellReport->setblnFill($blnFill); $header[]=$cellReport;
		}
	...
	public static function getDataReportRow(string $tipo='NORMAL',cheque_cuenta_corriente $cheque_cuenta_corriente,array $arrOrderBy,bool $bitParaReporteOrderBy) : array {
		$row=array();
		...
		if(Funciones::existeCadenaArrayOrderBy(' Empresa',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getid_empresa_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Sucursal',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getid_sucursal_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Ejercicio',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getid_ejercicio_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Periodo',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getid_periodo_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Usuario',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getid_usuario_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Cuenta Corriente',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getid_cuenta_corriente_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Categoria Cheque',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getid_categoria_cheque_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Cliente',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getid_cliente_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Proveedor',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getid_proveedor_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Beneficiario Ocacional',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getid_beneficiario_ocacional_cheque_Descripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Numero Cheque',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getnumero_cheque(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Fecha Emision',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getfecha_emision(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Monto',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getmonto(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Monto Texto',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getmonto_texto(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Saldo Actual',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getsaldo(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Descripcion',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getdescripcion(),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Cobrado',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine(Funciones::getBitDescription($cheque_cuenta_corriente->getcobrado()),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy('Impreso',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine(Funciones::getBitDescription($cheque_cuenta_corriente->getimpreso()),40,6,1); $row[]=$cellReport;
		}

		if(Funciones::existeCadenaArrayOrderBy(' Estado Deposito Retiro',$arrOrderBy,$bitParaReporteOrderBy)){
			$cellReport=new CellReport(); $cellReport->inicializarTextWidthHeightLine($cheque_cuenta_corriente->getid_estado_deposito_retiro_Descripcion(),40,6,1); $row[]=$cellReport;
		}
	...
	public static function getbeneficiario_ocacional_chequeDescripcion(?beneficiario_ocacional_cheque $beneficiario_ocacional_cheque) : string {
		...
		if($beneficiario_ocacional_cheque!==null) {
			$sDescripcion=beneficiario_ocacional_cheque_util::getbeneficiario_ocacional_chequeDescripcion($beneficiario_ocacional_cheque);
		}
		return $sDescripcion;
	}	
	...
	interface cheque_cuenta_corriente_util extends GeneralEntityConstantesFunciones  {
		...
		//DESCRIPCION
		public static function getcheque_cuenta_corrienteDescripcion(?cheque_cuenta_corriente $cheque_cuenta_corriente) : string {;	
		public static function setcheque_cuenta_corrienteDescripcion(?cheque_cuenta_corriente $cheque_cuenta_corriente,string $sValor);
