...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/cuentascorrientes/cheque_cuenta_corriente/js/util/cheque_cuenta_corriente_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			cheque_cuenta_corriente_web::$STR_NOMBRE_PAGINA = 'cheque_cuenta_corriente_form_view.php';
			cheque_cuenta_corriente_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			cheque_cuenta_corriente_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trcheque_cuenta_corrienteElementosFormulario">
	<td>
		<div id="divMantenimientocheque_cuenta_corrienteAjaxWebPart" title="CHEQUE" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientocheque_cuenta_corriente" name="frmMantenimientocheque_cuenta_corriente">

			</br>

			<?php if(cheque_cuenta_corriente_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblcheque_cuenta_corrienteToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblcheque_cuenta_corrienteToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdcheque_cuenta_corrienteActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarcheque_cuenta_corriente" name="imgActualizarToolBarcheque_cuenta_corriente" title="ACTUALIZAR Cheque ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdcheque_cuenta_corrienteEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarcheque_cuenta_corriente" name="imgEliminarToolBarcheque_cuenta_corriente" title="ELIMINAR Cheque ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdcheque_cuenta_corrienteCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarcheque_cuenta_corriente" name="imgCancelarToolBarcheque_cuenta_corriente" title="CANCELAR Cheque ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdcheque_cuenta_corrienteRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultoscheque_cuenta_corriente',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblcheque_cuenta_corrienteToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblcheque_cuenta_corrienteToolBarFormularioExterior -->

			<table id="tblcheque_cuenta_corrienteElementos">
			<tr id="trcheque_cuenta_corrienteElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementoscheque_cuenta_corriente" class="elementos" style="width: 700px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					<tr id="tr_fila_1">
					...
					<tr id="tr_fila_8">
						<td id="td_title-id_beneficiario_ocacional_cheque" class="titulocampo">
							<label class="form-label"> Beneficiario Ocacional</label>
						</td>
						<td id="td_control-id_beneficiario_ocacional_cheque" align="left" class="controlcombo">
							
							<table align="left" cellspacing="0" cellpadding="0" border="0">
								<tr>
									<td><select id="form-id_beneficiario_ocacional_cheque" name="form-id_beneficiario_ocacional_cheque" title=" Beneficiario Ocacional" ></select></td>
									<td><a><img id="form-id_beneficiario_ocacional_cheque_img" name="form-id_beneficiario_ocacional_cheque_img" class="imagen_actualizar" title="ACTUALIZAR DATOS RELACIONADOS" src="/contabilidad0/webroot/img/Imagenes/actualizardatos.gif" alt="Actualizar Datos" border="" height="15" width="15"></a></td>
									<td><img id="form-id_beneficiario_ocacional_cheque_img_busqueda" name="form-id_beneficiario_ocacional_cheque_img_busqueda" title="Buscar Beneficiario Ocacional" style="width: 15px; height: 15px;text-align: center; visibility:hidden;" src="/contabilidad0/webroot/img/Imagenes/buscar.gif" width="15" height="15"/></td>
								</tr>
							</table>
							<span id="spanstrMensajeid_beneficiario_ocacional_cheque" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_9">
					...
					<tr id="tr_fila_15">
						<td id="td_title-cobrado" class="titulocampo">
							<label class="form-label">Cobrado</label>
						</td>
						<td id="td_control-cobrado" align="left" class="controlcampo">
							<input id="form-cobrado" name="form-cobrado" type="checkbox" >
							<span id="spanstrMensajecobrado" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_16">
						<td id="td_title-impreso" class="titulocampo">
							<label class="form-label">Impreso</label>
						</td>
						<td id="td_control-impreso" align="left" class="controlcampo">
							<input id="form-impreso" name="form-impreso" type="checkbox" >
							<span id="spanstrMensajeimpreso" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_17">
				...
				</table> <!-- tblElementoscheque_cuenta_corriente -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultoscheque_cuenta_corriente" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultoscheque_cuenta_corriente -->

			</td></tr> <!-- trcheque_cuenta_corrienteElementos -->
			</table> <!-- tblcheque_cuenta_corrienteElementos -->
			</form> <!-- frmMantenimientocheque_cuenta_corriente -->


			

				<form id="frmAccionesMantenimientocheque_cuenta_corriente" name="frmAccionesMantenimientocheque_cuenta_corriente">

			<?php if(cheque_cuenta_corriente_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblcheque_cuenta_corrienteAcciones" class="elementos" style="text-align: center">
		<tr id="trcheque_cuenta_corrienteAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientocheque_cuenta_corriente" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientocheque_cuenta_corrienteBasicos">
							<td id="tdbtnNuevocheque_cuenta_corriente" style="visibility:visible">
								<div id="divNuevocheque_cuenta_corriente" style="display:table-row">
									<input type="button" id="btnNuevocheque_cuenta_corriente" name="btnNuevocheque_cuenta_corriente" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarcheque_cuenta_corriente" style="visibility:visible">
								<div id="divActualizarcheque_cuenta_corriente" style="display:table-row">
									<input type="button" id="btnActualizarcheque_cuenta_corriente" name="btnActualizarcheque_cuenta_corriente" title="ACTUALIZAR Cheque ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarcheque_cuenta_corriente" style="visibility:visible">
								<div id="divEliminarcheque_cuenta_corriente" style="display:table-row">
									<input type="button" id="btnEliminarcheque_cuenta_corriente" name="btnEliminarcheque_cuenta_corriente" title="ELIMINAR Cheque ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimircheque_cuenta_corriente" style="visibility:visible">
								<input type="button" id="btnImprimircheque_cuenta_corriente" name="btnImprimircheque_cuenta_corriente" title="IMPRIMIR PAGINA Cheque ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarcheque_cuenta_corriente" style="visibility:visible">
								<input type="button" id="btnCancelarcheque_cuenta_corriente" name="btnCancelarcheque_cuenta_corriente" title="CANCELAR Cheque ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientocheque_cuenta_corrienteGuardar" style="display:none">
							<td id="tdbtnGuardarCambioscheque_cuenta_corriente" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambioscheque_cuenta_corriente" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariocheque_cuenta_corriente" name="btnGuardarCambiosFormulariocheque_cuenta_corriente" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientocheque_cuenta_corriente -->
			</td>
		</tr> <!-- trcheque_cuenta_corrienteAcciones -->
		<?php if(cheque_cuenta_corriente_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trcheque_cuenta_corrienteParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblcheque_cuenta_corrienteParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trcheque_cuenta_corrienteFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblcheque_cuenta_corrienteParametrosAcciones -->
			</td>
		</tr> <!-- trcheque_cuenta_corrienteParametrosAcciones -->
		<?php }?>
		<tr id="trcheque_cuenta_corrienteMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trcheque_cuenta_corrienteMensajes -->
			</table> <!-- tblcheque_cuenta_corrienteAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientocheque_cuenta_corriente -->
			</div> <!-- divMantenimientocheque_cuenta_corrienteAjaxWebPart -->
		</td>
	</tr> <!-- trcheque_cuenta_corrienteElementosFormulario/super -->
		<?php if(cheque_cuenta_corriente_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {cheque_cuenta_corriente_webcontrol,cheque_cuenta_corriente_webcontrol1} from './webroot/js/JavaScript/contabilidad/cuentascorrientes/cheque_cuenta_corriente/js/webcontrol/cheque_cuenta_corriente_form_webcontrol.js?random=1';
