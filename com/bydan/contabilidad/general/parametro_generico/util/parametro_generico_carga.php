...
class parametro_generico_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/util/parametro_generico_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/util/parametro_genericoParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/util/parametro_generico_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/business/entity/parametro_generico.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/business/entity/parametro_genericoForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/business/data/parametro_generico_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/business/data/parametro_generico_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/business/logic/parametro_generico_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/business/logic/parametro_generico_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/presentation/session/parametro_generico_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/presentation/view/parametro_generico_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!parametro_generico_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/business/entity/parametro_generico.php');				
						parametro_generico_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!parametro_generico_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/business/data/parametro_generico_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/business/data/parametro_generico_data.php');
						parametro_generico_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!parametro_generico_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!parametro_generico_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/business/logic/parametro_generico_logic.php');
						parametro_generico_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!parametro_generico_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/util/parametro_generico_util.php');
						parametro_generico_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!parametro_generico_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_generico/presentation/session/parametro_generico_session.php');
						parametro_generico_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface parametro_generico_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
