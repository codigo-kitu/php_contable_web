...
class log_actividad_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/util/log_actividad_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/util/log_actividadParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/util/log_actividad_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/business/entity/log_actividad.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/business/entity/log_actividadForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/business/data/log_actividad_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/business/data/log_actividad_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/business/logic/log_actividad_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/business/logic/log_actividad_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/presentation/session/log_actividad_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/presentation/view/log_actividad_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!log_actividad_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/business/entity/log_actividad.php');				
						log_actividad_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!log_actividad_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/business/data/log_actividad_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/business/data/log_actividad_data.php');
						log_actividad_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!log_actividad_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!log_actividad_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/business/logic/log_actividad_logic.php');
						log_actividad_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!log_actividad_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/util/log_actividad_util.php');
						log_actividad_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!log_actividad_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/log_actividad/presentation/session/log_actividad_session.php');
						log_actividad_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
