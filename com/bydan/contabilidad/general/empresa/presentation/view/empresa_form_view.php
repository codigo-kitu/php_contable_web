...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/general/empresa/js/util/empresa_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			empresa_web::$STR_NOMBRE_PAGINA = 'empresa_form_view.php';
			empresa_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			empresa_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trempresaElementosFormulario">
	<td>
		<div id="divMantenimientoempresaAjaxWebPart" title="EMPRESA" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoempresa" name="frmMantenimientoempresa">

			</br>

			<?php if(empresa_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblempresaToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblempresaToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdempresaActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarempresa" name="imgActualizarToolBarempresa" title="ACTUALIZAR Empresa ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdempresaEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarempresa" name="imgEliminarToolBarempresa" title="ELIMINAR Empresa ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdempresaCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarempresa" name="imgCancelarToolBarempresa" title="CANCELAR Empresa ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdempresaRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosempresa',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblempresaToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblempresaToolBarFormularioExterior -->

			<table id="tblempresaElementos">
			<tr id="trempresaElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosempresa" class="elementos" style="width: 350px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					<tr id="tr_fila_1">
					...
					<tr id="tr_fila_2">
						...
						<td id="td_control-ruc" align="left" class="controlcampo">
							<input id="form-ruc" name="form-ruc" type="text" class="form-control"  placeholder="RUC"  title="RUC"    size="15"  maxlength="15"/>
					...
					<tr id="tr_fila_3">
						...
						<td id="td_title-nombre_comercial" class="titulocampo">
							<label class="form-label">Nombre Comercial</label>
						</td>
						<td id="td_control-nombre_comercial" align="left" class="controlcampo">
							<textarea id="form-nombre_comercial" name="form-nombre_comercial" class="form-control"  placeholder="Nombre Comercial"  title="Nombre Comercial"   style="font-size: 13px;" rows="2" cols="25" size="20" ></textarea>
							<span id="spanstrMensajenombre_comercial" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_4">
						<td id="td_title-sector" class="titulocampo">
							<label class="form-label">Sector</label>
						</td>
						<td id="td_control-sector" align="left" class="controlcampo">
							<textarea id="form-sector" name="form-sector" class="form-control"  placeholder="Sector"  title="Sector"   style="font-size: 13px;" rows="2" cols="25" size="20" ></textarea>
					...
					<tr id="tr_fila_6">
						...
						<td id="td_title-movil" class="titulocampo">
							<label class="form-label">Telefono Movil</label>
						</td>
						<td id="td_control-movil" align="left" class="controlcampo">
							<input id="form-movil" name="form-movil" type="text" class="form-control"  placeholder="Telefono Movil"  title="Telefono Movil"    size="20"  maxlength="40"/>
							<span id="spanstrMensajemovil" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_7">
						<td id="td_title-mail" class="titulocampo">
							<label class="form-label">Mail.(*)</label>
						</td>
						<td id="td_control-mail" align="left" class="controlcampo">
							<textarea id="form-mail" name="form-mail" class="form-control"  placeholder="Mail"  title="Mail"   style="font-size: 13px;" rows="2" cols="25" size="20" ></textarea>
				...
				</table> <!-- tblElementosempresa -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosempresa" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultosempresa -->

			</td></tr> <!-- trempresaElementos -->
			</table> <!-- tblempresaElementos -->
			</form> <!-- frmMantenimientoempresa -->


			

				<form id="frmAccionesMantenimientoempresa" name="frmAccionesMantenimientoempresa">

			<?php if(empresa_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblempresaAcciones" class="elementos" style="text-align: center">
		<tr id="trempresaAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoempresa" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientoempresaBasicos">
							<td id="tdbtnNuevoempresa" style="visibility:visible">
								<div id="divNuevoempresa" style="display:table-row">
									<input type="button" id="btnNuevoempresa" name="btnNuevoempresa" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarempresa" style="visibility:visible">
								<div id="divActualizarempresa" style="display:table-row">
									<input type="button" id="btnActualizarempresa" name="btnActualizarempresa" title="ACTUALIZAR Empresa ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarempresa" style="visibility:visible">
								<div id="divEliminarempresa" style="display:table-row">
									<input type="button" id="btnEliminarempresa" name="btnEliminarempresa" title="ELIMINAR Empresa ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirempresa" style="visibility:visible">
								<input type="button" id="btnImprimirempresa" name="btnImprimirempresa" title="IMPRIMIR PAGINA Empresa ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarempresa" style="visibility:visible">
								<input type="button" id="btnCancelarempresa" name="btnCancelarempresa" title="CANCELAR Empresa ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoempresaGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosempresa" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosempresa" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioempresa" name="btnGuardarCambiosFormularioempresa" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoempresa -->
			</td>
		</tr> <!-- trempresaAcciones -->
		<?php if(empresa_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trempresaParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblempresaParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trempresaFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblempresaParametrosAcciones -->
			</td>
		</tr> <!-- trempresaParametrosAcciones -->
		<?php }?>
		<tr id="trempresaMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trempresaMensajes -->
			</table> <!-- tblempresaAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoempresa -->
			</div> <!-- divMantenimientoempresaAjaxWebPart -->
		</td>
	</tr> <!-- trempresaElementosFormulario/super -->
		<?php if(empresa_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {empresa_webcontrol,empresa_webcontrol1} from './webroot/js/JavaScript/contabilidad/general/empresa/js/webcontrol/empresa_form_webcontrol.js?random=1';
