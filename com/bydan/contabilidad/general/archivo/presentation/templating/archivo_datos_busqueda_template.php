			...
			<?php foreach ($archivosLocal as $archivo) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionararchivo" idactualarchivo="<?php echo($archivo->id) ?>"  funcionjsactualarchivo="'.str_replace('TO_REPLACE',$archivo->id.',\''.archivo_util::getarchivoDescripcion($archivo).'\'',$this->strFuncionJs).'" title="SELECCIONAR Archivos ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Archivos ACTUAL" value="<?php echo($archivo->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($archivo->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
