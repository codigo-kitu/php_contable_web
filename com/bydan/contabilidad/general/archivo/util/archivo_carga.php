...
use com\bydan\contabilidad\general\otro_documento\util\otro_documento_carga;//1-M,M-M
...
class archivo_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/util/archivo_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/util/archivoParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/util/archivo_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/business/entity/archivo.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/business/entity/archivoForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/business/data/archivo_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/business/data/archivo_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/business/logic/archivo_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/business/logic/archivo_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/presentation/session/archivo_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/presentation/view/archivo_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!archivo_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/business/entity/archivo.php');				
						archivo_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!archivo_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/business/data/archivo_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/business/data/archivo_data.php');
						archivo_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!archivo_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!archivo_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/business/logic/archivo_logic.php');
						archivo_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!archivo_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/util/archivo_util.php');
						archivo_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!archivo_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/archivo/presentation/session/archivo_session.php');
						archivo_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesRelaciones(string $paqueteTipo='LOGIC') {
		...
		otro_documento_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/general/otro_documento/presentation/session/otro_documento_session.php');
