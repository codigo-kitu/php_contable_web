...
use com\bydan\contabilidad\general\parametro_auxiliar\util\parametro_auxiliar_carga;//1-M,M-M
use com\bydan\contabilidad\inventario\parametro_inventario\util\parametro_inventario_carga;//1-M,M-M
...
class tipo_costeo_kardex_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/util/tipo_costeo_kardex_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/util/tipo_costeo_kardexParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/util/tipo_costeo_kardex_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/business/entity/tipo_costeo_kardex.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/business/entity/tipo_costeo_kardexForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/business/data/tipo_costeo_kardex_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/business/data/tipo_costeo_kardex_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/business/logic/tipo_costeo_kardex_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/business/logic/tipo_costeo_kardex_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/presentation/session/tipo_costeo_kardex_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/presentation/view/tipo_costeo_kardex_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!tipo_costeo_kardex_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/business/entity/tipo_costeo_kardex.php');				
						tipo_costeo_kardex_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!tipo_costeo_kardex_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/business/data/tipo_costeo_kardex_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/business/data/tipo_costeo_kardex_data.php');
						tipo_costeo_kardex_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!tipo_costeo_kardex_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!tipo_costeo_kardex_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/business/logic/tipo_costeo_kardex_logic.php');
						tipo_costeo_kardex_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!tipo_costeo_kardex_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/util/tipo_costeo_kardex_util.php');
						tipo_costeo_kardex_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!tipo_costeo_kardex_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_costeo_kardex/presentation/session/tipo_costeo_kardex_session.php');
						tipo_costeo_kardex_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesRelaciones(string $paqueteTipo='LOGIC') {
		...
		parametro_auxiliar_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/general/parametro_auxiliar/presentation/session/parametro_auxiliar_session.php');
		...
		parametro_inventario_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/inventario/parametro_inventario/presentation/session/parametro_inventario_session.php');
	...
	/*
	interface tipo_costeo_kardex_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
