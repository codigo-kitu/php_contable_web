			...
			<?php foreach ($tipo_termino_pagosLocal as $tipo_termino_pago) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionartipo_termino_pago" idactualtipo_termino_pago="<?php echo($tipo_termino_pago->id) ?>"  funcionjsactualtipo_termino_pago="'.str_replace('TO_REPLACE',$tipo_termino_pago->id.',\''.tipo_termino_pago_util::gettipo_termino_pagoDescripcion($tipo_termino_pago).'\'',$this->strFuncionJs).'" title="SELECCIONAR Tipo Termino Pago ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Tipo Termino Pago ACTUAL" value="<?php echo($tipo_termino_pago->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($tipo_termino_pago->id) ?>" style="width:50px" ></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $tipo_termino_pago->updated_at ) ?>
					</td>
					...
					<td class="elementotabla col_codigo" > 
						<?php echo( $tipo_termino_pago->codigo ) ?>
					</td>
				
					<td class="elementotabla col_nombre" > 
						<?php echo( $tipo_termino_pago->nombre ) ?>
					</td>
