...
class tipo_persona_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/util/tipo_persona_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/util/tipo_personaParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/util/tipo_persona_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/business/entity/tipo_persona.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/business/entity/tipo_personaForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/business/data/tipo_persona_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/business/data/tipo_persona_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/business/logic/tipo_persona_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/business/logic/tipo_persona_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/presentation/session/tipo_persona_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/presentation/view/tipo_persona_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!tipo_persona_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/business/entity/tipo_persona.php');				
						tipo_persona_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!tipo_persona_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/business/data/tipo_persona_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/business/data/tipo_persona_data.php');
						tipo_persona_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!tipo_persona_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!tipo_persona_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/business/logic/tipo_persona_logic.php');
						tipo_persona_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!tipo_persona_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/util/tipo_persona_util.php');
						tipo_persona_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!tipo_persona_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tipo_persona/presentation/session/tipo_persona_session.php');
						tipo_persona_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
