...
class reporte_monica_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/util/reporte_monica_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/util/reporte_monicaParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/util/reporte_monica_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/business/entity/reporte_monica.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/business/entity/reporte_monicaForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/business/data/reporte_monica_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/business/data/reporte_monica_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/business/logic/reporte_monica_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/business/logic/reporte_monica_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/presentation/session/reporte_monica_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/presentation/view/reporte_monica_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!reporte_monica_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/business/entity/reporte_monica.php');				
						reporte_monica_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!reporte_monica_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/business/data/reporte_monica_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/business/data/reporte_monica_data.php');
						reporte_monica_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!reporte_monica_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!reporte_monica_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/business/logic/reporte_monica_logic.php');
						reporte_monica_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!reporte_monica_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/util/reporte_monica_util.php');
						reporte_monica_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!reporte_monica_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/reporte_monica/presentation/session/reporte_monica_session.php');
						reporte_monica_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface reporte_monica_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
