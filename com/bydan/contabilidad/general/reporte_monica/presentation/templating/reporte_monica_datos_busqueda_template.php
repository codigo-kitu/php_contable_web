			...
			<?php foreach ($reporte_monicasLocal as $reporte_monica) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarreporte_monica" idactualreporte_monica="<?php echo($reporte_monica->id) ?>"  funcionjsactualreporte_monica="'.str_replace('TO_REPLACE',$reporte_monica->id.',\''.reporte_monica_util::getreporte_monicaDescripcion($reporte_monica).'\'',$this->strFuncionJs).'" title="SELECCIONAR Reportes Monica ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Reportes Monica ACTUAL" value="<?php echo($reporte_monica->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($reporte_monica->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $reporte_monica->updated_at ) ?>
					</td>
					...
					<td class="elementotabla col_nombre" > 
						<?php echo( $reporte_monica->nombre ) ?>
					</td>
				
					<td class="elementotabla col_descripcion" > 
						<?php echo( $reporte_monica->descripcion ) ?>
					</td>
				
					<td class="elementotabla col_estado" > 
						<?php echo( $reporte_monica->estado ) ?>
					</td>
				
					<td class="elementotabla col_modulo" > 
						<?php echo( $reporte_monica->modulo ) ?>
					</td>
				
					<td class="elementotabla col_sub_modulo" > 
						<?php echo( $reporte_monica->sub_modulo ) ?>
					</td>
