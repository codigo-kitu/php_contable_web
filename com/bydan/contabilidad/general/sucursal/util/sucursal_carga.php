...
class sucursal_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/util/sucursal_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/util/sucursalParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/util/sucursal_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/business/entity/sucursal.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/business/entity/sucursalForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/business/data/sucursal_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/business/data/sucursal_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/business/logic/sucursal_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/business/logic/sucursal_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/presentation/session/sucursal_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/presentation/view/sucursal_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!sucursal_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/business/entity/sucursal.php');				
						sucursal_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!sucursal_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/business/data/sucursal_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/business/data/sucursal_data.php');
						sucursal_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!sucursal_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!sucursal_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/business/logic/sucursal_logic.php');
						sucursal_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!sucursal_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/util/sucursal_util.php');
						sucursal_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!sucursal_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/sucursal/presentation/session/sucursal_session.php');
						sucursal_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
