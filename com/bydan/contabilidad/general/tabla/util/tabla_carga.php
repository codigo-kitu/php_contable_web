...
use com\bydan\contabilidad\inventario\costo_producto\util\costo_producto_carga;//1-M,M-M
...
class tabla_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/util/tabla_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/util/tablaParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/util/tabla_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/business/entity/tabla.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/business/entity/tablaForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/business/data/tabla_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/business/data/tabla_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/business/logic/tabla_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/business/logic/tabla_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/presentation/session/tabla_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/presentation/view/tabla_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!tabla_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/business/entity/tabla.php');				
						tabla_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!tabla_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/business/data/tabla_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/business/data/tabla_data.php');
						tabla_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!tabla_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!tabla_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/business/logic/tabla_logic.php');
						tabla_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!tabla_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/util/tabla_util.php');
						tabla_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!tabla_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/tabla/presentation/session/tabla_session.php');
						tabla_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesRelaciones(string $paqueteTipo='LOGIC') {
		...
		costo_producto_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/inventario/costo_producto/presentation/session/costo_producto_session.php');
