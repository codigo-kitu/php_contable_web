...
namespace com\bydan\contabilidad\general\tabla\presentation\session;
...
class tabla_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $tabla_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->tabla_sessionAdditional=new tabla_sessionAdditional();
		*/
