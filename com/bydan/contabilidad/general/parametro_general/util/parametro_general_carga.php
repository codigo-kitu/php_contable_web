...
class parametro_general_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/util/parametro_general_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/util/parametro_generalParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/util/parametro_general_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/business/entity/parametro_general.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/business/entity/parametro_generalForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/business/data/parametro_general_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/business/data/parametro_general_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/business/logic/parametro_general_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/business/logic/parametro_general_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/presentation/session/parametro_general_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/presentation/view/parametro_general_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!parametro_general_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/business/entity/parametro_general.php');				
						parametro_general_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!parametro_general_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/business/data/parametro_general_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/business/data/parametro_general_data.php');
						parametro_general_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!parametro_general_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!parametro_general_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/business/logic/parametro_general_logic.php');
						parametro_general_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!parametro_general_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/util/parametro_general_util.php');
						parametro_general_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!parametro_general_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/parametro_general/presentation/session/parametro_general_session.php');
						parametro_general_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface parametro_general_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
