...
class comentario_documento_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/util/comentario_documento_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/util/comentario_documentoParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/util/comentario_documento_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/business/entity/comentario_documento.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/business/entity/comentario_documentoForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/business/data/comentario_documento_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/business/data/comentario_documento_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/business/logic/comentario_documento_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/business/logic/comentario_documento_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/presentation/session/comentario_documento_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/presentation/view/comentario_documento_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!comentario_documento_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/business/entity/comentario_documento.php');				
						comentario_documento_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!comentario_documento_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/business/data/comentario_documento_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/business/data/comentario_documento_data.php');
						comentario_documento_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!comentario_documento_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!comentario_documento_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/business/logic/comentario_documento_logic.php');
						comentario_documento_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!comentario_documento_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/util/comentario_documento_util.php');
						comentario_documento_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!comentario_documento_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/general/comentario_documento/presentation/session/comentario_documento_session.php');
						comentario_documento_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface comentario_documento_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
