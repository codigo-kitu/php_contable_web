...
class tipo_fondo_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/util/tipo_fondo_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/util/tipo_fondoParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/util/tipo_fondo_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/business/entity/tipo_fondo.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/business/entity/tipo_fondoForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/business/data/tipo_fondo_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/business/data/tipo_fondo_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/business/logic/tipo_fondo_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/business/logic/tipo_fondo_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/presentation/session/tipo_fondo_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/presentation/view/tipo_fondo_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!tipo_fondo_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/business/entity/tipo_fondo.php');				
						tipo_fondo_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!tipo_fondo_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/business/data/tipo_fondo_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/business/data/tipo_fondo_data.php');
						tipo_fondo_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!tipo_fondo_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!tipo_fondo_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/business/logic/tipo_fondo_logic.php');
						tipo_fondo_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!tipo_fondo_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/util/tipo_fondo_util.php');
						tipo_fondo_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!tipo_fondo_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/tipo_fondo/presentation/session/tipo_fondo_session.php');
						tipo_fondo_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
