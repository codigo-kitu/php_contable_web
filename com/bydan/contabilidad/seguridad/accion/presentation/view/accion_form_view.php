...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/seguridad/accion/js/util/accion_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			accion_web::$STR_NOMBRE_PAGINA = 'accion_form_view.php';
			accion_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			accion_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="traccionElementosFormulario">
	<td>
		<div id="divMantenimientoaccionAjaxWebPart" title="ACCION" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoaccion" name="frmMantenimientoaccion">

			</br>

			<?php if(accion_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblaccionToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblaccionToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdaccionActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBaraccion" name="imgActualizarToolBaraccion" title="ACTUALIZAR Accion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdaccionEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBaraccion" name="imgEliminarToolBaraccion" title="ELIMINAR Accion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdaccionCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBaraccion" name="imgCancelarToolBaraccion" title="CANCELAR Accion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdaccionRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosaccion',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblaccionToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblaccionToolBarFormularioExterior -->

			<table id="tblaccionElementos">
			<tr id="traccionElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosaccion" class="elementos" style="width: 300px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: center;">
					<tr id="tr_fila_1">
				...
				</table> <!-- tblElementosaccion -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosaccion" class="elementos" style="display: table-row;">
					<caption class="busquedacabecera">
						<span>Campos Ocultos</span>
					</caption>
				</table> <!-- tblCamposOcultosaccion -->

			</td></tr> <!-- traccionElementos -->
			</table> <!-- tblaccionElementos -->
			</form> <!-- frmMantenimientoaccion -->


			

				<form id="frmAccionesMantenimientoaccion" name="frmAccionesMantenimientoaccion">

			<?php if(accion_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblaccionAcciones" class="elementos" style="text-align: center">
		<tr id="traccionAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoaccion" class="busqueda" style="width: 50%;text-align: center">
						...
						<tr id="trAccionesMantenimientoaccionBasicos">
							<td id="tdbtnNuevoaccion" style="visibility:visible">
								<div id="divNuevoaccion" style="display:table-row">
									<input type="button" id="btnNuevoaccion" name="btnNuevoaccion" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizaraccion" style="visibility:visible">
								<div id="divActualizaraccion" style="display:table-row">
									<input type="button" id="btnActualizaraccion" name="btnActualizaraccion" title="ACTUALIZAR Accion ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminaraccion" style="visibility:visible">
								<div id="divEliminaraccion" style="display:table-row">
									<input type="button" id="btnEliminaraccion" name="btnEliminaraccion" title="ELIMINAR Accion ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimiraccion" style="visibility:visible">
								<input type="button" id="btnImprimiraccion" name="btnImprimiraccion" title="IMPRIMIR PAGINA Accion ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelaraccion" style="visibility:visible">
								<input type="button" id="btnCancelaraccion" name="btnCancelaraccion" title="CANCELAR Accion ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoaccionGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosaccion" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosaccion" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioaccion" name="btnGuardarCambiosFormularioaccion" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoaccion -->
			</td>
		</tr> <!-- traccionAcciones -->
		<?php if(accion_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="traccionParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblaccionParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="traccionFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblaccionParametrosAcciones -->
			</td>
		</tr> <!-- traccionParametrosAcciones -->
		<?php }?>
		<tr id="traccionMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- traccionMensajes -->
			</table> <!-- tblaccionAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoaccion -->
			</div> <!-- divMantenimientoaccionAjaxWebPart -->
		</td>
	</tr> <!-- traccionElementosFormulario/super -->
		<?php if(accion_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {accion_webcontrol,accion_webcontrol1} from './webroot/js/JavaScript/contabilidad/seguridad/accion/js/webcontrol/accion_form_webcontrol.js?random=1';
