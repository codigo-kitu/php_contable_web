			...
			<?php foreach ($provinciasLocal as $provincia) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarprovincia" idactualprovincia="<?php echo($provincia->id) ?>"  funcionjsactualprovincia="'.str_replace('TO_REPLACE',$provincia->id.',\''.provincia_util::getprovinciaDescripcion($provincia).'\'',$this->strFuncionJs).'" title="SELECCIONAR Provincia ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Provincia ACTUAL" value="<?php echo($provincia->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($provincia->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $provincia->updated_at ) ?>
					</td>
				
					<td class="elementotabla col_updated_at"  style="display:none"> 
						<?php echo( $provincia->updated_at ) ?>
					</td>
				<td class="elementotabla col_id_pais" > <?php echo($provincia->id_pais_Descripcion) ?></td>
				
					<td class="elementotabla col_codigo" > 
						<?php echo( $provincia->codigo ) ?>
					</td>
