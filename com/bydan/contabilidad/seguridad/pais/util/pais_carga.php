...
use com\bydan\contabilidad\general\parametro_general\util\parametro_general_carga;//1-M,M-M
...
use com\bydan\contabilidad\general\sucursal\util\sucursal_carga;//1-M,M-M
use com\bydan\contabilidad\seguridad\provincia\util\provincia_carga;//1-M,M-M
use com\bydan\contabilidad\general\empresa\util\empresa_carga;//1-M,M-M
...
class pais_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/util/pais_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/util/paisParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/util/pais_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/business/entity/pais.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/business/entity/paisForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/business/data/pais_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/business/data/pais_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/business/logic/pais_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/business/logic/pais_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/presentation/session/pais_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/presentation/view/pais_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!pais_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/business/entity/pais.php');				
						pais_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!pais_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/business/data/pais_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/business/data/pais_data.php');
						pais_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!pais_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!pais_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/business/logic/pais_logic.php');
						pais_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!pais_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/util/pais_util.php');
						pais_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!pais_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/pais/presentation/session/pais_session.php');
						pais_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesRelaciones(string $paqueteTipo='LOGIC') {
		...
		parametro_general_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/general/parametro_general/presentation/session/parametro_general_session.php');
		...
		include_once('com/bydan/contabilidad/general/sucursal/presentation/session/sucursal_session.php');
		...
		include_once('com/bydan/contabilidad/seguridad/provincia/presentation/session/provincia_session.php');
		...
		include_once('com/bydan/contabilidad/general/empresa/presentation/session/empresa_session.php');
