...
namespace com\bydan\contabilidad\seguridad\sistema\presentation\session;
...
class sistema_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $sistema_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->sistema_sessionAdditional=new sistema_sessionAdditional();
		*/
