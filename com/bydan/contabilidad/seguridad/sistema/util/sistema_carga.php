...
use com\bydan\contabilidad\seguridad\paquete\util\paquete_carga;//1-M,M-M
...
class sistema_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/util/sistema_util.php');			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/util/sistemaParameterGeneral_add.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/util/sistema_param_return_add.php');
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/util/sistemaParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/util/sistema_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/entity/sistema.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/entity/sistemaForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/data/sistema_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/data/sistema_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/logic/sistema_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/logic/sistema_logic.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/logic/sistema_logic_add.php');		
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/presentation/session/sistema_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/presentation/view/sistema_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!sistema_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/entity/sistema.php');				
						sistema_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!sistema_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/data/sistema_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/data/sistema_data.php');
						sistema_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!sistema_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!sistema_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/logic/sistema_logic.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/business/logic/sistemaLogic_add.php');
						sistema_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!sistema_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/util/sistema_util.php');
						sistema_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!sistema_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/sistema/presentation/session/sistema_session.php');
						sistema_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesRelaciones(string $paqueteTipo='LOGIC') {
		...
		paquete_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/seguridad/paquete/presentation/session/paquete_session.php');
		...
		include_once('com/bydan/contabilidad/seguridad/modulo/presentation/session/modulo_session.php');
