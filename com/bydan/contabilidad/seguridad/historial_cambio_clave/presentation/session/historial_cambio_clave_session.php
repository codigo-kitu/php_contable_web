...
namespace com\bydan\contabilidad\seguridad\historial_cambio_clave\presentation\session;
...
class historial_cambio_clave_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $historial_cambio_clave_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->historial_cambio_clave_sessionAdditional=new historial_cambio_clave_sessionAdditional();
		*/
