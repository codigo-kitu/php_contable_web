...
class historial_cambio_clave_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/util/historial_cambio_clave_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/util/historial_cambio_claveParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/util/historial_cambio_clave_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/business/entity/historial_cambio_clave.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/business/entity/historial_cambio_claveForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/business/data/historial_cambio_clave_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/business/data/historial_cambio_clave_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/business/logic/historial_cambio_clave_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/business/logic/historial_cambio_clave_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/presentation/session/historial_cambio_clave_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/presentation/view/historial_cambio_clave_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!historial_cambio_clave_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/business/entity/historial_cambio_clave.php');				
						historial_cambio_clave_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!historial_cambio_clave_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/business/data/historial_cambio_clave_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/business/data/historial_cambio_clave_data.php');
						historial_cambio_clave_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!historial_cambio_clave_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!historial_cambio_clave_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/business/logic/historial_cambio_clave_logic.php');
						historial_cambio_clave_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!historial_cambio_clave_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/util/historial_cambio_clave_util.php');
						historial_cambio_clave_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!historial_cambio_clave_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/historial_cambio_clave/presentation/session/historial_cambio_clave_session.php');
						historial_cambio_clave_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface historial_cambio_clave_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
