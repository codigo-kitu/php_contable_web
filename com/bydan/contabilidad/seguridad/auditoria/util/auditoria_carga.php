...
use com\bydan\contabilidad\seguridad\auditoria_detalle\util\auditoria_detalle_carga;//1-M,M-M
...
class auditoria_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/util/auditoria_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/util/auditoriaParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/util/auditoria_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/business/entity/auditoria.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/business/entity/auditoriaForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/business/data/auditoria_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/business/data/auditoria_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/business/logic/auditoria_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/business/logic/auditoria_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/presentation/session/auditoria_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/presentation/view/auditoria_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!auditoria_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/business/entity/auditoria.php');				
						auditoria_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!auditoria_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/business/data/auditoria_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/business/data/auditoria_data.php');
						auditoria_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!auditoria_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!auditoria_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/business/logic/auditoria_logic.php');
						auditoria_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!auditoria_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/util/auditoria_util.php');
						auditoria_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!auditoria_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/seguridad/auditoria/presentation/session/auditoria_session.php');
						auditoria_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesRelaciones(string $paqueteTipo='LOGIC') {
		...
		auditoria_detalle_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/seguridad/auditoria_detalle/presentation/session/auditoria_detalle_session.php');
