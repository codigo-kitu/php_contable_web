...
namespace com\bydan\contabilidad\seguridad\grupo_opcion\presentation\session;
...
class grupo_opcion_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $grupo_opcion_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->grupo_opcion_sessionAdditional=new grupo_opcion_sessionAdditional();
		*/
