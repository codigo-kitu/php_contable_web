...
namespace com\bydan\contabilidad\seguridad\perfil\presentation\session;
...
class perfil_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $perfil_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->perfil_sessionAdditional=new perfil_sessionAdditional();
		*/
