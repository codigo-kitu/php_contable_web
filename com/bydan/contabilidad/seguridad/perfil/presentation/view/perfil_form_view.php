...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/seguridad/perfil/js/util/perfil_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			perfil_web::$STR_NOMBRE_PAGINA = 'perfil_form_view.php';
			perfil_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			perfil_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trperfilElementosFormulario">
	<td>
		<div id="divMantenimientoperfilAjaxWebPart" title="PERFIL" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoperfil" name="frmMantenimientoperfil">

			</br>

			<?php if(perfil_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblperfilToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblperfilToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdperfilActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarperfil" name="imgActualizarToolBarperfil" title="ACTUALIZAR Perfil ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdperfilEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarperfil" name="imgEliminarToolBarperfil" title="ELIMINAR Perfil ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdperfilCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarperfil" name="imgCancelarToolBarperfil" title="CANCELAR Perfil ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdperfilRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosperfil',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblperfilToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblperfilToolBarFormularioExterior -->

			<table id="tblperfilElementos">
			<tr id="trperfilElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosperfil" class="elementos" style="width: 300px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: center;">
					<tr id="tr_fila_1">
					...
					<tr id="tr_fila_7">
						<td id="td_title-nombre2" class="titulocampo">
							<label class="form-label">Nombre Alterno.(*)</label>
						</td>
						<td id="td_control-nombre2" align="left" class="controlcampo">
							<textarea id="form-nombre2" name="form-nombre2" class="form-control"  placeholder="Nombre Alterno"  title="Nombre Alterno"   style="font-size: 13px;"  rows ="3" cols= "25"></textarea>
				...
				</table> <!-- tblElementosperfil -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosperfil" class="elementos" style="display: table-row;">
					<caption class="busquedacabecera">
						<span>Campos Ocultos</span>
					</caption>
				</table> <!-- tblCamposOcultosperfil -->

			</td></tr> <!-- trperfilElementos -->
			</table> <!-- tblperfilElementos -->
			</form> <!-- frmMantenimientoperfil -->


			

				<form id="frmAccionesMantenimientoperfil" name="frmAccionesMantenimientoperfil">

			<?php if(perfil_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblperfilAcciones" class="elementos" style="text-align: center">
		<tr id="trperfilAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoperfil" class="busqueda" style="width: 50%;text-align: center">
						...
						<tr id="trAccionesMantenimientoperfilBasicos">
							<td id="tdbtnNuevoperfil" style="visibility:visible">
								<div id="divNuevoperfil" style="display:table-row">
									<input type="button" id="btnNuevoperfil" name="btnNuevoperfil" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarperfil" style="visibility:visible">
								<div id="divActualizarperfil" style="display:table-row">
									<input type="button" id="btnActualizarperfil" name="btnActualizarperfil" title="ACTUALIZAR Perfil ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarperfil" style="visibility:visible">
								<div id="divEliminarperfil" style="display:table-row">
									<input type="button" id="btnEliminarperfil" name="btnEliminarperfil" title="ELIMINAR Perfil ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirperfil" style="visibility:visible">
								<input type="button" id="btnImprimirperfil" name="btnImprimirperfil" title="IMPRIMIR PAGINA Perfil ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarperfil" style="visibility:visible">
								<input type="button" id="btnCancelarperfil" name="btnCancelarperfil" title="CANCELAR Perfil ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoperfilGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosperfil" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosperfil" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioperfil" name="btnGuardarCambiosFormularioperfil" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoperfil -->
			</td>
		</tr> <!-- trperfilAcciones -->
		<?php if(perfil_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trperfilParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblperfilParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trperfilFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblperfilParametrosAcciones -->
			</td>
		</tr> <!-- trperfilParametrosAcciones -->
		<?php }?>
		<tr id="trperfilMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trperfilMensajes -->
			</table> <!-- tblperfilAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoperfil -->
			</div> <!-- divMantenimientoperfilAjaxWebPart -->
		</td>
	</tr> <!-- trperfilElementosFormulario/super -->
		<?php if(perfil_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {perfil_webcontrol,perfil_webcontrol1} from './webroot/js/JavaScript/contabilidad/seguridad/perfil/js/webcontrol/perfil_form_webcontrol.js?random=1';
