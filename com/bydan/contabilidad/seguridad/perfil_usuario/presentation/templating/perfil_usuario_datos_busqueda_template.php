			...
			<?php foreach ($perfil_usuariosLocal as $perfil_usuario) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarperfil_usuario" idactualperfil_usuario="<?php echo($perfil_usuario->id) ?>"  funcionjsactualperfil_usuario="'.str_replace('TO_REPLACE',$perfil_usuario->id.',\''.perfil_usuario_util::getperfil_usuarioDescripcion($perfil_usuario).'\'',$this->strFuncionJs).'" title="SELECCIONAR Usuarios Perfiles  ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Usuarios Perfiles  ACTUAL" value="<?php echo($perfil_usuario->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($perfil_usuario->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $perfil_usuario->updated_at ) ?>
					</td>
				
					<td class="elementotabla col_updated_at"  style="display:none"> 
						<?php echo( $perfil_usuario->updated_at ) ?>
					</td>
				<td class="elementotabla col_id_perfil" > <?php echo($perfil_usuario->id_perfil_Descripcion) ?></td>
				<?php if($IS_DEVELOPING) { ?>
				<td> <?php echo($perfil_usuario->id_usuario_Descripcion) ?></td>
				<?php } ?>
				
					<td class="elementotabla col_estado" ><?php  $funciones->getCheckBox($perfil_usuario->estado,'form<?php echo($strSufijo) ?>-estadoi',$paraReporte)  ?>
					</td>
