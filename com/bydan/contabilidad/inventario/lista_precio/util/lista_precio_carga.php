...
class lista_precio_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/util/lista_precio_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/util/lista_precioParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/util/lista_precio_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/business/entity/lista_precio.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/business/entity/lista_precioForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/business/data/lista_precio_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/business/data/lista_precio_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/business/logic/lista_precio_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/business/logic/lista_precio_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/presentation/session/lista_precio_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/presentation/view/lista_precio_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!lista_precio_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/business/entity/lista_precio.php');				
						lista_precio_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!lista_precio_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/business/data/lista_precio_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/business/data/lista_precio_data.php');
						lista_precio_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!lista_precio_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!lista_precio_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/business/logic/lista_precio_logic.php');
						lista_precio_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!lista_precio_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/util/lista_precio_util.php');
						lista_precio_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!lista_precio_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_precio/presentation/session/lista_precio_session.php');
						lista_precio_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
