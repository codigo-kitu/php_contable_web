...
namespace com\bydan\contabilidad\inventario\lista_cliente\presentation\session;
...
class lista_cliente_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $lista_cliente_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->lista_cliente_sessionAdditional=new lista_cliente_sessionAdditional();
		*/
