			...
			<?php foreach ($lista_clientesLocal as $lista_cliente) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarlista_cliente" idactuallista_cliente="<?php echo($lista_cliente->id) ?>"  funcionjsactuallista_cliente="'.str_replace('TO_REPLACE',$lista_cliente->id.',\''.lista_cliente_util::getlista_clienteDescripcion($lista_cliente).'\'',$this->strFuncionJs).'" title="SELECCIONAR Lista Cliente ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Lista Cliente ACTUAL" value="<?php echo($lista_cliente->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($lista_cliente->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $lista_cliente->updated_at ) ?>
					</td>
				
					<td class="elementotabla col_updated_at"  style="display:none"> 
						<?php echo( $lista_cliente->updated_at ) ?>
					</td>
				<td class="elementotabla col_id_cliente" > <?php echo($lista_cliente->id_cliente_Descripcion) ?></td>
				<td class="elementotabla col_id_producto" > <?php echo($lista_cliente->id_producto_Descripcion) ?></td>
				
					<td class="elementotabla col_precio" > 
						<?php echo( $lista_cliente->precio ) ?>
					</td>
