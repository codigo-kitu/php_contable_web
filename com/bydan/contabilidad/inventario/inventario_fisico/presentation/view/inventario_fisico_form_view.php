...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/inventario/inventario_fisico/js/util/inventario_fisico_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			inventario_fisico_web::$STR_NOMBRE_PAGINA = 'inventario_fisico_form_view.php';
			inventario_fisico_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			inventario_fisico_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trinventario_fisicoElementosFormulario">
	<td>
		<div id="divMantenimientoinventario_fisicoAjaxWebPart" title="INVENTARIO FISICO" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoinventario_fisico" name="frmMantenimientoinventario_fisico">

			</br>

			<?php if(inventario_fisico_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblinventario_fisicoToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblinventario_fisicoToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdinventario_fisicoActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarinventario_fisico" name="imgActualizarToolBarinventario_fisico" title="ACTUALIZAR Inventario Fisico ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdinventario_fisicoEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarinventario_fisico" name="imgEliminarToolBarinventario_fisico" title="ELIMINAR Inventario Fisico ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdinventario_fisicoCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarinventario_fisico" name="imgCancelarToolBarinventario_fisico" title="CANCELAR Inventario Fisico ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdinventario_fisicoRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosinventario_fisico',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblinventario_fisicoToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblinventario_fisicoToolBarFormularioExterior -->

			<table id="tblinventario_fisicoElementos">
			<tr id="trinventario_fisicoElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosinventario_fisico" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					<tr id="tr_fila_1">
					...
					<tr id="tr_fila_8">
						<td id="td_title-id_almacen" class="titulocampo">
							<label class="form-label">Id Almacen.(*)</label>
						</td>
						<td id="td_control-id_almacen" align="left" class="controlcampo">
							<input id="form-id_almacen" name="form-id_almacen" type="text" class="form-control"  placeholder="Id Almacen"  title="Id Almacen"    maxlength="19" size="10" >
							<span id="spanstrMensajeid_almacen" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_9">
						<td id="td_title-prod_cont_almacen" class="titulocampo">
							<label class="form-label">Prod Cont Almacen.(*)</label>
						</td>
						<td id="td_control-prod_cont_almacen" align="left" class="controlcampo">
							<input id="form-prod_cont_almacen" name="form-prod_cont_almacen" type="text" class="form-control"  placeholder="Prod Cont Almacen"  title="Prod Cont Almacen"    maxlength="18" size="12" >
							<span id="spanstrMensajeprod_cont_almacen" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_10">
						<td id="td_title-total_productos_almacen" class="titulocampo">
							<label class="form-label">Total Productos Almacen.(*)</label>
						</td>
						<td id="td_control-total_productos_almacen" align="left" class="controlcampo">
							<input id="form-total_productos_almacen" name="form-total_productos_almacen" type="text" class="form-control"  placeholder="Total Productos Almacen"  title="Total Productos Almacen"    maxlength="18" size="12" >
				...
				</table> <!-- tblElementosinventario_fisico -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosinventario_fisico" class="elementos" style="display: table-row;">
					<caption class="busquedacabecera">
						<span>Campos Ocultos</span>
					</caption>
				</table> <!-- tblCamposOcultosinventario_fisico -->

			</td></tr> <!-- trinventario_fisicoElementos -->
			</table> <!-- tblinventario_fisicoElementos -->
			</form> <!-- frmMantenimientoinventario_fisico -->


			

				<form id="frmAccionesMantenimientoinventario_fisico" name="frmAccionesMantenimientoinventario_fisico">

			<?php if(inventario_fisico_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblinventario_fisicoAcciones" class="elementos" style="text-align: center">
		<tr id="trinventario_fisicoAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoinventario_fisico" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientoinventario_fisicoBasicos">
							<td id="tdbtnNuevoinventario_fisico" style="visibility:visible">
								<div id="divNuevoinventario_fisico" style="display:table-row">
									<input type="button" id="btnNuevoinventario_fisico" name="btnNuevoinventario_fisico" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarinventario_fisico" style="visibility:visible">
								<div id="divActualizarinventario_fisico" style="display:table-row">
									<input type="button" id="btnActualizarinventario_fisico" name="btnActualizarinventario_fisico" title="ACTUALIZAR Inventario Fisico ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarinventario_fisico" style="visibility:visible">
								<div id="divEliminarinventario_fisico" style="display:table-row">
									<input type="button" id="btnEliminarinventario_fisico" name="btnEliminarinventario_fisico" title="ELIMINAR Inventario Fisico ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirinventario_fisico" style="visibility:visible">
								<input type="button" id="btnImprimirinventario_fisico" name="btnImprimirinventario_fisico" title="IMPRIMIR PAGINA Inventario Fisico ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarinventario_fisico" style="visibility:visible">
								<input type="button" id="btnCancelarinventario_fisico" name="btnCancelarinventario_fisico" title="CANCELAR Inventario Fisico ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoinventario_fisicoGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosinventario_fisico" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosinventario_fisico" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioinventario_fisico" name="btnGuardarCambiosFormularioinventario_fisico" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoinventario_fisico -->
			</td>
		</tr> <!-- trinventario_fisicoAcciones -->
		<?php if(inventario_fisico_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trinventario_fisicoParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblinventario_fisicoParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trinventario_fisicoFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblinventario_fisicoParametrosAcciones -->
			</td>
		</tr> <!-- trinventario_fisicoParametrosAcciones -->
		<?php }?>
		<tr id="trinventario_fisicoMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trinventario_fisicoMensajes -->
			</table> <!-- tblinventario_fisicoAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoinventario_fisico -->
			</div> <!-- divMantenimientoinventario_fisicoAjaxWebPart -->
		</td>
	</tr> <!-- trinventario_fisicoElementosFormulario/super -->
		<?php if(inventario_fisico_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {inventario_fisico_webcontrol,inventario_fisico_webcontrol1} from './webroot/js/JavaScript/contabilidad/inventario/inventario_fisico/js/webcontrol/inventario_fisico_form_webcontrol.js?random=1';
