...
namespace com\bydan\contabilidad\inventario\inventario_fisico\presentation\session;
...
class inventario_fisico_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $inventario_fisico_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->inventario_fisico_sessionAdditional=new inventario_fisico_sessionAdditional();
		*/
