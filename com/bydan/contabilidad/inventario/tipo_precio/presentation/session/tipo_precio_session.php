...
namespace com\bydan\contabilidad\inventario\tipo_precio\presentation\session;
...
class tipo_precio_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $tipo_precio_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->tipo_precio_sessionAdditional=new tipo_precio_sessionAdditional();
		*/
