...
class tipo_kardex_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/util/tipo_kardex_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/util/tipo_kardexParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/util/tipo_kardex_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/entity/tipo_kardex.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/entity/tipo_kardexForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/data/tipo_kardex_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/data/tipo_kardex_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/logic/tipo_kardex_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/logic/tipo_kardex_logic.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/logic/tipo_kardex_logic_add.php');		
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/presentation/session/tipo_kardex_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/presentation/view/tipo_kardex_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!tipo_kardex_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/entity/tipo_kardex.php');				
						tipo_kardex_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!tipo_kardex_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/data/tipo_kardex_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/data/tipo_kardex_data.php');
						tipo_kardex_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!tipo_kardex_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!tipo_kardex_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/logic/tipo_kardex_logic.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/business/logic/tipo_kardexLogic_add.php');
						tipo_kardex_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!tipo_kardex_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/util/tipo_kardex_util.php');
						tipo_kardex_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!tipo_kardex_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_kardex/presentation/session/tipo_kardex_session.php');
						tipo_kardex_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
