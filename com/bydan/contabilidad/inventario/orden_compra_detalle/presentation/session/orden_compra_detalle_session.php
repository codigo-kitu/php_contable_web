...
namespace com\bydan\contabilidad\inventario\orden_compra_detalle\presentation\session;
...
class orden_compra_detalle_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $orden_compra_detalle_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->orden_compra_detalle_sessionAdditional=new orden_compra_detalle_sessionAdditional();
		*/
