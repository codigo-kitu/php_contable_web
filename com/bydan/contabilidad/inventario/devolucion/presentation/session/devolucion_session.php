...
namespace com\bydan\contabilidad\inventario\devolucion\presentation\session;
...
class devolucion_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $devolucion_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->devolucion_sessionAdditional=new devolucion_sessionAdditional();
		*/
