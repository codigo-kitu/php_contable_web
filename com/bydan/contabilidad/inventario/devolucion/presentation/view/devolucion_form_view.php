...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/inventario/devolucion/js/util/devolucion_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			devolucion_web::$STR_NOMBRE_PAGINA = 'devolucion_form_view.php';
			devolucion_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			devolucion_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trdevolucionElementosFormulario">
	<td>
		<div id="divMantenimientodevolucionAjaxWebPart" title="DEVOLUCION" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientodevolucion" name="frmMantenimientodevolucion">

			</br>

			<?php if(devolucion_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tbldevolucionToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tbldevolucionToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tddevolucionActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBardevolucion" name="imgActualizarToolBardevolucion" title="ACTUALIZAR Devolucion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tddevolucionEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBardevolucion" name="imgEliminarToolBardevolucion" title="ELIMINAR Devolucion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tddevolucionCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBardevolucion" name="imgCancelarToolBardevolucion" title="CANCELAR Devolucion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tddevolucionRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosdevolucion',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tbldevolucionToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tbldevolucionToolBarFormularioExterior -->

			<table id="tbldevolucionElementos">
			<tr id="trdevolucionElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosdevolucion" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					...
					<?php if(true || devolucion_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="8"><span><img id="imgMostrarOcultardevolucionprincipal" name="imgMostrarOcultardevolucionprincipal" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trdevolucionprincipalElementos',this,'../')"/>PRINCIPAL</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trdevolucionprincipalElementos">
						<td id="tddevolucionprincipalElementos"  colspan="8">
				<table class="elementos" style="width:800px;text-align:left; padding: 0px; border-spacing: 0px; border-collapse: collapse;">
					...
					<tr id="tr_fila_5">
						...
						<td id="td_title-envia" class="titulocampo">
							<label class="form-label">Envia</label>
						</td>
						<td id="td_control-envia" align="left" class="controlcampo">
							<textarea id="form-envia" name="form-envia" class="form-control"  placeholder="Envia"  title="Envia"   style="font-size: 13px;" rows="2" cols="25" size="20" ></textarea>
						...
						<td id="td_control-observacion" align="left" class="controlcampo">
							<textarea id="form-observacion" name="form-observacion" class="form-control"  placeholder="Observacion"  title="Observacion"   style="font-size: 13px;" rows="2" cols="25" size="20" ></textarea>
				...
				</table> <!-- tblElementosdevolucion -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosdevolucion" class="elementos" style="display: table-row;">
					...
					<tr id="tr_fila_2">
						...
						<td id="td_control-factura_proveedor" align="left" class="controlcampo">
							<input id="form-factura_proveedor" name="form-factura_proveedor" type="text" class="form-control"  placeholder="Nro Factura Proveedor"  title="Nro Factura Proveedor"    size="20"  maxlength="30"/>
							<span id="spanstrMensajefactura_proveedor" class="mensajeerror"></span>
						</td>
					
					
						<td id="td_title-pago" class="titulocampo">
							<label class="form-label">Pago.(*)</label>
						</td>
						<td id="td_control-pago" align="left" class="controlcampo">
							<input id="form-pago" name="form-pago" type="text" class="form-control"  placeholder="Pago"  title="Pago"    maxlength="18" size="12" >
							<span id="spanstrMensajepago" class="mensajeerror"></span>
						</td>
					</tr>
					<tr id="tr_fila_3">
						...
						<td id="td_title-id_documento_cuenta_pagar" class="titulocampo">
							<label class="form-label">Docs Cp</label>
						</td>
						<td id="td_control-id_documento_cuenta_pagar" align="left" class="controlcombo">
							
							<table align="left" cellspacing="0" cellpadding="0" border="0">
								<tr>
									<td><select id="form-id_documento_cuenta_pagar" name="form-id_documento_cuenta_pagar" title="Docs Cp" ></select></td>
					...
					<td></td><td></td></tr>
				</table> <!-- tblCamposOcultosdevolucion -->

			</td></tr> <!-- trdevolucionElementos -->
			</table> <!-- tbldevolucionElementos -->
			</form> <!-- frmMantenimientodevolucion -->

			<?php
			if(devolucion_web::$STR_ES_RELACIONES=="true") {
				...
				echo('<div id="tabs_general" class="tabs" style="width: 100%">');
					echo('<ul>');
						echo('<li class="titulotab"><a href="#divdevolucion_detalles">Devolucion Detalles</a></li>');
					echo('</ul>');

					echo('<div id="divdevolucion_detalles">');
					require_once('com/bydan/contabilidad/inventario/presentation/view/devolucion_detalle_view.php');
					echo('</div>');
			...
			?>
			<form id="frmMantenimientoTotalesdevolucion" name="frmMantenimientoTotalesdevolucion">
				<table>
					...
					<?php if(true || devolucion_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="8"><span><img id="imgMostrarOcultardevoluciontotales" name="imgMostrarOcultardevoluciontotales" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trdevoluciontotalesElementos',this,'../')"/>TOTALES</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trdevoluciontotalesElementos">
						<td id="tddevoluciontotalesElementos"  colspan="8">
				...
				<form id="frmAccionesMantenimientodevolucion" name="frmAccionesMantenimientodevolucion">

			<?php if(devolucion_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tbldevolucionAcciones" class="elementos" style="text-align: center">
		<tr id="trdevolucionAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientodevolucion" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientodevolucionBasicos">
							<td id="tdbtnNuevodevolucion" style="visibility:visible">
								<div id="divNuevodevolucion" style="display:table-row">
									<input type="button" id="btnNuevodevolucion" name="btnNuevodevolucion" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizardevolucion" style="visibility:visible">
								<div id="divActualizardevolucion" style="display:table-row">
									<input type="button" id="btnActualizardevolucion" name="btnActualizardevolucion" title="ACTUALIZAR Devolucion ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminardevolucion" style="visibility:visible">
								<div id="divEliminardevolucion" style="display:table-row">
									<input type="button" id="btnEliminardevolucion" name="btnEliminardevolucion" title="ELIMINAR Devolucion ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirdevolucion" style="visibility:visible">
								<input type="button" id="btnImprimirdevolucion" name="btnImprimirdevolucion" title="IMPRIMIR PAGINA Devolucion ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelardevolucion" style="visibility:visible">
								<input type="button" id="btnCancelardevolucion" name="btnCancelardevolucion" title="CANCELAR Devolucion ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientodevolucionGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosdevolucion" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosdevolucion" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariodevolucion" name="btnGuardarCambiosFormulariodevolucion" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientodevolucion -->
			</td>
		</tr> <!-- trdevolucionAcciones -->
		<?php if(devolucion_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trdevolucionParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tbldevolucionParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trdevolucionFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tbldevolucionParametrosAcciones -->
			</td>
		</tr> <!-- trdevolucionParametrosAcciones -->
		<?php }?>
		<tr id="trdevolucionMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trdevolucionMensajes -->
			</table> <!-- tbldevolucionAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientodevolucion -->
			</div> <!-- divMantenimientodevolucionAjaxWebPart -->
		</td>
	</tr> <!-- trdevolucionElementosFormulario/super -->
		<?php if(devolucion_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {devolucion_webcontrol,devolucion_webcontrol1} from './webroot/js/JavaScript/contabilidad/inventario/devolucion/js/webcontrol/devolucion_form_webcontrol.js?random=1';
