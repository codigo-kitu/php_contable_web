			...
			<?php foreach ($imagen_kardexsLocal as $imagen_kardex) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarimagen_kardex" idactualimagen_kardex="<?php echo($imagen_kardex->id) ?>"  funcionjsactualimagen_kardex="'.str_replace('TO_REPLACE',$imagen_kardex->id.',\''.imagen_kardex_util::getimagen_kardexDescripcion($imagen_kardex).'\'',$this->strFuncionJs).'" title="SELECCIONAR Imagenes Kardex ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Imagenes Kardex ACTUAL" value="<?php echo($imagen_kardex->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($imagen_kardex->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $imagen_kardex->updated_at ) ?>
					</td>
					...
					<td class="elementotabla col_nro_documento" > 
						<?php echo( $imagen_kardex->nro_documento ) ?>
					</td>
				
					<td class="elementotabla col_imagen" > 
						<?php echo( $imagen_kardex->imagen ) ?>
					</td>
