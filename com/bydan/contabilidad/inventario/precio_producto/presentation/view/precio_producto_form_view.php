...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/inventario/precio_producto/js/util/precio_producto_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			precio_producto_web::$STR_NOMBRE_PAGINA = 'precio_producto_form_view.php';
			precio_producto_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			precio_producto_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trprecio_productoElementosFormulario">
	<td>
		<div id="divMantenimientoprecio_productoAjaxWebPart" title="PRECIO PRODUCTO" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoprecio_producto" name="frmMantenimientoprecio_producto">

			</br>

			<?php if(precio_producto_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblprecio_productoToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblprecio_productoToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdprecio_productoActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarprecio_producto" name="imgActualizarToolBarprecio_producto" title="ACTUALIZAR Precio Producto ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdprecio_productoEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarprecio_producto" name="imgEliminarToolBarprecio_producto" title="ELIMINAR Precio Producto ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdprecio_productoCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarprecio_producto" name="imgCancelarToolBarprecio_producto" title="CANCELAR Precio Producto ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdprecio_productoRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosprecio_producto',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblprecio_productoToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblprecio_productoToolBarFormularioExterior -->

			<table id="tblprecio_productoElementos">
			<tr id="trprecio_productoElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosprecio_producto" class="elementos" style="width: 350px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: center;">
					<tr id="tr_fila_1">
					...
					<tr id="tr_fila_8">
						...
						<td id="td_control-descuento_porciento" align="left" class="controlcampo">
							<input id="form-descuento_porciento" name="form-descuento_porciento" type="text" class="form-control"  placeholder="% Desc"  title="% Desc"    maxlength="18" size="12" >
							<span id="spanstrMensajedescuento_porciento" class="mensajeerror"></span>
						</td>
					</tr>
				</table> <!-- tblElementosprecio_producto -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosprecio_producto" class="elementos" style="display: table-row;">
				...
				</table> <!-- tblCamposOcultosprecio_producto -->

			</td></tr> <!-- trprecio_productoElementos -->
			</table> <!-- tblprecio_productoElementos -->
			</form> <!-- frmMantenimientoprecio_producto -->


			

				<form id="frmAccionesMantenimientoprecio_producto" name="frmAccionesMantenimientoprecio_producto">

			<?php if(precio_producto_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblprecio_productoAcciones" class="elementos" style="text-align: center">
		<tr id="trprecio_productoAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoprecio_producto" class="busqueda" style="width: 50%;text-align: center">
						...
						<tr id="trAccionesMantenimientoprecio_productoBasicos">
							<td id="tdbtnNuevoprecio_producto" style="visibility:visible">
								<div id="divNuevoprecio_producto" style="display:table-row">
									<input type="button" id="btnNuevoprecio_producto" name="btnNuevoprecio_producto" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarprecio_producto" style="visibility:visible">
								<div id="divActualizarprecio_producto" style="display:table-row">
									<input type="button" id="btnActualizarprecio_producto" name="btnActualizarprecio_producto" title="ACTUALIZAR Precio Producto ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarprecio_producto" style="visibility:visible">
								<div id="divEliminarprecio_producto" style="display:table-row">
									<input type="button" id="btnEliminarprecio_producto" name="btnEliminarprecio_producto" title="ELIMINAR Precio Producto ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirprecio_producto" style="visibility:visible">
								<input type="button" id="btnImprimirprecio_producto" name="btnImprimirprecio_producto" title="IMPRIMIR PAGINA Precio Producto ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarprecio_producto" style="visibility:visible">
								<input type="button" id="btnCancelarprecio_producto" name="btnCancelarprecio_producto" title="CANCELAR Precio Producto ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoprecio_productoGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosprecio_producto" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosprecio_producto" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioprecio_producto" name="btnGuardarCambiosFormularioprecio_producto" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoprecio_producto -->
			</td>
		</tr> <!-- trprecio_productoAcciones -->
		<?php if(precio_producto_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trprecio_productoParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblprecio_productoParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trprecio_productoFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblprecio_productoParametrosAcciones -->
			</td>
		</tr> <!-- trprecio_productoParametrosAcciones -->
		<?php }?>
		<tr id="trprecio_productoMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trprecio_productoMensajes -->
			</table> <!-- tblprecio_productoAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoprecio_producto -->
			</div> <!-- divMantenimientoprecio_productoAjaxWebPart -->
		</td>
	</tr> <!-- trprecio_productoElementosFormulario/super -->
		<?php if(precio_producto_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {precio_producto_webcontrol,precio_producto_webcontrol1} from './webroot/js/JavaScript/contabilidad/inventario/precio_producto/js/webcontrol/precio_producto_form_webcontrol.js?random=1';
