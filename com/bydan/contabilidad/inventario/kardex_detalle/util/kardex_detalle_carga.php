...
class kardex_detalle_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/util/kardex_detalle_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/util/kardex_detalleParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/util/kardex_detalle_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/entity/kardex_detalle.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/entity/kardex_detalleForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/data/kardex_detalle_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/data/kardex_detalle_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/logic/kardex_detalle_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/logic/kardex_detalle_logic.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/logic/kardex_detalle_logic_add.php');		
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/presentation/session/kardex_detalle_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/presentation/view/kardex_detalle_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!kardex_detalle_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/entity/kardex_detalle.php');				
						kardex_detalle_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!kardex_detalle_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/data/kardex_detalle_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/data/kardex_detalle_data.php');
						kardex_detalle_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!kardex_detalle_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!kardex_detalle_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/logic/kardex_detalle_logic.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/business/logic/kardex_detalleLogic_add.php');
						kardex_detalle_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!kardex_detalle_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/util/kardex_detalle_util.php');
						kardex_detalle_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!kardex_detalle_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex_detalle/presentation/session/kardex_detalle_session.php');
						kardex_detalle_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC') {
		...
		lote_producto_carga::cargarArchivosPaquetesBase($paqueteTipo);
	...
	/*
	interface kardex_detalle_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
