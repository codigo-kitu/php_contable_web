...
namespace com\bydan\contabilidad\inventario\imagen_producto\presentation\session;
...
class imagen_producto_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $imagen_producto_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->imagen_producto_sessionAdditional=new imagen_producto_sessionAdditional();
		*/
