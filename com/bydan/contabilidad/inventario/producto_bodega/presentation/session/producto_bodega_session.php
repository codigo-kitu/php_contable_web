...
namespace com\bydan\contabilidad\inventario\producto_bodega\presentation\session;
...
class producto_bodega_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $producto_bodega_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->producto_bodega_sessionAdditional=new producto_bodega_sessionAdditional();
		*/
