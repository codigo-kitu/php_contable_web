...
use com\bydan\contabilidad\inventario\kardex_detalle\util\kardex_detalle_carga;//1-M,M-M
...
class kardex_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/util/kardex_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/util/kardexParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/util/kardex_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/entity/kardex.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/entity/kardexForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/data/kardex_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/data/kardex_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/logic/kardex_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/logic/kardex_logic.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/logic/kardex_logic_add.php');		
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/presentation/session/kardex_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/presentation/view/kardex_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!kardex_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/entity/kardex.php');				
						kardex_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!kardex_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/data/kardex_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/data/kardex_data.php');
						kardex_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!kardex_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!kardex_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/logic/kardex_logic.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/business/logic/kardexLogic_add.php');
						kardex_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!kardex_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/util/kardex_util.php');
						kardex_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!kardex_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kardex/presentation/session/kardex_session.php');
						kardex_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesRelaciones(string $paqueteTipo='LOGIC') {
		...
		kardex_detalle_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/inventario/kardex_detalle/presentation/session/kardex_detalle_session.php');
