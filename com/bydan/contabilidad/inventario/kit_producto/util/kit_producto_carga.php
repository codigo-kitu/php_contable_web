...
class kit_producto_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/util/kit_producto_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/util/kit_productoParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/util/kit_producto_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/business/entity/kit_producto.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/business/entity/kit_productoForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/business/data/kit_producto_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/business/data/kit_producto_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/business/logic/kit_producto_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/business/logic/kit_producto_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/presentation/session/kit_producto_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/presentation/view/kit_producto_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!kit_producto_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/business/entity/kit_producto.php');				
						kit_producto_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!kit_producto_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/business/data/kit_producto_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/business/data/kit_producto_data.php');
						kit_producto_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!kit_producto_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!kit_producto_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/business/logic/kit_producto_logic.php');
						kit_producto_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!kit_producto_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/util/kit_producto_util.php');
						kit_producto_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!kit_producto_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/kit_producto/presentation/session/kit_producto_session.php');
						kit_producto_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
