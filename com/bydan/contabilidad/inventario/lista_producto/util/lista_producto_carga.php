...
class lista_producto_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/util/lista_producto_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/util/lista_productoParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/util/lista_producto_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/business/entity/lista_producto.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/business/entity/lista_productoForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/business/data/lista_producto_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/business/data/lista_producto_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/business/logic/lista_producto_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/business/logic/lista_producto_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/presentation/session/lista_producto_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/presentation/view/lista_producto_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!lista_producto_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/business/entity/lista_producto.php');				
						lista_producto_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!lista_producto_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/business/data/lista_producto_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/business/data/lista_producto_data.php');
						lista_producto_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!lista_producto_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!lista_producto_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/business/logic/lista_producto_logic.php');
						lista_producto_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!lista_producto_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/util/lista_producto_util.php');
						lista_producto_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!lista_producto_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/lista_producto/presentation/session/lista_producto_session.php');
						lista_producto_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface lista_producto_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
