...
class imagen_orden_compra_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/util/imagen_orden_compra_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/util/imagen_orden_compraParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/util/imagen_orden_compra_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/business/entity/imagen_orden_compra.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/business/entity/imagen_orden_compraForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/business/data/imagen_orden_compra_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/business/data/imagen_orden_compra_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/business/logic/imagen_orden_compra_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/business/logic/imagen_orden_compra_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/presentation/session/imagen_orden_compra_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/presentation/view/imagen_orden_compra_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!imagen_orden_compra_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/business/entity/imagen_orden_compra.php');				
						imagen_orden_compra_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!imagen_orden_compra_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/business/data/imagen_orden_compra_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/business/data/imagen_orden_compra_data.php');
						imagen_orden_compra_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!imagen_orden_compra_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!imagen_orden_compra_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/business/logic/imagen_orden_compra_logic.php');
						imagen_orden_compra_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!imagen_orden_compra_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/util/imagen_orden_compra_util.php');
						imagen_orden_compra_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!imagen_orden_compra_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_orden_compra/presentation/session/imagen_orden_compra_session.php');
						imagen_orden_compra_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface imagen_orden_compra_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
