...
namespace com\bydan\contabilidad\inventario\lote_producto\presentation\session;
...
class lote_producto_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $lote_producto_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->lote_producto_sessionAdditional=new lote_producto_sessionAdditional();
		*/
