...
class imagen_cotizacion_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/util/imagen_cotizacion_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/util/imagen_cotizacionParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/util/imagen_cotizacion_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/business/entity/imagen_cotizacion.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/business/entity/imagen_cotizacionForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/business/data/imagen_cotizacion_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/business/data/imagen_cotizacion_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/business/logic/imagen_cotizacion_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/business/logic/imagen_cotizacion_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/presentation/session/imagen_cotizacion_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/presentation/view/imagen_cotizacion_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!imagen_cotizacion_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/business/entity/imagen_cotizacion.php');				
						imagen_cotizacion_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!imagen_cotizacion_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/business/data/imagen_cotizacion_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/business/data/imagen_cotizacion_data.php');
						imagen_cotizacion_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!imagen_cotizacion_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!imagen_cotizacion_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/business/logic/imagen_cotizacion_logic.php');
						imagen_cotizacion_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!imagen_cotizacion_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/util/imagen_cotizacion_util.php');
						imagen_cotizacion_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!imagen_cotizacion_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/imagen_cotizacion/presentation/session/imagen_cotizacion_session.php');
						imagen_cotizacion_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface imagen_cotizacion_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
