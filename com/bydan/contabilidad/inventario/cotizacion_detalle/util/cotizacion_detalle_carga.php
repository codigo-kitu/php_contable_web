...
class cotizacion_detalle_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/util/cotizacion_detalle_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/util/cotizacion_detalleParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/util/cotizacion_detalle_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/entity/cotizacion_detalle.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/entity/cotizacion_detalleForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/data/cotizacion_detalle_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/data/cotizacion_detalle_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/logic/cotizacion_detalle_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/logic/cotizacion_detalle_logic.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/logic/cotizacion_detalle_logic_add.php');		
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/presentation/session/cotizacion_detalle_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/presentation/view/cotizacion_detalle_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!cotizacion_detalle_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/entity/cotizacion_detalle.php');				
						cotizacion_detalle_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!cotizacion_detalle_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/data/cotizacion_detalle_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/data/cotizacion_detalle_data.php');
						cotizacion_detalle_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!cotizacion_detalle_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!cotizacion_detalle_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/logic/cotizacion_detalle_logic.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/business/logic/cotizacion_detalleLogic_add.php');
						cotizacion_detalle_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!cotizacion_detalle_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/util/cotizacion_detalle_util.php');
						cotizacion_detalle_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!cotizacion_detalle_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/cotizacion_detalle/presentation/session/cotizacion_detalle_session.php');
						cotizacion_detalle_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	/*
	interface cotizacion_detalle_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
