...
namespace com\bydan\contabilidad\inventario\unidad\presentation\session;
...
class unidad_session extends GeneralEntitySessionBean {
	
	
	
	//ADDITIONAL
	//public $unidad_sessionAdditional=null;
	...
	function __construct () {	
		...
		$this->intNumeroPaginacion = unidad_util::$INT_NUMERO_PAGINACION;
		...
		$this->unidad_sessionAdditional=new unidad_sessionAdditional();
		*/
