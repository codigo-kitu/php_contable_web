...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/inventario/imagen_devolucion_cliente/js/util/imagen_devolucion_cliente_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			imagen_devolucion_cliente_web::$STR_NOMBRE_PAGINA = 'imagen_devolucion_cliente_form_view.php';
			imagen_devolucion_cliente_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			imagen_devolucion_cliente_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trimagen_devolucion_clienteElementosFormulario">
	<td>
		<div id="divMantenimientoimagen_devolucion_clienteAjaxWebPart" title="IMAGENES DEVOLUCION CLIENTE" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientoimagen_devolucion_cliente" name="frmMantenimientoimagen_devolucion_cliente">

			</br>

			<?php if(imagen_devolucion_cliente_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblimagen_devolucion_clienteToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblimagen_devolucion_clienteToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdimagen_devolucion_clienteActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarimagen_devolucion_cliente" name="imgActualizarToolBarimagen_devolucion_cliente" title="ACTUALIZAR Imagenes Devolucion Cliente ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_devolucion_clienteEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarimagen_devolucion_cliente" name="imgEliminarToolBarimagen_devolucion_cliente" title="ELIMINAR Imagenes Devolucion Cliente ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_devolucion_clienteCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarimagen_devolucion_cliente" name="imgCancelarToolBarimagen_devolucion_cliente" title="CANCELAR Imagenes Devolucion Cliente ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdimagen_devolucion_clienteRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultosimagen_devolucion_cliente',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblimagen_devolucion_clienteToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblimagen_devolucion_clienteToolBarFormularioExterior -->

			<table id="tblimagen_devolucion_clienteElementos">
			<tr id="trimagen_devolucion_clienteElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementosimagen_devolucion_cliente" class="elementos" style="width: 300px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: center;">
					<tr id="tr_fila_1">
					...
					<tr id="tr_fila_4">
						...
						<td id="td_control-id_imagen" align="left" class="controlcampo">
							<input id="form-id_imagen" name="form-id_imagen" type="text" class="form-control"  placeholder="Id Imagen"  title="Id Imagen"    maxlength="19" size="10" >
				...
				</table> <!-- tblElementosimagen_devolucion_cliente -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultosimagen_devolucion_cliente" class="elementos" style="display: table-row;">
					<caption class="busquedacabecera">
						<span>Campos Ocultos</span>
					</caption>
				</table> <!-- tblCamposOcultosimagen_devolucion_cliente -->

			</td></tr> <!-- trimagen_devolucion_clienteElementos -->
			</table> <!-- tblimagen_devolucion_clienteElementos -->
			</form> <!-- frmMantenimientoimagen_devolucion_cliente -->


			

				<form id="frmAccionesMantenimientoimagen_devolucion_cliente" name="frmAccionesMantenimientoimagen_devolucion_cliente">

			<?php if(imagen_devolucion_cliente_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblimagen_devolucion_clienteAcciones" class="elementos" style="text-align: center">
		<tr id="trimagen_devolucion_clienteAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientoimagen_devolucion_cliente" class="busqueda" style="width: 50%;text-align: center">
						...
						<tr id="trAccionesMantenimientoimagen_devolucion_clienteBasicos">
							<td id="tdbtnNuevoimagen_devolucion_cliente" style="visibility:visible">
								<div id="divNuevoimagen_devolucion_cliente" style="display:table-row">
									<input type="button" id="btnNuevoimagen_devolucion_cliente" name="btnNuevoimagen_devolucion_cliente" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarimagen_devolucion_cliente" style="visibility:visible">
								<div id="divActualizarimagen_devolucion_cliente" style="display:table-row">
									<input type="button" id="btnActualizarimagen_devolucion_cliente" name="btnActualizarimagen_devolucion_cliente" title="ACTUALIZAR Imagenes Devolucion Cliente ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarimagen_devolucion_cliente" style="visibility:visible">
								<div id="divEliminarimagen_devolucion_cliente" style="display:table-row">
									<input type="button" id="btnEliminarimagen_devolucion_cliente" name="btnEliminarimagen_devolucion_cliente" title="ELIMINAR Imagenes Devolucion Cliente ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimirimagen_devolucion_cliente" style="visibility:visible">
								<input type="button" id="btnImprimirimagen_devolucion_cliente" name="btnImprimirimagen_devolucion_cliente" title="IMPRIMIR PAGINA Imagenes Devolucion Cliente ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarimagen_devolucion_cliente" style="visibility:visible">
								<input type="button" id="btnCancelarimagen_devolucion_cliente" name="btnCancelarimagen_devolucion_cliente" title="CANCELAR Imagenes Devolucion Cliente ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientoimagen_devolucion_clienteGuardar" style="display:none">
							<td id="tdbtnGuardarCambiosimagen_devolucion_cliente" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambiosimagen_devolucion_cliente" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormularioimagen_devolucion_cliente" name="btnGuardarCambiosFormularioimagen_devolucion_cliente" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientoimagen_devolucion_cliente -->
			</td>
		</tr> <!-- trimagen_devolucion_clienteAcciones -->
		<?php if(imagen_devolucion_cliente_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trimagen_devolucion_clienteParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblimagen_devolucion_clienteParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trimagen_devolucion_clienteFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblimagen_devolucion_clienteParametrosAcciones -->
			</td>
		</tr> <!-- trimagen_devolucion_clienteParametrosAcciones -->
		<?php }?>
		<tr id="trimagen_devolucion_clienteMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trimagen_devolucion_clienteMensajes -->
			</table> <!-- tblimagen_devolucion_clienteAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientoimagen_devolucion_cliente -->
			</div> <!-- divMantenimientoimagen_devolucion_clienteAjaxWebPart -->
		</td>
	</tr> <!-- trimagen_devolucion_clienteElementosFormulario/super -->
		<?php if(imagen_devolucion_cliente_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {imagen_devolucion_cliente_webcontrol,imagen_devolucion_cliente_webcontrol1} from './webroot/js/JavaScript/contabilidad/inventario/imagen_devolucion_cliente/js/webcontrol/imagen_devolucion_cliente_form_webcontrol.js?random=1';
