			...
			<?php foreach ($imagen_devolucion_clientesLocal as $imagen_devolucion_cliente) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarimagen_devolucion_cliente" idactualimagen_devolucion_cliente="<?php echo($imagen_devolucion_cliente->id) ?>"  funcionjsactualimagen_devolucion_cliente="'.str_replace('TO_REPLACE',$imagen_devolucion_cliente->id.',\''.imagen_devolucion_cliente_util::getimagen_devolucion_clienteDescripcion($imagen_devolucion_cliente).'\'',$this->strFuncionJs).'" title="SELECCIONAR Imagenes Devolucion Cliente ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Imagenes Devolucion Cliente ACTUAL" value="<?php echo($imagen_devolucion_cliente->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($imagen_devolucion_cliente->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $imagen_devolucion_cliente->updated_at ) ?>
					</td>
					...
					<td class="elementotabla col_id_imagen" > 
						<?php echo( $imagen_devolucion_cliente->id_imagen ) ?>
					</td>
				
					<td class="elementotabla col_imagen" > 
						<?php echo( $imagen_devolucion_cliente->imagen ) ?>
					</td>
				
					<td class="elementotabla col_nro_devolucion" > 
						<?php echo( $imagen_devolucion_cliente->nro_devolucion ) ?>
					</td>
