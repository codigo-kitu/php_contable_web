			...
			<?php foreach ($otro_suplidorsLocal as $otro_suplidor) { ?>
				...
				<td class="elementotabla col_id" >
					...
					<table>
						<tr>
							...
							<td>
								<img class="imgseleccionarotro_suplidor" idactualotro_suplidor="<?php echo($otro_suplidor->id) ?>"  funcionjsactualotro_suplidor="'.str_replace('TO_REPLACE',$otro_suplidor->id.',\''.otro_suplidor_util::getotro_suplidorDescripcion($otro_suplidor).'\'',$this->strFuncionJs).'" title="SELECCIONAR Otro Suplidor ACTUAL" src="<?php echo($PATH_IMAGEN) ?>/Imagenes/seleccionar.gif" alt="Seleccionar" border="0" height="15" width="15">
							</td>
						</tr>
					</table>
					</a>
				...
				<td class="elementotabla columna_tabla_sel col_id" >
					<table>
						<tr>
							<td>
								<input id="t-id_<?php echo($i) ?>" name="t-id_<?php echo($i) ?>" type="checkbox" class="chkb_id" title="SELECCIONAR Otro Suplidor ACTUAL" value="<?php echo($otro_suplidor->id) ?>"></input>
							</td>
							<td>
								<input id="t-cel_<?php echo($i) ?>_0" name="t-cel_<?php echo($i) ?>_0" type="text" maxlength="25" value="<?php echo($otro_suplidor->id) ?>" style="width:50px" readonly></input>
							</td>
						</tr>
					</table>
				</td>
					...
					<td class="elementotabla col_created_at"  style="display:none"> 
						<?php echo( $otro_suplidor->updated_at ) ?>
					</td>
				
					<td class="elementotabla col_updated_at"  style="display:none"> 
						<?php echo( $otro_suplidor->updated_at ) ?>
					</td>
				<td class="elementotabla col_id_producto" > <?php echo($otro_suplidor->id_producto_Descripcion) ?></td>
				<td class="elementotabla col_id_proveedor" > <?php echo($otro_suplidor->id_proveedor_Descripcion) ?></td>
