...
class parametro_inventario_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/util/parametro_inventario_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/util/parametro_inventarioParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/util/parametro_inventario_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/entity/parametro_inventario.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/entity/parametro_inventarioForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/data/parametro_inventario_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/data/parametro_inventario_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/logic/parametro_inventario_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/logic/parametro_inventario_logic.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/logic/parametro_inventario_logic_add.php');		
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/presentation/session/parametro_inventario_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/presentation/view/parametro_inventario_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!parametro_inventario_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/entity/parametro_inventario.php');				
						parametro_inventario_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!parametro_inventario_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/data/parametro_inventario_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/data/parametro_inventario_data.php');
						parametro_inventario_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!parametro_inventario_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!parametro_inventario_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/logic/parametro_inventario_logic.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/business/logic/parametro_inventarioLogic_add.php');
						parametro_inventario_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!parametro_inventario_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/util/parametro_inventario_util.php');
						parametro_inventario_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!parametro_inventario_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/parametro_inventario/presentation/session/parametro_inventario_session.php');
						parametro_inventario_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
	...
	public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC') {
		...
		include_once('com/bydan/contabilidad/general/tipo_costeo_kardex/util/tipo_costeo_kardex_carga.php');
		tipo_costeo_kardex_carga::cargarArchivosPaquetesBase($paqueteTipo);

		include_once('com/bydan/contabilidad/inventario/tipo_kardex/util/tipo_kardex_carga.php');
		tipo_kardex_carga::cargarArchivosPaquetesBase($paqueteTipo);
	...
	/*
	interface parametro_inventario_carga {
		public static function cargarArchivosFrameworkBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER');
		public static function cargarArchivosPaquetes(array $arrPaquetesTipos=array());
		public static function cargarArchivosPaquetesForeignKeys(string $paqueteTipo='LOGIC');
