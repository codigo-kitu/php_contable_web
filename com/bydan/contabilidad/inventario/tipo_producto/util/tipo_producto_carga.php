...
class tipo_producto_carga {
	...
	public static function cargarArchivosPaquetesBase(string $paqueteTipo='CONTROLLER') {
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER || $paqueteTipo==PaqueteTipo::$LOGIC) {
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/util/tipo_producto_util.php');			
			
			
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/util/tipo_productoParameterGeneral.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/util/tipo_producto_param_return.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/business/entity/tipo_producto.php');						
			/*include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/business/entity/tipo_productoForeignKey.php');*/
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/business/data/tipo_producto_dataI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/business/data/tipo_producto_data.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/business/logic/tipo_producto_logicI.php');
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/business/logic/tipo_producto_logic.php');
		}
		...
		if($paqueteTipo==PaqueteTipo::$CONTROLLER) {
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/presentation/session/tipo_producto_session.php');
			...
			include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/presentation/view/tipo_producto_web.php');
		...
		if(!Constantes::$BIT_CONCARGA_INICIAL) {
			...
			foreach($arrPaquetesTipos as $sPaqueteTipo) {
				...
				if($sPaqueteTipo==PaqueteTipo::$ENTITIES) {
					if((!tipo_producto_carga::$ENTITIES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/business/entity/tipo_producto.php');				
						tipo_producto_carga::$ENTITIES=true;
						continue;
					}    			    			
				} else if($sPaqueteTipo==PaqueteTipo::$DATA_ACCESS) {
					if((!tipo_producto_carga::$DATA_ACCESS && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/business/data/tipo_producto_dataI.php');
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/business/data/tipo_producto_data.php');
						tipo_producto_carga::$DATA_ACCESS=true;
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$INTERFACE) {
					if((!tipo_producto_carga::$INTERFACE && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						continue;
					}    			
				} else if($sPaqueteTipo==PaqueteTipo::$LOGIC) {
					if((!tipo_producto_carga::$LOGIC && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/business/logic/tipo_producto_logic.php');
						tipo_producto_carga::$LOGIC=true;
						continue;
					}
				} else if($sPaqueteTipo==PaqueteTipo::$CONSTANTES_FUNCIONES) {
					if((!tipo_producto_carga::$CONSTANTES_FUNCIONES && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/util/tipo_producto_util.php');
						tipo_producto_carga::$CONSTANTES_FUNCIONES=true;
						continue;
					}
					...
					*/
					...
					if((!tipo_producto_carga::$WEB_SESSION && Constantes::$CON_CONTROL_CARGAR) || !Constantes::$CON_CONTROL_CARGAR) {
						include_once(Constantes::$PATH_REL.'com/bydan/contabilidad/inventario/tipo_producto/presentation/session/tipo_producto_session.php');
						tipo_producto_carga::$WEB_SESSION=true;
						continue;
					}
				}
			}
