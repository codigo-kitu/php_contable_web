...
?>
		...
		<script type="module" src="webroot/js/JavaScript/Library/Validacion/Validacion.js"></script>
			...
			<script type="module" src="webroot/js/JavaScript/contabilidad/inventario/cotizacion/js/util/cotizacion_form_funcion.js?random=1"></script>
		...
		<?php 
			...
			cotizacion_web::$STR_NOMBRE_PAGINA = 'cotizacion_form_view.php';
			cotizacion_web::$BIT_ES_PAGINA_PRINCIPAL = 'false';
			cotizacion_web::$BIT_ES_PAGINA_FORM = 'true';
...
<tr id="trcotizacionElementosFormulario">
	<td>
		<div id="divMantenimientocotizacionAjaxWebPart" title="COTIZACION" style="height: 90%;width: 90%;position: relative;top: 30px;left: 30px;">
			<form id="frmMantenimientocotizacion" name="frmMantenimientocotizacion">

			</br>

			<?php if(cotizacion_web::$STR_ES_RELACIONES=='false' ) {?>
			</br>
			<?php } ?>

			<!-- SECCION/TOOLBAR -->
			<table id="tblcotizacionToolBarFormularioExterior" style="width: 65%">
				<tr style="display:table-row">
					<td align="center">

						<table id="tblcotizacionToolBarFormulario" style="text-align: center"  style="display:table-row">
							<tr>
								<td id="tdcotizacionActualizarToolBar" style="visibility:visible">
									<img id="imgActualizarToolBarcotizacion" name="imgActualizarToolBarcotizacion" title="ACTUALIZAR Cotizacion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/actualizar.gif" width="25" height="25"/>
								</td>
								<td id="tdcotizacionEliminarToolBar" style="visibility:visible">
									<img id="imgEliminarToolBarcotizacion" name="imgEliminarToolBarcotizacion" title="ELIMINAR Cotizacion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/eliminar.gif" width="25" height="25"/>
								</td>
								<td id="tdcotizacionCancelarToolBar" style="visibility:visible">
									<img id="imgCancelarToolBarcotizacion" name="imgCancelarToolBarcotizacion" title="CANCELAR Cotizacion ACTUAL" style="width: 22px; height: 22px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/cancelar.gif" width="25" height="25"/>
								</td>
								<td id="tdcotizacionRelacionesToolBar" style="display:table-row">
									<img style="visibility:visible" src="/contabilidad0/webroot/img/Imagenes/xexpand.png" width="25" height="25" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('tblCamposOcultoscotizacion',this,'../')"/>
								</td>
							</tr>
						</table> <!-- tblcotizacionToolBarFormulario -->

					</td>
				</tr>
			</table> <!-- tblcotizacionToolBarFormularioExterior -->

			<table id="tblcotizacionElementos">
			<tr id="trcotizacionElementos" class="elementos" style="display:table-row">
			<td align="center">
			...
			<a id="Campos"></a>
				...
				<!-- SECCION/FORMULARIO -->
				<table id="tblElementoscotizacion" class="elementos" style="width: 400px; padding: 0px; border-spacing: 0px; border-collapse: collapse; text-align: left;">
					...
					<?php if(true || cotizacion_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="6"><span><img id="imgMostrarOcultarcotizacionprincipal" name="imgMostrarOcultarcotizacionprincipal" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trcotizacionprincipalElementos',this,'../')"/>PRINCIPAL</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trcotizacionprincipalElementos">
						<td id="tdcotizacionprincipalElementos"  colspan="6">
				<table class="elementos" style="width:800px;text-align:left; padding: 0px; border-spacing: 0px; border-collapse: collapse;">
					...
					<tr id="tr_fila_4">
						...
						<td id="td_control-enviar" align="left" class="controlcampo">
							<textarea id="form-enviar" name="form-enviar" class="form-control"  placeholder="Enviar"  title="Enviar"   style="font-size: 13px;" rows="2" cols="25" size="20" ></textarea>
				...
				</table> <!-- tblElementoscotizacion -->

				<!-- SECCION/OCULTOS -->
				<table id="tblCamposOcultoscotizacion" class="elementos" style="display: table-row;">
					...
					<tr id="tr_fila_2">
						...
						<td id="td_control-otro_monto" align="left" class="controlcampo">
							<input id="form-otro_monto" name="form-otro_monto" type="text" class="form-control"  placeholder="Otro Monto"  title="Otro Monto"    maxlength="18" size="12" >
						...
						<td id="td_control-otro_porciento" align="left" class="controlcampo">
							<input id="form-otro_porciento" name="form-otro_porciento" type="text" class="form-control"  placeholder="Otro %"  title="Otro %"    maxlength="18" size="12" >
							<span id="spanstrMensajeotro_porciento" class="mensajeerror"></span>
						</td>
					</tr>
				</table> <!-- tblCamposOcultoscotizacion -->

			</td></tr> <!-- trcotizacionElementos -->
			</table> <!-- tblcotizacionElementos -->
			</form> <!-- frmMantenimientocotizacion -->

			<?php
			if(cotizacion_web::$STR_ES_RELACIONES=="true") {
				...
				echo('<div id="tabs_general" class="tabs" style="width: 100%">');
					echo('<ul>');
						echo('<li class="titulotab"><a href="#divcotizacion_detalles">Cotizacion Detalles</a></li>');
					echo('</ul>');

					echo('<div id="divcotizacion_detalles">');
					require_once('com/bydan/contabilidad/inventario/presentation/view/cotizacion_detalle_view.php');
					echo('</div>');
			...
			?>
			<form id="frmMantenimientoTotalescotizacion" name="frmMantenimientoTotalescotizacion">
				<table>
					...
					<?php if(true || cotizacion_web::$STR_ES_RELACIONES=='false' ) {?>
					<tr class="busquedacabecera">
						<td colspan="6"><span><img id="imgMostrarOcultarcotizaciontotales" name="imgMostrarOcultarcotizaciontotales" title="Mostrar/Ocultar" style="width: 10px; height: 10px;text-align: center" src="/contabilidad0/webroot/img/Imagenes/xcollapse.png" width="10" height="10" onclick="funcionGeneral.mostrarOcultarFilaCambiarImagenRelative('trcotizaciontotalesElementos',this,'../')"/>TOTALES</span>
						</td>
					</tr>
					<?php } ?>
					<tr id="trcotizaciontotalesElementos">
						<td id="tdcotizaciontotalesElementos"  colspan="6">
				<table class="elementos" style="width:325px;text-align:left; padding: 0px; border-spacing: 0px; border-collapse: collapse;">
					...
					<tr id="tr_fila_2">
						...
						<td id="td_control-iva_porciento" align="left" class="controlcampo">
							<input id="form-iva_porciento" name="form-iva_porciento" type="text" class="form-control"  placeholder="Iva %"  title="Iva %"    maxlength="18" size="12"  readonly="readonly">
				...
				<form id="frmAccionesMantenimientocotizacion" name="frmAccionesMantenimientocotizacion">

			<?php if(cotizacion_web::$STR_ES_BUSQUEDA=='false' ) {?>
			<table id="tblcotizacionAcciones" class="elementos" style="text-align: center">
		<tr id="trcotizacionAcciones" class="elementos" style="display:table-row">
			<td align="center">
				<a id="Acciones" ></a>
				...
				<?php } ?>
					...
					<!-- SECCION/BOTONES -->
					<table id="tblAccionesMantenimientocotizacion" class="busqueda" style="width: 50%;text-align: left">
						...
						<tr id="trAccionesMantenimientocotizacionBasicos">
							<td id="tdbtnNuevocotizacion" style="visibility:visible">
								<div id="divNuevocotizacion" style="display:table-row">
									<input type="button" id="btnNuevocotizacion" name="btnNuevocotizacion" value="NUEVO" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnActualizarcotizacion" style="visibility:visible">
								<div id="divActualizarcotizacion" style="display:table-row">
									<input type="button" id="btnActualizarcotizacion" name="btnActualizarcotizacion" title="ACTUALIZAR Cotizacion ACTUAL" value="Actualizar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnEliminarcotizacion" style="visibility:visible">
								<div id="divEliminarcotizacion" style="display:table-row">
									<input type="button" id="btnEliminarcotizacion" name="btnEliminarcotizacion" title="ELIMINAR Cotizacion ACTUAL" value="Eliminar" class="btn btn-primary"/>
								</div>
							</td>
							<td id="tdbtnImprimircotizacion" style="visibility:visible">
								<input type="button" id="btnImprimircotizacion" name="btnImprimircotizacion" title="IMPRIMIR PAGINA Cotizacion ACTUAL" value="Imp. Datos" class="btn btn-primary"/>
							</td>
							<td id="tdbtnCancelarcotizacion" style="visibility:visible">
								<input type="button" id="btnCancelarcotizacion" name="btnCancelarcotizacion" title="CANCELAR Cotizacion ACTUAL" value="Cancelar" class="btn btn-primary"/>
							</td>
						</tr>
						<tr id="trAccionesMantenimientocotizacionGuardar" style="display:none">
							<td id="tdbtnGuardarCambioscotizacion" colspan="4" align="center" style="visibility:visible">
								<div id="divGuardarCambioscotizacion" style="display:table-row">
									<input type="button" id="btnGuardarCambiosFormulariocotizacion" name="btnGuardarCambiosFormulariocotizacion" title="GUARDAR" value="GUADAR CAMBIOS" class="btn btn-primary"/>
								</div>
							</td>
						</tr>
					</table> <!-- tblAccionesMantenimientocotizacion -->
			</td>
		</tr> <!-- trcotizacionAcciones -->
		<?php if(cotizacion_web::$STR_ES_RELACIONADO=='false' ) {?>
		<tr id="trcotizacionParametrosAcciones" class="impresion"  style="display:table-row">
			<td align="center">
				<!-- SECCION/POST -->
				<table id="tblcotizacionParametrosAcciones" style="text-align: center;border: 0px solid black;padding: 0px; border-spacing: 0px">
					<caption class="busquedacabecera" style="padding: 0px;caption-side: top;">
						<span>Acciones Extra/Post</span>
					</caption>
					<tr id="trcotizacionFilaParametrosAcciones">
						<td>
				...
				</table> <!-- tblcotizacionParametrosAcciones -->
			</td>
		</tr> <!-- trcotizacionParametrosAcciones -->
		<?php }?>
		<tr id="trcotizacionMensajes" class="mensajes">
			<td align="center">
				<a id="Mensajes"></a>
			</td>
		</tr> <!-- trcotizacionMensajes -->
			</table> <!-- tblcotizacionAcciones -->
			<?php } ?>
			</form> <!-- frmMantenimientocotizacion -->
			</div> <!-- divMantenimientocotizacionAjaxWebPart -->
		</td>
	</tr> <!-- trcotizacionElementosFormulario/super -->
		<?php if(cotizacion_web::$STR_ES_RELACIONADO=='false' ) {?>
		...
		?>	
				...
				import {cotizacion_webcontrol,cotizacion_webcontrol1} from './webroot/js/JavaScript/contabilidad/inventario/cotizacion/js/webcontrol/cotizacion_form_webcontrol.js?random=1';
